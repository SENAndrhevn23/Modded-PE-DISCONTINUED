...
void FlxBitmapDataPoolNode_obj::__construct( ::openfl::display::BitmapData bmd, ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode prev, ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode next){
            	HX_GC_STACKFRAME(&_hx_pos_0a3a17009128d090_163_new)
HXLINE( 164)		this->_hx_set_bmd(HX_CTX, bmd);
HXLINE( 165)		this->_hx_set_prev(HX_CTX, prev);
HXLINE( 166)		this->_hx_set_next(HX_CTX, next);
            	}
...
::hx::Val FlxBitmapDataPoolNode_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"bmd") ) { _hx_set_bmd(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"prev") ) { _hx_set_prev(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode >()); return inValue; }
		if (HX_FIELD_EQ(inName,"next") ) { _hx_set_next(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxBitmapDataPool::FlxBitmapDataPoolNode >()); return inValue; }
	}
