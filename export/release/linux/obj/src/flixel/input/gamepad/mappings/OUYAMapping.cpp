...
void OUYAMapping_obj::initValues(){
            	HX_GC_STACKFRAME(&_hx_pos_cb034decec2e0057_17_initValues)
HXLINE(  18)		this->_hx_set_leftStick(HX_CTX, ::flixel::input::gamepad::id::OUYAID_obj::LEFT_ANALOG_STICK);
HXLINE(  19)		this->_hx_set_rightStick(HX_CTX, ::flixel::input::gamepad::id::OUYAID_obj::RIGHT_ANALOG_STICK);
            	}
