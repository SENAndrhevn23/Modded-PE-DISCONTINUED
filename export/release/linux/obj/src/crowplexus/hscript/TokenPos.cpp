...
void TokenPos_obj::__construct( ::crowplexus::hscript::Token t,int min,int max){
            	HX_GC_STACKFRAME(&_hx_pos_3baf37bc1b271d6d_57_new)
HXLINE(  58)		this->_hx_set_t(HX_CTX, t);
...
::hx::Val TokenPos_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
		if (HX_FIELD_EQ(inName,"t") ) { _hx_set_t(HX_CTX_GET,inValue.Cast<  ::crowplexus::hscript::Token >()); return inValue; }
		break;
	case 3:
