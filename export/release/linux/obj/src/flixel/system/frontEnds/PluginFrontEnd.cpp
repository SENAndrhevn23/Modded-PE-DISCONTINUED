...
HX_LOCAL_STACK_FRAME(_hx_pos_4a20ba41f30cf210_30_add_mikolka_vslice_components_ScreenshotPlugin,"flixel.system.frontEnds.PluginFrontEnd","add_mikolka_vslice_components_ScreenshotPlugin",0x46a94cc9,"flixel.system.frontEnds.PluginFrontEnd.add_mikolka_vslice_components_ScreenshotPlugin","flixel/system/frontEnds/PluginFrontEnd.hx",30,0xbff70e9e)
...
HXLINE(  17)		this->_hx_set_list(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
...
bool PluginFrontEnd_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::mikolka::vslice::components::ScreenshotPlugin PluginFrontEnd_obj::add_mikolka_vslice_components_ScreenshotPlugin( ::mikolka::vslice::components::ScreenshotPlugin plugin){
            	HX_STACKFRAME(&_hx_pos_4a20ba41f30cf210_30_add_mikolka_vslice_components_ScreenshotPlugin)
HXDLIN(  30)		return ( ( ::mikolka::vslice::components::ScreenshotPlugin)(this->addIfUniqueType(plugin)) );
            	}


HX_DEFINE_DYNAMIC_FUNC1(PluginFrontEnd_obj,add_mikolka_vslice_components_ScreenshotPlugin,return )
...
::hx::Val PluginFrontEnd_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 15:
		...
		break;
	case 46:
		if (HX_FIELD_EQ(inName,"add_mikolka_vslice_components_ScreenshotPlugin") ) { return ::hx::Val( add_mikolka_vslice_components_ScreenshotPlugin_dyn() ); }
	}
...
::hx::Val PluginFrontEnd_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"list") ) { _hx_set_list(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
...
static ::String PluginFrontEnd_obj_sMemberFields[] = {
	HX_("add_mikolka_vslice_components_ScreenshotPlugin",7a,b3,20,69),
