...
HXLINE(  26)		this->_hx_set_onComplete(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE(  79)		this->_hx_set_buffer(HX_CTX, buffer);
HXLINE(  80)		this->offset = offset;
HXLINE(  82)		this->_hx_set__hx___backend(HX_CTX,  ::lime::_internal::backend::native::NativeAudioSource_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this)));
...
::hx::Val AudioSource_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"buffer") ) { _hx_set_buffer(HX_CTX_GET,inValue.Cast<  ::lime::media::AudioBuffer >()); return inValue; }
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"__backend") ) { _hx_set__hx___backend(HX_CTX_GET,inValue.Cast<  ::lime::_internal::backend::native::NativeAudioSource >()); return inValue; }
		break;
	case 10:
