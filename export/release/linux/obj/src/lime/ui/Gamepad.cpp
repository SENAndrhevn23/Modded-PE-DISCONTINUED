...
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_66_rumble,"lime.ui.Gamepad","rumble",0xc27bc7df,"lime.ui.Gamepad.rumble","lime/ui/Gamepad.hx",66,0x36bc843e)
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_112_get_guid,"lime.ui.Gamepad","get_guid",0x2f6ca220,"lime.ui.Gamepad.get_guid","lime/ui/Gamepad.hx",112,0x36bc843e)
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_123_get_name,"lime.ui.Gamepad","get_name",0x33fdf6e2,"lime.ui.Gamepad.get_name","lime/ui/Gamepad.hx",123,0x36bc843e)
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_51_addMappings,"lime.ui.Gamepad","addMappings",0x7dce3c98,"lime.ui.Gamepad.addMappings","lime/ui/Gamepad.hx",51,0x36bc843e)
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_92___connect,"lime.ui.Gamepad","__connect",0x06daaffc,"lime.ui.Gamepad.__connect","lime/ui/Gamepad.hx",92,0x36bc843e)
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_101___disconnect,"lime.ui.Gamepad","__disconnect",0x04d0478a,"lime.ui.Gamepad.__disconnect","lime/ui/Gamepad.hx",101,0x36bc843e)
...
HXLINE(  25)		this->_hx_set_onDisconnect(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE(  24)		this->_hx_set_onButtonUp(HX_CTX,  ::lime::app::_Event_lime_ui_GamepadButton_Void_obj::__alloc( HX_CTX ));
HXLINE(  23)		this->_hx_set_onButtonDown(HX_CTX,  ::lime::app::_Event_lime_ui_GamepadButton_Void_obj::__alloc( HX_CTX ));
HXLINE(  22)		this->_hx_set_onAxisMove(HX_CTX,  ::lime::app::_Event_lime_ui_GamepadAxis_Float_Void_obj::__alloc( HX_CTX ));
...
void Gamepad_obj::rumble(Float lowFrequencyRumble,Float highFrequencyRumble,int duration){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_66_rumble)
HXDLIN(  66)		::lime::_internal::backend::native::NativeCFFI_obj::lime_gamepad_rumble(this->id,lowFrequencyRumble,highFrequencyRumble,duration);
            	}


HX_DEFINE_DYNAMIC_FUNC3(Gamepad_obj,rumble,(void))

::String Gamepad_obj::get_guid(){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_112_get_guid)
HXDLIN( 112)		return ( (::String)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gamepad_get_device_guid(this->id)) )) );
            	}
...
::String Gamepad_obj::get_name(){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_123_get_name)
HXDLIN( 123)		return ( (::String)(( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gamepad_get_device_name(this->id)) )) );
            	}
...
void Gamepad_obj::addMappings(::Array< ::String > mappings){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_51_addMappings)
HXDLIN(  51)		::lime::_internal::backend::native::NativeCFFI_obj::lime_gamepad_add_mappings(::hx::DynamicPtr(mappings));
            	}
...
void Gamepad_obj::_hx___connect(int id){
            	HX_GC_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_92___connect)
HXDLIN(  92)		if (!(::lime::ui::Gamepad_obj::devices->exists(id))) {
HXLINE(  94)			 ::lime::ui::Gamepad gamepad =  ::lime::ui::Gamepad_obj::__alloc( HX_CTX ,id);
HXLINE(  95)			::lime::ui::Gamepad_obj::devices->set(id,gamepad);
HXLINE(  96)			::lime::ui::Gamepad_obj::onConnect->dispatch(gamepad);
            		}
            	}
...
void Gamepad_obj::_hx___disconnect(int id){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_101___disconnect)
HXLINE( 102)		 ::lime::ui::Gamepad gamepad = ( ( ::lime::ui::Gamepad)(::lime::ui::Gamepad_obj::devices->get(id)) );
HXLINE( 103)		if (::hx::IsNotNull( gamepad )) {
HXLINE( 103)			gamepad->connected = false;
            		}
HXLINE( 104)		::lime::ui::Gamepad_obj::devices->remove(id);
HXLINE( 105)		if (::hx::IsNotNull( gamepad )) {
HXLINE( 105)			gamepad->onDisconnect->dispatch();
            		}
            	}
...
::hx::Val Gamepad_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"rumble") ) { return ::hx::Val( rumble_dyn() ); }
		break;
	case 8:
...
::hx::Val Gamepad_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"onAxisMove") ) { _hx_set_onAxisMove(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_lime_ui_GamepadAxis_Float_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onButtonUp") ) { _hx_set_onButtonUp(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_lime_ui_GamepadButton_Void >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"onButtonDown") ) { _hx_set_onButtonDown(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_lime_ui_GamepadButton_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onDisconnect") ) { _hx_set_onDisconnect(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
	}
