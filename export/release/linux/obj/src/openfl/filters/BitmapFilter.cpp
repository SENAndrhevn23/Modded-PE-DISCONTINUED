...
void BitmapFilter_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_f182c9f42f2f4da3_39_new)
...
HXLINE(  46)		this->_hx_set__hx___shaderBlendMode(HX_CTX, 10);
...
::hx::Val BitmapFilter_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 17:
		...
		if (HX_FIELD_EQ(inName,"__shaderBlendMode") ) { _hx_set__hx___shaderBlendMode(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 22:
