...
HXLINE( 150)		this->_hx_set_data(HX_CTX,  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,0));
HXLINE( 151)		this->data->_hx_set__hx___endian(HX_CTX, 1);
...
HXLINE( 158)		event->_hx_set_target(HX_CTX, this->target);
HXLINE( 159)		event->_hx_set_currentTarget(HX_CTX, this->currentTarget);
HXLINE( 160)		event->eventPhase = this->eventPhase;
HXLINE( 161)		event->_hx_set_data(HX_CTX, this->data);
...
HXLINE( 174)		this->_hx_set_data(HX_CTX,  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,0));
HXLINE( 175)		this->data->_hx_set__hx___endian(HX_CTX, 1);
