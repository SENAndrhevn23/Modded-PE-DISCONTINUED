...
class HXCPP_CLASS_ATTRIBUTES BMFontInfo_obj : public ::hx::Object
{
	...
	public:
		...
		::String face;
		inline ::String _hx_set_face(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return face=_hx_v; }
		int size;
		bool bold;
		bool italic;
		::String charset;
		inline ::String _hx_set_charset(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return charset=_hx_v; }
		bool unicode;
		int stretchH;
		bool smooth;
		int aa;
		 ::flixel::graphics::frames::bmfont::BMFontPadding padding;
		inline  ::flixel::graphics::frames::bmfont::BMFontPadding _hx_set_padding(::hx::StackContext *_hx_ctx, ::flixel::graphics::frames::bmfont::BMFontPadding _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return padding=_hx_v; }
		 ::flixel::graphics::frames::bmfont::BMFontSpacing spacing;
		inline  ::flixel::graphics::frames::bmfont::BMFontSpacing _hx_set_spacing(::hx::StackContext *_hx_ctx, ::flixel::graphics::frames::bmfont::BMFontSpacing _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return spacing=_hx_v; }
		int outline;
		bool fixedHeight;
};
