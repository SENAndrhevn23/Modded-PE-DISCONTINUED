...
class HXCPP_CLASS_ATTRIBUTES FlxKeyboard_obj : public  ::flixel::input::FlxKeyManager_obj
{
	...
	public:
		...
		inline  ::haxe::ds::StringMap _hx_set__nativeCorrection(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _nativeCorrection=_hx_v; }
