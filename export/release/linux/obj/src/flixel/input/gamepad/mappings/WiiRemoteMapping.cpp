...
HXDLIN( 219)		return (axisID == 4);
 ...
 ::flixel::input::gamepad::FlxGamepadAttachment WiiRemoteMapping_obj::set_attachment( ::flixel::input::gamepad::FlxGamepadAttachment attachment){
            	HX_GC_STACKFRAME(&_hx_pos_bff79226d1e7d85e_266_set_attachment)
...
HXDLIN( 267)		this->_hx_set_leftStick(HX_CTX, _hx_tmp);
...
HXDLIN( 273)		this->_hx_set_rightStick(HX_CTX, _hx_tmp1);
