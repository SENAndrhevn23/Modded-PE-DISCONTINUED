...
void HTTPStatusEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< int >  __o_status,::hx::Null< bool >  __o_redirected){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_3e9f49414be9df9e_29_new)
HXLINE(  79)		this->_hx_set_responseHeaders(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
...
HXLINE( 136)		event->_hx_set_target(HX_CTX, this->target);
HXLINE( 137)		event->_hx_set_currentTarget(HX_CTX, this->currentTarget);
...
::hx::Val HTTPStatusEvent_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"responseURL") ) { _hx_set_responseURL(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 15:
