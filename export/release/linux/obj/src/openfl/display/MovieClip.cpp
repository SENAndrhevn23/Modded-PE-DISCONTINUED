...
void MovieClip_obj::attachTimeline( ::openfl::display::Timeline timeline){
            	HX_GC_STACKFRAME(&_hx_pos_9f7ac0293b858dd4_206_attachTimeline)
HXLINE( 207)		this->_hx_set__hx___timeline(HX_CTX, timeline);
...
HXLINE( 530)				this->_hx_set__hx___scene(HX_CTX,  ::openfl::display::Scene_obj::__alloc( HX_CTX ,HX_("",00,00,00,00),::Array_obj< ::Dynamic>::__new(0),1));
            			}
...
::hx::Val MovieClip_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"__scene") ) { _hx_set__hx___scene(HX_CTX_GET,inValue.Cast<  ::openfl::display::Scene >()); return inValue; }
		break;
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"__timeline") ) { _hx_set__hx___timeline(HX_CTX_GET,inValue.Cast<  ::openfl::display::Timeline >()); return inValue; }
		break;
	case 13:
