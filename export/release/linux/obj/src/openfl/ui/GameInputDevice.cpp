...
HXLINE(  50)		this->_hx_set__hx___controls(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE(  49)		this->_hx_set__hx___button(HX_CTX,  ::haxe::ds::IntMap_obj::__alloc( HX_CTX ));
HXLINE(  48)		this->_hx_set__hx___axis(HX_CTX,  ::haxe::ds::IntMap_obj::__alloc( HX_CTX ));
HXLINE(  66)		this->_hx_set_id(HX_CTX, id);
HXLINE(  67)		this->_hx_set_name(HX_CTX, name);
...
::hx::Val GameInputDevice_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"__axis") ) { _hx_set__hx___axis(HX_CTX_GET,inValue.Cast<  ::haxe::ds::IntMap >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"enabled") ) { enabled=inValue.Cast< bool >(); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"__button") ) { _hx_set__hx___button(HX_CTX_GET,inValue.Cast<  ::haxe::ds::IntMap >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"__gamepad") ) { _hx_set__hx___gamepad(HX_CTX_GET,inValue.Cast<  ::lime::ui::Gamepad >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"__controls") ) { _hx_set__hx___controls(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 14:
