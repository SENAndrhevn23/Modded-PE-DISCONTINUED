...
void Event_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_460ec5366bb20ab2_763_new)
HXLINE( 764)		this->_hx_set_type(HX_CTX, type);
...
HXLINE( 797)		event->_hx_set_target(HX_CTX, this->target);
HXLINE( 798)		event->_hx_set_currentTarget(HX_CTX, this->currentTarget);
...
void Event_obj::_hx___init(){
            	HX_GC_STACKFRAME(&_hx_pos_460ec5366bb20ab2_940___init)
HXLINE( 942)		this->_hx_set_target(HX_CTX, null());
HXLINE( 943)		this->_hx_set_currentTarget(HX_CTX, null());
...
::hx::Val Event_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"currentTarget") ) { _hx_set_currentTarget(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 15:
