...
class HXCPP_CLASS_ATTRIBUTES FlxSound_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		inline  ::flixel::sound::FlxSoundGroup _hx_set_group(::hx::StackContext *_hx_ctx, ::flixel::sound::FlxSoundGroup _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return group=_hx_v; }
		bool looped;
		Float loopTime;
		 ::Dynamic endTime;
		inline  ::Dynamic _hx_set_endTime(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return endTime=_hx_v; }
		 ::flixel::tweens::FlxTween fadeTween;
		inline  ::flixel::tweens::FlxTween _hx_set_fadeTween(::hx::StackContext *_hx_ctx, ::flixel::tweens::FlxTween _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return fadeTween=_hx_v; }
		 ::openfl::media::Sound _sound;
		inline  ::openfl::media::Sound _hx_set__sound(::hx::StackContext *_hx_ctx, ::openfl::media::Sound _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _sound=_hx_v; }
		 ::openfl::media::SoundChannel _channel;
		inline  ::openfl::media::SoundChannel _hx_set__channel(::hx::StackContext *_hx_ctx, ::openfl::media::SoundChannel _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _channel=_hx_v; }
		 ::openfl::media::SoundTransform _transform;
		inline  ::openfl::media::SoundTransform _hx_set__transform(::hx::StackContext *_hx_ctx, ::openfl::media::SoundTransform _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _transform=_hx_v; }
		bool _paused;
		Float _volume;
		Float _time;
		Float _length;
		...
		inline  ::flixel::FlxObject _hx_set__target(::hx::StackContext *_hx_ctx, ::flixel::FlxObject _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _target=_hx_v; }
		Float _radius;
		bool _proximityPan;
		bool _alreadyPaused;
		void reset();
