...
void Stdin_obj::__construct( ::Dynamic p){
            	HX_GC_STACKFRAME(&_hx_pos_c7a66aa1623b080e_31_new)
HXLINE(  32)		this->_hx_set_p(HX_CTX, p);
HXLINE(  33)		this->_hx_set_buf(HX_CTX, ::haxe::io::Bytes_obj::alloc(1));
            	}
...
::hx::Val Stdin_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 1:
		...
		break;
	case 3:
		if (HX_FIELD_EQ(inName,"buf") ) { _hx_set_buf(HX_CTX_GET,inValue.Cast<  ::haxe::io::Bytes >()); return inValue; }
	}
