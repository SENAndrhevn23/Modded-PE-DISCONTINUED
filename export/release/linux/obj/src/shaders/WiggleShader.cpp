...
HX_DEFINE_STACK_FRAME(_hx_pos_a512a5ea5b78a9ad_139_new,"shaders.WiggleShader","new",0x0b44eb02,"shaders.WiggleShader.new","shaders/WiggleEffect.hx",139,0xdc7063e1)
namespace shaders{

void WiggleShader_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_a512a5ea5b78a9ad_139_new)
...
HXLINE(  71)		this->_hx___isGenerated = true;
HXDLIN(  71)		this->_hx___initGL();
            	}
...
bool WiggleShader_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x1efca5b6) {
		if (inClassId<=(int)0x0601697e) {
			if (inClassId<=(int)0x04f93fcd) {
				return inClassId==(int)0x00000001 || inClassId==(int)0x04f93fcd;
			} else {
				return inClassId==(int)0x0601697e;
			}
		} else {
...
::hx::ObjectPtr< WiggleShader_obj > WiggleShader_obj::__alloc(::hx::Ctx *_hx_ctx) {
	WiggleShader_obj *__this = (WiggleShader_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(WiggleShader_obj), true, "shaders.WiggleShader"));
...
::hx::Val WiggleShader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 2:
		if (HX_FIELD_EQ(inName,"tx") ) { _hx_set_tx(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 5:
	...
	case 6:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"effectType") ) { _hx_set_effectType(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Int >()); return inValue; }
...
void WiggleShader_obj::__register()
{
	...
	__mClass->mName = HX_("shaders.WiggleShader",10,02,77,61);
