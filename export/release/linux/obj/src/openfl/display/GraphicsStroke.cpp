...
void GraphicsStroke_obj::__construct( ::Dynamic thickness,::hx::Null< bool >  __o_pixelHinting, ::Dynamic __o_scaleMode, ::Dynamic __o_caps, ::Dynamic __o_joints,::hx::Null< Float >  __o_miterLimit,::Dynamic fill){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_55614d7317440053_216_new)
HXLINE( 217)		if (::hx::IsNull( thickness )) {
HXLINE( 217)			thickness = ::Math_obj::NaN;
            		}
HXLINE( 219)		this->_hx_set_caps(HX_CTX, caps);
HXLINE( 220)		this->_hx_set_fill(HX_CTX, fill);
HXLINE( 221)		this->_hx_set_joints(HX_CTX, joints);
HXLINE( 222)		this->miterLimit = miterLimit;
HXLINE( 223)		this->pixelHinting = pixelHinting;
HXLINE( 224)		this->_hx_set_scaleMode(HX_CTX, scaleMode);
...
::hx::Val GraphicsStroke_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"caps") ) { _hx_set_caps(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"fill") ) { _hx_set_fill(HX_CTX_GET,inValue.Cast< ::Dynamic >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"joints") ) { _hx_set_joints(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"scaleMode") ) { _hx_set_scaleMode(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
