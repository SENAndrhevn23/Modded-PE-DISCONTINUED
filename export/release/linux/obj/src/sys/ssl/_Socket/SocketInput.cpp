...
void SocketInput_obj::__construct( ::sys::ssl::Socket s){
            	HX_GC_STACKFRAME(&_hx_pos_8eb172850483f24d_36_new)
HXDLIN(  36)		this->_hx_set___s(HX_CTX, s);
            	}
...
::hx::Val SocketInput_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"__s") ) { _hx_set___s(HX_CTX_GET,inValue.Cast<  ::sys::ssl::Socket >()); return inValue; }
	}
