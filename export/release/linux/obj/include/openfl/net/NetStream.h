...
class HXCPP_CLASS_ATTRIBUTES NetStream_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		bool checkPolicyFile;
		 ::Dynamic client;
		inline  ::Dynamic _hx_set_client(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return client=_hx_v; }
		Float currentFPS;
		int decodedFrames;
		Float liveDelay;
		int objectEncoding;
		...
		inline  ::openfl::net::NetConnection _hx_set__hx___connection(::hx::StackContext *_hx_ctx, ::openfl::net::NetConnection _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___connection=_hx_v; }
		...
		inline  ::haxe::Timer _hx_set__hx___timer(::hx::StackContext *_hx_ctx, ::haxe::Timer _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___timer=_hx_v; }
		void close();
		::Dynamic close_dyn();
