...
class HXCPP_CLASS_ATTRIBUTES DisplayObject_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		inline  ::Dynamic _hx_set_opaqueBackground(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return opaqueBackground=_hx_v; }
		 ::openfl::display::DisplayObjectContainer parent;
		inline  ::openfl::display::DisplayObjectContainer _hx_set_parent(::hx::StackContext *_hx_ctx, ::openfl::display::DisplayObjectContainer _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return parent=_hx_v; }
		...
		inline  ::openfl::geom::Matrix _hx_set__hx___cacheAsBitmapMatrix(::hx::StackContext *_hx_ctx, ::openfl::geom::Matrix _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___cacheAsBitmapMatrix=_hx_v; }
		 ::openfl::display::Bitmap _hx___cacheBitmap;
		inline  ::openfl::display::Bitmap _hx_set__hx___cacheBitmap(::hx::StackContext *_hx_ctx, ::openfl::display::Bitmap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___cacheBitmap=_hx_v; }
		 ::Dynamic _hx___cacheBitmapBackground;
		inline  ::Dynamic _hx_set__hx___cacheBitmapBackground(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___cacheBitmapBackground=_hx_v; }
		 ::openfl::geom::ColorTransform _hx___cacheBitmapColorTransform;
		inline  ::openfl::geom::ColorTransform _hx_set__hx___cacheBitmapColorTransform(::hx::StackContext *_hx_ctx, ::openfl::geom::ColorTransform _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___cacheBitmapColorTransform=_hx_v; }
		 ::openfl::display::BitmapData _hx___cacheBitmapData;
		inline  ::openfl::display::BitmapData _hx_set__hx___cacheBitmapData(::hx::StackContext *_hx_ctx, ::openfl::display::BitmapData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___cacheBitmapData=_hx_v; }
		 ::openfl::display::BitmapData _hx___cacheBitmapData2;
		inline  ::openfl::display::BitmapData _hx_set__hx___cacheBitmapData2(::hx::StackContext *_hx_ctx, ::openfl::display::BitmapData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___cacheBitmapData2=_hx_v; }
		 ::openfl::display::BitmapData _hx___cacheBitmapData3;
		inline  ::openfl::display::BitmapData _hx_set__hx___cacheBitmapData3(::hx::StackContext *_hx_ctx, ::openfl::display::BitmapData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___cacheBitmapData3=_hx_v; }
		 ::openfl::geom::Matrix _hx___cacheBitmapMatrix;
		inline  ::openfl::geom::Matrix _hx_set__hx___cacheBitmapMatrix(::hx::StackContext *_hx_ctx, ::openfl::geom::Matrix _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___cacheBitmapMatrix=_hx_v; }
		 ::openfl::display::DisplayObjectRenderer _hx___cacheBitmapRenderer;
		inline  ::openfl::display::DisplayObjectRenderer _hx_set__hx___cacheBitmapRenderer(::hx::StackContext *_hx_ctx, ::openfl::display::DisplayObjectRenderer _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___cacheBitmapRenderer=_hx_v; }
		 ::lime::graphics::cairo::Cairo _hx___cairo;
		inline  ::lime::graphics::cairo::Cairo _hx_set__hx___cairo(::hx::StackContext *_hx_ctx, ::lime::graphics::cairo::Cairo _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___cairo=_hx_v; }
		::Array< ::Dynamic> _hx___children;
		inline ::Array< ::Dynamic> _hx_set__hx___children(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___children=_hx_v; }
		bool _hx___customRenderClear;
		 ::openfl::events::RenderEvent _hx___customRenderEvent;
		inline  ::openfl::events::RenderEvent _hx_set__hx___customRenderEvent(::hx::StackContext *_hx_ctx, ::openfl::events::RenderEvent _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___customRenderEvent=_hx_v; }
		int _hx___drawableType;
		::Array< ::Dynamic> _hx___filters;
		inline ::Array< ::Dynamic> _hx_set__hx___filters(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___filters=_hx_v; }
		 ::openfl::display::Graphics _hx___graphics;
		inline  ::openfl::display::Graphics _hx_set__hx___graphics(::hx::StackContext *_hx_ctx, ::openfl::display::Graphics _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___graphics=_hx_v; }
		bool _hx___interactive;
		bool _hx___isCacheBitmapRender;
		bool _hx___isMask;
		 ::openfl::display::LoaderInfo _hx___loaderInfo;
		inline  ::openfl::display::LoaderInfo _hx_set__hx___loaderInfo(::hx::StackContext *_hx_ctx, ::openfl::display::LoaderInfo _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___loaderInfo=_hx_v; }
		...
		inline  ::openfl::display::DisplayObject _hx_set__hx___maskTarget(::hx::StackContext *_hx_ctx, ::openfl::display::DisplayObject _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___maskTarget=_hx_v; }
		::String _hx___name;
		inline ::String _hx_set__hx___name(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return _hx___name=_hx_v; }
		 ::openfl::geom::Transform _hx___objectTransform;
		inline  ::openfl::geom::Transform _hx_set__hx___objectTransform(::hx::StackContext *_hx_ctx, ::openfl::geom::Transform _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___objectTransform=_hx_v; }
		bool _hx___renderable;
		bool _hx___renderDirty;
		 ::openfl::display::DisplayObject _hx___renderParent;
		inline  ::openfl::display::DisplayObject _hx_set__hx___renderParent(::hx::StackContext *_hx_ctx, ::openfl::display::DisplayObject _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___renderParent=_hx_v; }
		...
		inline  ::openfl::geom::Matrix _hx_set__hx___renderTransformCache(::hx::StackContext *_hx_ctx, ::openfl::geom::Matrix _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___renderTransformCache=_hx_v; }
		...
		inline  ::openfl::geom::Rectangle _hx_set__hx___scale9Grid(::hx::StackContext *_hx_ctx, ::openfl::geom::Rectangle _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___scale9Grid=_hx_v; }
		Float _hx___scaleX;
		Float _hx___scaleY;
		...
		inline  ::openfl::display::Shader _hx_set__hx___shader(::hx::StackContext *_hx_ctx, ::openfl::display::Shader _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___shader=_hx_v; }
		 ::openfl::geom::Point _hx___tempPoint;
		inline  ::openfl::geom::Point _hx_set__hx___tempPoint(::hx::StackContext *_hx_ctx, ::openfl::geom::Point _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___tempPoint=_hx_v; }
		...
		inline  ::Dynamic _hx_set__hx___worldBlendMode(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___worldBlendMode=_hx_v; }
		 ::openfl::geom::Rectangle _hx___worldClip;
		inline  ::openfl::geom::Rectangle _hx_set__hx___worldClip(::hx::StackContext *_hx_ctx, ::openfl::geom::Rectangle _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___worldClip=_hx_v; }
		...
		inline  ::openfl::display::Shader _hx_set__hx___worldShader(::hx::StackContext *_hx_ctx, ::openfl::display::Shader _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___worldShader=_hx_v; }
		 ::openfl::geom::Rectangle _hx___worldScale9Grid;
		inline  ::openfl::geom::Rectangle _hx_set__hx___worldScale9Grid(::hx::StackContext *_hx_ctx, ::openfl::geom::Rectangle _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___worldScale9Grid=_hx_v; }
