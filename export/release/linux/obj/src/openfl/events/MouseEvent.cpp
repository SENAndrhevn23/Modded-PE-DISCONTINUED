...
void MouseEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< Float >  __o_localX,::hx::Null< Float >  __o_localY, ::openfl::display::InteractiveObject relatedObject,::hx::Null< bool >  __o_ctrlKey,::hx::Null< bool >  __o_altKey,::hx::Null< bool >  __o_shiftKey,::hx::Null< bool >  __o_buttonDown,::hx::Null< int >  __o_delta,::hx::Null< bool >  __o_commandKey,::hx::Null< bool >  __o_controlKey,::hx::Null< int >  __o_clickCount){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_643_new)
...
HXLINE( 650)		this->_hx_set_relatedObject(HX_CTX, relatedObject);
...
HXLINE( 670)		event->_hx_set_target(HX_CTX, this->target);
HXLINE( 671)		event->_hx_set_currentTarget(HX_CTX, this->currentTarget);
...
void MouseEvent_obj::_hx___init(){
            	HX_GC_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_709___init)
...
HXLINE( 715)		this->_hx_set_relatedObject(HX_CTX, null());
...
HXLINE( 703)		event->_hx_set_target(HX_CTX, target);
...
::hx::Val MouseEvent_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"relatedObject") ) { _hx_set_relatedObject(HX_CTX_GET,inValue.Cast<  ::openfl::display::InteractiveObject >()); return inValue; }
		break;
	case 22:
