...
HXLINE(  59)		this->_hx_set_bitmapData(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  60)		this->_hx_set_font(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  61)		this->_hx_set_sound(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
            	}
...
HXLINE(  84)			this->_hx_set_bitmapData(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  85)			this->_hx_set_font(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  86)			this->_hx_set_sound(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
            		}
            		else {
...
::hx::Val AssetCache_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"sound") ) { _hx_set_sound(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
		break;
	case 7:
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"bitmapData") ) { _hx_set_bitmapData(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
	}
