...
HX_DEFINE_STACK_FRAME(_hx_pos_4a87544bdb02f918_261_new,"backend.ui.PsychUIDropDownItem","new",0x3996e125,"backend.ui.PsychUIDropDownItem.new","backend/ui/PsychUIDropDownMenu.hx",261,0x0f4dd77f)
HX_LOCAL_STACK_FRAME(_hx_pos_4a87544bdb02f918_293_update,"backend.ui.PsychUIDropDownItem","update",0x4f437e64,"backend.ui.PsychUIDropDownItem.update","backend/ui/PsychUIDropDownMenu.hx",293,0x0f4dd77f)
HX_LOCAL_STACK_FRAME(_hx_pos_4a87544bdb02f918_315_set_label,"backend.ui.PsychUIDropDownItem","set_label",0xfb9cc8dc,"backend.ui.PsychUIDropDownItem.set_label","backend/ui/PsychUIDropDownMenu.hx",315,0x0f4dd77f)
namespace backend{
namespace ui{
...
void PsychUIDropDownItem_obj::__construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< Float >  __o_width){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_4a87544bdb02f918_261_new)
HXLINE( 291)		this->forceNextUpdate = false;
HXLINE( 268)		this->_hx_set_normalStyle(HX_CTX,  ::Dynamic(::hx::Anon_obj::Create(3)
...
HXLINE( 263)		this->_hx_set_hoverStyle(HX_CTX,  ::Dynamic(::hx::Anon_obj::Create(3)
            			->setFixed(0,HX_("bgAlpha",59,b7,bd,ce),( (Float)(1) ))
            			->setFixed(1,HX_("textColor",76,01,4a,e3),-1)
            			->setFixed(2,HX_("bgColor",5e,81,83,f7),-16750849)));
HXLINE( 278)		super::__construct(x,y,null());
HXLINE( 280)		this->_hx_set_bg(HX_CTX,  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(1,1,-1,null(),null()));
HXLINE( 281)		this->bg->setGraphicSize(width,20);
HXLINE( 282)		this->bg->updateHitbox();
HXLINE( 283)		this->add(this->bg);
HXLINE( 285)		this->_hx_set_text(HX_CTX,  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,width,null(),8,null()));
HXLINE( 286)		this->text->set_color(-16777216);
HXLINE( 287)		this->add(this->text);
            	}
...
void PsychUIDropDownItem_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_4a87544bdb02f918_293_update)
HXLINE( 294)		this->super::update(elapsed);
HXLINE( 295)		bool _hx_tmp;
HXDLIN( 295)		bool _hx_tmp1;
HXDLIN( 295)		 ::flixel::input::mouse::FlxMouse _this = ::flixel::FlxG_obj::mouse;
HXDLIN( 295)		bool _hx_tmp2;
HXDLIN( 295)		if ((_this->_prevX == _this->x)) {
HXLINE( 295)			_hx_tmp2 = (_this->_prevY != _this->y);
            		}
            		else {
HXLINE( 295)			_hx_tmp2 = true;
            		}
HXDLIN( 295)		if (!(_hx_tmp2)) {
HXLINE( 295)			_hx_tmp1 = (::flixel::FlxG_obj::mouse->_leftButton->current == 2);
            		}
            		else {
HXLINE( 295)			_hx_tmp1 = true;
            		}
HXDLIN( 295)		if (!(_hx_tmp1)) {
HXLINE( 295)			_hx_tmp = this->forceNextUpdate;
            		}
            		else {
HXLINE( 295)			_hx_tmp = true;
            		}
HXDLIN( 295)		if (_hx_tmp) {
HXLINE( 297)			 ::flixel::input::mouse::FlxMouse overlapped = ::flixel::FlxG_obj::mouse;
HXDLIN( 297)			 ::flixel::FlxSprite overlapped1 = this->bg;
HXDLIN( 297)			bool overlapped2 = overlapped->overlaps(overlapped1,this->get_camera());
HXLINE( 299)			 ::Dynamic style;
HXDLIN( 299)			if (overlapped2) {
HXLINE( 299)				style = this->hoverStyle;
            			}
            			else {
HXLINE( 299)				style = this->normalStyle;
            			}
HXLINE( 300)			this->bg->set_color(( (int)(style->__Field(HX_("bgColor",5e,81,83,f7),::hx::paccDynamic)) ));
HXLINE( 301)			this->text->set_color(( (int)(style->__Field(HX_("textColor",76,01,4a,e3),::hx::paccDynamic)) ));
HXLINE( 302)			this->bg->set_alpha(( (Float)(style->__Field(HX_("bgAlpha",59,b7,bd,ce),::hx::paccDynamic)) ));
HXLINE( 303)			this->forceNextUpdate = false;
HXLINE( 305)			bool _hx_tmp3;
HXDLIN( 305)			if (overlapped2) {
HXLINE( 305)				_hx_tmp3 = (::flixel::FlxG_obj::mouse->_leftButton->current == 2);
            			}
            			else {
HXLINE( 305)				_hx_tmp3 = false;
            			}
HXDLIN( 305)			if (_hx_tmp3) {
HXLINE( 306)				this->onClick();
            			}
            		}
HXLINE( 309)		this->text->set_x(this->bg->x);
HXLINE( 310)		 ::flixel::text::FlxText _hx_tmp4 = this->text;
HXDLIN( 310)		Float _hx_tmp5 = this->bg->y;
HXDLIN( 310)		Float _hx_tmp6 = (_hx_tmp5 + (this->bg->get_height() / ( (Float)(2) )));
HXDLIN( 310)		_hx_tmp4->set_y((_hx_tmp6 - (this->text->get_height() / ( (Float)(2) ))));
            	}


::String PsychUIDropDownItem_obj::set_label(::String v){
            	HX_GC_STACKFRAME(&_hx_pos_4a87544bdb02f918_315_set_label)
HXLINE( 316)		this->_hx_set_label(HX_CTX, v);
HXLINE( 317)		this->text->set_text(v);
HXLINE( 318)		{
HXLINE( 318)			 ::flixel::math::FlxBasePoint this1 = this->bg->scale;
HXDLIN( 318)			this1->set_y((this->text->get_height() + 6));
            		}
HXLINE( 319)		this->bg->updateHitbox();
HXLINE( 320)		return v;
            	}
