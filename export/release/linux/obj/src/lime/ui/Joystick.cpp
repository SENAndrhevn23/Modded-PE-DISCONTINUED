...
HXLINE(  28)		this->_hx_set_onHatMove(HX_CTX,  ::lime::app::_Event_Int_lime_ui_JoystickHatPosition_Void_obj::__alloc( HX_CTX ));
HXLINE(  27)		this->_hx_set_onDisconnect(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE(  26)		this->_hx_set_onButtonUp(HX_CTX,  ::lime::app::_Event_Int_Void_obj::__alloc( HX_CTX ));
HXLINE(  25)		this->_hx_set_onButtonDown(HX_CTX,  ::lime::app::_Event_Int_Void_obj::__alloc( HX_CTX ));
HXLINE(  24)		this->_hx_set_onAxisMove(HX_CTX,  ::lime::app::_Event_Int_Float_Void_obj::__alloc( HX_CTX ));
...
::hx::Val Joystick_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"onHatMove") ) { _hx_set_onHatMove(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Int_lime_ui_JoystickHatPosition_Void >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"onAxisMove") ) { _hx_set_onAxisMove(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Int_Float_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onButtonUp") ) { _hx_set_onButtonUp(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Int_Void >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"onButtonDown") ) { _hx_set_onButtonDown(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Int_Void >()); return inValue; }
