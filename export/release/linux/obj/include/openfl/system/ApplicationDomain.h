...
class HXCPP_CLASS_ATTRIBUTES ApplicationDomain_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::openfl::_hx_system::ApplicationDomain _hx_set_parentDomain(::hx::StackContext *_hx_ctx, ::openfl::_hx_system::ApplicationDomain _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return parentDomain=_hx_v; }
