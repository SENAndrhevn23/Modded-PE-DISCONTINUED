...
::hx::Val RenderContext_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 2:
		...
		break;
	case 3:
		if (HX_FIELD_EQ(inName,"dom") ) { _hx_set_dom(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 4:
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"flash") ) { _hx_set_flash(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"gles2") ) { _hx_set_gles2(HX_CTX_GET,inValue.Cast<  ::lime::_internal::backend::native::NativeOpenGLRenderContext >()); return inValue; }
		if (HX_FIELD_EQ(inName,"gles3") ) { _hx_set_gles3(HX_CTX_GET,inValue.Cast<  ::lime::_internal::backend::native::NativeOpenGLRenderContext >()); return inValue; }
		if (HX_FIELD_EQ(inName,"webgl") ) { _hx_set_webgl(HX_CTX_GET,inValue.Cast<  ::lime::_internal::backend::native::NativeOpenGLRenderContext >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"webgl2") ) { _hx_set_webgl2(HX_CTX_GET,inValue.Cast<  ::lime::_internal::backend::native::NativeOpenGLRenderContext >()); return inValue; }
	...
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"canvas2D") ) { _hx_set_canvas2D(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"attributes") ) { _hx_set_attributes(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
