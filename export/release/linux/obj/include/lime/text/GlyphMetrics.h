			...
			*(void **)__this = GlyphMetrics_obj::_hx_vtable;
{
		...
		inline  ::lime::math::Vector2 _hx_set_advance(::hx::StackContext *_hx_ctx, ::lime::math::Vector2 _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return advance=_hx_v; }
		int height;
		 ::lime::math::Vector2 horizontalBearing;
		inline  ::lime::math::Vector2 _hx_set_horizontalBearing(::hx::StackContext *_hx_ctx, ::lime::math::Vector2 _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return horizontalBearing=_hx_v; }
		 ::lime::math::Vector2 verticalBearing;
		inline  ::lime::math::Vector2 _hx_set_verticalBearing(::hx::StackContext *_hx_ctx, ::lime::math::Vector2 _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return verticalBearing=_hx_v; }
};
