...
HXLINE(  44)		this->_hx_set_json(HX_CTX, vjson);
HXLINE(  45)		this->_hx_set_fileName(HX_CTX, vfileName);
HXLINE(  46)		this->currentLine = 1;
HXLINE(  47)		this->lastSymbolQuoted = false;
HXLINE(  48)		this->pos = 0;
HXLINE(  49)		this->_hx_set_floatRegex(HX_CTX,  ::EReg_obj::__alloc( HX_CTX ,HX_("^-?[0-9]*\\.[0-9]+$",05,05,e4,a1),HX_("",00,00,00,00)));
HXLINE(  50)		this->_hx_set_intRegex(HX_CTX,  ::EReg_obj::__alloc( HX_CTX ,HX_("^-?[0-9]+$",65,12,70,cb),HX_("",00,00,00,00)));
...
HXDLIN(  51)		this->_hx_set_strProcessor(HX_CTX, _hx_tmp);
HXLINE(  52)		this->_hx_set_cache(HX_CTX, ::cpp::VirtualArray_obj::__new());
            	}
...
::hx::Val TJSONParser_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 3:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"json") ) { _hx_set_json(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 5:
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"intRegex") ) { _hx_set_intRegex(HX_CTX_GET,inValue.Cast<  ::EReg >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"floatRegex") ) { _hx_set_floatRegex(HX_CTX_GET,inValue.Cast<  ::EReg >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"currentLine") ) { currentLine=inValue.Cast< int >(); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"strProcessor") ) { _hx_set_strProcessor(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 16:
