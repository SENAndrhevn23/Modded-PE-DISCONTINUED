...
HXLINE(  48)		this->_hx_set_visibilityChanged(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX ));
HXLINE(  42)		this->_hx_set_drawDebugChanged(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX ));
HXLINE(  37)		this->drawDebug = false;
HXLINE(  31)		this->_hx_set_toggleKeys(HX_CTX, ::Array_obj< int >::fromData( _hx_array_data_ec6bb02d_1,3));
...
::hx::Val DebuggerFrontEnd_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"toggleKeys") ) { _hx_set_toggleKeys(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"drawDebugChanged") ) { _hx_set_drawDebugChanged(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal0 >()); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"visibilityChanged") ) { _hx_set_visibilityChanged(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal0 >()); return inValue; }
	}
