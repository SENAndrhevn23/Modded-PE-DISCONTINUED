...
void FlxMouseEvent_obj::__construct( ::Dynamic object, ::Dynamic onMouseDown, ::Dynamic onMouseUp, ::Dynamic onMouseOver, ::Dynamic onMouseOut,bool mouseChildren,bool mouseEnabled,bool pixelPerfect,::Array< int > mouseButtons){
            	HX_GC_STACKFRAME(&_hx_pos_2c0ea66f87a6cfc0_245_new)
HXLINE( 246)		this->_hx_set_object(HX_CTX, ( ( ::flixel::FlxObject)(object) ));
HXLINE( 247)		this->_hx_set_onMouseDown(HX_CTX, onMouseDown);
HXLINE( 248)		this->_hx_set_onMouseUp(HX_CTX, onMouseUp);
HXLINE( 249)		this->_hx_set_onMouseOver(HX_CTX, onMouseOver);
HXLINE( 250)		this->_hx_set_onMouseOut(HX_CTX, onMouseOut);
...
HXDLIN( 254)		this->_hx_set_mouseButtons(HX_CTX, _hx_tmp);
HXLINE( 256)		if (::Std_obj::isOfType(object,::hx::ClassOf< ::flixel::FlxSprite >())) {
HXLINE( 258)			this->_hx_set_sprite(HX_CTX, ( ( ::flixel::FlxSprite)(object) ));
            		}
            	}
...
void FlxMouseEvent_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_2c0ea66f87a6cfc0_263_destroy)
HXLINE( 264)		this->_hx_set_object(HX_CTX, null());
HXLINE( 265)		this->_hx_set_sprite(HX_CTX, null());
HXLINE( 266)		this->_hx_set_onMouseDown(HX_CTX, null());
HXLINE( 267)		this->_hx_set_onMouseUp(HX_CTX, null());
HXLINE( 268)		this->_hx_set_onMouseClick(HX_CTX, null());
HXLINE( 269)		this->_hx_set_onMouseDoubleClick(HX_CTX, null());
HXLINE( 270)		this->_hx_set_onMouseOver(HX_CTX, null());
HXLINE( 271)		this->_hx_set_onMouseOut(HX_CTX, null());
HXLINE( 272)		this->_hx_set_onMouseMove(HX_CTX, null());
HXLINE( 273)		this->_hx_set_onMouseWheel(HX_CTX, null());
HXLINE( 274)		this->_hx_set_mouseButtons(HX_CTX, null());
            	}
...
::hx::Val FlxMouseEvent_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"onMouseUp") ) { _hx_set_onMouseUp(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"onMouseOut") ) { _hx_set_onMouseOut(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"onMouseDown") ) { _hx_set_onMouseDown(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onMouseOver") ) { _hx_set_onMouseOver(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onMouseMove") ) { _hx_set_onMouseMove(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"onMouseClick") ) { _hx_set_onMouseClick(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onMouseWheel") ) { _hx_set_onMouseWheel(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"mouseButtons") ) { _hx_set_mouseButtons(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"mouseChildren") ) { mouseChildren=inValue.Cast< bool >(); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"onMouseDoubleClick") ) { _hx_set_onMouseDoubleClick(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"currentMouseButton") ) { _hx_set_currentMouseButton(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
