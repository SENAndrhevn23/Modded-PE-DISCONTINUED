...
class HXCPP_CLASS_ATTRIBUTES GraphicsPath_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::openfl::_Vector::IntVector _hx_set_commands(::hx::StackContext *_hx_ctx, ::openfl::_Vector::IntVector _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return commands=_hx_v; }
		 ::openfl::_Vector::FloatVector data;
		inline  ::openfl::_Vector::FloatVector _hx_set_data(::hx::StackContext *_hx_ctx, ::openfl::_Vector::FloatVector _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return data=_hx_v; }
		 ::Dynamic winding;
		inline  ::Dynamic _hx_set_winding(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return winding=_hx_v; }
