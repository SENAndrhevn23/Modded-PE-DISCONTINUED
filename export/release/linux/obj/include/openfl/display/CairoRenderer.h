...
class HXCPP_CLASS_ATTRIBUTES CairoRenderer_obj : public  ::openfl::display::DisplayObjectRenderer_obj
{
	...
	public:
		...
		inline  ::lime::utils::ArrayBufferView _hx_set__hx___matrix3(::hx::StackContext *_hx_ctx, ::lime::utils::ArrayBufferView _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___matrix3=_hx_v; }
