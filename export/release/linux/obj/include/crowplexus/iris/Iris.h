...
class HXCPP_CLASS_ATTRIBUTES Iris_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::crowplexus::iris::IrisConfig _hx_set_config(::hx::StackContext *_hx_ctx, ::crowplexus::iris::IrisConfig _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return config=_hx_v; }
		::String get_name();
		::Dynamic get_name_dyn();

		::String scriptCode;
		inline ::String _hx_set_scriptCode(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return scriptCode=_hx_v; }
		 ::crowplexus::hscript::Interp interp;
		inline  ::crowplexus::hscript::Interp _hx_set_interp(::hx::StackContext *_hx_ctx, ::crowplexus::hscript::Interp _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return interp=_hx_v; }
		 ::crowplexus::hscript::Parser parser;
		inline  ::crowplexus::hscript::Parser _hx_set_parser(::hx::StackContext *_hx_ctx, ::crowplexus::hscript::Parser _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return parser=_hx_v; }
		 ::crowplexus::hscript::Expr expr;
		inline  ::crowplexus::hscript::Expr _hx_set_expr(::hx::StackContext *_hx_ctx, ::crowplexus::hscript::Expr _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return expr=_hx_v; }
		::String interpErrStr;
		inline ::String _hx_set_interpErrStr(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return interpErrStr=_hx_v; }
		 ::Dynamic execute();
		::Dynamic execute_dyn();
		...
		virtual void set(::String name, ::Dynamic value,::hx::Null< bool >  allowOverride);
		::Dynamic set_dyn();

		 ::crowplexus::iris::IrisCall call(::String fun,::cpp::VirtualArray args);
		::Dynamic call_dyn();
