...
class HXCPP_CLASS_ATTRIBUTES AssetLibrary_obj : public  ::lime::utils::AssetLibrary_obj
{
	...
	public:
		...
		inline  ::lime::utils::AssetLibrary _hx_set__hx___proxy(::hx::StackContext *_hx_ctx, ::lime::utils::AssetLibrary _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___proxy=_hx_v; }
