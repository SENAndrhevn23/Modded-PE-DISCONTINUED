...
void FlxNode_obj::__construct( ::flixel::math::FlxRect rect, ::flixel::graphics::atlas::FlxAtlas atlas,::hx::Null< bool >  __o_filled,::String __o_key,::hx::Null< bool >  __o_rotated){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_95af95d3889446aa_84_new)
HXLINE(  85)		this->filled = filled;
HXLINE(  86)		this->_hx_set_left(HX_CTX, null());
HXLINE(  87)		this->_hx_set_right(HX_CTX, null());
HXLINE(  88)		this->_hx_set_rect(HX_CTX, rect);
HXLINE(  89)		this->_hx_set_key(HX_CTX, key);
HXLINE(  90)		this->_hx_set_atlas(HX_CTX, atlas);
...
void FlxNode_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_95af95d3889446aa_95_destroy)
HXLINE(  96)		this->_hx_set_key(HX_CTX, null());
HXLINE(  97)		this->_hx_set_left(HX_CTX, null());
HXLINE(  98)		this->_hx_set_right(HX_CTX, null());
HXLINE(  99)		this->_hx_set_rect(HX_CTX, null());
HXLINE( 100)		this->_hx_set_atlas(HX_CTX, null());
            	}
...
::hx::Val FlxNode_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 3:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"left") ) { _hx_set_left(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::atlas::FlxNode >()); return inValue; }
		if (HX_FIELD_EQ(inName,"rect") ) { _hx_set_rect(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxRect >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"right") ) { _hx_set_right(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::atlas::FlxNode >()); return inValue; }
		if (HX_FIELD_EQ(inName,"atlas") ) { _hx_set_atlas(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::atlas::FlxAtlas >()); return inValue; }
