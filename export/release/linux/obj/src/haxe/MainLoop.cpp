...
void MainLoop_obj::sortEvents(){
            	HX_GC_STACKFRAME(&_hx_pos_b562134d2cd5593c_104_sortEvents)
...
HXLINE( 149)						tail->_hx_set_next(HX_CTX, e);
            					}
            					else {
HXLINE( 151)						list = e;
            					}
HXLINE( 152)					e->_hx_set_prev(HX_CTX, tail);
HXLINE( 153)					tail = e;
            				}
            				_hx_goto_5:;
HXLINE( 155)				p = q;
            			}
HXLINE( 157)			tail->_hx_set_next(HX_CTX, null());
...
HXLINE( 160)			insize = (insize * 2);
            		...
            		_hx_goto_2:;
HXLINE( 162)		list->_hx_set_prev(HX_CTX, null());
