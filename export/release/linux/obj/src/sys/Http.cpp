...
HXLINE(  63)			_gthis->_hx_set_responseBytes(HX_CTX, output->getBytes());
HXLINE(  64)			err[0] = true;
HXLINE(  66)			_gthis->_hx_set_onError(HX_CTX, old);
...
HXLINE(  62)		this->_hx_set_onError(HX_CTX,  ::Dynamic(new _hx_Closure_0(err,_gthis,output,old)));
...
HXLINE(  93)		this->_hx_set_responseAsString(HX_CTX, null());
HXLINE(  94)		this->_hx_set_responseBytes(HX_CTX, null());
...
HXLINE( 145)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_9,1));
            						}
            						else {
...
HXLINE( 146)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(boundary)));
            						}
            						else {
...
HXLINE( 147)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_10,1));
            						}
            						else {
...
HXLINE( 148)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_11,1));
            						}
            						else {
...
HXLINE( 149)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            						}
            						else {
...
HXLINE( 150)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_12,1));
            						}
            						else {
...
HXLINE( 151)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_13,1));
            						}
            						else {
...
HXLINE( 152)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_14,1));
            						}
            						else {
...
HXLINE( 153)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1)));
            						}
            						else {
...
HXLINE( 154)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_15,1));
            						}
            						else {
...
HXLINE( 156)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_16,1));
            				}
            				else {
...
HXLINE( 157)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(boundary)));
            				}
            				else {
...
HXLINE( 158)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_17,1));
            				}
            				else {
...
HXLINE( 159)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_18,1));
            				}
            				else {
...
HXLINE( 160)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2)));
            				}
            				else {
...
HXLINE( 161)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_19,1));
            				}
            				else {
...
HXLINE( 162)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3)));
            				}
            				else {
...
HXLINE( 163)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_20,1));
            				}
            				else {
...
HXLINE( 164)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_00b75aa9_21,1));
            				}
            				else {
...
HXLINE( 165)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4)));
            				}
            				else {
...
HXLINE( 205)			this->_hx_set_postBytes(HX_CTX, ::haxe::io::Bytes_obj::ofString(this->postData,null()));
HXLINE( 206)			this->_hx_set_postData(HX_CTX, null());
            		}
...
HXLINE( 380)		this->_hx_set_responseHeaders(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
...
HXLINE( 393)							this->_hx_set_responseHeadersSameKey(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
            						}
...
HXLINE( 416)		this->_hx_set_chunk_size(HX_CTX, null());
HXLINE( 417)		this->_hx_set_chunk_buf(HX_CTX, null());
...
HXLINE( 469)				this->_hx_set_chunk_buf(HX_CTX, null());
            			}
...
HXLINE( 479)					this->_hx_set_chunk_size(HX_CTX, ::Std_obj::parseInt((HX_("0x",48,2a,00,00) + cstr)));
HXLINE( 480)					if (::hx::IsEq( this->chunk_size,0 )) {
HXLINE( 481)						this->_hx_set_chunk_size(HX_CTX, null());
HXLINE( 482)						this->_hx_set_chunk_buf(HX_CTX, null());
...
HXLINE( 494)			this->_hx_set_chunk_buf(HX_CTX, buf->sub(0,len));
HXLINE( 495)			return true;
            		}
HXLINE( 498)		if (::hx::IsGreater( this->chunk_size,len )) {
HXLINE( 499)			 ::sys::Http _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 499)			_hx_tmp1->_hx_set_chunk_size(HX_CTX, (_hx_tmp1->chunk_size - len));
...
HXLINE( 508)			this->_hx_set_chunk_size(HX_CTX, null());
HXLINE( 509)			if ((len == 0)) {
...
HXDLIN( 515)		_hx_tmp2->_hx_set_chunk_size(HX_CTX, (_hx_tmp2->chunk_size - len));
...
::hx::Val Http_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"file") ) { _hx_set_file(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"chunk_buf") ) { _hx_set_chunk_buf(HX_CTX_GET,inValue.Cast<  ::haxe::io::Bytes >()); return inValue; }
		break;
	case 10:
		...
		if (HX_FIELD_EQ(inName,"chunk_size") ) { _hx_set_chunk_size(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"responseHeaders") ) { _hx_set_responseHeaders(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
		break;
	case 22:
		if (HX_FIELD_EQ(inName,"responseHeadersSameKey") ) { _hx_set_responseHeadersSameKey(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
	}
