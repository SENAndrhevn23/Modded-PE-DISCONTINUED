...
void FlxBasePreloader_obj::__construct(::hx::Null< Float >  __o_MinDisplayTime,::Array< ::String > AllowedURLs){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_25_new)
...
HXLINE(  81)		this->_hx_set_siteLockBodyText(HX_CTX, ((((HX_("It appears the website you are using is hosting an unauthorized copy of this game. ",87,c8,8a,0b) + HX_("Storage or redistribution of this content, without the express permission of the ",81,40,12,73)) + HX_("developer or other copyright holder, is prohibited under copyright law.\n\n",69,45,11,95)) + HX_("Thank you for your interest in this game! Please support the developer by ",0c,a9,6a,4f)) + HX_("visiting the following website to play the game:",86,04,f5,9a)));
HXLINE(  71)		this->_hx_set_siteLockTitleText(HX_CTX, HX_("Sorry.",11,94,ca,64));
...
HXLINE( 111)			this->_hx_set_allowedURLs(HX_CTX, AllowedURLs);
            		}
            		else {
HXLINE( 113)			this->_hx_set_allowedURLs(HX_CTX, ::Array_obj< ::String >::__new(0));
            		}
...
void FlxBasePreloader_obj::onInit(){
            	HX_GC_STACKFRAME(&_hx_pos_dc9b83cdd7f291e2_132_onInit)
HXLINE( 133)		this->super::onInit();
HXLINE( 135)		::openfl::Lib_obj::get_current()->stage->set_scaleMode(2);
HXLINE( 136)		::openfl::Lib_obj::get_current()->stage->_hx_set_align(HX_CTX, 6);
...
::hx::Val FlxBasePreloader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"allowedURLs") ) { _hx_set_allowedURLs(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
	...
	case 16:
		...
		if (HX_FIELD_EQ(inName,"siteLockBodyText") ) { _hx_set_siteLockBodyText(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"siteLockTitleText") ) { _hx_set_siteLockTitleText(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	}
