...
void XmlParserException_obj::__construct(::String message,::String xml,int position){
            	HX_GC_STACKFRAME(&_hx_pos_24410f4636548391_75_new)
HXLINE(  76)		this->_hx_set_xml(HX_CTX, xml);
HXLINE(  77)		this->_hx_set_message(HX_CTX, message);
...
::hx::Val XmlParserException_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"xml") ) { _hx_set_xml(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 7:
