...
{
            	HX_GC_STACKFRAME(&_hx_pos_89999802178ac74a_17_new)
HXLINE(  29)		( ( ::flixel::graphics::frames::bmfont::BMFontChar)(__this) )->_hx_set_letter(HX_CTX, null());
...
HXDLIN(  17)			( ( ::flixel::graphics::frames::bmfont::BMFontChar)(__this) )->_hx_set_letter(HX_CTX, letter);
            		}
            	}
		...
		int chnl;
		::String letter;
		inline ::String _hx_set_letter(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return letter=_hx_v; }
};
