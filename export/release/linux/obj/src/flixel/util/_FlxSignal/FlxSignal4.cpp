...
void FlxSignal4_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_024ec818dae5a948_265_new)
HXLINE( 266)		super::__construct();
HXLINE( 267)		this->_hx_set_dispatch(HX_CTX, this->dispatch4_dyn());
            	}
...
void FlxSignal4_obj::dispatch4( ::Dynamic value1, ::Dynamic value2, ::Dynamic value3, ::Dynamic value4){
            	HX_GC_STACKFRAME(&_hx_pos_024ec818dae5a948_293_dispatch4)
