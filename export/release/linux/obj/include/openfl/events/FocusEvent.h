...
class HXCPP_CLASS_ATTRIBUTES FocusEvent_obj : public  ::openfl::events::Event_obj
{
	...
	public:
		...
		inline  ::openfl::display::InteractiveObject _hx_set_relatedObject(::hx::StackContext *_hx_ctx, ::openfl::display::InteractiveObject _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return relatedObject=_hx_v; }
		bool shiftKey;
