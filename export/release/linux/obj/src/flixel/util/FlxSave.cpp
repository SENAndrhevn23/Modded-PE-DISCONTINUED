...
void FlxSave_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_2a670326751daced_121_new)
HXDLIN( 121)		this->_hx_set_status(HX_CTX, ::flixel::util::FlxSaveStatus_obj::EMPTY_dyn());
            	}
...
void FlxSave_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_2a670326751daced_140_destroy)
HXLINE( 141)		this->_hx_set__sharedObject(HX_CTX, null());
HXLINE( 142)		this->_hx_set_status(HX_CTX, ::flixel::util::FlxSaveStatus_obj::EMPTY_dyn());
HXLINE( 143)		this->_hx_set_data(HX_CTX, null());
            	}
...
bool FlxSave_obj::bind(::String name,::String path){
            	HX_GC_STACKFRAME(&_hx_pos_2a670326751daced_158_bind)
...
HXLINE( 167)			this->_hx_set__sharedObject(HX_CTX, ::flixel::util::_FlxSave::FlxSharedObject_obj::getLocal(name,path));
HXLINE( 168)			this->_hx_set_status(HX_CTX, ::flixel::util::FlxSaveStatus_obj::BOUND(name,path));
            		} catch( ::Dynamic _hx_e) {
...
HXLINE( 176)		this->_hx_set_data(HX_CTX, this->_sharedObject->data);
...
bool FlxSave_obj::flush(::hx::Null< int >  __o_minFileSize){
            		int minFileSize = __o_minFileSize.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_2a670326751daced_263_flush)
...
HXLINE( 272)				this->_hx_set_status(HX_CTX, ::flixel::util::FlxSaveStatus_obj::ERROR(HX_("FlxSave is requesting extra storage space.",65,ed,43,59)));
            			}
            		} catch( ::Dynamic _hx_e) {
            			if (_hx_e.IsClass<  ::openfl::errors::Error >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::openfl::errors::Error e = _hx_e;
HXLINE( 276)				this->_hx_set_status(HX_CTX, ::flixel::util::FlxSaveStatus_obj::ERROR(HX_("There was an problem flushing the save data.",31,08,61,29)));
            			}
            			else {
            				HX_STACK_DO_THROW(_hx_e);
            			}
...
bool FlxSave_obj::erase(){
            	HX_GC_STACKFRAME(&_hx_pos_2a670326751daced_292_erase)
HXLINE( 293)		if (!(this->checkStatus())) {
HXLINE( 294)			return false;
            		}
HXLINE( 296)		this->_sharedObject->clear();
HXLINE( 297)		this->_hx_set_data(HX_CTX,  ::Dynamic(::hx::Anon_obj::Create(0)));
...
::hx::Val FlxSave_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"status") ) { _hx_set_status(HX_CTX_GET,inValue.Cast<  ::flixel::util::FlxSaveStatus >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"_sharedObject") ) { _hx_set__sharedObject(HX_CTX_GET,inValue.Cast<  ::openfl::net::SharedObject >()); return inValue; }
	}
