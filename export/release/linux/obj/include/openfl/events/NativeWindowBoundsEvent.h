...
class HXCPP_CLASS_ATTRIBUTES NativeWindowBoundsEvent_obj : public  ::openfl::events::Event_obj
{
	...
	public:
		...
		inline  ::openfl::geom::Rectangle _hx_set_beforeBounds(::hx::StackContext *_hx_ctx, ::openfl::geom::Rectangle _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return beforeBounds=_hx_v; }
		 ::openfl::geom::Rectangle afterBounds;
		inline  ::openfl::geom::Rectangle _hx_set_afterBounds(::hx::StackContext *_hx_ctx, ::openfl::geom::Rectangle _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return afterBounds=_hx_v; }
