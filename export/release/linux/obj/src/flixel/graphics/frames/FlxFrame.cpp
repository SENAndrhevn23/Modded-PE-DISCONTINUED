...
void FlxFrame_obj::__construct( ::flixel::graphics::FlxGraphic parent,::hx::Null< int >  __o_angle,::hx::Null< bool >  __o_flipX,::hx::Null< bool >  __o_flipY,::hx::Null< Float >  __o_duration){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_5df8bdd839d6a258_112_new)
HXLINE( 113)		this->_hx_set_parent(HX_CTX, parent);
...
HXDLIN( 121)		this->_hx_set_sourceSize(HX_CTX, point);
...
HXDLIN( 122)		this->_hx_set_offset(HX_CTX, point1);
HXLINE( 124)		this->_hx_set_blitMatrix(HX_CTX, ::Array_obj< Float >::__new(6));
HXLINE( 125)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 126)			this->_hx_set_tileMatrix(HX_CTX, ::Array_obj< Float >::__new(6));
            		}
            	}
...
HXLINE( 445)			frameToFill->_hx_set_parent(HX_CTX, this->parent);
...
HXLINE( 494)				{
HXLINE( 494)					 ::flixel::math::FlxMatrix _this2 = ::flixel::graphics::frames::FlxFrame_obj::_matrix;
HXDLIN( 494)					_this2->setTo(-(_this2->b),_this2->a,-(_this2->d),_this2->c,-(_this2->ty),_this2->tx);
            				}
...
HXLINE( 499)					{
HXLINE( 499)						 ::flixel::math::FlxMatrix _this3 = ::flixel::graphics::frames::FlxFrame_obj::_matrix;
HXDLIN( 499)						_this3->setTo(_this3->b,-(_this3->a),_this3->d,-(_this3->c),_this3->ty,-(_this3->tx));
            					}
...
HX_DEFINE_DYNAMIC_FUNC2(FlxFrame_obj,subFrameTo,return )
 ...
 ::flixel::graphics::frames::FlxFrame FlxFrame_obj::setBorderTo( ::flixel::math::FlxBasePoint border, ::flixel::graphics::frames::FlxFrame frameToFill){
            	HX_GC_STACKFRAME(&_hx_pos_5df8bdd839d6a258_526_setBorderTo)
...
HXLINE( 529)		frameToFill->_hx_set_name(HX_CTX, this->name);
...
HXLINE( 550)			clippedFrame->_hx_set_parent(HX_CTX, this->parent);
...
HXLINE( 556)		clippedFrame->_hx_set_name(HX_CTX, this->name);
...
HXLINE( 596)				{
HXLINE( 596)					 ::flixel::math::FlxMatrix _this2 = ::flixel::graphics::frames::FlxFrame_obj::_matrix;
HXDLIN( 596)					_this2->setTo(-(_this2->b),_this2->a,-(_this2->d),_this2->c,-(_this2->ty),_this2->tx);
            				}
...
HXLINE( 601)					{
HXLINE( 601)						 ::flixel::math::FlxMatrix _this3 = ::flixel::graphics::frames::FlxFrame_obj::_matrix;
HXDLIN( 601)						_this3->setTo(_this3->b,-(_this3->a),_this3->d,-(_this3->c),_this3->ty,-(_this3->tx));
            					}
...
HXLINE( 635)			clone->_hx_set_parent(HX_CTX, this->parent);
...
HXLINE( 646)		clone->_hx_set_name(HX_CTX, this->name);
...
void FlxFrame_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_5df8bdd839d6a258_652_destroy)
HXLINE( 653)		this->_hx_set_name(HX_CTX, null());
HXLINE( 654)		this->_hx_set_parent(HX_CTX, null());
HXLINE( 655)		this->_hx_set_sourceSize(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->sourceSize)) ));
HXLINE( 656)		this->_hx_set_offset(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->offset)) ));
HXLINE( 657)		this->set_frame(( ( ::flixel::math::FlxRect)(::flixel::util::FlxDestroyUtil_obj::put(this->frame)) ));
HXLINE( 658)		this->_hx_set_uv(HX_CTX, ( ( ::flixel::math::FlxRect)(::flixel::util::FlxDestroyUtil_obj::put(this->uv)) ));
HXLINE( 659)		this->_hx_set_blitMatrix(HX_CTX, null());
HXLINE( 660)		this->_hx_set_tileMatrix(HX_CTX, null());
            	}
...
::String FlxFrame_obj::toString(){
            	HX_GC_STACKFRAME(&_hx_pos_5df8bdd839d6a258_665_toString)
...
HXDLIN( 665)		_this->_hx_set_label(HX_CTX, HX_("name",4b,72,ff,48));
HXDLIN( 665)		_this->_hx_set_value(HX_CTX, value);
...
HX_DEFINE_DYNAMIC_FUNC0(FlxFrame_obj,toString,return )
 ...
 ::flixel::math::FlxRect FlxFrame_obj::set_frame( ::flixel::math::FlxRect value){
            	HX_GC_STACKFRAME(&_hx_pos_5df8bdd839d6a258_669_set_frame)
...
HXDLIN( 673)				this->_hx_set_uv(HX_CTX, rect);
            			}
HXLINE( 675)			{
...
HXLINE( 678)		return (this->_hx_set_frame(HX_CTX, value));
            	}
...
::hx::Val FlxFrame_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 2:
		if (HX_FIELD_EQ(inName,"uv") ) { _hx_set_uv(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxRect >()); return inValue; }
		break;
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"frame") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_frame(inValue.Cast<  ::flixel::math::FlxRect >()) );_hx_set_frame(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxRect >()); return inValue; }
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"parent") ) { _hx_set_parent(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::FlxGraphic >()); return inValue; }
	...
	case 8:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"sourceSize") ) { _hx_set_sourceSize(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		if (HX_FIELD_EQ(inName,"tileMatrix") ) { _hx_set_tileMatrix(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"blitMatrix") ) { _hx_set_blitMatrix(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
	}
