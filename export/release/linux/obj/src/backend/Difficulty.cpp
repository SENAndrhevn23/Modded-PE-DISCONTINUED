...
HXDLIN(  19)			 ::EReg hideChars =  ::EReg_obj::__alloc( HX_CTX ,HX_("[,'\"%?!]",e2,95,ce,be),HX_("g",67,00,00,00));
...
HXDLIN(  19)			 ::EReg hideChars1 =  ::EReg_obj::__alloc( HX_CTX ,HX_("[,'\"%?!]",e2,95,ce,be),HX_("g",67,00,00,00));
...
HXDLIN(  23)		 ::EReg hideChars2 =  ::EReg_obj::__alloc( HX_CTX ,HX_("[,'\"%?!]",e2,95,ce,be),HX_("g",67,00,00,00));
...
void Difficulty_obj::loadFromWeek( ::backend::WeekData week){
            	HX_GC_STACKFRAME(&_hx_pos_3c198266d4e3ce55_27_loadFromWeek)
...
HXLINE(  39)					diffs->setCtx( HX_CTX, i,::StringTools_obj::trim(diffs->__get(i)));
...
HXDLIN(  65)			::backend::Language_obj::phraseStr = ( ( ::haxe::ds::StringMap)(this1) )->get_string(::StringTools_obj::trim(hideChars->replace(::StringTools_obj::replace(key,HX_(" ",20,00,00,00),HX_("_",5f,00,00,00)),HX_("",00,00,00,00)).toLowerCase()));
HXDLIN(  65)			if (::hx::IsNull( ::backend::Language_obj::phraseStr )) {
HXLINE(  65)				::backend::Language_obj::phraseStr = diffName1;
            			}
HXDLIN(  65)			if (::hx::IsNull( ::backend::Language_obj::phraseStr )) {
HXLINE(  65)				::backend::Language_obj::phraseStr = key;
            			}
HXDLIN(  65)			if (::hx::IsNotNull( values )) {
...
HXDLIN(  65)					::backend::Language_obj::phraseStr = ::StringTools_obj::replace(::backend::Language_obj::phraseStr,((HX_("{",7b,00,00,00) + (num1 + 1)) + HX_("}",7d,00,00,00)),( (::String)(value) ));
            				}
            			}
HXDLIN(  65)			return ::backend::Language_obj::phraseStr;
            		}
            		else {
