...
HXLINE(  62)		this->_hx_set__activeGamepads(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  57)		this->_hx_set__gamepads(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE( 326)		this->_hx_set_deviceConnected(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX ));
HXLINE( 327)		this->_hx_set_deviceDisconnected(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX ));
...
void FlxGamepadManager_obj::removeByID(int GamepadID){
            	HX_GC_STACKFRAME(&_hx_pos_dd40c6c1396c027e_81_removeByID)
...
HXLINE(  86)			this->_gamepads->setCtx( HX_CTX, GamepadID,null());
HXLINE(  88)			int i = this->_activeGamepads->indexOf(gamepad,null());
HXLINE(  89)			if ((i != -1)) {
HXLINE(  91)				this->_activeGamepads->setCtx( HX_CTX, i,null());
...
HXLINE(  99)			this->_hx_set_lastActive(HX_CTX, null());
            		}
HXLINE( 101)		if (::hx::IsInstanceEq( this->firstActive,gamepad )) {
HXLINE( 102)			this->_hx_set_firstActive(HX_CTX, null());
            		}
            	}
...
HXLINE( 111)			this->_gamepads->setCtx( HX_CTX, GamepadID,gamepad);
...
HXLINE( 119)						this->_activeGamepads->setCtx( HX_CTX, i,gamepad);
...
HXLINE( 129)		this->_hx_set_lastActive(HX_CTX, gamepad);
HXLINE( 130)		if (::hx::IsNull( this->firstActive )) {
HXLINE( 131)			this->_hx_set_firstActive(HX_CTX, gamepad);
            		}
...
void FlxGamepadManager_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_dd40c6c1396c027e_299_destroy)
HXLINE( 300)		this->_hx_set__gamepads(HX_CTX, ::flixel::util::FlxDestroyUtil_obj::destroyArray(this->_gamepads));
HXLINE( 302)		this->_hx_set_firstActive(HX_CTX, null());
HXLINE( 303)		this->_hx_set_lastActive(HX_CTX, null());
HXLINE( 304)		this->_hx_set__gamepads(HX_CTX, null());
...
void FlxGamepadManager_obj::addGamepad( ::openfl::ui::GameInputDevice Device){
            	HX_GC_STACKFRAME(&_hx_pos_dd40c6c1396c027e_369_addGamepad)
...
HXLINE( 380)		gamepad->_hx_set__device(HX_CTX, Device);
...
::hx::Val FlxGamepadManager_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 9:
		if (HX_FIELD_EQ(inName,"_gamepads") ) { _hx_set__gamepads(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"lastActive") ) { _hx_set_lastActive(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::FlxGamepad >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"firstActive") ) { _hx_set_firstActive(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::FlxGamepad >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"globalDeadZone") ) { _hx_set_globalDeadZone(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"deviceConnected") ) { _hx_set_deviceConnected(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal1 >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_activeGamepads") ) { _hx_set__activeGamepads(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"deviceDisconnected") ) { _hx_set_deviceDisconnected(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal1 >()); return inValue; }
	}
