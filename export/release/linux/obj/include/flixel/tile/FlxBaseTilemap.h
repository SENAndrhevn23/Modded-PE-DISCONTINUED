...
class HXCPP_CLASS_ATTRIBUTES FlxBaseTilemap_obj : public  ::flixel::FlxObject_obj
{
	...
	public:
		...
		inline  ::flixel::tile::FlxTilemapAutoTiling _hx_set__hx_auto(::hx::StackContext *_hx_ctx, ::flixel::tile::FlxTilemapAutoTiling _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx_auto=_hx_v; }
		int widthInTiles;
		int heightInTiles;
		int totalTiles;
		::Array< int > customTileRemap;
		inline ::Array< int > _hx_set_customTileRemap(::hx::StackContext *_hx_ctx,::Array< int > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return customTileRemap=_hx_v; }
		::Array< int > _randomIndices;
		inline ::Array< int > _hx_set__randomIndices(::hx::StackContext *_hx_ctx,::Array< int > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _randomIndices=_hx_v; }
		::Array< ::Dynamic> _randomChoices;
		inline ::Array< ::Dynamic> _hx_set__randomChoices(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _randomChoices=_hx_v; }
		 ::Dynamic _randomLambda;
		inline  ::Dynamic _hx_set__randomLambda(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _randomLambda=_hx_v; }
		Dynamic _randomLambda_dyn() { return _randomLambda;}
		::cpp::VirtualArray _tileObjects;
		inline ::cpp::VirtualArray _hx_set__tileObjects(::hx::StackContext *_hx_ctx,::cpp::VirtualArray _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _tileObjects=_hx_v; }
		int _startingIndex;
		::Array< int > _data;
		inline ::Array< int > _hx_set__data(::hx::StackContext *_hx_ctx,::Array< int > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _data=_hx_v; }
		int _drawIndex;
		int _collideIndex;
