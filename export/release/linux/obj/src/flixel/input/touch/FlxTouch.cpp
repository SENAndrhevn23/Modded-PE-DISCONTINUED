...
HXDLIN(  39)		this->_hx_set_justPressedPosition(HX_CTX, point);
HXLINE(  37)		this->_hx_set_flashPoint(HX_CTX,  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null()));
HXLINE(  68)		super::__construct();
HXLINE(  70)		this->_hx_set_input(HX_CTX,  ::flixel::input::FlxInput_obj::__alloc( HX_CTX ,pointID));
...
void FlxTouch_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_23711c7fa15af2bf_43_destroy)
HXLINE(  44)		this->_hx_set_input(HX_CTX, null());
HXLINE(  45)		this->_hx_set_justPressedPosition(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->justPressedPosition)) ));
HXLINE(  46)		this->_hx_set_flashPoint(HX_CTX, null());
            	}
...
void FlxTouch_obj::recycle(int x,int y,int pointID,Float pressure){
            	HX_GC_STACKFRAME(&_hx_pos_23711c7fa15af2bf_53_recycle)
HXLINE(  54)		this->setXY(x,y);
HXLINE(  55)		this->input->_hx_set_ID(HX_CTX, pointID);
...
void FlxTouch_obj::setXY(int X,int Y){
            	HX_GC_STACKFRAME(&_hx_pos_23711c7fa15af2bf_102_setXY)
HXLINE( 103)		this->flashPoint->setTo(( (Float)(X) ),( (Float)(Y) ));
HXLINE( 104)		this->_hx_set_flashPoint(HX_CTX, ::flixel::FlxG_obj::game->globalToLocal(this->flashPoint));
HXLINE( 106)		{
...
::hx::Val FlxTouch_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"input") ) { _hx_set_input(HX_CTX_GET,inValue.Cast<  ::flixel::input::FlxInput >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"pressure") ) { pressure=inValue.Cast< Float >(); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"flashPoint") ) { _hx_set_flashPoint(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Point >()); return inValue; }
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"justPressedPosition") ) { _hx_set_justPressedPosition(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		break;
	case 22:
