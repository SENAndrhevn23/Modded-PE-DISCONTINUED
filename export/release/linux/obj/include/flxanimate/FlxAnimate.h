...
class HXCPP_CLASS_ATTRIBUTES FlxAnimate_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		inline  ::flxanimate::animate::FlxAnim _hx_set_anim(::hx::StackContext *_hx_ctx, ::flxanimate::animate::FlxAnim _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return anim=_hx_v; }
		...
		inline ::Array< ::Dynamic> _hx_set__symbols(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _symbols=_hx_v; }
		...
		inline  ::flixel::graphics::frames::FlxFrame _hx_set__pivot(::hx::StackContext *_hx_ctx, ::flixel::graphics::frames::FlxFrame _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _pivot=_hx_v; }
		 ::flixel::graphics::frames::FlxFrame _indicator;
		inline  ::flixel::graphics::frames::FlxFrame _hx_set__indicator(::hx::StackContext *_hx_ctx, ::flixel::graphics::frames::FlxFrame _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _indicator=_hx_v; }
		 ::flxanimate::display::FlxAnimateFilterRenderer renderer;
		inline  ::flxanimate::display::FlxAnimateFilterRenderer _hx_set_renderer(::hx::StackContext *_hx_ctx, ::flxanimate::display::FlxAnimateFilterRenderer _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return renderer=_hx_v; }
		 ::flixel::FlxCamera filterCamera;
		inline  ::flixel::FlxCamera _hx_set_filterCamera(::hx::StackContext *_hx_ctx, ::flixel::FlxCamera _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return filterCamera=_hx_v; }
		Float relativeX;
		Float relativeY;
		virtual void loadAtlas(::String Path);
		...
		inline  ::flixel::math::FlxMatrix _hx_set__mat(::hx::StackContext *_hx_ctx, ::flixel::math::FlxMatrix _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _mat=_hx_v; }
