...
void FlxTypedGroup_obj::__construct(::hx::Null< int >  __o_MaxSize){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_bfa1de30d9ec9fbd_22_new)
HXLINE(  89)		this->_marker = 0;
HXLINE(  62)		this->length = 0;
HXLINE(  96)		super::__construct();
HXLINE(  98)		this->_hx_set_members(HX_CTX, ::cpp::VirtualArray_obj::__new(0));
...
void FlxTypedGroup_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_bfa1de30d9ec9fbd_114_destroy)
...
HXLINE( 133)			this->_hx_set_members(HX_CTX, null());
            		}
            	}
...
HXLINE( 906)			this->_hx_set__memberAdded(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX ));
            		}
...
HXLINE( 915)			this->_hx_set__memberRemoved(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX ));
            		}
...
::hx::Val FlxTypedGroup_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"_memberAdded") ) { _hx_set__memberAdded(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal1 >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"_memberRemoved") ) { _hx_set__memberRemoved(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal1 >()); return inValue; }
	}
