...
void FlxSharedObject_obj::clear(){
            	HX_GC_STACKFRAME(&_hx_pos_6b726de06a800834_639_clear)
HXLINE( 640)		this->_hx_set_data(HX_CTX,  ::Dynamic(::hx::Anon_obj::Create(0)));
HXLINE( 642)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
HXLINE( 453)			sharedObject->_hx_set_data(HX_CTX,  ::Dynamic(::hx::Anon_obj::Create(0)));
HXLINE( 454)			sharedObject->_hx_set__hx___localPath(HX_CTX, localPath);
HXLINE( 455)			sharedObject->_hx_set__hx___name(HX_CTX, name);
...
HXLINE( 464)					sharedObject->_hx_set_data(HX_CTX, unserializer->unserialize());
            				} catch( ::Dynamic _hx_e) {
            					if (_hx_e.IsClass<  ::Dynamic >() ){
            						HX_STACK_BEGIN_CATCH
            						 ::Dynamic _g1 = _hx_e;
