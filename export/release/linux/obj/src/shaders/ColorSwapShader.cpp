...
HX_DEFINE_STACK_FRAME(_hx_pos_fe79ca0ba5a76a7b_211_new,"shaders.ColorSwapShader","new",0x3cfee0ed,"shaders.ColorSwapShader.new","shaders/ColorSwap.hx",211,0xb3f18f49)
namespace shaders{

void ColorSwapShader_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_fe79ca0ba5a76a7b_211_new)
...
HXLINE(  34)		this->_hx___isGenerated = true;
HXDLIN(  34)		this->_hx___initGL();
            	}
...
::hx::Val ColorSwapShader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"awesomeOutline") ) { _hx_set_awesomeOutline(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Bool >()); return inValue; }
	}
