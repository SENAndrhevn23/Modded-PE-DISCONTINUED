...
HX_DEFINE_STACK_FRAME(_hx_pos_dc7d927db8215320_5_new,"mikolka.stages.standard.MallEvil","new",0x0a52d81e,"mikolka.stages.standard.MallEvil.new","mikolka/stages/standard/MallEvil.hx",5,0x9a47c4d1)
HX_LOCAL_STACK_FRAME(_hx_pos_dc7d927db8215320_8_create,"mikolka.stages.standard.MallEvil","create",0x998549fe,"mikolka.stages.standard.MallEvil.create","mikolka/stages/standard/MallEvil.hx",8,0x9a47c4d1)
HX_LOCAL_STACK_FRAME(_hx_pos_dc7d927db8215320_49_winterHorrorlandCutscene,"mikolka.stages.standard.MallEvil","winterHorrorlandCutscene",0x4afdac26,"mikolka.stages.standard.MallEvil.winterHorrorlandCutscene","mikolka/stages/standard/MallEvil.hx",49,0x9a47c4d1)
HX_LOCAL_STACK_FRAME(_hx_pos_dc7d927db8215320_61_winterHorrorlandCutscene,"mikolka.stages.standard.MallEvil","winterHorrorlandCutscene",0x4afdac26,"mikolka.stages.standard.MallEvil.winterHorrorlandCutscene","mikolka/stages/standard/MallEvil.hx",61,0x9a47c4d1)
HX_LOCAL_STACK_FRAME(_hx_pos_dc7d927db8215320_55_winterHorrorlandCutscene,"mikolka.stages.standard.MallEvil","winterHorrorlandCutscene",0x4afdac26,"mikolka.stages.standard.MallEvil.winterHorrorlandCutscene","mikolka/stages/standard/MallEvil.hx",55,0x9a47c4d1)
HX_LOCAL_STACK_FRAME(_hx_pos_dc7d927db8215320_33_winterHorrorlandCutscene,"mikolka.stages.standard.MallEvil","winterHorrorlandCutscene",0x4afdac26,"mikolka.stages.standard.MallEvil.winterHorrorlandCutscene","mikolka/stages/standard/MallEvil.hx",33,0x9a47c4d1)
namespace mikolka{
namespace stages{
namespace standard{

void MallEvil_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_dc7d927db8215320_5_new)
...
void MallEvil_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_dc7d927db8215320_8_create)
...
HXLINE(  24)			if ((( ( ::states::PlayState)(::flixel::FlxG_obj::game->_state) )->songName == HX_("winter-horrorland",9d,39,f4,1e))) {
...
void MallEvil_obj::winterHorrorlandCutscene(){
            		HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_0, ::mikolka::stages::standard::MallEvil,_gthis, ::flixel::FlxSprite,blackScreen2) HXARGC(1)
            		void _hx_run( ::flixel::tweens::FlxTween twn){
            			HX_GC_STACKFRAME(&_hx_pos_dc7d927db8215320_49_winterHorrorlandCutscene)
HXLINE(  49)			_gthis->remove(blackScreen2,null());
            		}
            		HX_END_LOCAL_FUNC1((void))

            		HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_2, ::mikolka::stages::standard::MallEvil,_gthis) HXARGC(1)
            		void _hx_run( ::flixel::util::FlxTimer tmr){
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_1, ::mikolka::stages::standard::MallEvil,_gthis) HXARGC(1)
            			void _hx_run( ::flixel::tweens::FlxTween twn){
            				HX_GC_STACKFRAME(&_hx_pos_dc7d927db8215320_61_winterHorrorlandCutscene)
HXLINE(  61)				_gthis->startCountdown();
            			}
            			HX_END_LOCAL_FUNC1((void))

            			HX_GC_STACKFRAME(&_hx_pos_dc7d927db8215320_55_winterHorrorlandCutscene)
HXLINE(  56)			( ( ::states::PlayState)(::flixel::FlxG_obj::game->_state) )->camHUD->set_visible(true);
HXLINE(  57)			::flixel::tweens::FlxTween_obj::tween(::flixel::FlxG_obj::camera, ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("zoom",13,a3,f8,50),( ( ::states::PlayState)(::flixel::FlxG_obj::game->_state) )->defaultCamZoom)),((Float)2.5), ::Dynamic(::hx::Anon_obj::Create(2)
            	...
            	HX_GC_STACKFRAME(&_hx_pos_dc7d927db8215320_33_winterHorrorlandCutscene)
HXDLIN(  33)		 ::mikolka::stages::standard::MallEvil _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(  34)		( ( ::states::PlayState)(::flixel::FlxG_obj::game->_state) )->camHUD->set_visible(false);
HXLINE(  35)		( ( ::states::PlayState)(::flixel::FlxG_obj::game->_state) )->inCutscene = true;
...
::hx::ObjectPtr< MallEvil_obj > MallEvil_obj::__alloc(::hx::Ctx *_hx_ctx) {
	MallEvil_obj *__this = (MallEvil_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(MallEvil_obj), true, "mikolka.stages.standard.MallEvil"));
...
void MallEvil_obj::__register()
{
	...
	__mClass->mName = HX_("mikolka.stages.standard.MallEvil",2c,31,09,3b);
