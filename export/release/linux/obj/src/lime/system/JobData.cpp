...
void JobData_obj::__construct( ::Dynamic doWork, ::Dynamic state, ::Dynamic id){
            	HX_GC_STACKFRAME(&_hx_pos_1b59eeda1eb9bd15_285_new)
...
HXLINE( 325)		this->_hx_set_doWork(HX_CTX, doWork);
HXLINE( 326)		this->_hx_set_state(HX_CTX, state);
            	}
...
::hx::Val JobData_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 2:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"state") ) { _hx_set_state(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"doWork") ) { _hx_set_doWork(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 8:
