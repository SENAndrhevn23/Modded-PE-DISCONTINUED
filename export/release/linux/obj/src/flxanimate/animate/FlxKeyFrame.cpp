...
HXLINE(  53)		this->_hx_set_clTMat(HX_CTX,  ::flixel::math::FlxMatrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
...
HXDLIN(  64)		this->_hx_set__elements(HX_CTX, _hx_tmp);
HXLINE(  65)		this->set_colorEffect(colorEffect);
HXLINE(  66)		this->_hx_set_callbacks(HX_CTX, ::cpp::VirtualArray_obj::__new(0));
HXLINE(  67)		this->_hx_set__bitmapMatrix(HX_CTX,  ::flixel::math::FlxMatrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
            	}
...
::Array< ::Dynamic> FlxKeyFrame_obj::set_filters(::Array< ::Dynamic> value){
            	HX_GC_STACKFRAME(&_hx_pos_03816aded6b39d0f_83_set_filters)
...
HXLINE(  87)		return (this->_hx_set_filters(HX_CTX, value));
            	}
...
HX_DEFINE_DYNAMIC_FUNC4(FlxKeyFrame_obj,updateRender,(void))
 ...
 ::Dynamic FlxKeyFrame_obj::add( ::Dynamic element){
            	HX_GC_STACKFRAME(&_hx_pos_03816aded6b39d0f_125_add)
...
HXLINE( 134)			element1->_hx_set__parent(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
...
void FlxKeyFrame_obj::removeCallbacks(){
            	HX_GC_STACKFRAME(&_hx_pos_03816aded6b39d0f_190_removeCallbacks)
HXDLIN( 190)		this->_hx_set_callbacks(HX_CTX, ::cpp::VirtualArray_obj::__new(0));
            	}
...
HXLINE( 195)		keyframe->_hx_set_callbacks(HX_CTX, this->callbacks);
...
void FlxKeyFrame_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_03816aded6b39d0f_200_destroy)
HXLINE( 201)		this->_hx_set__parent(HX_CTX, null());
HXLINE( 202)		this->set_name(null());
HXLINE( 203)		this->set_index(0);
HXLINE( 204)		this->set_duration(0);
HXLINE( 205)		this->_hx_set_callbacks(HX_CTX, null());
...
HX_DEFINE_DYNAMIC_FUNC0(FlxKeyFrame_obj,toString,return )
 ...
 ::flxanimate::effects::FlxColorEffect FlxKeyFrame_obj::set_colorEffect( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_03816aded6b39d0f_218_set_colorEffect)
...
HXLINE( 222)			this->_hx_set_colorEffect(HX_CTX, ::flxanimate::data::AnimationData_obj::parseColorEffect(value));
            		}
            		else {
HXLINE( 224)			this->_hx_set_colorEffect(HX_CTX, ( ( ::flxanimate::effects::FlxColorEffect)(value) ));
            		}
...
::String FlxKeyFrame_obj::set_name(::String name){
            	HX_GC_STACKFRAME(&_hx_pos_03816aded6b39d0f_240_set_name)
...
HXLINE( 247)		return (this->_hx_set_name(HX_CTX, name));
            	}
...
bool FlxKeyFrame_obj::set_classicTween(bool value){
            	HX_GC_STACKFRAME(&_hx_pos_03816aded6b39d0f_250_set_classicTween)
...
HXDLIN( 254)			this->_hx_set__tFrame(HX_CTX, _hx_tmp);
            		}
...
::hx::Val FlxKeyFrame_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"clTMat") ) { _hx_set_clTMat(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxMatrix >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"_tFrame") ) { _hx_set__tFrame(HX_CTX_GET,inValue.Cast<  ::flxanimate::animate::FlxKeyFrame >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_parent") ) { _hx_set__parent(HX_CTX_GET,inValue.Cast<  ::flxanimate::animate::FlxLayer >()); return inValue; }
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"callbacks") ) { _hx_set_callbacks(HX_CTX_GET,inValue.Cast< ::cpp::VirtualArray >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_elements") ) { _hx_set__elements(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	...
	case 12:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"_bitmapMatrix") ) { _hx_set__bitmapMatrix(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxMatrix >()); return inValue; }
		break;
	case 14:
