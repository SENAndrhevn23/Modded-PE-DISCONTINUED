...
class HXCPP_CLASS_ATTRIBUTES Paths_obj : public ::hx::Object
{
	...
	public:
		...
		static ::cpp::VirtualArray defaultNoteStuff;
		static ::String defaultPath;
		static ::String defaultSkin;
		static  ::flixel::FlxSprite defaultNoteSprite;
		static  ::haxe::ds::StringMap noteSkinFramesMap;
		static  ::haxe::ds::StringMap noteSkinAnimsMap;
		static  ::haxe::ds::StringMap popUpFramesMap;
		static  ::flixel::graphics::frames::FlxFramesCollection splashFrames;
		static  ::flixel::animation::FlxAnimationController splashAnimation;
		...
		static void initDefaultSkin(::String noteSkin, ::Dynamic inEditor);
		static ::Dynamic initDefaultSkin_dyn();

		static void initNote(::String noteSkin);
		static ::Dynamic initNote_dyn();
		...
		static ::String formatToSongPlainPath(::String path);
		static ::Dynamic formatToSongPlainPath_dyn();
		...
		static ::String findFile(::String key);
		static ::Dynamic findFile_dyn();

		static ::String findNode(::String dir,::String key);
		...
		static ::Array< ::String > readDirectory(::String directory);
