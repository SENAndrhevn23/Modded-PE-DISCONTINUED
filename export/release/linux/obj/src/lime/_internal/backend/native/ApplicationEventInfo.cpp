...
HX_DEFINE_STACK_FRAME(_hx_pos_1a94701d58bd3d3e_674_new,"lime._internal.backend.native.ApplicationEventInfo","new",0xb35cdd3c,"lime._internal.backend.native.ApplicationEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",674,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_1a94701d58bd3d3e_681_clone,"lime._internal.backend.native.ApplicationEventInfo","clone",0x996e0f39,"lime._internal.backend.native.ApplicationEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",681,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void ApplicationEventInfo_obj::__construct( ::Dynamic type,::hx::Null< int >  __o_deltaTime){
            	...
            	HX_STACKFRAME(&_hx_pos_1a94701d58bd3d3e_674_new)
HXLINE( 675)		this->type = ( (int)(type) );
HXLINE( 676)		this->deltaTime = deltaTime;
            	}
...
bool ApplicationEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::ApplicationEventInfo ApplicationEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_1a94701d58bd3d3e_681_clone)
HXDLIN( 681)		return  ::lime::_internal::backend::native::ApplicationEventInfo_obj::__alloc( HX_CTX ,this->type,this->deltaTime);
            	}
