...
void ImageBuffer_obj::__construct( ::lime::utils::ArrayBufferView data,::hx::Null< int >  __o_width,::hx::Null< int >  __o_height,::hx::Null< int >  __o_bitsPerPixel, ::Dynamic format){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_890299056ccc780d_110_new)
HXLINE( 111)		this->_hx_set_data(HX_CTX, data);
...
HXDLIN( 175)					_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN( 175)						_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN( 175)								_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN( 175)								_this3->_hx_set_buffer(HX_CTX, bytes);
...
HXDLIN( 175)			buffer->_hx_set_data(HX_CTX, this1);
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(ImageBuffer_obj,get_src,return )
 ...
 ::Dynamic ImageBuffer_obj::set_src( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_890299056ccc780d_200_set_src)
HXLINE( 214)		this->_hx_set__hx___srcCustom(HX_CTX, value);
...
::hx::Val ImageBuffer_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"__srcImage") ) { _hx_set__hx___srcImage(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"transparent") ) { transparent=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__srcCanvas") ) { _hx_set__hx___srcCanvas(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"__srcContext") ) { _hx_set__hx___srcContext(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"premultiplied") ) { premultiplied=inValue.Cast< bool >(); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"__srcImageData") ) { _hx_set__hx___srcImageData(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"__srcBitmapData") ) { _hx_set__hx___srcBitmapData(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
