...
class HXCPP_CLASS_ATTRIBUTES StyleSheet_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		inline ::Array< ::String > _hx_set__hx___styleNames(::hx::StackContext *_hx_ctx,::Array< ::String > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___styleNames=_hx_v; }
		bool _hx___styleNamesDirty;
		 ::haxe::ds::StringMap _hx___styles;
		inline  ::haxe::ds::StringMap _hx_set__hx___styles(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___styles=_hx_v; }
		void clear();
		::Dynamic clear_dyn();
