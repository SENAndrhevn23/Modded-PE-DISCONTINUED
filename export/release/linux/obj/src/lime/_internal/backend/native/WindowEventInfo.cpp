...
HX_DEFINE_STACK_FRAME(_hx_pos_d8a53269ce4a50a3_991_new,"lime._internal.backend.native.WindowEventInfo","new",0x4cd621b8,"lime._internal.backend.native.WindowEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",991,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_d8a53269ce4a50a3_1002_clone,"lime._internal.backend.native.WindowEventInfo","clone",0x771e6ab5,"lime._internal.backend.native.WindowEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",1002,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void WindowEventInfo_obj::__construct( ::Dynamic type,::hx::Null< int >  __o_windowID,::hx::Null< int >  __o_width,::hx::Null< int >  __o_height,::hx::Null< int >  __o_x,::hx::Null< int >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_d8a53269ce4a50a3_991_new)
HXLINE( 992)		this->type = ( (int)(type) );
HXLINE( 993)		this->windowID = windowID;
HXLINE( 994)		this->width = width;
HXLINE( 995)		this->height = height;
HXLINE( 996)		this->x = x;
HXLINE( 997)		this->y = y;
            	}
...
bool WindowEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::WindowEventInfo WindowEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_d8a53269ce4a50a3_1002_clone)
HXDLIN(1002)		return  ::lime::_internal::backend::native::WindowEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->width,this->height,this->x,this->y);
            	}
