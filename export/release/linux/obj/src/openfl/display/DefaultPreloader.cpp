...
HXLINE( 139)		this->_hx_set_outline(HX_CTX,  ::openfl::display::Shape_obj::__alloc( HX_CTX ));
...
HXLINE( 147)		this->_hx_set_progress(HX_CTX,  ::openfl::display::Shape_obj::__alloc( HX_CTX ));
...
::hx::Val DefaultPreloader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"outline") ) { _hx_set_outline(HX_CTX_GET,inValue.Cast<  ::openfl::display::Shape >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"progress") ) { _hx_set_progress(HX_CTX_GET,inValue.Cast<  ::openfl::display::Shape >()); return inValue; }
		break;
	case 12:
