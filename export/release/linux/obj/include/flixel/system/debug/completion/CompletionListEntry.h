...
class HXCPP_CLASS_ATTRIBUTES CompletionListEntry_obj : public  ::openfl::display::Sprite_obj
{
	...
	public:
		...
		inline  ::openfl::display::Bitmap _hx_set_background(::hx::StackContext *_hx_ctx, ::openfl::display::Bitmap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return background=_hx_v; }
		 ::openfl::text::TextField label;
		inline  ::openfl::text::TextField _hx_set_label(::hx::StackContext *_hx_ctx, ::openfl::text::TextField _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return label=_hx_v; }
