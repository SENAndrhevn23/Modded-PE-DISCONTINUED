...
void Expr_obj::__construct( ::crowplexus::hscript::ExprDef e,int pmin,int pmax,::String origin,int line){
            	HX_GC_STACKFRAME(&_hx_pos_2f90f74ce626e589_38_new)
HXDLIN(  38)		this->_hx_set_e(HX_CTX, e);
HXDLIN(  38)		this->pmin = pmin;
HXDLIN(  38)		this->pmax = pmax;
HXDLIN(  38)		this->_hx_set_origin(HX_CTX, origin);
...
::hx::Val Expr_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
		if (HX_FIELD_EQ(inName,"e") ) { _hx_set_e(HX_CTX_GET,inValue.Cast<  ::crowplexus::hscript::ExprDef >()); return inValue; }
		break;
	case 4:
