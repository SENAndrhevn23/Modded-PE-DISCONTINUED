...
void Certificate_obj::__construct( ::Dynamic x, ::sys::ssl::Certificate h){
            	HX_GC_STACKFRAME(&_hx_pos_0462ffd2dbc17767_33_new)
HXLINE(  34)		this->_hx_set__hx___x(HX_CTX, x);
HXLINE(  35)		this->_hx_set__hx___h(HX_CTX, h);
            	}
...
::hx::Val Certificate_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"__h") ) { _hx_set__hx___h(HX_CTX_GET,inValue.Cast<  ::sys::ssl::Certificate >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__x") ) { _hx_set__hx___x(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
