...
HX_DEFINE_STACK_FRAME(_hx_pos_52f3c7f247919dae_3_new,"shaders.ColorSwap","new",0xfcc2faa8,"shaders.ColorSwap.new","shaders/ColorSwap.hx",3,0xb3f18f49)
...
HX_LOCAL_STACK_FRAME(_hx_pos_52f3c7f247919dae_9_set_hue,"shaders.ColorSwap","set_hue",0xc2eb98a3,"shaders.ColorSwap.set_hue","shaders/ColorSwap.hx",9,0xb3f18f49)
HX_LOCAL_STACK_FRAME(_hx_pos_52f3c7f247919dae_15_set_saturation,"shaders.ColorSwap","set_saturation",0x7e7b2f47,"shaders.ColorSwap.set_saturation","shaders/ColorSwap.hx",15,0xb3f18f49)
HX_LOCAL_STACK_FRAME(_hx_pos_52f3c7f247919dae_21_set_brightness,"shaders.ColorSwap","set_brightness",0xed4ae946,"shaders.ColorSwap.set_brightness","shaders/ColorSwap.hx",21,0xb3f18f49)
namespace shaders{

void ColorSwap_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_52f3c7f247919dae_3_new)
HXLINE(   7)		this->brightness = ((Float)0);
HXLINE(   6)		this->saturation = ((Float)0);
HXLINE(   5)		this->hue = ((Float)0);
HXLINE(   4)		this->_hx_set_shader(HX_CTX,  ::shaders::ColorSwapShader_obj::__alloc( HX_CTX ));
HXLINE(  29)		this->shader->uTime->_hx_set_value(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_453ec6b6_1,3));
HXLINE(  30)		this->shader->awesomeOutline->_hx_set_value(HX_CTX, ::Array_obj< bool >::fromData( _hx_array_data_453ec6b6_2,1));
            	}
...
Float ColorSwap_obj::set_hue(Float value){
            	HX_STACKFRAME(&_hx_pos_52f3c7f247919dae_9_set_hue)
HXLINE(  10)		this->hue = value;
HXLINE(  11)		this->shader->uTime->value[0] = this->hue;
HXLINE(  12)		return this->hue;
            	}
...
Float ColorSwap_obj::set_saturation(Float value){
            	HX_STACKFRAME(&_hx_pos_52f3c7f247919dae_15_set_saturation)
HXLINE(  16)		this->saturation = value;
HXLINE(  17)		this->shader->uTime->value[1] = this->saturation;
HXLINE(  18)		return this->saturation;
            	}
...
Float ColorSwap_obj::set_brightness(Float value){
            	HX_STACKFRAME(&_hx_pos_52f3c7f247919dae_21_set_brightness)
HXLINE(  22)		this->brightness = value;
HXLINE(  23)		this->shader->uTime->value[2] = this->brightness;
HXLINE(  24)		return this->brightness;
            	}
...
::hx::Val ColorSwap_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 3:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"shader") ) { _hx_set_shader(HX_CTX_GET,inValue.Cast<  ::shaders::ColorSwapShader >()); return inValue; }
		break;
	case 10:
