...
HXLINE(  60)		this->_hx_set_element(HX_CTX, element);
HXLINE(  86)		this->_hx_set__hx___clipRects(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE(  87)		this->_hx___numClipRects = 0;
HXLINE(  88)		this->_hx___z = 0;
HXLINE(  91)		this->_hx_set__hx___type(HX_CTX, HX_("dom",82,42,4c,00));
HXLINE(  94)		this->_hx_set__hx___canvasRenderer(HX_CTX,  ::openfl::display::CanvasRenderer_obj::__alloc( HX_CTX ,null()));
...
void DOMRenderer_obj::_hx___popMaskRect(){
            	HX_GC_STACKFRAME(&_hx_pos_6e05dc14770b0678_223___popMaskRect)
HXDLIN( 223)		if ((this->_hx___numClipRects > 0)) {
HXLINE( 225)			this->_hx___numClipRects--;
HXLINE( 227)			if ((this->_hx___numClipRects > 0)) {
HXLINE( 229)				this->_hx_set__hx___currentClipRect(HX_CTX, this->_hx___clipRects->__get((this->_hx___numClipRects - 1)).StaticCast<  ::openfl::geom::Rectangle >());
            			}
            			else {
HXLINE( 233)				this->_hx_set__hx___currentClipRect(HX_CTX, null());
            			}
            		}
            	}
...
HXLINE( 264)			this->_hx___clipRects->setCtx( HX_CTX, this->_hx___numClipRects, ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
            		}
...
HXLINE( 286)		this->_hx_set__hx___currentClipRect(HX_CTX, clipRect);
...
void DOMRenderer_obj::_hx___setBlendMode( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_6e05dc14770b0678_383___setBlendMode)
...
HXLINE( 387)		this->_hx_set__hx___blendMode(HX_CTX, value);
            	}
...
HXLINE( 463)			displayObject->_hx_set__hx___worldClip(HX_CTX, null());
            		}
            		else {
HXLINE( 467)			if (::hx::IsNull( displayObject->_hx___worldClip )) {
HXLINE( 469)				displayObject->_hx_set__hx___worldClip(HX_CTX,  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
            			}
...
::hx::Val DOMRenderer_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 14:
		...
		if (HX_FIELD_EQ(inName,"__vendorPrefix") ) { _hx_set__hx___vendorPrefix(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"__canvasRenderer") ) { _hx_set__hx___canvasRenderer(HX_CTX_GET,inValue.Cast<  ::openfl::display::CanvasRenderer >()); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"__currentClipRect") ) { _hx_set__hx___currentClipRect(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"__transformProperty") ) { _hx_set__hx___transformProperty(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 25:
		if (HX_FIELD_EQ(inName,"__transformOriginProperty") ) { _hx_set__hx___transformOriginProperty(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	}
