...
HXLINE( 173)		this->_hx_set__filledBarPoint(HX_CTX,  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null()));
HXLINE( 174)		this->_hx_set__filledBarRect(HX_CTX,  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
HXLINE( 175)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE( 177)			this->_hx_set__zeroOffset(HX_CTX,  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null()));
HXLINE( 178)			this->_hx_set__emptyBarRect(HX_CTX,  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
...
HXDLIN( 183)			this->_hx_set__filledFlxRect(HX_CTX, rect);
            		}
HXLINE( 186)		if (::hx::IsNotNull( parentRef )) {
HXLINE( 188)			this->_hx_set_parent(HX_CTX, parentRef);
HXLINE( 189)			this->_hx_set_parentVariable(HX_CTX, variable);
            		}
...
void FlxBar_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_29953dbeb33e4775_198_destroy)
HXLINE( 199)		this->_hx_set_positionOffset(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->positionOffset)) ));
HXLINE( 201)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 203)			this->set_frontFrames(null());
HXLINE( 204)			this->_hx_set__filledFlxRect(HX_CTX, ( ( ::flixel::math::FlxRect)(::flixel::util::FlxDestroyUtil_obj::put(this->_filledFlxRect)) ));
            		}
            		else {
HXLINE( 208)			this->_hx_set__emptyBarRect(HX_CTX, null());
HXLINE( 209)			this->_hx_set__zeroOffset(HX_CTX, null());
HXLINE( 210)			this->_hx_set__emptyBar(HX_CTX, ::flixel::util::FlxDestroyUtil_obj::dispose(this->_emptyBar));
HXLINE( 211)			this->_hx_set__filledBar(HX_CTX, ::flixel::util::FlxDestroyUtil_obj::dispose(this->_filledBar));
            		}
HXLINE( 213)		this->_hx_set__filledBarRect(HX_CTX, null());
HXLINE( 214)		this->_hx_set__filledBarPoint(HX_CTX, null());
HXLINE( 216)		this->_hx_set_parent(HX_CTX, null());
HXLINE( 217)		this->_hx_set_emptyCallback(HX_CTX, null());
HXLINE( 218)		this->_hx_set_filledCallback(HX_CTX, null());
HXLINE( 220)		this->super::destroy();
            	}


void FlxBar_obj::trackParent(int offsetX,int offsetY){
            	HX_GC_STACKFRAME(&_hx_pos_29953dbeb33e4775_233_trackParent)
...
HXDLIN( 235)		this->_hx_set_positionOffset(HX_CTX, point);
...
void FlxBar_obj::setParent( ::Dynamic parentRef,::String variable,::hx::Null< bool >  __o_track,::hx::Null< int >  __o_offsetX,::hx::Null< int >  __o_offsetY){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_29953dbeb33e4775_254_setParent)
HXLINE( 255)		this->_hx_set_parent(HX_CTX, parentRef);
HXLINE( 256)		this->_hx_set_parentVariable(HX_CTX, variable);
HXLINE( 258)		if (track) {
...
void FlxBar_obj::setCallbacks( ::Dynamic onEmpty, ::Dynamic onFilled,::hx::Null< bool >  __o_killOnEmpty){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_29953dbeb33e4775_289_setCallbacks)
...
HXDLIN( 290)		this->_hx_set_emptyCallback(HX_CTX, _hx_tmp);
...
HXDLIN( 291)		this->_hx_set_filledCallback(HX_CTX, _hx_tmp1);
...
HXLINE( 382)				this->_hx_set__emptyBar(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->barWidth,this->barHeight,true,border));
...
HXLINE( 387)				this->_hx_set__emptyBar(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->barWidth,this->barHeight,true,empty));
            			}
...
HXLINE( 435)				this->_hx_set__filledBar(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->barWidth,this->barHeight,true,border));
...
HXLINE( 440)				this->_hx_set__filledBar(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->barWidth,this->barHeight,true,fill));
            			}
...
HXLINE( 519)				this->_hx_set__emptyBar(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->barWidth,this->barHeight,true,border));
...
HXLINE( 524)				this->_hx_set__emptyBar(HX_CTX, ::flixel::util::FlxGradient_obj::createGradientBitmapData(this->barWidth,this->barHeight,empty,chunkSize,rotation,null()));
            			}
...
HXLINE( 584)				this->_hx_set__filledBar(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->barWidth,this->barHeight,true,border));
...
HXLINE( 589)				this->_hx_set__filledBar(HX_CTX, ::flixel::util::FlxGradient_obj::createGradientBitmapData(this->barWidth,this->barHeight,fill,chunkSize,rotation,null()));
            			}
...
HX_DEFINE_DYNAMIC_FUNC4(FlxBar_obj,createImageBar,return )
 ...
 ::flixel::ui::FlxBar FlxBar_obj::createImageEmptyBar( ::Dynamic empty,::hx::Null< int >  __o_emptyBackground){
            		int emptyBackground = __o_emptyBackground.Default(-16777216);
            	HX_GC_STACKFRAME(&_hx_pos_29953dbeb33e4775_627_createImageEmptyBar)
...
HXLINE( 638)				this->_hx_set__emptyBar(HX_CTX, emptyGraphic->bitmap->clone());
...
HX_DEFINE_DYNAMIC_FUNC2(FlxBar_obj,createImageEmptyBar,return )
 ...
 ::flixel::ui::FlxBar FlxBar_obj::createImageFilledBar( ::Dynamic fill,::hx::Null< int >  __o_fillBackground){
            		int fillBackground = __o_fillBackground.Default(-16711936);
            	HX_GC_STACKFRAME(&_hx_pos_29953dbeb33e4775_669_createImageFilledBar)
...
HXLINE( 680)				this->_hx_set__filledBar(HX_CTX, filledGraphic->bitmap->clone());
...
HX_DEFINE_DYNAMIC_FUNC2(FlxBar_obj,createImageFilledBar,return )
 ...
 ::flixel::ui::FlxBarFillDirection FlxBar_obj::set_fillDirection( ::flixel::ui::FlxBarFillDirection direction){
            	HX_GC_STACKFRAME(&_hx_pos_29953dbeb33e4775_702_set_fillDirection)
HXLINE( 703)		this->_hx_set_fillDirection(HX_CTX, direction);
...
void FlxBar_obj::updateFilledBar(){
            	HX_GC_STACKFRAME(&_hx_pos_29953dbeb33e4775_748_updateFilledBar)
...
HXLINE( 810)						this->_hx_set__frontFrame(HX_CTX, this->get_frontFrames()->get_frame()->clipTo(this->_filledFlxRect,this->_frontFrame));
            					}
            				}
            			}
            		}
...
::String FlxBar_obj::toString(){
            	HX_GC_STACKFRAME(&_hx_pos_29953dbeb33e4775_902_toString)
...
HXDLIN( 903)		_this->_hx_set_label(HX_CTX, HX_("min",92,11,53,00));
HXDLIN( 903)		_this->_hx_set_value(HX_CTX, value);
...
HXDLIN( 904)		_this1->_hx_set_label(HX_CTX, HX_("max",a4,0a,53,00));
HXDLIN( 904)		_this1->_hx_set_value(HX_CTX, value1);
...
HXDLIN( 905)		_this2->_hx_set_label(HX_CTX, HX_("range",bd,a5,1f,e4));
HXDLIN( 905)		_this2->_hx_set_value(HX_CTX, value2);
...
HXDLIN( 906)		_this3->_hx_set_label(HX_CTX, HX_("%",25,00,00,00));
HXDLIN( 906)		_this3->_hx_set_value(HX_CTX, value3);
...
HXDLIN( 907)		_this4->_hx_set_label(HX_CTX, HX_("px/%",1e,1d,63,4a));
HXDLIN( 907)		_this4->_hx_set_value(HX_CTX, value4);
...
HXDLIN( 908)		_this5->_hx_set_label(HX_CTX, HX_("value",71,7f,b8,31));
HXDLIN( 908)		_this5->_hx_set_value(HX_CTX, value5);
...
HX_DEFINE_DYNAMIC_FUNC0(FlxBar_obj,get_frontFrames,return )
 ...
 ::flixel::graphics::frames::FlxImageFrame FlxBar_obj::set_frontFrames( ::flixel::graphics::frames::FlxImageFrame value){
            	HX_GC_STACKFRAME(&_hx_pos_29953dbeb33e4775_983_set_frontFrames)
...
HXLINE( 992)			this->_hx_set_frontFrames(HX_CTX, value);
...
HXDLIN( 993)			this->_hx_set__frontFrame(HX_CTX, _hx_tmp);
            		}
            		else {
...
::hx::Val FlxBar_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"parent") ) { _hx_set_parent(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 7:
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"_emptyBar") ) { _hx_set__emptyBar(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
		break;
	case 10:
		...
		if (HX_FIELD_EQ(inName,"_filledBar") ) { _hx_set__filledBar(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"killOnEmpty") ) { killOnEmpty=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"frontFrames") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_frontFrames(inValue.Cast<  ::flixel::graphics::frames::FlxImageFrame >()) );_hx_set_frontFrames(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::frames::FlxImageFrame >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_frontFrame") ) { _hx_set__frontFrame(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::frames::FlxFrame >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_zeroOffset") ) { _hx_set__zeroOffset(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Point >()); return inValue; }
	...
	case 13:
		...
		if (HX_FIELD_EQ(inName,"emptyCallback") ) { _hx_set_emptyCallback(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"fillDirection") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_fillDirection(inValue.Cast<  ::flixel::ui::FlxBarFillDirection >()) );_hx_set_fillDirection(HX_CTX_GET,inValue.Cast<  ::flixel::ui::FlxBarFillDirection >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_emptyBarRect") ) { _hx_set__emptyBarRect(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"positionOffset") ) { _hx_set_positionOffset(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		if (HX_FIELD_EQ(inName,"filledCallback") ) { _hx_set_filledCallback(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"parentVariable") ) { _hx_set_parentVariable(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_filledFlxRect") ) { _hx_set__filledFlxRect(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxRect >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_filledBarRect") ) { _hx_set__filledBarRect(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"_fillHorizontal") ) { _fillHorizontal=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_filledBarPoint") ) { _hx_set__filledBarPoint(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Point >()); return inValue; }
	}
