...
class HXCPP_CLASS_ATTRIBUTES VertexBuffer3D_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::openfl::_Vector::FloatVector _hx_set__hx___data(::hx::StackContext *_hx_ctx, ::openfl::_Vector::FloatVector _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___data=_hx_v; }
		 ::lime::graphics::opengl::GLObject _hx___id;
		inline  ::lime::graphics::opengl::GLObject _hx_set__hx___id(::hx::StackContext *_hx_ctx, ::lime::graphics::opengl::GLObject _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___id=_hx_v; }
		int _hx___memoryUsage;
		int _hx___numVertices;
		int _hx___stride;
		 ::lime::utils::ArrayBufferView _hx___tempFloat32Array;
		inline  ::lime::utils::ArrayBufferView _hx_set__hx___tempFloat32Array(::hx::StackContext *_hx_ctx, ::lime::utils::ArrayBufferView _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___tempFloat32Array=_hx_v; }
		int _hx___usage;
