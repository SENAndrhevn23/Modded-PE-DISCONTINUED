...
class HXCPP_CLASS_ATTRIBUTES CanvasRenderer_obj : public  ::openfl::display::DisplayObjectRenderer_obj
{
	...
	public:
		...
		static  ::Dynamic __meta__;
		 ::Dynamic context;
		inline  ::Dynamic _hx_set_context(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return context=_hx_v; }
		bool _hx___isDOM;
		 ::openfl::geom::Matrix _hx___tempMatrix;
		inline  ::openfl::geom::Matrix _hx_set__hx___tempMatrix(::hx::StackContext *_hx_ctx, ::openfl::geom::Matrix _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___tempMatrix=_hx_v; }
