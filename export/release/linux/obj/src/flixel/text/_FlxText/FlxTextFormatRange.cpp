...
HXLINE(1197)		this->_hx_set_range(HX_CTX,  ::flixel::util::helpers::FlxRange_obj::__alloc( HX_CTX ,start,end));
HXLINE(1198)		this->_hx_set_format(HX_CTX, format);
            	}
...
::hx::Val FlxTextFormatRange_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"range") ) { _hx_set_range(HX_CTX_GET,inValue.Cast<  ::flixel::util::helpers::FlxRange >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"format") ) { _hx_set_format(HX_CTX_GET,inValue.Cast<  ::flixel::text::FlxTextFormat >()); return inValue; }
	}
