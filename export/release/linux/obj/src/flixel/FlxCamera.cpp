...
HXLINE( 554)		this->_hx_set__helperPoint(HX_CTX,  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null()));
HXLINE( 552)		this->_hx_set__helperMatrix(HX_CTX,  ::flixel::math::FlxMatrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
...
HXDLIN( 532)		this->_hx_set__bounds(HX_CTX, rect);
HXLINE( 527)		this->_hx_set__scrollRect(HX_CTX,  ::openfl::display::Sprite_obj::__alloc( HX_CTX ));
HXLINE( 506)		this->initialZoom = ((Float)1);
HXLINE( 498)		this->_hx_set_filters(HX_CTX, null());
...
HXDLIN( 493)		this->_hx_set__point(HX_CTX, point);
...
HXLINE( 462)		this->_hx_set__fxFadeComplete(HX_CTX, null());
...
HXDLIN( 446)		this->_hx_set__scrollTarget(HX_CTX, point1);
HXLINE( 436)		this->_fxFadeColor = 0;
HXLINE( 431)		this->_fxFlashAlpha = ((Float)0);
HXLINE( 426)		this->_hx_set__fxFlashComplete(HX_CTX, null());
...
HXDLIN( 411)		this->_hx_set__flashOffset(HX_CTX, point2);
HXLINE( 402)		this->_hx_set__flashPoint(HX_CTX,  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null()));
...
HXDLIN( 382)		this->_hx_set_followLead(HX_CTX, point3);
...
HXLINE( 351)		this->_hx_set__blitMatrix(HX_CTX,  ::flixel::math::FlxMatrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
HXLINE( 239)		this->height = 0;
HXLINE( 234)		this->width = 0;
HXLINE( 229)		this->_hx_set_pixelPerfectShake(HX_CTX, null());
HXLINE( 215)		this->_hx_set_flashSprite(HX_CTX,  ::openfl::display::Sprite_obj::__alloc( HX_CTX ));
...
HXDLIN( 170)		this->_hx_set_scroll(HX_CTX, point4);
...
HXDLIN( 126)		this->_hx_set_targetOffset(HX_CTX, point5);
...
HXLINE(1041)		this->_hx_set__flashRect(HX_CTX,  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,this->width,this->height));
...
HXLINE(1050)			this->_hx_set_screen(HX_CTX,  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null()));
HXLINE(1051)			this->_hx_set_buffer(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->width,this->height,true,0));
...
HXLINE(1054)			this->_hx_set__flashBitmap(HX_CTX,  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,this->buffer,null(),null()));
HXLINE(1055)			this->_scrollRect->addChild(this->_flashBitmap);
HXLINE(1056)			this->_hx_set__fill(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->width,this->height,true,0));
            		}
            		else {
HXLINE(1060)			this->_hx_set_canvas(HX_CTX,  ::openfl::display::Sprite_obj::__alloc( HX_CTX ));
...
HXLINE( 638)		itemToReturn->_hx_set_graphics(HX_CTX, graphic);
...
HXLINE( 643)		itemToReturn->_hx_set_blend(HX_CTX, blend);
HXLINE( 644)		itemToReturn->_hx_set_shader(HX_CTX, shader);
HXLINE( 646)		itemToReturn->_hx_set_nextTyped(HX_CTX, this->_headTiles);
HXLINE( 647)		this->_hx_set__headTiles(HX_CTX, itemToReturn);
HXLINE( 649)		if (::hx::IsNull( this->_headOfDrawStack )) {
HXLINE( 651)			this->_hx_set__headOfDrawStack(HX_CTX, itemToReturn);
            		}
HXLINE( 654)		if (::hx::IsNotNull( this->_currentDrawItem )) {
HXLINE( 656)			this->_currentDrawItem->_hx_set_next(HX_CTX, itemToReturn);
            		}
HXLINE( 659)		this->_hx_set__currentDrawItem(HX_CTX, itemToReturn);
...
HXLINE( 706)		itemToReturn->_hx_set_graphics(HX_CTX, graphic);
...
HXLINE( 712)		itemToReturn->_hx_set_shader(HX_CTX, shader);
HXLINE( 715)		itemToReturn->_hx_set_nextTyped(HX_CTX, this->_headTriangles);
HXLINE( 716)		this->_hx_set__headTriangles(HX_CTX, itemToReturn);
HXLINE( 718)		if (::hx::IsNull( this->_headOfDrawStack )) {
HXLINE( 720)			this->_hx_set__headOfDrawStack(HX_CTX, itemToReturn);
            		}
HXLINE( 723)		if (::hx::IsNotNull( this->_currentDrawItem )) {
HXLINE( 725)			this->_currentDrawItem->_hx_set_next(HX_CTX, itemToReturn);
            		}
HXLINE( 728)		this->_hx_set__currentDrawItem(HX_CTX, itemToReturn);
...
void FlxCamera_obj::clearDrawStack(){
            	HX_GC_STACKFRAME(&_hx_pos_d1aae230bd422321_735_clearDrawStack)
...
HXLINE( 743)			currTiles->_hx_set_nextTyped(HX_CTX, ::flixel::FlxCamera_obj::_storageTilesHead);
...
HXLINE( 755)			currTriangles->_hx_set_nextTyped(HX_CTX, ::flixel::FlxCamera_obj::_storageTrianglesHead);
HXLINE( 756)			::flixel::FlxCamera_obj::_storageTrianglesHead = currTriangles;
HXLINE( 757)			currTriangles = newTrianglesHead;
            		}
HXLINE( 760)		this->_hx_set__currentDrawItem(HX_CTX, null());
HXLINE( 761)		this->_hx_set__headOfDrawStack(HX_CTX, null());
HXLINE( 762)		this->_hx_set__headTiles(HX_CTX, null());
HXLINE( 763)		this->_hx_set__headTriangles(HX_CTX, null());
            	}
...
void FlxCamera_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_d1aae230bd422321_1086_destroy)
...
HXLINE(1092)			this->_hx_set_screen(HX_CTX, ( ( ::flixel::FlxSprite)(::flixel::util::FlxDestroyUtil_obj::destroy(this->screen)) ));
HXLINE(1093)			this->_hx_set_buffer(HX_CTX, null());
HXLINE(1094)			this->_hx_set__flashBitmap(HX_CTX, null());
HXLINE(1095)			this->_hx_set__fill(HX_CTX, ::flixel::util::FlxDestroyUtil_obj::dispose(this->_fill));
            		}
            		else {
...
HXLINE(1111)				this->_hx_set_canvas(HX_CTX, null());
            			}
HXLINE(1114)			if (::hx::IsNotNull( this->_headOfDrawStack )) {
HXLINE(1116)				this->clearDrawStack();
            			}
HXLINE(1119)			this->_hx_set__blitMatrix(HX_CTX, null());
HXLINE(1120)			this->_hx_set__helperMatrix(HX_CTX, null());
HXLINE(1121)			this->_hx_set__helperPoint(HX_CTX, null());
            		}
HXLINE(1124)		this->_hx_set__bounds(HX_CTX, null());
HXLINE(1125)		this->_hx_set_scroll(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->scroll)) ));
HXLINE(1126)		this->_hx_set_targetOffset(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->targetOffset)) ));
HXLINE(1127)		this->_hx_set_deadzone(HX_CTX, ( ( ::flixel::math::FlxRect)(::flixel::util::FlxDestroyUtil_obj::put(this->deadzone)) ));
HXLINE(1129)		this->_hx_set_target(HX_CTX, null());
HXLINE(1130)		this->_hx_set_flashSprite(HX_CTX, null());
HXLINE(1131)		this->_hx_set__scrollRect(HX_CTX, null());
HXLINE(1132)		this->_hx_set__flashRect(HX_CTX, null());
HXLINE(1133)		this->_hx_set__flashPoint(HX_CTX, null());
HXLINE(1134)		this->_hx_set__fxFlashComplete(HX_CTX, null());
HXLINE(1135)		this->_hx_set__fxFadeComplete(HX_CTX, null());
HXLINE(1136)		this->_hx_set__fxShakeComplete(HX_CTX, null());
...
void FlxCamera_obj::updateFollow(){
            	HX_GC_STACKFRAME(&_hx_pos_d1aae230bd422321_1198_updateFollow)
...
HXDLIN(1265)					this->_hx_set__lastTargetPosition(HX_CTX, point1);
            				}
...
void FlxCamera_obj::follow( ::flixel::FlxObject Target, ::flixel::FlxCameraFollowStyle Style, ::Dynamic Lerp){
            	HX_GC_STACKFRAME(&_hx_pos_d1aae230bd422321_1466_follow)
...
HXLINE(1473)		this->_hx_set_style(HX_CTX, Style);
HXLINE(1474)		this->_hx_set_target(HX_CTX, Target);
HXLINE(1475)		this->set_followLerp(( (Float)(Lerp) ));
HXLINE(1476)		Float helper;
HXLINE(1477)		Float w = ( (Float)(0) );
HXLINE(1478)		Float h = ( (Float)(0) );
HXLINE(1479)		this->_hx_set__lastTargetPosition(HX_CTX, null());
...
HXDLIN(1489)				this->_hx_set_deadzone(HX_CTX, rect);
            			}
            			break;
            			case (int)1: {
...
HXDLIN(1494)				this->_hx_set_deadzone(HX_CTX, rect1);
            			}
            			break;
            			case (int)2: {
...
HXDLIN(1498)				this->_hx_set_deadzone(HX_CTX, rect2);
            			}
            			break;
            			case (int)3: {
...
HXDLIN(1502)				this->_hx_set_deadzone(HX_CTX, rect3);
            			}
            			break;
            			case (int)4: {
...
HXDLIN(1505)				this->_hx_set_deadzone(HX_CTX, rect4);
            			}
            			break;
            			case (int)5: {
HXLINE(1508)				this->_hx_set_deadzone(HX_CTX, null());
            			}
            			break;
            		}
            	}
...
void FlxCamera_obj::flash(::hx::Null< int >  __o_Color,::hx::Null< Float >  __o_Duration, ::Dynamic OnComplete,::hx::Null< bool >  __o_Force){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_d1aae230bd422321_1542_flash)
...
HXLINE(1550)		this->_hx_set__fxFlashComplete(HX_CTX, OnComplete);
...
void FlxCamera_obj::fade(::hx::Null< int >  __o_Color,::hx::Null< Float >  __o_Duration,::hx::Null< bool >  __o_FadeIn, ::Dynamic OnComplete,::hx::Null< bool >  __o_Force){
            		...
            		bool Force = __o_Force.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_d1aae230bd422321_1564_fade)
...
HXLINE(1574)		this->_hx_set__fxFadeComplete(HX_CTX, OnComplete);
...
void FlxCamera_obj::shake(::hx::Null< Float >  __o_Intensity,::hx::Null< Float >  __o_Duration, ::Dynamic OnComplete,::hx::Null< bool >  __o_Force, ::Dynamic Axes){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_d1aae230bd422321_1590_shake)
...
HXLINE(1599)		this->_hx_set__fxShakeComplete(HX_CTX, OnComplete);
...
void FlxCamera_obj::setFilters(::Array< ::Dynamic> filters){
            	HX_GC_STACKFRAME(&_hx_pos_d1aae230bd422321_1621_setFilters)
HXDLIN(1621)		this->_hx_set_filters(HX_CTX, filters);
            	}
...
HXDLIN(1646)					this->_hx_set_deadzone(HX_CTX, rect);
            				}
HXLINE(1648)				{
...
HXLINE(1736)				this->_hx_set_buffer(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->width,this->height,true,0));
...
HXLINE(1742)				this->_hx_set__fill(HX_CTX, ::flixel::util::FlxDestroyUtil_obj::dispose(this->_fill));
HXLINE(1743)				this->_hx_set__fill(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->width,this->height,true,0));
...
void FlxCamera_obj::setScrollBounds( ::Dynamic MinX, ::Dynamic MaxX, ::Dynamic MinY, ::Dynamic MaxY){
            	HX_GC_STACKFRAME(&_hx_pos_d1aae230bd422321_1814_setScrollBounds)
HXLINE(1815)		this->_hx_set_minScrollX(HX_CTX, MinX);
HXLINE(1816)		this->_hx_set_maxScrollX(HX_CTX, MaxX);
HXLINE(1817)		this->_hx_set_minScrollY(HX_CTX, MinY);
HXLINE(1818)		this->_hx_set_maxScrollY(HX_CTX, MaxY);
...
::Array< ::Dynamic> FlxCamera_obj::set__filters(::Array< ::Dynamic> Value){
            	HX_GC_STACKFRAME(&_hx_pos_d1aae230bd422321_2183_set__filters)
HXDLIN(2183)		return (this->_hx_set_filters(HX_CTX, Value));
            	}
...
::hx::Val FlxCamera_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"style") ) { _hx_set_style(HX_CTX_GET,inValue.Cast<  ::flixel::FlxCameraFollowStyle >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"_fill") ) { _hx_set__fill(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
		break;
	case 6:
		...
		if (HX_FIELD_EQ(inName,"target") ) { _hx_set_target(HX_CTX_GET,inValue.Cast<  ::flixel::FlxObject >()); return inValue; }
		if (HX_FIELD_EQ(inName,"scroll") ) { _hx_set_scroll(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		if (HX_FIELD_EQ(inName,"buffer") ) { _hx_set_buffer(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
		if (HX_FIELD_EQ(inName,"screen") ) { _hx_set_screen(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSprite >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"_point") ) { _hx_set__point(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		if (HX_FIELD_EQ(inName,"canvas") ) { _hx_set_canvas(HX_CTX_GET,inValue.Cast<  ::openfl::display::Sprite >()); return inValue; }
		break;
	case 7:
		...
		if (HX_FIELD_EQ(inName,"_bounds") ) { _hx_set__bounds(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxRect >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"deadzone") ) { _hx_set_deadzone(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxRect >()); return inValue; }
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"minScrollX") ) { _hx_set_minScrollX(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"maxScrollX") ) { _hx_set_maxScrollX(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"minScrollY") ) { _hx_set_minScrollY(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"maxScrollY") ) { _hx_set_maxScrollY(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"followLead") ) { _hx_set_followLead(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_flashRect") ) { _hx_set__flashRect(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_headTiles") ) { _hx_set__headTiles(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::tile::FlxDrawQuadsItem >()); return inValue; }
		break;
	case 11:
		...
		if (HX_FIELD_EQ(inName,"flashSprite") ) { _hx_set_flashSprite(HX_CTX_GET,inValue.Cast<  ::openfl::display::Sprite >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"_blitMatrix") ) { _hx_set__blitMatrix(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxMatrix >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_flashPoint") ) { _hx_set__flashPoint(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Point >()); return inValue; }
		if (HX_FIELD_EQ(inName,"initialZoom") ) { initialZoom=inValue.Cast< Float >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_scrollRect") ) { _hx_set__scrollRect(HX_CTX_GET,inValue.Cast<  ::openfl::display::Sprite >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"targetOffset") ) { _hx_set_targetOffset(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"_flashOffset") ) { _hx_set__flashOffset(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"_flashBitmap") ) { _hx_set__flashBitmap(HX_CTX_GET,inValue.Cast<  ::openfl::display::Bitmap >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_helperPoint") ) { _hx_set__helperPoint(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Point >()); return inValue; }
		break;
	case 13:
		...
		if (HX_FIELD_EQ(inName,"_scrollTarget") ) { _hx_set__scrollTarget(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_helperMatrix") ) { _hx_set__helperMatrix(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxMatrix >()); return inValue; }
		break;
	case 14:
		...
		if (HX_FIELD_EQ(inName,"_headTriangles") ) { _hx_set__headTriangles(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::tile::FlxDrawTrianglesItem >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"_fxFadeDuration") ) { _fxFadeDuration=inValue.Cast< Float >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_fxFadeComplete") ) { _hx_set__fxFadeComplete(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"_fxFlashDuration") ) { _fxFlashDuration=inValue.Cast< Float >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_fxFlashComplete") ) { _hx_set__fxFlashComplete(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_fxShakeDuration") ) { _fxShakeDuration=inValue.Cast< Float >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_fxShakeComplete") ) { _hx_set__fxShakeComplete(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_currentDrawItem") ) { _hx_set__currentDrawItem(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::tile::FlxDrawBaseItem >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_headOfDrawStack") ) { _hx_set__headOfDrawStack(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::tile::FlxDrawBaseItem >()); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"pixelPerfectShake") ) { _hx_set_pixelPerfectShake(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	...
	case 18:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"_lastTargetPosition") ) { _hx_set__lastTargetPosition(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
	}
