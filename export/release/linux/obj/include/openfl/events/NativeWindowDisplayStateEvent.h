...
class HXCPP_CLASS_ATTRIBUTES NativeWindowDisplayStateEvent_obj : public  ::openfl::events::Event_obj
{
	...
	public:
		...
		inline  ::Dynamic _hx_set_beforeDisplayState(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return beforeDisplayState=_hx_v; }
		 ::Dynamic afterDisplayState;
		inline  ::Dynamic _hx_set_afterDisplayState(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return afterDisplayState=_hx_v; }
