...
HXLINE(  42)				leObj->_hx_set_shader(HX_CTX,  ::flixel::addons::display::FlxRuntimeShader_obj::__alloc( HX_CTX ,arr->__get(0),arr->__get(1)));
...
HXLINE(  50)		{
            			...
            			bool _hx_run(::String obj){
            				HX_GC_STACKFRAME(&_hx_pos_929905dd20ad7486_50_implement)
...
HXLINE(  58)					leObj->_hx_set_shader(HX_CTX, null());
