...
void Context3DBuffer_obj::__construct( ::openfl::display3D::Context3D context3D, ::openfl::display::_internal::Context3DElementType elementType,int elementCount,int dataPerVertex){
            	HX_GC_STACKFRAME(&_hx_pos_9e62df52b7800135_30_new)
HXLINE(  31)		this->_hx_set_context3D(HX_CTX, context3D);
HXLINE(  32)		this->_hx_set_elementType(HX_CTX, elementType);
...
void Context3DBuffer_obj::flushVertexBufferData(){
            	HX_GC_STACKFRAME(&_hx_pos_9e62df52b7800135_77_flushVertexBufferData)
HXLINE(  78)		if ((this->vertexBufferData->length > this->vertexCount)) {
HXLINE(  80)			this->vertexCount = this->vertexBufferData->length;
HXLINE(  81)			this->_hx_set_vertexBuffer(HX_CTX, this->context3D->createVertexBuffer(this->vertexCount,this->dataPerVertex,0));
            		}
...
HXLINE(  95)			this->_hx_set_vertexBuffer(HX_CTX, null());
...
HXDLIN( 123)					_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN( 123)						_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN( 123)								_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN( 123)			this->_hx_set_vertexBufferData(HX_CTX, this1);
            		}
            		else {
...
HXDLIN( 128)						_this4->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this4->byteLength));
...
HXDLIN( 128)							_this5->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this5->byteLength));
...
HXDLIN( 128)									_this6->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength1));
...
HXDLIN( 128)									_this7->_hx_set_buffer(HX_CTX, buffer1);
...
HXDLIN( 128)				this->_hx_set_vertexBufferData(HX_CTX, this2);
HXLINE( 129)				{
...
::hx::Val Context3DBuffer_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"elementType") ) { _hx_set_elementType(HX_CTX_GET,inValue.Cast<  ::openfl::display::_internal::Context3DElementType >()); return inValue; }
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"indexBuffers") ) { _hx_set_indexBuffers(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"vertexBuffer") ) { _hx_set_vertexBuffer(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::VertexBuffer3D >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"dataPerVertex") ) { dataPerVertex=inValue.Cast< int >(); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"indexBufferData") ) { _hx_set_indexBufferData(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"vertexBufferData") ) { _hx_set_vertexBufferData(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
	}
