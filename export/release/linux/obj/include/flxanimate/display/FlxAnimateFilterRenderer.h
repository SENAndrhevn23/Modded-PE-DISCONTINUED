...
class HXCPP_CLASS_ATTRIBUTES FlxAnimateFilterRenderer_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::flxanimate::filters::MaskShader _hx_set_maskShader(::hx::StackContext *_hx_ctx, ::flxanimate::filters::MaskShader _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return maskShader=_hx_v; }
		 ::openfl::filters::ShaderFilter maskFilter;
		inline  ::openfl::filters::ShaderFilter _hx_set_maskFilter(::hx::StackContext *_hx_ctx, ::openfl::filters::ShaderFilter _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return maskFilter=_hx_v; }
