...
void SamplerState_obj::__construct( ::Dynamic __o_wrap, ::Dynamic __o_filter, ::Dynamic __o_mipfilter,::hx::Null< Float >  __o_lodBias,::hx::Null< bool >  __o_ignoreSampler,::hx::Null< bool >  __o_centroid,::hx::Null< bool >  __o_textureAlpha){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_2927c9d004f07aab_26_new)
HXLINE(  27)		this->_hx_set_wrap(HX_CTX, wrap);
HXLINE(  28)		this->_hx_set_filter(HX_CTX, filter);
HXLINE(  29)		this->_hx_set_mipfilter(HX_CTX, mipfilter);
...
void SamplerState_obj::copyFrom( ::openfl::display::_internal::SamplerState other){
            	HX_GC_STACKFRAME(&_hx_pos_2927c9d004f07aab_44_copyFrom)
...
HXLINE(  47)		this->_hx_set_wrap(HX_CTX, other->wrap);
HXLINE(  48)		this->_hx_set_filter(HX_CTX, other->filter);
HXLINE(  49)		this->_hx_set_mipfilter(HX_CTX, other->mipfilter);
