...
HXLINE( 571)		this->_hx_set__hx___data(HX_CTX, null());
HXLINE( 572)		this->_hx_set__hx___path(HX_CTX, null());
...
HXLINE( 839)		this->_hx_set__hx___data(HX_CTX, null());
HXLINE( 840)		this->_hx_set__hx___path(HX_CTX, null());
HXLINE( 842)		this->_hx_set__hx___urlLoader(HX_CTX,  ::openfl::net::URLLoader_obj::__alloc( HX_CTX ,null()));
HXLINE( 843)		this->_hx___urlLoader->_hx_set_dataFormat(HX_CTX, 0);
...
void FileReference_obj::load(){
            	HX_GC_STACKFRAME(&_hx_pos_069fe0fa1a76d977_940_load)
HXDLIN( 940)		if (::hx::IsNotNull( this->_hx___path )) {
HXLINE( 942)			this->_hx_set_data(HX_CTX, ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromLimeBytes(::lime::utils::_Bytes::Bytes_Impl__obj::fromFile(this->_hx___path)));
...
HXLINE(1060)		this->_hx_set__hx___data(HX_CTX, null());
HXLINE(1061)		this->_hx_set__hx___path(HX_CTX, null());
HXLINE(1063)		if (::hx::IsNull( data )) {
HXLINE(1063)			return;
            		}
HXLINE(1066)		if (::Std_obj::isOfType(data,::hx::ClassOf< ::openfl::utils::ByteArrayData >())) {
HXLINE(1068)			this->_hx_set__hx___data(HX_CTX, ( ( ::openfl::utils::ByteArrayData)(data) ));
            		}
            		else {
HXLINE(1072)			this->_hx_set__hx___data(HX_CTX,  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,0));
HXLINE(1073)			{
...
HXDLIN(1353)			request1->_hx_set_url(HX_CTX, (request1->url + getVariables));
            		}
...
HXLINE(1385)		request->_hx_set_data(HX_CTX, requestData);
HXLINE(1387)		request->_hx_set_method(HX_CTX, HX_("POST",60,4c,1d,35));
HXLINE(1388)		request->_hx_set_contentType(HX_CTX, (HX_("multipart/form-data; boundary=",fe,c4,13,72) + boundary));
...
HXLINE(1389)		request->_hx_set_requestHeaders(HX_CTX, ::Array_obj< ::Dynamic>::__new(2)->init(0,_hx_tmp3)->init(1, ::openfl::net::URLRequestHeader_obj::__alloc( HX_CTX ,HX_("Cache-Control",d2,9e,1c,4d),HX_("no-cache",f6,5d,9f,da))));
HXLINE(1394)		 ::openfl::net::URLLoader urlLoader =  ::openfl::net::URLLoader_obj::__alloc( HX_CTX ,null());
HXLINE(1395)		urlLoader->_hx_set_dataFormat(HX_CTX, 0);
...
HXLINE(1424)		this->_hx_set_creationDate(HX_CTX, ( ( ::Date)(fileInfo->__Field(HX_("ctime",f0,39,a8,4d),::hx::paccDynamic)) ));
HXLINE(1425)		this->_hx_set_modificationDate(HX_CTX, ( ( ::Date)(fileInfo->__Field(HX_("mtime",fa,06,aa,0f),::hx::paccDynamic)) ));
HXLINE(1426)		this->size = ( (Float)(fileInfo->__Field(HX_("size",c1,a0,53,4c),::hx::paccDynamic)) );
HXLINE(1427)		this->_hx_set_type(HX_CTX, (HX_(".",2e,00,00,00) + ::haxe::io::Path_obj::extension(path)));
HXLINE(1430)		this->_hx_set_name(HX_CTX, ::haxe::io::Path_obj::withoutDirectory(path));
HXLINE(1431)		this->_hx_set__hx___path(HX_CTX, path);
...
HXLINE(1452)		this->_hx_set_name(HX_CTX, ::haxe::io::Path_obj::withoutDirectory(path));
...
HXLINE(1458)			this->_hx_set__hx___data(HX_CTX, null());
HXLINE(1459)			this->_hx_set__hx___path(HX_CTX, null());
            		}
            		else {
HXLINE(1463)			this->_hx_set__hx___path(HX_CTX, path);
            		}
...
HXLINE(1475)			this->_hx_set__hx___data(HX_CTX, ( ( ::openfl::utils::ByteArrayData)(this->_hx___urlLoader->data) ));
            		}
            		else {
HXLINE(1479)			this->_hx_set__hx___data(HX_CTX,  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,0));
HXLINE(1480)			{
...
HXLINE(1487)			this->_hx_set__hx___path(HX_CTX, null());
HXLINE(1488)			this->_hx_set__hx___data(HX_CTX, null());
            		}
...
::hx::Val FileReference_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"data") ) { _hx_set_data(HX_CTX_GET,inValue.Cast<  ::openfl::utils::ByteArrayData >()); return inValue; }
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"__data") ) { _hx_set__hx___data(HX_CTX_GET,inValue.Cast<  ::openfl::utils::ByteArrayData >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__path") ) { _hx_set__hx___path(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"creator") ) { _hx_set_creator(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"extension") ) { _hx_set_extension(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"__urlLoader") ) { _hx_set__hx___urlLoader(HX_CTX_GET,inValue.Cast<  ::openfl::net::URLLoader >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"creationDate") ) { _hx_set_creationDate(HX_CTX_GET,inValue.Cast<  ::Date >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"modificationDate") ) { _hx_set_modificationDate(HX_CTX_GET,inValue.Cast<  ::Date >()); return inValue; }
	}
