...
void RenderEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable, ::openfl::geom::Matrix objectMatrix, ::openfl::geom::ColorTransform objectColorTransform,::hx::Null< bool >  __o_allowSmoothing){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_6a559adcb74b53ca_154_new)
HXLINE( 155)		super::__construct(type,bubbles,cancelable);
HXLINE( 157)		this->_hx_set_objectMatrix(HX_CTX, objectMatrix);
HXLINE( 158)		this->_hx_set_objectColorTransform(HX_CTX, objectColorTransform);
...
HXLINE( 166)		event5->_hx_set_target(HX_CTX, this->target);
HXLINE( 167)		event5->_hx_set_currentTarget(HX_CTX, this->currentTarget);
...
void RenderEvent_obj::_hx___init(){
            	HX_GC_STACKFRAME(&_hx_pos_6a559adcb74b53ca_180___init)
HXLINE( 181)		this->super::_hx___init();
HXLINE( 182)		this->_hx_set_objectMatrix(HX_CTX, null());
HXLINE( 183)		this->_hx_set_objectColorTransform(HX_CTX, null());
HXLINE( 184)		this->allowSmoothing = false;
HXLINE( 185)		this->_hx_set_renderer(HX_CTX, null());
            	}
...
::hx::Val RenderEvent_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"renderer") ) { _hx_set_renderer(HX_CTX_GET,inValue.Cast<  ::openfl::display::DisplayObjectRenderer >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"objectMatrix") ) { _hx_set_objectMatrix(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Matrix >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"allowSmoothing") ) { allowSmoothing=inValue.Cast< bool >(); return inValue; }
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"objectColorTransform") ) { _hx_set_objectColorTransform(HX_CTX_GET,inValue.Cast<  ::openfl::geom::ColorTransform >()); return inValue; }
	}
