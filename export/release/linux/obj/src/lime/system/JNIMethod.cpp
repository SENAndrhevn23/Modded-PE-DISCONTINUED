...
void JNIMethod_obj::__construct( ::Dynamic method){
            	HX_GC_STACKFRAME(&_hx_pos_39b0deb1236c4593_314_new)
HXDLIN( 314)		this->_hx_set_method(HX_CTX, method);
            	}
...
::hx::Val JNIMethod_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"method") ) { _hx_set_method(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
