...
HXDLIN( 381)		if (_hx_tmp) {
            			...
            			void _hx_run(){
            				HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_385_switchState)
HXLINE( 385)				if (::hx::IsInstanceEq( ::flixel::FlxG_obj::game->_state,stateOnCall )) {
HXLINE( 386)					::flixel::FlxG_obj::game->_hx_set__nextState(HX_CTX, nextState);
            				}
            				else {
...
HXDLIN( 419)				if (_hx_tmp1) {
            					HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_0, ::Dynamic,nextState, ::flixel::FlxState,stateOnCall) HXARGC(0)
            					void _hx_run(){
            						HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_419_resetState)
HXLINE( 419)						if (::hx::IsInstanceEq( ::flixel::FlxG_obj::game->_state,stateOnCall )) {
HXLINE( 419)							::flixel::FlxG_obj::game->_hx_set__nextState(HX_CTX, nextState);
            						}
            						else {
...
HXDLIN( 422)				if (_hx_tmp2) {
            					...
            					void _hx_run(){
            						HX_GC_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_422_resetState)
HXLINE( 422)						if (::hx::IsInstanceEq( ::flixel::FlxG_obj::game->_state,stateOnCall1 )) {
HXLINE( 422)							::flixel::FlxG_obj::game->_hx_set__nextState(HX_CTX, nextState1);
            						}
            						else {
