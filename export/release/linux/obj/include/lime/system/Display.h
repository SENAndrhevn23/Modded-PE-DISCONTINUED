...
HX_DECLARE_STACK_FRAME(_hx_pos_84dc687d4538b090_50_new)
			...
			*(void **)__this = Display_obj::_hx_vtable;
{
		...
		inline  ::lime::math::Rectangle _hx_set_bounds(::hx::StackContext *_hx_ctx, ::lime::math::Rectangle _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return bounds=_hx_v; }
		 ::lime::_hx_system::DisplayMode currentMode;
		inline  ::lime::_hx_system::DisplayMode _hx_set_currentMode(::hx::StackContext *_hx_ctx, ::lime::_hx_system::DisplayMode _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return currentMode=_hx_v; }
		int id;
		Float dpi;
		int orientation;
		::String name;
		...
		inline ::Array< ::Dynamic> _hx_set_supportedModes(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return supportedModes=_hx_v; }
		 ::lime::math::Rectangle safeArea;
		inline  ::lime::math::Rectangle _hx_set_safeArea(::hx::StackContext *_hx_ctx, ::lime::math::Rectangle _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return safeArea=_hx_v; }
};
