...
void Video_obj::attachNetStream( ::openfl::net::NetStream netStream){
            	HX_GC_STACKFRAME(&_hx_pos_cb6bc49fba42380b_258_attachNetStream)
HXDLIN( 258)		this->_hx_set__hx___stream(HX_CTX, netStream);
            	}
...
HXDLIN( 307)			this->_hx_set__hx___indexBufferData(HX_CTX,  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,6,6));
HXLINE( 308)			{
...
HXLINE( 315)			this->_hx_set__hx___indexBufferContext(HX_CTX, context->_hx___context);
HXLINE( 316)			this->_hx_set__hx___indexBuffer(HX_CTX, context->createIndexBuffer(6,null()));
...
HXDLIN( 385)			this->_hx_set__hx___vertexBufferData(HX_CTX,  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,20,8));
HXLINE( 387)			{
...
HXLINE( 396)			this->_hx_set__hx___vertexBufferContext(HX_CTX, context->_hx___context);
HXLINE( 397)			this->_hx_set__hx___vertexBuffer(HX_CTX, context->createVertexBuffer(3,5,null()));
...
::hx::Val Video_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"__buffer") ) { _hx_set__hx___buffer(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__height") ) { _hx___height=inValue.Cast< Float >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__stream") ) { _hx_set__hx___stream(HX_CTX_GET,inValue.Cast<  ::openfl::net::NetStream >()); return inValue; }
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"__texture") ) { _hx_set__hx___texture(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::textures::RectangleTexture >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"deblocking") ) { deblocking=inValue.Cast< int >(); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"__bufferData") ) { _hx_set__hx___bufferData(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
		break;
	case 13:
	...
	case 14:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"__bufferContext") ) { _hx_set__hx___bufferContext(HX_CTX_GET,inValue.Cast<  ::lime::graphics::RenderContext >()); return inValue; }
	...
	case 21:
		...
		break;
	case 22:
		if (HX_FIELD_EQ(inName,"__bufferColorTransform") ) { _hx_set__hx___bufferColorTransform(HX_CTX_GET,inValue.Cast<  ::openfl::geom::ColorTransform >()); return inValue; }
	}
