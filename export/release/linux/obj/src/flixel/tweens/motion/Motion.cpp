...
void Motion_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_3615c645ab6bc3d8_25_destroy)
HXLINE(  26)		this->super::destroy();
HXLINE(  27)		this->_hx_set__object(HX_CTX, null());
            	}


 ::flixel::tweens::motion::Motion Motion_obj::setObject( ::flixel::FlxObject object){
            	HX_GC_STACKFRAME(&_hx_pos_3615c645ab6bc3d8_31_setObject)
HXLINE(  32)		this->_hx_set__object(HX_CTX, object);
...
::hx::Val Motion_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 1:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"_object") ) { _hx_set__object(HX_CTX_GET,inValue.Cast<  ::flixel::FlxObject >()); return inValue; }
		break;
	case 19:
