...
HXDLIN(  28)		this->_hx_set_buttonPlus(HX_CTX, _hx_tmp->loadGraphic(::backend::Paths_obj::image(HX_("psych-ui/stepper_plus",11,e2,e3,43),HX_("embed",d9,8d,cf,6f),null()),true,16,16,null(),null()));
...
HXDLIN(  34)		this->_hx_set_buttonMinus(HX_CTX, _hx_tmp2->loadGraphic(::backend::Paths_obj::image(HX_("psych-ui/stepper_minus",d9,3d,4d,67),HX_("embed",d9,8d,cf,6f),null()),true,16,16,null(),null()));
...
HXLINE(  40)		this->_hx_set_unfocus(HX_CTX,  ::Dynamic(new _hx_Closure_0(_gthis)));
...
::hx::Val PsychUINumericStepper_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"buttonPlus") ) { _hx_set_buttonPlus(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSprite >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"buttonMinus") ) { _hx_set_buttonMinus(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSprite >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"onValueChange") ) { _hx_set_onValueChange(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 21:
