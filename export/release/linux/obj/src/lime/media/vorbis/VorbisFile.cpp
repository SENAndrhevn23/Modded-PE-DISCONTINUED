...
void VorbisFile_obj::__construct( ::Dynamic handle){
            	HX_GC_STACKFRAME(&_hx_pos_31beaa65b9069eee_20_new)
HXDLIN(  20)		this->_hx_set_handle(HX_CTX, handle);
            	}
...
HXLINE(  56)			comment->_hx_set_userComments(HX_CTX, ( (::Array< ::String >)(( ( ::Dynamic)(data) )->__Field(HX_("userComments",9f,aa,f5,57),::hx::paccDynamic)) ));
HXLINE(  57)			comment->_hx_set_vendor(HX_CTX, ( (::String)(( ( ::Dynamic)(data) )->__Field(HX_("vendor",88,e5,96,9e),::hx::paccDynamic)) ));
