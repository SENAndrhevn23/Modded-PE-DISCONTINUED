...
HXLINE( 190)							output->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            						}
            						else {
...
HXLINE( 190)							output->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            						}
...
HXLINE( 674)					words->setCtx( HX_CTX, i,words->__get(i).toUpperCase());
            				}
            				else {
...
HXDLIN( 676)						words->setCtx( HX_CTX, i,(_hx_tmp1 + words->__get(i).substr(1,null())));
            					}
            				}
            			}
            		}
