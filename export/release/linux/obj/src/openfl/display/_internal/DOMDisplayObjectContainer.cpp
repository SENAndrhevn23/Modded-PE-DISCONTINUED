...
void DOMDisplayObjectContainer_obj::renderDrawable( ::openfl::display::DisplayObjectContainer displayObjectContainer, ::openfl::display::DOMRenderer renderer){
            	HX_GC_STACKFRAME(&_hx_pos_8d5a21e4727bbbb1_9_renderDrawable)
HXLINE(  10)		{
...
HXLINE(  30)			displayObjectContainer->_hx___cacheBitmap->_hx_set_stage(HX_CTX, displayObjectContainer->stage);
HXLINE(  31)			return;
            		}
