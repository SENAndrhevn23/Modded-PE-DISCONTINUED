...
void GraphicsBitmapFill_obj::__construct( ::openfl::display::BitmapData bitmapData, ::openfl::geom::Matrix matrix,::hx::Null< bool >  __o_repeat,::hx::Null< bool >  __o_smooth){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_1aabeebe910bc323_94_new)
HXLINE(  95)		this->_hx_set_bitmapData(HX_CTX, bitmapData);
HXLINE(  96)		this->_hx_set_matrix(HX_CTX, matrix);
...
::hx::Val GraphicsBitmapFill_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"bitmapData") ) { _hx_set_bitmapData(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
		break;
	case 18:
