...
::String Font_obj::set_fontName(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_bf5c0d6977753a1b_313_set_fontName)
HXDLIN( 313)		return (this->_hx_set_name(HX_CTX, value));
            	}
...
::hx::Val Font_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"fontType") ) { _hx_set_fontType(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"fontStyle") ) { _hx_set_fontStyle(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 13:
