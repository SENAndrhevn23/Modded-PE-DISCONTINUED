...
HX_LOCAL_STACK_FRAME(_hx_pos_66fb301aeed14640_91__drawStripes,"states.editors.content.ChartingGridSprite","_drawStripes",0xd38fdb59,"states.editors.content.ChartingGridSprite._drawStripes","states/editors/content/ChartingGridSprite.hx",91,0x8cf25763)
HX_LOCAL_STACK_FRAME(_hx_pos_66fb301aeed14640_102_updateStripes,"states.editors.content.ChartingGridSprite","updateStripes",0x78d75dc7,"states.editors.content.ChartingGridSprite.updateStripes","states/editors/content/ChartingGridSprite.hx",102,0x8cf25763)
HX_LOCAL_STACK_FRAME(_hx_pos_66fb301aeed14640_110_set_rows,"states.editors.content.ChartingGridSprite","set_rows",0xb2304ecc,"states.editors.content.ChartingGridSprite.set_rows","states/editors/content/ChartingGridSprite.hx",110,0x8cf25763)
HX_LOCAL_STACK_FRAME(_hx_pos_66fb301aeed14640_117_set_spacing,"states.editors.content.ChartingGridSprite","set_spacing",0xbc28abb0,"states.editors.content.ChartingGridSprite.set_spacing","states/editors/content/ChartingGridSprite.hx",117,0x8cf25763)
HX_LOCAL_STACK_FRAME(_hx_pos_66fb301aeed14640_124_recalcHeight,"states.editors.content.ChartingGridSprite","recalcHeight",0x0182ab85,"states.editors.content.ChartingGridSprite.recalcHeight","states/editors/content/ChartingGridSprite.hx",124,0x8cf25763)
namespace states{
namespace editors{
namespace content{
...
HXLINE(  30)		this->_hx_set_vortexLine(HX_CTX,  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(1,1,-1,null(),null()));
HXLINE(  31)		{
...
HXLINE(  36)		this->_hx_set_stripe(HX_CTX,  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(1,1,-1,null(),null()));
...
HXLINE(  54)		if ((this->rows < 1)) {
HXLINE(  54)			return;
            		}
HXLINE(  56)		this->super::draw();
HXLINE(  57)		if ((this->rows == 1)) {
HXLINE(  59)			this->_drawStripes();
HXLINE(  60)			return;
            		}
HXLINE(  63)		Float initialY = this->y;
HXLINE(  64)		{
HXLINE(  64)			int _g = 1;
HXDLIN(  64)			int _g1 = this->rows;
HXDLIN(  64)			while((_g < _g1)){
HXLINE(  64)				_g = (_g + 1);
HXDLIN(  64)				int i = (_g - 1);
HXLINE(  66)				this->set_y((this->y + (::states::editors::ChartingState_obj::GRID_SIZE + this->spacing)));
HXLINE(  67)				::String _hx_tmp;
HXDLIN(  67)				if ((::hx::Mod(i,2) == 1)) {
HXLINE(  67)					_hx_tmp = HX_("odd",af,91,54,00);
            				}
            				else {
HXLINE(  67)					_hx_tmp = HX_("even",1a,6f,1c,43);
            				}
HXDLIN(  67)				this->animation->play(_hx_tmp,true,null(),null());
HXLINE(  68)				this->super::draw();
            			}
            		}
HXLINE(  70)		this->animation->play(HX_("even",1a,6f,1c,43),true,null(),null());
HXLINE(  71)		this->set_y(initialY);
HXLINE(  73)		this->_drawStripes();
HXLINE(  75)		if (this->vortexLineEnabled) {
HXLINE(  77)			this->vortexLine->set_x(this->x);
HXLINE(  78)			this->vortexLine->set_y((this->y - ( (Float)(1) )));
HXLINE(  79)			while(true){
HXLINE(  81)				 ::flixel::FlxSprite fh = this->vortexLine;
HXDLIN(  81)				fh->set_y((fh->y + this->vortexLineSpace));
HXLINE(  82)				Float _hx_tmp1 = this->vortexLine->y;
HXDLIN(  82)				Float _hx_tmp2 = this->y;
HXDLIN(  82)				if ((_hx_tmp1 >= (_hx_tmp2 + this->get_height()))) {
HXLINE(  82)					goto _hx_goto_5;
            				}
HXLINE(  84)				this->vortexLine->draw();
            			}
            			_hx_goto_5:;
            		}
            	}
...
void ChartingGridSprite_obj::_drawStripes(){
            	HX_STACKFRAME(&_hx_pos_66fb301aeed14640_91__drawStripes)
HXDLIN(  91)		int _g_current = 0;
HXDLIN(  91)		::Array< int > _g_array = this->stripes;
HXDLIN(  91)		while((_g_current < _g_array->length)){
HXDLIN(  91)			int _g_value = _g_array->__get(_g_current);
HXDLIN(  91)			_g_current = (_g_current + 1);
HXDLIN(  91)			int _g_key = (_g_current - 1);
HXDLIN(  91)			int i = _g_key;
HXDLIN(  91)			int column = _g_value;
HXLINE(  92)			{
HXLINE(  93)				if ((column == 0)) {
HXLINE(  94)					this->stripe->set_x(this->x);
            				}
            				else {
HXLINE(  96)					 ::flixel::FlxSprite _hx_tmp = this->stripe;
HXDLIN(  96)					Float _hx_tmp1 = (this->x + (::states::editors::ChartingState_obj::GRID_SIZE * column));
HXDLIN(  96)					_hx_tmp->set_x((_hx_tmp1 - (this->stripe->get_width() / ( (Float)(2) ))));
            				}
HXLINE(  97)				this->stripe->draw();
            			}
            		}
            	}
...
void ChartingGridSprite_obj::updateStripes(){
            	HX_STACKFRAME(&_hx_pos_66fb301aeed14640_102_updateStripes)
HXLINE( 103)		bool _hx_tmp;
HXDLIN( 103)		if (::hx::IsNotNull( this->stripe )) {
HXLINE( 103)			_hx_tmp = !(this->stripe->exists);
            		}
            		else {
...
HXLINE( 104)		this->stripe->set_y(this->y);
HXLINE( 105)		 ::flixel::FlxSprite _hx_tmp1 = this->stripe;
HXDLIN( 105)		_hx_tmp1->setGraphicSize(2,this->get_height());
HXLINE( 106)		this->stripe->updateHitbox();
            	}


HX_DEFINE_DYNAMIC_FUNC0(ChartingGridSprite_obj,updateStripes,(void))

int ChartingGridSprite_obj::set_rows(int v){
            	HX_STACKFRAME(&_hx_pos_66fb301aeed14640_110_set_rows)
HXLINE( 111)		this->rows = v;
HXLINE( 112)		this->recalcHeight();
HXLINE( 113)		return this->rows;
            	}
...
int ChartingGridSprite_obj::set_spacing(int v){
            	HX_STACKFRAME(&_hx_pos_66fb301aeed14640_117_set_spacing)
HXLINE( 118)		this->set_rows(v);
...
void ChartingGridSprite_obj::recalcHeight(){
            	HX_STACKFRAME(&_hx_pos_66fb301aeed14640_124_recalcHeight)
HXLINE( 125)		this->set_height(( (Float)((((::states::editors::ChartingState_obj::GRID_SIZE + this->spacing) * this->rows) - this->spacing)) ));
HXLINE( 126)		this->updateStripes();
            	}
...
::hx::Val ChartingGridSprite_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"rows") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_rows(inValue.Cast< int >()) );rows=inValue.Cast< int >(); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"stripe") ) { _hx_set_stripe(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSprite >()); return inValue; }
		break;
	case 7:
		...
		if (HX_FIELD_EQ(inName,"stripes") ) { _hx_set_stripes(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"vortexLine") ) { _hx_set_vortexLine(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSprite >()); return inValue; }
		break;
	case 15:
...
static ::hx::StorageInfo ChartingGridSprite_obj_sMemberStorageInfo[] = {
	{::hx::fsInt,(int)offsetof(ChartingGridSprite_obj,rows),HX_("rows",19,f5,ae,4b)},
