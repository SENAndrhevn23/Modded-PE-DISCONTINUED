...
class MainMenuState extends MusicBeatState
{
	...
	public static var pSliceVersion:String = ''; // Version of P-Slice
	public static var funkinVersion:String = '0.5.3'; // Version of funkin' we are emulating
	public static var psyVersion:String = '0.0.1'; // Version of Modded-PE
	...
	override function create()
	{
		...
		var padding:Float = 8;
		var psyVer:FlxText = new FlxText(padding, FlxG.height - 78 - padding, FlxG.width, 'Modded PE' + psyVersion, 12);
		var psliceVer:FlxText = new FlxText(padding, FlxG.height - 58 - padding, FlxG.width, '${pSliceVersion}', 12);
		...
		psyVer.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		psyVer.scrollFactor.set();
		psliceVer.scrollFactor.set();
		psychVer.scrollFactor.set();
		fnfVer.scrollFactor.set();
		
		psyVer.antialiasing = ClientPrefs.data.antialiasing;
