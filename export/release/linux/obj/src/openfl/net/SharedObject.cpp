...
void SharedObject_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_1b14c676d7ad0011_305_new)
HXLINE( 306)		super::__construct(null());
HXLINE( 308)		this->_hx_set_client(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
...
void SharedObject_obj::clear(){
            	HX_GC_STACKFRAME(&_hx_pos_1b14c676d7ad0011_325_clear)
HXLINE( 326)		this->_hx_set_data(HX_CTX,  ::Dynamic(::hx::Anon_obj::Create(0)));
HXLINE( 328)		try {
...
HXLINE( 720)			sharedObject->_hx_set_data(HX_CTX,  ::Dynamic(::hx::Anon_obj::Create(0)));
HXLINE( 721)			sharedObject->_hx_set__hx___localPath(HX_CTX, localPath);
HXLINE( 722)			sharedObject->_hx_set__hx___name(HX_CTX, name);
...
HXLINE( 730)					sharedObject->_hx_set_data(HX_CTX, unserializer->unserialize());
            				} catch( ::Dynamic _hx_e) {
            					if (_hx_e.IsClass<  ::Dynamic >() ){
            						HX_STACK_BEGIN_CATCH
            						 ::Dynamic _g2 = _hx_e;
...
::hx::Val SharedObject_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"client") ) { _hx_set_client(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__name") ) { _hx_set__hx___name(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"__localPath") ) { _hx_set__hx___localPath(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 14:
