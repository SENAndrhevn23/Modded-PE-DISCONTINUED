...
class HXCPP_CLASS_ATTRIBUTES MovieClip_obj : public  ::openfl::display::Sprite_obj
{
	...
	public:
		...
		inline  ::openfl::display::Scene _hx_set__hx___scene(::hx::StackContext *_hx_ctx, ::openfl::display::Scene _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___scene=_hx_v; }
		 ::openfl::display::Timeline _hx___timeline;
		inline  ::openfl::display::Timeline _hx_set__hx___timeline(::hx::StackContext *_hx_ctx, ::openfl::display::Timeline _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___timeline=_hx_v; }
