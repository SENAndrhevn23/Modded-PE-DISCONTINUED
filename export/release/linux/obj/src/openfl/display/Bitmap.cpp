...
void Bitmap_obj::__construct( ::openfl::display::BitmapData bitmapData, ::Dynamic pixelSnapping,::hx::Null< bool >  __o_smoothing){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_f5857023424199a6_110_new)
HXLINE( 111)		super::__construct();
HXLINE( 113)		this->_hx___drawableType = 2;
HXLINE( 114)		this->_hx_set__hx___bitmapData(HX_CTX, bitmapData);
HXLINE( 115)		this->_hx_set_pixelSnapping(HX_CTX, pixelSnapping);
HXLINE( 116)		this->smoothing = smoothing;
HXLINE( 118)		if (::hx::IsNull( pixelSnapping )) {
HXLINE( 120)			this->_hx_set_pixelSnapping(HX_CTX, 1);
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Bitmap_obj,get_bitmapData,return )
 ...
 ::openfl::display::BitmapData Bitmap_obj::set_bitmapData( ::openfl::display::BitmapData value){
            	HX_GC_STACKFRAME(&_hx_pos_f5857023424199a6_202_set_bitmapData)
HXLINE( 203)		this->_hx_set__hx___bitmapData(HX_CTX, value);
...
::hx::Val Bitmap_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"pixelSnapping") ) { _hx_set_pixelSnapping(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 14:
