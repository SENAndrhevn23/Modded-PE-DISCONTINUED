...
HX_DEFINE_DYNAMIC_FUNC0(AudioBuffer_obj,get_src,return )
 ...
 ::Dynamic AudioBuffer_obj::set_src( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_473_set_src)
HXDLIN( 473)		return (this->_hx_set__hx___srcVorbisFile(HX_CTX, ( ( ::lime::media::vorbis::VorbisFile)(value) )));
            	}
...
HXDLIN( 131)		audioBuffer->_hx_set_data(HX_CTX, this1);
...
HXDLIN( 174)		audioBuffer->_hx_set_data(HX_CTX, this1);
...
HXDLIN( 229)				_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN( 229)					_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN( 229)							_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN( 229)							_this3->_hx_set_buffer(HX_CTX, buffer);
...
HXDLIN( 229)		audioBuffer->_hx_set_data(HX_CTX, this1);
...
HXLINE( 301)		audioBuffer->_hx_set__hx___srcVorbisFile(HX_CTX, vorbisFile);
...
::hx::Val AudioBuffer_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"__srcHowl") ) { _hx_set__hx___srcHowl(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"sampleRate") ) { sampleRate=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__srcAudio") ) { _hx_set__hx___srcAudio(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__srcSound") ) { _hx_set__hx___srcSound(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"__srcBuffer") ) { _hx_set__hx___srcBuffer(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__srcCustom") ) { _hx_set__hx___srcCustom(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"bitsPerSample") ) { bitsPerSample=inValue.Cast< int >(); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"__srcVorbisFile") ) { _hx_set__hx___srcVorbisFile(HX_CTX_GET,inValue.Cast<  ::lime::media::vorbis::VorbisFile >()); return inValue; }
	}
