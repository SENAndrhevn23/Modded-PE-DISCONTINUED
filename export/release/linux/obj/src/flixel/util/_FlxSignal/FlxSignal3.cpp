...
void FlxSignal3_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_540d1a6e6f832f77_251_new)
HXLINE( 252)		super::__construct();
HXLINE( 253)		this->_hx_set_dispatch(HX_CTX, this->dispatch3_dyn());
            	}
...
void FlxSignal3_obj::dispatch3( ::Dynamic value1, ::Dynamic value2, ::Dynamic value3){
            	HX_GC_STACKFRAME(&_hx_pos_540d1a6e6f832f77_293_dispatch3)
