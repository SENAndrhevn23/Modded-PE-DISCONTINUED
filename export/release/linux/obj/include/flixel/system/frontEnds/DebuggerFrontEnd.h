...
class HXCPP_CLASS_ATTRIBUTES DebuggerFrontEnd_obj : public ::hx::Object
{
	...
	public:
		...
		inline ::Array< int > _hx_set_toggleKeys(::hx::StackContext *_hx_ctx,::Array< int > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return toggleKeys=_hx_v; }
		bool drawDebug;
		 ::flixel::util::_FlxSignal::FlxSignal0 drawDebugChanged;
		inline  ::flixel::util::_FlxSignal::FlxSignal0 _hx_set_drawDebugChanged(::hx::StackContext *_hx_ctx, ::flixel::util::_FlxSignal::FlxSignal0 _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return drawDebugChanged=_hx_v; }
		 ::flixel::util::_FlxSignal::FlxSignal0 visibilityChanged;
		inline  ::flixel::util::_FlxSignal::FlxSignal0 _hx_set_visibilityChanged(::hx::StackContext *_hx_ctx, ::flixel::util::_FlxSignal::FlxSignal0 _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return visibilityChanged=_hx_v; }
		bool visible;
