...
void FlxTypedPathfinder_obj::__construct( ::Dynamic factory){
            	HX_GC_STACKFRAME(&_hx_pos_eed5c81c71278288_46_new)
HXDLIN(  46)		this->_hx_set_createData(HX_CTX, factory);
            	}
...
::hx::Val FlxTypedPathfinder_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 10:
		if (HX_FIELD_EQ(inName,"createData") ) { _hx_set_createData(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
