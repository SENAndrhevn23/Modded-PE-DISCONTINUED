...
class HXCPP_CLASS_ATTRIBUTES DisplayObjectContainer_obj : public  ::openfl::display::InteractiveObject_obj
{
	...
	public:
		...
		inline  ::openfl::_Vector::ObjectVector _hx_set__hx___removedChildren(::hx::StackContext *_hx_ctx, ::openfl::_Vector::ObjectVector _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___removedChildren=_hx_v; }
