...
class HXCPP_CLASS_ATTRIBUTES ResetScoreSubState_obj : public  ::backend::MusicBeatSubstate_obj
{
	...
	public:
		...
		inline ::Array< ::Dynamic> _hx_set_alphabetArray(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return alphabetArray=_hx_v; }
		...
		inline  ::objects::Alphabet _hx_set_yesText(::hx::StackContext *_hx_ctx, ::objects::Alphabet _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return yesText=_hx_v; }
		 ::objects::Alphabet noText;
		inline  ::objects::Alphabet _hx_set_noText(::hx::StackContext *_hx_ctx, ::objects::Alphabet _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return noText=_hx_v; }
		::String song;
