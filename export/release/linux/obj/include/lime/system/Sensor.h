...
class HXCPP_CLASS_ATTRIBUTES Sensor_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::lime::app::_Event_Float_Float_Float_Void _hx_set_onUpdate(::hx::StackContext *_hx_ctx, ::lime::app::_Event_Float_Float_Float_Void _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onUpdate=_hx_v; }
		 ::lime::_hx_system::SensorType type;
		inline  ::lime::_hx_system::SensorType _hx_set_type(::hx::StackContext *_hx_ctx, ::lime::_hx_system::SensorType _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return type=_hx_v; }
};
