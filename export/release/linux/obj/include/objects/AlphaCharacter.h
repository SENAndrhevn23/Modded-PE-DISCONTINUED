...
class HXCPP_CLASS_ATTRIBUTES AlphaCharacter_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		inline  ::objects::Alphabet _hx_set_parent(::hx::StackContext *_hx_ctx, ::objects::Alphabet _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return parent=_hx_v; }
		Float alignOffset;
		::Array< Float > letterOffset;
		inline ::Array< Float > _hx_set_letterOffset(::hx::StackContext *_hx_ctx,::Array< Float > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return letterOffset=_hx_v; }
		int row;
		Float rowWidth;
		::String character;
		inline ::String _hx_set_character(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return character=_hx_v; }
		 ::Dynamic curLetter;
		inline  ::Dynamic _hx_set_curLetter(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return curLetter=_hx_v; }
