...
HXLINE( 161)		this->_hx_set_list(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE( 162)		this->_hx_set__inactiveTouches(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE( 163)		this->_hx_set__touchesCache(HX_CTX,  ::haxe::ds::IntMap_obj::__alloc( HX_CTX ));
...
void FlxTouchManager_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_267129cd6cd94d38_62_destroy)
HXLINE(  63)		{
HXLINE(  63)			int _g = 0;
...
HXLINE(  67)		this->_hx_set_list(HX_CTX, null());
HXLINE(  69)		{
HXLINE(  69)			int _g2 = 0;
HXDLIN(  69)			::Array< ::Dynamic> _g3 = this->_inactiveTouches;
HXDLIN(  69)			while((_g2 < _g3->length)){
HXLINE(  69)				 ::flixel::input::touch::FlxTouch touch1 = _g3->__get(_g2).StaticCast<  ::flixel::input::touch::FlxTouch >();
HXDLIN(  69)				_g2 = (_g2 + 1);
HXLINE(  71)				touch1->destroy();
            			}
            		}
HXLINE(  73)		this->_hx_set__inactiveTouches(HX_CTX, null());
HXLINE(  75)		this->_hx_set__touchesCache(HX_CTX, null());
            	}
...
::hx::Val FlxTouchManager_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"_touchesCache") ) { _hx_set__touchesCache(HX_CTX_GET,inValue.Cast<  ::haxe::ds::IntMap >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"_inactiveTouches") ) { _hx_set__inactiveTouches(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
