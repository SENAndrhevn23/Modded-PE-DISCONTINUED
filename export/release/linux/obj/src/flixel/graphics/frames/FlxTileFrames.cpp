...
HXDLIN( 527)		tileFrames->_hx_set_region(HX_CTX, _this1);
HXLINE( 528)		tileFrames->_hx_set_atlasFrame(HX_CTX, this->atlasFrame);
HXLINE( 529)		tileFrames->_hx_set_tileSize(HX_CTX, resultSize);
...
HXDLIN( 530)		tileFrames->_hx_set_tileSpacing(HX_CTX, this5);
HXLINE( 532)		{
HXLINE( 532)			int _g = 0;
...
void FlxTileFrames_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_43be537ea661b39f_541_destroy)
HXLINE( 542)		this->super::destroy();
HXLINE( 543)		this->_hx_set_atlasFrame(HX_CTX, null());
HXLINE( 544)		this->_hx_set_region(HX_CTX, ( ( ::flixel::math::FlxRect)(::flixel::util::FlxDestroyUtil_obj::put(this->region)) ));
HXLINE( 545)		this->_hx_set_tileSize(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->tileSize)) ));
HXLINE( 546)		this->_hx_set_tileSpacing(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->tileSpacing)) ));
            	}
...
HXLINE( 142)		tileFrames->_hx_set_atlasFrame(HX_CTX, frame);
HXLINE( 143)		tileFrames->_hx_set_region(HX_CTX, frame->frame);
HXLINE( 144)		tileFrames->_hx_set_tileSize(HX_CTX, tileSize);
HXLINE( 145)		tileFrames->_hx_set_tileSpacing(HX_CTX, tileSpacing);
HXLINE( 147)		{
...
HXLINE( 199)		tileFrames->_hx_set_region(HX_CTX, null());
HXLINE( 200)		tileFrames->_hx_set_atlasFrame(HX_CTX, null());
...
HXDLIN( 201)		tileFrames->_hx_set_tileSize(HX_CTX, this1);
...
HXDLIN( 202)		tileFrames->_hx_set_tileSpacing(HX_CTX, point2);
...
HXLINE( 284)		tileFrames->_hx_set_region(HX_CTX, region);
HXLINE( 285)		tileFrames->_hx_set_atlasFrame(HX_CTX, null());
HXLINE( 286)		tileFrames->_hx_set_tileSize(HX_CTX, tileSize);
HXLINE( 287)		tileFrames->_hx_set_tileSpacing(HX_CTX, tileSpacing);
HXLINE( 289)		{
...
HXDLIN( 430)		result->_hx_set_region(HX_CTX, rect);
HXLINE( 431)		result->_hx_set_atlasFrame(HX_CTX, null());
...
HXDLIN( 432)		result->_hx_set_tileSize(HX_CTX, point);
...
HXDLIN( 433)		result->_hx_set_tileSpacing(HX_CTX, point1);
...
::hx::Val FlxTileFrames_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"region") ) { _hx_set_region(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxRect >()); return inValue; }
		break;
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"tileSize") ) { _hx_set_tileSize(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"atlasFrame") ) { _hx_set_atlasFrame(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::frames::FlxFrame >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"tileSpacing") ) { _hx_set_tileSpacing(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
	}
