...
#include <mikolka/stages/standard/HenchmenKillState.h>
#endif
...
#endif
#ifndef INCLUDED___ASSET__assets_embed_images_psych_ui_copystate_ignore_txt
#include <__ASSET__assets_embed_images_psych_ui_copystate_ignore_txt.h>
#endif
...
#endif
#ifndef INCLUDED___ASSET__OPENFL__assets_fonts_fps_ttf
#include <__ASSET__OPENFL__assets_fonts_fps_ttf.h>
#endif
...
#endif
#ifndef INCLUDED___ASSET__assets_fonts_inconsolata_bold_ttf
#include <__ASSET__assets_fonts_inconsolata_bold_ttf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_5by7_ttf
#include <__ASSET__assets_fonts_5by7_ttf.h>
#endif
#ifndef INCLUDED___ASSET__assets_fonts_inconsolata_black_ttf
#include <__ASSET__assets_fonts_inconsolata_black_ttf.h>
#endif
...
#endif
#ifndef INCLUDED___ASSET__assets_fonts_fps_ttf
#include <__ASSET__assets_fonts_fps_ttf.h>
#endif
...
::substates::PauseType_obj::__register();
::substates::PauseSpecialAction_obj::__register();
::states::stages::objects::SpraycanState_obj::__register();
::shaders::WiggleEffectType_obj::__register();
...
::objects::PopupType_obj::__register();
::objects::Alignment_obj::__register();
::mikolka::vslice::freeplay::obj::IconType_obj::__register();
::mikolka::vslice::freeplay::FreeplayDJState_obj::__register();
::mikolka::vslice::charSelect::FadeStatus_obj::__register();
::mikolka::vslice::FunkinPreloaderState_obj::__register();
::mikolka::stages::standard::HenchmenKillState_obj::__register();
::mikolka::stages::erect::HenchmenKillState_obj::__register();
::mikolka::stages::NeneState_obj::__register();
::mikolka::funkin::utils::FileWriteMode_obj::__register();
::mikolka::funkin::Case_obj::__register();
...
::funkin::vis::dsp::MathType_obj::__register();
...
::flixel::text::WordSplitConditions_obj::__register();
::flixel::text::Wrap_obj::__register();
...
::substates::StickerSubState_obj::__register();
...
::objects::_Note::Note_Fields__obj::__register();
...
::mobile::input::_MobileInputID::MobileInputID_Impl__obj::__register();
::mobile::backend::StorageUtil_obj::__register();
::mobile::backend::MobileScaleMode_obj::__register();
::mikolka::vslice::freeplay::pslice::BPMCache_obj::__register();
::mikolka::vslice::freeplay::FreeplayState_obj::__register();
::mikolka::vslice::freeplay::FreeplayDJ_obj::__register();
::mikolka::vslice::components::ScreenshotPlugin_obj::__register();
::mikolka::vslice::FunkinPreloader_obj::__register();
::mikolka::vslice::LogoImage_obj::__register();
::mikolka::stages::PicoCapableStage_obj::__register();
::mikolka::funkin::utils::MemoryUtil_obj::__register();
::mikolka::funkin::utils::MathUtil_obj::__register();
::mikolka::funkin::players::Save_obj::__register();
::mikolka::funkin::players::PlayerRegistry_obj::__register();
::mikolka::funkin::freeplay::album::AlbumRegistry_obj::__register();
::mikolka::funkin::freeplay::FreeplayStyleRegistry_obj::__register();
::mikolka::funkin::_Scoring::ScoringRank_Impl__obj::__register();
::mikolka::funkin::IntervalShake_obj::__register();
::mikolka::funkin::FlxAtlasSprite_obj::__register();
::mikolka::funkin::Constants_obj::__register();
::mikolka::funkin::_AtlasText::AtlasFontData_obj::__register();
::mikolka::funkin::AtlasText_obj::__register();
::mikolka::editors::editorProps::HelpSubstate_obj::__register();
::mikolka::compatibility::FreeplayHelpers_obj::__register();
...
::grig::audio::FFT_obj::__register();
::funkin::vis::dsp::_hx__Complex::Complex_Impl__obj::__register();
...
::backend::SongJson_obj::__register();
...
::__ASSET__assets_embed_images_psych_ui_copystate_ignore_txt_obj::__register();
...
::substates::StickerInfo_obj::__register();
::substates::StickerSprite_obj::__register();
...
::states::editors::ResultPreviewMenu_obj::__register();
...
::shaders::VFDOverlay_obj::__register();
::shaders::StrokeShader_obj::__register();
::shaders::RGBPaletteShader_obj::__register();
::shaders::RGBShaderReference_obj::__register();
::shaders::RGBPalette_obj::__register();
::shaders::PureColor_obj::__register();
::shaders::PulseShader_obj::__register();
::shaders::PulseEffect_obj::__register();
::shaders::MosaicEffect_obj::__register();
::shaders::LeftMaskShader_obj::__register();
::shaders::HSVShader_obj::__register();
::shaders::Grayscale_obj::__register();
::shaders::GaussianBlurShader_obj::__register();
::shaders::ColorSwapShader_obj::__register();
::shaders::ColorSwap_obj::__register();
::shaders::BlueFade_obj::__register();
::shaders::AngleMask_obj::__register();
::shaders::AdjustColorShader_obj::__register();
...
::options::OptimizeSettingsSubState_obj::__register();
...
::options::GameRendererSettingsSubState_obj::__register();
::options::BaseGameSubState_obj::__register();
...
::objects::SustainSplash_obj::__register();
::objects::StrumNote_obj::__register();
::objects::Popup_obj::__register();
::objects::PixelSplashShader_obj::__register();
::shaders::flixel::_hx_system::FlxShader_obj::__register();
::objects::PixelSplashShaderRef_obj::__register();
::objects::NoteGroup_obj::__register();
...
::mobile::options::MobileOptionsSubState_obj::__register();
::options::BaseOptionsMenu_obj::__register();
::mobile::backend::TouchUtil_obj::__register();
::mobile::backend::SwipeUtil_obj::__register();
::mikolka::vslice::results::TallyNumber_obj::__register();
::mikolka::vslice::results::TallyCounter_obj::__register();
::mikolka::vslice::results::_Tallies::Tallies_Impl__obj::__register();
::mikolka::vslice::results::ResultState_obj::__register();
::mikolka::vslice::results::ScoreNum_obj::__register();
::mikolka::vslice::results::ResultScore_obj::__register();
::mikolka::vslice::results::ClearPercentNumber_obj::__register();
::mikolka::vslice::results::ClearPercentCounter_obj::__register();
::mikolka::vslice::freeplay::pslice::FreeplayColorTweener_obj::__register();
::mikolka::vslice::freeplay::obj::PixelatedIcon_obj::__register();
::mikolka::vslice::freeplay::obj::FreeplayFlames_obj::__register();
::mikolka::vslice::freeplay::obj::InstrumentalSelector_obj::__register();
::mikolka::vslice::freeplay::obj::CapsuleOptionsMenu_obj::__register();
::mikolka::vslice::freeplay::backcards::PicoCard_obj::__register();
::mikolka::vslice::freeplay::backcards::NewCharacterCard_obj::__register();
::mikolka::vslice::freeplay::backcards::BoyfriendCard_obj::__register();
::mikolka::vslice::freeplay::backcards::BackingCard_obj::__register();
::mikolka::vslice::freeplay::CapsuleNumber_obj::__register();
::mikolka::vslice::freeplay::FreeplayRank_obj::__register();
::mikolka::vslice::freeplay::SongMenuItem_obj::__register();
::mikolka::vslice::freeplay::FreeplayLetter_obj::__register();
::mikolka::vslice::freeplay::LetterSort_obj::__register();
::mikolka::vslice::freeplay::DifficultySelector_obj::__register();
::mikolka::vslice::freeplay::ScoreNum_obj::__register();
::mikolka::vslice::freeplay::FreeplayScore_obj::__register();
::mikolka::vslice::freeplay::DifficultyStars_obj::__register();
::mikolka::vslice::freeplay::DifficultySprite_obj::__register();
::mikolka::vslice::freeplay::CapsuleText_obj::__register();
::mikolka::vslice::freeplay::BGScrollingText_obj::__register();
::mikolka::vslice::freeplay::AlbumRoll_obj::__register();
::mikolka::vslice::components::crash::UserErrorSubstate_obj::__register();
::mikolka::vslice::components::FunkinSoundTray_obj::__register();
::mikolka::vslice::components::ALSoftConfig_obj::__register();
::mikolka::vslice::charSelect::pslice::ModSelector_obj::__register();
::mikolka::vslice::charSelect::Nametag_obj::__register();
::mikolka::vslice::charSelect::Lock_obj::__register();
::mikolka::vslice::charSelect::CharSelectSubState_obj::__register();
::mikolka::vslice::charSelect::CharSelectPlayer_obj::__register();
::mikolka::vslice::charSelect::CharSelectGF_obj::__register();
::mikolka::vslice::CrashState_obj::__register();
::mikolka::vslice::AttractState_obj::__register();
::mikolka::stages::standard::Tank_obj::__register();
::mikolka::stages::standard::StageWeek1_obj::__register();
::mikolka::stages::standard::Spooky_obj::__register();
::mikolka::stages::standard::SchoolEvil_obj::__register();
::mikolka::stages::standard::School_obj::__register();
::mikolka::stages::standard::PhillyStreets_obj::__register();
::mikolka::stages::standard::PhillyBlazin_obj::__register();
::mikolka::stages::standard::Philly_obj::__register();
::mikolka::stages::standard::MallEvil_obj::__register();
::mikolka::stages::standard::Mall_obj::__register();
::mikolka::stages::standard::Limo_obj::__register();
::mikolka::stages::objects::PicoDopplegangerSprite_obj::__register();
::mikolka::stages::erect::SpookyMansionErect_obj::__register();
::mikolka::stages::erect::PhillyTrainErect_obj::__register();
::mikolka::stages::erect::PhillyStreetsErect_obj::__register();
::mikolka::stages::erect::MallXmasErect_obj::__register();
::mikolka::stages::erect::MainStageErect_obj::__register();
::mikolka::stages::erect::LimoRideErect_obj::__register();
::mikolka::funkin::utils::StringTools_obj::__register();
::mikolka::funkin::utils::SortUtil_obj::__register();
::mikolka::funkin::utils::FileUtil_obj::__register();
::mikolka::funkin::utils::DateUtil_obj::__register();
::mikolka::funkin::utils::ArrayTools_obj::__register();
::mikolka::funkin::players::FakeCharArray_obj::__register();
::mikolka::funkin::players::PlayerFreeplayDJData_obj::__register();
::mikolka::funkin::players::PlayerData_obj::__register();
::mikolka::funkin::players::PlayableCharacter_obj::__register();
::mikolka::funkin::freeplay::album::AlbumData_obj::__register();
::mikolka::funkin::freeplay::album::Album_obj::__register();
::mikolka::funkin::freeplay::FreeplayStyle_obj::__register();
::mikolka::funkin::custom::VsliceSubState_obj::__register();
::mikolka::funkin::custom::PsliceRegistry_obj::__register();
::mikolka::funkin::custom::FunkinTools_obj::__register();
::mikolka::funkin::custom::FreeplayMeta_obj::__register();
::mikolka::funkin::custom::FreeplayMetaJSON_obj::__register();
::mikolka::funkin::Scoring_obj::__register();
::mikolka::funkin::IteratorTools_obj::__register();
::mikolka::funkin::FunkinSprite_obj::__register();
::mikolka::funkin::FunkinSound_obj::__register();
::mikolka::funkin::FramesJSFLParser_obj::__register();
::mikolka::funkin::FlxAnimateFilterRenderer_obj::__register();
::mikolka::funkin::FlxFilteredSprite_obj::__register();
::mikolka::funkin::AtlasChar_obj::__register();
::mikolka::editors::editorProps::FreeplayEditSubstate_obj::__register();
::mikolka::editors::editorProps::DJAnimPreview_obj::__register();
::mikolka::editors::editorProps::JsonDJ_obj::__register();
::mikolka::editors::editorProps::CharJson_obj::__register();
::mikolka::editors::editorProps::CharIconGrid_obj::__register();
::mikolka::editors::editorProps::AnimPreview_obj::__register();
::mikolka::editors::StickerTest_obj::__register();
::mikolka::editors::CharSelectEditor_obj::__register();
::mikolka::compatibility::VsliceOptions_obj::__register();
::mikolka::compatibility::ModsHelper_obj::__register();
::mikolka::compatibility::FunkinPath_obj::__register();
::mikolka::compatibility::FunkinControls_obj::__register();
::mikolka::compatibility::FunkinCamera_obj::__register();
::mikolka::compatibility::FreeplaySongData_obj::__register();
::mikolka::JoinedLuaVariables_obj::__register();
...
::lime::_hx_system::_ThreadPool::JobQueue_Impl__obj::__register();
::lime::_hx_system::_ThreadPool::JobArrayIterator_obj::__register();
::lime::_hx_system::_ThreadPool::JobArray_obj::__register();
...
::lime::app::_Event_lime_system_Orientation_Void_obj::__register();
::lime::app::_Event_lime_graphics_RenderContext_Void_obj::__register();
::lime::app::_Event_haxe_Exception_Void_obj::__register();
...
::lime::app::_Event_Int_lime_system_Orientation_Void_obj::__register();
...
::lime::app::Promise_Int_obj::__register();
...
::lime::_internal::backend::native::OrientationEventInfo_obj::__register();
...
::hxcodec::flixel::FlxVideoSprite_obj::__register();
...
::grig::audio::lime::UInt8ArrayTools_obj::__register();
::grig::audio::FFTVisualization_obj::__register();
::grig::audio::_hx__Complex::Complex_Impl__obj::__register();
::funkin::vis::dsp::SpectralAnalyzer_obj::__register();
::funkin::vis::dsp::Signal_obj::__register();
::funkin::vis::dsp::RecentPeakFinder_obj::__register();
::funkin::vis::dsp::_OffsetArray::OffsetArrayIterator_obj::__register();
::funkin::vis::dsp::_OffsetArray::OffsetArray_Impl__obj::__register();
::funkin::vis::dsp::FFT_obj::__register();
::funkin::vis::audioclip::frontends::LimeAudioClip_obj::__register();
::funkin::vis::_internal::html5::AnalyzerNode_obj::__register();
::funkin::vis::AudioClip_obj::__register();
::funkin::vis::AudioBuffer_obj::__register();
::funkin::util::flixel::sound::FlxPartialSound_obj::__register();
...
::backend::CrashHandler_obj::__register();
...
::__ASSET__OPENFL__assets_fonts_inconsolata_bold_ttf_obj::__register();
::__ASSET__OPENFL__assets_fonts_5by7_ttf_obj::__register();
::__ASSET__OPENFL__assets_fonts_inconsolata_black_ttf_obj::__register();
...
::__ASSET__OPENFL__assets_fonts_fps_ttf_obj::__register();
::__ASSET__assets_fonts_pixel_latin_ttf_obj::__register();
::__ASSET__assets_fonts_ds_digi_ttf_obj::__register();
::__ASSET__assets_fonts_inconsolata_bold_ttf_obj::__register();
::__ASSET__assets_fonts_5by7_ttf_obj::__register();
::__ASSET__assets_fonts_inconsolata_black_ttf_obj::__register();
...
::__ASSET__assets_fonts_fps_ttf_obj::__register();
...
::substates::PauseType_obj::__boot();
::substates::PauseSpecialAction_obj::__boot();
::states::stages::objects::SpraycanState_obj::__boot();
::shaders::WiggleEffectType_obj::__boot();
...
::objects::PopupType_obj::__boot();
::objects::Alignment_obj::__boot();
::mikolka::vslice::freeplay::obj::IconType_obj::__boot();
::mikolka::vslice::freeplay::FreeplayDJState_obj::__boot();
::mikolka::vslice::charSelect::FadeStatus_obj::__boot();
::mikolka::vslice::FunkinPreloaderState_obj::__boot();
::mikolka::stages::standard::HenchmenKillState_obj::__boot();
::mikolka::stages::erect::HenchmenKillState_obj::__boot();
::mikolka::stages::NeneState_obj::__boot();
::mikolka::funkin::utils::FileWriteMode_obj::__boot();
::mikolka::funkin::Case_obj::__boot();
...
::funkin::vis::dsp::MathType_obj::__boot();
...
::flixel::text::WordSplitConditions_obj::__boot();
::flixel::text::Wrap_obj::__boot();
...
::__ASSET__assets_embed_images_psych_ui_copystate_ignore_txt_obj::__boot();
...
::funkin::vis::dsp::_hx__Complex::Complex_Impl__obj::__boot();
::grig::audio::FFT_obj::__boot();
...
::mikolka::compatibility::FreeplayHelpers_obj::__boot();
::mikolka::editors::editorProps::HelpSubstate_obj::__boot();
::mikolka::funkin::AtlasText_obj::__boot();
::mikolka::funkin::_AtlasText::AtlasFontData_obj::__boot();
::mikolka::funkin::Constants_obj::__boot();
::mikolka::funkin::FlxAtlasSprite_obj::__boot();
::mikolka::funkin::IntervalShake_obj::__boot();
::mikolka::funkin::_Scoring::ScoringRank_Impl__obj::__boot();
::mikolka::funkin::freeplay::FreeplayStyleRegistry_obj::__boot();
::mikolka::funkin::freeplay::album::AlbumRegistry_obj::__boot();
::mikolka::funkin::players::PlayerRegistry_obj::__boot();
::mikolka::funkin::players::Save_obj::__boot();
::mikolka::funkin::utils::MathUtil_obj::__boot();
::mikolka::funkin::utils::MemoryUtil_obj::__boot();
::mikolka::stages::PicoCapableStage_obj::__boot();
::mikolka::vslice::LogoImage_obj::__boot();
::mikolka::vslice::FunkinPreloader_obj::__boot();
::mikolka::vslice::components::ScreenshotPlugin_obj::__boot();
::mikolka::vslice::freeplay::FreeplayDJ_obj::__boot();
::mikolka::vslice::freeplay::FreeplayState_obj::__boot();
::mikolka::vslice::freeplay::pslice::BPMCache_obj::__boot();
::mobile::backend::MobileScaleMode_obj::__boot();
::mobile::backend::StorageUtil_obj::__boot();
::mobile::input::_MobileInputID::MobileInputID_Impl__obj::__boot();
::objects::Alphabet_obj::__boot();
::objects::Character_obj::__boot();
::objects::MenuCharacter_obj::__boot();
::objects::Note_obj::__boot();
::objects::_Note::Note_Fields__obj::__boot();
...
::options::GameplayChangersSubstate_obj::__boot();
::options::GameplaySettingsSubState_obj::__boot();
::options::OptionsState_obj::__boot();
::options::VisualsSettingsSubState_obj::__boot();
...
::states::ModsMenuState_obj::__boot();
...
::substates::StickerSubState_obj::__boot();
::sys::Http_obj::__boot();
