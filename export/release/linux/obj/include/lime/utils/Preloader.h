...
class HXCPP_CLASS_ATTRIBUTES Preloader_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::lime::app::_Event_Int_Int_Void _hx_set_onProgress(::hx::StackContext *_hx_ctx, ::lime::app::_Event_Int_Int_Void _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onProgress=_hx_v; }
		int bytesLoaded;
		 ::haxe::ds::ObjectMap bytesLoadedCache;
		inline  ::haxe::ds::ObjectMap _hx_set_bytesLoadedCache(::hx::StackContext *_hx_ctx, ::haxe::ds::ObjectMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return bytesLoadedCache=_hx_v; }
		 ::haxe::ds::StringMap bytesLoadedCache2;
		inline  ::haxe::ds::StringMap _hx_set_bytesLoadedCache2(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return bytesLoadedCache2=_hx_v; }
		int bytesTotal;
		 ::haxe::ds::StringMap bytesTotalCache;
		inline  ::haxe::ds::StringMap _hx_set_bytesTotalCache(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return bytesTotalCache=_hx_v; }
		bool initLibraryNames;
		::Array< ::Dynamic> libraries;
		inline ::Array< ::Dynamic> _hx_set_libraries(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return libraries=_hx_v; }
		::Array< ::String > libraryNames;
		inline ::Array< ::String > _hx_set_libraryNames(::hx::StackContext *_hx_ctx,::Array< ::String > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return libraryNames=_hx_v; }
		int loadedLibraries;
		bool loadedStage;
