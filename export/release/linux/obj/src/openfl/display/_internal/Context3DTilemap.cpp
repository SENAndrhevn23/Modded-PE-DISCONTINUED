...
HXDLIN(  94)		getLength->setCtx( HX_CTX, 0, ::Dynamic(new _hx_Closure_0(getLength)));
...
HXLINE( 634)			tilemap->_hx_set__hx___buffer(HX_CTX,  ::openfl::display::_internal::Context3DBuffer_obj::__alloc( HX_CTX ,::openfl::display::_internal::Context3DTilemap_obj::context,::openfl::display::_internal::Context3DElementType_obj::QUADS_dyn(),::openfl::display::_internal::Context3DTilemap_obj::numTiles,::openfl::display::_internal::Context3DTilemap_obj::dataPerVertex));
            		}
            		else {
