...
void TJSONEncoder_obj::__construct(::hx::Null< bool >  __o_useCache){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_6541b35aed1f76b2_358_new)
HXLINE( 359)		this->uCache = useCache;
HXLINE( 360)		if (this->uCache) {
HXLINE( 360)			this->_hx_set_cache(HX_CTX, ::cpp::VirtualArray_obj::__new());
            		}
            	}
...
HXLINE( 377)				buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            			}
            			else {
...
HXLINE( 380)					buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1)));
            				}
            				else {
...
HXLINE( 383)						buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2)));
            					}
            					else {
...
HXLINE( 390)				buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            			}
            			else {
...
HXLINE( 404)							buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1)));
            						}
            						else {
...
HXLINE( 405)							buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2)));
            						}
            						else {
...
HXLINE( 406)							buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3)));
            						}
            						else {
...
HXLINE( 407)							buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4)));
            						}
            						else {
...
HXLINE( 420)							buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x5)));
            						}
            						else {
...
HXLINE( 421)							buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x6)));
            						}
            						else {
...
HXLINE( 422)							buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x7)));
            						}
            						else {
...
HXLINE( 429)				buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x8)));
            			}
            			else {
...
HXLINE( 436)				buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            			}
            			else {
...
HXLINE( 439)						buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1)));
            					}
            					else {
...
HXLINE( 440)						buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2)));
            					}
            					else {
...
HXLINE( 442)						buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3)));
            					}
            					else {
...
HXLINE( 443)						buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4)));
            					}
            					else {
...
HXLINE( 445)				buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x5)));
            			}
            			else {
...
HXLINE( 452)				buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            			}
            			else {
...
HXLINE( 455)						buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1)));
            					}
            					else {
...
HXLINE( 456)						buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2)));
            					}
            					else {
...
HXLINE( 457)						buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3)));
            					}
            					else {
...
HXLINE( 460)				buffer->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4)));
            			}
            			else {
