...
class HXCPP_CLASS_ATTRIBUTES FlxQuadTree_obj : public  ::flixel::math::FlxRect_obj
{
	...
	public:
		...
		inline  ::flixel::_hx_system::FlxLinkedList _hx_set__headA(::hx::StackContext *_hx_ctx, ::flixel::_hx_system::FlxLinkedList _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _headA=_hx_v; }
		 ::flixel::_hx_system::FlxLinkedList _tailA;
		inline  ::flixel::_hx_system::FlxLinkedList _hx_set__tailA(::hx::StackContext *_hx_ctx, ::flixel::_hx_system::FlxLinkedList _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _tailA=_hx_v; }
		 ::flixel::_hx_system::FlxLinkedList _headB;
		inline  ::flixel::_hx_system::FlxLinkedList _hx_set__headB(::hx::StackContext *_hx_ctx, ::flixel::_hx_system::FlxLinkedList _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _headB=_hx_v; }
		 ::flixel::_hx_system::FlxLinkedList _tailB;
		inline  ::flixel::_hx_system::FlxLinkedList _hx_set__tailB(::hx::StackContext *_hx_ctx, ::flixel::_hx_system::FlxLinkedList _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _tailB=_hx_v; }
		 ::flixel::_hx_system::FlxQuadTree _northWestTree;
		inline  ::flixel::_hx_system::FlxQuadTree _hx_set__northWestTree(::hx::StackContext *_hx_ctx, ::flixel::_hx_system::FlxQuadTree _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _northWestTree=_hx_v; }
		 ::flixel::_hx_system::FlxQuadTree _northEastTree;
		inline  ::flixel::_hx_system::FlxQuadTree _hx_set__northEastTree(::hx::StackContext *_hx_ctx, ::flixel::_hx_system::FlxQuadTree _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _northEastTree=_hx_v; }
		 ::flixel::_hx_system::FlxQuadTree _southEastTree;
		inline  ::flixel::_hx_system::FlxQuadTree _hx_set__southEastTree(::hx::StackContext *_hx_ctx, ::flixel::_hx_system::FlxQuadTree _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _southEastTree=_hx_v; }
		 ::flixel::_hx_system::FlxQuadTree _southWestTree;
		inline  ::flixel::_hx_system::FlxQuadTree _hx_set__southWestTree(::hx::StackContext *_hx_ctx, ::flixel::_hx_system::FlxQuadTree _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _southWestTree=_hx_v; }
		Float _leftEdge;
		Float _rightEdge;
		Float _topEdge;
		Float _bottomEdge;
		...
		inline  ::flixel::_hx_system::FlxQuadTree _hx_set_next(::hx::StackContext *_hx_ctx, ::flixel::_hx_system::FlxQuadTree _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return next=_hx_v; }
