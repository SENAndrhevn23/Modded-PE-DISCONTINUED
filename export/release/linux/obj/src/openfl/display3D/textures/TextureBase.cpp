...
HXLINE(  64)		this->_hx_set__hx___context(HX_CTX, context);
HXLINE(  65)		 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = this->_hx___context->gl;
HXLINE(  68)		this->_hx_set__hx___textureID(HX_CTX, gl->createTexture());
HXLINE(  69)		this->_hx_set__hx___textureContext(HX_CTX, this->_hx___context->_hx___context);
...
void TextureBase_obj::dispose(){
            	HX_GC_STACKFRAME(&_hx_pos_6659164148434b5e_150_dispose)
...
HXLINE( 180)			this->_hx_set__hx___glStencilRenderbuffer(HX_CTX, null());
            		}
            	}
...
HXLINE( 191)			this->_hx_set__hx___glFramebuffer(HX_CTX, gl->createFramebuffer());
...
HXLINE( 212)				this->_hx_set__hx___glDepthRenderbuffer(HX_CTX, gl->createRenderbuffer());
HXLINE( 213)				this->_hx_set__hx___glStencilRenderbuffer(HX_CTX, this->_hx___glDepthRenderbuffer);
...
HXLINE( 221)				this->_hx_set__hx___glDepthRenderbuffer(HX_CTX, gl->createRenderbuffer());
HXLINE( 222)				this->_hx_set__hx___glStencilRenderbuffer(HX_CTX, gl->createRenderbuffer());
...
HXLINE( 371)				this->_hx_set__hx___samplerState(HX_CTX, state->clone());
            			}
...
::hx::Val TextureBase_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"__textureID") ) { _hx_set__hx___textureID(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"__alphaTexture") ) { _hx_set__hx___alphaTexture(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::textures::TextureBase >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__samplerState") ) { _hx_set__hx___samplerState(HX_CTX_GET,inValue.Cast<  ::openfl::display::_internal::SamplerState >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"__glFramebuffer") ) { _hx_set__hx___glFramebuffer(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
	...
	case 17:
		...
		break;
	case 21:
		if (HX_FIELD_EQ(inName,"__glDepthRenderbuffer") ) { _hx_set__hx___glDepthRenderbuffer(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 23:
		if (HX_FIELD_EQ(inName,"__glStencilRenderbuffer") ) { _hx_set__hx___glStencilRenderbuffer(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 28:
