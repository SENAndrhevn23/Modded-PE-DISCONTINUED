...
HX_LOCAL_STACK_FRAME(_hx_pos_c165ffff73ee1fcf_44_update,"states.ErrorState","update",0x5a8c5c62,"states.ErrorState.update","states/ErrorState.hx",44,0xd8622448)
namespace states{

void ErrorState_obj::__construct(::String error, ::Dynamic accept, ::Dynamic back){
            	HX_GC_STACKFRAME(&_hx_pos_c165ffff73ee1fcf_3_new)
HXLINE(  18)		this->errorSine = ((Float)0);
HXLINE(  11)		this->_hx_set_errorMsg(HX_CTX, error);
HXLINE(  12)		this->_hx_set_acceptCallback(HX_CTX, accept);
HXLINE(  13)		this->_hx_set_backCallback(HX_CTX, back);
...
HXLINE(  28)		this->_hx_set_errorText(HX_CTX,  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,(::flixel::FlxG_obj::width - 300),this->errorMsg,32,null()));
HXLINE(  29)		 ::flixel::text::FlxText _hx_tmp4 = this->errorText;
HXDLIN(  29)		::String file = ::backend::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN(  29)		::String _hx_tmp5;
HXDLIN(  29)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE(  29)			_hx_tmp5 = file;
            		}
            		else {
HXLINE(  29)			_hx_tmp5 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
...
HXLINE(  30)		{
HXLINE(  30)			 ::flixel::math::FlxBasePoint this1 = this->errorText->scrollFactor;
...
HXLINE(  33)		this->errorText->set_antialiasing(::backend::ClientPrefs_obj::data->antialiasing);
HXLINE(  34)		this->add(this->errorText);
HXLINE(  35)		this->super::create();
            	}


void ErrorState_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_c165ffff73ee1fcf_44_update)
HXLINE(  45)		 ::states::ErrorState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  45)		_hx_tmp->errorSine = (_hx_tmp->errorSine + (( (Float)(180) ) * elapsed));
HXLINE(  46)		this->errorText->set_alpha((( (Float)(1) ) - ::Math_obj::sin(((::Math_obj::PI * this->errorSine) / ( (Float)(180) )))));
HXLINE(  48)		bool _hx_tmp1;
HXDLIN(  48)		if (this->get_controls()->get_ACCEPT()) {
HXLINE(  48)			_hx_tmp1 = ::hx::IsNotNull( this->acceptCallback );
            		}
            		else {
HXLINE(  48)			_hx_tmp1 = false;
            		}
HXDLIN(  48)		if (_hx_tmp1) {
HXLINE(  49)			this->acceptCallback();
            		}
            		else {
HXLINE(  50)			bool _hx_tmp2;
HXDLIN(  50)			if (this->get_controls()->get_BACK()) {
HXLINE(  50)				_hx_tmp2 = ::hx::IsNotNull( this->backCallback );
            			}
            			else {
HXLINE(  50)				_hx_tmp2 = false;
            			}
HXDLIN(  50)			if (_hx_tmp2) {
HXLINE(  51)				this->backCallback();
            			}
            		}
...
::hx::Val ErrorState_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"errorMsg") ) { _hx_set_errorMsg(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 9:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"backCallback") ) { _hx_set_backCallback(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"acceptCallback") ) { _hx_set_acceptCallback(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
