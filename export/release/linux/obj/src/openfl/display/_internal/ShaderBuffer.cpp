...
void ShaderBuffer_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_e0175c80fad344ef_56_new)
HXLINE(  57)		this->_hx_set_inputRefs(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  58)		this->_hx_set_inputFilter(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  59)		this->_hx_set_inputMipFilter(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  60)		this->_hx_set_inputs(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  61)		this->_hx_set_inputWrap(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  64)		this->_hx_set_overrideIntNames(HX_CTX, ::Array_obj< ::String >::__new(0));
HXLINE(  65)		this->_hx_set_overrideIntValues(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  66)		this->_hx_set_overrideFloatNames(HX_CTX, ::Array_obj< ::String >::__new(0));
HXLINE(  67)		this->_hx_set_overrideFloatValues(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  68)		this->_hx_set_overrideBoolNames(HX_CTX, ::Array_obj< ::String >::__new(0));
HXLINE(  69)		this->_hx_set_overrideBoolValues(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  70)		this->_hx_set_paramLengths(HX_CTX, ::Array_obj< int >::__new(0));
HXLINE(  71)		this->_hx_set_paramPositions(HX_CTX, ::Array_obj< int >::__new(0));
HXLINE(  72)		this->_hx_set_paramRefs_Bool(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  73)		this->_hx_set_paramRefs_Float(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  74)		this->_hx_set_paramRefs_Int(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  75)		this->_hx_set_paramTypes(HX_CTX, ::Array_obj< int >::__new(0));
            	}
...
void ShaderBuffer_obj::addBoolOverride(::String name,::Array< bool > values){
            	HX_GC_STACKFRAME(&_hx_pos_e0175c80fad344ef_79_addBoolOverride)
HXLINE(  80)		this->overrideBoolNames->setCtx( HX_CTX, this->overrideBoolCount,name);
HXLINE(  81)		this->overrideBoolValues->setCtx( HX_CTX, this->overrideBoolCount,values);
...
void ShaderBuffer_obj::addFloatOverride(::String name,::Array< Float > values){
            	HX_GC_STACKFRAME(&_hx_pos_e0175c80fad344ef_86_addFloatOverride)
HXLINE(  87)		this->overrideFloatNames->setCtx( HX_CTX, this->overrideFloatCount,name);
HXLINE(  88)		this->overrideFloatValues->setCtx( HX_CTX, this->overrideFloatCount,values);
...
void ShaderBuffer_obj::addIntOverride(::String name,::Array< int > values){
            	HX_GC_STACKFRAME(&_hx_pos_e0175c80fad344ef_93_addIntOverride)
HXLINE(  94)		this->overrideIntNames->setCtx( HX_CTX, this->overrideIntCount,name);
HXLINE(  95)		this->overrideIntValues->setCtx( HX_CTX, this->overrideIntCount,values);
...
HXLINE( 120)		this->_hx_set_shader(HX_CTX, null());
...
HXLINE( 132)				this->inputs->setCtx( HX_CTX, i,input->input);
HXLINE( 133)				this->inputFilter->setCtx( HX_CTX, i,input->filter);
HXLINE( 134)				this->inputMipFilter->setCtx( HX_CTX, i,input->mipFilter);
HXLINE( 135)				this->inputRefs->setCtx( HX_CTX, i,input);
HXLINE( 136)				this->inputWrap->setCtx( HX_CTX, i,input->wrap);
            			}
            		}
...
HXLINE( 160)				this->paramRefs_Bool->setCtx( HX_CTX, i1,param);
HXLINE( 161)				p = (p + 1);
            			}
            		}
...
HXLINE( 176)				this->paramRefs_Float->setCtx( HX_CTX, i2,param1);
HXLINE( 177)				p = (p + 1);
            			}
            		}
...
HXLINE( 192)				this->paramRefs_Int->setCtx( HX_CTX, i3,param2);
HXLINE( 193)				p = (p + 1);
            			}
            		}
...
HXDLIN( 200)						_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN( 200)							_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN( 200)									_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN( 200)									_this3->_hx_set_buffer(HX_CTX, buffer);
...
HXDLIN( 200)				this->_hx_set_paramData(HX_CTX, this1);
            			}
            			else {
...
HXDLIN( 204)							_this4->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this4->byteLength));
...
HXDLIN( 204)								_this5->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this5->byteLength));
...
HXDLIN( 204)										_this6->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength1));
...
HXDLIN( 204)										_this7->_hx_set_buffer(HX_CTX, buffer1);
...
HXLINE( 206)					this->_hx_set_paramData(HX_CTX, data);
            				}
            			}
            		}
...
HXLINE( 256)		this->_hx_set_shader(HX_CTX, shader);
            	}
...
::hx::Val ShaderBuffer_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"inputs") ) { _hx_set_inputs(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"shader") ) { _hx_set_shader(HX_CTX_GET,inValue.Cast<  ::openfl::display::GraphicsShader >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"inputRefs") ) { _hx_set_inputRefs(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"inputWrap") ) { _hx_set_inputWrap(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"paramData") ) { _hx_set_paramData(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
		break;
	case 10:
		...
		if (HX_FIELD_EQ(inName,"paramTypes") ) { _hx_set_paramTypes(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"inputFilter") ) { _hx_set_inputFilter(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"paramLengths") ) { _hx_set_paramLengths(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"paramIntCount") ) { paramIntCount=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"paramRefs_Int") ) { _hx_set_paramRefs_Int(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"inputMipFilter") ) { _hx_set_inputMipFilter(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"paramBoolCount") ) { paramBoolCount=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"paramPositions") ) { _hx_set_paramPositions(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"paramRefs_Bool") ) { _hx_set_paramRefs_Bool(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"paramDataBuffer") ) { _hx_set_paramDataBuffer(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"paramRefs_Float") ) { _hx_set_paramRefs_Float(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"overrideIntCount") ) { overrideIntCount=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"overrideIntNames") ) { _hx_set_overrideIntNames(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"overrideBoolCount") ) { overrideBoolCount=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"overrideBoolNames") ) { _hx_set_overrideBoolNames(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"overrideIntValues") ) { _hx_set_overrideIntValues(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"overrideBoolValues") ) { _hx_set_overrideBoolValues(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"overrideFloatCount") ) { overrideFloatCount=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"overrideFloatNames") ) { _hx_set_overrideFloatNames(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"overrideFloatValues") ) { _hx_set_overrideFloatValues(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
