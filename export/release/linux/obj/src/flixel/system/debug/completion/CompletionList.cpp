...
void CompletionList_obj::__construct(int capacity){
            	HX_GC_STACKFRAME(&_hx_pos_26f69c8799845277_11_new)
HXLINE(  25)		this->upperVisibleIndex = 0;
HXLINE(  24)		this->lowerVisibleIndex = 0;
HXLINE(  23)		this->selectedIndex = 0;
HXLINE(  21)		this->_hx_set_entries(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
...
void CompletionList_obj::show(Float x,::Array< ::String > items){
            	HX_GC_STACKFRAME(&_hx_pos_26f69c8799845277_45_show)
HXLINE(  46)		this->set_visible(true);
HXLINE(  47)		this->set_x(x);
HXLINE(  48)		this->_hx_set_originalItems(HX_CTX, items);
...
HXLINE(  81)		this->_hx_set_scrollBar(HX_CTX,  ::flixel::_hx_system::debug::completion::CompletionListScrollBar_obj::__alloc( HX_CTX ,150,0,5,this->actualHeight));
...
void CompletionList_obj::setItems(::Array< ::String > items){
            	HX_GC_STACKFRAME(&_hx_pos_26f69c8799845277_167_setItems)
...
HXLINE( 173)		this->_hx_set_items(HX_CTX, items);
...
::String CompletionList_obj::set_filter(::String filter){
            	HX_GC_STACKFRAME(&_hx_pos_26f69c8799845277_231_set_filter)
HXLINE( 232)		if ((filter == this->filter)) {
HXLINE( 233)			return filter;
            		}
HXLINE( 235)		this->setItems(this->filterItems(filter));
HXLINE( 236)		return (this->_hx_set_filter(HX_CTX, filter));
            	}
...
::hx::Val CompletionList_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"items") ) { _hx_set_items(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"closed") ) { _hx_set_closed(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"filter") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_filter(inValue.Cast< ::String >()) );_hx_set_filter(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"entries") ) { _hx_set_entries(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"completed") ) { _hx_set_completed(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"scrollBar") ) { _hx_set_scrollBar(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::debug::completion::CompletionListScrollBar >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"actualHeight") ) { actualHeight=inValue.Cast< int >(); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"originalItems") ) { _hx_set_originalItems(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"selectedIndex") ) { selectedIndex=inValue.Cast< int >(); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"selectionChanged") ) { _hx_set_selectionChanged(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 17:
