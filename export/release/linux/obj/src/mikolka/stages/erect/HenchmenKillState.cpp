...
::mikolka::stages::erect::HenchmenKillState HenchmenKillState_obj::KILLING;

::mikolka::stages::erect::HenchmenKillState HenchmenKillState_obj::SPEEDING;

::mikolka::stages::erect::HenchmenKillState HenchmenKillState_obj::SPEEDING_OFFSCREEN;

::mikolka::stages::erect::HenchmenKillState HenchmenKillState_obj::STOPPING;

::mikolka::stages::erect::HenchmenKillState HenchmenKillState_obj::WAIT;
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("mikolka.stages.erect.HenchmenKillState",01,2a,23,71), ::hx::TCanCast< HenchmenKillState_obj >,HenchmenKillState_obj_sStaticFields,0,
