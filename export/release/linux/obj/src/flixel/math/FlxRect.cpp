...
::String FlxRect_obj::toString(){
            	HX_GC_STACKFRAME(&_hx_pos_4c6d58e3fc627ab0_459_toString)
...
HXDLIN( 460)		_this->_hx_set_label(HX_CTX, HX_("x",78,00,00,00));
HXDLIN( 460)		_this->_hx_set_value(HX_CTX, value);
...
HXDLIN( 461)		_this1->_hx_set_label(HX_CTX, HX_("y",79,00,00,00));
HXDLIN( 461)		_this1->_hx_set_value(HX_CTX, value1);
...
HXDLIN( 462)		_this2->_hx_set_label(HX_CTX, HX_("w",77,00,00,00));
HXDLIN( 462)		_this2->_hx_set_value(HX_CTX, value2);
...
HXDLIN( 463)		_this3->_hx_set_label(HX_CTX, HX_("h",68,00,00,00));
HXDLIN( 463)		_this3->_hx_set_value(HX_CTX, value3);
