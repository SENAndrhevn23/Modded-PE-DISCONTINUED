...
class HXCPP_CLASS_ATTRIBUTES Sound_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		inline  ::openfl::media::SoundChannel _hx_set__hx___pendingSoundChannel(::hx::StackContext *_hx_ctx, ::openfl::media::SoundChannel _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___pendingSoundChannel=_hx_v; }
		 ::lime::media::AudioSource _hx___pendingAudioSource;
		inline  ::lime::media::AudioSource _hx_set__hx___pendingAudioSource(::hx::StackContext *_hx_ctx, ::lime::media::AudioSource _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___pendingAudioSource=_hx_v; }
		 ::lime::media::AudioBuffer _hx___buffer;
		inline  ::lime::media::AudioBuffer _hx_set__hx___buffer(::hx::StackContext *_hx_ctx, ::lime::media::AudioBuffer _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___buffer=_hx_v; }
		 ::lime::media::OpenALAudioContext _hx___alAudioContext;
		inline  ::lime::media::OpenALAudioContext _hx_set__hx___alAudioContext(::hx::StackContext *_hx_ctx, ::lime::media::OpenALAudioContext _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___alAudioContext=_hx_v; }
		void close();
		::Dynamic close_dyn();
