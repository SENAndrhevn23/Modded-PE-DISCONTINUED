...
HX_DEFINE_STACK_FRAME(_hx_pos_281fad3e86f1efa8_620_new,"lime.utils._Assets.LibrarySymbol","new",0x85584603,"lime.utils._Assets.LibrarySymbol.new","lime/utils/Assets.hx",620,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_281fad3e86f1efa8_628_isLocal,"lime.utils._Assets.LibrarySymbol","isLocal",0x28a9f044,"lime.utils._Assets.LibrarySymbol.isLocal","lime/utils/Assets.hx",628,0x95055f23)
HX_LOCAL_STACK_FRAME(_hx_pos_281fad3e86f1efa8_631_exists,"lime.utils._Assets.LibrarySymbol","exists",0xf7109019,"lime.utils._Assets.LibrarySymbol.exists","lime/utils/Assets.hx",631,0x95055f23)
namespace lime{
namespace utils{
namespace _Assets{

void LibrarySymbol_obj::__construct(::String id){
            	HX_GC_STACKFRAME(&_hx_pos_281fad3e86f1efa8_620_new)
HXLINE( 621)		int colonIndex = id.indexOf(HX_(":",3a,00,00,00),null());
HXLINE( 622)		this->_hx_set_libraryName(HX_CTX, id.substring(0,colonIndex));
HXLINE( 623)		this->_hx_set_symbolName(HX_CTX, id.substring((colonIndex + 1),null()));
HXLINE( 624)		this->_hx_set_library(HX_CTX, ::lime::utils::Assets_obj::getLibrary(this->libraryName));
            	}
...
bool LibrarySymbol_obj::isLocal(::String type){
            	HX_STACKFRAME(&_hx_pos_281fad3e86f1efa8_628_isLocal)
HXDLIN( 628)		return this->library->isLocal(this->symbolName,type);
            	}
...
bool LibrarySymbol_obj::exists(::String type){
            	HX_STACKFRAME(&_hx_pos_281fad3e86f1efa8_631_exists)
HXDLIN( 631)		return this->library->exists(this->symbolName,type);
            	}
...
::hx::Val LibrarySymbol_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"library") ) { _hx_set_library(HX_CTX_GET,inValue.Cast<  ::lime::utils::AssetLibrary >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"symbolName") ) { _hx_set_symbolName(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"libraryName") ) { _hx_set_libraryName(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	}
