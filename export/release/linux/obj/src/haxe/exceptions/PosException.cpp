...
void PosException_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic pos){
            	HX_GC_STACKFRAME(&_hx_pos_75c02f6763217556_12_new)
HXDLIN(  12)		{
HXLINE(  13)			super::__construct(message,previous,null());
HXLINE(  14)			if (::hx::IsNull( pos )) {
HXLINE(  15)				this->_hx_set_posInfos(HX_CTX, ::hx::SourceInfo(HX_("(unknown)",87,5d,fc,5f),0,HX_("(unknown)",87,5d,fc,5f),HX_("(unknown)",87,5d,fc,5f)));
            			}
            			else {
HXLINE(  17)				this->_hx_set_posInfos(HX_CTX, pos);
            			}
            		}
HXLINE(  12)		{
