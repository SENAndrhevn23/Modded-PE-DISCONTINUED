...
void BlurShader_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_4c03b94c358d6de6_319_new)
HXLINE( 182)		if (::hx::IsNull( this->_hx___glFragmentSource )) {
HXLINE( 184)			this->_hx_set__hx___glFragmentSource(HX_CTX, HX_("uniform sampler2D openfl_Texture;\n\n\t\tvarying vec2 vBlurCoords[7];\n\n\t\tvoid main(void) {\n\n\t\t\tvec4 sum = vec4(0.0);\n\t\t\tsum += texture2D(openfl_Texture, vBlurCoords[0]) * 0.00443;\n\t\t\tsum += texture2D(openfl_Texture, vBlurCoords[1]) * 0.05399;\n\t\t\tsum += texture2D(openfl_Texture, vBlurCoords[2]) * 0.24197;\n\t\t\tsum += texture2D(openfl_Texture, vBlurCoords[3]) * 0.39894;\n\t\t\tsum += texture2D(openfl_Texture, vBlurCoords[4]) * 0.24197;\n\t\t\tsum += texture2D(openfl_Texture, vBlurCoords[5]) * 0.05399;\n\t\t\tsum += texture2D(openfl_Texture, vBlurCoords[6]) * 0.00443;\n\n\t\t\tgl_FragColor = sum;\n\n\t\t}",d4,2c,4c,ca));
            		}
...
HXLINE( 323)		this->uRadius->_hx_set_value(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_309f542d_1,2));
...
void BlurShader_obj::_hx___update(){
            	HX_GC_STACKFRAME(&_hx_pos_4c03b94c358d6de6_328___update)
HXLINE( 330)		this->uTextureSize->_hx_set_value(HX_CTX, ::Array_obj< Float >::__new(2)->init(0,this->_hx___texture->input->width)->init(1,this->_hx___texture->input->height));
...
::hx::Val BlurShader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"uTextureSize") ) { _hx_set_uTextureSize(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
	}
