...
HXDLIN(  40)		this->_hx_set_m_matrix(HX_CTX,  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,height,true,array,true));
HXLINE(  41)		{
HXLINE(  41)			int _g = 0;
...
HXLINE( 158)		this->_hx_set_m_matrix(HX_CTX, null());
...
::hx::Val DynamicMatrix_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"m_matrix") ) { _hx_set_m_matrix(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::ObjectVector >()); return inValue; }
	}
