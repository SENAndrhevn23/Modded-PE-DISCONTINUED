...
void FancyStyle_obj::__construct(::String __o_tab){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_6a710a44e91753fb_558_new)
HXLINE( 559)		this->_hx_set_tab(HX_CTX, tab);
HXLINE( 560)		this->_hx_set_charTimesNCache(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_af574ada_1,1));
            	}
...
::String FancyStyle_obj::charTimesN(int n){
            	HX_GC_STACKFRAME(&_hx_pos_6a710a44e91753fb_585_charTimesN)
...
HXDLIN( 588)			return (this->charTimesNCache->setCtx( HX_CTX, n,(_hx_tmp + this->tab)));
            		}
...
::hx::Val FancyStyle_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"tab") ) { _hx_set_tab(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"charTimesNCache") ) { _hx_set_charTimesNCache(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
	}
