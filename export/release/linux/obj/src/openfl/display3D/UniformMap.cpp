...
HXDLIN(1057)		this->_hx_set__hx___registerLookup(HX_CTX,  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,total,fixed,array,true));
HXLINE(1059)		{
...
::hx::Val UniformMap_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"__uniforms") ) { _hx_set__hx___uniforms(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"__registerLookup") ) { _hx_set__hx___registerLookup(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::ObjectVector >()); return inValue; }
	}
