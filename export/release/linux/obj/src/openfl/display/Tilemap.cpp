...
HXLINE( 123)		this->_hx_set__hx___tileset(HX_CTX, tileset);
...
HXLINE( 130)		this->_hx_set__hx___group(HX_CTX,  ::openfl::display::TileContainer_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null()));
...
HX_DEFINE_DYNAMIC_FUNC0(Tilemap_obj,get_tileset,return )
 ...
 ::openfl::display::Tileset Tilemap_obj::set_tileset( ::openfl::display::Tileset value){
            	HX_GC_STACKFRAME(&_hx_pos_1cbb708783dfd99e_472_set_tileset)
HXLINE( 473)		if (::hx::IsInstanceNotEq( value,this->_hx___tileset )) {
HXLINE( 475)			this->_hx_set__hx___tileset(HX_CTX, value);
...
::hx::Val Tilemap_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"__group") ) { _hx_set__hx___group(HX_CTX_GET,inValue.Cast<  ::openfl::display::TileContainer >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__width") ) { _hx___width=inValue.Cast< int >(); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"__buffer") ) { _hx_set__hx___buffer(HX_CTX_GET,inValue.Cast<  ::openfl::display::_internal::Context3DBuffer >()); return inValue; }
