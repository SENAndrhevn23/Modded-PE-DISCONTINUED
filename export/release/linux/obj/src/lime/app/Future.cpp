...
HXLINE(  82)				promise->_hx_set_future(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
HXLINE(  84)				::lime::app::FutureWork_obj::run(work,promise);
            			}
            			else {
HXLINE(  89)				try {
            					HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE(  91)					this->_hx_set_value(HX_CTX, work());
...
HXLINE(  95)						{
HXLINE(  96)							this->_hx_set_error(HX_CTX, e);
...
bool Future_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::app::Future Future_obj::onComplete( ::Dynamic listener){
            	HX_GC_STACKFRAME(&_hx_pos_b16b96f10668b207_125_onComplete)
...
HXLINE( 136)						this->_hx_set__hx___completeListeners(HX_CTX, ::Array_obj< ::Dynamic>::__new());
            					}
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,onComplete,return )
 ...
 ::lime::app::Future Future_obj::onError( ::Dynamic listener){
            	HX_GC_STACKFRAME(&_hx_pos_b16b96f10668b207_154_onError)
...
HXLINE( 165)						this->_hx_set__hx___errorListeners(HX_CTX, ::Array_obj< ::Dynamic>::__new());
            					}
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,onError,return )
 ...
 ::lime::app::Future Future_obj::onProgress( ::Dynamic listener){
            	HX_GC_STACKFRAME(&_hx_pos_b16b96f10668b207_183_onProgress)
HXLINE( 184)		if (::hx::IsNotNull( listener )) {
HXLINE( 186)			if (::hx::IsNull( this->_hx___progressListeners )) {
HXLINE( 188)				this->_hx_set__hx___progressListeners(HX_CTX, ::Array_obj< ::Dynamic>::__new());
            			}
...
HXLINE( 263)				future->_hx_set_error(HX_CTX, this->error);
...
HXLINE( 293)		future->_hx_set_error(HX_CTX, error);
...
HXLINE( 306)		future->_hx_set_value(HX_CTX, value);
...
::hx::Val Future_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"value") ) { _hx_set_value(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 7:
	...
	case 10:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"__errorListeners") ) { _hx_set__hx___errorListeners(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"__completeListeners") ) { _hx_set__hx___completeListeners(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__progressListeners") ) { _hx_set__hx___progressListeners(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
