...
HXLINE(  70)		this->_hx_set_h(HX_CTX, x);
HXLINE(  71)		if (::hx::IsNull( this->q )) {
HXLINE(  72)			this->_hx_set_q(HX_CTX, x);
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(List_obj,push,(void))
 ...
 ::Dynamic List_obj::pop(){
            	HX_GC_STACKFRAME(&_hx_pos_109688f3b41df45c_99_pop)
HXLINE( 100)		if (::hx::IsNull( this->h )) {
HXLINE( 101)			return null();
            		}
HXLINE( 102)		 ::Dynamic x = this->h->item;
HXLINE( 103)		this->_hx_set_h(HX_CTX, this->h->next);
HXLINE( 104)		if (::hx::IsNull( this->h )) {
HXLINE( 105)			this->_hx_set_q(HX_CTX, null());
            		}
...
void List_obj::clear(){
            	HX_GC_STACKFRAME(&_hx_pos_109688f3b41df45c_123_clear)
HXLINE( 124)		this->_hx_set_h(HX_CTX, null());
HXLINE( 125)		this->_hx_set_q(HX_CTX, null());
...
bool List_obj::remove( ::Dynamic v){
            	HX_GC_STACKFRAME(&_hx_pos_109688f3b41df45c_137_remove)
...
HXLINE( 143)					this->_hx_set_h(HX_CTX, l->next);
            				}
            				else {
HXLINE( 145)					prev->_hx_set_next(HX_CTX, l->next);
            				}
HXLINE( 146)				if (::hx::IsInstanceEq( this->q,l )) {
HXLINE( 147)					this->_hx_set_q(HX_CTX, prev);
            				}
