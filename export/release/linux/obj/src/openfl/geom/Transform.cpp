...
HXLINE( 165)		this->_hx_set__hx___colorTransform(HX_CTX,  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null()));
HXLINE( 166)		this->_hx_set_concatenatedColorTransform(HX_CTX,  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null()));
HXLINE( 167)		this->_hx_set_pixelBounds(HX_CTX,  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
HXLINE( 169)		this->_hx_set__hx___displayObject(HX_CTX, displayObject);
...
::hx::Val Transform_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"pixelBounds") ) { _hx_set_pixelBounds(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
	...
	case 14:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"__displayObject") ) { _hx_set__hx___displayObject(HX_CTX_GET,inValue.Cast<  ::openfl::display::DisplayObject >()); return inValue; }
		break;
	case 16:
		...
		break;
	case 26:
		if (HX_FIELD_EQ(inName,"concatenatedColorTransform") ) { _hx_set_concatenatedColorTransform(HX_CTX_GET,inValue.Cast<  ::openfl::geom::ColorTransform >()); return inValue; }
	}
