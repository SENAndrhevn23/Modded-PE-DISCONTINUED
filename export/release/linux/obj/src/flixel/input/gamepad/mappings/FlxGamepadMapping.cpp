...
void FlxGamepadMapping_obj::__construct( ::flixel::input::gamepad::FlxGamepadAttachment attachment){
            	HX_GC_STACKFRAME(&_hx_pos_1d930114df1f84ac_10_new)
HXLINE(  19)		this->_hx_set_attachment(HX_CTX, ::flixel::input::gamepad::FlxGamepadAttachment_obj::NONE_dyn());
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGamepadMapping_obj,isAxisForMotion,return )
 ...
 ::flixel::input::gamepad::FlxGamepadAttachment FlxGamepadMapping_obj::set_attachment( ::flixel::input::gamepad::FlxGamepadAttachment attachment){
            	HX_GC_STACKFRAME(&_hx_pos_1d930114df1f84ac_102_set_attachment)
HXDLIN( 102)		return (this->_hx_set_attachment(HX_CTX, attachment));
            	}
...
::hx::Val FlxGamepadMapping_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 9:
		if (HX_FIELD_EQ(inName,"leftStick") ) { _hx_set_leftStick(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::FlxGamepadAnalogStick >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"rightStick") ) { _hx_set_rightStick(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::FlxGamepadAnalogStick >()); return inValue; }
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"manufacturer") ) { _hx_set_manufacturer(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::mappings::Manufacturer >()); return inValue; }
		break;
	case 14:
