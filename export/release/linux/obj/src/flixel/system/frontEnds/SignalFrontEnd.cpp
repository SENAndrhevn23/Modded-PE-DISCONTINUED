...
HXLINE(  53)		this->_hx_set_focusLost(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX ));
HXLINE(  52)		this->_hx_set_focusGained(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX ));
HXLINE(  51)		this->_hx_set_postDraw(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX ));
HXLINE(  50)		this->_hx_set_preDraw(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX ));
HXLINE(  49)		this->_hx_set_postUpdate(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX ));
HXLINE(  48)		this->_hx_set_preUpdate(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX ));
HXLINE(  44)		this->_hx_set_postGameStart(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX ));
HXLINE(  38)		this->_hx_set_preGameStart(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX ));
HXLINE(  32)		this->_hx_set_postGameReset(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX ));
HXLINE(  31)		this->_hx_set_preGameReset(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX ));
HXLINE(  29)		this->_hx_set_gameResized(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal2_obj::__alloc( HX_CTX ));
HXLINE(  23)		this->_hx_set_preStateCreate(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX ));
HXLINE(  19)		this->_hx_set_postStateSwitch(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX ));
HXLINE(  14)		this->_hx_set_preStateSwitch(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX ));
            	}
...
::hx::Val SignalFrontEnd_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"preDraw") ) { _hx_set_preDraw(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal0 >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"postDraw") ) { _hx_set_postDraw(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal0 >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"preUpdate") ) { _hx_set_preUpdate(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal0 >()); return inValue; }
		if (HX_FIELD_EQ(inName,"focusLost") ) { _hx_set_focusLost(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal0 >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"postUpdate") ) { _hx_set_postUpdate(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal0 >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"gameResized") ) { _hx_set_gameResized(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal2 >()); return inValue; }
		if (HX_FIELD_EQ(inName,"focusGained") ) { _hx_set_focusGained(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal0 >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"preGameReset") ) { _hx_set_preGameReset(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal0 >()); return inValue; }
		if (HX_FIELD_EQ(inName,"preGameStart") ) { _hx_set_preGameStart(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal0 >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"postGameReset") ) { _hx_set_postGameReset(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal0 >()); return inValue; }
		if (HX_FIELD_EQ(inName,"postGameStart") ) { _hx_set_postGameStart(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal0 >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"preStateSwitch") ) { _hx_set_preStateSwitch(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal0 >()); return inValue; }
		if (HX_FIELD_EQ(inName,"preStateCreate") ) { _hx_set_preStateCreate(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal1 >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"postStateSwitch") ) { _hx_set_postStateSwitch(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal0 >()); return inValue; }
	}
