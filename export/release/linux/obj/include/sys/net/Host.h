...
{
            	HX_GC_STACKFRAME(&_hx_pos_07fa8c3ac512567a_35_new)
HXLINE(  36)		( ( ::sys::net::Host)(__this) )->_hx_set_host(HX_CTX, name);
HXLINE(  37)		try {
...
HXLINE(  40)				( ( ::sys::net::Host)(__this) )->_hx_set_ipv6(HX_CTX, _hx_std_host_resolve_ipv6(name));
            			}
            			else {
		...
		static void __boot();
		::String host;
		inline ::String _hx_set_host(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return host=_hx_v; }
		int ip;
		::Array< unsigned char > ipv6;
		inline ::Array< unsigned char > _hx_set_ipv6(::hx::StackContext *_hx_ctx,::Array< unsigned char > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return ipv6=_hx_v; }
