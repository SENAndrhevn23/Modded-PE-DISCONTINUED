...
void ColorMatrixShader_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_65d84bf4a5bd7bcf_275_new)
...
HXLINE( 279)		this->uMultipliers->_hx_set_value(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_a1263c29_1,16));
HXLINE( 280)		this->uOffsets->_hx_set_value(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_a1263c29_2,4));
...
::hx::Val ColorMatrixShader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"uOffsets") ) { _hx_set_uOffsets(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"uMultipliers") ) { _hx_set_uMultipliers(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
	}
