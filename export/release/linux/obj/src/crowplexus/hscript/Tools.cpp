...
HX_LOCAL_STACK_FRAME(_hx_pos_1b0b0a898a4e415f_172_last,"crowplexus.hscript.Tools","last",0x1648f58e,"crowplexus.hscript.Tools.last","crowplexus/hscript/Tools.hx",172,0x1731c34a)
...
::String Tools_obj::last(::Array< ::String > arr){
            	HX_STACKFRAME(&_hx_pos_1b0b0a898a4e415f_172_last)
HXDLIN( 172)		return arr->__get((arr->length - 1));
            	}
