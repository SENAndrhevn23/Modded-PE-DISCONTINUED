...
class HXCPP_CLASS_ATTRIBUTES HaxeThread_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::sys::thread::EventLoop _hx_set_events(::hx::StackContext *_hx_ctx, ::sys::thread::EventLoop _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return events=_hx_v; }
		 ::Dynamic handle;
		...
		inline  ::sys::thread::Deque _hx_set_messages(::hx::StackContext *_hx_ctx, ::sys::thread::Deque _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return messages=_hx_v; }
};
