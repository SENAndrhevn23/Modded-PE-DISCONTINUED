...
HX_DECLARE_STACK_FRAME(_hx_pos_3eb566585b06ea2e_840_new)
...
HXLINE( 841)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 842)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->windowID = 0;
HXLINE( 843)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->x = x;
HXLINE( 844)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->y = y;
HXLINE( 845)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->button = button;
HXLINE( 846)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->movementX = movementX;
HXLINE( 847)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->movementY = movementY;
HXLINE( 848)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->clickCount = clickCount;
            	}
