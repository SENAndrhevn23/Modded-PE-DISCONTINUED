...
void BlurAlphaShader_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_6216d328fc85d16b_570_new)
...
HXLINE( 573)		this->uRadius->_hx_set_value(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_3a938b81_1,2));
HXLINE( 574)		this->uColor->_hx_set_value(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_3a938b81_2,4));
HXLINE( 575)		this->uStrength->_hx_set_value(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_3a938b81_3,1));
...
::hx::Val BlurAlphaShader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"uColor") ) { _hx_set_uColor(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"uRadius") ) { _hx_set_uRadius(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 9:
