...
class HXCPP_CLASS_ATTRIBUTES Tile_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::openfl::display::TileContainer _hx_set_parent(::hx::StackContext *_hx_ctx, ::openfl::display::TileContainer _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return parent=_hx_v; }
		Float _hx___alpha;
		...
		inline  ::openfl::geom::Matrix _hx_set__hx___matrix(::hx::StackContext *_hx_ctx, ::openfl::geom::Matrix _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___matrix=_hx_v; }
		Float _hx___originX;
		Float _hx___originY;
		 ::openfl::geom::Rectangle _hx___rect;
		inline  ::openfl::geom::Rectangle _hx_set__hx___rect(::hx::StackContext *_hx_ctx, ::openfl::geom::Rectangle _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___rect=_hx_v; }
		 ::Dynamic _hx___rotation;
		inline  ::Dynamic _hx_set__hx___rotation(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___rotation=_hx_v; }
		Float _hx___rotationCosine;
		Float _hx___rotationSine;
		 ::Dynamic _hx___scaleX;
		inline  ::Dynamic _hx_set__hx___scaleX(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___scaleX=_hx_v; }
		 ::Dynamic _hx___scaleY;
		inline  ::Dynamic _hx_set__hx___scaleY(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___scaleY=_hx_v; }
		...
		inline  ::openfl::display::Tileset _hx_set__hx___tileset(::hx::StackContext *_hx_ctx, ::openfl::display::Tileset _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___tileset=_hx_v; }
		bool _hx___visible;
