...
void FlxMouseEventManager_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_7737cad62ef16250_26_new)
...
HXDLIN(  36)		this->_hx_set__point(HX_CTX, point);
HXLINE(  33)		this->mouseClickedTime = -1;
HXLINE(  31)		this->_hx_set__clickList(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  30)		this->_hx_set__downList(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  29)		this->_hx_set__overList(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  28)		this->_hx_set__list(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  46)		super::__construct();
HXLINE(  48)		if (::hx::IsNotNull( this->_list )) {
HXLINE(  50)			this->clearRegistry();
            		}
HXLINE(  52)		this->_hx_set__list(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE(  53)		this->_hx_set__overList(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE(  54)		this->_hx_set__downList(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE(  55)		this->_hx_set__clickList(HX_CTX, ::Array_obj< ::Dynamic>::__new());
...
void FlxMouseEventManager_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_7737cad62ef16250_61_destroy)
HXLINE(  62)		this->clearRegistry();
HXLINE(  63)		this->_hx_set__point(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->_point)) ));
...
void FlxMouseEventManager_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_7737cad62ef16250_69_update)
...
HXLINE( 184)			this->_hx_set__clickList(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
            		}
...
HXLINE( 195)				this->_hx_set__clickList(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
            			}
HXLINE( 198)			{
...
HXLINE( 228)			this->_hx_set__downList(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
            		}
...
HXLINE( 244)		this->_hx_set__overList(HX_CTX, currentOverObjects);
            	}
...
void FlxMouseEventManager_obj::removeAll(){
            	HX_GC_STACKFRAME(&_hx_pos_7737cad62ef16250_312_removeAll)
...
HXLINE( 322)		this->_hx_set__overList(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE( 323)		this->_hx_set__downList(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE( 324)		this->_hx_set__clickList(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
            	}
...
void FlxMouseEventManager_obj::reorder(){
            	HX_GC_STACKFRAME(&_hx_pos_7737cad62ef16250_335_reorder)
...
HXLINE( 341)		this->_hx_set__list(HX_CTX, orderedObjects);
...
void FlxMouseEventManager_obj::setMouseDownCallback( ::Dynamic object, ::Dynamic onMouseDown){
            	HX_GC_STACKFRAME(&_hx_pos_7737cad62ef16250_353_setMouseDownCallback)
HXLINE( 354)		 ::flixel::input::mouse::FlxMouseEvent event = this->get(object,null());
HXLINE( 356)		if (::hx::IsNotNull( event )) {
HXLINE( 358)			event->_hx_set_onMouseDown(HX_CTX, onMouseDown);
            		}
            	}
...
void FlxMouseEventManager_obj::setMouseUpCallback( ::Dynamic object, ::Dynamic onMouseUp){
            	HX_GC_STACKFRAME(&_hx_pos_7737cad62ef16250_369_setMouseUpCallback)
HXLINE( 370)		 ::flixel::input::mouse::FlxMouseEvent event = this->get(object,null());
HXLINE( 372)		if (::hx::IsNotNull( event )) {
HXLINE( 374)			event->_hx_set_onMouseUp(HX_CTX, onMouseUp);
            		}
            	}
...
void FlxMouseEventManager_obj::setMouseClickCallback( ::Dynamic object, ::Dynamic onMouseClick){
            	HX_GC_STACKFRAME(&_hx_pos_7737cad62ef16250_386_setMouseClickCallback)
HXLINE( 387)		 ::flixel::input::mouse::FlxMouseEvent event = this->get(object,null());
HXLINE( 389)		if (::hx::IsNotNull( event )) {
HXLINE( 391)			event->_hx_set_onMouseClick(HX_CTX, onMouseClick);
            		}
            	}
...
void FlxMouseEventManager_obj::setMouseDoubleClickCallback( ::Dynamic object, ::Dynamic onMouseDoubleClick){
            	HX_GC_STACKFRAME(&_hx_pos_7737cad62ef16250_403_setMouseDoubleClickCallback)
HXLINE( 404)		 ::flixel::input::mouse::FlxMouseEvent event = this->get(object,null());
HXLINE( 406)		if (::hx::IsNotNull( event )) {
HXLINE( 408)			event->_hx_set_onMouseDoubleClick(HX_CTX, onMouseDoubleClick);
            		}
            	}
...
void FlxMouseEventManager_obj::setMouseOverCallback( ::Dynamic object, ::Dynamic onMouseOver){
            	HX_GC_STACKFRAME(&_hx_pos_7737cad62ef16250_419_setMouseOverCallback)
HXLINE( 420)		 ::flixel::input::mouse::FlxMouseEvent event = this->get(object,null());
HXLINE( 422)		if (::hx::IsNotNull( event )) {
HXLINE( 424)			event->_hx_set_onMouseOver(HX_CTX, onMouseOver);
            		}
            	}
...
void FlxMouseEventManager_obj::setMouseOutCallback( ::Dynamic object, ::Dynamic onMouseOut){
            	HX_GC_STACKFRAME(&_hx_pos_7737cad62ef16250_435_setMouseOutCallback)
HXLINE( 436)		 ::flixel::input::mouse::FlxMouseEvent event = this->get(object,null());
HXLINE( 438)		if (::hx::IsNotNull( event )) {
HXLINE( 440)			event->_hx_set_onMouseOut(HX_CTX, onMouseOut);
            		}
            	}
...
void FlxMouseEventManager_obj::setMouseMoveCallback( ::Dynamic object, ::Dynamic onMouseMove){
            	HX_GC_STACKFRAME(&_hx_pos_7737cad62ef16250_452_setMouseMoveCallback)
HXLINE( 453)		 ::flixel::input::mouse::FlxMouseEvent event = this->get(object,null());
HXLINE( 455)		if (::hx::IsNotNull( event )) {
HXLINE( 457)			event->_hx_set_onMouseMove(HX_CTX, onMouseMove);
            		}
            	}
...
void FlxMouseEventManager_obj::setMouseWheelCallback( ::Dynamic object, ::Dynamic onMouseWheel){
            	HX_GC_STACKFRAME(&_hx_pos_7737cad62ef16250_469_setMouseWheelCallback)
HXLINE( 470)		 ::flixel::input::mouse::FlxMouseEvent event = this->get(object,null());
HXLINE( 472)		if (::hx::IsNotNull( event )) {
HXLINE( 474)			event->_hx_set_onMouseWheel(HX_CTX, onMouseWheel);
            		}
            	}
...
void FlxMouseEventManager_obj::setObjectMouseButtons( ::Dynamic object,::Array< int > mouseButtons){
            	HX_GC_STACKFRAME(&_hx_pos_7737cad62ef16250_561_setObjectMouseButtons)
HXLINE( 562)		 ::flixel::input::mouse::FlxMouseEvent event = this->get(object,null());
HXLINE( 564)		if (::hx::IsNotNull( event )) {
HXLINE( 566)			event->_hx_set_mouseButtons(HX_CTX, mouseButtons);
            		}
            	}
...
void FlxMouseEventManager_obj::clearRegistry(){
            	HX_GC_STACKFRAME(&_hx_pos_7737cad62ef16250_626_clearRegistry)
HXLINE( 627)		this->_hx_set__overList(HX_CTX, null());
HXLINE( 628)		this->_hx_set__downList(HX_CTX, null());
HXLINE( 629)		this->_hx_set__clickList(HX_CTX, null());
HXLINE( 630)		this->_hx_set__list(HX_CTX, ::flixel::util::FlxDestroyUtil_obj::destroyArray(this->_list));
            	}
...
bool FlxMouseEventManager_obj::checkOverlap( ::flixel::input::mouse::FlxMouseEvent event){
            	HX_GC_STACKFRAME(&_hx_pos_7737cad62ef16250_634_checkOverlap)
HXLINE( 635)		{
HXLINE( 635)			int _g = 0;
...
HXDLIN( 635)				_g = (_g + 1);
HXLINE( 638)				this->_hx_set__point(HX_CTX, ::flixel::FlxG_obj::mouse->getPositionInCameraView(camera,this->_point));
...
HXLINE( 641)					this->_hx_set__point(HX_CTX, ::flixel::FlxG_obj::mouse->getWorldPosition(camera,this->_point));
...
HXLINE( 653)						this->_hx_set__point(HX_CTX, touch->getPositionInCameraView(camera,this->_point));
...
HXDLIN( 654)						if (point2->_weak) {
HXLINE( 654)							point2->put();
            						}
HXDLIN( 654)						if (contained3) {
HXLINE( 656)							this->_hx_set__point(HX_CTX, touch->getWorldPosition(camera,this->_point));
...
::hx::Val FlxMouseEventManager_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"_list") ) { _hx_set__list(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"_point") ) { _hx_set__point(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"_overList") ) { _hx_set__overList(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_downList") ) { _hx_set__downList(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"_clickList") ) { _hx_set__clickList(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 16:
