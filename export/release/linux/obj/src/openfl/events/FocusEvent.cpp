...
HXLINE( 179)		event->_hx_set_target(HX_CTX, this->target);
HXLINE( 180)		event->_hx_set_currentTarget(HX_CTX, this->currentTarget);
...
void FocusEvent_obj::_hx___init(){
            	HX_GC_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_191___init)
HXLINE( 192)		this->super::_hx___init();
HXLINE( 193)		this->keyCode = 0;
HXLINE( 194)		this->shiftKey = false;
HXLINE( 195)		this->_hx_set_relatedObject(HX_CTX, null());
            	}
