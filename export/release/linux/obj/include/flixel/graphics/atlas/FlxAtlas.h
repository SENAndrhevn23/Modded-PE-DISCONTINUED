...
class HXCPP_CLASS_ATTRIBUTES FlxAtlas_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::flixel::graphics::atlas::FlxNode _hx_set_root(::hx::StackContext *_hx_ctx, ::flixel::graphics::atlas::FlxNode _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return root=_hx_v; }
		::String name;
		...
		inline  ::haxe::ds::StringMap _hx_set_nodes(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return nodes=_hx_v; }
		 ::openfl::display::BitmapData bitmapData;
		inline  ::openfl::display::BitmapData _hx_set_bitmapData(::hx::StackContext *_hx_ctx, ::openfl::display::BitmapData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return bitmapData=_hx_v; }
		bool persist;
		int border;
		int width;
		int height;
		...
		inline  ::flixel::graphics::FlxGraphic _hx_set__graphic(::hx::StackContext *_hx_ctx, ::flixel::graphics::FlxGraphic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _graphic=_hx_v; }
		::Array< ::Dynamic> _tempStorage;
		inline ::Array< ::Dynamic> _hx_set__tempStorage(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _tempStorage=_hx_v; }
		void initRoot();
