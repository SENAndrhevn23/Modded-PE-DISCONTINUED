			...
			*(void **)__this = TreeNode_obj::_hx_vtable;
{
            	...
            	HX_GC_STACKFRAME(&_hx_pos_3b67413c38760ea6_252_new)
HXLINE( 253)		( ( ::haxe::ds::TreeNode)(__this) )->_hx_set_left(HX_CTX, l);
HXLINE( 254)		( ( ::haxe::ds::TreeNode)(__this) )->_hx_set_key(HX_CTX, k);
HXLINE( 255)		( ( ::haxe::ds::TreeNode)(__this) )->_hx_set_value(HX_CTX, v);
HXLINE( 256)		( ( ::haxe::ds::TreeNode)(__this) )->_hx_set_right(HX_CTX, r);
HXLINE( 257)		if ((h == -1)) {
...
HXLINE( 260)			( ( ::haxe::ds::TreeNode)(__this) )->_height = h;
		...
		inline  ::haxe::ds::TreeNode _hx_set_left(::hx::StackContext *_hx_ctx, ::haxe::ds::TreeNode _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return left=_hx_v; }
		 ::haxe::ds::TreeNode right;
		inline  ::haxe::ds::TreeNode _hx_set_right(::hx::StackContext *_hx_ctx, ::haxe::ds::TreeNode _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return right=_hx_v; }
		 ::Dynamic key;
