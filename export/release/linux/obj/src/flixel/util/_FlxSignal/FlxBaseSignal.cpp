...
void FlxBaseSignal_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_06997c0c7386deb2_100_new)
HXLINE( 109)		this->processingListeners = false;
HXLINE( 113)		this->_hx_set_handlers(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE( 114)		this->_hx_set_pendingRemove(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
            	}
...
void FlxBaseSignal_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_06997c0c7386deb2_165_destroy)
HXLINE( 166)		::flixel::util::FlxDestroyUtil_obj::destroyArray(this->handlers);
HXLINE( 167)		this->_hx_set_handlers(HX_CTX, null());
HXLINE( 168)		this->_hx_set_pendingRemove(HX_CTX, null());
            	}
...
::hx::Val FlxBaseSignal_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"handlers") ) { _hx_set_handlers(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"pendingRemove") ) { _hx_set_pendingRemove(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 19:
