...
class HXCPP_CLASS_ATTRIBUTES PsychUIDropDownMenu_obj : public  ::backend::ui::PsychUIInputText_obj
{
	...
	public:
		...
		inline  ::flixel::FlxSprite _hx_set_button(::hx::StackContext *_hx_ctx, ::flixel::FlxSprite _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return button=_hx_v; }
		 ::Dynamic onSelect;
		inline  ::Dynamic _hx_set_onSelect(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onSelect=_hx_v; }
		Dynamic onSelect_dyn() { return onSelect;}
		int selectedIndex;
		::String selectedLabel;
		inline ::String _hx_set_selectedLabel(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return selectedLabel=_hx_v; }
		::Array< ::String > _curFilter;
		inline ::Array< ::String > _hx_set__curFilter(::hx::StackContext *_hx_ctx,::Array< ::String > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _curFilter=_hx_v; }
		Float _itemWidth;
		...
		inline ::Array< ::Dynamic> _hx_set__items(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _items=_hx_v; }
		int curScroll;
