...
class HXCPP_CLASS_ATTRIBUTES Graphics_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::openfl::geom::Rectangle _hx_set__hx___bounds(::hx::StackContext *_hx_ctx, ::openfl::geom::Rectangle _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___bounds=_hx_v; }
		 ::openfl::display::_internal::DrawCommandBuffer _hx___commands;
		inline  ::openfl::display::_internal::DrawCommandBuffer _hx_set__hx___commands(::hx::StackContext *_hx_ctx, ::openfl::display::_internal::DrawCommandBuffer _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___commands=_hx_v; }
		bool _hx___dirty;
		...
		inline  ::openfl::display::_internal::Context3DBuffer _hx_set__hx___quadBuffer(::hx::StackContext *_hx_ctx, ::openfl::display::_internal::Context3DBuffer _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___quadBuffer=_hx_v; }
		...
		inline  ::lime::utils::ObjectPool _hx_set__hx___shaderBufferPool(::hx::StackContext *_hx_ctx, ::lime::utils::ObjectPool _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___shaderBufferPool=_hx_v; }
		...
		inline  ::openfl::display3D::IndexBuffer3D _hx_set__hx___triangleIndexBuffer(::hx::StackContext *_hx_ctx, ::openfl::display3D::IndexBuffer3D _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___triangleIndexBuffer=_hx_v; }
		int _hx___triangleIndexBufferCount;
		 ::lime::utils::ArrayBufferView _hx___triangleIndexBufferData;
		inline  ::lime::utils::ArrayBufferView _hx_set__hx___triangleIndexBufferData(::hx::StackContext *_hx_ctx, ::lime::utils::ArrayBufferView _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___triangleIndexBufferData=_hx_v; }
		 ::haxe::ds::List _hx___usedShaderBuffers;
		inline  ::haxe::ds::List _hx_set__hx___usedShaderBuffers(::hx::StackContext *_hx_ctx, ::haxe::ds::List _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___usedShaderBuffers=_hx_v; }
		...
		inline  ::lime::utils::ArrayBufferView _hx_set__hx___vertexBufferDataUVT(::hx::StackContext *_hx_ctx, ::lime::utils::ArrayBufferView _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___vertexBufferDataUVT=_hx_v; }
		 ::openfl::display3D::VertexBuffer3D _hx___vertexBufferUVT;
		inline  ::openfl::display3D::VertexBuffer3D _hx_set__hx___vertexBufferUVT(::hx::StackContext *_hx_ctx, ::openfl::display3D::VertexBuffer3D _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___vertexBufferUVT=_hx_v; }
		bool _hx___visible;
		 ::openfl::display::DisplayObject _hx___owner;
		inline  ::openfl::display::DisplayObject _hx_set__hx___owner(::hx::StackContext *_hx_ctx, ::openfl::display::DisplayObject _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___owner=_hx_v; }
		int _hx___width;
		...
		inline  ::openfl::display::BitmapData _hx_set__hx___bitmap(::hx::StackContext *_hx_ctx, ::openfl::display::BitmapData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___bitmap=_hx_v; }
