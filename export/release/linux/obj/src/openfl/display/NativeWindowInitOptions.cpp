...
void NativeWindowInitOptions_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_9abfb447380e406a_19_new)
HXLINE( 166)		this->_hx_set_type(HX_CTX, 1);
HXLINE( 145)		this->transparent = false;
HXLINE( 125)		this->_hx_set_systemChrome(HX_CTX, 2);
HXLINE( 108)		this->resizable = true;
HXLINE(  90)		this->_hx_set_renderMode(HX_CTX, null());
HXLINE(  81)		this->_hx_set_owner(HX_CTX, null());
...
::hx::Val NativeWindowInitOptions_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"owner") ) { _hx_set_owner(HX_CTX_GET,inValue.Cast<  ::openfl::display::NativeWindow >()); return inValue; }
		break;
	case 8:
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"renderMode") ) { _hx_set_renderMode(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"systemChrome") ) { _hx_set_systemChrome(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
