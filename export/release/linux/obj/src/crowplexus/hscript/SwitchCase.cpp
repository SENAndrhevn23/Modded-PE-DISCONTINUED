...
HX_DEFINE_STACK_FRAME(_hx_pos_67ec89ecb84ac291_98_new,"crowplexus.hscript.SwitchCase","new",0xc9ca283b,"crowplexus.hscript.SwitchCase.new","crowplexus/hscript/Expr.hx",98,0x8be9fac2)
HX_LOCAL_STACK_FRAME(_hx_pos_67ec89ecb84ac291_104_toString,"crowplexus.hscript.SwitchCase","toString",0xffc51ef1,"crowplexus.hscript.SwitchCase.toString","crowplexus/hscript/Expr.hx",104,0x8be9fac2)
...
void SwitchCase_obj::__construct(::Array< ::Dynamic> values, ::crowplexus::hscript::Expr expr, ::crowplexus::hscript::Expr ifExpr){
            	HX_GC_STACKFRAME(&_hx_pos_67ec89ecb84ac291_98_new)
HXDLIN(  98)		this->_hx_set_values(HX_CTX, values);
HXDLIN(  98)		this->_hx_set_expr(HX_CTX, expr);
HXDLIN(  98)		this->_hx_set_ifExpr(HX_CTX, ifExpr);
            	}
...
::String SwitchCase_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_67ec89ecb84ac291_104_toString)
HXDLIN( 104)		return ::Std_obj::string( ::Dynamic(::hx::Anon_obj::Create(3)
...
::hx::Val SwitchCase_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"values") ) { _hx_set_values(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"ifExpr") ) { _hx_set_ifExpr(HX_CTX_GET,inValue.Cast<  ::crowplexus::hscript::Expr >()); return inValue; }
	}
