...
HXLINE(  51)		this->_hx_set_context(HX_CTX, context);
HXLINE(  53)		this->_hx_set__hx___tempMatrix(HX_CTX,  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
HXLINE(  56)		this->_hx_set__hx___type(HX_CTX, HX_("canvas",d8,54,42,b8));
            	}
...
void CanvasRenderer_obj::_hx___clear(){
            	HX_GC_STACKFRAME(&_hx_pos_dcbf857ab860ed73_99___clear)
HXDLIN(  99)		if (::hx::IsNotNull( this->_hx___stage )) {
HXLINE( 101)			 ::Dynamic cacheBlendMode = this->_hx___blendMode;
HXLINE( 102)			this->_hx_set__hx___blendMode(HX_CTX, null());
...
void CanvasRenderer_obj::_hx___setBlendMode( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_dcbf857ab860ed73_240___setBlendMode)
...
HXLINE( 244)		this->_hx_set__hx___blendMode(HX_CTX, value);
...
::hx::Val CanvasRenderer_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"context") ) { _hx_set_context(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__isDOM") ) { _hx___isDOM=inValue.Cast< bool >(); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"__tempMatrix") ) { _hx_set__hx___tempMatrix(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Matrix >()); return inValue; }
	}
