...
HX_LOCAL_STACK_FRAME(_hx_pos_0bdd6de38e5581b0_218_implement,"psychlua.ReflectionFunctions","implement",0x9729eff4,"psychlua.ReflectionFunctions.implement","psychlua/ReflectionFunctions.hx",218,0x2ed48560)
HX_LOCAL_STACK_FRAME(_hx_pos_0bdd6de38e5581b0_221_implement,"psychlua.ReflectionFunctions","implement",0x9729eff4,"psychlua.ReflectionFunctions.implement","psychlua/ReflectionFunctions.hx",221,0x2ed48560)
HX_LOCAL_STACK_FRAME(_hx_pos_0bdd6de38e5581b0_245_implement,"psychlua.ReflectionFunctions","implement",0x9729eff4,"psychlua.ReflectionFunctions.implement","psychlua/ReflectionFunctions.hx",245,0x2ed48560)
HX_LOCAL_STACK_FRAME(_hx_pos_0bdd6de38e5581b0_262_implement,"psychlua.ReflectionFunctions","implement",0x9729eff4,"psychlua.ReflectionFunctions.implement","psychlua/ReflectionFunctions.hx",262,0x2ed48560)
HX_LOCAL_STACK_FRAME(_hx_pos_0bdd6de38e5581b0_270_parseInstances,"psychlua.ReflectionFunctions","parseInstances",0x1170b09a,"psychlua.ReflectionFunctions.parseInstances","psychlua/ReflectionFunctions.hx",270,0x2ed48560)
HX_LOCAL_STACK_FRAME(_hx_pos_0bdd6de38e5581b0_281_parseSingleInstance,"psychlua.ReflectionFunctions","parseSingleInstance",0x0fc5ef61,"psychlua.ReflectionFunctions.parseSingleInstance","psychlua/ReflectionFunctions.hx",281,0x2ed48560)
HX_LOCAL_STACK_FRAME(_hx_pos_0bdd6de38e5581b0_306_callMethodFromObject,"psychlua.ReflectionFunctions","callMethodFromObject",0x9b57c417,"psychlua.ReflectionFunctions.callMethodFromObject","psychlua/ReflectionFunctions.hx",306,0x2ed48560)
...
HXLINE(  28)						_hx_tmp1 = ::psychlua::ReflectionFunctions_obj::parseSingleInstance(value);
            					}
            					else {
...
HXLINE(  31)					_hx_tmp3 = ::psychlua::ReflectionFunctions_obj::parseSingleInstance(value);
            				}
            				else {
...
HXLINE(  66)						_hx_tmp = ::psychlua::ReflectionFunctions_obj::parseSingleInstance(value);
            					}
            					else {
...
HXLINE(  69)					_hx_tmp1 = ::psychlua::ReflectionFunctions_obj::parseSingleInstance(value);
            				}
            				else {
...
HXLINE( 123)										_hx_tmp = ::psychlua::ReflectionFunctions_obj::parseSingleInstance(value);
            									}
            									else {
...
HXLINE( 126)									_hx_tmp1 = ::psychlua::ReflectionFunctions_obj::parseSingleInstance(value);
            								}
            								else {
...
HXLINE( 130)								_hx_tmp2 = ::psychlua::ReflectionFunctions_obj::parseSingleInstance(value);
            							}
            							else {
...
HXDLIN( 130)						if (( (bool)(allowInstances) )) {
HXLINE( 130)							_hx_tmp3 = ::psychlua::ReflectionFunctions_obj::parseSingleInstance(value);
            						}
            						else {
...
HXLINE( 206)					split->shift();
HXLINE( 207)					funcToRun = ::StringTools_obj::trim(split->join(HX_(".",2e,00,00,00)));
HXLINE( 208)					parent = varParent;
            				}
HXLINE( 211)				if ((funcToRun.length > 0)) {
HXLINE( 213)					return ::psychlua::ReflectionFunctions_obj::callMethodFromObject(parent,funcToRun,::psychlua::ReflectionFunctions_obj::parseInstances(args));
            				}
HXLINE( 215)				return ::Reflect_obj::callMethod(null(),parent,::psychlua::ReflectionFunctions_obj::parseInstances(args));
            			}
            			HX_END_LOCAL_FUNC2(return)
...
HXLINE( 217)		{
            			HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_9) HXARGC(3)
            			 ::Dynamic _hx_run(::String className,::String funcToRun,::cpp::VirtualArray args){
            				HX_STACKFRAME(&_hx_pos_0bdd6de38e5581b0_218_implement)
HXLINE( 218)				::hx::Class _hx_tmp = ::Type_obj::resolveClass(className);
HXDLIN( 218)				return ::psychlua::ReflectionFunctions_obj::callMethodFromObject(_hx_tmp,funcToRun,::psychlua::ReflectionFunctions_obj::parseInstances(args));
            			}
            			HX_END_LOCAL_FUNC3(return)

HXLINE( 217)			::llua::Lua_helper_obj::callbacks->set(HX_("callMethodFromClass",4f,38,64,be), ::Dynamic(new _hx_Closure_9()));
HXDLIN( 217)			linc::callbacks::add_callback_function(lua,HX_("callMethodFromClass",4f,38,64,be));
            		}
HXLINE( 221)		{
            			...
            			bool _hx_run(::String variableToSave,::String className,::cpp::VirtualArray args){
            				HX_STACKFRAME(&_hx_pos_0bdd6de38e5581b0_221_implement)
HXLINE( 222)				variableToSave = ::StringTools_obj::replace(::StringTools_obj::trim(variableToSave),HX_(".",2e,00,00,00),HX_("",00,00,00,00));
HXLINE( 223)				if (::hx::IsNull( ::backend::MusicBeatState_obj::getVariables()->get(variableToSave) )) {
HXLINE( 225)					if (::hx::IsNull( args )) {
HXLINE( 225)						args = ::cpp::VirtualArray_obj::__new(0);
            					}
HXLINE( 226)					 ::Dynamic myType = ::Type_obj::resolveClass(className);
HXLINE( 228)					if (::hx::IsNull( myType )) {
HXLINE( 230)						::psychlua::FunkinLua_obj::luaTrace(((HX_("createInstance: Class ",df,17,95,f8) + className) + HX_(" not found",55,f3,a5,21)),false,false,-65536);
HXLINE( 231)						return false;
            					}
HXLINE( 234)					 ::Dynamic obj = ::Type_obj::createInstance(myType,::psychlua::ReflectionFunctions_obj::parseInstances(args));
HXLINE( 235)					if (::hx::IsNotNull( obj )) {
HXLINE( 236)						::backend::MusicBeatState_obj::getVariables()->set(variableToSave,obj);
            					}
            					else {
HXLINE( 238)						::psychlua::FunkinLua_obj::luaTrace(((HX_("createInstance: Failed to create ",eb,a9,51,2f) + variableToSave) + HX_(", arguments are possibly wrong.",12,b8,b6,e3)),false,false,-65536);
            					}
HXLINE( 240)					return ::hx::IsNotNull( obj );
            				}
            				else {
HXLINE( 242)					::psychlua::FunkinLua_obj::luaTrace(((HX_("createInstance: Variable ",cd,f7,b0,5e) + variableToSave) + HX_(" is already being used and cannot be replaced!",04,3c,54,b7)),false,false,-65536);
            				}
HXLINE( 243)				return false;
            			}
            			HX_END_LOCAL_FUNC3(return)

HXLINE( 221)			::llua::Lua_helper_obj::callbacks->set(HX_("createInstance",b1,9e,1b,ac), ::Dynamic(new _hx_Closure_10()));
HXDLIN( 221)			linc::callbacks::add_callback_function(lua,HX_("createInstance",b1,9e,1b,ac));
            		}
HXLINE( 245)		{
            		...
            		if (::hx::IsNull(__o_inFront)) inFront = false;
            				HX_STACKFRAME(&_hx_pos_0bdd6de38e5581b0_245_implement)
HXLINE( 246)				 ::Dynamic savedObj = ::backend::MusicBeatState_obj::getVariables()->get(objectName);
HXLINE( 247)				if (::hx::IsNotNull( savedObj )) {
HXLINE( 249)					 ::Dynamic obj = savedObj;
HXLINE( 250)					if (( (bool)(inFront) )) {
HXLINE( 251)						::psychlua::LuaUtils_obj::getTargetInstance()->add(obj).StaticCast<  ::flixel::FlxBasic >();
            					}
            					else {
HXLINE( 254)						if (!(::states::PlayState_obj::instance->isDead)) {
HXLINE( 255)							 ::states::PlayState _hx_tmp = ::states::PlayState_obj::instance;
HXDLIN( 255)							::Array< ::Dynamic> _hx_tmp1 = ::states::PlayState_obj::instance->members;
HXDLIN( 255)							 ::flixel::group::FlxTypedSpriteGroup group = ::states::PlayState_obj::instance->gfGroup;
HXDLIN( 255)							int pos = ::states::PlayState_obj::instance->members->indexOf(group,null());
HXDLIN( 255)							int newPos = ::states::PlayState_obj::instance->members->indexOf(::states::PlayState_obj::instance->boyfriendGroup,null());
HXDLIN( 255)							if ((newPos < pos)) {
HXLINE( 255)								group = ::states::PlayState_obj::instance->boyfriendGroup;
HXDLIN( 255)								pos = newPos;
            							}
HXDLIN( 255)							newPos = ::states::PlayState_obj::instance->members->indexOf(::states::PlayState_obj::instance->dadGroup,null());
HXDLIN( 255)							if ((newPos < pos)) {
HXLINE( 255)								group = ::states::PlayState_obj::instance->dadGroup;
HXDLIN( 255)								pos = newPos;
            							}
HXDLIN( 255)							_hx_tmp->insert(_hx_tmp1->indexOf(group,null()),obj).StaticCast<  ::flixel::FlxBasic >();
            						}
            						else {
HXLINE( 257)							 ::substates::GameOverSubstate _hx_tmp2 = ::substates::GameOverSubstate_obj::instance;
HXDLIN( 257)							_hx_tmp2->insert(::substates::GameOverSubstate_obj::instance->members->indexOf(::substates::GameOverSubstate_obj::instance->boyfriend,null()),obj).StaticCast<  ::flixel::FlxBasic >();
            						}
            					}
            				}
            				else {
HXLINE( 260)					::psychlua::FunkinLua_obj::luaTrace(((HX_("addInstance: Can't add what doesn't exist~ (",6b,4c,da,1e) + objectName) + HX_(")",29,00,00,00)),false,false,-65536);
            				}
            			}
            			HX_END_LOCAL_FUNC2((void))

HXLINE( 245)			::llua::Lua_helper_obj::callbacks->set(HX_("addInstance",d6,56,3d,8b), ::Dynamic(new _hx_Closure_11()));
HXDLIN( 245)			linc::callbacks::add_callback_function(lua,HX_("addInstance",d6,56,3d,8b));
            		}
HXLINE( 262)		{
            			HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_12) HXARGC(2)
            			::String _hx_run(::String instanceName,::String className){
            				HX_STACKFRAME(&_hx_pos_0bdd6de38e5581b0_262_implement)
HXLINE( 263)				::String retStr = (((HX_("",00,00,00,00) + ::Std_obj::string(::psychlua::ReflectionFunctions_obj::instanceStr)) + HX_("::",c0,32,00,00)) + instanceName);
HXLINE( 264)				if (::hx::IsNotNull( className )) {
HXLINE( 264)					retStr = (retStr + (HX_("::",c0,32,00,00) + className));
            				}
HXLINE( 265)				return retStr;
            			}
            			HX_END_LOCAL_FUNC2(return)

HXLINE( 262)			::llua::Lua_helper_obj::callbacks->set(HX_("instanceArg",c1,c1,0a,29), ::Dynamic(new _hx_Closure_12()));
HXDLIN( 262)			linc::callbacks::add_callback_function(lua,HX_("instanceArg",c1,c1,0a,29));
            		}
            	}
...
::cpp::VirtualArray ReflectionFunctions_obj::parseInstances(::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_0bdd6de38e5581b0_270_parseInstances)
HXLINE( 271)		if (::hx::IsNull( args )) {
HXLINE( 271)			return ::cpp::VirtualArray_obj::__new(0);
            		}
HXLINE( 273)		{
HXLINE( 273)			int _g = 0;
HXDLIN( 273)			int _g1 = args->get_length();
HXDLIN( 273)			while((_g < _g1)){
HXLINE( 273)				_g = (_g + 1);
HXDLIN( 273)				int i = (_g - 1);
HXLINE( 275)				args->set(i,::psychlua::ReflectionFunctions_obj::parseSingleInstance(args->__get(i)));
            			}
            		}
HXLINE( 277)		return args;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ReflectionFunctions_obj,parseInstances,return )
 ...
 ::Dynamic ReflectionFunctions_obj::parseSingleInstance( ::Dynamic arg){
            	HX_STACKFRAME(&_hx_pos_0bdd6de38e5581b0_281_parseSingleInstance)
HXLINE( 282)		::String argStr = ( (::String)(arg) );
HXLINE( 283)		bool _hx_tmp;
HXDLIN( 283)		if (::hx::IsNotNull( argStr )) {
HXLINE( 283)			_hx_tmp = ::hx::IsGreater( argStr.length,::psychlua::ReflectionFunctions_obj::instanceStr->__Field(HX_("length",e6,94,07,9f),::hx::paccDynamic) );
            		}
            		else {
HXLINE( 283)			_hx_tmp = false;
            		}
HXDLIN( 283)		if (_hx_tmp) {
HXLINE( 285)			int index = argStr.indexOf(HX_("::",c0,32,00,00),null());
HXLINE( 286)			if ((index > -1)) {
HXLINE( 288)				argStr = argStr.substring((index + 2),null());
HXLINE( 290)				int lastIndex = argStr.lastIndexOf(HX_("::",c0,32,00,00),null());
HXLINE( 292)				::Array< ::String > split;
HXDLIN( 292)				if ((lastIndex > -1)) {
HXLINE( 292)					split = argStr.substring(0,lastIndex).split(HX_(".",2e,00,00,00));
            				}
            				else {
HXLINE( 292)					split = argStr.split(HX_(".",2e,00,00,00));
            				}
HXLINE( 293)				if ((lastIndex > -1)) {
HXLINE( 293)					arg = ::Type_obj::resolveClass(argStr.substring((lastIndex + 2),null()));
            				}
            				else {
HXLINE( 293)					arg = ::states::PlayState_obj::instance;
            				}
HXLINE( 294)				{
HXLINE( 294)					int _g = 0;
HXDLIN( 294)					int _g1 = split->length;
HXDLIN( 294)					while((_g < _g1)){
HXLINE( 294)						_g = (_g + 1);
HXDLIN( 294)						int j = (_g - 1);
HXLINE( 297)						arg = ::psychlua::LuaUtils_obj::getVarInArray(arg,::StringTools_obj::trim(split->__get(j)),null());
            					}
            				}
            			}
            		}
HXLINE( 302)		return arg;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(ReflectionFunctions_obj,parseSingleInstance,return )
 ...
 ::Dynamic ReflectionFunctions_obj::callMethodFromObject( ::Dynamic classObj,::String funcStr,::cpp::VirtualArray args){
            	HX_STACKFRAME(&_hx_pos_0bdd6de38e5581b0_306_callMethodFromObject)
HXLINE( 307)		::Array< ::String > split = funcStr.split(HX_(".",2e,00,00,00));
HXLINE( 308)		 ::Dynamic funcToRun = null();
HXLINE( 309)		 ::Dynamic obj = classObj;
HXLINE( 311)		if (::hx::IsNull( obj )) {
HXLINE( 313)			return null();
            		}
HXLINE( 316)		{
HXLINE( 316)			int _g = 0;
HXDLIN( 316)			int _g1 = split->length;
HXDLIN( 316)			while((_g < _g1)){
HXLINE( 316)				_g = (_g + 1);
HXDLIN( 316)				int i = (_g - 1);
HXLINE( 318)				obj = ::psychlua::LuaUtils_obj::getVarInArray(obj,::StringTools_obj::trim(split->__get(i)),null());
            			}
            		}
HXLINE( 322)		funcToRun = obj;
HXLINE( 324)		if (::hx::IsNotNull( funcToRun )) {
HXLINE( 324)			return ::Reflect_obj::callMethod(obj,funcToRun,args);
            		}
            		else {
