...
HXLINE(  17)		this->_hx_set_i(HX_CTX, i);
HXLINE(  18)		this->_hx_set_reader(HX_CTX,  ::haxe::zip::Reader_obj::__alloc( HX_CTX ,i));
            	}
...
::hx::Val Zip_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
		if (HX_FIELD_EQ(inName,"i") ) { _hx_set_i(HX_CTX_GET,inValue.Cast<  ::haxe::io::Input >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"reader") ) { _hx_set_reader(HX_CTX_GET,inValue.Cast<  ::haxe::zip::Reader >()); return inValue; }
	}
