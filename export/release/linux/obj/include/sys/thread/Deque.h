...
{
            	HX_GC_STACKFRAME(&_hx_pos_136ea4cadc3ef98e_30_new)
HXDLIN(  30)		( ( ::sys::thread::Deque)(__this) )->_hx_set_q(HX_CTX,  ::__hxcpp_deque_create());
            	}
		...
		::String __ToString() const { return HX_("Deque",00,24,58,6a); }
		 ...
		 ::Dynamic q;
		inline  ::Dynamic _hx_set_q(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return q=_hx_v; }
		void add( ::Dynamic i);
		::Dynamic add_dyn();
