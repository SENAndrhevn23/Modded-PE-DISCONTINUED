...
HXLINE( 130)		this->_hx_set_onTextInput(HX_CTX,  ::lime::app::_Event_String_Void_obj::__alloc( HX_CTX ));
HXLINE( 129)		this->_hx_set_onTextEdit(HX_CTX,  ::lime::app::_Event_String_Int_Int_Void_obj::__alloc( HX_CTX ));
HXLINE( 128)		this->_hx_set_onShow(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE( 127)		this->_hx_set_onRestore(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE( 125)		this->_hx_set_onResize(HX_CTX,  ::lime::app::_Event_Int_Int_Void_obj::__alloc( HX_CTX ));
HXLINE( 120)		this->_hx_set_onRenderContextRestored(HX_CTX,  ::lime::app::_Event_lime_graphics_RenderContext_Void_obj::__alloc( HX_CTX ));
HXLINE( 119)		this->_hx_set_onRenderContextLost(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE( 118)		this->_hx_set_onRender(HX_CTX,  ::lime::app::_Event_lime_graphics_RenderContext_Void_obj::__alloc( HX_CTX ));
HXLINE( 117)		this->_hx_set_onMove(HX_CTX,  ::lime::app::_Event_Float_Float_Void_obj::__alloc( HX_CTX ));
HXLINE( 112)		this->_hx_set_onMouseWheel(HX_CTX,  ::lime::app::_Event_Float_Float_lime_ui_MouseWheelMode_Void_obj::__alloc( HX_CTX ));
HXLINE( 107)		this->_hx_set_onMouseUp(HX_CTX,  ::lime::app::_Event_Float_Float_Int_Void_obj::__alloc( HX_CTX ));
HXLINE( 102)		this->_hx_set_onMouseMoveRelative(HX_CTX,  ::lime::app::_Event_Float_Float_Void_obj::__alloc( HX_CTX ));
HXLINE( 101)		this->_hx_set_onMouseMove(HX_CTX,  ::lime::app::_Event_Float_Float_Void_obj::__alloc( HX_CTX ));
HXLINE(  96)		this->_hx_set_onMouseDown(HX_CTX,  ::lime::app::_Event_Float_Float_lime_ui_MouseButton_Void_obj::__alloc( HX_CTX ));
HXLINE(  91)		this->_hx_set_onMinimize(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE(  86)		this->_hx_set_onMaximize(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE(  81)		this->_hx_set_onLeave(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE(  79)		this->_hx_set_onKeyUp(HX_CTX,  ::lime::app::_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj::__alloc( HX_CTX ));
HXLINE(  74)		this->_hx_set_onKeyDown(HX_CTX,  ::lime::app::_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj::__alloc( HX_CTX ));
HXLINE(  69)		this->_hx_set_onHide(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE(  68)		this->_hx_set_onFullscreen(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE(  67)		this->_hx_set_onFocusOut(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE(  66)		this->_hx_set_onFocusIn(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE(  65)		this->_hx_set_onExpose(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE(  64)		this->_hx_set_onEnter(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE(  63)		this->_hx_set_onDropFile(HX_CTX,  ::lime::app::_Event_String_Void_obj::__alloc( HX_CTX ));
HXLINE(  62)		this->_hx_set_onDeactivate(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE(  61)		this->_hx_set_onClose(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE(  60)		this->_hx_set_onActivate(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE( 204)		this->_hx_set_application(HX_CTX, application);
...
HXDLIN( 205)		this->_hx_set__hx___attributes(HX_CTX, _hx_tmp);
HXLINE( 207)		if (::Reflect_obj::hasField(this->_hx___attributes,HX_("parameters",aa,be,7e,51))) {
HXLINE( 207)			this->_hx_set_parameters(HX_CTX,  ::Dynamic(this->_hx___attributes->__Field(HX_("parameters",aa,be,7e,51),::hx::paccDynamic)));
            		}
...
HXDLIN( 215)		this->_hx_set__hx___title(HX_CTX, _hx_tmp1);
...
HXLINE( 224)		this->_hx_set__hx___backend(HX_CTX,  ::lime::_internal::backend::native::NativeWindow_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this)));
...
::String Window_obj::set_title(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_ee84c8bd7ccb9d8c_724_set_title)
HXDLIN( 724)		return (this->_hx_set__hx___title(HX_CTX, this->_hx___backend->setTitle(value)));
            	}
...
::hx::Val Window_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"onHide") ) { _hx_set_onHide(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onMove") ) { _hx_set_onMove(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Float_Float_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onShow") ) { _hx_set_onShow(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"context") ) { _hx_set_context(HX_CTX_GET,inValue.Cast<  ::lime::graphics::RenderContext >()); return inValue; }
		if (HX_FIELD_EQ(inName,"display") ) { _hx_set_display(HX_CTX_GET,inValue.Cast<  ::lime::_hx_system::Display >()); return inValue; }
		if (HX_FIELD_EQ(inName,"element") ) { _hx_set_element(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onClose") ) { _hx_set_onClose(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onEnter") ) { _hx_set_onEnter(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onKeyUp") ) { _hx_set_onKeyUp(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onLeave") ) { _hx_set_onLeave(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"__title") ) { _hx_set__hx___title(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"onExpose") ) { _hx_set_onExpose(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onRender") ) { _hx_set_onRender(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_lime_graphics_RenderContext_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onResize") ) { _hx_set_onResize(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Int_Int_Void >()); return inValue; }
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"onFocusIn") ) { _hx_set_onFocusIn(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onKeyDown") ) { _hx_set_onKeyDown(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onMouseUp") ) { _hx_set_onMouseUp(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Float_Float_Int_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onRestore") ) { _hx_set_onRestore(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"resizable") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_resizable(inValue.Cast< bool >()) ); }
		if (HX_FIELD_EQ(inName,"__backend") ) { _hx_set__hx___backend(HX_CTX_GET,inValue.Cast<  ::lime::_internal::backend::native::NativeWindow >()); return inValue; }
		break;
	case 10:
		...
		if (HX_FIELD_EQ(inName,"onActivate") ) { _hx_set_onActivate(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onDropFile") ) { _hx_set_onDropFile(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_String_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onFocusOut") ) { _hx_set_onFocusOut(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onMaximize") ) { _hx_set_onMaximize(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onMinimize") ) { _hx_set_onMinimize(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onTextEdit") ) { _hx_set_onTextEdit(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_String_Int_Int_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"parameters") ) { _hx_set_parameters(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"onMouseDown") ) { _hx_set_onMouseDown(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Float_Float_lime_ui_MouseButton_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onMouseMove") ) { _hx_set_onMouseMove(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Float_Float_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onTextInput") ) { _hx_set_onTextInput(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_String_Void >()); return inValue; }
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"onDeactivate") ) { _hx_set_onDeactivate(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onFullscreen") ) { _hx_set_onFullscreen(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onMouseWheel") ) { _hx_set_onMouseWheel(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Float_Float_lime_ui_MouseWheelMode_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__attributes") ) { _hx_set__hx___attributes(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	...
	case 16:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"onMouseMoveRelative") ) { _hx_set_onMouseMoveRelative(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Float_Float_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onRenderContextLost") ) { _hx_set_onRenderContextLost(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		break;
	case 23:
		if (HX_FIELD_EQ(inName,"onRenderContextRestored") ) { _hx_set_onRenderContextRestored(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_lime_graphics_RenderContext_Void >()); return inValue; }
	}
