...
class HXCPP_CLASS_ATTRIBUTES TransitionEffect_obj : public  ::flixel::group::FlxTypedSpriteGroup_obj
{
	...
	public:
		...
		inline  ::flixel::FlxCamera _hx_set__customCamera(::hx::StackContext *_hx_ctx, ::flixel::FlxCamera _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _customCamera=_hx_v; }
		 ::flixel::addons::transition::TransitionData _data;
		inline  ::flixel::addons::transition::TransitionData _hx_set__data(::hx::StackContext *_hx_ctx, ::flixel::addons::transition::TransitionData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _data=_hx_v; }
