...
{
            	HX_GC_STACKFRAME(&_hx_pos_0860c5b2df24b64b_102_new)
HXLINE( 103)		( ( ::openfl::net::FileFilter)(__this) )->_hx_set_description(HX_CTX, description);
HXLINE( 104)		( ( ::openfl::net::FileFilter)(__this) )->_hx_set_extension(HX_CTX, extension);
HXLINE( 105)		( ( ::openfl::net::FileFilter)(__this) )->_hx_set_macType(HX_CTX, macType);
            	}
		...
		::String macType;
		inline ::String _hx_set_macType(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return macType=_hx_v; }
};
