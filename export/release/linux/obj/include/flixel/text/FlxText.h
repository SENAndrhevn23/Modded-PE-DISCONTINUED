...
class HXCPP_CLASS_ATTRIBUTES FlxText_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		inline  ::openfl::text::TextFormat _hx_set__defaultFormat(::hx::StackContext *_hx_ctx, ::openfl::text::TextFormat _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _defaultFormat=_hx_v; }
		 ::openfl::text::TextFormat _formatAdjusted;
		inline  ::openfl::text::TextFormat _hx_set__formatAdjusted(::hx::StackContext *_hx_ctx, ::openfl::text::TextFormat _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _formatAdjusted=_hx_v; }
		::Array< ::Dynamic> _formatRanges;
		inline ::Array< ::Dynamic> _hx_set__formatRanges(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _formatRanges=_hx_v; }
		::String _font;
		inline ::String _hx_set__font(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return _font=_hx_v; }
		bool _regen;
		 ::openfl::display::BitmapData _borderPixels;
		inline  ::openfl::display::BitmapData _hx_set__borderPixels(::hx::StackContext *_hx_ctx, ::openfl::display::BitmapData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _borderPixels=_hx_v; }
		 ::openfl::geom::ColorTransform _borderColorTransform;
		inline  ::openfl::geom::ColorTransform _hx_set__borderColorTransform(::hx::StackContext *_hx_ctx, ::openfl::geom::ColorTransform _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _borderColorTransform=_hx_v; }
