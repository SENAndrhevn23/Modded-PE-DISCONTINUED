...
HXLINE(  15)		this->_hx_set_onUpdate(HX_CTX,  ::lime::app::_Event_Float_Float_Float_Void_obj::__alloc( HX_CTX ));
HXLINE(  20)		this->_hx_set_type(HX_CTX, type);
...
::hx::Val Sensor_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 2:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"type") ) { _hx_set_type(HX_CTX_GET,inValue.Cast<  ::lime::_hx_system::SensorType >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"onUpdate") ) { _hx_set_onUpdate(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Float_Float_Float_Void >()); return inValue; }
	}
