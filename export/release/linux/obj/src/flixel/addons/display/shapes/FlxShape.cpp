...
void FlxShape_obj::__construct(Float X,Float Y,Float CanvasWidth,Float CanvasHeight, ::Dynamic LineStyle_,int FillColor,::hx::Null< Float >  __o_TrueWidth,::hx::Null< Float >  __o_TrueHeight){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_3f95af7519c5c220_15_new)
HXLINE(  25)		this->shapeDirty = false;
HXLINE(  24)		this->_hx_set_shape_id(HX_CTX, ::flixel::addons::display::shapes::FlxShapeType_obj::UNKNOWN_dyn());
HXLINE(  43)		super::__construct(X,Y,null());
HXLINE(  45)		{
HXLINE(  45)			this->_hx_set_lineStyle(HX_CTX, LineStyle_);
...
HXLINE(  76)		this->_hx_set__drawStyle(HX_CTX,  ::Dynamic(::hx::Anon_obj::Create(5)
...
void FlxShape_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_3f95af7519c5c220_96_destroy)
HXLINE(  97)		{
HXLINE(  97)			 ::Dynamic ls = null();
HXDLIN(  97)			this->_hx_set_lineStyle(HX_CTX, ls);
...
HX_DEFINE_DYNAMIC_FUNC1(FlxShape_obj,set_fillColor,return )
 ...
 ::Dynamic FlxShape_obj::set_lineStyle( ::Dynamic ls){
            	HX_GC_STACKFRAME(&_hx_pos_3f95af7519c5c220_197_set_lineStyle)
HXLINE( 198)		this->_hx_set_lineStyle(HX_CTX, ls);
...
::hx::Val FlxShape_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"shape_id") ) { _hx_set_shape_id(HX_CTX_GET,inValue.Cast<  ::flixel::addons::display::shapes::FlxShapeType >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"lineStyle") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_lineStyle(inValue.Cast<  ::Dynamic >()) );_hx_set_lineStyle(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"_drawStyle") ) { _hx_set__drawStyle(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 11:
