...
HXLINE( 102)		this->_hx_set_buf(HX_CTX, buf);
HXLINE( 103)		this->length = this->buf.length;
HXLINE( 104)		this->pos = 0;
HXLINE( 108)		this->_hx_set_scache(HX_CTX, ::Array_obj< ::String >::__new());
HXLINE( 109)		this->_hx_set_cache(HX_CTX, ::cpp::VirtualArray_obj::__new());
...
HXLINE( 115)		this->_hx_set_resolver(HX_CTX, r);
            	}
...
HXDLIN( 128)			this->_hx_set_resolver(HX_CTX, ::haxe::_Unserializer::NullResolver_obj::instance);
            		}
            		else {
HXLINE( 130)			this->_hx_set_resolver(HX_CTX, r);
            		}
            	}
