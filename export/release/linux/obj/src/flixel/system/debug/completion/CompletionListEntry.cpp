...
HXLINE(  32)		this->addChild((this->_hx_set_background(HX_CTX,  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,null(),null(),null()))));
HXLINE(  33)		this->background->set_bitmapData(::flixel::_hx_system::debug::completion::CompletionListEntry_obj::normalBitmapData);
HXLINE(  35)		this->_hx_set_label(HX_CTX, ::flixel::_hx_system::debug::DebuggerUtil_obj::createTextField(null(),null(),null(),null()));
...
::hx::Val CompletionListEntry_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"label") ) { _hx_set_label(HX_CTX_GET,inValue.Cast<  ::openfl::text::TextField >()); return inValue; }
		break;
	case 8:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"background") ) { _hx_set_background(HX_CTX_GET,inValue.Cast<  ::openfl::display::Bitmap >()); return inValue; }
	}
