...
HXDLIN(  54)		this->_hx_set_stage(HX_CTX,  ::openfl::display::Stage_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this),_hx_tmp));
HXLINE(  56)		if (::Reflect_obj::hasField(attributes,HX_("parameters",aa,be,7e,51))) {
HXLINE(  58)			try {
            				HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE(  60)				this->stage->get_loaderInfo()->_hx_set_parameters(HX_CTX,  ::Dynamic(attributes->__Field(HX_("parameters",aa,be,7e,51),::hx::paccDynamic)));
            			} catch( ::Dynamic _hx_e) {
...
void Window_obj::close(){
            	HX_GC_STACKFRAME(&_hx_pos_a9a8b88d3857954c_81_close)
...
HXLINE(  95)		this->_hx_set_stage(HX_CTX, null());
            	}
