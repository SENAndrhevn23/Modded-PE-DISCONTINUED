...
void FlxPool_obj::__construct( ::Dynamic constructor){
            	HX_GC_STACKFRAME(&_hx_pos_5955daa7b9049940_38_new)
HXLINE(  49)		this->_count = 0;
HXLINE(  42)		this->_hx_set__pool(HX_CTX, ::cpp::VirtualArray_obj::__new(0));
HXLINE(  59)		this->_hx_set__constructor(HX_CTX, constructor);
            	}
...
::cpp::VirtualArray FlxPool_obj::clear(){
            	HX_GC_STACKFRAME(&_hx_pos_5955daa7b9049940_104_clear)
HXLINE( 105)		this->_count = 0;
HXLINE( 106)		::cpp::VirtualArray oldPool = this->_pool;
HXLINE( 107)		this->_hx_set__pool(HX_CTX, ::cpp::VirtualArray_obj::__new(0));
...
::hx::Val FlxPool_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"_pool") ) { _hx_set__pool(HX_CTX_GET,inValue.Cast< ::cpp::VirtualArray >()); return inValue; }
		break;
	case 6:
