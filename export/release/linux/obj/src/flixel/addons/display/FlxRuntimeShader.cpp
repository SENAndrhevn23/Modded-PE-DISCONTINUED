...
void FlxRuntimeShader_obj::__construct(::String fragmentSource,::String vertexSource){
            	HX_GC_STACKFRAME(&_hx_pos_880c0549bfe0a230_173_new)
...
void FlxRuntimeShader_obj::setFloat(::String name,Float value){
            	HX_GC_STACKFRAME(&_hx_pos_880c0549bfe0a230_194_setFloat)
...
HXLINE( 203)		prop->_hx_set_value(HX_CTX, ::Array_obj< Float >::__new(1)->init(0,value));
            	}
...
void FlxRuntimeShader_obj::setFloatArray(::String name,::Array< Float > value){
            	HX_GC_STACKFRAME(&_hx_pos_880c0549bfe0a230_231_setFloatArray)
...
HXLINE( 240)		prop->_hx_set_value(HX_CTX, value);
            	}
...
void FlxRuntimeShader_obj::setInt(::String name,int value){
            	HX_GC_STACKFRAME(&_hx_pos_880c0549bfe0a230_268_setInt)
...
HXLINE( 277)		prop->_hx_set_value(HX_CTX, ::Array_obj< int >::__new(1)->init(0,value));
            	}
...
void FlxRuntimeShader_obj::setIntArray(::String name,::Array< int > value){
            	HX_GC_STACKFRAME(&_hx_pos_880c0549bfe0a230_305_setIntArray)
...
HXLINE( 314)		prop->_hx_set_value(HX_CTX, value);
            	}
...
void FlxRuntimeShader_obj::setBool(::String name,bool value){
            	HX_GC_STACKFRAME(&_hx_pos_880c0549bfe0a230_342_setBool)
...
HXLINE( 351)		prop->_hx_set_value(HX_CTX, ::Array_obj< bool >::__new(1)->init(0,value));
            	}
...
void FlxRuntimeShader_obj::setBoolArray(::String name,::Array< bool > value){
            	HX_GC_STACKFRAME(&_hx_pos_880c0549bfe0a230_379_setBoolArray)
...
HXLINE( 388)		prop->_hx_set_value(HX_CTX, value);
            	}
...
void FlxRuntimeShader_obj::setSampler2D(::String name, ::openfl::display::BitmapData value){
            	HX_GC_STACKFRAME(&_hx_pos_880c0549bfe0a230_416_setSampler2D)
...
HXLINE( 425)		prop->_hx_set_input(HX_CTX, value);
            	}
...
HXLINE( 475)				input->_hx_set_name(HX_CTX, name);
...
HXLINE( 484)					this->_hx_set__hx___bitmap(HX_CTX, input);
HXDLIN( 484)					goto _hx_goto_16;
            				}
            				if (  (_hx_switch_0==HX_("openfl_Texture",cc,bd,e4,7e)) ){
HXLINE( 482)					this->_hx_set__hx___texture(HX_CTX, input);
...
HXLINE( 548)						parameter->_hx_set_type(HX_CTX, parameterType);
...
HXLINE( 557)							this->_hx_set__hx___hasColorTransform(HX_CTX, parameter);
            						}
...
HXLINE( 572)						parameter1->_hx_set_type(HX_CTX, parameterType);
...
HXLINE( 591)						parameter2->_hx_set_type(HX_CTX, parameterType);
...
HXDLIN( 595)									_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN( 595)										_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN( 595)												_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN( 595)												_this3->_hx_set_buffer(HX_CTX, buffer);
...
HXDLIN( 595)							parameter2->_hx_set__hx___uniformMatrix(HX_CTX, this1);
            						}
...
::String FlxRuntimeShader_obj::set_glFragmentSource(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_880c0549bfe0a230_634_set_glFragmentSource)
...
HXLINE( 641)		return (this->_hx_set__hx___glFragmentSource(HX_CTX, value));
            	}


::String FlxRuntimeShader_obj::set_glVertexSource(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_880c0549bfe0a230_645_set_glVertexSource)
...
HXLINE( 652)		return (this->_hx_set__hx___glVertexSource(HX_CTX, value));
            	}
