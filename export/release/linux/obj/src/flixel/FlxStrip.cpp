...
HXDLIN(  33)		this->_hx_set_colors(HX_CTX,  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length,fixed,array));
HXLINE(  31)		int length1 = null();
HXDLIN(  31)		bool fixed1 = null();
HXDLIN(  31)		::Array< Float > array1 = null();
HXDLIN(  31)		this->_hx_set_uvtData(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length1,fixed1,array1,true));
HXLINE(  26)		int length2 = null();
HXDLIN(  26)		bool fixed2 = null();
HXDLIN(  26)		::Array< int > array2 = null();
HXDLIN(  26)		this->_hx_set_indices(HX_CTX,  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length2,fixed2,array2));
HXLINE(  21)		int length3 = null();
HXDLIN(  21)		bool fixed3 = null();
HXDLIN(  21)		::Array< Float > array3 = null();
HXDLIN(  21)		this->_hx_set_vertices(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length3,fixed3,array3,true));
...
void FlxStrip_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_c99c00bf7ae8682b_38_destroy)
HXLINE(  39)		this->_hx_set_vertices(HX_CTX, null());
HXLINE(  40)		this->_hx_set_indices(HX_CTX, null());
HXLINE(  41)		this->_hx_set_uvtData(HX_CTX, null());
HXLINE(  42)		this->_hx_set_colors(HX_CTX, null());
