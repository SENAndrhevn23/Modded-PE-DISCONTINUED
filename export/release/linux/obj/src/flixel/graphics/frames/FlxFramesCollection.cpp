...
HXLINE(  61)		this->_hx_set_parent(HX_CTX, parent);
HXLINE(  62)		this->_hx_set_type(HX_CTX, type);
...
HXDLIN(  63)		this->_hx_set_border(HX_CTX, _hx_tmp);
HXLINE(  64)		this->_hx_set_frames(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  65)		this->_hx_set_framesByName(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
...
void FlxFramesCollection_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_8894dc9191d7a9ff_133_destroy)
HXLINE( 134)		this->_hx_set_frames(HX_CTX, ::flixel::util::FlxDestroyUtil_obj::destroyArray(this->frames));
HXLINE( 135)		this->_hx_set_border(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->border)) ));
HXLINE( 136)		this->_hx_set_framesByName(HX_CTX, null());
HXLINE( 137)		this->_hx_set_parent(HX_CTX, null());
HXLINE( 138)		this->_hx_set_type(HX_CTX, null());
            	}
...
HXLINE( 196)		texFrame->_hx_set_name(HX_CTX, name);
HXLINE( 197)		{
...
::String FlxFramesCollection_obj::toString(){
            	HX_GC_STACKFRAME(&_hx_pos_8894dc9191d7a9ff_393_toString)
...
HXDLIN( 393)		_this->_hx_set_label(HX_CTX, HX_("frames",a6,af,85,ac));
HXDLIN( 393)		_this->_hx_set_value(HX_CTX, value);
...
HXDLIN( 393)		_this1->_hx_set_label(HX_CTX, HX_("type",ba,f2,08,4d));
HXDLIN( 393)		_this1->_hx_set_value(HX_CTX, value1);
...
HX_DEFINE_DYNAMIC_FUNC0(FlxFramesCollection_obj,get_framesHash,return )
 ...
 ::haxe::ds::StringMap FlxFramesCollection_obj::set_framesHash( ::haxe::ds::StringMap value){
            	HX_GC_STACKFRAME(&_hx_pos_8894dc9191d7a9ff_408_set_framesHash)
HXDLIN( 408)		return (this->_hx_set_framesByName(HX_CTX, value));
            	}
...
::hx::Val FlxFramesCollection_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"type") ) { _hx_set_type(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::frames::FlxFrameCollectionType >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"frames") ) { _hx_set_frames(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"parent") ) { _hx_set_parent(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::FlxGraphic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"border") ) { _hx_set_border(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"framesHash") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_framesHash(inValue.Cast<  ::haxe::ds::StringMap >()) ); }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"framesByName") ) { _hx_set_framesByName(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
	}
