...
HXLINE(  50)				graphics->_hx_set__hx___bounds(HX_CTX,  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
            			}
...
HXLINE( 119)				graphics->_hx_set__hx___cairo(HX_CTX, null());
HXLINE( 120)				graphics->_hx_set__hx___bitmap(HX_CTX, null());
...
HXLINE( 152)			graphics->_hx_set__hx___cairo(HX_CTX,  ::lime::graphics::cairo::Cairo_obj::__alloc( HX_CTX ,surface1));
HXLINE( 153)			graphics->_hx___visible = true;
HXLINE( 154)			graphics->_hx___managed = true;
HXLINE( 156)			graphics->_hx_set__hx___bitmap(HX_CTX, bitmap);
...
HXLINE( 265)								textEngine->_hx_set__hx___cairoFont(HX_CTX, null());
            							}
            						}
HXLINE( 269)						if (::hx::IsNull( textEngine->_hx___cairoFont )) {
HXLINE( 271)							textEngine->_hx_set__hx___font(HX_CTX, font);
HXLINE( 272)							textEngine->_hx_set__hx___cairoFont(HX_CTX, ::lime::graphics::cairo::_CairoFTFontFace::CairoFTFontFace_Impl__obj::create(font,0));
            						}
