...
HX_LOCAL_STACK_FRAME(_hx_pos_b537b97081e2aab9_65_resume,"lime.media.AudioManager","resume",0xd988a3c1,"lime.media.AudioManager.resume","lime/media/AudioManager.hx",65,0x63af6ea2)
HX_LOCAL_STACK_FRAME(_hx_pos_b537b97081e2aab9_81_shutdown,"lime.media.AudioManager","shutdown",0xb121e3aa,"lime.media.AudioManager.shutdown","lime/media/AudioManager.hx",81,0x63af6ea2)
HX_LOCAL_STACK_FRAME(_hx_pos_b537b97081e2aab9_108_suspend,"lime.media.AudioManager","suspend",0x09fdc6e8,"lime.media.AudioManager.suspend","lime/media/AudioManager.hx",108,0x63af6ea2)
namespace lime{
namespace media{
...
HXLINE(  31)				::lime::media::AudioManager_obj::context =  ::lime::media::AudioContext_obj::__alloc( HX_CTX ,null());
HXLINE(  32)				context = ::lime::media::AudioManager_obj::context;
HXLINE(  35)				if ((context->type == HX_("openal",35,5f,94,21))) {
HXLINE(  37)					 ::lime::media::OpenALAudioContext alc = context->openal;
HXLINE(  40)					::mikolka::vslice::components::ALSoftConfig_obj::init();
HXLINE(  42)					 ::Dynamic device = alc->openDevice(null());
HXLINE(  43)					 ::Dynamic ctx = alc->createContext(device,null());
HXLINE(  44)					alc->makeContextCurrent(ctx);
HXLINE(  45)					alc->processContext(ctx);
            				}
            			}
HXLINE(  50)			::lime::media::AudioManager_obj::context = context;
            		}
            	}
...
void AudioManager_obj::resume(){
            	HX_STACKFRAME(&_hx_pos_b537b97081e2aab9_65_resume)
HXDLIN(  65)		bool _hx_tmp;
HXDLIN(  65)		if (::hx::IsNotNull( ::lime::media::AudioManager_obj::context )) {
HXDLIN(  65)			_hx_tmp = (::lime::media::AudioManager_obj::context->type == HX_("openal",35,5f,94,21));
            		}
            		else {
HXDLIN(  65)			_hx_tmp = false;
            		}
HXDLIN(  65)		if (_hx_tmp) {
HXLINE(  67)			 ::lime::media::OpenALAudioContext alc = ::lime::media::AudioManager_obj::context->openal;
HXLINE(  68)			 ::Dynamic currentContext = alc->getCurrentContext();
HXLINE(  70)			if (::hx::IsNotNull( currentContext )) {
HXLINE(  72)				 ::Dynamic device = alc->getContextsDevice(currentContext);
HXLINE(  73)				alc->resumeDevice(device);
HXLINE(  74)				alc->processContext(currentContext);
            			}
            		}
            	}
...
void AudioManager_obj::shutdown(){
            	HX_STACKFRAME(&_hx_pos_b537b97081e2aab9_81_shutdown)
HXLINE(  83)		bool _hx_tmp;
HXDLIN(  83)		if (::hx::IsNotNull( ::lime::media::AudioManager_obj::context )) {
HXLINE(  83)			_hx_tmp = (::lime::media::AudioManager_obj::context->type == HX_("openal",35,5f,94,21));
            		}
            		else {
HXLINE(  83)			_hx_tmp = false;
            		}
HXDLIN(  83)		if (_hx_tmp) {
HXLINE(  85)			 ::lime::media::OpenALAudioContext alc = ::lime::media::AudioManager_obj::context->openal;
HXLINE(  86)			 ::Dynamic currentContext = alc->getCurrentContext();
HXLINE(  88)			if (::hx::IsNotNull( currentContext )) {
HXLINE(  90)				 ::Dynamic device = alc->getContextsDevice(currentContext);
HXLINE(  91)				alc->makeContextCurrent(null());
HXLINE(  92)				alc->destroyContext(currentContext);
HXLINE(  94)				if (::hx::IsNotNull( device )) {
HXLINE(  96)					alc->closeDevice(device);
            				}
            			}
            		}
HXLINE( 102)		::lime::media::AudioManager_obj::context = null();
            	}
...
void AudioManager_obj::suspend(){
            	HX_STACKFRAME(&_hx_pos_b537b97081e2aab9_108_suspend)
HXDLIN( 108)		bool _hx_tmp;
HXDLIN( 108)		if (::hx::IsNotNull( ::lime::media::AudioManager_obj::context )) {
HXDLIN( 108)			_hx_tmp = (::lime::media::AudioManager_obj::context->type == HX_("openal",35,5f,94,21));
            		}
            		else {
HXDLIN( 108)			_hx_tmp = false;
            		}
HXDLIN( 108)		if (_hx_tmp) {
HXLINE( 110)			 ::lime::media::OpenALAudioContext alc = ::lime::media::AudioManager_obj::context->openal;
HXLINE( 111)			 ::Dynamic currentContext = alc->getCurrentContext();
HXLINE( 113)			if (::hx::IsNotNull( currentContext )) {
HXLINE( 115)				alc->suspendContext(currentContext);
HXLINE( 116)				 ::Dynamic device = alc->getContextsDevice(currentContext);
HXLINE( 118)				if (::hx::IsNotNull( device )) {
HXLINE( 120)					alc->pauseDevice(device);
            				}
            			}
            		}
            	}
