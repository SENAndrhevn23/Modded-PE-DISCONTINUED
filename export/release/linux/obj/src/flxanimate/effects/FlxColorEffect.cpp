...
HXLINE(  25)		this->_hx_set_c_Transform(HX_CTX, null());
HXLINE(  19)		this->renderDirty = true;
HXLINE(  32)		this->_hx_set_c_Transform(HX_CTX,  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null()));
...
::hx::Val FlxColorEffect_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"c_Transform") ) { _hx_set_c_Transform(HX_CTX_GET,inValue.Cast<  ::openfl::geom::ColorTransform >()); return inValue; }
	}
