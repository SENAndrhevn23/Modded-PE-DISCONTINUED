...
HXLINE(  56)		this->_hx_set_cairo(HX_CTX, cairo);
HXLINE(  58)		this->_hx_set__hx___matrix(HX_CTX,  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
HXLINE(  59)		this->_hx_set__hx___matrix3(HX_CTX, ::lime::math::_Matrix3::Matrix3_Impl__obj::_new(null(),null(),null(),null(),null(),null()));
HXLINE(  61)		this->_hx_set__hx___type(HX_CTX, HX_("cairo",88,30,19,41));
            	}
...
void CairoRenderer_obj::_hx___setBlendMode( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_765a23aeaf3cad17_236___setBlendMode)
...
HXLINE( 240)		this->_hx_set__hx___blendMode(HX_CTX, value);
...
::hx::Val CairoRenderer_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"__matrix3") ) { _hx_set__hx___matrix3(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
	}
