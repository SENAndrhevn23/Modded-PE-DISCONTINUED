...
HXLINE( 135)			this->_hx_set___s(HX_CTX, _hx_std_socket_new(false));
            		}
...
HXLINE( 141)		this->_hx_set_input(HX_CTX,  ::sys::net::_Socket::SocketInput_obj::__alloc( HX_CTX ,this->__s));
HXLINE( 142)		this->_hx_set_output(HX_CTX,  ::sys::net::_Socket::SocketOutput_obj::__alloc( HX_CTX ,this->__s));
            	}
...
void Socket_obj::close(){
            	HX_GC_STACKFRAME(&_hx_pos_123d5468720475b0_145_close)
...
HXLINE( 150)			input->_hx_set___s(HX_CTX, null());
HXLINE( 151)			output->_hx_set___s(HX_CTX, null());
            		}
...
void Socket_obj::connect( ::sys::net::Host host,int port){
            	HX_GC_STACKFRAME(&_hx_pos_123d5468720475b0_170_connect)
HXDLIN( 170)		try {
...
HXLINE( 176)					this->_hx_set___s(HX_CTX, _hx_std_socket_new(false,true));
...
::hx::Val Socket_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"__s") ) { _hx_set___s(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"input") ) { _hx_set_input(HX_CTX_GET,inValue.Cast<  ::haxe::io::Input >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"output") ) { _hx_set_output(HX_CTX_GET,inValue.Cast<  ::haxe::io::Output >()); return inValue; }
		break;
	case 9:
