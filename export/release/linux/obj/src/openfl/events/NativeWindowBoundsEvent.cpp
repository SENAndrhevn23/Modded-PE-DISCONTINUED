...
void NativeWindowBoundsEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable, ::openfl::geom::Rectangle beforeBounds, ::openfl::geom::Rectangle afterBounds){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_9a121b49e54f4376_106_new)
HXLINE( 107)		super::__construct(type,bubbles,cancelable);
HXLINE( 108)		this->_hx_set_beforeBounds(HX_CTX, beforeBounds);
HXLINE( 109)		this->_hx_set_afterBounds(HX_CTX, afterBounds);
            	}
...
HXLINE( 116)		event->_hx_set_target(HX_CTX, this->target);
HXLINE( 117)		event->_hx_set_currentTarget(HX_CTX, this->currentTarget);
...
::hx::Val NativeWindowBoundsEvent_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 11:
		if (HX_FIELD_EQ(inName,"afterBounds") ) { _hx_set_afterBounds(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"beforeBounds") ) { _hx_set_beforeBounds(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
	}
