...
class HXCPP_CLASS_ATTRIBUTES FlxTimer_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::flixel::util::FlxTimerManager _hx_set_manager(::hx::StackContext *_hx_ctx, ::flixel::util::FlxTimerManager _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return manager=_hx_v; }
		Float time;
		int loops;
		bool active;
		bool finished;
