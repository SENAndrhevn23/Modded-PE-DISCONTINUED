...
HXDLIN( 707)			this->_hx_set__hx___array(HX_CTX,  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,9,8));
            		}
...
HXLINE( 752)		{
HXLINE( 752)			 ::lime::utils::ArrayBufferView this1 = ::openfl::geom::Matrix_obj::_hx___matrix3;
HXDLIN( 752)			Float a = this->a;
HXDLIN( 752)			Float b = this->b;
HXDLIN( 752)			Float c = this->c;
HXDLIN( 752)			Float d = this->d;
HXDLIN( 752)			Float tx = this->tx;
HXDLIN( 752)			Float ty = this->ty;
HXDLIN( 752)			 ::__hxcpp_memory_set_float(this1->buffer->b,this1->byteOffset,a);
HXDLIN( 752)			 ::__hxcpp_memory_set_float(this1->buffer->b,(this1->byteOffset + 4),b);
HXDLIN( 752)			 ::__hxcpp_memory_set_float(this1->buffer->b,(this1->byteOffset + 12),c);
HXDLIN( 752)			 ::__hxcpp_memory_set_float(this1->buffer->b,(this1->byteOffset + 16),d);
HXDLIN( 752)			 ::__hxcpp_memory_set_float(this1->buffer->b,(this1->byteOffset + 24),tx);
HXDLIN( 752)			 ::__hxcpp_memory_set_float(this1->buffer->b,(this1->byteOffset + 28),ty);
            		}
...
::hx::Val Matrix_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 2:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"__array") ) { _hx_set__hx___array(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
	}
...
{
            	HX_STACKFRAME(&_hx_pos_99143fe9fb0bb031_79_boot)
HXDLIN(  79)		_hx___matrix3 = ::lime::math::_Matrix3::Matrix3_Impl__obj::_new(null(),null(),null(),null(),null(),null());
            	}
}
