...
void NativeApplication_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_d993c3fd7589a798_21_new)
HXLINE( 247)		this->_hx_set__hx___openedWindows(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE( 232)		this->_hx_set_icon(HX_CTX, null());
...
::hx::Val NativeApplication_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"icon") ) { _hx_set_icon(HX_CTX_GET,inValue.Cast<  ::openfl::desktop::InteractiveIcon >()); return inValue; }
		break;
	case 8:
	...
	case 12:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"__activeWindow") ) { _hx_set__hx___activeWindow(HX_CTX_GET,inValue.Cast<  ::openfl::display::NativeWindow >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"__openedWindows") ) { _hx_set__hx___openedWindows(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
