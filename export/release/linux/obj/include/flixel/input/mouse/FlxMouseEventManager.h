...
class HXCPP_CLASS_ATTRIBUTES FlxMouseEventManager_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		::Array< ::Dynamic> _list;
		inline ::Array< ::Dynamic> _hx_set__list(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _list=_hx_v; }
		::Array< ::Dynamic> _overList;
		inline ::Array< ::Dynamic> _hx_set__overList(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _overList=_hx_v; }
		::Array< ::Dynamic> _downList;
		inline ::Array< ::Dynamic> _hx_set__downList(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _downList=_hx_v; }
		::Array< ::Dynamic> _clickList;
		inline ::Array< ::Dynamic> _hx_set__clickList(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _clickList=_hx_v; }
