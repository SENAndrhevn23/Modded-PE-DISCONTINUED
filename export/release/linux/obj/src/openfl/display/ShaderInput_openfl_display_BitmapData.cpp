...
void ShaderInput_openfl_display_BitmapData_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_e18280422777664c_141_new)
HXLINE( 142)		this->channels = 0;
HXLINE( 143)		this->_hx_set_filter(HX_CTX, 5);
HXLINE( 144)		this->height = 0;
HXLINE( 145)		this->_hx_set_index(HX_CTX, 0);
HXLINE( 146)		this->_hx_set_mipFilter(HX_CTX, 2);
HXLINE( 147)		this->width = 0;
HXLINE( 148)		this->_hx_set_wrap(HX_CTX, 0);
            	}
...
::hx::Val ShaderInput_openfl_display_BitmapData_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		if (HX_FIELD_EQ(inName,"wrap") ) { _hx_set_wrap(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"index") ) { _hx_set_index(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"input") ) { _hx_set_input(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
		if (HX_FIELD_EQ(inName,"width") ) { width=inValue.Cast< int >(); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"filter") ) { _hx_set_filter(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"mipFilter") ) { _hx_set_mipFilter(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 11:
