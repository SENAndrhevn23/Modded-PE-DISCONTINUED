...
class HXCPP_CLASS_ATTRIBUTES FlxDrawBaseItem_obj : public ::hx::Object
{
	...
	public:
		...
		static ::Dynamic blendToInt_dyn();
		 ...
		 ::Dynamic nextTyped;
		inline  ::Dynamic _hx_set_nextTyped(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return nextTyped=_hx_v; }
		 ::flixel::graphics::tile::FlxDrawBaseItem next;
		inline  ::flixel::graphics::tile::FlxDrawBaseItem _hx_set_next(::hx::StackContext *_hx_ctx, ::flixel::graphics::tile::FlxDrawBaseItem _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return next=_hx_v; }
		 ::flixel::graphics::FlxGraphic graphics;
		inline  ::flixel::graphics::FlxGraphic _hx_set_graphics(::hx::StackContext *_hx_ctx, ::flixel::graphics::FlxGraphic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return graphics=_hx_v; }
		bool antialiasing;
		bool colored;
		...
		inline  ::flixel::graphics::tile::FlxDrawItemType _hx_set_type(::hx::StackContext *_hx_ctx, ::flixel::graphics::tile::FlxDrawItemType _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return type=_hx_v; }
		virtual void reset();
		::Dynamic reset_dyn();
