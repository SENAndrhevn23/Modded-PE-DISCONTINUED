...
HXLINE(  79)		this->_hx_set_group(HX_CTX,  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,MaxSize));
HXLINE(  80)		this->_hx_set__sprites(HX_CTX, this->group->members);
            	}
...
HXLINE(  92)		this->_hx_set_offset(HX_CTX,  ::flixel::math::FlxCallbackPoint_obj::__alloc( HX_CTX ,this->offsetCallback_dyn(),null(),null()));
HXLINE(  93)		this->_hx_set_origin(HX_CTX,  ::flixel::math::FlxCallbackPoint_obj::__alloc( HX_CTX ,this->originCallback_dyn(),null(),null()));
HXLINE(  94)		this->_hx_set_scale(HX_CTX,  ::flixel::math::FlxCallbackPoint_obj::__alloc( HX_CTX ,this->scaleCallback_dyn(),null(),null()));
HXLINE(  95)		this->_hx_set_scrollFactor(HX_CTX,  ::flixel::math::FlxCallbackPoint_obj::__alloc( HX_CTX ,this->scrollFactorCallback_dyn(),null(),null()));
HXLINE(  97)		{
...
HXDLIN( 100)			this->_hx_set_velocity(HX_CTX, point);
...
HXDLIN( 100)			this->_hx_set_acceleration(HX_CTX, point1);
...
HXDLIN( 100)			this->_hx_set_drag(HX_CTX, point2);
...
HXDLIN( 100)			this->_hx_set_maxVelocity(HX_CTX, point3);
            		}
            	}


void FlxTypedSpriteGroup_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_114_destroy)
HXLINE( 116)		this->_hx_set_offset(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::destroy(this->offset)) ));
HXLINE( 117)		this->_hx_set_origin(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::destroy(this->origin)) ));
HXLINE( 118)		this->_hx_set_scale(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::destroy(this->scale)) ));
HXLINE( 119)		this->_hx_set_scrollFactor(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::destroy(this->scrollFactor)) ));
HXLINE( 121)		this->_hx_set_group(HX_CTX, ( ( ::flixel::group::FlxTypedGroup)(::flixel::util::FlxDestroyUtil_obj::destroy(this->group)) ));
HXLINE( 122)		this->_hx_set__sprites(HX_CTX, null());
...
HXLINE( 790)		return (this->color = Value);
 ...
 ::Dynamic FlxTypedSpriteGroup_obj::set_blend( ::Dynamic Value){
            	HX_GC_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_794_set_blend)
...
HXLINE( 797)		return (this->_hx_set_blend(HX_CTX, Value));
            	}
...
::hx::Val FlxTypedSpriteGroup_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"group") ) { _hx_set_group(HX_CTX_GET,inValue.Cast<  ::flixel::group::FlxTypedGroup >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"maxSize") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_maxSize(inValue.Cast< int >()) ); }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"_sprites") ) { _hx_set__sprites(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 11:
