...
void DisplayObjectShader_obj::__construct( ::openfl::utils::ByteArrayData code){
            	HX_GC_STACKFRAME(&_hx_pos_2d8f6df4c3f42d01_104_new)
...
::hx::Val DisplayObjectShader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 12:
		if (HX_FIELD_EQ(inName,"openfl_Alpha") ) { _hx_set_openfl_Alpha(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"openfl_Matrix") ) { _hx_set_openfl_Matrix(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"openfl_Texture") ) { _hx_set_openfl_Texture(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"openfl_Position") ) { _hx_set_openfl_Position(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"openfl_ColorOffset") ) { _hx_set_openfl_ColorOffset(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		if (HX_FIELD_EQ(inName,"openfl_TextureSize") ) { _hx_set_openfl_TextureSize(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"openfl_TextureCoord") ) { _hx_set_openfl_TextureCoord(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 22:
		if (HX_FIELD_EQ(inName,"openfl_ColorMultiplier") ) { _hx_set_openfl_ColorMultiplier(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 24:
		if (HX_FIELD_EQ(inName,"openfl_HasColorTransform") ) { _hx_set_openfl_HasColorTransform(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Bool >()); return inValue; }
	}
