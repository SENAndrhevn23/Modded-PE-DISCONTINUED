...
void FlxSwipe_obj::__construct(int ID, ::flixel::math::FlxBasePoint StartPosition, ::flixel::math::FlxBasePoint EndPosition,int StartTimeInTicks){
            	HX_GC_STACKFRAME(&_hx_pos_223f15e5be8ee429_32_new)
HXLINE(  33)		this->ID = ID;
HXLINE(  34)		this->_hx_set_startPosition(HX_CTX, StartPosition);
HXLINE(  35)		this->_hx_set_endPosition(HX_CTX, EndPosition);
...
::String FlxSwipe_obj::toString(){
            	HX_GC_STACKFRAME(&_hx_pos_223f15e5be8ee429_42_toString)
...
HXDLIN(  43)		_this->_hx_set_label(HX_CTX, HX_("ID",db,3f,00,00));
HXDLIN(  43)		_this->_hx_set_value(HX_CTX, value);
...
HXDLIN(  44)		_this1->_hx_set_label(HX_CTX, HX_("start",62,74,0b,84));
HXDLIN(  44)		_this1->_hx_set_value(HX_CTX, value1);
...
HXDLIN(  45)		_this2->_hx_set_label(HX_CTX, HX_("end",db,03,4d,00));
HXDLIN(  45)		_this2->_hx_set_value(HX_CTX, value2);
...
HXDLIN(  46)		_this3->_hx_set_label(HX_CTX, HX_("distance",35,93,f9,6b));
HXDLIN(  46)		_this3->_hx_set_value(HX_CTX, value3);
...
HXDLIN(  47)		_this4->_hx_set_label(HX_CTX, HX_("degrees",a7,e3,5a,3a));
HXDLIN(  47)		_this4->_hx_set_value(HX_CTX, value4);
...
HXDLIN(  48)		_this5->_hx_set_label(HX_CTX, HX_("duration",54,0f,8e,14));
HXDLIN(  48)		_this5->_hx_set_value(HX_CTX, value5);
...
::hx::Val FlxSwipe_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 2:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"endPosition") ) { _hx_set_endPosition(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		break;
	case 13:
