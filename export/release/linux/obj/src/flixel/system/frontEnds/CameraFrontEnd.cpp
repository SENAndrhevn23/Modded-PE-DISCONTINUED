...
HXLINE(  53)		this->_hx_set__cameraRect(HX_CTX,  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
HXLINE(  48)		this->useBufferLocking = false;
HXLINE(  42)		this->_hx_set_cameraResized(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX ));
HXLINE(  39)		this->_hx_set_cameraRemoved(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX ));
HXLINE(  36)		this->_hx_set_cameraAdded(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX ));
HXLINE(  28)		this->_hx_set_defaults(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  22)		this->_hx_set_list(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
...
::hx::Val CameraFrontEnd_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"defaults") ) { _hx_set_defaults(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"cameraAdded") ) { _hx_set_cameraAdded(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal1 >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_cameraRect") ) { _hx_set__cameraRect(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"cameraRemoved") ) { _hx_set_cameraRemoved(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal1 >()); return inValue; }
		if (HX_FIELD_EQ(inName,"cameraResized") ) { _hx_set_cameraResized(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal1 >()); return inValue; }
		break;
	case 16:
