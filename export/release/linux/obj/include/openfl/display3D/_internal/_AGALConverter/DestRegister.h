...
class HXCPP_CLASS_ATTRIBUTES DestRegister_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::openfl::display3D::_internal::_AGALConverter::ProgramType _hx_set_programType(::hx::StackContext *_hx_ctx, ::openfl::display3D::_internal::_AGALConverter::ProgramType _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return programType=_hx_v; }
		int type;
		::String getWriteMask();
