...
HX_DECLARE_STACK_FRAME(_hx_pos_a12cec1f7f1a6feb_13_new)
...
{
            	HX_GC_STACKFRAME(&_hx_pos_a12cec1f7f1a6feb_13_new)
HXDLIN(  13)		( ( ::crowplexus::iris::IrisCall)(__this) )->_hx_set_funName(HX_CTX, funName);
HXDLIN(  13)		( ( ::crowplexus::iris::IrisCall)(__this) )->_hx_set_signature(HX_CTX, signature);
HXDLIN(  13)		( ( ::crowplexus::iris::IrisCall)(__this) )->_hx_set_returnValue(HX_CTX, returnValue);
            	}
		...
		::String funName;
		inline ::String _hx_set_funName(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return funName=_hx_v; }
		 ::Dynamic signature;
		inline  ::Dynamic _hx_set_signature(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return signature=_hx_v; }
		 ::Dynamic returnValue;
