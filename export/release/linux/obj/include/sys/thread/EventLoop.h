...
class HXCPP_CLASS_ATTRIBUTES EventLoop_obj : public ::hx::Object
{
	...
	public:
		...
		inline ::Array< ::Dynamic> _hx_set_oneTimeEvents(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return oneTimeEvents=_hx_v; }
		int oneTimeEventsIdx;
		 ::sys::thread::Lock waitLock;
		inline  ::sys::thread::Lock _hx_set_waitLock(::hx::StackContext *_hx_ctx, ::sys::thread::Lock _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return waitLock=_hx_v; }
		int promisedEventsCount;
		 ::sys::thread::_EventLoop::RegularEvent regularEvents;
		inline  ::sys::thread::_EventLoop::RegularEvent _hx_set_regularEvents(::hx::StackContext *_hx_ctx, ::sys::thread::_EventLoop::RegularEvent _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return regularEvents=_hx_v; }
		bool isMainThread;
