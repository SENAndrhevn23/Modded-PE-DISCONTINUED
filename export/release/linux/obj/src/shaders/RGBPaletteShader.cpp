...
HX_DEFINE_STACK_FRAME(_hx_pos_7cea3061d3662d29_152_new,"shaders.RGBPaletteShader","new",0x51b57a05,"shaders.RGBPaletteShader.new","shaders/RGBPalette.hx",152,0xd43b990f)
namespace shaders{

void RGBPaletteShader_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_7cea3061d3662d29_152_new)
...
HXLINE( 153)		super::__construct(null());
HXLINE( 117)		this->_hx___isGenerated = true;
HXDLIN( 117)		this->_hx___initGL();
            	}
