...
HXLINE( 107)		this->_hx_set_minSize(HX_CTX,  ::openfl::geom::Point_obj::__alloc( HX_CTX ,50,30));
...
HXLINE( 112)		this->_hx_set__drag(HX_CTX,  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null()));
HXLINE( 113)		this->_resizable = Resizable;
HXLINE( 114)		this->_closable = Closable;
HXLINE( 115)		this->_alwaysOnTop = AlwaysOnTop;
HXLINE( 117)		this->_hx_set__shadow(HX_CTX,  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,1,2,true,-16777216),null(),null()));
HXLINE( 118)		this->_hx_set__background(HX_CTX,  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,1,1,true,-580952225),null(),null()));
HXLINE( 119)		this->_hx_set__header(HX_CTX,  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,1,15,true,(int)-1157627904),null(),null()));
HXLINE( 120)		 ::openfl::display::Bitmap _hx_tmp = this->_background;
HXDLIN( 120)		_hx_tmp->set_y(this->_header->get_height());
HXLINE( 122)		this->_hx_set__title(HX_CTX, ::flixel::_hx_system::debug::DebuggerUtil_obj::createTextField(2,-1,null(),null()));
...
HXLINE( 134)			this->_hx_set__icon(HX_CTX,  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,Icon,null(),null()));
...
HXLINE( 144)			this->_hx_set__handle(HX_CTX,  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,::flixel::_hx_system::debug::DebuggerUtil_obj::fixSize( ::flixel::_hx_system::debug::_Window::GraphicWindowHandle_obj::__alloc( HX_CTX ,0,0,null(),null())),null(),null()));
HXLINE( 145)			this->addChild(this->_handle);
            		}
HXLINE( 148)		if (this->_closable) {
HXLINE( 150)			this->_hx_set__closeButton(HX_CTX,  ::flixel::_hx_system::ui::FlxSystemButton_obj::__alloc( HX_CTX , ::flixel::_hx_system::debug::GraphicCloseButton_obj::__alloc( HX_CTX ,0,0,null(),null()),this->close_dyn(),null()));
...
void Window_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_4e51d5a8805713a4_176_destroy)
HXLINE( 177)		this->_hx_set_minSize(HX_CTX, null());
HXLINE( 178)		this->_hx_set_maxSize(HX_CTX, null());
HXLINE( 179)		this->_hx_set__bounds(HX_CTX, null());
HXLINE( 180)		if (::hx::IsNotNull( this->_shadow )) {
HXLINE( 182)			this->removeChild(this->_shadow);
            		}
HXLINE( 184)		this->_hx_set__shadow(HX_CTX, null());
HXLINE( 185)		if (::hx::IsNotNull( this->_background )) {
HXLINE( 187)			this->removeChild(this->_background);
            		}
HXLINE( 189)		this->_hx_set__background(HX_CTX, null());
HXLINE( 190)		if (::hx::IsNotNull( this->_header )) {
HXLINE( 192)			this->removeChild(this->_header);
            		}
HXLINE( 194)		this->_hx_set__header(HX_CTX, null());
HXLINE( 195)		if (::hx::IsNotNull( this->_title )) {
HXLINE( 197)			this->removeChild(this->_title);
            		}
HXLINE( 199)		this->_hx_set__title(HX_CTX, null());
HXLINE( 200)		if (::hx::IsNotNull( this->_handle )) {
HXLINE( 202)			this->removeChild(this->_handle);
            		}
HXLINE( 204)		this->_hx_set__handle(HX_CTX, null());
HXLINE( 205)		this->_hx_set__drag(HX_CTX, null());
HXLINE( 206)		this->_hx_set__closeButton(HX_CTX, ( ( ::flixel::_hx_system::ui::FlxSystemButton)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_closeButton)) ));
...
HXLINE( 251)		this->_hx_set__bounds(HX_CTX, Bounds);
HXLINE( 252)		if (::hx::IsNotNull( this->_bounds )) {
HXLINE( 254)			this->_hx_set_maxSize(HX_CTX,  ::openfl::geom::Point_obj::__alloc( HX_CTX ,this->_bounds->width,this->_bounds->height));
            		}
            		else {
HXLINE( 258)			this->_hx_set_maxSize(HX_CTX,  ::openfl::geom::Point_obj::__alloc( HX_CTX ,((Float)1.79e+308),((Float)1.79e+308)));
            		}
            	}
...
::hx::Val Window_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 3:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"_icon") ) { _hx_set__icon(HX_CTX_GET,inValue.Cast<  ::openfl::display::Bitmap >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_drag") ) { _hx_set__drag(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Point >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"_width") ) { _width=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_title") ) { _hx_set__title(HX_CTX_GET,inValue.Cast<  ::openfl::text::TextField >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"minSize") ) { _hx_set_minSize(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Point >()); return inValue; }
		if (HX_FIELD_EQ(inName,"maxSize") ) { _hx_set_maxSize(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Point >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_height") ) { _height=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_bounds") ) { _hx_set__bounds(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_header") ) { _hx_set__header(HX_CTX_GET,inValue.Cast<  ::openfl::display::Bitmap >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_shadow") ) { _hx_set__shadow(HX_CTX_GET,inValue.Cast<  ::openfl::display::Bitmap >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_handle") ) { _hx_set__handle(HX_CTX_GET,inValue.Cast<  ::openfl::display::Bitmap >()); return inValue; }
		break;
	case 9:
	...
	case 10:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"_background") ) { _hx_set__background(HX_CTX_GET,inValue.Cast<  ::openfl::display::Bitmap >()); return inValue; }
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"toggleButton") ) { _hx_set_toggleButton(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::ui::FlxSystemButton >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_closeButton") ) { _hx_set__closeButton(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::ui::FlxSystemButton >()); return inValue; }
