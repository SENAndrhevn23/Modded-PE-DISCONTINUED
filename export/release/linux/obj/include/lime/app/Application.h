...
HX_DECLARE_CLASS2(lime,app,_Event_Int_lime_system_Orientation_Void)
HX_DECLARE_CLASS2(lime,app,_Event_lime_system_Orientation_Void)
...
class HXCPP_CLASS_ATTRIBUTES Application_obj : public  ::lime::app::Module_obj
{
	...
	public:
		...
		inline  ::haxe::ds::StringMap _hx_set_meta(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return meta=_hx_v; }
		::Array< ::Dynamic> modules;
		inline ::Array< ::Dynamic> _hx_set_modules(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return modules=_hx_v; }
		 ::lime::app::_Event_Int_Void onUpdate;
		inline  ::lime::app::_Event_Int_Void _hx_set_onUpdate(::hx::StackContext *_hx_ctx, ::lime::app::_Event_Int_Void _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onUpdate=_hx_v; }
		 ::lime::app::_Event_lime_ui_Window_Void onCreateWindow;
		inline  ::lime::app::_Event_lime_ui_Window_Void _hx_set_onCreateWindow(::hx::StackContext *_hx_ctx, ::lime::app::_Event_lime_ui_Window_Void _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onCreateWindow=_hx_v; }
		 ::lime::app::_Event_Int_lime_system_Orientation_Void onDisplayOrientationChange;
		inline  ::lime::app::_Event_Int_lime_system_Orientation_Void _hx_set_onDisplayOrientationChange(::hx::StackContext *_hx_ctx, ::lime::app::_Event_Int_lime_system_Orientation_Void _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onDisplayOrientationChange=_hx_v; }
		 ::lime::app::_Event_lime_system_Orientation_Void onDeviceOrientationChange;
		inline  ::lime::app::_Event_lime_system_Orientation_Void _hx_set_onDeviceOrientationChange(::hx::StackContext *_hx_ctx, ::lime::app::_Event_lime_system_Orientation_Void _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onDeviceOrientationChange=_hx_v; }
		 ::lime::utils::Preloader preloader;
		inline  ::lime::utils::Preloader _hx_set_preloader(::hx::StackContext *_hx_ctx, ::lime::utils::Preloader _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return preloader=_hx_v; }
		...
		inline ::Array< ::Dynamic> _hx_set_windows(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return windows=_hx_v; }
		 ::lime::_internal::backend::native::NativeApplication _hx___backend;
		inline  ::lime::_internal::backend::native::NativeApplication _hx_set__hx___backend(::hx::StackContext *_hx_ctx, ::lime::_internal::backend::native::NativeApplication _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___backend=_hx_v; }
		 ::lime::utils::Preloader _hx___preloader;
		inline  ::lime::utils::Preloader _hx_set__hx___preloader(::hx::StackContext *_hx_ctx, ::lime::utils::Preloader _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___preloader=_hx_v; }
		 ::lime::ui::Window _hx___window;
		inline  ::lime::ui::Window _hx_set__hx___window(::hx::StackContext *_hx_ctx, ::lime::ui::Window _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___window=_hx_v; }
		 ::haxe::ds::IntMap _hx___windowByID;
		inline  ::haxe::ds::IntMap _hx_set__hx___windowByID(::hx::StackContext *_hx_ctx, ::haxe::ds::IntMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___windowByID=_hx_v; }
		::Array< ::Dynamic> _hx___windows;
		inline ::Array< ::Dynamic> _hx_set__hx___windows(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___windows=_hx_v; }
		...
		int get_deviceOrientation();
		::Dynamic get_deviceOrientation_dyn();
