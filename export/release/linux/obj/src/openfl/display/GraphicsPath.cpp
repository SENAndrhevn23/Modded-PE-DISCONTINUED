...
void GraphicsPath_obj::__construct( ::openfl::_Vector::IntVector commands, ::openfl::_Vector::FloatVector data, ::Dynamic __o_winding){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_9d2387a0b056a42f_59_new)
HXLINE(  60)		this->_hx_set_commands(HX_CTX, commands);
HXLINE(  61)		this->_hx_set_data(HX_CTX, data);
HXLINE(  62)		this->_hx_set_winding(HX_CTX, winding);
...
HXDLIN(  85)			this->_hx_set_commands(HX_CTX,  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length,fixed,array));
            		}
HXLINE(  86)		if (::hx::IsNull( this->data )) {
HXLINE(  86)			int length1 = null();
HXDLIN(  86)			bool fixed1 = null();
HXDLIN(  86)			::Array< Float > array1 = null();
HXDLIN(  86)			this->_hx_set_data(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length1,fixed1,array1,true));
            		}
...
HXDLIN( 116)			this->_hx_set_commands(HX_CTX,  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length,fixed,array));
            		}
...
HXDLIN( 117)			this->_hx_set_data(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length1,fixed1,array1,true));
            		}
...
HXDLIN( 135)			this->_hx_set_commands(HX_CTX,  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length,fixed,array));
            		}
...
HXDLIN( 136)			this->_hx_set_data(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length1,fixed1,array1,true));
            		}
...
HXDLIN( 152)			this->_hx_set_commands(HX_CTX,  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length,fixed,array));
            		}
...
HXDLIN( 153)			this->_hx_set_data(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length1,fixed1,array1,true));
            		}
...
HXDLIN( 169)			this->_hx_set_commands(HX_CTX,  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length,fixed,array));
            		}
...
HXDLIN( 170)			this->_hx_set_data(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length1,fixed1,array1,true));
            		}
...
HXDLIN( 186)			this->_hx_set_commands(HX_CTX,  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length,fixed,array));
            		}
...
HXDLIN( 187)			this->_hx_set_data(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length1,fixed1,array1,true));
            		}
...
::hx::Val GraphicsPath_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"data") ) { _hx_set_data(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::FloatVector >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"winding") ) { _hx_set_winding(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"commands") ) { _hx_set_commands(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::IntVector >()); return inValue; }
		break;
	case 18:
