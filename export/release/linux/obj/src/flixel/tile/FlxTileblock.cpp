...
void FlxTileblock_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_ca22d206eb905d85_39_destroy)
HXLINE(  40)		this->_hx_set_tileSprite(HX_CTX, ( ( ::flixel::FlxSprite)(::flixel::util::FlxDestroyUtil_obj::destroy(this->tileSprite)) ));
...
HXDLIN(  59)		this->_hx_set_tileSprite(HX_CTX, _hx_tmp);
...
::hx::Val FlxTileblock_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 10:
		if (HX_FIELD_EQ(inName,"tileSprite") ) { _hx_set_tileSprite(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSprite >()); return inValue; }
	}
