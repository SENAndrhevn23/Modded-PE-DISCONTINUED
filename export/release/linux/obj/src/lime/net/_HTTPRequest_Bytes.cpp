...
HXLINE( 111)			_gthis->_hx_set_responseData(HX_CTX, errorResponse->responseData);
...
HXLINE( 117)			_gthis->_hx_set_responseData(HX_CTX, _gthis->fromBytes(bytes));
...
HXLINE( 102)			this->_hx_set_uri(HX_CTX, uri);
            		}
