...
void TextLayout_obj::__construct(::String __o_text, ::lime::text::Font font,::hx::Null< int >  __o_size,::hx::Null< int >  __o_direction,::String __o_script,::String __o_language){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_25_new)
...
HXLINE(  80)		this->_hx_set__hx___script(HX_CTX, script);
HXLINE(  81)		this->_hx_set__hx___language(HX_CTX, language);
HXLINE(  83)		this->_hx_set_positions(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
...
void TextLayout_obj::_hx___create(int direction,::String script,::String language){
            	HX_GC_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_90___create)
HXLINE(  91)		if ((language.length != 4)) {
HXLINE(  91)			return;
            		}
HXLINE(  94)		this->_hx_set__hx___hbBuffer(HX_CTX, ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::_new());
HXLINE(  95)		{
...
HXLINE( 103)		this->_hx_set_positions(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
...
HXLINE( 110)				this->_hx_set__hx___buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc((this->text.length * 5)));
            			}
HXLINE( 114)			if (::hx::IsInstanceNotEq( this->_hx___font,this->font )) {
HXLINE( 116)				this->_hx_set__hx___font(HX_CTX, this->font);
HXLINE( 118)				this->font->_hx___setSize(this->size,null());
HXLINE( 119)				this->_hx_set__hx___hbFont(HX_CTX, ::lime::text::harfbuzz::_HBFTFont::HBFTFont_Impl__obj::_new(this->font));
...
HXLINE( 131)				this->font->_hx___setSize(this->size,null());
            			}
HXLINE( 134)			if (::hx::IsNull( this->_hx___hbBuffer )) {
HXLINE( 136)				this->_hx_set__hx___hbBuffer(HX_CTX, ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::_new());
            			}
            			else {
...
HX_DEFINE_DYNAMIC_FUNC1(TextLayout_obj,set_direction,return )
 ...
 ::lime::text::Font TextLayout_obj::set_font( ::lime::text::Font value){
            	HX_GC_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_218_set_font)
HXLINE( 219)		if (::hx::IsInstanceEq( value,this->font )) {
HXLINE( 219)			return value;
            		}
HXLINE( 221)		this->_hx_set_font(HX_CTX, value);
...
::String TextLayout_obj::set_language(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_246_set_language)
HXLINE( 247)		if ((value == this->_hx___language)) {
HXLINE( 247)			return value;
            		}
HXLINE( 249)		this->_hx_set__hx___language(HX_CTX, value);
...
::String TextLayout_obj::set_script(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_261_set_script)
HXLINE( 262)		if ((value == this->_hx___script)) {
HXLINE( 262)			return value;
            		}
HXLINE( 264)		this->_hx_set__hx___script(HX_CTX, value);
...
::String TextLayout_obj::set_text(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_280_set_text)
HXLINE( 281)		if ((value == this->text)) {
HXLINE( 281)			return value;
            		}
HXLINE( 283)		this->_hx_set_text(HX_CTX, value);
...
::hx::Val TextLayout_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"font") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_font(inValue.Cast<  ::lime::text::Font >()) );_hx_set_font(HX_CTX_GET,inValue.Cast<  ::lime::text::Font >()); return inValue; }
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"glyphs") ) { _hx_set_glyphs(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"script") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_script(inValue.Cast< ::String >()) ); }
		if (HX_FIELD_EQ(inName,"__font") ) { _hx_set__hx___font(HX_CTX_GET,inValue.Cast<  ::lime::text::Font >()); return inValue; }
		break;
	case 7:
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"__buffer") ) { _hx_set__hx___buffer(HX_CTX_GET,inValue.Cast<  ::haxe::io::Bytes >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__handle") ) { _hx_set__hx___handle(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__script") ) { _hx_set__hx___script(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__hbFont") ) { _hx_set__hx___hbFont(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"direction") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_direction(inValue.Cast< int >()) ); }
		if (HX_FIELD_EQ(inName,"positions") ) { _hx_set_positions(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"__language") ) { _hx_set__hx___language(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__hbBuffer") ) { _hx_set__hx___hbBuffer(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 11:
