...
HX_DEFINE_STACK_FRAME(_hx_pos_ebf7fdb6543df13b_14_new,"mikolka.stages.standard.Limo","new",0x5fd79135,"mikolka.stages.standard.Limo.new","mikolka/stages/standard/Limo.hx",14,0xe5f2701a)
HX_LOCAL_STACK_FRAME(_hx_pos_ebf7fdb6543df13b_31_create,"mikolka.stages.standard.Limo","create",0xe62e1947,"mikolka.stages.standard.Limo.create","mikolka/stages/standard/Limo.hx",31,0xe5f2701a)
static const ::String _hx_array_data_f4a7d2c3_2[] = {
	HX_("background limo pink",65,40,fe,9c),
};
static const ::String _hx_array_data_f4a7d2c3_3[] = {
	HX_("Henchmen on rail",13,dc,25,64),
};
static const ::String _hx_array_data_f4a7d2c3_4[] = {
	HX_("henchmen death",34,87,54,b2),
};
static const ::String _hx_array_data_f4a7d2c3_5[] = {
	HX_("blood",ba,7f,fc,b4),
};
HX_LOCAL_STACK_FRAME(_hx_pos_ebf7fdb6543df13b_79_createPost,"mikolka.stages.standard.Limo","createPost",0xb0577947,"mikolka.stages.standard.Limo.createPost","mikolka/stages/standard/Limo.hx",79,0xe5f2701a)
static const ::String _hx_array_data_f4a7d2c3_7[] = {
	HX_("Limo stage",1d,b3,df,4c),
};
HX_LOCAL_STACK_FRAME(_hx_pos_ebf7fdb6543df13b_89_update,"mikolka.stages.standard.Limo","update",0xf1243854,"mikolka.stages.standard.Limo.update","mikolka/stages/standard/Limo.hx",89,0xe5f2701a)
HX_LOCAL_STACK_FRAME(_hx_pos_ebf7fdb6543df13b_92_update,"mikolka.stages.standard.Limo","update",0xf1243854,"mikolka.stages.standard.Limo.update","mikolka/stages/standard/Limo.hx",92,0xe5f2701a)
static const ::String _hx_array_data_f4a7d2c3_11[] = {
	HX_("blood",ba,7f,fc,b4),
};
HX_LOCAL_STACK_FRAME(_hx_pos_ebf7fdb6543df13b_173_beatHit,"mikolka.stages.standard.Limo","beatHit",0xe4c239d2,"mikolka.stages.standard.Limo.beatHit","mikolka/stages/standard/Limo.hx",173,0xe5f2701a)
HX_LOCAL_STACK_FRAME(_hx_pos_ebf7fdb6543df13b_177_beatHit,"mikolka.stages.standard.Limo","beatHit",0xe4c239d2,"mikolka.stages.standard.Limo.beatHit","mikolka/stages/standard/Limo.hx",177,0xe5f2701a)
HX_LOCAL_STACK_FRAME(_hx_pos_ebf7fdb6543df13b_188_closeSubState,"mikolka.stages.standard.Limo","closeSubState",0x0ef5155e,"mikolka.stages.standard.Limo.closeSubState","mikolka/stages/standard/Limo.hx",188,0xe5f2701a)
HX_LOCAL_STACK_FRAME(_hx_pos_ebf7fdb6543df13b_196_openSubState,"mikolka.stages.standard.Limo","openSubState",0x274262e6,"mikolka.stages.standard.Limo.openSubState","mikolka/stages/standard/Limo.hx",196,0xe5f2701a)
HX_LOCAL_STACK_FRAME(_hx_pos_ebf7fdb6543df13b_204_eventCalled,"mikolka.stages.standard.Limo","eventCalled",0xb655be0c,"mikolka.stages.standard.Limo.eventCalled","mikolka/stages/standard/Limo.hx",204,0xe5f2701a)
HX_LOCAL_STACK_FRAME(_hx_pos_ebf7fdb6543df13b_212_dancersParenting,"mikolka.stages.standard.Limo","dancersParenting",0x9bab6baf,"mikolka.stages.standard.Limo.dancersParenting","mikolka/stages/standard/Limo.hx",212,0xe5f2701a)
HX_LOCAL_STACK_FRAME(_hx_pos_ebf7fdb6543df13b_220_resetLimoKill,"mikolka.stages.standard.Limo","resetLimoKill",0x1b3b8861,"mikolka.stages.standard.Limo.resetLimoKill","mikolka/stages/standard/Limo.hx",220,0xe5f2701a)
HX_LOCAL_STACK_FRAME(_hx_pos_ebf7fdb6543df13b_232_resetFastCar,"mikolka.stages.standard.Limo","resetFastCar",0x3ff83554,"mikolka.stages.standard.Limo.resetFastCar","mikolka/stages/standard/Limo.hx",232,0xe5f2701a)
HX_LOCAL_STACK_FRAME(_hx_pos_ebf7fdb6543df13b_248_fastCarDrive,"mikolka.stages.standard.Limo","fastCarDrive",0xaecc939d,"mikolka.stages.standard.Limo.fastCarDrive","mikolka/stages/standard/Limo.hx",248,0xe5f2701a)
HX_LOCAL_STACK_FRAME(_hx_pos_ebf7fdb6543df13b_241_fastCarDrive,"mikolka.stages.standard.Limo","fastCarDrive",0xaecc939d,"mikolka.stages.standard.Limo.fastCarDrive","mikolka/stages/standard/Limo.hx",241,0xe5f2701a)
HX_LOCAL_STACK_FRAME(_hx_pos_ebf7fdb6543df13b_256_killHenchmen,"mikolka.stages.standard.Limo","killHenchmen",0x229ffa69,"mikolka.stages.standard.Limo.killHenchmen","mikolka/stages/standard/Limo.hx",256,0xe5f2701a)
namespace mikolka{
namespace stages{
namespace standard{

void Limo_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_ebf7fdb6543df13b_14_new)
HXLINE(  87)		this->limoSpeed = ((Float)0);
HXLINE(  28)		this->dancersDiff = ((Float)320);
HXLINE(  21)		this->_hx_set_limoKillingState(HX_CTX, ::mikolka::stages::standard::HenchmenKillState_obj::WAIT_dyn());
...
bool Limo_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x230cab9d) {
		if (inClassId<=(int)0x07d5b4b3) {
			return inClassId==(int)0x00000001 || inClassId==(int)0x07d5b4b3;
		} else {
...
void Limo_obj::create(){
            	HX_GC_STACKFRAME(&_hx_pos_ebf7fdb6543df13b_31_create)
...
HXLINE(  35)		if (!(::mikolka::compatibility::VsliceOptions_obj::get_LOW_QUALITY())) {
HXLINE(  36)			this->_hx_set_limoMetalPole(HX_CTX,  ::objects::BGSprite_obj::__alloc( HX_CTX ,HX_("gore/metalPole",6b,f5,62,65),-500,220,((Float)0.4),((Float)0.4),null(),null()));
HXLINE(  37)			this->add(this->limoMetalPole);
HXLINE(  39)			this->_hx_set_bgLimo(HX_CTX,  ::objects::BGSprite_obj::__alloc( HX_CTX ,HX_("limo/bgLimo",b4,c7,45,2c),-150,480,((Float)0.4),((Float)0.4),::Array_obj< ::String >::fromData( _hx_array_data_f4a7d2c3_2,1),true));
HXLINE(  40)			this->add(this->bgLimo);
HXLINE(  42)			this->_hx_set_limoCorpse(HX_CTX,  ::objects::BGSprite_obj::__alloc( HX_CTX ,HX_("gore/noooooo",da,20,24,22),-500,(this->limoMetalPole->y - ( (Float)(130) )),((Float)0.4),((Float)0.4),::Array_obj< ::String >::fromData( _hx_array_data_f4a7d2c3_3,1),true));
HXLINE(  43)			this->add(this->limoCorpse);
HXLINE(  45)			this->_hx_set_limoCorpseTwo(HX_CTX,  ::objects::BGSprite_obj::__alloc( HX_CTX ,HX_("gore/noooooo",da,20,24,22),-500,this->limoMetalPole->y,((Float)0.4),((Float)0.4),::Array_obj< ::String >::fromData( _hx_array_data_f4a7d2c3_4,1),true));
HXLINE(  46)			this->add(this->limoCorpseTwo);
HXLINE(  48)			this->_hx_set_grpLimoDancers(HX_CTX,  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null()));
...
HXLINE(  58)			this->_hx_set_limoLight(HX_CTX,  ::objects::BGSprite_obj::__alloc( HX_CTX ,HX_("gore/coldHeartKiller",79,ac,4a,05),(this->limoMetalPole->x - ( (Float)(180) )),(this->limoMetalPole->y - ( (Float)(80) )),((Float)0.4),((Float)0.4),null(),null()));
HXLINE(  59)			this->add(this->limoLight);
HXLINE(  61)			this->_hx_set_grpLimoParticles(HX_CTX,  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null()));
HXLINE(  62)			this->add(this->grpLimoParticles);
HXLINE(  65)			 ::objects::BGSprite particle =  ::objects::BGSprite_obj::__alloc( HX_CTX ,HX_("gore/stupidBlood",af,b8,f7,cb),-400,-400,((Float)0.4),((Float)0.4),::Array_obj< ::String >::fromData( _hx_array_data_f4a7d2c3_5,1),false);
...
HXLINE(  75)		this->_hx_set_fastCar(HX_CTX,  ::objects::BGSprite_obj::__alloc( HX_CTX ,HX_("limo/fastCarLol",c1,b0,ed,94),-300,160,null(),null(),null(),null()));
HXLINE(  76)		this->fastCar->set_active(true);
            	}


void Limo_obj::createPost(){
            	HX_GC_STACKFRAME(&_hx_pos_ebf7fdb6543df13b_79_createPost)
HXLINE(  80)		this->resetFastCar();
HXLINE(  81)		this->addBehindGF(this->fastCar);
HXLINE(  83)		 ::objects::BGSprite limo =  ::objects::BGSprite_obj::__alloc( HX_CTX ,HX_("limo/limoDrive",3b,67,64,e6),-120,550,1,1,::Array_obj< ::String >::fromData( _hx_array_data_f4a7d2c3_7,1),true);
HXLINE(  84)		this->addBehindGF(limo);
            	}


void Limo_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_ebf7fdb6543df13b_89_update)
HXDLIN(  89)		 ::mikolka::stages::standard::Limo _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(  90)		if (!(::mikolka::compatibility::VsliceOptions_obj::get_LOW_QUALITY())) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::mikolka::stages::standard::Limo,_gthis) HXARGC(1)
            			void _hx_run( ::objects::BGSprite spr){
            				HX_STACKFRAME(&_hx_pos_ebf7fdb6543df13b_92_update)
...
HXLINE( 121)										 ::objects::BGSprite particle3 =  ::objects::BGSprite_obj::__alloc( HX_CTX ,HX_("gore/stupidBlood",af,b8,f7,cb),(dancers->__get(i).StaticCast<  ::states::stages::objects::BackgroundDancer >()->x - ( (Float)(110) )),(dancers->__get(i).StaticCast<  ::states::stages::objects::BackgroundDancer >()->y + 20),((Float)0.4),((Float)0.4),::Array_obj< ::String >::fromData( _hx_array_data_f4a7d2c3_11,1),false);
...
HXLINE( 137)						this->_hx_set_limoKillingState(HX_CTX, ::mikolka::stages::standard::HenchmenKillState_obj::SPEEDING_OFFSCREEN_dyn());
            					}
            				}
            				break;
            				case (int)2: {
HXLINE( 141)					 ::mikolka::stages::standard::Limo _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 145)						this->_hx_set_limoKillingState(HX_CTX, ::mikolka::stages::standard::HenchmenKillState_obj::SPEEDING_dyn());
            					}
            				}
            				break;
            				case (int)3: {
HXLINE( 149)					 ::mikolka::stages::standard::Limo _hx_tmp3 = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 154)						this->_hx_set_limoKillingState(HX_CTX, ::mikolka::stages::standard::HenchmenKillState_obj::STOPPING_dyn());
...
HXLINE( 163)						this->_hx_set_limoKillingState(HX_CTX, ::mikolka::stages::standard::HenchmenKillState_obj::WAIT_dyn());
            					}
...
void Limo_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_ebf7fdb6543df13b_173_beatHit)
HXLINE( 174)		if (!(::mikolka::compatibility::VsliceOptions_obj::get_LOW_QUALITY())) {
            			HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            			void _hx_run( ::states::stages::objects::BackgroundDancer dancer){
            				HX_STACKFRAME(&_hx_pos_ebf7fdb6543df13b_177_beatHit)
...
void Limo_obj::closeSubState(){
            	HX_STACKFRAME(&_hx_pos_ebf7fdb6543df13b_188_closeSubState)
HXDLIN( 188)		if (( ( ::states::PlayState)(::flixel::FlxG_obj::game->_state) )->paused) {
...
void Limo_obj::openSubState( ::flixel::FlxSubState SubState){
            	HX_STACKFRAME(&_hx_pos_ebf7fdb6543df13b_196_openSubState)
HXDLIN( 196)		if (( ( ::states::PlayState)(::flixel::FlxG_obj::game->_state) )->paused) {
...
void Limo_obj::eventCalled(::String eventName,::String value1,::String value2, ::Dynamic flValue1, ::Dynamic flValue2,Float strumTime){
            	HX_STACKFRAME(&_hx_pos_ebf7fdb6543df13b_204_eventCalled)
...
void Limo_obj::dancersParenting(){
            	HX_STACKFRAME(&_hx_pos_ebf7fdb6543df13b_212_dancersParenting)
...
void Limo_obj::resetLimoKill(){
            	HX_STACKFRAME(&_hx_pos_ebf7fdb6543df13b_220_resetLimoKill)
...
void Limo_obj::resetFastCar(){
            	HX_STACKFRAME(&_hx_pos_ebf7fdb6543df13b_232_resetFastCar)
...
void Limo_obj::fastCarDrive(){
            		...
            		void _hx_run( ::flixel::util::FlxTimer tmr){
            			HX_GC_STACKFRAME(&_hx_pos_ebf7fdb6543df13b_248_fastCarDrive)
HXLINE( 249)			_gthis->resetFastCar();
HXLINE( 250)			_gthis->_hx_set_carTimer(HX_CTX, null());
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_ebf7fdb6543df13b_241_fastCarDrive)
HXDLIN( 241)		 ::mikolka::stages::standard::Limo _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXDLIN( 245)			int x = ::flixel::FlxG_obj::random->_hx_int(170,220,null());
HXDLIN( 245)			this1->set_x(((( (Float)(x) ) / ::flixel::FlxG_obj::elapsed) * ( (Float)(3) )));
            		}
HXLINE( 246)		this->fastCarCanDrive = false;
HXLINE( 247)		this->_hx_set_carTimer(HX_CTX,  ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(2, ::Dynamic(new _hx_Closure_0(_gthis)),null()));
            	}
...
void Limo_obj::killHenchmen(){
            	HX_GC_STACKFRAME(&_hx_pos_ebf7fdb6543df13b_256_killHenchmen)
HXDLIN( 256)		if (!(::mikolka::compatibility::VsliceOptions_obj::get_LOW_QUALITY())) {
HXLINE( 257)			if (::hx::IsPointerEq( this->limoKillingState,::mikolka::stages::standard::HenchmenKillState_obj::WAIT_dyn() )) {
...
HXLINE( 263)				this->_hx_set_limoKillingState(HX_CTX, ::mikolka::stages::standard::HenchmenKillState_obj::KILLING_dyn());
...
::hx::ObjectPtr< Limo_obj > Limo_obj::__alloc(::hx::Ctx *_hx_ctx) {
	Limo_obj *__this = (Limo_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(Limo_obj), true, "mikolka.stages.standard.Limo"));
...
::hx::Val Limo_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 15:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"limoKillingState") ) { _hx_set_limoKillingState(HX_CTX_GET,inValue.Cast<  ::mikolka::stages::standard::HenchmenKillState >()); return inValue; }
...
static ::hx::StorageInfo Limo_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::mikolka::stages::standard::HenchmenKillState */ ,(int)offsetof(Limo_obj,limoKillingState),HX_("limoKillingState",2c,a9,3f,1b)},
...
void Limo_obj::__register()
{
	...
	__mClass->mName = HX_("mikolka.stages.standard.Limo",c3,d2,a7,f4);
