...
class HXCPP_CLASS_ATTRIBUTES FlxTypedGroup_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		inline  ::flixel::util::_FlxSignal::FlxSignal1 _hx_set__memberAdded(::hx::StackContext *_hx_ctx, ::flixel::util::_FlxSignal::FlxSignal1 _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _memberAdded=_hx_v; }
		 ::flixel::util::_FlxSignal::FlxSignal1 _memberRemoved;
		inline  ::flixel::util::_FlxSignal::FlxSignal1 _hx_set__memberRemoved(::hx::StackContext *_hx_ctx, ::flixel::util::_FlxSignal::FlxSignal1 _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _memberRemoved=_hx_v; }
		int _marker;
