...
void StringBuf_obj::flush(){
            	HX_GC_STACKFRAME(&_hx_pos_7d06a5e189b00d33_43_flush)
HXLINE(  44)		if (::hx::IsNull( this->b )) {
HXLINE(  45)			this->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,this->charBufAsString()));
            		}
            		else {
HXLINE(  47)			::Array< ::String > _hx_tmp = this->b;
HXDLIN(  47)			_hx_tmp->push(this->charBufAsString());
            		}
HXLINE(  48)		this->_hx_set_charBuf(HX_CTX, null());
            	}
...
::hx::Val StringBuf_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
		if (HX_FIELD_EQ(inName,"b") ) { _hx_set_b(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"charBuf") ) { _hx_set_charBuf(HX_CTX_GET,inValue.Cast< ::Array< char > >()); return inValue; }
	}
