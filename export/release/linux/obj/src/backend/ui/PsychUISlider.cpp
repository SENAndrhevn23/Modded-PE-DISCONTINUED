...
HXLINE(  22)		this->_hx_set_onChange(HX_CTX, callback);
HXLINE(  24)		this->_hx_set_bar(HX_CTX,  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(1,1,-1,null(),null()));
HXLINE(  25)		{
...
HXLINE(  30)		this->_hx_set_minText(HX_CTX,  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,80,HX_("",00,00,00,00),8,null()));
...
HXLINE(  34)		this->_hx_set_maxText(HX_CTX,  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,80,HX_("",00,00,00,00),8,null()));
...
HXLINE(  38)		this->_hx_set_valueText(HX_CTX,  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,80,HX_("",00,00,00,00),8,null()));
...
HXLINE(  42)		this->_hx_set_labelText(HX_CTX,  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,wid,HX_("",00,00,00,00),8,null()));
HXLINE(  43)		this->labelText->set_alignment(HX_("center",d5,25,db,05));
HXLINE(  44)		this->add(this->labelText);
HXLINE(  46)		this->_hx_set_handle(HX_CTX,  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(1,1,-1,null(),null()));
HXLINE(  47)		{
...
::hx::Val PsychUISlider_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"handle") ) { _hx_set_handle(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSprite >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"minText") ) { _hx_set_minText(HX_CTX_GET,inValue.Cast<  ::flixel::text::FlxText >()); return inValue; }
		if (HX_FIELD_EQ(inName,"maxText") ) { _hx_set_maxText(HX_CTX_GET,inValue.Cast<  ::flixel::text::FlxText >()); return inValue; }
		break;
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"valueText") ) { _hx_set_valueText(HX_CTX_GET,inValue.Cast<  ::flixel::text::FlxText >()); return inValue; }
		if (HX_FIELD_EQ(inName,"labelText") ) { _hx_set_labelText(HX_CTX_GET,inValue.Cast<  ::flixel::text::FlxText >()); return inValue; }
		break;
	case 12:
