...
HXLINE(  18)		this->_hx_set_value(HX_CTX,  ::flixel::input::gamepad::lists::FlxGamepadAnalogValueList_obj::__alloc( HX_CTX ,gamepad));
HXLINE(  19)		this->_hx_set_justMoved(HX_CTX,  ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList_obj::__alloc( HX_CTX ,2,gamepad));
HXLINE(  20)		this->_hx_set_justReleased(HX_CTX,  ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList_obj::__alloc( HX_CTX ,-1,gamepad));
            	}
...
::hx::Val FlxGamepadAnalogList_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"value") ) { _hx_set_value(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::lists::FlxGamepadAnalogValueList >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"justMoved") ) { _hx_set_justMoved(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"justReleased") ) { _hx_set_justReleased(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList >()); return inValue; }
	}
