...
HXLINE( 126)		this->_hx_set__translationKey(HX_CTX, null());
HXLINE( 125)		this->_hx_set__text(HX_CTX, null());
HXLINE( 124)		this->_hx_set__name(HX_CTX, null());
HXLINE(  42)		this->_hx_set_keys(HX_CTX, null());
HXLINE(  41)		this->_hx_set_defaultKeys(HX_CTX, null());
HXLINE(  39)		this->_hx_set_name(HX_CTX, HX_("Unknown",6a,4b,cc,ae));
HXLINE(  38)		this->_hx_set_description(HX_CTX, HX_("",00,00,00,00));
HXLINE(  37)		this->_hx_set_displayFormat(HX_CTX, HX_("%v",b1,20,00,00));
HXLINE(  35)		this->decimals = 1;
HXLINE(  34)		this->_hx_set_maxValue(HX_CTX, null());
HXLINE(  33)		this->_hx_set_minValue(HX_CTX, null());
HXLINE(  32)		this->_hx_set_changeValue(HX_CTX, 1);
HXLINE(  31)		this->_hx_set_options(HX_CTX, null());
HXLINE(  30)		this->curOption = 0;
HXLINE(  28)		this->_hx_set_defaultValue(HX_CTX, null());
HXLINE(  27)		this->_hx_set_variable(HX_CTX, null());
HXLINE(  26)		this->scrollSpeed = ((Float)50);
HXLINE(  24)		this->_hx_set_type(HX_CTX, ::options::OptionType_obj::BOOL_dyn());
HXLINE(  23)		this->_hx_set_onChange(HX_CTX, null());
HXLINE(  46)		this->_hx_set__name(HX_CTX, name);
...
HXDLIN(  47)		this->_hx_set__translationKey(HX_CTX, _hx_tmp);
...
HXDLIN(  48)		::backend::Language_obj::phraseStr = ( ( ::haxe::ds::StringMap)(this1) )->get_string(::StringTools_obj::trim(hideChars->replace(::StringTools_obj::replace(key,HX_(" ",20,00,00,00),HX_("_",5f,00,00,00)),HX_("",00,00,00,00)).toLowerCase()));
HXDLIN(  48)		if (::hx::IsNull( ::backend::Language_obj::phraseStr )) {
HXLINE(  48)			::backend::Language_obj::phraseStr = name;
            		}
HXDLIN(  48)		if (::hx::IsNull( ::backend::Language_obj::phraseStr )) {
HXLINE(  48)			::backend::Language_obj::phraseStr = key;
            		}
HXDLIN(  48)		if (::hx::IsNotNull( values )) {
...
HXDLIN(  48)				::backend::Language_obj::phraseStr = ::StringTools_obj::replace(::backend::Language_obj::phraseStr,((HX_("{",7b,00,00,00) + (num + 1)) + HX_("}",7d,00,00,00)),( (::String)(value) ));
            			}
            		}
HXDLIN(  48)		this->_hx_set_name(HX_CTX, ::backend::Language_obj::phraseStr);
...
HXDLIN(  49)		::backend::Language_obj::phraseStr = ( ( ::haxe::ds::StringMap)(this2) )->get_string(::StringTools_obj::trim(hideChars1->replace(::StringTools_obj::replace(key1,HX_(" ",20,00,00,00),HX_("_",5f,00,00,00)),HX_("",00,00,00,00)).toLowerCase()));
HXDLIN(  49)		if (::hx::IsNull( ::backend::Language_obj::phraseStr )) {
HXLINE(  49)			::backend::Language_obj::phraseStr = description;
            		}
HXDLIN(  49)		if (::hx::IsNull( ::backend::Language_obj::phraseStr )) {
HXLINE(  49)			::backend::Language_obj::phraseStr = key1;
            		}
HXDLIN(  49)		if (::hx::IsNotNull( values1 )) {
...
HXDLIN(  49)				::backend::Language_obj::phraseStr = ::StringTools_obj::replace(::backend::Language_obj::phraseStr,((HX_("{",7b,00,00,00) + (num1 + 1)) + HX_("}",7d,00,00,00)),( (::String)(value1) ));
            			}
            		}
HXDLIN(  49)		this->_hx_set_description(HX_CTX, ::backend::Language_obj::phraseStr);
HXLINE(  50)		this->_hx_set_variable(HX_CTX, variable);
HXLINE(  51)		this->_hx_set_type(HX_CTX, type);
HXLINE(  52)		this->_hx_set_options(HX_CTX, options);
HXLINE(  54)		if (::hx::IsPointerNotEq( this->type,::options::OptionType_obj::KEYBIND_dyn() )) {
HXLINE(  54)			this->_hx_set_defaultValue(HX_CTX, ::Reflect_obj::getProperty(::backend::ClientPrefs_obj::defaultData,variable));
            		}
HXLINE(  55)		switch((int)(type->_hx_getIndex())){
            			case (int)0: {
HXLINE(  58)				if (::hx::IsNull( this->defaultValue )) {
HXLINE(  58)					this->_hx_set_defaultValue(HX_CTX, false);
            				}
            			}
            			break;
            			case (int)1: case (int)2: {
HXLINE(  60)				if (::hx::IsNull( this->defaultValue )) {
HXLINE(  60)					this->_hx_set_defaultValue(HX_CTX, 0);
            				}
            			}
            			break;
            			case (int)3: {
HXLINE(  62)				if (::hx::IsNull( this->defaultValue )) {
HXLINE(  62)					this->_hx_set_defaultValue(HX_CTX, 1);
            				}
HXLINE(  63)				this->_hx_set_displayFormat(HX_CTX, HX_("%v%",54,7a,1c,00));
HXLINE(  64)				this->_hx_set_changeValue(HX_CTX, ((Float)0.01));
HXLINE(  65)				this->_hx_set_minValue(HX_CTX, 0);
HXLINE(  66)				this->_hx_set_maxValue(HX_CTX, 1);
...
HXLINE(  71)					this->_hx_set_defaultValue(HX_CTX, options->__get(0));
            				}
HXLINE(  72)				if (::hx::IsNull( this->defaultValue )) {
HXLINE(  73)					this->_hx_set_defaultValue(HX_CTX, HX_("",00,00,00,00));
            				}
            			}
            			break;
            			case (int)5: {
HXLINE(  76)				this->_hx_set_defaultValue(HX_CTX, HX_("",00,00,00,00));
HXLINE(  77)				this->_hx_set_defaultKeys(HX_CTX,  ::Dynamic(::hx::Anon_obj::Create(2)
            					->setFixed(0,HX_("gamepad",a1,e0,85,89),HX_("NONE",b8,da,ca,33))
            					->setFixed(1,HX_("keyboard",a7,bc,29,68),HX_("NONE",b8,da,ca,33))));
HXLINE(  78)				this->_hx_set_keys(HX_CTX,  ::Dynamic(::hx::Anon_obj::Create(2)
            					->setFixed(0,HX_("gamepad",a1,e0,85,89),HX_("NONE",b8,da,ca,33))
            					->setFixed(1,HX_("keyboard",a7,bc,29,68),HX_("NONE",b8,da,ca,33))));
            			}
            			break;
...
HXLINE( 134)			this->_hx_set__text(HX_CTX, newValue);
...
HXDLIN( 135)			::backend::Language_obj::phraseStr = ( ( ::haxe::ds::StringMap)(this1) )->get_string(::StringTools_obj::trim(hideChars->replace(::StringTools_obj::replace(key1,HX_(" ",20,00,00,00),HX_("_",5f,00,00,00)),HX_("",00,00,00,00)).toLowerCase()));
HXDLIN( 135)			if (::hx::IsNull( ::backend::Language_obj::phraseStr )) {
HXLINE( 135)				::backend::Language_obj::phraseStr = defaultPhrase;
            			}
HXDLIN( 135)			if (::hx::IsNull( ::backend::Language_obj::phraseStr )) {
HXLINE( 135)				::backend::Language_obj::phraseStr = key1;
            			}
HXDLIN( 135)			if (::hx::IsNotNull( values )) {
...
HXDLIN( 135)					::backend::Language_obj::phraseStr = ::StringTools_obj::replace(::backend::Language_obj::phraseStr,((HX_("{",7b,00,00,00) + (num + 1)) + HX_("}",7d,00,00,00)),( (::String)(value) ));
            				}
            			}
HXDLIN( 135)			_hx_tmp->set_text(::backend::Language_obj::phraseStr);
...
::hx::Val Option_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		if (HX_FIELD_EQ(inName,"keys") ) { _hx_set_keys(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 5:
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"getValue") ) { _hx_set_getValue(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"setValue") ) { _hx_set_setValue(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 9:
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"description") ) { _hx_set_description(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"defaultKeys") ) { _hx_set_defaultKeys(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 12:
	...
	case 13:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"_translationKey") ) { _hx_set__translationKey(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	}
