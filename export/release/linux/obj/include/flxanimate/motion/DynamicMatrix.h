...
class HXCPP_CLASS_ATTRIBUTES DynamicMatrix_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::openfl::_Vector::ObjectVector _hx_set_m_matrix(::hx::StackContext *_hx_ctx, ::openfl::_Vector::ObjectVector _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return m_matrix=_hx_v; }
