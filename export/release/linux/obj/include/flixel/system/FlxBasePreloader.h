...
class HXCPP_CLASS_ATTRIBUTES FlxBasePreloader_obj : public  ::flixel::_hx_system::_FlxBasePreloader::DefaultPreloader_obj
{
	...
	public:
		...
		inline ::Array< ::String > _hx_set_allowedURLs(::hx::StackContext *_hx_ctx,::Array< ::String > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return allowedURLs=_hx_v; }
		int siteLockURLIndex;
		::String siteLockTitleText;
		inline ::String _hx_set_siteLockTitleText(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return siteLockTitleText=_hx_v; }
		::String siteLockBodyText;
		inline ::String _hx_set_siteLockBodyText(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return siteLockBodyText=_hx_v; }
		Float _percent;
		int _width;
		int _height;
		bool _loaded;
