...
void GraphicsShader_obj::__construct( ::openfl::utils::ByteArrayData code){
            	HX_GC_STACKFRAME(&_hx_pos_642a1830a16331e0_104_new)
...
::hx::Val GraphicsShader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"bitmap") ) { _hx_set_bitmap(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >()); return inValue; }
		break;
	case 12:
