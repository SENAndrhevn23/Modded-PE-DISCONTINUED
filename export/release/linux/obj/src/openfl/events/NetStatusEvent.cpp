...
void NetStatusEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable, ::Dynamic info){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_27135fd1b85393b6_150_new)
HXLINE( 151)		this->_hx_set_info(HX_CTX, info);
...
HXLINE( 159)		event->_hx_set_target(HX_CTX, this->target);
HXLINE( 160)		event->_hx_set_currentTarget(HX_CTX, this->currentTarget);
...
void NetStatusEvent_obj::_hx___init(){
            	HX_GC_STACKFRAME(&_hx_pos_27135fd1b85393b6_171___init)
HXLINE( 172)		this->super::_hx___init();
HXLINE( 173)		this->_hx_set_info(HX_CTX, null());
            	}
...
::hx::Val NetStatusEvent_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"info") ) { _hx_set_info(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
