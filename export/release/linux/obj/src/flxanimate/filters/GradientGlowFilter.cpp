...
HXLINE( 284)		this->_hx_set__hx___colors(HX_CTX, colors);
HXLINE( 285)		this->_hx_set__hx___alphas(HX_CTX, alphas);
HXLINE( 286)		this->_hx_set__hx___ratios(HX_CTX, ratios);
...
HXLINE( 291)		this->_hx_set__hx___type(HX_CTX, type);
HXLINE( 292)		this->_hx___knockout = knockout;
HXLINE( 293)		this->_hx_set__hx___colorFadeArr(HX_CTX,  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,0));
...
HXDLIN( 310)		return  ::flxanimate::filters::GradientGlowFilter_obj::__alloc( HX_CTX ,this->_hx___distance,this->_hx___angle,this->_hx___colors,this->_hx___alphas,this->_hx___ratios,this->_hx___blurX,this->_hx___blurY,this->_hx___strength,this->_hx___quality,this->_hx___type,this->_hx___knockout);
 ...
 ::openfl::display::Shader GradientGlowFilter_obj::_hx___initShader( ::openfl::display::DisplayObjectRenderer renderer,int pass, ::openfl::display::BitmapData sourceBitmapData){
            	HX_GC_STACKFRAME(&_hx_pos_25fa1c831a7caa8d_315___initShader)
...
HXLINE( 334)			shader->uColor->_hx_set_value(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_4c7daec7_4,4));
...
HXLINE( 344)			shader1->colorGradient->_hx_set_input(HX_CTX, ::flxanimate::filters::GradientGlowFilter_obj::_hx___colorFadeBmp);
...
HXLINE( 387)				shader2->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 394)			shader3->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 371)				shader4->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 377)			shader5->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 355)				shader6->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 361)			shader7->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
::Array< Float > GradientGlowFilter_obj::set_alphas(::Array< Float > value){
            	HX_GC_STACKFRAME(&_hx_pos_25fa1c831a7caa8d_480_set_alphas)
HXLINE( 481)		if (::hx::IsPointerNotEq( value,this->_hx___alphas )) {
HXLINE( 483)			this->_hx_set__hx___alphas(HX_CTX, value);
...
::Array< int > GradientGlowFilter_obj::set_colors(::Array< int > value){
            	HX_GC_STACKFRAME(&_hx_pos_25fa1c831a7caa8d_544_set_colors)
HXLINE( 545)		if (::hx::IsPointerNotEq( value,this->_hx___colors )) {
HXLINE( 547)			this->_hx_set__hx___colors(HX_CTX, value);
...
::Array< int > GradientGlowFilter_obj::set_ratios(::Array< int > value){
            	HX_GC_STACKFRAME(&_hx_pos_25fa1c831a7caa8d_598_set_ratios)
HXLINE( 599)		if (::hx::IsPointerNotEq( value,this->_hx___ratios )) {
HXLINE( 601)			this->_hx_set__hx___ratios(HX_CTX, value);
...
::String GradientGlowFilter_obj::set_type(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_25fa1c831a7caa8d_625_set_type)
HXLINE( 626)		if ((value != this->_hx___type)) {
HXLINE( 628)			this->_hx_set__hx___type(HX_CTX, value);
