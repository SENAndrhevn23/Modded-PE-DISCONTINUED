...
void FlxSystemButton_obj::__construct( ::openfl::display::BitmapData Icon, ::Dynamic UpHandler,::hx::Null< bool >  __o_ToggleMode){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_9eece198099547db_14_new)
...
HXLINE(  66)		this->_hx_set_upHandler(HX_CTX, UpHandler);
...
HXLINE(  86)		this->_hx_set__icon(HX_CTX,  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,Icon,null(),null()));
...
void FlxSystemButton_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_9eece198099547db_91_destroy)
...
HXLINE(  96)		this->_hx_set__icon(HX_CTX, null());
HXLINE(  97)		this->_hx_set_upHandler(HX_CTX, null());
            	}
...
::hx::Val FlxSystemButton_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"upHandler") ) { _hx_set_upHandler(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 10:
