...
HX_DEFINE_STACK_FRAME(_hx_pos_70f0cc6e85e841ba_451_new,"objects.PixelSplashShader","new",0xb8c8064a,"objects.PixelSplashShader.new","objects/NoteSplash.hx",451,0xe471e78a)
namespace objects{

void PixelSplashShader_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_70f0cc6e85e841ba_451_new)
...
HXLINE( 452)		super::__construct(null());
HXLINE( 409)		this->_hx___isGenerated = true;
HXDLIN( 409)		this->_hx___initGL();
            	}
...
bool PixelSplashShader_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x25f51fe6) {
		if (inClassId<=(int)0x1efca5b6) {
			...
			return inClassId==(int)0x25f51fe6;
		}
	} else {
...
::hx::Val PixelSplashShader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
		if (HX_FIELD_EQ(inName,"r") ) { _hx_set_r(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		if (HX_FIELD_EQ(inName,"g") ) { _hx_set_g(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		if (HX_FIELD_EQ(inName,"b") ) { _hx_set_b(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"mult") ) { _hx_set_mult(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"uBlocksize") ) { _hx_set_uBlocksize(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
	}
