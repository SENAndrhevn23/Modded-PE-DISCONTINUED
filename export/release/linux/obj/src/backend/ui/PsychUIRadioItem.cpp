...
HX_DEFINE_STACK_FRAME(_hx_pos_02040e8724a597e5_324_new,"backend.ui.PsychUIRadioItem","new",0x6fb973f1,"backend.ui.PsychUIRadioItem.new","backend/ui/PsychUIRadioGroup.hx",324,0x4e47afeb)
HX_LOCAL_STACK_FRAME(_hx_pos_02040e8724a597e5_329_boxGraphic,"backend.ui.PsychUIRadioItem","boxGraphic",0x1fa3cc6c,"backend.ui.PsychUIRadioItem.boxGraphic","backend/ui/PsychUIRadioGroup.hx",329,0x4e47afeb)
...
void PsychUIRadioItem_obj::__construct(Float x,Float y,::String label,::hx::Null< int >  __o_textWid){
            	...
            	HX_STACKFRAME(&_hx_pos_02040e8724a597e5_324_new)
HXLINE( 325)		super::__construct(x,y,label,textWid,null());
HXLINE( 326)		this->broadcastCheckBoxEvent = false;
            	}
...
void PsychUIRadioItem_obj::boxGraphic(){
            	HX_STACKFRAME(&_hx_pos_02040e8724a597e5_329_boxGraphic)
HXLINE( 330)		 ::flixel::FlxSprite _hx_tmp = this->box;
HXDLIN( 330)		_hx_tmp->loadGraphic(::backend::Paths_obj::image(HX_("psych-ui/radio",52,30,b5,7e),HX_("embed",d9,8d,cf,6f),null()),true,16,16,null(),null());
HXLINE( 331)		this->box->animation->add(HX_("false",a3,35,4f,fb),::Array_obj< int >::fromData( _hx_array_data_213aa77f_2,1),null(),null(),null(),null());
HXLINE( 332)		this->box->animation->add(HX_("true",4e,a7,03,4d),::Array_obj< int >::fromData( _hx_array_data_213aa77f_3,1),null(),null(),null(),null());
HXLINE( 333)		this->box->animation->play(HX_("false",a3,35,4f,fb),null(),null(),null());
            	}
