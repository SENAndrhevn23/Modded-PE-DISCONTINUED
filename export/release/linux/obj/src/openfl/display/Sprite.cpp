...
void Sprite_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_154_new)
...
HXLINE( 165)			this->_hx_set__hx___pendingBindLibrary(HX_CTX, null());
HXLINE( 166)			this->_hx_set__hx___pendingBindClassName(HX_CTX, null());
...
void Sprite_obj::_hx___bind( ::openfl::utils::AssetLibrary library,::String className){
            	HX_GC_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_274___bind)
HXDLIN( 274)		if (::hx::IsNull( this->_hx___worldTransform )) {
HXLINE( 276)			this->_hx_set__hx___pendingBindLibrary(HX_CTX, library);
HXLINE( 277)			this->_hx_set__hx___pendingBindClassName(HX_CTX, className);
            		}
            		else {
...
bool Sprite_obj::_hx___hitTestHitArea(Float x,Float y,bool shapeFlag,::Array< ::Dynamic> stack,bool interactiveOnly, ::openfl::display::DisplayObject hitObject){
            	HX_GC_STACKFRAME(&_hx_pos_781fdaae6ecb7a58_331___hitTestHitArea)
...
HXLINE( 342)					stack->setCtx( HX_CTX, stack->length,hitObject);
            				}
...
HXLINE( 371)			this->_hx_set__hx___graphics(HX_CTX,  ::openfl::display::Graphics_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this)));
            		}
...
::hx::Val Sprite_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"hitArea") ) { _hx_set_hitArea(HX_CTX_GET,inValue.Cast<  ::openfl::display::Sprite >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"buttonMode") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_buttonMode(inValue.Cast< bool >()) ); }
		if (HX_FIELD_EQ(inName,"dropTarget") ) { _hx_set_dropTarget(HX_CTX_GET,inValue.Cast<  ::openfl::display::DisplayObject >()); return inValue; }
		break;
	case 12:
	...
	case 13:
		...
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"__pendingBindLibrary") ) { _hx_set__hx___pendingBindLibrary(HX_CTX_GET,inValue.Cast<  ::openfl::utils::AssetLibrary >()); return inValue; }
		break;
	case 22:
		if (HX_FIELD_EQ(inName,"__pendingBindClassName") ) { _hx_set__hx___pendingBindClassName(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	}
