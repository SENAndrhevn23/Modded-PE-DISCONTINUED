...
HXLINE( 101)		this->_hx_set_name(HX_CTX, name);
HXLINE( 102)		this->_hx_set_value(HX_CTX, value);
            	}
...
::hx::Val URLRequestHeader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"value") ) { _hx_set_value(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	}
