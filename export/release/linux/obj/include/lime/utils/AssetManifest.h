...
class HXCPP_CLASS_ATTRIBUTES AssetManifest_obj : public ::hx::Object
{
	...
	public:
		...
		inline ::cpp::VirtualArray _hx_set_assets(::hx::StackContext *_hx_ctx,::cpp::VirtualArray _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return assets=_hx_v; }
		::Array< ::String > libraryArgs;
		inline ::Array< ::String > _hx_set_libraryArgs(::hx::StackContext *_hx_ctx,::Array< ::String > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return libraryArgs=_hx_v; }
		::String libraryType;
		inline ::String _hx_set_libraryType(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return libraryType=_hx_v; }
		::String name;
		inline ::String _hx_set_name(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return name=_hx_v; }
		::String rootPath;
		inline ::String _hx_set_rootPath(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return rootPath=_hx_v; }
		int version;
		::String serialize();
