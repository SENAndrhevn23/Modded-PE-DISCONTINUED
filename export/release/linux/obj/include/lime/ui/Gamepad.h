...
class HXCPP_CLASS_ATTRIBUTES Gamepad_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::lime::app::_Event_lime_ui_GamepadAxis_Float_Void _hx_set_onAxisMove(::hx::StackContext *_hx_ctx, ::lime::app::_Event_lime_ui_GamepadAxis_Float_Void _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onAxisMove=_hx_v; }
		 ::lime::app::_Event_lime_ui_GamepadButton_Void onButtonDown;
		inline  ::lime::app::_Event_lime_ui_GamepadButton_Void _hx_set_onButtonDown(::hx::StackContext *_hx_ctx, ::lime::app::_Event_lime_ui_GamepadButton_Void _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onButtonDown=_hx_v; }
		 ::lime::app::_Event_lime_ui_GamepadButton_Void onButtonUp;
		inline  ::lime::app::_Event_lime_ui_GamepadButton_Void _hx_set_onButtonUp(::hx::StackContext *_hx_ctx, ::lime::app::_Event_lime_ui_GamepadButton_Void _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onButtonUp=_hx_v; }
		...
		void rumble(Float lowFrequencyRumble,Float highFrequencyRumble,int duration);
		::Dynamic rumble_dyn();
