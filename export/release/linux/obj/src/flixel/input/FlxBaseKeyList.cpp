...
void FlxBaseKeyList_obj::__construct(int status, ::flixel::input::FlxKeyManager keyManager){
            	HX_GC_STACKFRAME(&_hx_pos_b224d6bfd31a08e5_18_new)
HXLINE(  19)		this->status = status;
HXLINE(  20)		this->_hx_set_keyManager(HX_CTX, keyManager);
            	}
...
::hx::Val FlxBaseKeyList_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"keyManager") ) { _hx_set_keyManager(HX_CTX_GET,inValue.Cast<  ::flixel::input::FlxKeyManager >()); return inValue; }
	}
