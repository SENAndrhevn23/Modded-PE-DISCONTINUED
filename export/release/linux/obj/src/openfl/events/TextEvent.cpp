...
void TextEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::String __o_text){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_a9542994cee360f6_82_new)
HXLINE(  83)		super::__construct(type,bubbles,cancelable);
HXLINE(  85)		this->_hx_set_text(HX_CTX, text);
            	}
...
HXLINE(  91)		event->_hx_set_target(HX_CTX, this->target);
HXLINE(  92)		event->_hx_set_currentTarget(HX_CTX, this->currentTarget);
...
void TextEvent_obj::_hx___init(){
            	HX_GC_STACKFRAME(&_hx_pos_a9542994cee360f6_103___init)
HXLINE( 104)		this->super::_hx___init();
HXLINE( 105)		this->_hx_set_text(HX_CTX, HX_("",00,00,00,00));
            	}
