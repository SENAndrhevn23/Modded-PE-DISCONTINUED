...
void IllegalOperationError_obj::__construct(::String __o_message){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_4cf27cf07614edf1_36_new)
HXDLIN(  36)		{
HXLINE(  37)			super::__construct(message,0);
HXLINE(  39)			this->_hx_set_name(HX_CTX, HX_("IllegalOperationError",17,ce,c0,9e));
            		}
HXLINE(  36)		{
HXDLIN(  36)			this->_hx___skipStack++;
            		}
            	}
