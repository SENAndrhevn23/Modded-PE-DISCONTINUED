...
class HXCPP_CLASS_ATTRIBUTES FlxGame_obj : public  ::openfl::display::Sprite_obj
{
	...
	public:
		...
		inline  ::flixel::_hx_system::ui::FlxSoundTray _hx_set_soundTray(::hx::StackContext *_hx_ctx, ::flixel::_hx_system::ui::FlxSoundTray _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return soundTray=_hx_v; }
		int ticks;
		bool filtersEnabled;
		bool _gameJustStarted;
		 ::Dynamic _initialState;
		inline  ::Dynamic _hx_set__initialState(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _initialState=_hx_v; }
		 ::flixel::FlxState _state;
		inline  ::flixel::FlxState _hx_set__state(::hx::StackContext *_hx_ctx, ::flixel::FlxState _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _state=_hx_v; }
		int _total;
		int _startTime;
		Float _accumulator;
		Float _elapsedMS;
		...
		inline ::Array< ::Dynamic> _hx_set__filters(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _filters=_hx_v; }
		 ::openfl::display::Sprite _inputContainer;
		inline  ::openfl::display::Sprite _hx_set__inputContainer(::hx::StackContext *_hx_ctx, ::openfl::display::Sprite _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _inputContainer=_hx_v; }
		::hx::Class _customSoundTray;
		inline ::hx::Class _hx_set__customSoundTray(::hx::StackContext *_hx_ctx,::hx::Class _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _customSoundTray=_hx_v; }
		bool _skipSplash;
		bool _startFullscreen;
		 ::Dynamic _nextState;
		inline  ::Dynamic _hx_set__nextState(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _nextState=_hx_v; }
		bool _resetGame;
		...
		::Dynamic getTimer;
		inline ::Dynamic _hx_set_getTimer(::hx::StackContext *_hx_ctx,::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return getTimer=_hx_v; }
