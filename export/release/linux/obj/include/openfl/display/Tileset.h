...
class HXCPP_CLASS_ATTRIBUTES Tileset_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::openfl::_Vector::FloatVector _hx_set_rectData(::hx::StackContext *_hx_ctx, ::openfl::_Vector::FloatVector _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return rectData=_hx_v; }
		 ::openfl::display::BitmapData _hx___bitmapData;
		inline  ::openfl::display::BitmapData _hx_set__hx___bitmapData(::hx::StackContext *_hx_ctx, ::openfl::display::BitmapData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___bitmapData=_hx_v; }
		::Array< ::Dynamic> _hx___data;
		inline ::Array< ::Dynamic> _hx_set__hx___data(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___data=_hx_v; }
