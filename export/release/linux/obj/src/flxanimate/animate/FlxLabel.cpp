...
void FlxLabel_obj::__construct(::String name,int frame){
            	HX_GC_STACKFRAME(&_hx_pos_7c1e70a241741db4_14_new)
HXLINE(  15)		this->_hx_set_name(HX_CTX, name);
HXLINE(  16)		this->frame = frame;
HXLINE(  17)		this->_hx_set_callbacks(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
            	}
...
void FlxLabel_obj::removeCallbacks(){
            	HX_GC_STACKFRAME(&_hx_pos_7c1e70a241741db4_29_removeCallbacks)
HXDLIN(  29)		this->_hx_set_callbacks(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
            	}
...
::hx::Val FlxLabel_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"callbacks") ) { _hx_set_callbacks(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
