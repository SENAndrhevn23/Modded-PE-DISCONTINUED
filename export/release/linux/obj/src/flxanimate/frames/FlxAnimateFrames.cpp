...
void FlxAnimateFrames_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_0a2ec04d5fc2238b_24_new)
HXLINE(  25)		super::__construct(null(),null());
HXLINE(  26)		this->_hx_set_parents(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
            	}
...
HXDLIN( 268)				frame->_hx_set_name(HX_CTX, (_hx_tmp1 + ::Std_obj::string((10000 + imgs->indexOf(img,null()))).substring(1,null())));
...
::hx::Val FlxAnimateFrames_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"parents") ) { _hx_set_parents(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
