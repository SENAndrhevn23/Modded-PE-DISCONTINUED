...
class HXCPP_CLASS_ATTRIBUTES FlxBitmapFont_obj : public  ::flixel::graphics::frames::FlxFramesCollection_obj
{
	...
	public:
		...
		inline  ::haxe::ds::IntMap _hx_set_charMap(::hx::StackContext *_hx_ctx, ::haxe::ds::IntMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return charMap=_hx_v; }
		 ::haxe::ds::IntMap charAdvance;
		inline  ::haxe::ds::IntMap _hx_set_charAdvance(::hx::StackContext *_hx_ctx, ::haxe::ds::IntMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return charAdvance=_hx_v; }
