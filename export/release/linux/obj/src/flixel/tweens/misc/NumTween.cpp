...
void NumTween_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_48a467e39416ef35_24_destroy)
HXLINE(  25)		this->super::destroy();
HXLINE(  26)		this->_hx_set__tweenFunction(HX_CTX, null());
            	}


 ::flixel::tweens::misc::NumTween NumTween_obj::tween(Float fromValue,Float toValue,Float duration, ::Dynamic tweenFunction){
            	HX_GC_STACKFRAME(&_hx_pos_48a467e39416ef35_38_tween)
HXLINE(  39)		this->_hx_set__tweenFunction(HX_CTX, tweenFunction);
...
::hx::Val NumTween_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"_tweenFunction") ) { _hx_set__tweenFunction(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
