...
void LinearPath_obj::__construct( ::Dynamic Options, ::flixel::tweens::FlxTweenManager manager){
            	HX_GC_STACKFRAME(&_hx_pos_a5dbf3466a77d348_11_new)
...
HXLINE(  35)		this->_hx_set_points(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  36)		this->_hx_set__pointD(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_a8147b8e_1,1));
HXLINE(  37)		this->_hx_set__pointT(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_a8147b8e_2,1));
            	}
...
void LinearPath_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_a5dbf3466a77d348_41_destroy)
...
HXLINE(  48)		this->_hx_set__last(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->_last)) ));
HXLINE(  49)		this->_hx_set__prevPoint(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->_prevPoint)) ));
HXLINE(  50)		this->_hx_set__nextPoint(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->_nextPoint)) ));
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(LinearPath_obj,setMotion,return )
 ...
 ::flixel::tweens::motion::LinearPath LinearPath_obj::addPoint(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_a5dbf3466a77d348_79_addPoint)
...
HXDLIN(  85)		_hx_tmp1->setCtx( HX_CTX, _hx_tmp2,(this->_hx_set__last(HX_CTX, point)));
...
void LinearPath_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_a5dbf3466a77d348_106_update)
...
HXLINE( 132)			this->_hx_set__prevPoint(HX_CTX, this->points->__get(this->_index).StaticCast<  ::flixel::math::FlxBasePoint >());
HXLINE( 133)			this->_hx_set__nextPoint(HX_CTX, this->points->__get((this->_index + 1)).StaticCast<  ::flixel::math::FlxBasePoint >());
...
HXLINE( 155)			this->_hx_set__prevPoint(HX_CTX, this->points->__get(this->_index).StaticCast<  ::flixel::math::FlxBasePoint >());
HXLINE( 156)			this->_hx_set__nextPoint(HX_CTX, this->points->__get((this->_index - 1)).StaticCast<  ::flixel::math::FlxBasePoint >());
...
::hx::Val LinearPath_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"_last") ) { _hx_set__last(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"points") ) { _hx_set_points(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"_pointD") ) { _hx_set__pointD(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_pointT") ) { _hx_set__pointT(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"distance") ) { distance=inValue.Cast< Float >(); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"_prevPoint") ) { _hx_set__prevPoint(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_nextPoint") ) { _hx_set__nextPoint(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
	}
