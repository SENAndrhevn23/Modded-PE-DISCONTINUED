...
HXLINE(  51)		this->_hx_set_volumeDownSound(HX_CTX, HX_("flixel/sounds/beep",e6,b5,a9,33));
HXLINE(  48)		this->_hx_set_volumeUpSound(HX_CTX, HX_("flixel/sounds/beep",e6,b5,a9,33));
...
HXLINE(  85)		dtf->_hx_set_align(HX_CTX, 0);
...
HXLINE(  91)		int bx = 10;
HXLINE(  92)		int by = 14;
HXLINE(  93)		this->_hx_set__bars(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE(  95)		{
HXLINE(  95)			int _g = 0;
...
::hx::Val FlxSoundTray_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"_bars") ) { _hx_set__bars(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 6:
	...
	case 13:
		...
		if (HX_FIELD_EQ(inName,"volumeUpSound") ) { _hx_set_volumeUpSound(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"volumeDownSound") ) { _hx_set_volumeDownSound(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	}
