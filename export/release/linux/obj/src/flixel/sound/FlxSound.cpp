...
HXLINE( 238)		this->_hx_set_endTime(HX_CTX, ((Float)0.0));
HXLINE( 239)		this->_hx_set__target(HX_CTX, null());
...
HXLINE( 249)			this->_hx_set__transform(HX_CTX,  ::openfl::media::SoundTransform_obj::__alloc( HX_CTX ,null(),null()));
            		}
...
void FlxSound_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_119249e340fa9820_254_destroy)
HXLINE( 255)		this->_hx_set__transform(HX_CTX, null());
HXLINE( 256)		this->set_exists(false);
HXLINE( 257)		this->set_active(false);
HXLINE( 258)		this->_hx_set__target(HX_CTX, null());
HXLINE( 259)		this->_hx_set_name(HX_CTX, null());
HXLINE( 260)		this->_hx_set_artist(HX_CTX, null());
...
HXLINE( 266)			this->_hx_set__channel(HX_CTX, null());
            		}
...
HXLINE( 272)			this->_hx_set__sound(HX_CTX, null());
            		}
HXLINE( 275)		this->_hx_set_onComplete(HX_CTX, null());
...
HXLINE( 330)		this->cleanup(false,null());
 ...
 ::flixel::sound::FlxSound FlxSound_obj::loadEmbedded( ::Dynamic EmbeddedSound,::hx::Null< bool >  __o_Looped,::hx::Null< bool >  __o_AutoDestroy, ::Dynamic OnComplete){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_119249e340fa9820_344_loadEmbedded)
...
HXLINE( 352)			this->_hx_set__sound(HX_CTX, ( ( ::openfl::media::Sound)(EmbeddedSound) ));
            		}
            		else {
HXLINE( 354)			if (::Std_obj::isOfType(EmbeddedSound,::hx::ClassOf< ::hx::Class >())) {
HXLINE( 356)				this->_hx_set__sound(HX_CTX, ( ( ::openfl::media::Sound)(::Type_obj::createInstance(EmbeddedSound,::cpp::VirtualArray_obj::__new(0))) ));
            			}
            			else {
...
HXLINE( 361)						this->_hx_set__sound(HX_CTX, ::openfl::utils::Assets_obj::getSound(( (::String)(EmbeddedSound) ),null()));
            					}
            					else {
...
HXLINE( 385)		this->_hx_set__sound(HX_CTX,  ::openfl::media::Sound_obj::__alloc( HX_CTX ,null(),null()));
...
HXLINE( 388)		loadCallback->setCtx( HX_CTX, 0, ::Dynamic(new _hx_Closure_0(OnLoad,_gthis,loadCallback)));
...
HX_DEFINE_DYNAMIC_FUNC5(FlxSound_obj,loadStream,return )
 ...
 ::flixel::sound::FlxSound FlxSound_obj::init(::hx::Null< bool >  __o_Looped,::hx::Null< bool >  __o_AutoDestroy, ::Dynamic OnComplete){
            		bool Looped = __o_Looped.Default(false);
            		bool AutoDestroy = __o_AutoDestroy.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_119249e340fa9820_429_init)
...
HXLINE( 434)		this->_hx_set_onComplete(HX_CTX, OnComplete);
...
HXLINE( 439)		this->_hx_set_endTime(HX_CTX, this->_length);
...
HX_DEFINE_DYNAMIC_FUNC3(FlxSound_obj,init,return )
 ...
 ::flixel::sound::FlxSound FlxSound_obj::proximity(Float X,Float Y, ::flixel::FlxObject TargetObject,Float Radius,::hx::Null< bool >  __o_Pan){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_119249e340fa9820_455_proximity)
HXLINE( 456)		this->x = X;
HXLINE( 457)		this->y = Y;
HXLINE( 458)		this->_hx_set__target(HX_CTX, TargetObject);
...
HX_DEFINE_DYNAMIC_FUNC5(FlxSound_obj,proximity,return )
 ...
 ::flixel::sound::FlxSound FlxSound_obj::play(::hx::Null< bool >  __o_ForceRestart,::hx::Null< Float >  __o_StartTime, ::Dynamic EndTime){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_119249e340fa9820_476_play)
...
HXLINE( 490)		this->_hx_set_endTime(HX_CTX, EndTime);
...
HX_DEFINE_DYNAMIC_FUNC0(FlxSound_obj,stop,return )
 ...
 ::flixel::sound::FlxSound FlxSound_obj::fadeOut(::hx::Null< Float >  __o_Duration, ::Dynamic __o_To, ::Dynamic onComplete){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_119249e340fa9820_534_fadeOut)
HXLINE( 535)		if (::hx::IsNotNull( this->fadeTween )) {
HXLINE( 536)			this->fadeTween->cancel();
            		}
HXLINE( 537)		this->_hx_set_fadeTween(HX_CTX, ::flixel::tweens::FlxTween_obj::num(this->_volume,( (Float)(To) ),Duration, ::Dynamic(::hx::Anon_obj::Create(1)
...
HX_DEFINE_DYNAMIC_FUNC3(FlxSound_obj,fadeOut,return )
 ...
 ::flixel::sound::FlxSound FlxSound_obj::fadeIn(::hx::Null< Float >  __o_Duration,::hx::Null< Float >  __o_From,::hx::Null< Float >  __o_To, ::Dynamic onComplete){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_119249e340fa9820_550_fadeIn)
...
HXLINE( 557)		this->_hx_set_fadeTween(HX_CTX, ::flixel::tweens::FlxTween_obj::num(From,To,Duration, ::Dynamic(::hx::Anon_obj::Create(1)
            			->setFixed(0,HX_("onComplete",f8,d4,7e,5d),onComplete)),this->volumeTween_dyn()));
...
void FlxSound_obj::startSound(Float StartTime){
            	HX_GC_STACKFRAME(&_hx_pos_119249e340fa9820_607_startSound)
HXLINE( 608)		if (::hx::IsNull( this->_sound )) {
HXLINE( 609)			return;
            		}
HXLINE( 611)		this->_time = StartTime;
HXLINE( 612)		this->_paused = false;
HXLINE( 613)		this->_hx_set__channel(HX_CTX, this->_sound->play(this->_time,0,this->_transform));
...
void FlxSound_obj::cleanup(bool destroySound,::hx::Null< bool >  __o_resetPosition){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_119249e340fa9820_657_cleanup)
...
HXLINE( 668)			this->_hx_set__channel(HX_CTX, null());
            		}
...
void FlxSound_obj::gotID3( ::openfl::events::Event _){
            	HX_GC_STACKFRAME(&_hx_pos_119249e340fa9820_684_gotID3)
HXLINE( 685)		this->_hx_set_name(HX_CTX, this->_sound->get_id3()->songName);
HXLINE( 686)		this->_hx_set_artist(HX_CTX, this->_sound->get_id3()->artist);
...
::String FlxSound_obj::toString(){
            	HX_GC_STACKFRAME(&_hx_pos_119249e340fa9820_800_toString)
...
HXDLIN( 801)		_this->_hx_set_label(HX_CTX, HX_("playing",6e,0f,18,8a));
HXDLIN( 801)		_this->_hx_set_value(HX_CTX, value);
...
HXDLIN( 802)		_this1->_hx_set_label(HX_CTX, HX_("time",0d,cc,fc,4c));
HXDLIN( 802)		_this1->_hx_set_value(HX_CTX, value1);
...
HXDLIN( 803)		_this2->_hx_set_label(HX_CTX, HX_("length",e6,94,07,9f));
HXDLIN( 803)		_this2->_hx_set_value(HX_CTX, value2);
...
HXDLIN( 804)		_this3->_hx_set_label(HX_CTX, HX_("volume",da,29,53,5f));
HXDLIN( 804)		_this3->_hx_set_value(HX_CTX, value3);
...
::hx::Val FlxSound_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"group") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_group(inValue.Cast<  ::flixel::sound::FlxSoundGroup >()) );_hx_set_group(HX_CTX_GET,inValue.Cast<  ::flixel::sound::FlxSoundGroup >()); return inValue; }
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"_sound") ) { _hx_set__sound(HX_CTX_GET,inValue.Cast<  ::openfl::media::Sound >()); return inValue; }
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"endTime") ) { _hx_set_endTime(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"_target") ) { _hx_set__target(HX_CTX_GET,inValue.Cast<  ::flixel::FlxObject >()); return inValue; }
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"_channel") ) { _hx_set__channel(HX_CTX_GET,inValue.Cast<  ::openfl::media::SoundChannel >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"amplitude") ) { amplitude=inValue.Cast< Float >(); return inValue; }
		if (HX_FIELD_EQ(inName,"fadeTween") ) { _hx_set_fadeTween(HX_CTX_GET,inValue.Cast<  ::flixel::tweens::FlxTween >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"onComplete") ) { _hx_set_onComplete(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_transform") ) { _hx_set__transform(HX_CTX_GET,inValue.Cast<  ::openfl::media::SoundTransform >()); return inValue; }
		break;
	case 11:
