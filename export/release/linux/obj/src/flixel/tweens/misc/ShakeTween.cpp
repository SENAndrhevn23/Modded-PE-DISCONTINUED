...
HXLINE(  43)		this->_hx_set_sprite(HX_CTX, Sprite);
HXLINE(  44)		this->duration = Duration;
HXLINE(  45)		this->axes = Axes;
HXLINE(  46)		this->_hx_set_initialOffset(HX_CTX,  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,Sprite->offset->x,Sprite->offset->y));
...
void ShakeTween_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_5f32b179d409136f_52_destroy)
...
HXLINE(  58)		this->_hx_set_sprite(HX_CTX, null());
HXLINE(  59)		this->_hx_set_initialOffset(HX_CTX, null());
            	}
