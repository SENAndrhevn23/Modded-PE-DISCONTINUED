...
HXLINE(  45)		this->_hx_set__hx___pool(HX_CTX,  ::haxe::ds::ObjectMap_obj::__alloc( HX_CTX ));
HXLINE(  47)		this->activeObjects = 0;
HXLINE(  48)		this->inactiveObjects = 0;
HXLINE(  50)		this->_hx_set__hx___inactiveObject0(HX_CTX, null());
HXLINE(  51)		this->_hx_set__hx___inactiveObject1(HX_CTX, null());
HXLINE(  52)		this->_hx_set__hx___inactiveObjectList(HX_CTX,  ::haxe::ds::List_obj::__alloc( HX_CTX ));
HXLINE(  54)		if (::hx::IsNotNull( create )) {
HXLINE(  56)			this->_hx_set_create(HX_CTX, create);
            		}
HXLINE(  58)		if (::hx::IsNotNull( clean )) {
HXLINE(  60)			this->_hx_set_clean(HX_CTX, clean);
            		}
...
void ObjectPool_obj::add( ::Dynamic object){
            	HX_GC_STACKFRAME(&_hx_pos_06bcacad9f56fcf1_74_add)
...
HXLINE(  78)					this->_hx_set__hx___inactiveObject0(HX_CTX, object);
            				}
            				else {
HXLINE(  78)					if (::hx::IsNull( this->_hx___inactiveObject1 )) {
HXLINE(  78)						this->_hx_set__hx___inactiveObject1(HX_CTX, object);
            					}
            					else {
...
HXLINE(  96)		this->_hx_set__hx___pool(HX_CTX,  ::haxe::ds::ObjectMap_obj::__alloc( HX_CTX ));
HXLINE(  98)		this->activeObjects = 0;
HXLINE(  99)		this->inactiveObjects = 0;
HXLINE( 101)		this->_hx_set__hx___inactiveObject0(HX_CTX, null());
HXLINE( 102)		this->_hx_set__hx___inactiveObject1(HX_CTX, null());
...
HX_END_DEFAULT_FUNC
 ...
 ::Dynamic ObjectPool_obj::get(){
            	HX_GC_STACKFRAME(&_hx_pos_06bcacad9f56fcf1_122_get)
...
HXDLIN( 127)				this->_hx_set__hx___inactiveObject0(HX_CTX, null());
            			}
            			else {
HXLINE( 127)				if (::hx::IsNotNull( this->_hx___inactiveObject1 )) {
HXLINE( 127)					object1 = this->_hx___inactiveObject1;
HXDLIN( 127)					this->_hx_set__hx___inactiveObject1(HX_CTX, null());
            				}
            				else {
HXLINE( 127)					object1 = this->_hx___inactiveObjectList->pop();
HXDLIN( 127)					if ((this->_hx___inactiveObjectList->length > 0)) {
HXLINE( 127)						this->_hx_set__hx___inactiveObject0(HX_CTX, this->_hx___inactiveObjectList->pop());
            					}
HXDLIN( 127)					if ((this->_hx___inactiveObjectList->length > 0)) {
HXLINE( 127)						this->_hx_set__hx___inactiveObject1(HX_CTX, this->_hx___inactiveObjectList->pop());
            					}
            				}
            			}
...
void ObjectPool_obj::release( ::Dynamic object){
            	HX_GC_STACKFRAME(&_hx_pos_06bcacad9f56fcf1_149_release)
...
HXLINE( 166)					this->_hx_set__hx___inactiveObject0(HX_CTX, object);
            				}
            				else {
HXLINE( 166)					if (::hx::IsNull( this->_hx___inactiveObject1 )) {
HXLINE( 166)						this->_hx_set__hx___inactiveObject1(HX_CTX, object);
            					}
            					else {
...
void ObjectPool_obj::remove( ::Dynamic object){
            	HX_GC_STACKFRAME(&_hx_pos_06bcacad9f56fcf1_181_remove)
...
HXLINE( 187)				this->_hx_set__hx___inactiveObject0(HX_CTX, null());
HXLINE( 188)				this->inactiveObjects--;
            			}
            			else {
HXLINE( 190)				if (::hx::IsEq( this->_hx___inactiveObject1,object )) {
HXLINE( 192)					this->_hx_set__hx___inactiveObject1(HX_CTX, null());
...
void ObjectPool_obj::_hx___addInactive( ::Dynamic object){
            	HX_GC_STACKFRAME(&_hx_pos_06bcacad9f56fcf1_207___addInactive)
HXLINE( 212)		if (::hx::IsNull( this->_hx___inactiveObject0 )) {
HXLINE( 214)			this->_hx_set__hx___inactiveObject0(HX_CTX, object);
            		}
            		else {
HXLINE( 216)			if (::hx::IsNull( this->_hx___inactiveObject1 )) {
HXLINE( 218)				this->_hx_set__hx___inactiveObject1(HX_CTX, object);
            			}
            			else {
...
HX_DEFINE_DYNAMIC_FUNC1(ObjectPool_obj,_hx___addInactive,(void))
 ...
 ::Dynamic ObjectPool_obj::_hx___getInactive(){
            	HX_GC_STACKFRAME(&_hx_pos_06bcacad9f56fcf1_229___getInactive)
...
HXLINE( 235)			this->_hx_set__hx___inactiveObject0(HX_CTX, null());
            		}
            		else {
HXLINE( 237)			if (::hx::IsNotNull( this->_hx___inactiveObject1 )) {
HXLINE( 239)				object = this->_hx___inactiveObject1;
HXLINE( 240)				this->_hx_set__hx___inactiveObject1(HX_CTX, null());
            			}
            			else {
HXLINE( 244)				object = this->_hx___inactiveObjectList->pop();
HXLINE( 246)				if ((this->_hx___inactiveObjectList->length > 0)) {
HXLINE( 248)					this->_hx_set__hx___inactiveObject0(HX_CTX, this->_hx___inactiveObjectList->pop());
            				}
HXLINE( 251)				if ((this->_hx___inactiveObjectList->length > 0)) {
HXLINE( 253)					this->_hx_set__hx___inactiveObject1(HX_CTX, this->_hx___inactiveObjectList->pop());
            				}
            			}
            		}
...
void ObjectPool_obj::_hx___removeInactive(int count){
            	HX_GC_STACKFRAME(&_hx_pos_06bcacad9f56fcf1_268___removeInactive)
...
HXLINE( 274)			this->_hx_set__hx___inactiveObject0(HX_CTX, null());
...
HXLINE( 284)			this->_hx_set__hx___inactiveObject1(HX_CTX, null());
...
HX_DEFINE_DYNAMIC_FUNC0(ObjectPool_obj,get_size,return )
 ...
 ::Dynamic ObjectPool_obj::set_size( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_06bcacad9f56fcf1_309_set_size)
HXLINE( 310)		if (::hx::IsNull( value )) {
HXLINE( 312)			this->_hx_set__hx___size(HX_CTX, null());
            		}
            		else {
HXLINE( 316)			int current = (this->inactiveObjects + this->activeObjects);
HXLINE( 317)			this->_hx_set__hx___size(HX_CTX, value);
...
::hx::Val ObjectPool_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"clean") ) { _hx_set_clean(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"__pool") ) { _hx_set__hx___pool(HX_CTX_GET,inValue.Cast< ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__size") ) { _hx_set__hx___size(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"create") ) { _hx_set_create(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 13:
	...
	case 15:
		...
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"__inactiveObject0") ) { _hx_set__hx___inactiveObject0(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__inactiveObject1") ) { _hx_set__hx___inactiveObject1(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"__inactiveObjectList") ) { _hx_set__hx___inactiveObjectList(HX_CTX_GET,inValue.Cast<  ::haxe::ds::List >()); return inValue; }
	}
