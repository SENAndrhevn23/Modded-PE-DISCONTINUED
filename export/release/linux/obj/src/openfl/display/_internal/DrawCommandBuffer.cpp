...
void DrawCommandBuffer_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_fae278bbae08f83e_39_new)
HXDLIN(  39)		if (::hx::IsNull( ::openfl::display::_internal::DrawCommandBuffer_obj::empty )) {
HXLINE(  41)			this->_hx_set_types(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  43)			this->_hx_set_b(HX_CTX, ::Array_obj< bool >::__new(0));
HXLINE(  44)			this->_hx_set_i(HX_CTX, ::Array_obj< int >::__new(0));
HXLINE(  45)			this->_hx_set_f(HX_CTX, ::Array_obj< Float >::__new(0));
HXLINE(  46)			this->_hx_set_o(HX_CTX, ::cpp::VirtualArray_obj::__new(0));
HXLINE(  47)			this->_hx_set_ff(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  48)			this->_hx_set_ii(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
...
HXLINE(  62)			this->_hx_set_types(HX_CTX, other->types);
HXLINE(  63)			this->_hx_set_b(HX_CTX, other->b);
HXLINE(  64)			this->_hx_set_i(HX_CTX, other->i);
HXLINE(  65)			this->_hx_set_f(HX_CTX, other->f);
HXLINE(  66)			this->_hx_set_o(HX_CTX, other->o);
HXLINE(  67)			this->_hx_set_ff(HX_CTX, other->ff);
HXLINE(  68)			this->_hx_set_ii(HX_CTX, other->ii);
...
HXLINE(  81)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::BEGIN_BITMAP_FILL_dyn());
...
HXLINE(  84)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::BEGIN_FILL_dyn());
...
HXLINE(  87)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::BEGIN_GRADIENT_FILL_dyn());
...
HXLINE(  90)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::BEGIN_SHADER_FILL_dyn());
...
HXLINE(  93)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::CUBIC_CURVE_TO_dyn());
...
HXLINE(  96)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::CURVE_TO_dyn());
...
HXLINE(  99)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::DRAW_CIRCLE_dyn());
...
HXLINE( 102)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::DRAW_ELLIPSE_dyn());
...
HXLINE( 105)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::DRAW_QUADS_dyn());
...
HXLINE( 108)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::DRAW_RECT_dyn());
...
HXLINE( 111)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::DRAW_ROUND_RECT_dyn());
...
HXLINE( 114)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::DRAW_TRIANGLES_dyn());
...
HXLINE( 117)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::END_FILL_dyn());
...
HXLINE( 120)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::LINE_BITMAP_STYLE_dyn());
...
HXLINE( 123)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::LINE_GRADIENT_STYLE_dyn());
...
HXLINE( 126)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::LINE_STYLE_dyn());
...
HXLINE( 129)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::LINE_TO_dyn());
...
HXLINE( 132)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::MOVE_TO_dyn());
...
HXLINE( 135)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::OVERRIDE_MATRIX_dyn());
...
HXLINE( 138)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::WINDING_EVEN_ODD_dyn());
...
HXLINE( 141)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::WINDING_NON_ZERO_dyn());
...
void DrawCommandBuffer_obj::clear(){
            	HX_GC_STACKFRAME(&_hx_pos_fae278bbae08f83e_196_clear)
HXLINE( 197)		this->_hx_set_types(HX_CTX, ::openfl::display::_internal::DrawCommandBuffer_obj::empty->types);
HXLINE( 199)		this->_hx_set_b(HX_CTX, ::openfl::display::_internal::DrawCommandBuffer_obj::empty->b);
HXLINE( 200)		this->_hx_set_i(HX_CTX, ::openfl::display::_internal::DrawCommandBuffer_obj::empty->i);
HXLINE( 201)		this->_hx_set_f(HX_CTX, ::openfl::display::_internal::DrawCommandBuffer_obj::empty->f);
HXLINE( 202)		this->_hx_set_o(HX_CTX, ::openfl::display::_internal::DrawCommandBuffer_obj::empty->o);
HXLINE( 203)		this->_hx_set_ff(HX_CTX, ::openfl::display::_internal::DrawCommandBuffer_obj::empty->ff);
HXLINE( 204)		this->_hx_set_ii(HX_CTX, ::openfl::display::_internal::DrawCommandBuffer_obj::empty->ii);
...
void DrawCommandBuffer_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_fae278bbae08f83e_241_destroy)
HXLINE( 242)		this->clear();
HXLINE( 244)		this->_hx_set_types(HX_CTX, null());
HXLINE( 246)		this->_hx_set_b(HX_CTX, null());
HXLINE( 247)		this->_hx_set_i(HX_CTX, null());
HXLINE( 248)		this->_hx_set_f(HX_CTX, null());
HXLINE( 249)		this->_hx_set_o(HX_CTX, null());
HXLINE( 250)		this->_hx_set_ff(HX_CTX, null());
HXLINE( 251)		this->_hx_set_ii(HX_CTX, null());
            	}
...
void DrawCommandBuffer_obj::prepareWrite(){
            	HX_GC_STACKFRAME(&_hx_pos_fae278bbae08f83e_390_prepareWrite)
HXDLIN( 390)		if (this->copyOnWrite) {
HXLINE( 392)			this->_hx_set_types(HX_CTX, this->types->copy());
HXLINE( 393)			this->_hx_set_b(HX_CTX, this->b->copy());
HXLINE( 394)			this->_hx_set_i(HX_CTX, this->i->copy());
HXLINE( 395)			this->_hx_set_f(HX_CTX, this->f->copy());
HXLINE( 396)			this->_hx_set_o(HX_CTX, this->o->copy());
HXLINE( 397)			this->_hx_set_ff(HX_CTX, this->ff->copy());
HXLINE( 398)			this->_hx_set_ii(HX_CTX, this->ii->copy());
...
::hx::Val DrawCommandBuffer_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
		if (HX_FIELD_EQ(inName,"b") ) { _hx_set_b(HX_CTX_GET,inValue.Cast< ::Array< bool > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"f") ) { _hx_set_f(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"i") ) { _hx_set_i(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"o") ) { _hx_set_o(HX_CTX_GET,inValue.Cast< ::cpp::VirtualArray >()); return inValue; }
		break;
	case 2:
		if (HX_FIELD_EQ(inName,"ff") ) { _hx_set_ff(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"ii") ) { _hx_set_ii(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"types") ) { _hx_set_types(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 11:
