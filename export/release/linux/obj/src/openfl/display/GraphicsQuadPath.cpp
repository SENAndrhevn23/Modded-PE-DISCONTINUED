...
void GraphicsQuadPath_obj::__construct( ::openfl::_Vector::FloatVector rects, ::openfl::_Vector::IntVector indices, ::openfl::_Vector::FloatVector transforms){
            	HX_GC_STACKFRAME(&_hx_pos_7b37310b03d9d57e_65_new)
HXLINE(  66)		this->_hx_set_rects(HX_CTX, rects);
HXLINE(  67)		this->_hx_set_indices(HX_CTX, indices);
HXLINE(  68)		this->_hx_set_transforms(HX_CTX, transforms);
