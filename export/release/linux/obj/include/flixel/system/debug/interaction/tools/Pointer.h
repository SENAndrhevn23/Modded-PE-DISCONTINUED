...
class HXCPP_CLASS_ATTRIBUTES Pointer_obj : public  ::flixel::_hx_system::debug::interaction::tools::Tool_obj
{
	...
	public:
		...
		inline  ::flixel::math::FlxBasePoint _hx_set__selectionStartPoint(::hx::StackContext *_hx_ctx, ::flixel::math::FlxBasePoint _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _selectionStartPoint=_hx_v; }
		 ::flixel::math::FlxBasePoint _selectionEndPoint;
		inline  ::flixel::math::FlxBasePoint _hx_set__selectionEndPoint(::hx::StackContext *_hx_ctx, ::flixel::math::FlxBasePoint _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _selectionEndPoint=_hx_v; }
		bool _selectionHappening;
		 ::flixel::math::FlxRect _selectionArea;
		inline  ::flixel::math::FlxRect _hx_set__selectionArea(::hx::StackContext *_hx_ctx, ::flixel::math::FlxRect _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _selectionArea=_hx_v; }
