...
::Array< ::Dynamic> NoteTypesConfig_obj::loadNoteTypeData(::String name){
            	HX_GC_STACKFRAME(&_hx_pos_59e44f2791909106_17_loadNoteTypeData)
...
HXDLIN(  24)				daList->setCtx( HX_CTX, i,::StringTools_obj::trim(daList->__get(i)));
            			}
            		}
...
HXDLIN(  35)						arr->setCtx( HX_CTX, i1,::StringTools_obj::trim(arr->__get(i1)));
            					}
            				}
