...
HXLINE(  85)			range->_hx_set_format(HX_CTX, textFormat);
...
HXLINE( 175)									format->_hx_set_url(HX_CTX, ::openfl::text::_internal::HTMLParser_obj::_hx___getAttributeMatch(::openfl::text::_internal::HTMLParser_obj::_hx___regexHref));
            								}
HXLINE( 166)								goto _hx_goto_3;
            							}
            							if (  (_hx_switch_0==HX_("b",62,00,00,00)) ){
HXLINE( 230)								format->_hx_set_bold(HX_CTX, true);
HXDLIN( 230)								goto _hx_goto_3;
            							}
            							if (  (_hx_switch_0==HX_("em",68,58,00,00)) ||  (_hx_switch_0==HX_("i",69,00,00,00)) ){
HXLINE( 236)								format->_hx_set_italic(HX_CTX, true);
...
HXLINE( 205)									format->_hx_set_font(HX_CTX, ::openfl::text::_internal::HTMLParser_obj::_hx___getAttributeMatch(::openfl::text::_internal::HTMLParser_obj::_hx___regexFace));
            								}
HXLINE( 208)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexColor->match(segment)) {
HXLINE( 210)									format->_hx_set_color(HX_CTX, ::Std_obj::parseInt((HX_("0x",48,2a,00,00) + ::openfl::text::_internal::HTMLParser_obj::_hx___getAttributeMatch(::openfl::text::_internal::HTMLParser_obj::_hx___regexColor))));
            								}
...
HXDLIN( 221)										format->_hx_set_size(HX_CTX, (parentFormat1 + ::Std_obj::parseInt(sizeAttr)));
            									}
            									else {
HXLINE( 225)										format->_hx_set_size(HX_CTX, ::Std_obj::parseInt(sizeAttr));
            									}
            								}
...
HXLINE( 198)								bulletFormat->_hx_set_underline(HX_CTX, false);
...
HXLINE( 187)									format->_hx_set_align(HX_CTX, ::openfl::text::_TextFormatAlign::TextFormatAlign_Impl__obj::fromString(align));
            								}
...
HXLINE( 241)									format->_hx_set_blockIndent(HX_CTX, ::Std_obj::parseInt(::openfl::text::_internal::HTMLParser_obj::_hx___getAttributeMatch(::openfl::text::_internal::HTMLParser_obj::_hx___regexBlockIndent)));
            								}
HXLINE( 244)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexIndent->match(segment)) {
HXLINE( 246)									format->_hx_set_indent(HX_CTX, ::Std_obj::parseInt(::openfl::text::_internal::HTMLParser_obj::_hx___getAttributeMatch(::openfl::text::_internal::HTMLParser_obj::_hx___regexIndent)));
            								}
HXLINE( 249)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexLeading->match(segment)) {
HXLINE( 251)									format->_hx_set_leading(HX_CTX, ::Std_obj::parseInt(::openfl::text::_internal::HTMLParser_obj::_hx___getAttributeMatch(::openfl::text::_internal::HTMLParser_obj::_hx___regexLeading)));
            								}
HXLINE( 254)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexLeftMargin->match(segment)) {
HXLINE( 256)									format->_hx_set_leftMargin(HX_CTX, ::Std_obj::parseInt(::openfl::text::_internal::HTMLParser_obj::_hx___getAttributeMatch(::openfl::text::_internal::HTMLParser_obj::_hx___regexLeftMargin)));
            								}
HXLINE( 259)								if (::openfl::text::_internal::HTMLParser_obj::_hx___regexRightMargin->match(segment)) {
HXLINE( 261)									format->_hx_set_rightMargin(HX_CTX, ::Std_obj::parseInt(::openfl::text::_internal::HTMLParser_obj::_hx___getAttributeMatch(::openfl::text::_internal::HTMLParser_obj::_hx___regexRightMargin)));
            								}
...
HXLINE( 274)									format->_hx_set_tabStops(HX_CTX, tabStops);
            								}
HXLINE( 238)								goto _hx_goto_3;
            							}
            							if (  (_hx_switch_0==HX_("u",75,00,00,00)) ){
HXLINE( 233)								format->_hx_set_underline(HX_CTX, true);
