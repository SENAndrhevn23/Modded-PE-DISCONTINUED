...
class HXCPP_CLASS_ATTRIBUTES BitmapFrontEnd_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::haxe::ds::StringMap _hx_set__cache(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _cache=_hx_v; }
		 ::flixel::graphics::frames::FlxFrame _whitePixel;
		inline  ::flixel::graphics::frames::FlxFrame _hx_set__whitePixel(::hx::StackContext *_hx_ctx, ::flixel::graphics::frames::FlxFrame _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _whitePixel=_hx_v; }
