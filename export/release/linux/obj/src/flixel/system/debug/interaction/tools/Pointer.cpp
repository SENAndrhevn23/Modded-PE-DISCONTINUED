...
HXLINE(  27)		this->_hx_set__selectionArea(HX_CTX,  ::flixel::math::FlxRect_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
HXLINE(  26)		this->_selectionHappening = false;
HXLINE(  25)		this->_hx_set__selectionEndPoint(HX_CTX,  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) )));
HXLINE(  24)		this->_hx_set__selectionStartPoint(HX_CTX,  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) )));
...
HXLINE(  33)		this->_hx_set__name(HX_CTX, HX_("Pointer",9d,e8,72,1e));
...
::hx::Val Pointer_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 14:
		if (HX_FIELD_EQ(inName,"_selectionArea") ) { _hx_set__selectionArea(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxRect >()); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"_selectionEndPoint") ) { _hx_set__selectionEndPoint(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"_selectionHappening") ) { _selectionHappening=inValue.Cast< bool >(); return inValue; }
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"_selectionStartPoint") ) { _hx_set__selectionStartPoint(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
	}
