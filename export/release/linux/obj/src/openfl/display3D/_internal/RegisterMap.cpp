...
void RegisterMap_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_b37c0bf690c3fac4_599_new)
HXDLIN( 599)		this->_hx_set_mEntries(HX_CTX, ::Array_obj< ::Dynamic>::__new());
            	}
...
HXLINE( 623)		entry1->_hx_set_name(HX_CTX, name);
HXLINE( 624)		entry1->number = number;
HXLINE( 625)		entry1->_hx_set_usage(HX_CTX, usage);
...
HXLINE( 712)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_13,1));
            						}
            						else {
...
HXLINE( 716)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_14,1));
            						}
            						else {
...
HXLINE( 719)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_15,1));
            						}
            						else {
...
HXLINE( 724)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_16,1));
            						}
            						else {
...
HXLINE( 727)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_17,1));
            						}
            						else {
...
HXLINE( 736)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_18,1));
            						}
            						else {
...
HXLINE( 742)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_19,1));
            						}
            						else {
...
HXLINE( 745)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_20,1));
            						}
            						else {
...
HXLINE( 748)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_21,1));
            						}
            						else {
...
HXLINE( 739)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_22,1));
            						}
            						else {
...
HXLINE( 762)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_23,1));
            						}
            						else {
...
HXLINE( 763)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            						}
            						else {
...
HXLINE( 764)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_24,1));
            						}
            						else {
...
HXLINE( 766)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_25,1));
            						}
            						else {
...
HXLINE( 767)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_26,1));
            						}
            						else {
...
HXLINE( 768)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1)));
            						}
            						else {
...
HXLINE( 769)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_27,1));
            						}
            						else {
...
HXLINE( 771)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_28,1));
            						}
            						else {
...
HXLINE( 772)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_29,1));
            						}
            						else {
...
HXLINE( 773)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2)));
            						}
            						else {
...
HXLINE( 774)							sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_30,1));
            						}
            						else {
...
HXLINE( 778)								sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_31,1));
            							}
            							else {
...
HXLINE( 779)								sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3)));
            							}
            							else {
...
HXLINE( 780)								sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_32,1));
            							}
            							else {
...
HXLINE( 782)								sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_33,1));
            							}
            							else {
...
HXLINE( 783)								sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_34,1));
            							}
            							else {
...
HXLINE( 784)								sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4)));
            							}
            							else {
...
HXLINE( 785)								sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_35,1));
            							}
            							else {
...
HXLINE( 787)								sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_36,1));
            							}
            							else {
...
HXLINE( 788)								sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_37,1));
            							}
            							else {
...
HXLINE( 789)								sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x5)));
            							}
            							else {
...
HXLINE( 790)								sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_38,1));
            							}
            							else {
...
HXLINE( 794)									sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x6)));
            								}
            								else {
...
HXLINE( 795)									sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_39,1));
            								}
            								else {
...
HXLINE( 799)									sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x7)));
            								}
            								else {
...
HXLINE( 800)									sb->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_cad9a0ee_40,1));
            								}
            								else {
...
::hx::Val RegisterMap_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"mEntries") ) { _hx_set_mEntries(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
