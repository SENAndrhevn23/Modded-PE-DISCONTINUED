...
class HXCPP_CLASS_ATTRIBUTES AudioSource_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::lime::media::AudioBuffer _hx_set_buffer(::hx::StackContext *_hx_ctx, ::lime::media::AudioBuffer _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return buffer=_hx_v; }
		int offset;
		 ::lime::_internal::backend::native::NativeAudioSource _hx___backend;
		inline  ::lime::_internal::backend::native::NativeAudioSource _hx_set__hx___backend(::hx::StackContext *_hx_ctx, ::lime::_internal::backend::native::NativeAudioSource _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___backend=_hx_v; }
		void dispose();
		::Dynamic dispose_dyn();
