...
HX_DEFINE_STACK_FRAME(_hx_pos_6e351c2c36f9ed26_34_new,"sys.thread.Tls","new",0xc6b2daea,"sys.thread.Tls.new","/usr/share/haxe/std/cpp/_std/sys/thread/Tls.hx",34,0x238331a2)
HX_LOCAL_STACK_FRAME(_hx_pos_6e351c2c36f9ed26_38_get_value,"sys.thread.Tls","get_value",0x0e3669d2,"sys.thread.Tls.get_value","/usr/share/haxe/std/cpp/_std/sys/thread/Tls.hx",38,0x238331a2)
HX_LOCAL_STACK_FRAME(_hx_pos_6e351c2c36f9ed26_41_set_value,"sys.thread.Tls","set_value",0xf18755de,"sys.thread.Tls.set_value","/usr/share/haxe/std/cpp/_std/sys/thread/Tls.hx",41,0x238331a2)
HX_LOCAL_STACK_FRAME(_hx_pos_6e351c2c36f9ed26_27_boot,"sys.thread.Tls","boot",0x0de5b268,"sys.thread.Tls.boot","/usr/share/haxe/std/cpp/_std/sys/thread/Tls.hx",27,0x238331a2)
namespace sys{
namespace thread{

void Tls_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6e351c2c36f9ed26_34_new)
...
bool Tls_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Tls_obj::get_value(){
            	HX_STACKFRAME(&_hx_pos_6e351c2c36f9ed26_38_get_value)
...
HX_DEFINE_DYNAMIC_FUNC0(Tls_obj,get_value,return )
 ...
 ::Dynamic Tls_obj::set_value( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_6e351c2c36f9ed26_41_set_value)
...
{
{
            	HX_STACKFRAME(&_hx_pos_6e351c2c36f9ed26_27_boot)
