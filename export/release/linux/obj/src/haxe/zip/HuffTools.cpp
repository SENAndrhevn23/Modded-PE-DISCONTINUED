...
void HuffTools_obj::treeWalk(::Array< ::Dynamic> table,int p,int cd,int d, ::haxe::zip::Huffman t){
            	HX_GC_STACKFRAME(&_hx_pos_5d42cb1a506472e6_63_treeWalk)
...
HXLINE(  69)				table->setCtx( HX_CTX, p,this->treeCompress(t));
            			}
            		}
            		else {
HXLINE(  71)			table->setCtx( HX_CTX, p,this->treeCompress(t));
            		}
            	}
