...
HXLINE( 640)			this->_hx_set_type(HX_CTX, HX_("opengles",9d,f6,c9,fa));
            		}
            		else {
HXLINE( 644)			this->_hx_set_type(HX_CTX, HX_("opengl",6f,64,94,21));
            		}
...
void NativeOpenGLRenderContext_obj::attachShader( ::lime::graphics::opengl::GLObject program, ::lime::graphics::opengl::GLObject shader){
            	HX_GC_STACKFRAME(&_hx_pos_65c657fec0b420d3_669_attachShader)
...
HXLINE( 674)				program->_hx_set_refs(HX_CTX, ::Array_obj< ::Dynamic>::__new(1)->init(0,shader));
            			}
            			else {
...
void NativeOpenGLRenderContext_obj::bindBuffer(int target, ::lime::graphics::opengl::GLObject buffer){
            	HX_GC_STACKFRAME(&_hx_pos_65c657fec0b420d3_709_bindBuffer)
HXLINE( 710)		if ((target == this->ARRAY_BUFFER)) {
HXLINE( 710)			this->_hx_set__hx___arrayBufferBinding(HX_CTX, buffer);
            		}
HXLINE( 711)		if ((target == this->ELEMENT_ARRAY_BUFFER)) {
HXLINE( 711)			this->_hx_set__hx___elementBufferBinding(HX_CTX, buffer);
            		}
...
void NativeOpenGLRenderContext_obj::bindFramebuffer(int target, ::lime::graphics::opengl::GLObject framebuffer){
            	HX_GC_STACKFRAME(&_hx_pos_65c657fec0b420d3_733_bindFramebuffer)
HXLINE( 734)		this->_hx_set__hx___framebufferBinding(HX_CTX, framebuffer);
...
void NativeOpenGLRenderContext_obj::bindRenderbuffer(int target, ::lime::graphics::opengl::GLObject renderbuffer){
            	HX_GC_STACKFRAME(&_hx_pos_65c657fec0b420d3_742_bindRenderbuffer)
HXLINE( 743)		this->_hx_set__hx___renderbufferBinding(HX_CTX, renderbuffer);
...
void NativeOpenGLRenderContext_obj::bindTexture(int target, ::lime::graphics::opengl::GLObject texture){
            	HX_GC_STACKFRAME(&_hx_pos_65c657fec0b420d3_758_bindTexture)
HXLINE( 759)		if ((target == this->TEXTURE_2D)) {
HXLINE( 759)			this->_hx_set__hx___texture2DBinding(HX_CTX, texture);
            		}
HXLINE( 760)		if ((target == this->TEXTURE_CUBE_MAP)) {
HXLINE( 760)			this->_hx_set__hx___textureCubeMapBinding(HX_CTX, texture);
            		}
...
HXLINE( 990)		object->_hx_set_ptr(HX_CTX, ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_register(id,3,::hx::DynamicPtr(object))) ));
...
HXLINE(1003)		object->_hx_set_ptr(HX_CTX, ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_register(id,5,::hx::DynamicPtr(object))) ));
...
HXLINE(1016)		object->_hx_set_ptr(HX_CTX, ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_register(id,1,::hx::DynamicPtr(object))) ));
...
HXLINE(1029)		object->_hx_set_ptr(HX_CTX, ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_register(id,8,::hx::DynamicPtr(object))) ));
...
HXLINE(1042)		object->_hx_set_ptr(HX_CTX, ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_register(id,6,::hx::DynamicPtr(object))) ));
...
HXLINE(1055)		object->_hx_set_ptr(HX_CTX, ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_register(id,9,::hx::DynamicPtr(object))) ));
...
HXLINE(1068)		object->_hx_set_ptr(HX_CTX, ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_register(id,2,::hx::DynamicPtr(object))) ));
...
HXLINE(1081)		object->_hx_set_ptr(HX_CTX, ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_register(id,4,::hx::DynamicPtr(object))) ));
...
HXLINE(1094)		object->_hx_set_ptr(HX_CTX, ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_register(id,11,::hx::DynamicPtr(object))) ));
...
HXLINE(1107)		object->_hx_set_ptr(HX_CTX, ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_register(id,7,::hx::DynamicPtr(object))) ));
...
HXDLIN(1828)						_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN(1828)							_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN(1828)									_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN(1828)									_this3->_hx_set_buffer(HX_CTX, buffer4);
...
HXDLIN(2295)									_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN(2295)										_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN(2295)												_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN(2295)												_this3->_hx_set_buffer(HX_CTX, buffer);
...
HXDLIN(2301)										_this4->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this4->byteLength));
...
HXDLIN(2301)											_this5->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this5->byteLength));
...
HXDLIN(2301)													_this6->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength1));
...
HXDLIN(2301)													_this7->_hx_set_buffer(HX_CTX, buffer1);
...
void NativeOpenGLRenderContext_obj::useProgram( ::lime::graphics::opengl::GLObject program){
            	HX_GC_STACKFRAME(&_hx_pos_65c657fec0b420d3_3122_useProgram)
HXLINE(3123)		this->_hx_set__hx___currentProgram(HX_CTX, program);
...
void NativeOpenGLRenderContext_obj::_hx___contextLost(){
            	HX_GC_STACKFRAME(&_hx_pos_65c657fec0b420d3_3261___contextLost)
HXLINE(3262)		this->_hx___isContextLost = true;
HXLINE(3263)		this->_hx_set__hx___arrayBufferBinding(HX_CTX, null());
HXLINE(3264)		this->_hx_set__hx___elementBufferBinding(HX_CTX, null());
HXLINE(3265)		this->_hx_set__hx___currentProgram(HX_CTX, null());
HXLINE(3266)		this->_hx_set__hx___framebufferBinding(HX_CTX, null());
HXLINE(3267)		this->_hx_set__hx___renderbufferBinding(HX_CTX, null());
HXLINE(3268)		this->_hx_set__hx___texture2DBinding(HX_CTX, null());
HXLINE(3269)		this->_hx_set__hx___textureCubeMapBinding(HX_CTX, null());
            	}
...
::hx::Val NativeOpenGLRenderContext_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 16:
		...
		if (HX_FIELD_EQ(inName,"__currentProgram") ) { _hx_set__hx___currentProgram(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 17:
	...
	case 18:
		...
		if (HX_FIELD_EQ(inName,"__texture2DBinding") ) { _hx_set__hx___texture2DBinding(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 19:
	...
	case 20:
		...
		if (HX_FIELD_EQ(inName,"__arrayBufferBinding") ) { _hx_set__hx___arrayBufferBinding(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__framebufferBinding") ) { _hx_set__hx___framebufferBinding(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 21:
		...
		if (HX_FIELD_EQ(inName,"__renderbufferBinding") ) { _hx_set__hx___renderbufferBinding(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 22:
		...
		if (HX_FIELD_EQ(inName,"__elementBufferBinding") ) { _hx_set__hx___elementBufferBinding(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 23:
		...
		if (HX_FIELD_EQ(inName,"__textureCubeMapBinding") ) { _hx_set__hx___textureCubeMapBinding(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 24:
