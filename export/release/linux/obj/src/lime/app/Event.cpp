...
void Event_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_0b5c7580c5ba99fe_42_new)
HXLINE(  44)		this->canceled = false;
HXLINE(  45)		this->_hx_set__hx___listeners(HX_CTX, ::cpp::VirtualArray_obj::__new());
...
::hx::Val Event_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"dispatch") ) { _hx_set_dispatch(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"__listeners") ) { _hx_set__hx___listeners(HX_CTX_GET,inValue.Cast< ::cpp::VirtualArray >()); return inValue; }
		break;
	case 12:
