...
HXLINE(  26)		this->_hx_set_importRegex(HX_CTX,  ::EReg_obj::__alloc( HX_CTX ,HX_("@import .*?;",b3,0e,97,b2),HX_("ig",de,5b,00,00)));
HXLINE(  25)		this->_hx_set_commentRegex(HX_CTX, HX_("(\\/\\*[\\s\\S]*?\\*\\/)",b6,b7,56,aa));
HXLINE(  24)		this->_hx_set_combinedCSSRegex(HX_CTX, HX_("((\\s*?(?:\\/\\*[\\s\\S]*?\\*\\/)?\\s*?@media[\\s\\S]*?){([\\s\\S]*?)}\\s*?})|(([\\s\\S]*?){([\\s\\S]*?)*?})",76,57,74,ce));
HXLINE(  23)		this->_hx_set_keyframeRegex(HX_CTX, HX_("((@.*?keyframes [\\s\\S]*?){([\\s\\S]*?}\\s*?)})",04,8d,5e,3b));
HXLINE(  22)		this->_hx_set_mediaQueryRegex(HX_CTX, HX_("((@media [\\s\\S]*?){([\\s\\S]*?}\\s*?)})",c6,68,b5,92));
HXLINE(  21)		this->_hx_set_cssRegex(HX_CTX,  ::EReg_obj::__alloc( HX_CTX ,HX_("([\\s\\S]*?){([\\s\\S]*?)*}",0e,f5,de,0e),HX_("ig",de,5b,00,00)));
HXLINE(  19)		this->_hx_set_keyframeStatements(HX_CTX, ::cpp::VirtualArray_obj::__new(0));
HXLINE(  18)		this->_hx_set_importStatements(HX_CTX, ::cpp::VirtualArray_obj::__new(0));
            	}
...
::hx::Val CSSParser_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"source") ) { _hx_set_source(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"options") ) { _hx_set_options(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"cssRegex") ) { _hx_set_cssRegex(HX_CTX_GET,inValue.Cast<  ::EReg >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"importRegex") ) { _hx_set_importRegex(HX_CTX_GET,inValue.Cast<  ::EReg >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"commentRegex") ) { _hx_set_commentRegex(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"keyframeRegex") ) { _hx_set_keyframeRegex(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"mediaQueryRegex") ) { _hx_set_mediaQueryRegex(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"importStatements") ) { _hx_set_importStatements(HX_CTX_GET,inValue.Cast< ::cpp::VirtualArray >()); return inValue; }
		if (HX_FIELD_EQ(inName,"combinedCSSRegex") ) { _hx_set_combinedCSSRegex(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"keyframeStatements") ) { _hx_set_keyframeStatements(HX_CTX_GET,inValue.Cast< ::cpp::VirtualArray >()); return inValue; }
	}
