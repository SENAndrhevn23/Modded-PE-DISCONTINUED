...
HX_DEFINE_STACK_FRAME(_hx_pos_41b97fe5a8880956_4_new,"shaders.RGBPalette","new",0x4af331c0,"shaders.RGBPalette.new","shaders/RGBPalette.hx",4,0xd43b990f)
HX_LOCAL_STACK_FRAME(_hx_pos_41b97fe5a8880956_11_set_r,"shaders.RGBPalette","set_r",0x347214b5,"shaders.RGBPalette.set_r","shaders/RGBPalette.hx",11,0xd43b990f)
HX_LOCAL_STACK_FRAME(_hx_pos_41b97fe5a8880956_17_set_g,"shaders.RGBPalette","set_g",0x347214aa,"shaders.RGBPalette.set_g","shaders/RGBPalette.hx",17,0xd43b990f)
HX_LOCAL_STACK_FRAME(_hx_pos_41b97fe5a8880956_23_set_b,"shaders.RGBPalette","set_b",0x347214a5,"shaders.RGBPalette.set_b","shaders/RGBPalette.hx",23,0xd43b990f)
HX_LOCAL_STACK_FRAME(_hx_pos_41b97fe5a8880956_29_set_mult,"shaders.RGBPalette","set_mult",0x4bc11f8d,"shaders.RGBPalette.set_mult","shaders/RGBPalette.hx",29,0xd43b990f)
namespace shaders{

void RGBPalette_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_41b97fe5a8880956_4_new)
HXLINE(   5)		this->_hx_set_shader(HX_CTX,  ::shaders::RGBPaletteShader_obj::__alloc( HX_CTX ));
HXLINE(  37)		this->set_r(-65536);
HXLINE(  38)		this->set_g(-16711936);
HXLINE(  39)		this->set_b(-16776961);
HXLINE(  40)		this->set_mult(((Float)1.0));
            	}
...
int RGBPalette_obj::set_r(int color){
            	HX_GC_STACKFRAME(&_hx_pos_41b97fe5a8880956_11_set_r)
HXLINE(  12)		this->r = color;
HXLINE(  13)		this->shader->r->_hx_set_value(HX_CTX, ::Array_obj< Float >::__new(3)->init(0,(( (Float)(((color >> 16) & 255)) ) / ( (Float)(255) )))->init(1,(( (Float)(((color >> 8) & 255)) ) / ( (Float)(255) )))->init(2,(( (Float)((color & 255)) ) / ( (Float)(255) ))));
HXLINE(  14)		return color;
            	}
...
int RGBPalette_obj::set_g(int color){
            	HX_GC_STACKFRAME(&_hx_pos_41b97fe5a8880956_17_set_g)
HXLINE(  18)		this->g = color;
HXLINE(  19)		this->shader->g->_hx_set_value(HX_CTX, ::Array_obj< Float >::__new(3)->init(0,(( (Float)(((color >> 16) & 255)) ) / ( (Float)(255) )))->init(1,(( (Float)(((color >> 8) & 255)) ) / ( (Float)(255) )))->init(2,(( (Float)((color & 255)) ) / ( (Float)(255) ))));
HXLINE(  20)		return color;
            	}
...
int RGBPalette_obj::set_b(int color){
            	HX_GC_STACKFRAME(&_hx_pos_41b97fe5a8880956_23_set_b)
HXLINE(  24)		this->b = color;
HXLINE(  25)		this->shader->b->_hx_set_value(HX_CTX, ::Array_obj< Float >::__new(3)->init(0,(( (Float)(((color >> 16) & 255)) ) / ( (Float)(255) )))->init(1,(( (Float)(((color >> 8) & 255)) ) / ( (Float)(255) )))->init(2,(( (Float)((color & 255)) ) / ( (Float)(255) ))));
HXLINE(  26)		return color;
            	}
...
Float RGBPalette_obj::set_mult(Float value){
            	HX_GC_STACKFRAME(&_hx_pos_41b97fe5a8880956_29_set_mult)
HXLINE(  30)		Float lowerBound;
HXDLIN(  30)		if ((value < 0)) {
HXLINE(  30)			lowerBound = ( (Float)(0) );
            		}
            		else {
HXLINE(  30)			lowerBound = value;
            		}
HXDLIN(  30)		Float _hx_tmp;
HXDLIN(  30)		if ((lowerBound > 1)) {
HXLINE(  30)			_hx_tmp = ( (Float)(1) );
            		}
            		else {
HXLINE(  30)			_hx_tmp = lowerBound;
            		}
HXDLIN(  30)		this->mult = _hx_tmp;
HXLINE(  31)		this->shader->mult->_hx_set_value(HX_CTX, ::Array_obj< Float >::__new(1)->init(0,this->mult));
HXLINE(  32)		return this->mult;
            	}
...
::hx::Val RGBPalette_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"shader") ) { _hx_set_shader(HX_CTX_GET,inValue.Cast<  ::shaders::RGBPaletteShader >()); return inValue; }
	}
