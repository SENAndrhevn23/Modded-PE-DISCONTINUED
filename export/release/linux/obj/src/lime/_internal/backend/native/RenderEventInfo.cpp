...
HX_DEFINE_STACK_FRAME(_hx_pos_e2a4e584e1f8ec25_871_new,"lime._internal.backend.native.RenderEventInfo","new",0x4ace2292,"lime._internal.backend.native.RenderEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",871,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_e2a4e584e1f8ec25_876_clone,"lime._internal.backend.native.RenderEventInfo","clone",0xe3bbd60f,"lime._internal.backend.native.RenderEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",876,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void RenderEventInfo_obj::__construct( ::Dynamic type){
            	HX_STACKFRAME(&_hx_pos_e2a4e584e1f8ec25_871_new)
HXDLIN( 871)		this->type = ( (int)(type) );
            	}
...
bool RenderEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::RenderEventInfo RenderEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_e2a4e584e1f8ec25_876_clone)
HXDLIN( 876)		return  ::lime::_internal::backend::native::RenderEventInfo_obj::__alloc( HX_CTX ,this->type);
            	}
