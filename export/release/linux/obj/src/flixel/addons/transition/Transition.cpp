...
void Transition_obj::__construct( ::flixel::addons::transition::TransitionData data){
            	HX_GC_STACKFRAME(&_hx_pos_ab83fa44df0ac8ad_32_new)
HXLINE(  33)		super::__construct(0);
HXLINE(  35)		this->_hx_set__effect(HX_CTX, this->createEffect(data));
HXLINE(  36)		{
...
void Transition_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_ab83fa44df0ac8ad_41_destroy)
HXLINE(  42)		this->super::destroy();
HXLINE(  44)		this->set_finishCallback(null());
HXLINE(  46)		this->_hx_set__effect(HX_CTX, ( ( ::flixel::addons::transition::TransitionEffect)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_effect)) ));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Transition_obj,get_finishCallback,return )
 ...
 ::Dynamic Transition_obj::set_finishCallback( ::Dynamic callback){
            	HX_GC_STACKFRAME(&_hx_pos_ab83fa44df0ac8ad_83_set_finishCallback)
HXLINE(  84)		if (::hx::IsNotNull( this->_effect )) {
HXLINE(  86)			this->_effect->_hx_set_finishCallback(HX_CTX, callback);
...
::hx::Val Transition_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"_effect") ) { _hx_set__effect(HX_CTX_GET,inValue.Cast<  ::flixel::addons::transition::TransitionEffect >()); return inValue; }
		break;
	case 14:
