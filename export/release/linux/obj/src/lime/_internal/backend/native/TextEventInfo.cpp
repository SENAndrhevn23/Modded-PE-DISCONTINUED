...
HX_DEFINE_STACK_FRAME(_hx_pos_48b909785036aaec_925_new,"lime._internal.backend.native.TextEventInfo","new",0x7aff2f5b,"lime._internal.backend.native.TextEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",925,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_48b909785036aaec_935_clone,"lime._internal.backend.native.TextEventInfo","clone",0x4be06718,"lime._internal.backend.native.TextEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",935,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void TextEventInfo_obj::__construct( ::Dynamic type,::hx::Null< int >  __o_windowID,::String text,::hx::Null< int >  __o_start,::hx::Null< int >  __o_length){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_48b909785036aaec_925_new)
HXLINE( 926)		this->type = ( (int)(type) );
HXLINE( 927)		this->windowID = windowID;
HXLINE( 928)		this->_hx_set_text(HX_CTX, text);
HXLINE( 929)		this->start = start;
HXLINE( 930)		this->length = length;
            	}
...
bool TextEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::TextEventInfo TextEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_48b909785036aaec_935_clone)
HXDLIN( 935)		return  ::lime::_internal::backend::native::TextEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->text,this->start,this->length);
            	}
