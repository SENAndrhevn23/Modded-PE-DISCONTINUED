...
HXLINE(  45)		this->_hx_set_output(HX_CTX,  ::StringBuf_obj::__alloc( HX_CTX ));
...
HXLINE(  68)							_this->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(input)));
            						}
            						else {
...
HXLINE(  69)							_this2->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(input1)));
            						}
            						else {
...
HXLINE(  71)									_this4->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(input2)));
            								}
            								else {
...
HXLINE(  72)									_this6->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(input3)));
            								}
            								else {
...
HXLINE(  73)								_this8->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_d3e3a3db_5,1));
            							}
            							else {
...
HXLINE(  76)							_this9->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_d3e3a3db_6,1));
            						}
            						else {
...
HXLINE(  77)							_this10->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_d3e3a3db_7,1));
            						}
            						else {
...
HXLINE(  81)								_this11->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(input4)));
            							}
            							else {
...
HXLINE(  82)								_this13->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(input5)));
            							}
            							else {
...
HXLINE(  83)							_this15->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_d3e3a3db_8,1));
            						}
            						else {
...
HXLINE(  84)							_this16->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_d3e3a3db_9,1));
            						}
            						else {
...
HXLINE(  86)							_this17->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_d3e3a3db_10,1));
            						}
            						else {
...
HXLINE(  87)							_this18->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_d3e3a3db_11,1));
            						}
            						else {
...
HXLINE(  92)								_this19->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(input6)));
            							}
            							else {
...
HXLINE(  93)							_this21->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_d3e3a3db_12,1));
            						}
            						else {
...
HXLINE(  52)							_this22->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(input7)));
            						}
            						else {
...
HXLINE(  53)							_this24->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(input8)));
            						}
            						else {
...
HXLINE(  54)						_this26->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_d3e3a3db_13,1));
            					}
            					else {
...
HXLINE(  55)						_this27->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_d3e3a3db_14,1));
            					}
            					else {
...
HXLINE(  60)						_this28->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(tabs)));
            					}
            					else {
...
HXLINE(  61)							_this30->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(input9)));
            						}
            						else {
...
HXLINE(  62)						_this32->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_d3e3a3db_15,1));
            					}
            					else {
...
HXLINE(  99)							_this33->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(input11)));
            						}
            						else {
...
HXLINE( 100)						_this35->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_d3e3a3db_16,1));
            					}
            					else {
...
HXLINE(  96)							_this36->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(input13)));
            						}
            						else {
...
HXLINE(  97)						_this38->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_d3e3a3db_17,1));
            					}
            					else {
...
::hx::Val Printer_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"output") ) { _hx_set_output(HX_CTX_GET,inValue.Cast<  ::StringBuf >()); return inValue; }
