...
class HXCPP_CLASS_ATTRIBUTES InflateImpl_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::haxe::zip::_InflateImpl::State _hx_set_state(::hx::StackContext *_hx_ctx, ::haxe::zip::_InflateImpl::State _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return state=_hx_v; }
		bool isFinal;
		 ::haxe::zip::Huffman huffman;
		inline  ::haxe::zip::Huffman _hx_set_huffman(::hx::StackContext *_hx_ctx, ::haxe::zip::Huffman _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return huffman=_hx_v; }
		 ::haxe::zip::Huffman huffdist;
		inline  ::haxe::zip::Huffman _hx_set_huffdist(::hx::StackContext *_hx_ctx, ::haxe::zip::Huffman _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return huffdist=_hx_v; }
		 ::haxe::zip::HuffTools htools;
		inline  ::haxe::zip::HuffTools _hx_set_htools(::hx::StackContext *_hx_ctx, ::haxe::zip::HuffTools _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return htools=_hx_v; }
		int len;
		int dist;
		int needed;
		 ::haxe::io::Bytes output;
		inline  ::haxe::io::Bytes _hx_set_output(::hx::StackContext *_hx_ctx, ::haxe::io::Bytes _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return output=_hx_v; }
		int outpos;
		 ::haxe::io::Input input;
		...
		::Array< int > lengths;
		inline ::Array< int > _hx_set_lengths(::hx::StackContext *_hx_ctx,::Array< int > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return lengths=_hx_v; }
		 ::haxe::zip::_InflateImpl::Window window;
		inline  ::haxe::zip::_InflateImpl::Window _hx_set_window(::hx::StackContext *_hx_ctx, ::haxe::zip::_InflateImpl::Window _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return window=_hx_v; }
