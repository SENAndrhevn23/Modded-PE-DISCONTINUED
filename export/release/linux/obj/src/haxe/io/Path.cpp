...
void Path_obj::__construct(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_6cfed01bf295c856_76_new)
HXLINE(  77)		::String _hx_switch_0 = path;
            		if (  (_hx_switch_0==HX_(".",2e,00,00,00)) ||  (_hx_switch_0==HX_("..",40,28,00,00)) ){
HXLINE(  79)			this->_hx_set_dir(HX_CTX, path);
HXLINE(  80)			this->_hx_set_file(HX_CTX, HX_("",00,00,00,00));
HXLINE(  81)			return;
...
HXLINE(  85)		if ((c1 < c2)) {
HXLINE(  86)			this->_hx_set_dir(HX_CTX, path.substr(0,c2));
HXLINE(  87)			path = path.substr((c2 + 1),null());
HXLINE(  88)			this->backslash = true;
            		}
            		else {
HXLINE(  89)			if ((c2 < c1)) {
HXLINE(  90)				this->_hx_set_dir(HX_CTX, path.substr(0,c1));
HXLINE(  91)				path = path.substr((c1 + 1),null());
            			}
            			else {
HXLINE(  93)				this->_hx_set_dir(HX_CTX, null());
            			}
            		}
HXLINE(  94)		int cp = path.lastIndexOf(HX_(".",2e,00,00,00),null());
HXLINE(  95)		if ((cp != -1)) {
HXLINE(  96)			this->_hx_set_ext(HX_CTX, path.substr((cp + 1),null()));
HXLINE(  97)			this->_hx_set_file(HX_CTX, path.substr(0,cp));
            		}
            		else {
HXLINE(  99)			this->_hx_set_ext(HX_CTX, null());
HXLINE( 100)			this->_hx_set_file(HX_CTX, path);
            		}
            	}
...
HXLINE( 125)		s->_hx_set_ext(HX_CTX, null());
...
HXLINE( 136)		s->_hx_set_dir(HX_CTX, null());
...
HXLINE( 249)											acc->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_4ec6cf05_13,1));
            										}
            										else {
...
HXLINE( 242)								acc->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_4ec6cf05_14,1));
            							}
            							else {
...
HXDLIN( 249)									if (::hx::IsNull( acc->b )) {
HXLINE( 249)										acc->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_4ec6cf05_15,1));
            									}
            									else {
HXLINE( 249)										acc->b->push(HX_("/",2f,00,00,00));
            									}
...
::hx::Val Path_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"dir") ) { _hx_set_dir(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"ext") ) { _hx_set_ext(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 4:
