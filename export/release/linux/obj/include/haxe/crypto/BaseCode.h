...
class HXCPP_CLASS_ATTRIBUTES BaseCode_obj : public ::hx::Object
{
	...
	public:
		...
		::String __ToString() const { return HX_("BaseCode",fe,5d,c4,cf); }
		 ...
		 ::haxe::io::Bytes base;
		inline  ::haxe::io::Bytes _hx_set_base(::hx::StackContext *_hx_ctx, ::haxe::io::Bytes _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return base=_hx_v; }
		int nbits;
		::Array< int > tbl;
		inline ::Array< int > _hx_set_tbl(::hx::StackContext *_hx_ctx,::Array< int > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return tbl=_hx_v; }
		void initTable();
