...
class HXCPP_CLASS_ATTRIBUTES FlxBar_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		inline  ::flixel::math::FlxBasePoint _hx_set_positionOffset(::hx::StackContext *_hx_ctx, ::flixel::math::FlxBasePoint _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return positionOffset=_hx_v; }
		bool killOnEmpty;
		Float value;
		Float min;
		Float max;
		...
		inline  ::Dynamic _hx_set_emptyCallback(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return emptyCallback=_hx_v; }
		Dynamic emptyCallback_dyn() { return emptyCallback;}
		 ::Dynamic filledCallback;
		inline  ::Dynamic _hx_set_filledCallback(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return filledCallback=_hx_v; }
		...
		inline ::String _hx_set_parentVariable(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return parentVariable=_hx_v; }
		int barWidth;
		int barHeight;
		 ::flixel::graphics::frames::FlxImageFrame frontFrames;
		inline  ::flixel::graphics::frames::FlxImageFrame _hx_set_frontFrames(::hx::StackContext *_hx_ctx, ::flixel::graphics::frames::FlxImageFrame _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return frontFrames=_hx_v; }
		 ::flixel::ui::FlxBarFillDirection fillDirection;
		inline  ::flixel::ui::FlxBarFillDirection _hx_set_fillDirection(::hx::StackContext *_hx_ctx, ::flixel::ui::FlxBarFillDirection _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return fillDirection=_hx_v; }
		bool _fillHorizontal;
		 ::flixel::graphics::frames::FlxFrame _frontFrame;
		inline  ::flixel::graphics::frames::FlxFrame _hx_set__frontFrame(::hx::StackContext *_hx_ctx, ::flixel::graphics::frames::FlxFrame _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _frontFrame=_hx_v; }
		 ::flixel::math::FlxRect _filledFlxRect;
		inline  ::flixel::math::FlxRect _hx_set__filledFlxRect(::hx::StackContext *_hx_ctx, ::flixel::math::FlxRect _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _filledFlxRect=_hx_v; }
		 ::openfl::display::BitmapData _emptyBar;
		inline  ::openfl::display::BitmapData _hx_set__emptyBar(::hx::StackContext *_hx_ctx, ::openfl::display::BitmapData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _emptyBar=_hx_v; }
		 ::openfl::geom::Rectangle _emptyBarRect;
		inline  ::openfl::geom::Rectangle _hx_set__emptyBarRect(::hx::StackContext *_hx_ctx, ::openfl::geom::Rectangle _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _emptyBarRect=_hx_v; }
		 ::openfl::display::BitmapData _filledBar;
		inline  ::openfl::display::BitmapData _hx_set__filledBar(::hx::StackContext *_hx_ctx, ::openfl::display::BitmapData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _filledBar=_hx_v; }
		 ::openfl::geom::Point _zeroOffset;
		inline  ::openfl::geom::Point _hx_set__zeroOffset(::hx::StackContext *_hx_ctx, ::openfl::geom::Point _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _zeroOffset=_hx_v; }
		 ::openfl::geom::Rectangle _filledBarRect;
		inline  ::openfl::geom::Rectangle _hx_set__filledBarRect(::hx::StackContext *_hx_ctx, ::openfl::geom::Rectangle _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _filledBarRect=_hx_v; }
		 ::openfl::geom::Point _filledBarPoint;
		inline  ::openfl::geom::Point _hx_set__filledBarPoint(::hx::StackContext *_hx_ctx, ::openfl::geom::Point _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _filledBarPoint=_hx_v; }
		int _maxPercent;
		void destroy();
