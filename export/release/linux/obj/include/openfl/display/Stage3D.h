...
class HXCPP_CLASS_ATTRIBUTES Stage3D_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		inline  ::openfl::geom::Matrix3D _hx_set__hx___projectionTransform(::hx::StackContext *_hx_ctx, ::openfl::geom::Matrix3D _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___projectionTransform=_hx_v; }
		 ::openfl::geom::Matrix3D _hx___renderTransform;
		inline  ::openfl::geom::Matrix3D _hx_set__hx___renderTransform(::hx::StackContext *_hx_ctx, ::openfl::geom::Matrix3D _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___renderTransform=_hx_v; }
