...
void URLRequest_obj::__construct(::String url){
            	HX_GC_STACKFRAME(&_hx_pos_d7a2132659cec934_347_new)
HXLINE( 348)		if (::hx::IsNotNull( url )) {
HXLINE( 350)			this->_hx_set_url(HX_CTX, url);
            		}
HXLINE( 353)		this->_hx_set_contentType(HX_CTX, null());
...
HXLINE( 370)		this->_hx_set_method(HX_CTX, HX_("GET",76,1c,36,00));
HXLINE( 371)		this->_hx_set_requestHeaders(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE( 372)		this->_hx_set_userAgent(HX_CTX, ::openfl::net::URLRequestDefaults_obj::userAgent);
            	}
...
::hx::Val URLRequest_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 13:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"requestHeaders") ) { _hx_set_requestHeaders(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 15:
