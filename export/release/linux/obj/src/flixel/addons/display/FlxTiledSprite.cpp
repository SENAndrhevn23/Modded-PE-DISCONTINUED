...
void FlxTiledSprite_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_9c4135b7a1fcedcd_91_destroy)
HXLINE(  92)		this->_hx_set_renderSprite(HX_CTX, ( ( ::flixel::FlxSprite)(::flixel::util::FlxDestroyUtil_obj::destroy(this->renderSprite)) ));
...
void FlxTiledSprite_obj::draw(){
            	HX_GC_STACKFRAME(&_hx_pos_9c4135b7a1fcedcd_135_draw)
...
HXLINE( 147)			this->renderSprite->_hx_set__cameras(HX_CTX, this->_cameras);
...
HXLINE( 161)			this->_hx_set_renderSprite(HX_CTX,  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null()));
            		}
...
::hx::Val FlxTiledSprite_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"renderSprite") ) { _hx_set_renderSprite(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSprite >()); return inValue; }
		break;
	case 14:
