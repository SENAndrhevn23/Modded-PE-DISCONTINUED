...
class HXCPP_CLASS_ATTRIBUTES RenderEvent_obj : public  ::openfl::events::Event_obj
{
	...
	public:
		...
		inline  ::openfl::geom::ColorTransform _hx_set_objectColorTransform(::hx::StackContext *_hx_ctx, ::openfl::geom::ColorTransform _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return objectColorTransform=_hx_v; }
		 ::openfl::geom::Matrix objectMatrix;
		inline  ::openfl::geom::Matrix _hx_set_objectMatrix(::hx::StackContext *_hx_ctx, ::openfl::geom::Matrix _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return objectMatrix=_hx_v; }
		 ::openfl::display::DisplayObjectRenderer renderer;
		inline  ::openfl::display::DisplayObjectRenderer _hx_set_renderer(::hx::StackContext *_hx_ctx, ::openfl::display::DisplayObjectRenderer _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return renderer=_hx_v; }
