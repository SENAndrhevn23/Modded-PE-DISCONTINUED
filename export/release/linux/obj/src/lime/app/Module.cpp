...
HXDLIN(  20)		this->_hx_set_onExit(HX_CTX,  ::lime::app::_Event_Int_Void_obj::__alloc( HX_CTX ));
            	}
...
::hx::Val Module_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"onExit") ) { _hx_set_onExit(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Int_Void >()); return inValue; }
	}
