...
HXDLIN(2614)		( ( ::lime::graphics::opengl::GLObject)(__this) )->id = id;
		...
		int id;
		 ::Dynamic ptr;
		inline  ::Dynamic _hx_set_ptr(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return ptr=_hx_v; }
		::Array< ::Dynamic> refs;
		inline ::Array< ::Dynamic> _hx_set_refs(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return refs=_hx_v; }
};
