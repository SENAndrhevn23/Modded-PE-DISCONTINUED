...
HX_DEFINE_STACK_FRAME(_hx_pos_31fff5ab54a2c1a2_39_new,"crowplexus.hscript.LocalVar","new",0xf5ffcc73,"crowplexus.hscript.LocalVar.new","crowplexus/hscript/Interp.hx",39,0x864063c3)
namespace crowplexus{
namespace hscript{

void LocalVar_obj::__construct( ::Dynamic r,bool _hx_const){
            	HX_GC_STACKFRAME(&_hx_pos_31fff5ab54a2c1a2_39_new)
HXDLIN(  39)		this->_hx_set_r(HX_CTX, r);
HXDLIN(  39)		this->_hx_const = _hx_const;
            	}
