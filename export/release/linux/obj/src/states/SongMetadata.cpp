...
HX_DEFINE_STACK_FRAME(_hx_pos_8e23e7423f533d70_693_new,"states.SongMetadata","new",0x9038fc22,"states.SongMetadata.new","states/FreeplayState.hx",693,0x1b2e20da)
namespace states{

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter,int color){
            	HX_GC_STACKFRAME(&_hx_pos_8e23e7423f533d70_693_new)
HXLINE( 700)		this->_hx_set_lastDifficulty(HX_CTX, null());
HXLINE( 699)		this->_hx_set_folder(HX_CTX, HX_("",00,00,00,00));
HXLINE( 698)		this->color = -7179779;
HXLINE( 697)		this->_hx_set_songCharacter(HX_CTX, HX_("",00,00,00,00));
HXLINE( 696)		this->week = 0;
HXLINE( 695)		this->_hx_set_songName(HX_CTX, HX_("",00,00,00,00));
HXLINE( 704)		this->_hx_set_songName(HX_CTX, song);
HXLINE( 705)		this->week = week;
HXLINE( 706)		this->_hx_set_songCharacter(HX_CTX, songCharacter);
HXLINE( 707)		this->color = color;
HXLINE( 708)		this->_hx_set_folder(HX_CTX, ::backend::Mods_obj::currentModDirectory);
HXLINE( 709)		if (::hx::IsNull( this->folder )) {
HXLINE( 709)			this->_hx_set_folder(HX_CTX, HX_("",00,00,00,00));
            		}
            	}
...
::hx::Val SongMetadata_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 13:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"lastDifficulty") ) { _hx_set_lastDifficulty(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	}
