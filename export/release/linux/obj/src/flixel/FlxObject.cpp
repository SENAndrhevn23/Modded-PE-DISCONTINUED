...
void FlxObject_obj::__construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< Float >  __o_width,::hx::Null< Float >  __o_height){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_c625bfaa5b4263df_75_new)
...
HXDLIN( 795)		this->_hx_set__rect(HX_CTX, rect);
...
HXDLIN( 793)		this->_hx_set__point(HX_CTX, point);
HXLINE( 790)		this->_hx_set_path(HX_CTX, null());
...
void FlxObject_obj::initVars(){
            	HX_GC_STACKFRAME(&_hx_pos_c625bfaa5b4263df_820_initVars)
...
HXDLIN( 822)		this->_hx_set_last(HX_CTX, point);
...
HXDLIN( 823)		this->_hx_set_scrollFactor(HX_CTX, point1);
...
HXDLIN( 826)			this->_hx_set_velocity(HX_CTX, point2);
...
HXDLIN( 826)			this->_hx_set_acceleration(HX_CTX, point3);
...
HXDLIN( 826)			this->_hx_set_drag(HX_CTX, point4);
...
HXDLIN( 826)			this->_hx_set_maxVelocity(HX_CTX, point5);
            		}
            	}
...
void FlxObject_obj::initMotionVars(){
            	HX_GC_STACKFRAME(&_hx_pos_c625bfaa5b4263df_834_initMotionVars)
...
HXDLIN( 835)		this->_hx_set_velocity(HX_CTX, point);
...
HXDLIN( 836)		this->_hx_set_acceleration(HX_CTX, point1);
...
HXDLIN( 837)		this->_hx_set_drag(HX_CTX, point2);
...
HXDLIN( 838)		this->_hx_set_maxVelocity(HX_CTX, point3);
            	}
...
void FlxObject_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_c625bfaa5b4263df_852_destroy)
HXLINE( 853)		this->super::destroy();
HXLINE( 855)		this->_hx_set_velocity(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->velocity)) ));
HXLINE( 856)		this->_hx_set_acceleration(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->acceleration)) ));
HXLINE( 857)		this->_hx_set_drag(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->drag)) ));
HXLINE( 858)		this->_hx_set_maxVelocity(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->maxVelocity)) ));
HXLINE( 859)		this->_hx_set_scrollFactor(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->scrollFactor)) ));
HXLINE( 860)		this->_hx_set_last(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->last)) ));
HXLINE( 861)		this->_hx_set__point(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->_point)) ));
HXLINE( 862)		this->_hx_set__rect(HX_CTX, ( ( ::flixel::math::FlxRect)(::flixel::util::FlxDestroyUtil_obj::put(this->_rect)) ));
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FlxObject_obj,setSize,(void))
 ...
 ::flixel::math::FlxRect FlxObject_obj::getBoundingBox( ::flixel::FlxCamera camera){
            	HX_GC_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1332_getBoundingBox)
...
HXLINE(1336)		this->_hx_set__rect(HX_CTX, camera->transformRect(this->_rect));
...
::String FlxObject_obj::toString(){
            	HX_GC_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1369_toString)
...
HXDLIN(1370)		_this->_hx_set_label(HX_CTX, HX_("x",78,00,00,00));
HXDLIN(1370)		_this->_hx_set_value(HX_CTX, value);
...
HXDLIN(1371)		_this1->_hx_set_label(HX_CTX, HX_("y",79,00,00,00));
HXDLIN(1371)		_this1->_hx_set_value(HX_CTX, value1);
...
HXDLIN(1372)		_this2->_hx_set_label(HX_CTX, HX_("w",77,00,00,00));
HXDLIN(1372)		_this2->_hx_set_value(HX_CTX, value2);
...
HXDLIN(1373)		_this3->_hx_set_label(HX_CTX, HX_("h",68,00,00,00));
HXDLIN(1373)		_this3->_hx_set_value(HX_CTX, value3);
...
HXDLIN(1374)		_this4->_hx_set_label(HX_CTX, HX_("visible",72,78,24,a3));
HXDLIN(1374)		_this4->_hx_set_value(HX_CTX, value4);
...
HXDLIN(1375)		_this5->_hx_set_label(HX_CTX, HX_("velocity",1d,02,fe,1e));
HXDLIN(1375)		_this5->_hx_set_value(HX_CTX, value5);
...
bool FlxObject_obj::set_pixelPerfectRender(bool value){
            	HX_GC_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1465_set_pixelPerfectRender)
HXDLIN(1465)		return ( (bool)((this->_hx_set_pixelPerfectRender(HX_CTX, value))) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxObject_obj,set_collisonXDrag,return )
 ...
 ::flixel::path::FlxPath FlxObject_obj::set_path( ::flixel::path::FlxPath path){
            	HX_GC_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1509_set_path)
HXLINE(1510)		if (::hx::IsInstanceEq( this->path,path )) {
HXLINE(1511)			return path;
            		}
HXLINE(1513)		if (::hx::IsNotNull( this->path )) {
HXLINE(1514)			this->path->_hx_set_object(HX_CTX, null());
            		}
HXLINE(1516)		if (::hx::IsNotNull( path )) {
HXLINE(1517)			path->_hx_set_object(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE(1518)		return (this->_hx_set_path(HX_CTX, path));
            	}
...
::hx::Val FlxObject_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 1:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"drag") ) { _hx_set_drag(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		if (HX_FIELD_EQ(inName,"last") ) { _hx_set_last(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		if (HX_FIELD_EQ(inName,"mass") ) { mass=inValue.Cast< Float >(); return inValue; }
		if (HX_FIELD_EQ(inName,"path") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_path(inValue.Cast<  ::flixel::path::FlxPath >()) );_hx_set_path(HX_CTX_GET,inValue.Cast<  ::flixel::path::FlxPath >()); return inValue; }
		break;
	case 5:
		...
		if (HX_FIELD_EQ(inName,"_rect") ) { _hx_set__rect(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxRect >()); return inValue; }
		break;
	case 6:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"velocity") ) { _hx_set_velocity(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
	...
	case 10:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"maxVelocity") ) { _hx_set_maxVelocity(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"scrollFactor") ) { _hx_set_scrollFactor(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		if (HX_FIELD_EQ(inName,"acceleration") ) { _hx_set_acceleration(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		break;
	case 13:
	...
	case 15:
		...
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"pixelPerfectRender") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_pixelPerfectRender(inValue.Cast<  ::Dynamic >()) );_hx_set_pixelPerfectRender(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 19:
