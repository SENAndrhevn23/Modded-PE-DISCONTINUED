...
class HXCPP_CLASS_ATTRIBUTES FlxGamepadAnalogStick_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::flixel::input::gamepad::FlxAnalogToDigitalMode _hx_set_mode(::hx::StackContext *_hx_ctx, ::flixel::input::gamepad::FlxAnalogToDigitalMode _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return mode=_hx_v; }
