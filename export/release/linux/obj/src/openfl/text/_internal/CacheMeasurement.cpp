...
HXLINE(  21)		this->_hx_set__hx___collisions(HX_CTX, ::Array_obj< ::String >::__new(0));
HXLINE(  22)		this->_hx_set__hx___wordMap(HX_CTX,  ::haxe::ds::IntMap_obj::__alloc( HX_CTX ));
...
::hx::Val CacheMeasurement_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"__wordMap") ) { _hx_set__hx___wordMap(HX_CTX_GET,inValue.Cast<  ::haxe::ds::IntMap >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"__collisions") ) { _hx_set__hx___collisions(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
	}
