...
::String FlxPointer_obj::toString(){
            	HX_GC_STACKFRAME(&_hx_pos_e74b11cf5585adaf_154_toString)
...
HXDLIN( 154)		_this->_hx_set_label(HX_CTX, HX_("x",78,00,00,00));
HXDLIN( 154)		_this->_hx_set_value(HX_CTX, value);
...
HXDLIN( 154)		_this1->_hx_set_label(HX_CTX, HX_("y",79,00,00,00));
HXDLIN( 154)		_this1->_hx_set_value(HX_CTX, value1);
