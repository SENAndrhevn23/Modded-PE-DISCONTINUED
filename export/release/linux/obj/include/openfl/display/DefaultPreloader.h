...
class HXCPP_CLASS_ATTRIBUTES DefaultPreloader_obj : public  ::openfl::display::Sprite_obj
{
	...
	public:
		...
		inline  ::openfl::display::Shape _hx_set_outline(::hx::StackContext *_hx_ctx, ::openfl::display::Shape _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return outline=_hx_v; }
		 ::openfl::display::Shape progress;
		inline  ::openfl::display::Shape _hx_set_progress(::hx::StackContext *_hx_ctx, ::openfl::display::Shape _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return progress=_hx_v; }
		int startAnimation;
