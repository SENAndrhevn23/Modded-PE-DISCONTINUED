...
class HXCPP_CLASS_ATTRIBUTES FlxBaseKeyList_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::flixel::input::FlxKeyManager _hx_set_keyManager(::hx::StackContext *_hx_ctx, ::flixel::input::FlxKeyManager _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return keyManager=_hx_v; }
