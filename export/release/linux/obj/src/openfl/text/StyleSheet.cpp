...
HXLINE(  78)		this->_hx_set__hx___styleNames(HX_CTX, null());
HXLINE(  79)		this->_hx_set__hx___styles(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
            	}
...
HXLINE( 239)				textFormat->_hx_set_color(HX_CTX, ::Std_obj::parseInt((HX_("0x",48,2a,00,00) + hex->matched(0))));
            			}
...
HXDLIN( 253)				textFormat->_hx_set_font(HX_CTX, this->_hx___parseFont(_hx_tmp4));
            			}
...
HXLINE( 257)				textFormat->_hx_set_size(HX_CTX, ::Std_obj::parseInt(numeric->matched(0)));
            			}
...
HXLINE( 266)					textFormat->_hx_set_italic(HX_CTX, true);
HXDLIN( 266)					goto _hx_goto_11;
            				}
            				if (  (_hx_switch_0==HX_("normal",27,72,69,30)) ){
HXLINE( 264)					textFormat->_hx_set_italic(HX_CTX, false);
...
HXLINE( 277)					textFormat->_hx_set_bold(HX_CTX, true);
HXDLIN( 277)					goto _hx_goto_12;
            				}
            				if (  (_hx_switch_1==HX_("normal",27,72,69,30)) ){
HXLINE( 275)					textFormat->_hx_set_bold(HX_CTX, false);
...
HXLINE( 286)				textFormat->_hx_set_leading(HX_CTX, ::Std_obj::parseInt(numeric->matched(0)));
            			}
...
HXLINE( 290)				textFormat->_hx_set_letterSpacing(HX_CTX, ::Std_obj::parseFloat(numeric->matched(0)));
            			}
...
HXLINE( 294)				textFormat->_hx_set_leftMargin(HX_CTX, ::Std_obj::parseInt(numeric->matched(0)));
            			}
...
HXLINE( 298)				textFormat->_hx_set_rightMargin(HX_CTX, ::Std_obj::parseInt(numeric->matched(0)));
            			}
...
HXLINE( 320)					textFormat->_hx_set_underline(HX_CTX, false);
HXDLIN( 320)					goto _hx_goto_14;
            				}
            				if (  (_hx_switch_3==HX_("underline",0c,15,d1,87)) ){
HXLINE( 322)					textFormat->_hx_set_underline(HX_CTX, true);
...
HXLINE( 328)				textFormat->_hx_set_blockIndent(HX_CTX, ::Std_obj::parseInt(numeric->matched(0)));
            			}
            		}
            	}
...
::Array< ::String > StyleSheet_obj::get_styleNames(){
            	HX_GC_STACKFRAME(&_hx_pos_aa62e0dbceb4da36_353_get_styleNames)
...
HXLINE( 356)			this->_hx_set__hx___styleNames(HX_CTX, ::Array_obj< ::String >::__new(0));
HXLINE( 357)			{
...
::hx::Val StyleSheet_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"__styles") ) { _hx_set__hx___styles(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"__styleNames") ) { _hx_set__hx___styleNames(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		break;
	case 17:
