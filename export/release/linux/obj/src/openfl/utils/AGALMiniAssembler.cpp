...
HXLINE( 187)		this->_hx_set_agalcode(HX_CTX,  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,0));
HXLINE( 188)		this->_hx_set_error(HX_CTX, HX_("",00,00,00,00));
...
HXLINE( 198)				this->_hx_set_error(HX_CTX, ((((((HX_("ERROR: mode needs to be \"",d8,b7,4c,b2) + HX_("fragment",d0,5f,e5,ad)) + HX_("\" or \"",a3,20,aa,4e)) + HX_("vertex",64,db,47,a1)) + HX_("\" but is \"",69,33,a7,e2)) + mode) + HX_("\".",cc,1d,00,00)));
            			}
            		}
HXLINE( 201)		this->agalcode->_hx_set__hx___endian(HX_CTX, 1);
...
HXLINE( 290)				this->_hx_set_error(HX_CTX, HX_("error: opcode requires version 2.",d2,34,38,ba));
...
HXLINE( 296)				this->_hx_set_error(HX_CTX, HX_("error: opcode is only allowed in vertex programs.",a4,4b,76,ab));
...
HXLINE( 302)				this->_hx_set_error(HX_CTX, HX_("error: opcode is only allowed in fragment programs.",50,b1,63,46));
...
HXLINE( 316)				this->_hx_set_error(HX_CTX, ((HX_("error: too many opcodes. maximum is ",26,64,b3,3b) + 4096) + HX_(".",2e,00,00,00)));
HXLINE( 317)				goto _hx_goto_2;
            			}
HXLINE( 321)			::Array< ::String > regs = this->match(line,reg4);
HXLINE( 323)			if ((regs->length != opFound->numRegister)) {
HXLINE( 325)				this->_hx_set_error(HX_CTX, ((((HX_("error: wrong number of operands. found ",ad,a0,73,c8) + regs->length) + HX_(" but expected ",e9,a0,e7,6d)) + opFound->numRegister) + HX_(".",2e,00,00,00)));
...
HXLINE( 340)						regs->setCtx( HX_CTX, j,::StringTools_obj::replace(regs->__get(j),relreg->__get(0),HX_("0",30,00,00,00)));
...
HXLINE( 353)						this->_hx_set_error(HX_CTX, ((((HX_("error: could not parse operand ",5e,e6,18,8a) + j) + HX_(" (",08,1c,00,00)) + regs->__get(j)) + HX_(").",e5,23,00,00)));
...
HXLINE( 368)						this->_hx_set_error(HX_CTX, ((((HX_("error: could not find register name for operand ",d3,f6,78,ae) + j) + HX_(" (",08,1c,00,00)) + regs->__get(j)) + HX_(").",e5,23,00,00)));
HXLINE( 369)						badreg = true;
HXLINE( 370)						goto _hx_goto_3;
            					}
HXLINE( 373)					if (isFrag) {
HXLINE( 375)						if (((regFound->flags & 32) == 0)) {
HXLINE( 377)							this->_hx_set_error(HX_CTX, ((((HX_("error: register operand ",66,bd,b9,f5) + j) + HX_(" (",08,1c,00,00)) + regs->__get(j)) + HX_(") only allowed in vertex programs.",e9,f2,50,fb)));
HXLINE( 378)							badreg = true;
HXLINE( 379)							goto _hx_goto_3;
            						}
HXLINE( 382)						if (isRelative) {
HXLINE( 384)							this->_hx_set_error(HX_CTX, ((((HX_("error: register operand ",66,bd,b9,f5) + j) + HX_(" (",08,1c,00,00)) + regs->__get(j)) + HX_(") relative adressing not allowed in fragment programs.",34,7c,f5,9f)));
...
HXLINE( 393)							this->_hx_set_error(HX_CTX, ((((HX_("error: register operand ",66,bd,b9,f5) + j) + HX_(" (",08,1c,00,00)) + regs->__get(j)) + HX_(") only allowed in fragment programs.",d5,73,aa,3f)));
HXLINE( 394)							badreg = true;
HXLINE( 395)							goto _hx_goto_3;
            						}
            					}
HXLINE( 399)					int _hx_tmp6 = regs->__get(j).indexOf(regFound->name,null());
HXDLIN( 399)					regs->setCtx( HX_CTX, j,regs->__get(j).substr((_hx_tmp6 + regFound->name.length),null()));
...
HXDLIN( 411)						this->_hx_set_error(HX_CTX, ((_hx_tmp8 + ::Std_obj::string(_hx_tmp9)) + HX_(".",2e,00,00,00)));
...
HXLINE( 426)						this->_hx_set_error(HX_CTX, HX_("error: relative can not be destination",54,bb,32,e3));
...
HXLINE( 480)							this->_hx_set_error(HX_CTX, HX_("error: bad index register",1a,79,3a,ab));
...
HXLINE( 490)							this->_hx_set_error(HX_CTX, HX_("error: bad index register select",42,31,f8,d3));
...
HXLINE( 511)							this->_hx_set_error(HX_CTX, ((HX_("error: index offset ",f1,9c,33,57) + reloffset) + HX_(" out of bounds. [0..255]",de,2b,59,f3)));
...
HXDLIN( 629)			_hx_tmp24->_hx_set_error(HX_CTX, (_hx_tmp24->error + (((HX_("\n  at line ",49,c3,70,34) + i) + HX_(" ",20,00,00,00)) + lines->__get(i))));
...
::hx::Val AGALMiniAssembler_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"error") ) { _hx_set_error(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"verbose") ) { verbose=inValue.Cast< bool >(); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"agalcode") ) { _hx_set_agalcode(HX_CTX_GET,inValue.Cast<  ::openfl::utils::ByteArrayData >()); return inValue; }
		break;
	case 12:
