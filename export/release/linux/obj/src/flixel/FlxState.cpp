...
void FlxState_obj::openSubState( ::flixel::FlxSubState SubState){
            	HX_GC_STACKFRAME(&_hx_pos_1b8de2909b3ba780_118_openSubState)
HXLINE( 119)		this->_requestSubStateReset = true;
HXLINE( 120)		this->_hx_set__requestedSubState(HX_CTX, SubState);
            	}
...
void FlxState_obj::resetSubState(){
            	HX_GC_STACKFRAME(&_hx_pos_1b8de2909b3ba780_135_resetSubState)
...
HXLINE( 149)		this->_hx_set_subState(HX_CTX, this->_requestedSubState);
HXLINE( 150)		this->_hx_set__requestedSubState(HX_CTX, null());
...
HXLINE( 158)			this->subState->_hx_set__parentState(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
...
HXDLIN( 176)			return null();
            	...
            	HX_GC_STACKFRAME(&_hx_pos_1b8de2909b3ba780_173_destroy)
HXLINE( 174)		this->_hx_set__constructor(HX_CTX, ::flixel::util::typeLimit::_NextState::NextState_Impl__obj::fromMaker( ::Dynamic(new _hx_Closure_0())));
...
HXLINE( 184)			this->_hx_set_subState(HX_CTX, null());
            		}
...
HXLINE( 268)			this->_hx_set__subStateOpened(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX ));
            		}
...
HXLINE( 277)			this->_hx_set__subStateClosed(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX ));
            		}
...
::hx::Val FlxState_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"subState") ) { _hx_set_subState(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSubState >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"_constructor") ) { _hx_set__constructor(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"persistentDraw") ) { persistentDraw=inValue.Cast< bool >(); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"_subStateOpened") ) { _hx_set__subStateOpened(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal1 >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_subStateClosed") ) { _hx_set__subStateClosed(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal1 >()); return inValue; }
		break;
	case 16:
		...
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"_requestedSubState") ) { _hx_set__requestedSubState(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSubState >()); return inValue; }
		break;
	case 21:
