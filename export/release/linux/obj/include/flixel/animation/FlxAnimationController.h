...
class HXCPP_CLASS_ATTRIBUTES FlxAnimationController_obj : public ::hx::Object
{
	...
	public:
		...
		int frameIndex;
		 ::Dynamic callback;
		inline  ::Dynamic _hx_set_callback(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return callback=_hx_v; }
		...
		inline  ::flixel::FlxSprite _hx_set__sprite(::hx::StackContext *_hx_ctx, ::flixel::FlxSprite _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _sprite=_hx_v; }
		 ::flixel::animation::FlxAnimation _curAnim;
		inline  ::flixel::animation::FlxAnimation _hx_set__curAnim(::hx::StackContext *_hx_ctx, ::flixel::animation::FlxAnimation _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _curAnim=_hx_v; }
		...
		inline  ::flixel::animation::FlxPrerotatedAnimation _hx_set__prerotated(::hx::StackContext *_hx_ctx, ::flixel::animation::FlxPrerotatedAnimation _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _prerotated=_hx_v; }
