...
class HXCPP_CLASS_ATTRIBUTES NativeWindow_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::lime::ui::MouseCursor _hx_set_cursor(::hx::StackContext *_hx_ctx, ::lime::ui::MouseCursor _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return cursor=_hx_v; }
		 ::lime::_hx_system::DisplayMode displayMode;
		inline  ::lime::_hx_system::DisplayMode _hx_set_displayMode(::hx::StackContext *_hx_ctx, ::lime::_hx_system::DisplayMode _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return displayMode=_hx_v; }
		Float frameRate;
		bool mouseLock;
		 ::lime::ui::Window parent;
		inline  ::lime::ui::Window _hx_set_parent(::hx::StackContext *_hx_ctx, ::lime::ui::Window _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return parent=_hx_v; }
		bool useHardware;
		 ::Dynamic cacheLock;
		inline  ::Dynamic _hx_set_cacheLock(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return cacheLock=_hx_v; }
		...
		inline  ::Dynamic _hx_set_primarySurface(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return primarySurface=_hx_v; }
