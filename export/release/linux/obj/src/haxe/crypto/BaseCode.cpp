...
void BaseCode_obj::__construct( ::haxe::io::Bytes base){
            	HX_GC_STACKFRAME(&_hx_pos_bcdbedb757785a37_33_new)
...
HXLINE(  40)		this->_hx_set_base(HX_CTX, base);
...
void BaseCode_obj::initTable(){
            	HX_GC_STACKFRAME(&_hx_pos_bcdbedb757785a37_72_initTable)
...
HXLINE(  78)		this->_hx_set_tbl(HX_CTX, tbl);
            	}
...
::hx::Val BaseCode_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"tbl") ) { _hx_set_tbl(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"base") ) { _hx_set_base(HX_CTX_GET,inValue.Cast<  ::haxe::io::Bytes >()); return inValue; }
		break;
	case 5:
