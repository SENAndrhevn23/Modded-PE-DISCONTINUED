...
class HXCPP_CLASS_ATTRIBUTES BlurAlphaShader_obj : public  ::openfl::filters::BitmapFilterShader_obj
{
	...
	public:
		...
		inline  ::openfl::display::ShaderParameter_Float _hx_set_uRadius(::hx::StackContext *_hx_ctx, ::openfl::display::ShaderParameter_Float _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return uRadius=_hx_v; }
		 ::openfl::display::ShaderParameter_Float uColor;
		inline  ::openfl::display::ShaderParameter_Float _hx_set_uColor(::hx::StackContext *_hx_ctx, ::openfl::display::ShaderParameter_Float _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return uColor=_hx_v; }
