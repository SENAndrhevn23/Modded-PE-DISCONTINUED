...
HXLINE(1079)			callback(state);
            	...
            	HX_GC_STACKFRAME(&_hx_pos_e4cf93b2067da49e_1076_add)
HXLINE(1077)		 ::Dynamic callCallback =  ::Dynamic(new _hx_Closure_0(callback));
HXLINE(1085)		this1->_hx_set__hx___doWork(HX_CTX, callCallback);
            	}
...
void PseudoEvent_Impl__obj::remove( ::lime::_hx_system::ThreadPool this1, ::Dynamic callback){
            	HX_GC_STACKFRAME(&_hx_pos_e4cf93b2067da49e_1100_remove)
HXDLIN(1100)		this1->_hx_set__hx___doWork(HX_CTX, null());
            	}
...
void PseudoEvent_Impl__obj::removeAll( ::lime::_hx_system::ThreadPool this1){
            	HX_GC_STACKFRAME(&_hx_pos_e4cf93b2067da49e_1105_removeAll)
HXDLIN(1105)		this1->_hx_set__hx___doWork(HX_CTX, null());
            	}
