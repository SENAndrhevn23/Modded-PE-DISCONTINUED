...
void Rating_obj::__construct(::String name){
            	HX_GC_STACKFRAME(&_hx_pos_187affb19d616a87_5_new)
HXLINE(  13)		this->hits = ((Float)0);
HXLINE(  12)		this->noteSplash = true;
HXLINE(  11)		this->score = 350;
HXLINE(  10)		this->ratingMod = ((Float)1);
HXLINE(   9)		this->_hx_set_hitWindow(HX_CTX, 0);
HXLINE(   8)		this->_hx_set_image(HX_CTX, HX_("",00,00,00,00));
HXLINE(   7)		this->_hx_set_name(HX_CTX, HX_("",00,00,00,00));
HXLINE(  17)		this->_hx_set_name(HX_CTX, name);
HXLINE(  18)		this->_hx_set_image(HX_CTX, name);
HXLINE(  19)		this->_hx_set_hitWindow(HX_CTX, 0);
HXLINE(  21)		::String window = (name + HX_("Window",10,08,21,87));
HXLINE(  22)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE(  24)			this->_hx_set_hitWindow(HX_CTX, ::Reflect_obj::field(::backend::ClientPrefs_obj::data,window));
            		} catch( ::Dynamic _hx_e) {
...
::hx::Val Rating_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		if (HX_FIELD_EQ(inName,"hits") ) { hits=inValue.Cast< Float >(); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"image") ) { _hx_set_image(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"score") ) { score=inValue.Cast< int >(); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"hitWindow") ) { _hx_set_hitWindow(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
...
static ::hx::StorageInfo Rating_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsFloat,(int)offsetof(Rating_obj,hits),HX_("hits",c0,42,0e,45)},
	{ ::hx::fsUnknown, 0, null()}
};
