...
class HXCPP_CLASS_ATTRIBUTES FlxGamepadAnalogList_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::flixel::input::gamepad::lists::FlxGamepadAnalogValueList _hx_set_value(::hx::StackContext *_hx_ctx, ::flixel::input::gamepad::lists::FlxGamepadAnalogValueList _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return value=_hx_v; }
		 ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList justMoved;
		inline  ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList _hx_set_justMoved(::hx::StackContext *_hx_ctx, ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return justMoved=_hx_v; }
		 ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList justReleased;
		inline  ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList _hx_set_justReleased(::hx::StackContext *_hx_ctx, ::flixel::input::gamepad::lists::FlxGamepadAnalogStateList _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return justReleased=_hx_v; }
};
