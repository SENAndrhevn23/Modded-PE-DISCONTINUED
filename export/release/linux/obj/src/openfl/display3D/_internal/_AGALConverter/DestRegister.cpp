...
HXLINE( 557)		dr->_hx_set_programType(HX_CTX, programType);
...
::hx::Val DestRegister_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"programType") ) { _hx_set_programType(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::_internal::_AGALConverter::ProgramType >()); return inValue; }
	}
