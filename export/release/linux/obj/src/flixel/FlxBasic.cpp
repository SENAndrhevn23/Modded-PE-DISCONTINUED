...
void FlxBasic_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_a86a375242b5e1cf_86_destroy)
HXLINE(  87)		this->set_exists(false);
HXLINE(  88)		this->_hx_set__cameras(HX_CTX, null());
            	}
...
::String FlxBasic_obj::toString(){
            	HX_GC_STACKFRAME(&_hx_pos_a86a375242b5e1cf_137_toString)
...
HXDLIN( 138)		_this->_hx_set_label(HX_CTX, HX_("active",c6,41,46,16));
HXDLIN( 138)		_this->_hx_set_value(HX_CTX, value);
...
HXDLIN( 139)		_this1->_hx_set_label(HX_CTX, HX_("visible",72,78,24,a3));
HXDLIN( 139)		_this1->_hx_set_value(HX_CTX, value1);
...
HXDLIN( 140)		_this2->_hx_set_label(HX_CTX, HX_("alive",cd,63,91,21));
HXDLIN( 140)		_this2->_hx_set_value(HX_CTX, value2);
...
HXDLIN( 141)		_this3->_hx_set_label(HX_CTX, HX_("exists",dc,1d,e0,bf));
HXDLIN( 141)		_this3->_hx_set_value(HX_CTX, value3);
...
HX_DEFINE_DYNAMIC_FUNC0(FlxBasic_obj,get_camera,return )
 ...
 ::flixel::FlxCamera FlxBasic_obj::set_camera( ::flixel::FlxCamera Value){
            	HX_GC_STACKFRAME(&_hx_pos_a86a375242b5e1cf_177_set_camera)
HXLINE( 178)		if (::hx::IsNull( this->_cameras )) {
HXLINE( 179)			this->_hx_set__cameras(HX_CTX, ::Array_obj< ::Dynamic>::__new(1)->init(0,Value));
            		}
            		else {
HXLINE( 181)			this->_cameras->setCtx( HX_CTX, 0,Value);
            		}
...
::Array< ::Dynamic> FlxBasic_obj::set_cameras(::Array< ::Dynamic> Value){
            	HX_GC_STACKFRAME(&_hx_pos_a86a375242b5e1cf_194_set_cameras)
HXDLIN( 194)		return (this->_hx_set__cameras(HX_CTX, Value));
            	}
...
::hx::Val FlxBasic_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"_cameras") ) { _hx_set__cameras(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 10:
...
static ::hx::StorageInfo FlxBasic_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsInt,(int)offsetof(FlxBasic_obj,zIndex),HX_("zIndex",38,10,cc,18)},
	{ ::hx::fsUnknown, 0, null()}
};
