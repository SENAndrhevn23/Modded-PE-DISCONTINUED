...
void FlxSignal2_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_892e156e4ad61ed9_237_new)
HXLINE( 238)		super::__construct();
HXLINE( 239)		this->_hx_set_dispatch(HX_CTX, this->dispatch2_dyn());
            	}
...
void FlxSignal2_obj::dispatch2( ::Dynamic value1, ::Dynamic value2){
            	HX_GC_STACKFRAME(&_hx_pos_892e156e4ad61ed9_293_dispatch2)
...
HXLINE( 310)			this->_hx_set_pendingRemove(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
            		}
            	}
