...
class HXCPP_CLASS_ATTRIBUTES ShapeCache_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::haxe::ds::StringMap _hx_set__hx___shortWordMap(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___shortWordMap=_hx_v; }
		 ::haxe::ds::StringMap _hx___longWordMap;
		inline  ::haxe::ds::StringMap _hx_set__hx___longWordMap(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___longWordMap=_hx_v; }
