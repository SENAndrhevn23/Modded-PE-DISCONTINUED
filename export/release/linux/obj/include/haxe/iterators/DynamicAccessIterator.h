...
class HXCPP_CLASS_ATTRIBUTES DynamicAccessIterator_obj : public ::hx::Object
{
	...
	public:
		...
		::String __ToString() const { return HX_("DynamicAccessIterator",71,c3,e1,09); }
		 ...
		 ::Dynamic access;
		inline  ::Dynamic _hx_set_access(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return access=_hx_v; }
		::Array< ::String > keys;
		inline ::Array< ::String > _hx_set_keys(::hx::StackContext *_hx_ctx,::Array< ::String > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return keys=_hx_v; }
		int index;
		bool hasNext();
		::Dynamic hasNext_dyn();
