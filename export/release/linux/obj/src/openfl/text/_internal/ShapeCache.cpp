...
HXLINE(  20)		this->_hx_set__hx___shortWordMap(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  21)		this->_hx_set__hx___longWordMap(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
            	}
...
::hx::Val ShapeCache_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 13:
		if (HX_FIELD_EQ(inName,"__longWordMap") ) { _hx_set__hx___longWordMap(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"__shortWordMap") ) { _hx_set__hx___shortWordMap(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
	}
