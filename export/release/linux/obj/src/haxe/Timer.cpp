...
HX_LOCAL_STACK_FRAME(_hx_pos_102f69689d37b2bb_278___check,"haxe.Timer","__check",0xb5623597,"haxe.Timer.__check","haxe/Timer.hx",278,0x1a690682)
...
HXDLIN( 273)		this->mRunning = false;
            	}
...
void Timer_obj::_hx___check(Float inTime){
            	HX_STACKFRAME(&_hx_pos_102f69689d37b2bb_278___check)
HXDLIN( 278)		if ((inTime >= this->mFireAt)) {
HXLINE( 280)			 ::haxe::Timer _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 280)			_hx_tmp->mFireAt = (_hx_tmp->mFireAt + this->mTime);
HXLINE( 281)			this->run();
            		}
            	}
...
HXLINE( 241)		t->_hx_set_run(HX_CTX,  ::Dynamic(new _hx_Closure_0(f,t)));
HXLINE( 247)		return t;
            	}
