...
HX_DEFINE_STACK_FRAME(_hx_pos_a21879e7650910f2_717_new,"lime._internal.backend.native.DropEventInfo","new",0x21a63a99,"lime._internal.backend.native.DropEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",717,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_a21879e7650910f2_724_clone,"lime._internal.backend.native.DropEventInfo","clone",0x32cf3dd6,"lime._internal.backend.native.DropEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",724,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void DropEventInfo_obj::__construct( ::Dynamic type,::String file){
            	HX_GC_STACKFRAME(&_hx_pos_a21879e7650910f2_717_new)
HXLINE( 718)		this->type = ( (int)(type) );
HXLINE( 719)		this->_hx_set_file(HX_CTX, file);
            	}
...
bool DropEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::DropEventInfo DropEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_a21879e7650910f2_724_clone)
HXDLIN( 724)		return  ::lime::_internal::backend::native::DropEventInfo_obj::__alloc( HX_CTX ,this->type,this->file);
            	}
