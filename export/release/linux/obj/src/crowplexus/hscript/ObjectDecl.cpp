...
HX_DEFINE_STACK_FRAME(_hx_pos_19835fc9225b7516_109_new,"crowplexus.hscript.ObjectDecl","new",0x1ff336c0,"crowplexus.hscript.ObjectDecl.new","crowplexus/hscript/Expr.hx",109,0x8be9fac2)
HX_LOCAL_STACK_FRAME(_hx_pos_19835fc9225b7516_114_toString,"crowplexus.hscript.ObjectDecl","toString",0xe1804e4c,"crowplexus.hscript.ObjectDecl.toString","crowplexus/hscript/Expr.hx",114,0x8be9fac2)
namespace crowplexus{
namespace hscript{

void ObjectDecl_obj::__construct(::String name, ::crowplexus::hscript::Expr e){
            	HX_GC_STACKFRAME(&_hx_pos_19835fc9225b7516_109_new)
HXDLIN( 109)		this->_hx_set_name(HX_CTX, name);
HXDLIN( 109)		this->_hx_set_e(HX_CTX, e);
            	}
...
::String ObjectDecl_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_19835fc9225b7516_114_toString)
HXDLIN( 114)		return ::Std_obj::string( ::Dynamic(::hx::Anon_obj::Create(2)
...
::hx::Val ObjectDecl_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
		if (HX_FIELD_EQ(inName,"e") ) { _hx_set_e(HX_CTX_GET,inValue.Cast<  ::crowplexus::hscript::Expr >()); return inValue; }
		break;
	case 4:
