...
void PS4Mapping_obj::initValues(){
            	HX_GC_STACKFRAME(&_hx_pos_e4c9bfb09cde4791_20_initValues)
HXLINE(  21)		this->_hx_set_leftStick(HX_CTX, ::flixel::input::gamepad::id::PS4ID_obj::LEFT_ANALOG_STICK);
HXLINE(  22)		this->_hx_set_rightStick(HX_CTX, ::flixel::input::gamepad::id::PS4ID_obj::RIGHT_ANALOG_STICK);
