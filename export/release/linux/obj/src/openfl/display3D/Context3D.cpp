...
HXLINE( 233)		this->_hx_set_profile(HX_CTX, 3);
HXLINE( 194)		this->_hx_set_driverInfo(HX_CTX, HX_("OpenGL (Direct blitting)",e6,33,c8,a6));
HXLINE( 173)		this->backBufferWidth = 0;
HXLINE( 163)		this->backBufferHeight = 0;
HXLINE( 287)		super::__construct(null());
HXLINE( 289)		this->_hx_set__hx___stage(HX_CTX, stage);
HXLINE( 290)		this->_hx_set__hx___contextState(HX_CTX, contextState);
HXLINE( 291)		this->_hx_set__hx___stage3D(HX_CTX, stage3D);
HXLINE( 293)		this->_hx_set__hx___context(HX_CTX, stage->window->context);
HXLINE( 297)		this->_hx_set_gl(HX_CTX, this->_hx___context->webgl);
HXLINE( 300)		if (::hx::IsNull( this->_hx___contextState )) {
HXLINE( 300)			this->_hx_set__hx___contextState(HX_CTX,  ::openfl::display3D::_internal::Context3DState_obj::__alloc( HX_CTX ));
            		}
HXLINE( 301)		this->_hx_set__hx___state(HX_CTX,  ::openfl::display3D::_internal::Context3DState_obj::__alloc( HX_CTX ));
...
HXDLIN( 304)		this->_hx_set__hx___vertexConstants(HX_CTX,  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,512,8));
...
HXDLIN( 305)		this->_hx_set__hx___fragmentConstants(HX_CTX,  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,512,8));
...
HXDLIN( 306)				_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN( 306)					_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN( 306)							_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN( 306)							_this3->_hx_set_buffer(HX_CTX, buffer2);
...
HXDLIN( 306)		this->_hx_set__hx___positionScale(HX_CTX, this1);
HXLINE( 308)		this->_hx_set__hx___programs(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
...
HXLINE( 399)		this->_hx_set_driverInfo(HX_CTX, ::openfl::display3D::Context3D_obj::_hx___driverInfo);
...
HXDLIN( 405)				_this4->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this4->byteLength));
...
HXDLIN( 405)					_this5->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this5->byteLength));
...
HXDLIN( 405)							_this6->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength1));
...
HXDLIN( 405)							_this7->_hx_set_buffer(HX_CTX, buffer3);
...
HXLINE( 423)		this->_hx_set__hx___quadIndexBuffer(HX_CTX, this->createIndexBuffer(this->_hx___quadIndexBufferCount,null()));
...
HXLINE( 607)				this->_hx_set__hx___backBufferTexture(HX_CTX, this->createRectangleTexture(width,height,1,true));
HXLINE( 608)				this->_hx_set__hx___frontBufferTexture(HX_CTX, this->createRectangleTexture(width,height,1,true));
HXLINE( 610)				if (::hx::IsNull( this->_hx___stage3D->_hx___vertexBuffer )) {
HXLINE( 612)					this->_hx___stage3D->_hx_set__hx___vertexBuffer(HX_CTX, this->createVertexBuffer(4,5,null()));
            				}
...
HXLINE( 630)					this->_hx___stage3D->_hx_set__hx___indexBuffer(HX_CTX, this->createIndexBuffer(6,null()));
...
HXLINE( 645)			this->_hx___state->_hx_set__hx___primaryGLFramebuffer(HX_CTX, this->_hx___backBufferTexture->_hx___getGLFramebuffer(enableDepthAndStencil,antiAlias,0));
...
void Context3D_obj::dispose(::hx::Null< bool >  __o_recreate){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1023_dispose)
HXLINE(1026)		this->_hx_set_gl(HX_CTX, null());
...
HXDLIN(1100)						_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN(1100)							_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN(1100)									_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN(1100)									_this3->_hx_set_buffer(HX_CTX, buffer);
...
void Context3D_obj::present(){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1242_present)
...
HXLINE(1255)			this->_hx_set__hx___backBufferTexture(HX_CTX, this->_hx___frontBufferTexture);
HXLINE(1256)			this->_hx_set__hx___frontBufferTexture(HX_CTX, cacheBuffer);
HXLINE(1258)			this->_hx___state->_hx_set__hx___primaryGLFramebuffer(HX_CTX, this->_hx___backBufferTexture->_hx___getGLFramebuffer(this->_hx___state->backBufferEnableDepthAndStencil,this->_hx___backBufferAntiAlias,0));
...
void Context3D_obj::setBlendFactorsSeparate( ::Dynamic sourceRGBFactor, ::Dynamic destinationRGBFactor, ::Dynamic sourceAlphaFactor, ::Dynamic destinationAlphaFactor){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1305_setBlendFactorsSeparate)
HXLINE(1306)		this->_hx___state->_hx_set_blendSourceRGBFactor(HX_CTX, sourceRGBFactor);
HXLINE(1307)		this->_hx___state->_hx_set_blendDestinationRGBFactor(HX_CTX, destinationRGBFactor);
HXLINE(1308)		this->_hx___state->_hx_set_blendSourceAlphaFactor(HX_CTX, sourceAlphaFactor);
HXLINE(1309)		this->_hx___state->_hx_set_blendDestinationAlphaFactor(HX_CTX, destinationAlphaFactor);
...
void Context3D_obj::setCulling( ::Dynamic triangleFaceToCull){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1352_setCulling)
HXDLIN(1352)		this->_hx___state->_hx_set_culling(HX_CTX, triangleFaceToCull);
            	}
...
void Context3D_obj::setDepthTest(bool depthMask, ::Dynamic passCompareMode){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1376_setDepthTest)
HXLINE(1377)		this->_hx___state->depthMask = depthMask;
HXLINE(1378)		this->_hx___state->_hx_set_depthCompareMode(HX_CTX, passCompareMode);
            	}
...
void Context3D_obj::setProgram( ::openfl::display3D::Program3D program){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1388_setProgram)
HXLINE(1389)		this->_hx___state->_hx_set_program(HX_CTX, program);
HXLINE(1390)		this->_hx___state->_hx_set_shader(HX_CTX, null());
...
HXLINE(1398)					this->_hx___state->samplerStates->setCtx( HX_CTX, i,program->_hx___samplerStates->__get(i).StaticCast<  ::openfl::display::_internal::SamplerState >()->clone());
            				}
            				else {
...
HXDLIN(1448)					_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN(1448)						_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN(1448)								_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN(1448)								_this3->_hx_set_buffer(HX_CTX, bytes);
...
void Context3D_obj::setRenderToBackBuffer(){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1626_setRenderToBackBuffer)
HXDLIN(1626)		this->_hx___state->_hx_set_renderToTexture(HX_CTX, null());
            	}
...
void Context3D_obj::setRenderToTexture( ::openfl::display3D::textures::TextureBase texture,::hx::Null< bool >  __o_enableDepthAndStencil,::hx::Null< int >  __o_antiAlias,::hx::Null< int >  __o_surfaceSelector){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1666_setRenderToTexture)
HXLINE(1667)		this->_hx___state->_hx_set_renderToTexture(HX_CTX, texture);
...
HXLINE(1703)			this->_hx___state->samplerStates->setCtx( HX_CTX, sampler, ::openfl::display::_internal::SamplerState_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null()));
            		}
...
HXLINE(1707)		state->_hx_set_wrap(HX_CTX, wrap);
HXLINE(1708)		state->_hx_set_filter(HX_CTX, filter);
HXLINE(1709)		state->_hx_set_mipfilter(HX_CTX, mipfilter);
            	}
...
void Context3D_obj::setStencilActions( ::Dynamic __o_triangleFace, ::Dynamic __o_compareMode, ::Dynamic __o_actionOnBothPass, ::Dynamic __o_actionOnDepthFail, ::Dynamic __o_actionOnDepthPassStencilFail){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1784_setStencilActions)
HXLINE(1785)		this->_hx___state->_hx_set_stencilTriangleFace(HX_CTX, triangleFace);
HXLINE(1786)		this->_hx___state->_hx_set_stencilCompareMode(HX_CTX, compareMode);
HXLINE(1787)		this->_hx___state->_hx_set_stencilPass(HX_CTX, actionOnBothPass);
HXLINE(1788)		this->_hx___state->_hx_set_stencilDepthFail(HX_CTX, actionOnDepthFail);
HXLINE(1789)		this->_hx___state->_hx_set_stencilFail(HX_CTX, actionOnDepthPassStencilFail);
            	}
...
void Context3D_obj::setTextureAt(int sampler, ::openfl::display3D::textures::TextureBase texture){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1839_setTextureAt)
HXDLIN(1839)		this->_hx___state->textures->setCtx( HX_CTX, sampler,texture);
            	}
...
void Context3D_obj::_hx___bindGLArrayBuffer( ::lime::graphics::opengl::GLObject buffer){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1932___bindGLArrayBuffer)
...
HXLINE(1935)			this->_hx___contextState->_hx_set__hx___currentGLArrayBuffer(HX_CTX, buffer);
            		}
            	}
...
void Context3D_obj::_hx___bindGLElementArrayBuffer( ::lime::graphics::opengl::GLObject buffer){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1941___bindGLElementArrayBuffer)
...
HXLINE(1944)			this->_hx___contextState->_hx_set__hx___currentGLElementArrayBuffer(HX_CTX, buffer);
            		}
            	}
...
void Context3D_obj::_hx___bindGLFramebuffer( ::lime::graphics::opengl::GLObject framebuffer){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1950___bindGLFramebuffer)
...
HXLINE(1953)			this->_hx___contextState->_hx_set__hx___currentGLFramebuffer(HX_CTX, framebuffer);
            		}
            	}
...
void Context3D_obj::_hx___bindGLTexture2D( ::lime::graphics::opengl::GLObject texture){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1958___bindGLTexture2D)
HXLINE(1963)		this->gl->bindTexture(this->gl->TEXTURE_2D,texture);
HXLINE(1964)		this->_hx___contextState->_hx_set__hx___currentGLTexture2D(HX_CTX, texture);
            	}
...
void Context3D_obj::_hx___bindGLTextureCubeMap( ::lime::graphics::opengl::GLObject texture){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1970___bindGLTextureCubeMap)
HXLINE(1975)		this->gl->bindTexture(this->gl->TEXTURE_CUBE_MAP,texture);
HXLINE(1976)		this->_hx___contextState->_hx_set__hx___currentGLTextureCubeMap(HX_CTX, texture);
            	}
...
void Context3D_obj::_hx___dispose(){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_1982___dispose)
HXLINE(1983)		 ::openfl::display3D::Context3D _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(1983)		_hx_tmp->_hx_set_driverInfo(HX_CTX, (_hx_tmp->driverInfo + HX_(" (Disposed)",7c,80,28,51)));
HXLINE(1985)		if (::hx::IsNotNull( this->_hx___stage3D )) {
HXLINE(1987)			this->_hx___stage3D->_hx_set__hx___indexBuffer(HX_CTX, null());
HXLINE(1988)			this->_hx___stage3D->_hx_set__hx___vertexBuffer(HX_CTX, null());
HXLINE(1989)			this->_hx___stage3D->_hx_set_context3D(HX_CTX, null());
HXLINE(1990)			this->_hx_set__hx___stage3D(HX_CTX, null());
            		}
HXLINE(1993)		this->_hx_set__hx___backBufferTexture(HX_CTX, null());
HXLINE(1994)		this->_hx_set__hx___context(HX_CTX, null());
HXLINE(1995)		this->_hx_set__hx___renderStage3DProgram(HX_CTX, null());
HXLINE(1996)		this->_hx_set__hx___fragmentConstants(HX_CTX, null());
HXLINE(1997)		this->_hx_set__hx___frontBufferTexture(HX_CTX, null());
HXLINE(1998)		this->_hx_set__hx___positionScale(HX_CTX, null());
HXLINE(1999)		this->_hx___present = false;
HXLINE(2000)		this->_hx_set__hx___quadIndexBuffer(HX_CTX, null());
HXLINE(2001)		this->_hx_set__hx___stage(HX_CTX, null());
HXLINE(2002)		this->_hx_set__hx___vertexConstants(HX_CTX, null());
            	}
...
void Context3D_obj::_hx___flushGLBlend(){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_2050___flushGLBlend)
...
HXLINE(2068)			this->_hx___contextState->_hx_set_blendDestinationRGBFactor(HX_CTX, this->_hx___state->blendDestinationRGBFactor);
HXLINE(2069)			this->_hx___contextState->_hx_set_blendSourceRGBFactor(HX_CTX, this->_hx___state->blendSourceRGBFactor);
HXLINE(2070)			this->_hx___contextState->_hx_set_blendDestinationAlphaFactor(HX_CTX, this->_hx___state->blendDestinationAlphaFactor);
HXLINE(2071)			this->_hx___contextState->_hx_set_blendSourceAlphaFactor(HX_CTX, this->_hx___state->blendSourceAlphaFactor);
            		}
            	}
...
HXLINE(2116)			this->_hx___contextState->_hx_set_culling(HX_CTX, this->_hx___state->culling);
            		}
            	}
...
HXLINE(2152)				HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            			...
            			_hx_goto_50:;
HXLINE(2155)			this->_hx___contextState->_hx_set_depthCompareMode(HX_CTX, this->_hx___state->depthCompareMode);
            		}
            	}
...
HXLINE(2170)				this->_hx___contextState->_hx_set_renderToTexture(HX_CTX, this->_hx___state->renderToTexture);
...
HXLINE(2195)				this->_hx___contextState->_hx_set_renderToTexture(HX_CTX, null());
...
void Context3D_obj::_hx___flushGLProgram(){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_2207___flushGLProgram)
...
HXLINE(2225)			this->_hx___contextState->_hx_set_shader(HX_CTX, shader);
            		}
...
HXLINE(2240)			this->_hx___contextState->_hx_set_program(HX_CTX, program);
            		}
...
void Context3D_obj::_hx___flushGLStencil(){
            	HX_GC_STACKFRAME(&_hx_pos_15a405ef6f3df6a7_2297___flushGLStencil)
...
HXLINE(2305)			this->_hx___contextState->_hx_set_stencilTriangleFace(HX_CTX, this->_hx___state->stencilTriangleFace);
HXLINE(2306)			this->_hx___contextState->_hx_set_stencilPass(HX_CTX, this->_hx___state->stencilPass);
HXLINE(2307)			this->_hx___contextState->_hx_set_stencilDepthFail(HX_CTX, this->_hx___state->stencilDepthFail);
HXLINE(2308)			this->_hx___contextState->_hx_set_stencilFail(HX_CTX, this->_hx___state->stencilFail);
            		}
...
HXLINE(2323)			this->_hx___contextState->_hx_set_stencilCompareMode(HX_CTX, this->_hx___state->stencilCompareMode);
...
HXLINE(2340)					this->_hx___state->samplerStates->setCtx( HX_CTX, i, ::openfl::display::_internal::SamplerState_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null()));
...
HXLINE(2365)					this->_hx___contextState->textures->setCtx( HX_CTX, i,texture);
...
HXLINE(2565)				this->_hx_set__hx___renderStage3DProgram(HX_CTX, this->createProgram(null()));
...
::hx::Val Context3D_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 2:
		if (HX_FIELD_EQ(inName,"gl") ) { _hx_set_gl(HX_CTX_GET,inValue.Cast<  ::lime::_internal::backend::native::NativeOpenGLRenderContext >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"profile") ) { _hx_set_profile(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__stage") ) { _hx_set__hx___stage(HX_CTX_GET,inValue.Cast<  ::openfl::display::Stage >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__state") ) { _hx_set__hx___state(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::_internal::Context3DState >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"__cleared") ) { _hx___cleared=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__context") ) { _hx_set__hx___context(HX_CTX_GET,inValue.Cast<  ::lime::graphics::RenderContext >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__present") ) { _hx___present=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__stage3D") ) { _hx_set__hx___stage3D(HX_CTX_GET,inValue.Cast<  ::openfl::display::Stage3D >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"driverInfo") ) { _hx_set_driverInfo(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__programs") ) { _hx_set__hx___programs(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"__contextState") ) { _hx_set__hx___contextState(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::_internal::Context3DState >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"backBufferWidth") ) { backBufferWidth=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__positionScale") ) { _hx_set__hx___positionScale(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"backBufferHeight") ) { backBufferHeight=inValue.Cast< int >(); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"__quadIndexBuffer") ) { _hx_set__hx___quadIndexBuffer(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::IndexBuffer3D >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__vertexConstants") ) { _hx_set__hx___vertexConstants(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
		break;
	case 18:
	...
	case 19:
		...
		if (HX_FIELD_EQ(inName,"__backBufferTexture") ) { _hx_set__hx___backBufferTexture(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::textures::RectangleTexture >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__fragmentConstants") ) { _hx_set__hx___fragmentConstants(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"__frontBufferTexture") ) { _hx_set__hx___frontBufferTexture(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::textures::RectangleTexture >()); return inValue; }
		break;
	case 21:
		...
		break;
	case 22:
		if (HX_FIELD_EQ(inName,"__renderStage3DProgram") ) { _hx_set__hx___renderStage3DProgram(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::Program3D >()); return inValue; }
