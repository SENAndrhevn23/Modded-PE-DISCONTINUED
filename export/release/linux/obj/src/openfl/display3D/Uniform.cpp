...
HXLINE( 950)		this->_hx_set_context(HX_CTX, context);
HXLINE( 952)		this->isDirty = true;
HXLINE( 955)		 ::haxe::io::Bytes bytes = null();
HXDLIN( 955)		this->_hx_set_regDataPointer(HX_CTX,  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,bytes,0));
            	}
...
::hx::Val Uniform_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"regData") ) { _hx_set_regData(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
	...
	case 8:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"regDataPointer") ) { _hx_set_regDataPointer(HX_CTX_GET,inValue.Cast<  ::lime::utils::BytePointerData >()); return inValue; }
	}
