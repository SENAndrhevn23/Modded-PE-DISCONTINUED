...
HXLINE( 110)		this->_hx_set__hx___context3D(HX_CTX, context);
HXLINE( 111)		this->_hx_set__hx___context(HX_CTX, context->_hx___context);
HXLINE( 113)		this->_hx_set_gl(HX_CTX, context->_hx___context->webgl);
HXLINE( 114)		this->_hx_set__hx___gl(HX_CTX, this->gl);
HXLINE( 116)		this->_hx_set__hx___defaultRenderTarget(HX_CTX, defaultRenderTarget);
...
HXLINE( 125)		this->_hx_set__hx___matrix(HX_CTX, ::lime::math::_Matrix4::Matrix4_Impl__obj::_new(null()));
HXLINE( 128)		this->_hx_set__hx___values(HX_CTX, ::Array_obj< Float >::__new());
HXLINE( 142)		this->_hx_set__hx___softwareRenderer(HX_CTX,  ::openfl::display::CairoRenderer_obj::__alloc( HX_CTX ,null()));
HXLINE( 146)		this->_hx_set__hx___type(HX_CTX, HX_("opengl",6f,64,94,21));
HXLINE( 149)		this->_hx___setBlendMode(10);
HXLINE( 150)		this->_hx___context3D->_hx___setGLBlend(true);
HXLINE( 152)		this->_hx_set__hx___clipRects(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE( 153)		this->_hx_set__hx___maskObjects(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE( 154)		this->_hx___numClipRects = 0;
HXLINE( 156)		this->_hx_set__hx___projection(HX_CTX, ::lime::math::_Matrix4::Matrix4_Impl__obj::_new(null()));
HXLINE( 157)		this->_hx_set__hx___projectionFlipped(HX_CTX, ::lime::math::_Matrix4::Matrix4_Impl__obj::_new(null()));
HXLINE( 159)		this->_hx___stencilReference = 0;
HXLINE( 160)		this->_hx_set__hx___tempRect(HX_CTX,  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
HXLINE( 162)		this->_hx_set__hx___defaultDisplayShader(HX_CTX,  ::openfl::display::DisplayObjectShader_obj::__alloc( HX_CTX ,null()));
HXLINE( 163)		this->_hx_set__hx___defaultGraphicsShader(HX_CTX,  ::openfl::display::GraphicsShader_obj::__alloc( HX_CTX ,null()));
HXLINE( 164)		this->_hx_set__hx___defaultShader(HX_CTX, this->_hx___defaultDisplayShader);
HXLINE( 166)		this->_hx___initShader(this->_hx___defaultShader);
HXLINE( 168)		this->_hx_set__hx___scrollRectMasks(HX_CTX,  ::lime::utils::ObjectPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()),null(),null()));
HXLINE( 169)		this->_hx_set__hx___maskShader(HX_CTX,  ::openfl::display::_internal::Context3DMaskShader_obj::__alloc( HX_CTX ));
            	}
...
void OpenGLRenderer_obj::applyAlpha(Float alpha){
            	HX_GC_STACKFRAME(&_hx_pos_2f59d7e567bca573_176_applyAlpha)
...
HXLINE( 185)					this->_hx___currentShader->_hx___alpha->_hx_set_value(HX_CTX, ::openfl::display::OpenGLRenderer_obj::_hx___alphaValue);
            				}
            			}
            		}
            	}
...
void OpenGLRenderer_obj::applyBitmapData( ::openfl::display::BitmapData bitmapData,bool smooth,::hx::Null< bool >  __o_repeat){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_2f59d7e567bca573_195_applyBitmapData)
...
HXLINE( 209)					this->_hx___currentShader->_hx___bitmap->_hx_set_input(HX_CTX, bitmapData);
...
HXDLIN( 210)					this->_hx___currentShader->_hx___bitmap->_hx_set_filter(HX_CTX, _hx_tmp);
HXLINE( 211)					this->_hx___currentShader->_hx___bitmap->_hx_set_mipFilter(HX_CTX, 2);
...
HXDLIN( 212)					this->_hx___currentShader->_hx___bitmap->_hx_set_wrap(HX_CTX, _hx_tmp2);
            				}
HXLINE( 215)				if (::hx::IsNotNull( this->_hx___currentShader->_hx___texture )) {
HXLINE( 217)					this->_hx___currentShader->_hx___texture->_hx_set_input(HX_CTX, bitmapData);
...
HXDLIN( 218)					this->_hx___currentShader->_hx___texture->_hx_set_filter(HX_CTX, _hx_tmp3);
HXLINE( 219)					this->_hx___currentShader->_hx___texture->_hx_set_mipFilter(HX_CTX, 2);
...
HXDLIN( 220)					this->_hx___currentShader->_hx___texture->_hx_set_wrap(HX_CTX, _hx_tmp5);
            				}
...
HXLINE( 230)						this->_hx___currentShader->_hx___textureSize->_hx_set_value(HX_CTX, ::openfl::display::OpenGLRenderer_obj::_hx___textureSizeValue);
            					}
            					else {
HXLINE( 234)						this->_hx___currentShader->_hx___textureSize->_hx_set_value(HX_CTX, null());
            					}
            				}
            			}
            		}
...
void OpenGLRenderer_obj::applyColorTransform( ::openfl::geom::ColorTransform colorTransform){
            	HX_GC_STACKFRAME(&_hx_pos_2f59d7e567bca573_245_applyColorTransform)
...
HXLINE( 260)						this->_hx___currentShader->_hx___colorMultiplier->_hx_set_value(HX_CTX, ::openfl::display::OpenGLRenderer_obj::_hx___colorMultipliersValue);
            					}
HXLINE( 261)					if (::hx::IsNotNull( this->_hx___currentShader->_hx___colorOffset )) {
HXLINE( 261)						this->_hx___currentShader->_hx___colorOffset->_hx_set_value(HX_CTX, ::openfl::display::OpenGLRenderer_obj::_hx___colorOffsetsValue);
            					}
            				}
            			}
            		}
...
HXLINE( 273)						this->_hx___currentShader->_hx___colorMultiplier->_hx_set_value(HX_CTX, ::openfl::display::OpenGLRenderer_obj::_hx___emptyColorValue);
            					}
HXLINE( 274)					if (::hx::IsNotNull( this->_hx___currentShader->_hx___colorOffset )) {
HXLINE( 274)						this->_hx___currentShader->_hx___colorOffset->_hx_set_value(HX_CTX, ::openfl::display::OpenGLRenderer_obj::_hx___emptyColorValue);
            					}
            				}
            			}
            		}
...
void OpenGLRenderer_obj::applyHasColorTransform(bool enabled){
            	HX_GC_STACKFRAME(&_hx_pos_2f59d7e567bca573_284_applyHasColorTransform)
...
HXLINE( 293)					this->_hx___currentShader->_hx___hasColorTransform->_hx_set_value(HX_CTX, ::openfl::display::OpenGLRenderer_obj::_hx___hasColorTransformValue);
            				}
            			}
            		}
            	}
...
void OpenGLRenderer_obj::applyMatrix(::Array< Float > matrix){
            	HX_GC_STACKFRAME(&_hx_pos_2f59d7e567bca573_302_applyMatrix)
...
HXLINE( 308)					this->_hx___currentShader->_hx___matrix->_hx_set_value(HX_CTX, matrix);
            				}
            			}
            		}
            	}
...
void OpenGLRenderer_obj::setShader( ::openfl::display::Shader shader){
            	HX_GC_STACKFRAME(&_hx_pos_2f59d7e567bca573_350_setShader)
HXLINE( 351)		this->_hx_set__hx___currentShaderBuffer(HX_CTX, null());
...
HXLINE( 363)			this->_hx_set__hx___currentShader(HX_CTX, null());
HXLINE( 364)			this->_hx___context3D->setProgram(null());
HXLINE( 366)			return;
            		}
            		else {
HXLINE( 370)			this->_hx_set__hx___currentShader(HX_CTX, shader);
...
HXLINE( 376)			this->_hx___context3D->_hx___state->_hx_set_shader(HX_CTX, shader);
            		}
            	}
...
void OpenGLRenderer_obj::_hx___clearShader(){
            	HX_GC_STACKFRAME(&_hx_pos_2f59d7e567bca573_463___clearShader)
...
HXLINE( 467)					this->_hx___currentShader->_hx___bitmap->_hx_set_input(HX_CTX, null());
            				}
            			}
            			else {
...
HXLINE( 474)				this->_hx___currentShader->_hx___texture->_hx_set_input(HX_CTX, null());
            			}
HXLINE( 475)			if (::hx::IsNotNull( this->_hx___currentShader->_hx___textureSize )) {
HXLINE( 475)				this->_hx___currentShader->_hx___textureSize->_hx_set_value(HX_CTX, null());
            			}
HXLINE( 476)			if (::hx::IsNotNull( this->_hx___currentShader->_hx___hasColorTransform )) {
HXLINE( 476)				this->_hx___currentShader->_hx___hasColorTransform->_hx_set_value(HX_CTX, null());
            			}
HXLINE( 477)			if (::hx::IsNotNull( this->_hx___currentShader->_hx___position )) {
HXLINE( 477)				this->_hx___currentShader->_hx___position->_hx_set_value(HX_CTX, null());
            			}
HXLINE( 478)			if (::hx::IsNotNull( this->_hx___currentShader->_hx___matrix )) {
HXLINE( 478)				this->_hx___currentShader->_hx___matrix->_hx_set_value(HX_CTX, null());
            			}
...
void OpenGLRenderer_obj::_hx___copyShader( ::openfl::display::OpenGLRenderer other){
            	HX_GC_STACKFRAME(&_hx_pos_2f59d7e567bca573_484___copyShader)
HXLINE( 485)		this->_hx_set__hx___currentShader(HX_CTX, other->_hx___currentShader);
HXLINE( 486)		this->_hx_set__hx___currentShaderBuffer(HX_CTX, other->_hx___currentShaderBuffer);
HXLINE( 487)		this->_hx_set__hx___currentDisplayShader(HX_CTX, other->_hx___currentDisplayShader);
HXLINE( 488)		this->_hx_set__hx___currentGraphicsShader(HX_CTX, other->_hx___currentGraphicsShader);
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(OpenGLRenderer_obj,_hx___getMatrix,return )
 ...
 ::openfl::display::Shader OpenGLRenderer_obj::_hx___initShader( ::openfl::display::Shader shader){
            	HX_GC_STACKFRAME(&_hx_pos_2f59d7e567bca573_530___initShader)
HXLINE( 531)		if (::hx::IsNotNull( shader )) {
HXLINE( 535)			if (::hx::IsNull( shader->_hx___context )) {
HXLINE( 537)				shader->_hx_set__hx___context(HX_CTX, this->_hx___context3D);
...
HX_DEFINE_DYNAMIC_FUNC1(OpenGLRenderer_obj,_hx___initShader,return )
 ...
 ::openfl::display::Shader OpenGLRenderer_obj::_hx___initDisplayShader( ::openfl::display::Shader shader){
            	HX_GC_STACKFRAME(&_hx_pos_2f59d7e567bca573_549___initDisplayShader)
HXLINE( 550)		if (::hx::IsNotNull( shader )) {
HXLINE( 554)			if (::hx::IsNull( shader->_hx___context )) {
HXLINE( 556)				shader->_hx_set__hx___context(HX_CTX, this->_hx___context3D);
...
HX_DEFINE_DYNAMIC_FUNC1(OpenGLRenderer_obj,_hx___initDisplayShader,return )
 ...
 ::openfl::display::Shader OpenGLRenderer_obj::_hx___initGraphicsShader( ::openfl::display::Shader shader){
            	HX_GC_STACKFRAME(&_hx_pos_2f59d7e567bca573_568___initGraphicsShader)
HXLINE( 569)		if (::hx::IsNotNull( shader )) {
HXLINE( 573)			if (::hx::IsNull( shader->_hx___context )) {
HXLINE( 575)				shader->_hx_set__hx___context(HX_CTX, this->_hx___context3D);
...
HXLINE( 713)			this->_hx___clipRects->setCtx( HX_CTX, this->_hx___numClipRects, ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
            		}
...
void OpenGLRenderer_obj::_hx___render(::Dynamic object){
            	HX_GC_STACKFRAME(&_hx_pos_2f59d7e567bca573_746___render)
...
HXLINE( 754)		this->_hx_set__hx___blendMode(HX_CTX, null());
...
void OpenGLRenderer_obj::_hx___setBlendMode( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_2f59d7e567bca573_1008___setBlendMode)
...
HXLINE(1012)		this->_hx_set__hx___blendMode(HX_CTX, value);
...
void OpenGLRenderer_obj::_hx___setRenderTarget( ::openfl::display::BitmapData renderTarget){
            	HX_GC_STACKFRAME(&_hx_pos_2f59d7e567bca573_1045___setRenderTarget)
HXLINE(1046)		this->_hx_set__hx___defaultRenderTarget(HX_CTX, renderTarget);
...
void OpenGLRenderer_obj::_hx___setShaderBuffer( ::openfl::display::_internal::ShaderBuffer shaderBuffer){
            	HX_GC_STACKFRAME(&_hx_pos_2f59d7e567bca573_1056___setShaderBuffer)
HXLINE(1057)		this->setShader(shaderBuffer->shader);
HXLINE(1058)		this->_hx_set__hx___currentShaderBuffer(HX_CTX, shaderBuffer);
            	}
...
::hx::Val OpenGLRenderer_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 2:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"__gl") ) { _hx_set__hx___gl(HX_CTX_GET,inValue.Cast<  ::lime::_internal::backend::native::NativeOpenGLRenderContext >()); return inValue; }
		break;
	case 7:
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"__matrix") ) { _hx_set__hx___matrix(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__values") ) { _hx_set__hx___values(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
		break;
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"__tempRect") ) { _hx_set__hx___tempRect(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__upscaled") ) { _hx___upscaled=inValue.Cast< bool >(); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"__context3D") ) { _hx_set__hx___context3D(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::Context3D >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__clipRects") ) { _hx_set__hx___clipRects(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"__maskShader") ) { _hx_set__hx___maskShader(HX_CTX_GET,inValue.Cast<  ::openfl::display::_internal::Context3DMaskShader >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__projection") ) { _hx_set__hx___projection(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"__maskObjects") ) { _hx_set__hx___maskObjects(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 14:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"__currentShader") ) { _hx_set__hx___currentShader(HX_CTX_GET,inValue.Cast<  ::openfl::display::Shader >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__defaultShader") ) { _hx_set__hx___defaultShader(HX_CTX_GET,inValue.Cast<  ::openfl::display::Shader >()); return inValue; }
	...
	case 16:
		...
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"__scrollRectMasks") ) { _hx_set__hx___scrollRectMasks(HX_CTX_GET,inValue.Cast<  ::lime::utils::ObjectPool >()); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"__softwareRenderer") ) { _hx_set__hx___softwareRenderer(HX_CTX_GET,inValue.Cast<  ::openfl::display::DisplayObjectRenderer >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__stencilReference") ) { _hx___stencilReference=inValue.Cast< int >(); return inValue; }
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"__projectionFlipped") ) { _hx_set__hx___projectionFlipped(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
		break;
	case 21:
		if (HX_FIELD_EQ(inName,"__currentRenderTarget") ) { _hx_set__hx___currentRenderTarget(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__currentShaderBuffer") ) { _hx_set__hx___currentShaderBuffer(HX_CTX_GET,inValue.Cast<  ::openfl::display::_internal::ShaderBuffer >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__defaultRenderTarget") ) { _hx_set__hx___defaultRenderTarget(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
		break;
	case 22:
		if (HX_FIELD_EQ(inName,"__currentDisplayShader") ) { _hx_set__hx___currentDisplayShader(HX_CTX_GET,inValue.Cast<  ::openfl::display::Shader >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__defaultDisplayShader") ) { _hx_set__hx___defaultDisplayShader(HX_CTX_GET,inValue.Cast<  ::openfl::display::DisplayObjectShader >()); return inValue; }
		break;
	case 23:
		if (HX_FIELD_EQ(inName,"__currentGraphicsShader") ) { _hx_set__hx___currentGraphicsShader(HX_CTX_GET,inValue.Cast<  ::openfl::display::Shader >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__defaultGraphicsShader") ) { _hx_set__hx___defaultGraphicsShader(HX_CTX_GET,inValue.Cast<  ::openfl::display::GraphicsShader >()); return inValue; }
	}
