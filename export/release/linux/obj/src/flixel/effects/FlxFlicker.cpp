...
void FlxFlicker_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_605e85deecbe4d03_125_destroy)
HXLINE( 126)		this->_hx_set_object(HX_CTX, null());
HXLINE( 127)		this->_hx_set_timer(HX_CTX, null());
HXLINE( 128)		this->_hx_set_completionCallback(HX_CTX, null());
HXLINE( 129)		this->_hx_set_progressCallback(HX_CTX, null());
            	}
...
HXLINE( 138)		this->_hx_set_object(HX_CTX, Object);
HXLINE( 139)		this->duration = Duration;
HXLINE( 140)		this->interval = Interval;
HXLINE( 141)		this->_hx_set_completionCallback(HX_CTX, CompletionCallback);
HXLINE( 142)		this->_hx_set_progressCallback(HX_CTX, ProgressCallback);
...
HXDLIN( 144)		this->_hx_set_timer(HX_CTX, _hx_tmp->start(_hx_tmp1,this->flickerProgress_dyn(),::Std_obj::_hx_int((this->duration / this->interval))));
            	}
