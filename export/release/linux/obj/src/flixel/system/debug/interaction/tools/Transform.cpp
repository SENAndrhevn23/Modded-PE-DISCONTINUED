...
HXLINE(  68)		this->_hx_set__mouseCursor(HX_CTX,  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) )));
HXLINE(  67)		this->_hx_set__targetArea(HX_CTX,  ::flixel::math::FlxRect_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
HXLINE(  65)		this->_hx_set__markers(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  63)		this->_hx_set__actionScaleDirection(HX_CTX,  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) )));
HXLINE(  60)		this->_hx_set__actionStartPoint(HX_CTX,  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) )));
HXLINE(  58)		this->_hx_set__actionTargetStartScale(HX_CTX,  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) )));
...
HXLINE(  91)			_gthis->_hx_set__target(HX_CTX, null());
            		}
...
HXLINE(  74)		this->_hx_set__name(HX_CTX, HX_("Transform",4c,0d,66,e7));
...
HXLINE(  83)		this->_hx_set__tooltip(HX_CTX, ::flixel::_hx_system::debug::Tooltip_obj::add(null(),HX_("",00,00,00,00)));
...
HXLINE( 333)		this->_hx_set__target(HX_CTX, null());
...
HXLINE( 344)					this->_hx_set__target(HX_CTX, ( ( ::flixel::FlxSprite)(member1) ));
...
::hx::Val Transform_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"_target") ) { _hx_set__target(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSprite >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"_tooltip") ) { _hx_set__tooltip(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::debug::TooltipOverlay >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_markers") ) { _hx_set__markers(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"_targetArea") ) { _hx_set__targetArea(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxRect >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"_mouseCursor") ) { _hx_set__mouseCursor(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		break;
	case 13:
	...
	case 16:
		...
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"_actionStartPoint") ) { _hx_set__actionStartPoint(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		break;
	case 21:
		if (HX_FIELD_EQ(inName,"_actionScaleDirection") ) { _hx_set__actionScaleDirection(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		break;
	case 23:
		if (HX_FIELD_EQ(inName,"_actionTargetStartScale") ) { _hx_set__actionTargetStartScale(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
