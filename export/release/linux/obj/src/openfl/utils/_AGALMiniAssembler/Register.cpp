...
void Register_obj::__construct(::String name,::String longName,int emitCode,int range,int flags){
            	HX_GC_STACKFRAME(&_hx_pos_6ccc15e272cca89a_831_new)
HXLINE( 832)		this->_hx_set_name(HX_CTX, name);
HXLINE( 833)		this->_hx_set_longName(HX_CTX, longName);
...
::hx::Val Register_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"longName") ) { _hx_set_longName(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	}
