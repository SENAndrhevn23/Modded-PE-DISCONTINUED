...
HXLINE(  47)		this->_hx_set_parent(HX_CTX, parent);
HXLINE(  49)		this->_hx_set_position(HX_CTX,  ::lime::math::Vector4_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
            	}
...
void NativeAudioSource_obj::dispose(){
            	HX_GC_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_54_dispose)
...
HXLINE(  65)				this->_hx_set_buffers(HX_CTX, null());
            			}
HXLINE(  67)			this->_hx_set_handle(HX_CTX, null());
            		}
            	}
...
void NativeAudioSource_obj::init(){
            	HX_GC_STACKFRAME(&_hx_pos_a101d5e86f44bfa1_72_init)
...
HXLINE( 106)			this->_hx_set_buffers(HX_CTX, ::cpp::VirtualArray_obj::__new());
HXLINE( 107)			this->_hx_set_bufferTimeBlocks(HX_CTX, ::Array_obj< Float >::__new());
HXLINE( 109)			{
HXLINE( 109)				int _g = 0;
...
HXLINE( 115)			this->_hx_set_handle(HX_CTX, ::lime::media::openal::AL_obj::createSource());
            		}
            		else {
HXLINE( 119)			if (::hx::IsNull( this->parent->buffer->_hx___srcBuffer )) {
HXLINE( 121)				this->parent->buffer->_hx_set__hx___srcBuffer(HX_CTX, ::lime::media::openal::AL_obj::createBuffer());
...
HXLINE( 131)			this->_hx_set_handle(HX_CTX, ::lime::media::openal::AL_obj::createSource());
...
HXLINE( 183)			this->_hx_set_streamTimer(HX_CTX,  ::haxe::Timer_obj::__alloc( HX_CTX ,( (Float)(::lime::_internal::backend::native::NativeAudioSource_obj::STREAM_TIMER_FREQUENCY) )));
HXLINE( 184)			this->streamTimer->_hx_set_run(HX_CTX, this->streamTimer_onRun_dyn());
            		}
            		else {
HXLINE( 188)			int time;
...
HXLINE( 447)				this->_hx_set_timer(HX_CTX,  ::haxe::Timer_obj::__alloc( HX_CTX ,( (Float)(timeRemaining1) )));
HXLINE( 448)				this->timer->_hx_set_run(HX_CTX, this->timer_onRun_dyn());
            			}
            			else {
...
HXLINE( 505)				this->_hx_set_timer(HX_CTX,  ::haxe::Timer_obj::__alloc( HX_CTX ,( (Float)(timeRemaining1) )));
HXLINE( 506)				this->timer->_hx_set_run(HX_CTX, this->timer_onRun_dyn());
            			}
            		}
HXLINE( 510)		return ( (int)((this->_hx_set_length(HX_CTX, value))) );
            	}
...
HXLINE( 548)				this->_hx_set_timer(HX_CTX,  ::haxe::Timer_obj::__alloc( HX_CTX ,( (Float)(timeRemaining1) )));
HXLINE( 549)				this->timer->_hx_set_run(HX_CTX, this->timer_onRun_dyn());
            			}
            		}
...
::hx::Val NativeAudioSource_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"timer") ) { _hx_set_timer(HX_CTX_GET,inValue.Cast<  ::haxe::Timer >()); return inValue; }
		break;
	case 6:
		...
		if (HX_FIELD_EQ(inName,"length") ) { _hx_set_length(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"parent") ) { _hx_set_parent(HX_CTX_GET,inValue.Cast<  ::lime::media::AudioSource >()); return inValue; }
		if (HX_FIELD_EQ(inName,"stream") ) { stream=inValue.Cast< bool >(); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"buffers") ) { _hx_set_buffers(HX_CTX_GET,inValue.Cast< ::cpp::VirtualArray >()); return inValue; }
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"position") ) { _hx_set_position(HX_CTX_GET,inValue.Cast<  ::lime::math::Vector4 >()); return inValue; }
		break;
	case 9:
	...
	case 10:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"streamTimer") ) { _hx_set_streamTimer(HX_CTX_GET,inValue.Cast<  ::haxe::Timer >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"bufferTimeBlocks") ) { _hx_set_bufferTimeBlocks(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
	}
