...
HXLINE( 103)		this->_hx_set_description(HX_CTX, description);
HXLINE( 104)		this->_hx_set_extension(HX_CTX, extension);
HXLINE( 105)		this->_hx_set_macType(HX_CTX, macType);
            	}
...
::hx::Val FileFilter_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"macType") ) { _hx_set_macType(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 9:
