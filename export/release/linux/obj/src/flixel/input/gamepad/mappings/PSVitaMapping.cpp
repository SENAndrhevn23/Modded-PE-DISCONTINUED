...
void PSVitaMapping_obj::initValues(){
            	HX_GC_STACKFRAME(&_hx_pos_cea460118c4fe0d4_9_initValues)
HXLINE(  10)		this->_hx_set_leftStick(HX_CTX, ::flixel::input::gamepad::id::PSVitaID_obj::LEFT_ANALOG_STICK);
HXLINE(  11)		this->_hx_set_rightStick(HX_CTX, ::flixel::input::gamepad::id::PSVitaID_obj::RIGHT_ANALOG_STICK);
            	}
