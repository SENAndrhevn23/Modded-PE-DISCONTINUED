...
class HXCPP_CLASS_ATTRIBUTES Path_obj : public ::hx::Object
{
	...
	public:
		...
		::String dir;
		inline ::String _hx_set_dir(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return dir=_hx_v; }
		::String file;
		inline ::String _hx_set_file(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return file=_hx_v; }
		::String ext;
		inline ::String _hx_set_ext(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return ext=_hx_v; }
		bool backslash;
