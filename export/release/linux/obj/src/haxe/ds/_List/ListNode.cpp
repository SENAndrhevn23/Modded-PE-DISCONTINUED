...
HXLINE( 267)		this->_hx_set_item(HX_CTX, item);
HXLINE( 268)		this->_hx_set_next(HX_CTX, next);
            	}
...
::hx::Val ListNode_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"item") ) { _hx_set_item(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"next") ) { _hx_set_next(HX_CTX_GET,inValue.Cast<  ::haxe::ds::_List::ListNode >()); return inValue; }
	}
