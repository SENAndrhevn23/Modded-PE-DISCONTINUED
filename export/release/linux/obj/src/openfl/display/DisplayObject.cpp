...
HXLINE(1055)		this->_hx_set__hx___blendMode(HX_CTX, 10);
HXLINE(1056)		this->_hx___cacheAsBitmap = false;
HXLINE(1057)		this->_hx_set__hx___transform(HX_CTX,  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
...
HXLINE(1067)		this->_hx_set__hx___worldBlendMode(HX_CTX, 10);
HXLINE(1068)		this->_hx_set__hx___worldTransform(HX_CTX,  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
HXLINE(1069)		this->_hx_set__hx___worldColorTransform(HX_CTX,  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null()));
HXLINE(1070)		this->_hx_set__hx___renderTransform(HX_CTX,  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
...
HXLINE(1077)			this->_hx_set_stage(HX_CTX, ::openfl::display::DisplayObject_obj::_hx___initStage);
...
HXLINE(1105)				this->_hx_set__hx___customRenderEvent(HX_CTX,  ::openfl::events::RenderEvent_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
HXLINE(1106)				this->_hx___customRenderEvent->_hx_set_objectColorTransform(HX_CTX,  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null()));
HXLINE(1107)				this->_hx___customRenderEvent->_hx_set_objectMatrix(HX_CTX,  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
...
bool DisplayObject_obj::dispatchEvent( ::openfl::events::Event event){
            	HX_GC_STACKFRAME(&_hx_pos_26400284d5456c16_1118_dispatchEvent)
...
HXLINE(1132)		event->_hx_set_target(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
...
void DisplayObject_obj::removeEventListener(::String type, ::Dynamic listener,::hx::Null< bool >  __o_useCapture){
            		bool useCapture = __o_useCapture.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_26400284d5456c16_1329_removeEventListener)
...
HXLINE(1350)				this->_hx_set__hx___customRenderEvent(HX_CTX, null());
            			}
...
void DisplayObject_obj::_hx___cleanup(){
            	HX_GC_STACKFRAME(&_hx_pos_26400284d5456c16_1368___cleanup)
HXLINE(1369)		this->_hx_set__hx___cairo(HX_CTX, null());
...
HXLINE(1384)			this->_hx_set__hx___cacheBitmap(HX_CTX, null());
            		}
HXLINE(1387)		if (::hx::IsNotNull( this->_hx___cacheBitmapData )) {
HXLINE(1389)			this->_hx___cacheBitmapData->dispose();
HXLINE(1390)			this->_hx_set__hx___cacheBitmapData(HX_CTX, null());
            		}
            	}
...
bool DisplayObject_obj::_hx___dispatchEvent( ::openfl::events::Event event){
            	HX_GC_STACKFRAME(&_hx_pos_26400284d5456c16_1414___dispatchEvent)
...
HXLINE(1429)				event->_hx_set_target(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
            			}
...
bool DisplayObject_obj::_hx___dispatchWithCapture( ::openfl::events::Event event){
            	HX_GC_STACKFRAME(&_hx_pos_26400284d5456c16_1439___dispatchWithCapture)
HXLINE(1440)		if (::hx::IsNull( event->target )) {
HXLINE(1442)			event->_hx_set_target(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
            		}
...
void DisplayObject_obj::_hx___setStageReference( ::openfl::display::Stage stage){
            	HX_GC_STACKFRAME(&_hx_pos_26400284d5456c16_1680___setStageReference)
HXDLIN(1680)		this->_hx_set_stage(HX_CTX, stage);
            	}
...
void DisplayObject_obj::_hx___update(bool transformOnly,bool updateChildren){
            	HX_GC_STACKFRAME(&_hx_pos_26400284d5456c16_1702___update)
...
HXLINE(1762)					this->_hx_set__hx___worldBlendMode(HX_CTX, renderParent->_hx___worldBlendMode);
            				}
            				else {
HXLINE(1766)					this->_hx_set__hx___worldBlendMode(HX_CTX, this->_hx___blendMode);
            				}
HXLINE(1769)				if (::hx::IsNull( this->_hx___shader )) {
HXLINE(1771)					this->_hx_set__hx___worldShader(HX_CTX, renderParent->_hx___shader);
            				}
            				else {
HXLINE(1775)					this->_hx_set__hx___worldShader(HX_CTX, this->_hx___shader);
            				}
HXLINE(1778)				if (::hx::IsNull( this->_hx___scale9Grid )) {
HXLINE(1780)					this->_hx_set__hx___worldScale9Grid(HX_CTX, renderParent->_hx___scale9Grid);
            				}
            				else {
HXLINE(1784)					this->_hx_set__hx___worldScale9Grid(HX_CTX, this->_hx___scale9Grid);
            				}
            			}
            			else {
...
HXLINE(1808)				this->_hx_set__hx___worldBlendMode(HX_CTX, this->_hx___blendMode);
HXLINE(1809)				this->_hx_set__hx___worldShader(HX_CTX, this->_hx___shader);
HXLINE(1810)				this->_hx_set__hx___worldScale9Grid(HX_CTX, this->_hx___scale9Grid);
            			}
            		}
...
HXLINE(1833)			this->_hx_set__hx___worldTransform(HX_CTX,  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
            		}
HXLINE(1836)		if (::hx::IsNull( this->_hx___renderTransform )) {
HXLINE(1838)			this->_hx_set__hx___renderTransform(HX_CTX,  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(DisplayObject_obj,get_blendMode,return )
 ...
 ::Dynamic DisplayObject_obj::set_blendMode( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_26400284d5456c16_1888_set_blendMode)
...
HXLINE(1892)		return (this->_hx_set__hx___blendMode(HX_CTX, value));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(DisplayObject_obj,get_cacheAsBitmapMatrix,return )
 ...
 ::openfl::geom::Matrix DisplayObject_obj::set_cacheAsBitmapMatrix( ::openfl::geom::Matrix value){
            	HX_GC_STACKFRAME(&_hx_pos_26400284d5456c16_1916_set_cacheAsBitmapMatrix)
...
HXDLIN(1918)		return (this->_hx_set__hx___cacheAsBitmapMatrix(HX_CTX, _hx_tmp));
            	}
...
::Array< ::Dynamic> DisplayObject_obj::set_filters(::Array< ::Dynamic> value){
            	HX_GC_STACKFRAME(&_hx_pos_26400284d5456c16_1934_set_filters)
...
HXLINE(1947)			this->_hx_set__hx___filters(HX_CTX, clonedFilters);
...
HXLINE(1953)				this->_hx_set__hx___filters(HX_CTX, null());
...
HX_DEFINE_DYNAMIC_FUNC0(DisplayObject_obj,get_mask,return )
 ...
 ::openfl::display::DisplayObject DisplayObject_obj::set_mask( ::openfl::display::DisplayObject value){
            	HX_GC_STACKFRAME(&_hx_pos_26400284d5456c16_2009_set_mask)
...
HXLINE(2024)			this->_hx___mask->_hx_set__hx___maskTarget(HX_CTX, null());
...
HXLINE(2032)			value->_hx_set__hx___maskTarget(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
...
HXLINE(2041)		return (this->_hx_set__hx___mask(HX_CTX, value));
            	}
...
::String DisplayObject_obj::set_name(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_26400284d5456c16_2067_set_name)
HXDLIN(2067)		return (this->_hx_set__hx___name(HX_CTX, value));
            	}
...
HXLINE(2122)				this->_hx_set__hx___scale9Grid(HX_CTX,  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
            			}
HXLINE(2123)			this->_hx___scale9Grid->copyFrom(value);
            		}
            		else {
HXLINE(2127)			this->_hx_set__hx___scale9Grid(HX_CTX, null());
            		}
...
HXLINE(2220)				this->_hx_set__hx___scrollRect(HX_CTX,  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
            			}
HXLINE(2221)			this->_hx___scrollRect->copyFrom(value);
            		}
            		else {
HXLINE(2225)			this->_hx_set__hx___scrollRect(HX_CTX, null());
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(DisplayObject_obj,get_shader,return )
 ...
 ::openfl::display::Shader DisplayObject_obj::set_shader( ::openfl::display::Shader value){
            	HX_GC_STACKFRAME(&_hx_pos_26400284d5456c16_2244_set_shader)
HXLINE(2245)		this->_hx_set__hx___shader(HX_CTX, value);
...
HXLINE(2254)			this->_hx_set__hx___objectTransform(HX_CTX,  ::openfl::geom::Transform_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this)));
            		}
...
HXLINE(2269)			this->_hx_set__hx___objectTransform(HX_CTX,  ::openfl::geom::Transform_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this)));
            		}
...
::hx::Val DisplayObject_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"stage") ) { _hx_set_stage(HX_CTX_GET,inValue.Cast<  ::openfl::display::Stage >()); return inValue; }
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"parent") ) { _hx_set_parent(HX_CTX_GET,inValue.Cast<  ::openfl::display::DisplayObjectContainer >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"__mask") ) { _hx_set__hx___mask(HX_CTX_GET,inValue.Cast<  ::openfl::display::DisplayObject >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__name") ) { _hx_set__hx___name(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 7:
		...
		if (HX_FIELD_EQ(inName,"__cairo") ) { _hx_set__hx___cairo(HX_CTX_GET,inValue.Cast<  ::lime::graphics::cairo::Cairo >()); return inValue; }
		break;
	case 8:
		...
		if (HX_FIELD_EQ(inName,"__shader") ) { _hx_set__hx___shader(HX_CTX_GET,inValue.Cast<  ::openfl::display::Shader >()); return inValue; }
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"__filters") ) { _hx_set__hx___filters(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"__children") ) { _hx_set__hx___children(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__graphics") ) { _hx_set__hx___graphics(HX_CTX_GET,inValue.Cast<  ::openfl::display::Graphics >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__rotation") ) { _hx___rotation=inValue.Cast< Float >(); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"__blendMode") ) { _hx_set__hx___blendMode(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__tempPoint") ) { _hx_set__hx___tempPoint(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Point >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__transform") ) { _hx_set__hx___transform(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Matrix >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__worldClip") ) { _hx_set__hx___worldClip(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"__loaderInfo") ) { _hx_set__hx___loaderInfo(HX_CTX_GET,inValue.Cast<  ::openfl::display::LoaderInfo >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__maskTarget") ) { _hx_set__hx___maskTarget(HX_CTX_GET,inValue.Cast<  ::openfl::display::DisplayObject >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__renderable") ) { _hx___renderable=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__scale9Grid") ) { _hx_set__hx___scale9Grid(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__scrollRect") ) { _hx_set__hx___scrollRect(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
	...
	case 13:
		...
		if (HX_FIELD_EQ(inName,"__cacheBitmap") ) { _hx_set__hx___cacheBitmap(HX_CTX_GET,inValue.Cast<  ::openfl::display::Bitmap >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"__worldShader") ) { _hx_set__hx___worldShader(HX_CTX_GET,inValue.Cast<  ::openfl::display::Shader >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"__drawableType") ) { _hx___drawableType=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__renderParent") ) { _hx_set__hx___renderParent(HX_CTX_GET,inValue.Cast<  ::openfl::display::DisplayObject >()); return inValue; }
	...
	case 15:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"opaqueBackground") ) { _hx_set_opaqueBackground(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"__worldBlendMode") ) { _hx_set__hx___worldBlendMode(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__worldTransform") ) { _hx_set__hx___worldTransform(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Matrix >()); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"__cacheBitmapData") ) { _hx_set__hx___cacheBitmapData(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__objectTransform") ) { _hx_set__hx___objectTransform(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Transform >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__renderTransform") ) { _hx_set__hx___renderTransform(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Matrix >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__worldScale9Grid") ) { _hx_set__hx___worldScale9Grid(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"__cacheBitmapData2") ) { _hx_set__hx___cacheBitmapData2(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__cacheBitmapData3") ) { _hx_set__hx___cacheBitmapData3(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
	...
	case 19:
		...
		if (HX_FIELD_EQ(inName,"__cacheBitmapMatrix") ) { _hx_set__hx___cacheBitmapMatrix(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Matrix >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__customRenderClear") ) { _hx___customRenderClear=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__customRenderEvent") ) { _hx_set__hx___customRenderEvent(HX_CTX_GET,inValue.Cast<  ::openfl::events::RenderEvent >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__worldAlphaChanged") ) { _hx___worldAlphaChanged=inValue.Cast< bool >(); return inValue; }
		break;
	case 21:
		if (HX_FIELD_EQ(inName,"__cacheAsBitmapMatrix") ) { _hx_set__hx___cacheAsBitmapMatrix(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Matrix >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__cacheBitmapRenderer") ) { _hx_set__hx___cacheBitmapRenderer(HX_CTX_GET,inValue.Cast<  ::openfl::display::DisplayObjectRenderer >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__isCacheBitmapRender") ) { _hx___isCacheBitmapRender=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__worldColorTransform") ) { _hx_set__hx___worldColorTransform(HX_CTX_GET,inValue.Cast<  ::openfl::geom::ColorTransform >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__worldVisibleChanged") ) { _hx___worldVisibleChanged=inValue.Cast< bool >(); return inValue; }
		break;
	case 22:
		if (HX_FIELD_EQ(inName,"__renderTransformCache") ) { _hx_set__hx___renderTransformCache(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Matrix >()); return inValue; }
		break;
	case 23:
		if (HX_FIELD_EQ(inName,"__cacheBitmapBackground") ) { _hx_set__hx___cacheBitmapBackground(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	...
	case 24:
		...
		break;
	case 27:
		if (HX_FIELD_EQ(inName,"__cacheBitmapColorTransform") ) { _hx_set__hx___cacheBitmapColorTransform(HX_CTX_GET,inValue.Cast<  ::openfl::geom::ColorTransform >()); return inValue; }
	}
