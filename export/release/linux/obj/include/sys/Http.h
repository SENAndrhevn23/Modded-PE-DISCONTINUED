...
class HXCPP_CLASS_ATTRIBUTES Http_obj : public  ::haxe::http::HttpBase_obj
{
	...
	public:
		...
		inline  ::haxe::ds::StringMap _hx_set_responseHeadersSameKey(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return responseHeadersSameKey=_hx_v; }
		 ::Dynamic chunk_size;
