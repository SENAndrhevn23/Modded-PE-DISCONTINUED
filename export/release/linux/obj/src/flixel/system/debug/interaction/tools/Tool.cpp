...
void Tool_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_d2c099c398a4a018_14_new)
HXLINE(  20)		this->_hx_set__name(HX_CTX, HX_("(Unknown tool)",73,db,28,1c));
HXLINE(  18)		this->_hx_set_cursorInUse(HX_CTX, HX_("",00,00,00,00));
...
void *Tool_obj::_hx_getInterface(int inHash) {
 ...
 ::flixel::_hx_system::debug::interaction::tools::Tool Tool_obj::init( ::flixel::_hx_system::debug::interaction::Interaction brain){
            	HX_GC_STACKFRAME(&_hx_pos_d2c099c398a4a018_25_init)
HXLINE(  26)		this->_hx_set__brain(HX_CTX, brain);
...
HXLINE(  47)		this->_hx_set_button(HX_CTX,  ::flixel::_hx_system::ui::FlxSystemButton_obj::__alloc( HX_CTX ,( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(Icon,::cpp::VirtualArray_obj::__new(2)->init(0,0)->init(1,0))) ),this->onButtonClicked_dyn(),true));
...
void Tool_obj::setCursor( ::openfl::display::BitmapData Icon){
            	HX_GC_STACKFRAME(&_hx_pos_d2c099c398a4a018_64_setCursor)
HXLINE(  65)		this->_hx_set_cursor(HX_CTX, Icon);
...
void Tool_obj::setCursorInUse(::String customCursorName){
            	HX_GC_STACKFRAME(&_hx_pos_d2c099c398a4a018_80_setCursorInUse)
HXDLIN(  80)		this->_hx_set_cursorInUse(HX_CTX, customCursorName);
            	}
...
void Tool_obj::useDefaultCursor(){
            	HX_GC_STACKFRAME(&_hx_pos_d2c099c398a4a018_88_useDefaultCursor)
HXDLIN(  88)		if ((this->cursorInUse != HX_("",00,00,00,00))) {
HXLINE(  89)			this->_hx_set_cursorInUse(HX_CTX, HX_("",00,00,00,00));
            		}
            	}
...
::hx::Val Tool_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"button") ) { _hx_set_button(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::ui::FlxSystemButton >()); return inValue; }
		if (HX_FIELD_EQ(inName,"cursor") ) { _hx_set_cursor(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_brain") ) { _hx_set__brain(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::debug::interaction::Interaction >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"_shortcut") ) { _hx_set__shortcut(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"cursorInUse") ) { _hx_set_cursorInUse(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	}
