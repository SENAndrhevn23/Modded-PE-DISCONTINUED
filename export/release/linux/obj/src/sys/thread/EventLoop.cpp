...
HXLINE(  28)		this->_hx_set_waitLock(HX_CTX,  ::sys::thread::Lock_obj::__alloc( HX_CTX ));
HXLINE(  27)		this->oneTimeEventsIdx = 0;
HXLINE(  26)		this->_hx_set_oneTimeEvents(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE(  25)		this->_hx_set_mutex(HX_CTX,  ::sys::thread::Mutex_obj::__alloc( HX_CTX ));
...
bool EventLoop_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::thread::NextEventTime EventLoop_obj::progress(){
            	HX_GC_STACKFRAME(&_hx_pos_dec05f81178ee6ce_146_progress)
...
HXDLIN( 146)				regularsToRun->setCtx( HX_CTX, (eventsToRunIdx - 1),current);
...
HXDLIN( 146)			regularsToRun->setCtx( HX_CTX, i,null());
            		}
...
HXDLIN( 146)				eventsToRunIdx = (eventsToRunIdx + 1);
HXDLIN( 146)				oneTimersToRun->setCtx( HX_CTX, (eventsToRunIdx - 1),event);
HXDLIN( 146)				this->oneTimeEvents->setCtx( HX_CTX, i1,null());
            			}
            		}
            		_hx_goto_4:;
...
HXDLIN( 146)			oneTimersToRun->setCtx( HX_CTX, i2,null());
            		}
...
void EventLoop_obj::loop(){
            	HX_GC_STACKFRAME(&_hx_pos_dec05f81178ee6ce_179_loop)
...
HXDLIN( 183)					regularsToRun->setCtx( HX_CTX, (eventsToRunIdx - 1),current);
...
HXDLIN( 183)				regularsToRun->setCtx( HX_CTX, i,null());
            			}
HXLINE( 234)			eventsToRunIdx = 0;
...
HXLINE( 183)					eventsToRunIdx = (eventsToRunIdx + 1);
HXDLIN( 183)					oneTimersToRun->setCtx( HX_CTX, (eventsToRunIdx - 1),event);
HXDLIN( 183)					this->oneTimeEvents->setCtx( HX_CTX, i1,null());
            				}
            			}
            			_hx_goto_12:;
...
HXDLIN( 183)				oneTimersToRun->setCtx( HX_CTX, i2,null());
            			}
...
::hx::Val EventLoop_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"waitLock") ) { _hx_set_waitLock(HX_CTX_GET,inValue.Cast<  ::sys::thread::Lock >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"isMainThread") ) { isMainThread=inValue.Cast< bool >(); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"oneTimeEvents") ) { _hx_set_oneTimeEvents(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"regularEvents") ) { _hx_set_regularEvents(HX_CTX_GET,inValue.Cast<  ::sys::thread::_EventLoop::RegularEvent >()); return inValue; }
		break;
	case 16:
