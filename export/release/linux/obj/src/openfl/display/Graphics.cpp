...
HXLINE(  97)		this->_hx_set__hx___owner(HX_CTX, owner);
HXLINE(  99)		this->_hx_set__hx___commands(HX_CTX,  ::openfl::display::_internal::DrawCommandBuffer_obj::__alloc( HX_CTX ));
...
HXLINE( 103)		this->_hx_set__hx___renderTransform(HX_CTX,  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
HXLINE( 104)		this->_hx_set__hx___usedShaderBuffers(HX_CTX,  ::haxe::ds::List_obj::__alloc( HX_CTX ));
HXLINE( 105)		this->_hx_set__hx___worldTransform(HX_CTX,  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
HXLINE( 106)		this->_hx___width = 0;
HXLINE( 107)		this->_hx___height = 0;
HXLINE( 109)		this->_hx___bitmapScale = ( (Float)(1) );
HXLINE( 111)		this->_hx_set__hx___shaderBufferPool(HX_CTX,  ::lime::utils::ObjectPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()),null(),null()));
            	}
...
void Graphics_obj::clear(){
            	HX_GC_STACKFRAME(&_hx_pos_043516e11ce5c7d5_407_clear)
HXLINE( 409)		{
...
HXLINE( 423)			this->_hx_set__hx___bounds(HX_CTX, null());
            		}
...
void Graphics_obj::copyFrom( ::openfl::display::Graphics sourceGraphics){
            	HX_GC_STACKFRAME(&_hx_pos_043516e11ce5c7d5_443_copyFrom)
...
HXDLIN( 444)		this->_hx_set__hx___bounds(HX_CTX, _hx_tmp);
HXLINE( 445)		this->_hx_set__hx___commands(HX_CTX, sourceGraphics->_hx___commands->copy());
...
void Graphics_obj::_hx___cleanup(){
            	HX_GC_STACKFRAME(&_hx_pos_043516e11ce5c7d5_1618___cleanup)
HXLINE(1626)		if (::hx::IsNotNull( this->_hx___bounds )) {
HXLINE(1628)			this->set___dirty(true);
HXLINE(1629)			this->_hx___transformDirty = true;
            		}
HXLINE(1633)		this->_hx_set__hx___bitmap(HX_CTX, null());
HXLINE(1639)		this->_hx_set__hx___cairo(HX_CTX, null());
            	}
...
HXLINE(1732)			this->_hx_set__hx___bounds(HX_CTX,  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,x,y,0,0));
...
HXLINE(1847)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::BEGIN_BITMAP_FILL_dyn());
...
HXLINE(1851)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::BEGIN_FILL_dyn());
...
HXLINE(1855)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::BEGIN_GRADIENT_FILL_dyn());
...
HXLINE(1788)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::CUBIC_CURVE_TO_dyn());
...
HXLINE(1792)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::CURVE_TO_dyn());
...
HXLINE(1804)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::DRAW_CIRCLE_dyn());
...
HXLINE(1808)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::DRAW_ELLIPSE_dyn());
...
HXLINE(1812)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::DRAW_RECT_dyn());
...
HXLINE(1816)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::DRAW_ROUND_RECT_dyn());
...
HXLINE(1843)							data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::END_FILL_dyn());
...
HXLINE(1830)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::LINE_BITMAP_STYLE_dyn());
...
HXLINE(1822)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::LINE_GRADIENT_STYLE_dyn());
...
HXLINE(1837)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::LINE_STYLE_dyn());
...
HXLINE(1839)						stroke->_hx_set_fill(HX_CTX,  ::openfl::display::GraphicsSolidFill_obj::__alloc( HX_CTX ,c11->buffer->i->__get(c11->iPos),c11->buffer->f->__get(c11->fPos)));
...
HXLINE(1796)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::LINE_TO_dyn());
...
HXLINE(1800)						data->_hx_set_prev(HX_CTX, ::openfl::display::_internal::DrawCommandType_obj::MOVE_TO_dyn());
...
HXLINE(1862)						data->_hx_set_prev(HX_CTX, type);
            					}
            				}
            			}
            		}
...
::hx::Val Graphics_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"__owner") ) { _hx_set__hx___owner(HX_CTX_GET,inValue.Cast<  ::openfl::display::DisplayObject >()); return inValue; }
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"__bounds") ) { _hx_set__hx___bounds(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__height") ) { _hx___height=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__bitmap") ) { _hx_set__hx___bitmap(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
		break;
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"__commands") ) { _hx_set__hx___commands(HX_CTX_GET,inValue.Cast<  ::openfl::display::_internal::DrawCommandBuffer >()); return inValue; }
		break;
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"__quadBuffer") ) { _hx_set__hx___quadBuffer(HX_CTX_GET,inValue.Cast<  ::openfl::display::_internal::Context3DBuffer >()); return inValue; }
		break;
	case 13:
	...
	case 17:
		...
		if (HX_FIELD_EQ(inName,"__vertexBufferUVT") ) { _hx_set__hx___vertexBufferUVT(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::VertexBuffer3D >()); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"__shaderBufferPool") ) { _hx_set__hx___shaderBufferPool(HX_CTX_GET,inValue.Cast<  ::lime::utils::ObjectPool >()); return inValue; }
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"__usedShaderBuffers") ) { _hx_set__hx___usedShaderBuffers(HX_CTX_GET,inValue.Cast<  ::haxe::ds::List >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__vertexBufferCount") ) { _hx___vertexBufferCount=inValue.Cast< int >(); return inValue; }
		break;
	case 21:
		if (HX_FIELD_EQ(inName,"__triangleIndexBuffer") ) { _hx_set__hx___triangleIndexBuffer(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::IndexBuffer3D >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__vertexBufferDataUVT") ) { _hx_set__hx___vertexBufferDataUVT(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
		break;
	case 22:
		if (HX_FIELD_EQ(inName,"__vertexBufferCountUVT") ) { _hx___vertexBufferCountUVT=inValue.Cast< int >(); return inValue; }
		break;
	case 25:
		if (HX_FIELD_EQ(inName,"__triangleIndexBufferData") ) { _hx_set__hx___triangleIndexBufferData(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
		break;
	case 26:
