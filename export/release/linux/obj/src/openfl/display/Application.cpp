...
HXLINE(  54)		::openfl::utils::_internal::Lib_obj::current->_hx_set__hx___loaderInfo(HX_CTX, ::openfl::display::LoaderInfo_obj::create(null()));
HXLINE(  55)		::openfl::utils::_internal::Lib_obj::current->_hx___loaderInfo->_hx_set_content(HX_CTX, ::openfl::utils::_internal::Lib_obj::current);
            	}
...
HXLINE(  71)			this->_hx_set__hx___window(HX_CTX, window);
...
HXLINE( 103)			initOptions->_hx_set__hx___window(HX_CTX, ( ( ::openfl::display::Window)(this->_hx___window) ));
