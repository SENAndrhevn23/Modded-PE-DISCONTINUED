...
void FlxTrail_obj::__construct( ::flixel::FlxSprite Target, ::Dynamic Graphic,::hx::Null< int >  __o_Length,::hx::Null< int >  __o_Delay,::hx::Null< Float >  __o_Alpha,::hx::Null< Float >  __o_Diff){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_54e0b0e195bf849b_20_new)
HXLINE(  88)		this->_hx_set__recentAnimations(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  87)		this->_hx_set__recentFlipY(HX_CTX, ::Array_obj< bool >::__new(0));
HXLINE(  86)		this->_hx_set__recentFlipX(HX_CTX, ::Array_obj< bool >::__new(0));
HXLINE(  85)		this->_hx_set__recentFrames(HX_CTX, ::Array_obj< int >::__new(0));
HXLINE(  84)		this->_hx_set__recentScales(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  83)		this->_hx_set__recentAngles(HX_CTX, ::Array_obj< Float >::__new(0));
HXLINE(  82)		this->_hx_set__recentPositions(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
...
HXDLIN( 109)		if (p->_weak) {
HXLINE( 109)			p->put();
            		}
HXDLIN( 109)		this->_hx_set__spriteOrigin(HX_CTX, this1);
HXLINE( 112)		this->_hx_set_target(HX_CTX, Target);
HXLINE( 113)		this->delay = Delay;
HXLINE( 114)		this->_hx_set__graphic(HX_CTX, Graphic);
...
void FlxTrail_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_54e0b0e195bf849b_124_destroy)
...
HXLINE( 128)		this->_hx_set__recentAngles(HX_CTX, null());
HXLINE( 129)		this->_hx_set__recentPositions(HX_CTX, null());
HXLINE( 130)		this->_hx_set__recentScales(HX_CTX, null());
HXLINE( 131)		this->_hx_set__recentFrames(HX_CTX, null());
HXLINE( 132)		this->_hx_set__recentFlipX(HX_CTX, null());
HXLINE( 133)		this->_hx_set__recentFlipY(HX_CTX, null());
HXLINE( 134)		this->_hx_set__recentAnimations(HX_CTX, null());
HXLINE( 135)		this->_hx_set__spriteOrigin(HX_CTX, null());
HXLINE( 137)		this->_hx_set_target(HX_CTX, null());
HXLINE( 138)		this->_hx_set__graphic(HX_CTX, null());
HXLINE( 140)		this->super::destroy();
            	}


void FlxTrail_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_54e0b0e195bf849b_147_update)
...
HXDLIN( 233)							_this->_hx_set__curAnim(HX_CTX, anim);
            						}
            					}
...
void FlxTrail_obj::changeGraphic( ::Dynamic Image){
            	HX_GC_STACKFRAME(&_hx_pos_54e0b0e195bf849b_317_changeGraphic)
HXLINE( 318)		this->_hx_set__graphic(HX_CTX, Image);
HXLINE( 320)		{
HXLINE( 320)			int _g = 0;
...
::hx::Val FlxTrail_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"target") ) { _hx_set_target(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSprite >()); return inValue; }
		break;
	case 7:
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"_graphic") ) { _hx_set__graphic(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 11:
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"_recentFlipX") ) { _hx_set__recentFlipX(HX_CTX_GET,inValue.Cast< ::Array< bool > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_recentFlipY") ) { _hx_set__recentFlipY(HX_CTX_GET,inValue.Cast< ::Array< bool > >()); return inValue; }
		break;
	case 13:
		...
		if (HX_FIELD_EQ(inName,"_recentAngles") ) { _hx_set__recentAngles(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_recentScales") ) { _hx_set__recentScales(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_recentFrames") ) { _hx_set__recentFrames(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_spriteOrigin") ) { _hx_set__spriteOrigin(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"rotationsEnabled") ) { rotationsEnabled=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_recentPositions") ) { _hx_set__recentPositions(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"_recentAnimations") ) { _hx_set__recentAnimations(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
