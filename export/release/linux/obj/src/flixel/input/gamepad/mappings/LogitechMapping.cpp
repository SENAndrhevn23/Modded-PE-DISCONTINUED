...
void LogitechMapping_obj::initValues(){
            	HX_GC_STACKFRAME(&_hx_pos_895a9f6ff22a02c8_17_initValues)
HXLINE(  18)		this->_hx_set_leftStick(HX_CTX, ::flixel::input::gamepad::id::LogitechID_obj::LEFT_ANALOG_STICK);
HXLINE(  19)		this->_hx_set_rightStick(HX_CTX, ::flixel::input::gamepad::id::LogitechID_obj::RIGHT_ANALOG_STICK);
            	}
