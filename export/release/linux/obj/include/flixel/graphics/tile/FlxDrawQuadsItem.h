...
class HXCPP_CLASS_ATTRIBUTES FlxDrawQuadsItem_obj : public  ::flixel::graphics::tile::FlxDrawBaseItem_obj
{
	...
	public:
		...
		inline  ::openfl::_Vector::FloatVector _hx_set_rects(::hx::StackContext *_hx_ctx, ::openfl::_Vector::FloatVector _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return rects=_hx_v; }
		 ::openfl::_Vector::FloatVector transforms;
		inline  ::openfl::_Vector::FloatVector _hx_set_transforms(::hx::StackContext *_hx_ctx, ::openfl::_Vector::FloatVector _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return transforms=_hx_v; }
		::Array< Float > alphas;
