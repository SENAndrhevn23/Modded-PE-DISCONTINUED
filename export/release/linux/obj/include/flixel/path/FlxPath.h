...
class HXCPP_CLASS_ATTRIBUTES FlxPath_obj : public ::hx::Object
{
	...
	public:
		...
		inline ::Array< ::Dynamic> _hx_set__nodes(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _nodes=_hx_v; }
		Float speed;
		bool immovable;
		Float angle;
		bool autoCenter;
		...
		inline  ::Dynamic _hx_set__wasObjectImmovable(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _wasObjectImmovable=_hx_v; }
		bool _firstUpdate;
