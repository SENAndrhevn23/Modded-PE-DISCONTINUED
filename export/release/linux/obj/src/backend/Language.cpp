...
HX_LOCAL_STACK_FRAME(_hx_pos_535418947a9b1146_59_getPhrase,"backend.Language","getPhrase",0xd3dde9d3,"backend.Language.getPhrase","backend/Language.hx",59,0xabbfcb8b)
...
void Language_obj::reloadPhrases(){
            	HX_GC_STACKFRAME(&_hx_pos_535418947a9b1146_11_reloadPhrases)
...
HXDLIN(  14)			if (::sys::FileSystem_obj::exists(pth)) {
...
HXLINE(  14)						_hx_tmp1 = !(foldersToCheck->contains(folder1));
            					}
            					else {
...
HXLINE(  14)				_hx_tmp2 = !(foldersToCheck->contains(folder2));
            			}
            			else {
...
HXLINE(  14)				_hx_tmp3 = (::backend::Mods_obj::currentModDirectory.length > 0);
            			}
            			else {
...
HXLINE(  14)					_hx_tmp4 = !(foldersToCheck->contains(folder3));
            				}
            				else {
...
HXLINE( 129)					folder3 = ::backend::Paths_obj::findFile(path);
HXLINE(  14)					if (::hx::IsNotNull( folder3 )) {
HXLINE(  14)						if (::sys::FileSystem_obj::isDirectory(folder3)) {
HXLINE(  14)							folder3 = (folder3 + HX_("/",2f,00,00,00));
            						}
...
HXLINE(  45)			::backend::ClientPrefs_obj::data->_hx_set_language(HX_CTX, ::backend::ClientPrefs_obj::defaultData->language);
            		}
...
::String Language_obj::phraseStr;

::String Language_obj::getPhrase(::String key,::String defaultPhrase,::cpp::VirtualArray values){
            	HX_GC_STACKFRAME(&_hx_pos_535418947a9b1146_59_getPhrase)
HXLINE(  62)		::Dynamic this1 = ::backend::Language_obj::phrases;
HXDLIN(  62)		 ::EReg hideChars =  ::EReg_obj::__alloc( HX_CTX ,HX_("[~&\\\\/;:<>#.,'\"%?!]",85,3f,6d,6d),HX_("g",67,00,00,00));
HXDLIN(  62)		::backend::Language_obj::phraseStr = ( ( ::haxe::ds::StringMap)(this1) )->get_string(::StringTools_obj::trim(hideChars->replace(::StringTools_obj::replace(key,HX_(" ",20,00,00,00),HX_("_",5f,00,00,00)),HX_("",00,00,00,00)).toLowerCase()));
HXLINE(  63)		if (::hx::IsNull( ::backend::Language_obj::phraseStr )) {
HXLINE(  63)			::backend::Language_obj::phraseStr = defaultPhrase;
            		}
HXLINE(  68)		if (::hx::IsNull( ::backend::Language_obj::phraseStr )) {
HXLINE(  68)			::backend::Language_obj::phraseStr = key;
            		}
...
HXLINE(  72)				::backend::Language_obj::phraseStr = ::StringTools_obj::replace(::backend::Language_obj::phraseStr,((HX_("{",7b,00,00,00) + (num + 1)) + HX_("}",7d,00,00,00)),( (::String)(value) ));
            			}
            		}
HXLINE(  74)		return ::backend::Language_obj::phraseStr;
            	}
...
HXDLIN(  98)				::backend::Language_obj::phraseStr = ( ( ::haxe::ds::StringMap)(this1) )->get_string(::StringTools_obj::trim(hideChars->replace(::StringTools_obj::replace(key,HX_(" ",20,00,00,00),HX_("_",5f,00,00,00)),HX_("",00,00,00,00)).toLowerCase()));
HXDLIN(  98)				if (::hx::IsNull( ::backend::Language_obj::phraseStr )) {
HXLINE(  98)					::backend::Language_obj::phraseStr = defaultPhrase;
            				}
HXDLIN(  98)				if (::hx::IsNull( ::backend::Language_obj::phraseStr )) {
HXLINE(  98)					::backend::Language_obj::phraseStr = key;
            				}
HXDLIN(  98)				if (::hx::IsNotNull( values )) {
...
HXDLIN(  98)						::backend::Language_obj::phraseStr = ::StringTools_obj::replace(::backend::Language_obj::phraseStr,((HX_("{",7b,00,00,00) + (num + 1)) + HX_("}",7d,00,00,00)),( (::String)(value) ));
            					}
            				}
HXDLIN(  98)				return ::backend::Language_obj::phraseStr;
            			}
...
bool Language_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"phraseStr") ) { outValue = ( phraseStr ); return true; }
...
bool Language_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"phraseStr") ) { phraseStr=ioValue.Cast< ::String >(); return true; }
		break;
	case 15:
...
static ::hx::StaticInfo Language_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsString,(void *) &Language_obj::phraseStr,HX_("phraseStr",38,d2,5f,4d)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static void Language_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(Language_obj::phraseStr,"phraseStr");
};
...
static void Language_obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(Language_obj::phraseStr,"phraseStr");
};
