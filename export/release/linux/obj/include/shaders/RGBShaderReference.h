...
class HXCPP_CLASS_ATTRIBUTES RGBShaderReference_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::shaders::RGBPalette _hx_set_parent(::hx::StackContext *_hx_ctx, ::shaders::RGBPalette _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return parent=_hx_v; }
		 ::flixel::FlxSprite _owner;
		inline  ::flixel::FlxSprite _hx_set__owner(::hx::StackContext *_hx_ctx, ::flixel::FlxSprite _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _owner=_hx_v; }
		 ::shaders::RGBPalette _original;
		inline  ::shaders::RGBPalette _hx_set__original(::hx::StackContext *_hx_ctx, ::shaders::RGBPalette _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _original=_hx_v; }
		int set_r(int value);
		::Dynamic set_r_dyn();
