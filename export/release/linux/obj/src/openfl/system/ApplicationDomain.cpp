...
void ApplicationDomain_obj::__construct( ::openfl::_hx_system::ApplicationDomain parentDomain){
            	HX_GC_STACKFRAME(&_hx_pos_5a0a7282aa095189_74_new)
HXDLIN(  74)		if (::hx::IsNotNull( parentDomain )) {
HXLINE(  76)			this->_hx_set_parentDomain(HX_CTX, parentDomain);
            		}
            		else {
HXLINE(  80)			this->_hx_set_parentDomain(HX_CTX, ::openfl::_hx_system::ApplicationDomain_obj::currentDomain);
            		}
            	}
...
::hx::Val ApplicationDomain_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 12:
		if (HX_FIELD_EQ(inName,"parentDomain") ) { _hx_set_parentDomain(HX_CTX_GET,inValue.Cast<  ::openfl::_hx_system::ApplicationDomain >()); return inValue; }
	}
