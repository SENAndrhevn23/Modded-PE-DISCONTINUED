...
HXLINE(  27)		this->_hx_set_spacing(HX_CTX,  ::flixel::graphics::frames::bmfont::BMFontSpacing_obj::__alloc( HX_CTX ,0,0));
HXLINE(  26)		this->_hx_set_padding(HX_CTX,  ::flixel::graphics::frames::bmfont::BMFontPadding_obj::__alloc( HX_CTX ,0,0,0,0));
HXLINE(  14)		this->_hx_set_face(HX_CTX, face);
HXDLIN(  14)		this->size = size;
HXDLIN(  14)		this->bold = bold;
HXDLIN(  14)		this->italic = italic;
HXDLIN(  14)		this->_hx_set_charset(HX_CTX, charset);
...
HXDLIN(  14)			this->_hx_set_padding(HX_CTX, padding);
            		}
HXDLIN(  14)		if (::hx::IsNotNull( spacing )) {
HXDLIN(  14)			this->_hx_set_spacing(HX_CTX, spacing);
            		}
...
HXLINE(  75)				charset->setCtx( HX_CTX, 0,value);
HXDLIN(  75)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("face",9d,b4,b5,43)) ){
HXLINE(  71)				face->setCtx( HX_CTX, 0,value);
...
HXDLIN(  80)				padding1->setCtx( HX_CTX, 0, ::flixel::graphics::frames::bmfont::BMFontPadding_obj::__alloc( HX_CTX ,_g,_g1,_g2,::Std_obj::parseInt(values->__get(3))));
...
HXLINE(  81)				spacing->setCtx( HX_CTX, 0,::flixel::graphics::frames::bmfont::BMFontSpacing_obj::fromString(value));
...
::hx::Val BMFontInfo_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 2:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"face") ) { _hx_set_face(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	...
	case 6:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"charset") ) { _hx_set_charset(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"unicode") ) { unicode=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"padding") ) { _hx_set_padding(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::frames::bmfont::BMFontPadding >()); return inValue; }
		if (HX_FIELD_EQ(inName,"spacing") ) { _hx_set_spacing(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::frames::bmfont::BMFontSpacing >()); return inValue; }
