...
void FlxDrawBaseItem_obj::reset(){
            	HX_GC_STACKFRAME(&_hx_pos_0484b113da1bcafb_44_reset)
HXLINE(  45)		this->_hx_set_graphics(HX_CTX, null());
HXLINE(  46)		this->antialiasing = false;
HXLINE(  47)		this->_hx_set_nextTyped(HX_CTX, null());
HXLINE(  48)		this->_hx_set_next(HX_CTX, null());
            	}
...
void FlxDrawBaseItem_obj::dispose(){
            	HX_GC_STACKFRAME(&_hx_pos_0484b113da1bcafb_52_dispose)
HXLINE(  53)		this->_hx_set_graphics(HX_CTX, null());
HXLINE(  54)		this->_hx_set_next(HX_CTX, null());
HXLINE(  55)		this->_hx_set_type(HX_CTX, null());
HXLINE(  56)		this->_hx_set_nextTyped(HX_CTX, null());
            	}
...
::hx::Val FlxDrawBaseItem_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"next") ) { _hx_set_next(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::tile::FlxDrawBaseItem >()); return inValue; }
		if (HX_FIELD_EQ(inName,"type") ) { _hx_set_type(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::tile::FlxDrawItemType >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"blend") ) { _hx_set_blend(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"colored") ) { colored=inValue.Cast< bool >(); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"graphics") ) { _hx_set_graphics(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::FlxGraphic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"blending") ) { blending=inValue.Cast< int >(); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"nextTyped") ) { _hx_set_nextTyped(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 12:
