...
void FlxTween_obj::__construct( ::Dynamic Options, ::flixel::tweens::FlxTweenManager manager){
            	HX_GC_STACKFRAME(&_hx_pos_b949e09b4c4d130d_175_new)
...
HXLINE( 552)		this->_hx_set_onStart(HX_CTX, Options->__Field(HX_("onStart",c3,12,49,1a),::hx::paccDynamic));
HXLINE( 553)		this->_hx_set_onUpdate(HX_CTX, Options->__Field(HX_("onUpdate",88,7c,b2,66),::hx::paccDynamic));
HXLINE( 554)		this->_hx_set_onComplete(HX_CTX, Options->__Field(HX_("onComplete",f8,d4,7e,5d),::hx::paccDynamic));
HXLINE( 555)		this->_hx_set_ease(HX_CTX, Options->__Field(HX_("ease",ee,8b,0c,43),::hx::paccDynamic));
...
HXDLIN( 557)		this->_hx_set_manager(HX_CTX, _hx_tmp);
            	}
...
void FlxTween_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_b949e09b4c4d130d_572_destroy)
HXLINE( 573)		this->_hx_set_onStart(HX_CTX, null());
HXLINE( 574)		this->_hx_set_onUpdate(HX_CTX, null());
HXLINE( 575)		this->_hx_set_onComplete(HX_CTX, null());
HXLINE( 576)		this->_hx_set_ease(HX_CTX, null());
HXLINE( 577)		this->_hx_set_manager(HX_CTX, null());
HXLINE( 578)		this->_hx_set__chainedTweens(HX_CTX, null());
HXLINE( 579)		this->_hx_set__nextTweenInChain(HX_CTX, null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxTween_obj,wait,return )
 ...
 ::flixel::tweens::FlxTween FlxTween_obj::addChainedTween( ::flixel::tweens::FlxTween tween){
            	HX_GC_STACKFRAME(&_hx_pos_b949e09b4c4d130d_600_addChainedTween)
HXLINE( 601)		tween->setVarsOnEnd();
HXLINE( 602)		tween->manager->remove(tween,false);
HXLINE( 604)		if (::hx::IsNull( this->_chainedTweens )) {
HXLINE( 605)			this->_hx_set__chainedTweens(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
            		}
...
void FlxTween_obj::cancelChain(){
            	HX_GC_STACKFRAME(&_hx_pos_b949e09b4c4d130d_690_cancelChain)
...
HXLINE( 697)			this->_hx_set__chainedTweens(HX_CTX, null());
            		}
...
void FlxTween_obj::processTweenChain(){
            	HX_GC_STACKFRAME(&_hx_pos_b949e09b4c4d130d_762_processTweenChain)
...
HXLINE( 767)		this->_hx_set__nextTweenInChain(HX_CTX, this->_chainedTweens->shift().StaticCast<  ::flixel::tweens::FlxTween >());
HXLINE( 769)		this->doNextTween(this->_nextTweenInChain);
HXLINE( 770)		this->_hx_set__chainedTweens(HX_CTX, null());
            	}
...
void FlxTween_obj::setChain(::Array< ::Dynamic> previousChain){
            	HX_GC_STACKFRAME(&_hx_pos_b949e09b4c4d130d_785_setChain)
HXLINE( 786)		if (::hx::IsNull( previousChain )) {
HXLINE( 787)			return;
            		}
HXLINE( 789)		if (::hx::IsNull( this->_chainedTweens )) {
HXLINE( 790)			this->_hx_set__chainedTweens(HX_CTX, previousChain);
            		}
            		else {
HXLINE( 792)			this->_hx_set__chainedTweens(HX_CTX, this->_chainedTweens->concat(previousChain));
            		}
            	}
...
::hx::Val FlxTween_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"manager") ) { _hx_set_manager(HX_CTX_GET,inValue.Cast<  ::flixel::tweens::FlxTweenManager >()); return inValue; }
	...
	case 11:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"_chainedTweens") ) { _hx_set__chainedTweens(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"_nextTweenInChain") ) { _hx_set__nextTweenInChain(HX_CTX_GET,inValue.Cast<  ::flixel::tweens::FlxTween >()); return inValue; }
		break;
	case 18:
