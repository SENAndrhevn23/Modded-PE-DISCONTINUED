...
HX_DEFINE_STACK_FRAME(_hx_pos_0f70c5927802d56d_1698_new,"lime._internal.graphics._ImageDataUtil.ImageDataView","new",0x36089ace,"lime._internal.graphics._ImageDataUtil.ImageDataView.new","lime/_internal/graphics/ImageDataUtil.hx",1698,0x59dddace)
HX_LOCAL_STACK_FRAME(_hx_pos_0f70c5927802d56d_1722_clip,"lime._internal.graphics._ImageDataUtil.ImageDataView","clip",0x0a3ec4a2,"lime._internal.graphics._ImageDataUtil.ImageDataView.clip","lime/_internal/graphics/ImageDataUtil.hx",1722,0x59dddace)
HX_LOCAL_STACK_FRAME(_hx_pos_0f70c5927802d56d_1732_hasRow,"lime._internal.graphics._ImageDataUtil.ImageDataView","hasRow",0xdbd8dd32,"lime._internal.graphics._ImageDataUtil.ImageDataView.hasRow","lime/_internal/graphics/ImageDataUtil.hx",1732,0x59dddace)
HX_LOCAL_STACK_FRAME(_hx_pos_0f70c5927802d56d_1736_offset,"lime._internal.graphics._ImageDataUtil.ImageDataView","offset",0x80da85e5,"lime._internal.graphics._ImageDataUtil.ImageDataView.offset","lime/_internal/graphics/ImageDataUtil.hx",1736,0x59dddace)
HX_LOCAL_STACK_FRAME(_hx_pos_0f70c5927802d56d_1764_row,"lime._internal.graphics._ImageDataUtil.ImageDataView","row",0x360bac88,"lime._internal.graphics._ImageDataUtil.ImageDataView.row","lime/_internal/graphics/ImageDataUtil.hx",1764,0x59dddace)
HX_LOCAL_STACK_FRAME(_hx_pos_0f70c5927802d56d_1768___update,"lime._internal.graphics._ImageDataUtil.ImageDataView","__update",0xdf2597fb,"lime._internal.graphics._ImageDataUtil.ImageDataView.__update","lime/_internal/graphics/ImageDataUtil.hx",1768,0x59dddace)
namespace lime{
namespace _internal{
namespace graphics{
...
void ImageDataView_obj::__construct( ::lime::graphics::Image image, ::lime::math::Rectangle rect){
            	HX_GC_STACKFRAME(&_hx_pos_0f70c5927802d56d_1698_new)
HXLINE(1699)		this->_hx_set_image(HX_CTX, image);
HXLINE(1701)		if (::hx::IsNull( rect )) {
HXLINE(1703)			this->_hx_set_rect(HX_CTX, image->get_rect());
            		}
            		else {
HXLINE(1707)			if ((rect->x < 0)) {
HXLINE(1707)				rect->x = ( (Float)(0) );
            			}
HXLINE(1708)			if ((rect->y < 0)) {
HXLINE(1708)				rect->y = ( (Float)(0) );
            			}
HXLINE(1709)			if (((rect->x + rect->width) > image->width)) {
HXLINE(1709)				rect->width = (( (Float)(image->width) ) - rect->x);
            			}
HXLINE(1710)			if (((rect->y + rect->height) > image->height)) {
HXLINE(1710)				rect->height = (( (Float)(image->height) ) - rect->y);
            			}
HXLINE(1711)			if ((rect->width < 0)) {
HXLINE(1711)				rect->width = ( (Float)(0) );
            			}
HXLINE(1712)			if ((rect->height < 0)) {
HXLINE(1712)				rect->height = ( (Float)(0) );
            			}
HXLINE(1713)			this->_hx_set_rect(HX_CTX, rect);
            		}
HXLINE(1716)		this->stride = image->buffer->get_stride();
HXLINE(1718)		this->_hx___update();
            	}
...
void ImageDataView_obj::clip(int x,int y,int width,int height){
            	HX_GC_STACKFRAME(&_hx_pos_0f70c5927802d56d_1722_clip)
HXLINE(1723)		if (::hx::IsNull( this->tempRect )) {
HXLINE(1723)			this->_hx_set_tempRect(HX_CTX,  ::lime::math::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
            		}
HXLINE(1724)		this->tempRect->setTo(( (Float)(x) ),( (Float)(y) ),( (Float)(width) ),( (Float)(height) ));
HXLINE(1726)		this->rect->intersection(this->tempRect,this->rect);
...
bool ImageDataView_obj::hasRow(int y){
            	HX_STACKFRAME(&_hx_pos_0f70c5927802d56d_1732_hasRow)
HXDLIN(1732)		if ((y >= 0)) {
HXDLIN(1732)			return (y < this->height);
            		}
            		else {
...
void ImageDataView_obj::offset(int x,int y){
            	HX_STACKFRAME(&_hx_pos_0f70c5927802d56d_1736_offset)
HXLINE(1737)		if ((x < 0)) {
HXLINE(1739)			 ::lime::math::Rectangle fh = this->rect;
HXDLIN(1739)			fh->x = (fh->x + x);
HXLINE(1740)			if ((this->rect->x < 0)) {
HXLINE(1740)				this->rect->x = ( (Float)(0) );
            			}
            		}
            		else {
HXLINE(1744)			 ::lime::math::Rectangle fh1 = this->rect;
HXDLIN(1744)			fh1->x = (fh1->x + x);
HXLINE(1745)			 ::lime::math::Rectangle fh2 = this->rect;
HXDLIN(1745)			fh2->width = (fh2->width - ( (Float)(x) ));
            		}
HXLINE(1748)		if ((y < 0)) {
HXLINE(1750)			 ::lime::math::Rectangle fh3 = this->rect;
HXDLIN(1750)			fh3->y = (fh3->y + y);
HXLINE(1751)			if ((this->rect->y < 0)) {
HXLINE(1751)				this->rect->y = ( (Float)(0) );
            			}
            		}
            		else {
HXLINE(1755)			 ::lime::math::Rectangle fh4 = this->rect;
HXDLIN(1755)			fh4->y = (fh4->y + y);
HXLINE(1756)			 ::lime::math::Rectangle fh5 = this->rect;
HXDLIN(1756)			fh5->height = (fh5->height - ( (Float)(y) ));
            		}
HXLINE(1759)		this->_hx___update();
            	}
...
int ImageDataView_obj::row(int y){
            	HX_STACKFRAME(&_hx_pos_0f70c5927802d56d_1764_row)
HXDLIN(1764)		return (this->byteOffset + (this->stride * y));
            	}
...
void ImageDataView_obj::_hx___update(){
            	HX_STACKFRAME(&_hx_pos_0f70c5927802d56d_1768___update)
HXLINE(1769)		this->x = ::Math_obj::ceil(this->rect->x);
HXLINE(1770)		this->y = ::Math_obj::ceil(this->rect->y);
HXLINE(1771)		this->width = ::Math_obj::floor(this->rect->width);
HXLINE(1772)		this->height = ::Math_obj::floor(this->rect->height);
HXLINE(1773)		this->byteOffset = ((this->stride * (this->y + this->image->offsetY)) + ((this->x + this->image->offsetX) * 4));
            	}
...
::hx::Val ImageDataView_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 1:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"rect") ) { _hx_set_rect(HX_CTX_GET,inValue.Cast<  ::lime::math::Rectangle >()); return inValue; }
		break;
	case 5:
	...
	case 6:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"tempRect") ) { _hx_set_tempRect(HX_CTX_GET,inValue.Cast<  ::lime::math::Rectangle >()); return inValue; }
		break;
	case 10:
