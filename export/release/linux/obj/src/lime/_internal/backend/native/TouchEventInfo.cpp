...
HX_DEFINE_STACK_FRAME(_hx_pos_dc6fd8f0bbdab31a_957_new,"lime._internal.backend.native.TouchEventInfo","new",0xc006dded,"lime._internal.backend.native.TouchEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",957,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_dc6fd8f0bbdab31a_970_clone,"lime._internal.backend.native.TouchEventInfo","clone",0xa51e5e2a,"lime._internal.backend.native.TouchEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",970,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void TouchEventInfo_obj::__construct( ::Dynamic type,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_id,::hx::Null< Float >  __o_dx,::hx::Null< Float >  __o_dy,::hx::Null< Float >  __o_pressure,::hx::Null< int >  __o_device){
            	...
            	HX_STACKFRAME(&_hx_pos_dc6fd8f0bbdab31a_957_new)
HXLINE( 958)		this->type = ( (int)(type) );
HXLINE( 959)		this->x = x;
HXLINE( 960)		this->y = y;
HXLINE( 961)		this->id = id;
HXLINE( 962)		this->dx = dx;
HXLINE( 963)		this->dy = dy;
HXLINE( 964)		this->pressure = pressure;
HXLINE( 965)		this->device = device;
            	}
...
bool TouchEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::TouchEventInfo TouchEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_dc6fd8f0bbdab31a_970_clone)
HXDLIN( 970)		return  ::lime::_internal::backend::native::TouchEventInfo_obj::__alloc( HX_CTX ,this->type,this->x,this->y,this->id,this->dx,this->dy,this->pressure,this->device);
            	}
