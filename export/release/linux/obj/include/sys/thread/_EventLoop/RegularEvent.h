...
{
            	HX_GC_STACKFRAME(&_hx_pos_522fc25da62d22ac_278_new)
HXLINE( 284)		( ( ::sys::thread::_EventLoop::RegularEvent)(__this) )->cancelled = false;
HXLINE( 287)		( ( ::sys::thread::_EventLoop::RegularEvent)(__this) )->_hx_set_run(HX_CTX, run);
...
HXLINE( 289)		( ( ::sys::thread::_EventLoop::RegularEvent)(__this) )->interval = interval;
		...
		inline  ::sys::thread::_EventLoop::RegularEvent _hx_set_next(::hx::StackContext *_hx_ctx, ::sys::thread::_EventLoop::RegularEvent _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return next=_hx_v; }
		bool cancelled;
};
