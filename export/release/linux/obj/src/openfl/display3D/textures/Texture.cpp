...
HXDLIN( 230)				_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN( 230)					_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN( 230)							_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN( 230)							_this3->_hx_set_buffer(HX_CTX, buffer);
...
HXDLIN( 326)						_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN( 326)							_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN( 326)									_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN( 326)									_this3->_hx_set_buffer(HX_CTX, bytes);
...
HXDLIN( 335)						_this4->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this4->byteLength));
...
HXDLIN( 335)							_this5->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this5->byteLength));
...
HXDLIN( 335)									_this6->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength1));
...
HXDLIN( 335)									_this7->_hx_set_buffer(HX_CTX, bytes);
...
HXLINE( 337)				_gthis->_hx_set__hx___alphaTexture(HX_CTX, alphaTexture);
            			}
            			else {
...
HXDLIN( 342)						_this8->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this8->byteLength));
...
HXDLIN( 342)							_this9->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this9->byteLength));
...
HXDLIN( 342)									_this10->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength2));
...
HXDLIN( 342)									_this11->_hx_set_buffer(HX_CTX, bytes);
...
HXDLIN( 348)					_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN( 348)						_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN( 348)								_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN( 348)								_this3->_hx_set_buffer(HX_CTX, buffer);
