...
class HXCPP_CLASS_ATTRIBUTES FlxBaseAnimation_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::flixel::animation::FlxAnimationController _hx_set_parent(::hx::StackContext *_hx_ctx, ::flixel::animation::FlxAnimationController _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return parent=_hx_v; }
		::String name;
