...
HXLINE( 137)		this->_hx_set_buttons(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
...
HXDLIN( 127)		this->_hx_set_axis(HX_CTX, _g);
HXLINE(  84)		this->_hx_set_deadZoneMode(HX_CTX, ::flixel::input::gamepad::FlxGamepadDeadZoneMode_obj::INDEPENDENT_AXES_dyn());
HXLINE(  61)		this->connected = true;
HXLINE( 141)		this->id = ID;
HXLINE( 143)		this->_hx_set_manager(HX_CTX, Manager);
HXLINE( 145)		this->_hx_set_pressed(HX_CTX,  ::flixel::input::gamepad::lists::FlxGamepadButtonList_obj::__alloc( HX_CTX ,1,::hx::ObjectPtr<OBJ_>(this)));
HXLINE( 146)		this->_hx_set_released(HX_CTX,  ::flixel::input::gamepad::lists::FlxGamepadButtonList_obj::__alloc( HX_CTX ,0,::hx::ObjectPtr<OBJ_>(this)));
HXLINE( 147)		this->_hx_set_justPressed(HX_CTX,  ::flixel::input::gamepad::lists::FlxGamepadButtonList_obj::__alloc( HX_CTX ,2,::hx::ObjectPtr<OBJ_>(this)));
HXLINE( 148)		this->_hx_set_justReleased(HX_CTX,  ::flixel::input::gamepad::lists::FlxGamepadButtonList_obj::__alloc( HX_CTX ,-1,::hx::ObjectPtr<OBJ_>(this)));
HXLINE( 149)		this->_hx_set_analog(HX_CTX,  ::flixel::input::gamepad::lists::FlxGamepadAnalogList_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this)));
HXLINE( 150)		this->_hx_set_motion(HX_CTX,  ::flixel::input::gamepad::lists::FlxGamepadMotionValueList_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this)));
HXLINE( 151)		this->_hx_set_pointer(HX_CTX,  ::flixel::input::gamepad::lists::FlxGamepadPointerValueList_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this)));
...
HXLINE( 170)		this->_hx_set_detectedModel(HX_CTX, Model);
            	}
...
HXLINE( 182)			this->buttons->setCtx( HX_CTX, RawID,gamepadButton);
            		}
...
void FlxGamepad_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_0a9014dd1064fc14_288_destroy)
HXLINE( 289)		this->connected = false;
HXLINE( 291)		this->_hx_set_buttons(HX_CTX, null());
HXLINE( 292)		this->_hx_set_axis(HX_CTX, null());
HXLINE( 293)		this->_hx_set_manager(HX_CTX, null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGamepad_obj,get_name,return )
 ...
 ::flixel::input::gamepad::FlxGamepadModel FlxGamepad_obj::set_model( ::flixel::input::gamepad::FlxGamepadModel Model){
            	HX_GC_STACKFRAME(&_hx_pos_0a9014dd1064fc14_858_set_model)
HXLINE( 859)		this->_hx_set_model(HX_CTX, Model);
HXLINE( 860)		this->_hx_set_mapping(HX_CTX, this->createMappingForModel(this->model));
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGamepad_obj,set_model,return )
 ...
 ::flixel::input::gamepad::FlxGamepadAttachment FlxGamepad_obj::set_attachment( ::flixel::input::gamepad::FlxGamepadAttachment Attachment){
            	HX_GC_STACKFRAME(&_hx_pos_0a9014dd1064fc14_866_set_attachment)
HXLINE( 867)		this->_hx_set_attachment(HX_CTX, Attachment);
...
::String FlxGamepad_obj::toString(){
            	HX_GC_STACKFRAME(&_hx_pos_0a9014dd1064fc14_892_toString)
...
HXDLIN( 893)		_this->_hx_set_label(HX_CTX, HX_("id",db,5b,00,00));
HXDLIN( 893)		_this->_hx_set_value(HX_CTX, value);
...
HXDLIN( 894)		_this1->_hx_set_label(HX_CTX, HX_("model",a9,23,58,0c));
HXDLIN( 894)		_this1->_hx_set_value(HX_CTX, value1);
...
HXDLIN( 895)		_this2->_hx_set_label(HX_CTX, HX_("deadZone",f0,3e,2e,58));
HXDLIN( 895)		_this2->_hx_set_value(HX_CTX, value2);
...
::hx::Val FlxGamepad_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 2:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"axis") ) { _hx_set_axis(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"model") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_model(inValue.Cast<  ::flixel::input::gamepad::FlxGamepadModel >()) );_hx_set_model(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::FlxGamepadModel >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"analog") ) { _hx_set_analog(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::lists::FlxGamepadAnalogList >()); return inValue; }
		if (HX_FIELD_EQ(inName,"motion") ) { _hx_set_motion(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::lists::FlxGamepadMotionValueList >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"mapping") ) { _hx_set_mapping(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::mappings::FlxGamepadMapping >()); return inValue; }
		if (HX_FIELD_EQ(inName,"pressed") ) { _hx_set_pressed(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::lists::FlxGamepadButtonList >()); return inValue; }
		if (HX_FIELD_EQ(inName,"pointer") ) { _hx_set_pointer(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::lists::FlxGamepadPointerValueList >()); return inValue; }
		if (HX_FIELD_EQ(inName,"manager") ) { _hx_set_manager(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::FlxGamepadManager >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_device") ) { _hx_set__device(HX_CTX_GET,inValue.Cast<  ::openfl::ui::GameInputDevice >()); return inValue; }
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"released") ) { _hx_set_released(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::lists::FlxGamepadButtonList >()); return inValue; }
		break;
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"attachment") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_attachment(inValue.Cast<  ::flixel::input::gamepad::FlxGamepadAttachment >()) );_hx_set_attachment(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::FlxGamepadAttachment >()); return inValue; }
		if (HX_FIELD_EQ(inName,"axisActive") ) { axisActive=inValue.Cast< bool >(); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"justPressed") ) { _hx_set_justPressed(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::lists::FlxGamepadButtonList >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"deadZoneMode") ) { _hx_set_deadZoneMode(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::FlxGamepadDeadZoneMode >()); return inValue; }
		if (HX_FIELD_EQ(inName,"justReleased") ) { _hx_set_justReleased(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::lists::FlxGamepadButtonList >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"detectedModel") ) { _hx_set_detectedModel(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::FlxGamepadModel >()); return inValue; }
	}
