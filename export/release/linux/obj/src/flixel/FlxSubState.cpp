...
HXLINE(  53)		this->_hx_set_closeCallback(HX_CTX, null());
HXLINE(  54)		this->_hx_set_openCallback(HX_CTX, null());
HXLINE(  56)		if (::flixel::FlxG_obj::renderTile) {
HXLINE(  57)			this->_hx_set__bgSprite(HX_CTX,  ::flixel::_hx_system::FlxBGSprite_obj::__alloc( HX_CTX ));
            		}
...
void FlxSubState_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_4f421a3440b44d31_81_destroy)
HXLINE(  82)		this->super::destroy();
HXLINE(  83)		this->_hx_set_closeCallback(HX_CTX, null());
HXLINE(  84)		this->_hx_set_openCallback(HX_CTX, null());
HXLINE(  85)		this->_hx_set__parentState(HX_CTX, null());
HXLINE(  86)		this->_hx_set__bgSprite(HX_CTX, ( ( ::flixel::_hx_system::FlxBGSprite)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_bgSprite)) ));
            	}
...
::hx::Val FlxSubState_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"_bgSprite") ) { _hx_set__bgSprite(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::FlxBGSprite >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"openCallback") ) { _hx_set_openCallback(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_parentState") ) { _hx_set__parentState(HX_CTX_GET,inValue.Cast<  ::flixel::FlxState >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"closeCallback") ) { _hx_set_closeCallback(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
