...
class HXCPP_CLASS_ATTRIBUTES DrawCommandReader_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::openfl::display::_internal::DrawCommandBuffer _hx_set_buffer(::hx::StackContext *_hx_ctx, ::openfl::display::_internal::DrawCommandBuffer _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return buffer=_hx_v; }
		int bPos;
		int iiPos;
		int iPos;
		int ffPos;
		...
		inline  ::openfl::display::_internal::DrawCommandType _hx_set_prev(::hx::StackContext *_hx_ctx, ::openfl::display::_internal::DrawCommandType _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return prev=_hx_v; }
		int tsPos;
		void advance();
		::Dynamic advance_dyn();
