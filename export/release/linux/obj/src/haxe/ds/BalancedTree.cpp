...
void BalancedTree_obj::set( ::Dynamic key, ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_4f13c97c1ff92405_51_set)
HXDLIN(  51)		this->_hx_set_root(HX_CTX, this->setLoop(key,value,this->root));
            	}
...
bool BalancedTree_obj::remove( ::Dynamic key){
            	HX_GC_STACKFRAME(&_hx_pos_4f13c97c1ff92405_86_remove)
HXDLIN(  86)		try {
            			HX_STACK_CATCHABLE(::String, 0);
            			HX_STACK_CATCHABLE( ::haxe::ValueException, 1);
HXLINE(  87)			this->_hx_set_root(HX_CTX, this->removeLoop(key,this->root));
...
::hx::Val BalancedTree_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"root") ) { _hx_set_root(HX_CTX_GET,inValue.Cast<  ::haxe::ds::TreeNode >()); return inValue; }
	}
