...
class HXCPP_CLASS_ATTRIBUTES Mover_obj : public  ::flixel::_hx_system::debug::interaction::tools::Tool_obj
{
	...
	public:
		...
		bool _dragging;
		 ::flixel::math::FlxBasePoint _lastCursorPosition;
		inline  ::flixel::math::FlxBasePoint _hx_set__lastCursorPosition(::hx::StackContext *_hx_ctx, ::flixel::math::FlxBasePoint _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _lastCursorPosition=_hx_v; }
