...
void FloatVector_obj::__construct(::hx::Null< int >  __o_length,::hx::Null< bool >  __o_fixed,::cpp::VirtualArray array,::hx::Null< bool >  __o_forceCopy){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_055b1e986ae1a23a_977_new)
HXLINE( 978)		if (forceCopy) {
HXLINE( 980)			this->_hx_set__hx___array(HX_CTX, ::Array_obj< Float >::__new());
...
HXLINE( 987)			this->_hx_set__hx___array(HX_CTX, array);
            		}
...
::hx::Val FloatVector_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"__array") ) { _hx_set__hx___array(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
		break;
	case 11:
