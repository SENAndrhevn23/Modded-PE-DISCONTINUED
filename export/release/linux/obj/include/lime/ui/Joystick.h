...
class HXCPP_CLASS_ATTRIBUTES Joystick_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::lime::app::_Event_Int_Float_Void _hx_set_onAxisMove(::hx::StackContext *_hx_ctx, ::lime::app::_Event_Int_Float_Void _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onAxisMove=_hx_v; }
		 ::lime::app::_Event_Int_Void onButtonDown;
		inline  ::lime::app::_Event_Int_Void _hx_set_onButtonDown(::hx::StackContext *_hx_ctx, ::lime::app::_Event_Int_Void _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onButtonDown=_hx_v; }
		 ::lime::app::_Event_Int_Void onButtonUp;
		inline  ::lime::app::_Event_Int_Void _hx_set_onButtonUp(::hx::StackContext *_hx_ctx, ::lime::app::_Event_Int_Void _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onButtonUp=_hx_v; }
		 ::lime::app::_Event_Void_Void onDisconnect;
		inline  ::lime::app::_Event_Void_Void _hx_set_onDisconnect(::hx::StackContext *_hx_ctx, ::lime::app::_Event_Void_Void _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onDisconnect=_hx_v; }
		 ::lime::app::_Event_Int_lime_ui_JoystickHatPosition_Void onHatMove;
		inline  ::lime::app::_Event_Int_lime_ui_JoystickHatPosition_Void _hx_set_onHatMove(::hx::StackContext *_hx_ctx, ::lime::app::_Event_Int_lime_ui_JoystickHatPosition_Void _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onHatMove=_hx_v; }
		::String get_guid();
