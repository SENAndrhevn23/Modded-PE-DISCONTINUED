...
{
            	HX_GC_STACKFRAME(&_hx_pos_03d4cd0e01152a25_248_new)
...
HXLINE( 253)		( ( ::lime::_internal::graphics::BlurStack)(__this) )->_hx_set_n(HX_CTX, null());
            	}
		...
		inline  ::lime::_internal::graphics::BlurStack _hx_set_n(::hx::StackContext *_hx_ctx, ::lime::_internal::graphics::BlurStack _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return n=_hx_v; }
};
