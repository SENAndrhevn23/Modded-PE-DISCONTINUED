...
void BMFont_obj::__construct( ::flixel::graphics::frames::bmfont::BMFontInfo info, ::flixel::graphics::frames::bmfont::BMFontCommon common,::Array< ::Dynamic> pages,::Array< ::Dynamic> chars,::Array< ::Dynamic> kerning){
            	HX_GC_STACKFRAME(&_hx_pos_4a007ae567d5ade1_17_new)
HXLINE(  23)		this->_hx_set_kerning(HX_CTX, null());
HXLINE(  27)		this->_hx_set_info(HX_CTX, info);
HXLINE(  28)		this->_hx_set_common(HX_CTX, common);
HXLINE(  29)		this->_hx_set_pages(HX_CTX, pages);
HXLINE(  30)		this->_hx_set_chars(HX_CTX, chars);
HXLINE(  31)		this->_hx_set_kerning(HX_CTX, kerning);
            	}
...
::hx::Val BMFont_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"info") ) { _hx_set_info(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::frames::bmfont::BMFontInfo >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"pages") ) { _hx_set_pages(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"chars") ) { _hx_set_chars(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"common") ) { _hx_set_common(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::frames::bmfont::BMFontCommon >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"kerning") ) { _hx_set_kerning(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
