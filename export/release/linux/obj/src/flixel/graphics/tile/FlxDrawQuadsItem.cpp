...
HXLINE(  27)		this->_hx_set_type(HX_CTX, ::flixel::graphics::tile::FlxDrawItemType_obj::TILES_dyn());
HXLINE(  28)		int length = null();
HXDLIN(  28)		bool fixed = null();
HXDLIN(  28)		::Array< Float > array = null();
HXDLIN(  28)		this->_hx_set_rects(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,array,true));
HXLINE(  29)		int length1 = null();
HXDLIN(  29)		bool fixed1 = null();
HXDLIN(  29)		::Array< Float > array1 = null();
HXDLIN(  29)		this->_hx_set_transforms(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length1,fixed1,array1,true));
HXLINE(  30)		this->_hx_set_alphas(HX_CTX, ::Array_obj< Float >::__new(0));
            	}
...
void FlxDrawQuadsItem_obj::dispose(){
            	HX_GC_STACKFRAME(&_hx_pos_6d98322fc3998392_46_dispose)
HXLINE(  47)		this->super::dispose();
HXLINE(  48)		this->_hx_set_rects(HX_CTX, null());
HXLINE(  49)		this->_hx_set_transforms(HX_CTX, null());
HXLINE(  50)		this->_hx_set_alphas(HX_CTX, null());
HXLINE(  51)		this->_hx_set_colorMultipliers(HX_CTX, null());
HXLINE(  52)		this->_hx_set_colorOffsets(HX_CTX, null());
            	}
...
void FlxDrawQuadsItem_obj::addQuad( ::flixel::graphics::frames::FlxFrame frame, ::flixel::math::FlxMatrix matrix, ::openfl::geom::ColorTransform transform){
            	HX_GC_STACKFRAME(&_hx_pos_6d98322fc3998392_56_addQuad)
...
HXLINE(  77)				this->_hx_set_colorMultipliers(HX_CTX, ::Array_obj< Float >::__new(0));
            			}
HXLINE(  79)			if (::hx::IsNull( this->colorOffsets )) {
HXLINE(  80)				this->_hx_set_colorOffsets(HX_CTX, ::Array_obj< Float >::__new(0));
            			}
HXLINE(  82)			{
HXLINE(  82)				int _g = 0;
...
void FlxDrawQuadsItem_obj::render( ::flixel::FlxCamera camera){
            	HX_GC_STACKFRAME(&_hx_pos_6d98322fc3998392_114_render)
...
HXLINE( 119)		shader->bitmap->_hx_set_input(HX_CTX, this->graphics->bitmap);
...
HXDLIN( 120)		shader->bitmap->_hx_set_filter(HX_CTX, _hx_tmp);
HXLINE( 121)		shader->alpha->_hx_set_value(HX_CTX, this->alphas);
...
HXLINE( 125)			shader->colorMultiplier->_hx_set_value(HX_CTX, this->colorMultipliers);
HXLINE( 126)			shader->colorOffset->_hx_set_value(HX_CTX, this->colorOffsets);
            		}
HXLINE( 129)		{
HXLINE( 129)			 ::openfl::display::ShaderParameter_Bool parameter = shader->hasTransform;
HXDLIN( 129)			if (::hx::IsNull( parameter->value )) {
HXLINE( 129)				parameter->_hx_set_value(HX_CTX, ::Array_obj< bool >::__new(0));
            			}
...
HXLINE( 130)				parameter1->_hx_set_value(HX_CTX, ::Array_obj< bool >::__new(0));
            			}
...
void FlxDrawQuadsItem_obj::setParameterValue( ::openfl::display::ShaderParameter_Bool parameter,bool value){
            	HX_GC_STACKFRAME(&_hx_pos_6d98322fc3998392_141_setParameterValue)
HXLINE( 142)		if (::hx::IsNull( parameter->value )) {
HXLINE( 143)			parameter->_hx_set_value(HX_CTX, ::Array_obj< bool >::__new(0));
            		}
...
::hx::Val FlxDrawQuadsItem_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"rects") ) { _hx_set_rects(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::FloatVector >()); return inValue; }
		break;
	case 6:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"transforms") ) { _hx_set_transforms(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::FloatVector >()); return inValue; }
		break;
	case 12:
