...
void TransitionFade_obj::__construct( ::flixel::addons::transition::TransitionData data){
            	HX_GC_STACKFRAME(&_hx_pos_85f0573c4a29b283_51_new)
HXLINE(  52)		super::__construct(data);
HXLINE(  54)		this->_hx_set_back(HX_CTX, this->makeSprite(data->direction->x,data->direction->y,data->region));
HXLINE(  55)		{
...
void TransitionFade_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_85f0573c4a29b283_60_destroy)
HXLINE(  61)		this->super::destroy();
HXLINE(  62)		this->_hx_set_back(HX_CTX, null());
            	}
...
::hx::Val TransitionFade_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"back") ) { _hx_set_back(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSprite >()); return inValue; }
	}
