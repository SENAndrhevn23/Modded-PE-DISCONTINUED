...
void FlxBaseAnimation_obj::__construct( ::flixel::animation::FlxAnimationController Parent,::String Name){
            	HX_GC_STACKFRAME(&_hx_pos_bb2d225a438df606_8_new)
HXLINE(  23)		this->curIndex = 0;
HXLINE(  39)		this->_hx_set_parent(HX_CTX, Parent);
HXLINE(  40)		this->_hx_set_name(HX_CTX, Name);
            	}
...
void FlxBaseAnimation_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_bb2d225a438df606_44_destroy)
HXLINE(  45)		this->_hx_set_parent(HX_CTX, null());
HXLINE(  46)		this->_hx_set_name(HX_CTX, null());
            	}
...
::hx::Val FlxBaseAnimation_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"parent") ) { _hx_set_parent(HX_CTX_GET,inValue.Cast<  ::flixel::animation::FlxAnimationController >()); return inValue; }
		break;
	case 8:
