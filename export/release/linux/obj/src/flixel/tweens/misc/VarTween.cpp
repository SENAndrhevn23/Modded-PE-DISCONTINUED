...
bool VarTween_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::tweens::misc::VarTween VarTween_obj::tween( ::Dynamic object, ::Dynamic properties,Float duration){
            	HX_GC_STACKFRAME(&_hx_pos_a4370a0a6fec63c7_27_tween)
HXLINE(  35)		this->_hx_set__object(HX_CTX, object);
HXLINE(  36)		this->_hx_set__properties(HX_CTX, properties);
HXLINE(  37)		this->_hx_set__propertyInfos(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
...
void VarTween_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_a4370a0a6fec63c7_111_destroy)
HXLINE( 112)		this->super::destroy();
HXLINE( 113)		this->_hx_set__object(HX_CTX, null());
HXLINE( 114)		this->_hx_set__properties(HX_CTX, null());
HXLINE( 115)		this->_hx_set__propertyInfos(HX_CTX, null());
            	}
...
::hx::Val VarTween_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"_object") ) { _hx_set__object(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"_properties") ) { _hx_set__properties(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"_propertyInfos") ) { _hx_set__propertyInfos(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
