...
class HXCPP_CLASS_ATTRIBUTES InteractiveObject_obj : public  ::openfl::display::DisplayObject_obj
{
	...
	public:
		...
		bool doubleClickEnabled;
		 ::Dynamic focusRect;
		inline  ::Dynamic _hx_set_focusRect(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return focusRect=_hx_v; }
		bool mouseEnabled;
		bool needsSoftKeyboard;
		 ::openfl::geom::Rectangle softKeyboardInputAreaOfInterest;
		inline  ::openfl::geom::Rectangle _hx_set_softKeyboardInputAreaOfInterest(::hx::StackContext *_hx_ctx, ::openfl::geom::Rectangle _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return softKeyboardInputAreaOfInterest=_hx_v; }
		 ::Dynamic _hx___tabEnabled;
		inline  ::Dynamic _hx_set__hx___tabEnabled(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___tabEnabled=_hx_v; }
		int _hx___tabIndex;
