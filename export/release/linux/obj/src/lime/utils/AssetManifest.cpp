...
void AssetManifest_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_8a07fa6861abdf37_26_new)
HXLINE(  27)		this->_hx_set_assets(HX_CTX, ::cpp::VirtualArray_obj::__new(0));
HXLINE(  28)		this->_hx_set_libraryArgs(HX_CTX, ::Array_obj< ::String >::__new(0));
 ...
 ::lime::app::Future AssetManifest_obj::loadFromFile(::String path,::String rootPath){
            		HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0,::Array< ::String >,rootPath1) HXARGC(1)
            		 ::lime::app::Future _hx_run( ::haxe::io::Bytes bytes){
            			HX_GC_STACKFRAME(&_hx_pos_8a07fa6861abdf37_68_loadFromFile)
HXLINE(  68)			return ::lime::app::Future_obj::withValue(::lime::utils::AssetManifest_obj::fromBytes(bytes,rootPath1->__get(0)));
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_GC_STACKFRAME(&_hx_pos_8a07fa6861abdf37_60_loadFromFile)
...
HXLINE(  62)		rootPath1->setCtx( HX_CTX, 0,::lime::utils::AssetManifest_obj::_hx___resolveRootPath(rootPath1->__get(0),path));
...
HXLINE(  82)			manifest->_hx_set_name(HX_CTX, ( (::String)(manifestData->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) ));
            		}
HXLINE(  85)		if (::Reflect_obj::hasField(manifestData,HX_("libraryType",55,df,f0,ae))) {
HXLINE(  87)			manifest->_hx_set_libraryType(HX_CTX, ( (::String)(manifestData->__Field(HX_("libraryType",55,df,f0,ae),::hx::paccDynamic)) ));
            		}
HXLINE(  90)		if (::Reflect_obj::hasField(manifestData,HX_("libraryArgs",f8,79,5c,a2))) {
HXLINE(  92)			manifest->_hx_set_libraryArgs(HX_CTX, ( (::Array< ::String >)(manifestData->__Field(HX_("libraryArgs",f8,79,5c,a2),::hx::paccDynamic)) ));
            		}
...
HXLINE( 100)				manifest->_hx_set_assets(HX_CTX, ( (::cpp::VirtualArray)(::haxe::Unserializer_obj::run(( (::String)(assets) ))) ));
            			}
            			else {
HXLINE( 104)				manifest->_hx_set_assets(HX_CTX, ( (::cpp::VirtualArray)(assets) ));
            			}
            		}
HXLINE( 108)		if (::Reflect_obj::hasField(manifestData,HX_("rootPath",e7,b8,88,e1))) {
HXLINE( 110)			manifest->_hx_set_rootPath(HX_CTX, ( (::String)(manifestData->__Field(HX_("rootPath",e7,b8,88,e1),::hx::paccDynamic)) ));
            		}
...
HXLINE( 117)				manifest->_hx_set_rootPath(HX_CTX, rootPath);
            			}
            			else {
HXLINE( 121)				manifest->_hx_set_rootPath(HX_CTX, ((rootPath + HX_("/",2f,00,00,00)) + manifest->rootPath));
            			}
            		}
...
::hx::Val AssetManifest_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"assets") ) { _hx_set_assets(HX_CTX_GET,inValue.Cast< ::cpp::VirtualArray >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"version") ) { version=inValue.Cast< int >(); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"rootPath") ) { _hx_set_rootPath(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"libraryArgs") ) { _hx_set_libraryArgs(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"libraryType") ) { _hx_set_libraryType(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	}
