...
class HXCPP_CLASS_ATTRIBUTES FlxGamepadManager_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::flixel::input::gamepad::FlxGamepad _hx_set_firstActive(::hx::StackContext *_hx_ctx, ::flixel::input::gamepad::FlxGamepad _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return firstActive=_hx_v; }
		 ::flixel::input::gamepad::FlxGamepad lastActive;
		inline  ::flixel::input::gamepad::FlxGamepad _hx_set_lastActive(::hx::StackContext *_hx_ctx, ::flixel::input::gamepad::FlxGamepad _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return lastActive=_hx_v; }
		 ::Dynamic globalDeadZone;
		inline  ::Dynamic _hx_set_globalDeadZone(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return globalDeadZone=_hx_v; }
		 ::flixel::util::_FlxSignal::FlxSignal1 deviceConnected;
		inline  ::flixel::util::_FlxSignal::FlxSignal1 _hx_set_deviceConnected(::hx::StackContext *_hx_ctx, ::flixel::util::_FlxSignal::FlxSignal1 _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return deviceConnected=_hx_v; }
		 ::flixel::util::_FlxSignal::FlxSignal1 deviceDisconnected;
		inline  ::flixel::util::_FlxSignal::FlxSignal1 _hx_set_deviceDisconnected(::hx::StackContext *_hx_ctx, ::flixel::util::_FlxSignal::FlxSignal1 _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return deviceDisconnected=_hx_v; }
		::Array< ::Dynamic> _gamepads;
		inline ::Array< ::Dynamic> _hx_set__gamepads(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _gamepads=_hx_v; }
		::Array< ::Dynamic> _activeGamepads;
		inline ::Array< ::Dynamic> _hx_set__activeGamepads(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _activeGamepads=_hx_v; }
