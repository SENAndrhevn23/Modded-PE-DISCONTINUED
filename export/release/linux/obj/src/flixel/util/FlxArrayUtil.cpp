...
::Array< ::Dynamic> FlxArrayUtil_obj::fastSplice_flixel_tweens_FlxTween(::Array< ::Dynamic> array, ::flixel::tweens::FlxTween element){
            	HX_GC_STACKFRAME(&_hx_pos_80883519d7ae1644_47_fastSplice_flixel_tweens_FlxTween)
HXLINE(  48)		int index = array->indexOf(element,null());
HXLINE(  49)		if ((index != -1)) {
HXLINE(  50)			array->setCtx( HX_CTX, index,array->__get((array->length - 1)).StaticCast<  ::flixel::tweens::FlxTween >());
...
::Array< ::Dynamic> FlxArrayUtil_obj::fastSplice_flixel_util_FlxTimer(::Array< ::Dynamic> array, ::flixel::util::FlxTimer element){
            	HX_GC_STACKFRAME(&_hx_pos_80883519d7ae1644_47_fastSplice_flixel_util_FlxTimer)
HXLINE(  48)		int index = array->indexOf(element,null());
HXLINE(  49)		if ((index != -1)) {
HXLINE(  50)			array->setCtx( HX_CTX, index,array->__get((array->length - 1)).StaticCast<  ::flixel::util::FlxTimer >());
