...
HXLINE( 935)		this->_hx_set__groupMembers(HX_CTX, groupMembers);
HXLINE( 936)		this->_hx_set__filter(HX_CTX, filter);
...
::hx::Val FlxTypedGroupIterator_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"_filter") ) { _hx_set__filter(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"_groupMembers") ) { _hx_set__groupMembers(HX_CTX_GET,inValue.Cast< ::cpp::VirtualArray >()); return inValue; }
	}
