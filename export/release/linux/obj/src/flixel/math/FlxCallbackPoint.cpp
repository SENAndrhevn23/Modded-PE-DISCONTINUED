...
void FlxCallbackPoint_obj::__construct( ::Dynamic setXCallback, ::Dynamic setYCallback, ::Dynamic setXYCallback){
            	HX_GC_STACKFRAME(&_hx_pos_0e989bab684323cb_1595_new)
HXLINE(1596)		super::__construct(null(),null());
HXLINE(1598)		this->_hx_set__setXCallback(HX_CTX, setXCallback);
HXLINE(1599)		this->_hx_set__setYCallback(HX_CTX, setXYCallback);
HXLINE(1600)		this->_hx_set__setXYCallback(HX_CTX, setXYCallback);
HXLINE(1602)		if (::hx::IsNotNull( this->_setXCallback )) {
HXLINE(1604)			if (::hx::IsNull( this->_setYCallback )) {
HXLINE(1605)				this->_hx_set__setYCallback(HX_CTX, setXCallback);
            			}
HXLINE(1606)			if (::hx::IsNull( this->_setXYCallback )) {
HXLINE(1607)				this->_hx_set__setXYCallback(HX_CTX, setXCallback);
            			}
            		}
            	}
...
void FlxCallbackPoint_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_0e989bab684323cb_1636_destroy)
HXLINE(1637)		this->super::destroy();
HXLINE(1638)		this->_hx_set__setXCallback(HX_CTX, null());
HXLINE(1639)		this->_hx_set__setYCallback(HX_CTX, null());
HXLINE(1640)		this->_hx_set__setXYCallback(HX_CTX, null());
            	}
...
::hx::Val FlxCallbackPoint_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 13:
		if (HX_FIELD_EQ(inName,"_setXCallback") ) { _hx_set__setXCallback(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_setYCallback") ) { _hx_set__setYCallback(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"_setXYCallback") ) { _hx_set__setXYCallback(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
