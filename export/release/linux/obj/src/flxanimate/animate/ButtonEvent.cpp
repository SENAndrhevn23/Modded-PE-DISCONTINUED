...
void ButtonEvent_obj::__construct( ::Dynamic Callback, ::flixel::sound::FlxSound sound){
            	HX_GC_STACKFRAME(&_hx_pos_b67213b30387cfdc_24_new)
HXLINE(  25)		this->_hx_set_callback(HX_CTX, Callback);
HXLINE(  28)		this->_hx_set_sound(HX_CTX, sound);
            	}
...
void ButtonEvent_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_b67213b30387cfdc_36_destroy)
HXLINE(  37)		this->_hx_set_callback(HX_CTX, null());
...
::hx::Val ButtonEvent_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"sound") ) { _hx_set_sound(HX_CTX_GET,inValue.Cast<  ::flixel::sound::FlxSound >()); return inValue; }
		break;
	case 8:
