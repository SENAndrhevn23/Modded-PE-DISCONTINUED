...
HXLINE( 161)		this->_hx_set_events(HX_CTX, ::Array_obj< bool >::__new());
HXLINE( 162)		{
...
HXLINE( 165)		this->_hx_set_onOpening(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE( 166)		this->_hx_set_onPlaying(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE( 167)		this->_hx_set_onStopped(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE( 168)		this->_hx_set_onPaused(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE( 169)		this->_hx_set_onEndReached(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE( 170)		this->_hx_set_onEncounteredError(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE( 171)		this->_hx_set_onForward(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE( 172)		this->_hx_set_onBackward(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE( 173)		this->_hx_set_onMediaChanged(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE( 174)		this->_hx_set_onTextureSetup(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE( 185)		this->instance = libvlc_new(0,NULL);
            	}
...
HXLINE( 197)			this->mediaItem = libvlc_media_new_location(this->instance,location.utf8_str());
            		}
            		else {
HXLINE( 198)			if (::hx::IsNotNull( location )) {
HXLINE( 203)				 libvlc_instance_t* _hx_tmp1 = this->instance;
HXDLIN( 203)				this->mediaItem = libvlc_media_new_path(_hx_tmp1,::haxe::io::Path_obj::normalize(location).utf8_str());
            			}
            			else {
HXLINE( 207)				return -1;
            			}
            		}
HXLINE( 209)		const char* _hx_tmp2;
HXDLIN( 209)		if (shouldLoop) {
HXLINE( 209)			_hx_tmp2 = HX_("input-repeat=65535",d9,23,75,20).utf8_str();
            		}
            		else {
HXLINE( 209)			_hx_tmp2 = HX_("input-repeat=0",51,79,b7,c1).utf8_str();
            		}
HXDLIN( 209)		libvlc_media_add_option(this->mediaItem,_hx_tmp2);
...
HXLINE( 218)		 libvlc_media_player_t* _hx_tmp3 = this->mediaPlayer;
HXDLIN( 218)		::cpp::Function< unsigned int  (void**,char*,unsigned int*,unsigned int*,unsigned int*,unsigned int*) > _hx_tmp4 = format_setup;
HXDLIN( 218)		libvlc_video_set_format_callbacks(_hx_tmp3,_hx_tmp4,NULL);
HXLINE( 219)		 libvlc_media_player_t* _hx_tmp5 = this->mediaPlayer;
HXDLIN( 219)		::cpp::Function< void*  (void*,void**) > _hx_tmp6 = lock;
HXDLIN( 219)		::cpp::Function< void  (void*,void*, void *const *) > _hx_tmp7 = NULL;
HXDLIN( 219)		::cpp::Function< void  (void*,void*) > _hx_tmp8 = NULL;
HXDLIN( 219)		libvlc_video_set_callbacks(_hx_tmp5,_hx_tmp6,_hx_tmp7,_hx_tmp8,this);
...
void Video_obj::dispose(){
            	HX_GC_STACKFRAME(&_hx_pos_ce6549ff18c97568_251_dispose)
...
HXLINE( 269)			this->_hx_set_texture(HX_CTX, null());
            		}
...
HXLINE( 298)			return ( (int)(libvlc_media_player_get_time(this->mediaPlayer)) );
            		}
HXLINE( 304)		return -1;
            	}
...
HXLINE( 336)			return ( (int)(libvlc_media_player_get_length(this->mediaPlayer)) );
            		}
HXLINE( 342)		return -1;
            	}
...
HXLINE( 350)			return ( (int)(libvlc_media_get_duration(this->mediaItem)) );
            		}
HXLINE( 356)		return -1;
            	}
...
HXLINE( 404)			return ( (int)(libvlc_audio_get_delay(this->mediaPlayer)) );
            		}
HXLINE( 410)		return -1;
            	}
...
HXLINE( 485)			 ::hxcodec::openfl::Video _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 485)			_hx_tmp1->deltaTime = (_hx_tmp1->deltaTime + elapsed);
...
HXLINE( 492)				_hx_tmp2 = ::hx::IsNotNull( this->pixels );
            			}
            			else {
HXLINE( 492)				_hx_tmp2 = false;
            			}
HXDLIN( 492)			if (_hx_tmp2) {
HXLINE( 493)				 ::openfl::display3D::textures::RectangleTexture _hx_tmp3 = this->texture;
...
HXDLIN( 493)				_hx_tmp3->uploadFromByteArray(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytesData(result),0);
            			}
...
void Video_obj::checkEvents(){
            	HX_GC_STACKFRAME(&_hx_pos_ce6549ff18c97568_501_checkEvents)
...
HXLINE( 570)			this->_hx_set_texture(HX_CTX, ::openfl::Lib_obj::get_current()->stage->context3D->createRectangleTexture(this->videoWidth,this->videoHeight,1,true));
...
::hx::Val Video_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"events") ) { _hx_set_events(HX_CTX_GET,inValue.Cast< ::Array< bool > >()); return inValue; }
		break;
	case 7:
		...
		if (HX_FIELD_EQ(inName,"texture") ) { _hx_set_texture(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::textures::RectangleTexture >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"position") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_position(inValue.Cast< float >()) ); }
		if (HX_FIELD_EQ(inName,"onPaused") ) { _hx_set_onPaused(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"onOpening") ) { _hx_set_onOpening(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onPlaying") ) { _hx_set_onPlaying(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onStopped") ) { _hx_set_onStopped(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onForward") ) { _hx_set_onForward(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"onBackward") ) { _hx_set_onBackward(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"videoHeight") ) { videoHeight=inValue.Cast< int >(); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"onEndReached") ) { _hx_set_onEndReached(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"onMediaChanged") ) { _hx_set_onMediaChanged(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onTextureSetup") ) { _hx_set_onTextureSetup(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"onEncounteredError") ) { _hx_set_onEncounteredError(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
	}
