...
void EReg_obj::__construct(::String r,::String opt){
            	HX_GC_STACKFRAME(&_hx_pos_0f9ac110bd093a4e_28_new)
...
bool EReg_obj::match(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_0f9ac110bd093a4e_36_match)
HXLINE(  37)		bool p = _hx_regexp_match(this->r,s,0,s.length);
HXLINE(  38)		if (p) {
HXLINE(  39)			this->_hx_set_last(HX_CTX, s);
            		}
            		else {
HXLINE(  41)			this->_hx_set_last(HX_CTX, null());
            		}
HXLINE(  42)		return p;
            	}
...
bool EReg_obj::matchSub(::String s,int pos,::hx::Null< int >  __o_len){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_0f9ac110bd093a4e_65_matchSub)
HXLINE(  66)		int p;
HXDLIN(  66)		if ((len < 0)) {
...
HXLINE(  67)		if (p1) {
HXLINE(  68)			this->_hx_set_last(HX_CTX, s);
            		}
            		else {
HXLINE(  70)			this->_hx_set_last(HX_CTX, null());
            		}
HXLINE(  71)		return p1;
            	}
...
HXLINE( 124)								b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_2dda4a0f_11,1));
            							}
            							else {
...
HXLINE( 131)								b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_2dda4a0f_12,1));
            							}
            							else {
...
HXLINE( 156)							buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            						}
            						else {
...
HXLINE( 160)					buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1)));
            				}
            				else {
...
HXLINE( 161)					buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2)));
            				}
            				else {
...
HXLINE( 163)						buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3)));
            					}
            					else {
...
HXLINE( 169)				buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4)));
            			}
            			else {
...
::hx::Val EReg_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 1:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"last") ) { _hx_set_last(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 6:
