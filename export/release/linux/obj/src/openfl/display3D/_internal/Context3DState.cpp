...
HXLINE(  79)		this->_hx_set_blendDestinationAlphaFactor(HX_CTX, 9);
HXLINE(  80)		this->_hx_set_blendSourceAlphaFactor(HX_CTX, 2);
HXLINE(  81)		this->_hx_set_blendDestinationRGBFactor(HX_CTX, 9);
HXLINE(  82)		this->_hx_set_blendSourceRGBFactor(HX_CTX, 2);
...
HXLINE(  87)		this->_hx_set_culling(HX_CTX, 3);
HXLINE(  88)		this->_hx_set_depthCompareMode(HX_CTX, 4);
HXLINE(  89)		this->depthMask = true;
HXLINE(  90)		this->_hx_set_samplerStates(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE(  91)		this->_hx_set_scissorRectangle(HX_CTX,  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
HXLINE(  92)		this->_hx_set_stencilCompareMode(HX_CTX, 0);
HXLINE(  93)		this->_hx_set_stencilDepthFail(HX_CTX, 5);
HXLINE(  94)		this->_hx_set_stencilFail(HX_CTX, 5);
HXLINE(  95)		this->_hx_set_stencilPass(HX_CTX, 5);
HXLINE(  96)		this->stencilReadMask = 255;
HXLINE(  97)		this->stencilReferenceValue = 0;
HXLINE(  98)		this->_hx_set_stencilTriangleFace(HX_CTX, 2);
HXLINE(  99)		this->stencilWriteMask = 255;
HXLINE( 100)		this->_hx_set_textures(HX_CTX, ::Array_obj< ::Dynamic>::__new());
...
::hx::Val Context3DState_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"shader") ) { _hx_set_shader(HX_CTX_GET,inValue.Cast<  ::openfl::display::Shader >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"culling") ) { _hx_set_culling(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"program") ) { _hx_set_program(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::Program3D >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"textures") ) { _hx_set_textures(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"depthMask") ) { depthMask=inValue.Cast< bool >(); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"stencilFail") ) { _hx_set_stencilFail(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"stencilPass") ) { _hx_set_stencilPass(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 12:
	...
	case 13:
		...
		if (HX_FIELD_EQ(inName,"samplerStates") ) { _hx_set_samplerStates(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 14:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"renderToTexture") ) { _hx_set_renderToTexture(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::textures::TextureBase >()); return inValue; }
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"depthCompareMode") ) { _hx_set_depthCompareMode(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"scissorRectangle") ) { _hx_set_scissorRectangle(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
		if (HX_FIELD_EQ(inName,"stencilDepthFail") ) { _hx_set_stencilDepthFail(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	...
	case 17:
		...
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"stencilCompareMode") ) { _hx_set_stencilCompareMode(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__enableGLCullFace") ) { _hx___enableGLCullFace=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__rttGLFramebuffer") ) { _hx_set__hx___rttGLFramebuffer(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"stencilTriangleFace") ) { _hx_set_stencilTriangleFace(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__enableGLDepthTest") ) { _hx___enableGLDepthTest=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__rttGLRenderbuffer") ) { _hx_set__hx___rttGLRenderbuffer(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"blendSourceRGBFactor") ) { _hx_set_blendSourceRGBFactor(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__currentGLTexture2D") ) { _hx_set__hx___currentGLTexture2D(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 21:
		...
		break;
	case 22:
		if (HX_FIELD_EQ(inName,"blendSourceAlphaFactor") ) { _hx_set_blendSourceAlphaFactor(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__currentGLArrayBuffer") ) { _hx_set__hx___currentGLArrayBuffer(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__currentGLFramebuffer") ) { _hx_set__hx___currentGLFramebuffer(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__primaryGLFramebuffer") ) { _hx_set__hx___primaryGLFramebuffer(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 24:
		if (HX_FIELD_EQ(inName,"renderToTextureAntiAlias") ) { renderToTextureAntiAlias=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__rttDepthGLRenderbuffer") ) { _hx_set__hx___rttDepthGLRenderbuffer(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 25:
		if (HX_FIELD_EQ(inName,"blendDestinationRGBFactor") ) { _hx_set_blendDestinationRGBFactor(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__currentGLTextureCubeMap") ) { _hx_set__hx___currentGLTextureCubeMap(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 26:
		if (HX_FIELD_EQ(inName,"__rttStencilGLRenderbuffer") ) { _hx_set__hx___rttStencilGLRenderbuffer(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 27:
		if (HX_FIELD_EQ(inName,"blendDestinationAlphaFactor") ) { _hx_set_blendDestinationAlphaFactor(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"renderToTextureDepthStencil") ) { renderToTextureDepthStencil=inValue.Cast< bool >(); return inValue; }
		break;
	case 29:
		if (HX_FIELD_EQ(inName,"__currentGLElementArrayBuffer") ) { _hx_set__hx___currentGLElementArrayBuffer(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 30:
