...
class HXCPP_CLASS_ATTRIBUTES FlxLinkedList_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::flixel::_hx_system::FlxLinkedList _hx_set_next(::hx::StackContext *_hx_ctx, ::flixel::_hx_system::FlxLinkedList _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return next=_hx_v; }
		bool exists;
		void destroy();
		::Dynamic destroy_dyn();
