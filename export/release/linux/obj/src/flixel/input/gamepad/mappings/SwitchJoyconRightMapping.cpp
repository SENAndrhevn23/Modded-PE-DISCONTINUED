...
void SwitchJoyconRightMapping_obj::initValues(){
            	HX_GC_STACKFRAME(&_hx_pos_41147a5694d65537_23_initValues)
HXLINE(  24)		this->_hx_set_leftStick(HX_CTX, ::flixel::input::gamepad::id::SwitchJoyconRightID_obj::LEFT_ANALOG_STICK);
