...
HXLINE( 127)		this->_hx_set_owner(HX_CTX, target);
HXLINE( 129)		this->_hx_set_maxSize(HX_CTX,  ::openfl::geom::Point_obj::__alloc( HX_CTX ,width,height));
HXLINE( 131)		this->_hx_set__shadow(HX_CTX,  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,1,2,true,-16777216),null(),null()));
HXLINE( 132)		this->_hx_set__background(HX_CTX,  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,1,1,true,-12961222),null(),null()));
HXLINE( 134)		this->_hx_set_textField(HX_CTX, ::flixel::_hx_system::debug::DebuggerUtil_obj::createTextField(2,1,null(),null()));
...
void TooltipOverlay_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_5991393b6edf960d_157_destroy)
HXLINE( 158)		this->_hx_set__shadow(HX_CTX, ( ( ::openfl::display::Bitmap)(::flixel::util::FlxDestroyUtil_obj::removeChild(::hx::ObjectPtr<OBJ_>(this),this->_shadow)) ));
HXLINE( 159)		this->_hx_set__background(HX_CTX, ( ( ::openfl::display::Bitmap)(::flixel::util::FlxDestroyUtil_obj::removeChild(::hx::ObjectPtr<OBJ_>(this),this->_background)) ));
HXLINE( 160)		this->_hx_set_textField(HX_CTX, ( ( ::openfl::text::TextField)(::flixel::util::FlxDestroyUtil_obj::removeChild(::hx::ObjectPtr<OBJ_>(this),this->textField)) ));
HXLINE( 161)		this->_hx_set_maxSize(HX_CTX, null());
...
HXLINE( 168)		this->_hx_set_owner(HX_CTX, null());
            	}
...
::hx::Val TooltipOverlay_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"owner") ) { _hx_set_owner(HX_CTX_GET,inValue.Cast<  ::openfl::display::Sprite >()); return inValue; }
		break;
	case 6:
