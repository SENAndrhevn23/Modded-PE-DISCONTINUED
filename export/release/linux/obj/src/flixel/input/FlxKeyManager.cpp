...
HXLINE(  58)		this->_hx_set__keyListMap(HX_CTX,  ::haxe::ds::IntMap_obj::__alloc( HX_CTX ));
HXLINE(  53)		this->_hx_set__keyListArray(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  26)		this->_hx_set_preventDefaultKeys(HX_CTX, ::cpp::VirtualArray_obj::__new(0));
...
HXLINE( 254)		this->_hx_set_pressed(HX_CTX, createKeyList(1,::hx::ObjectPtr<OBJ_>(this)));
HXLINE( 255)		this->_hx_set_released(HX_CTX, createKeyList(0,::hx::ObjectPtr<OBJ_>(this)));
HXLINE( 256)		this->_hx_set_justPressed(HX_CTX, createKeyList(2,::hx::ObjectPtr<OBJ_>(this)));
HXLINE( 257)		this->_hx_set_justReleased(HX_CTX, createKeyList(-1,::hx::ObjectPtr<OBJ_>(this)));
            	}
...
void FlxKeyManager_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_dc302cd06b06584e_230_destroy)
HXLINE( 231)		this->_hx_set__keyListArray(HX_CTX, null());
HXLINE( 232)		this->_hx_set__keyListMap(HX_CTX, null());
            	}
...
::hx::Val FlxKeyManager_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"pressed") ) { _hx_set_pressed(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"released") ) { _hx_set_released(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"justPressed") ) { _hx_set_justPressed(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_keyListMap") ) { _hx_set__keyListMap(HX_CTX_GET,inValue.Cast<  ::haxe::ds::IntMap >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"justReleased") ) { _hx_set_justReleased(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"_keyListArray") ) { _hx_set__keyListArray(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"preventDefaultKeys") ) { _hx_set_preventDefaultKeys(HX_CTX_GET,inValue.Cast< ::cpp::VirtualArray >()); return inValue; }
	}
