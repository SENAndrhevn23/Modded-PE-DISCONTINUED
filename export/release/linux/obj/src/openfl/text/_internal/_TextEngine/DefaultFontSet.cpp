...
void DefaultFontSet_obj::__construct( ::openfl::text::Font normal, ::openfl::text::Font bold, ::openfl::text::Font italic, ::openfl::text::Font boldItalic){
            	HX_GC_STACKFRAME(&_hx_pos_eeef98c53cb575cc_2014_new)
HXLINE(2015)		this->_hx_set_normal(HX_CTX, normal);
HXLINE(2016)		this->_hx_set_bold(HX_CTX, bold);
HXLINE(2017)		this->_hx_set_italic(HX_CTX, italic);
HXLINE(2018)		this->_hx_set_boldItalic(HX_CTX, boldItalic);
            	}
...
::hx::Val DefaultFontSet_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"bold") ) { _hx_set_bold(HX_CTX_GET,inValue.Cast<  ::openfl::text::Font >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"italic") ) { _hx_set_italic(HX_CTX_GET,inValue.Cast<  ::openfl::text::Font >()); return inValue; }
		if (HX_FIELD_EQ(inName,"normal") ) { _hx_set_normal(HX_CTX_GET,inValue.Cast<  ::openfl::text::Font >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"boldItalic") ) { _hx_set_boldItalic(HX_CTX_GET,inValue.Cast<  ::openfl::text::Font >()); return inValue; }
	}
