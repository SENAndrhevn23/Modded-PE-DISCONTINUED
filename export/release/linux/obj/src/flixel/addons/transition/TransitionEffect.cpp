...
void TransitionEffect_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_04bb584d68aa991f_32_destroy)
HXLINE(  33)		this->super::destroy();
HXLINE(  34)		this->_hx_set_finishCallback(HX_CTX, null());
...
HXLINE(  42)			this->_hx_set__customCamera(HX_CTX, null());
            		}
            	}
...
HXDLIN(  63)				this->_hx_set__customCamera(HX_CTX,  ::flixel::FlxCamera_obj::__alloc( HX_CTX ,0,0,_hx_tmp,::Std_obj::_hx_int(this->_data->region->height),null()));
...
::hx::Val TransitionEffect_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"_data") ) { _hx_set__data(HX_CTX_GET,inValue.Cast<  ::flixel::addons::transition::TransitionData >()); return inValue; }
		break;
	case 8:
	...
	case 10:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"_customCamera") ) { _hx_set__customCamera(HX_CTX_GET,inValue.Cast<  ::flixel::FlxCamera >()); return inValue; }
		break;
	case 14:
