...
HX_DEFINE_STACK_FRAME(_hx_pos_a12cec1f7f1a6feb_13_new,"crowplexus.iris.IrisCall","new",0xfe81a494,"crowplexus.iris.IrisCall.new","crowplexus/iris/Iris.hx",13,0x27ccb4fa)
...
HXDLIN(  13)		this->_hx_set_funName(HX_CTX, funName);
HXDLIN(  13)		this->_hx_set_signature(HX_CTX, signature);
HXDLIN(  13)		this->_hx_set_returnValue(HX_CTX, returnValue);
            	}
...
::hx::Val IrisCall_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"funName") ) { _hx_set_funName(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"signature") ) { _hx_set_signature(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 11:
