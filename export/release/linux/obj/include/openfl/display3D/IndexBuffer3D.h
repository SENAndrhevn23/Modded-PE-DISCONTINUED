...
class HXCPP_CLASS_ATTRIBUTES IndexBuffer3D_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::lime::utils::ArrayBufferView _hx_set__hx___tempUInt16Array(::hx::StackContext *_hx_ctx, ::lime::utils::ArrayBufferView _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___tempUInt16Array=_hx_v; }
		int _hx___usage;
		void dispose();
		::Dynamic dispose_dyn();
