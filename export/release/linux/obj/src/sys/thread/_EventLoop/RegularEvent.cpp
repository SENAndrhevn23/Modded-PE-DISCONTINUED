...
HXLINE( 287)		this->_hx_set_run(HX_CTX, run);
...
::hx::Val RegularEvent_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 3:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"next") ) { _hx_set_next(HX_CTX_GET,inValue.Cast<  ::sys::thread::_EventLoop::RegularEvent >()); return inValue; }
		break;
	case 8:
