...
HX_DEFINE_STACK_FRAME(_hx_pos_969328a31f5dabcc_92_new,"psychlua.CustomSubstate","new",0xb07241e5,"psychlua.CustomSubstate.new","psychlua/CustomSubstate.hx",92,0x1fcf300a)
HX_LOCAL_STACK_FRAME(_hx_pos_969328a31f5dabcc_81_create,"psychlua.CustomSubstate","create",0x3bb6f697,"psychlua.CustomSubstate.create","psychlua/CustomSubstate.hx",81,0x1fcf300a)
HX_LOCAL_STACK_FRAME(_hx_pos_969328a31f5dabcc_100_update,"psychlua.CustomSubstate","update",0x46ad15a4,"psychlua.CustomSubstate.update","psychlua/CustomSubstate.hx",100,0x1fcf300a)
HX_LOCAL_STACK_FRAME(_hx_pos_969328a31f5dabcc_107_destroy,"psychlua.CustomSubstate","destroy",0x177c44ff,"psychlua.CustomSubstate.destroy","psychlua/CustomSubstate.hx",107,0x1fcf300a)
...
void CustomSubstate_obj::__construct(::String name){
            	HX_STACKFRAME(&_hx_pos_969328a31f5dabcc_92_new)
HXLINE(  93)		::psychlua::CustomSubstate_obj::name = name;
HXLINE(  94)		::states::PlayState_obj::instance->setOnHScript(HX_("customSubstateName",cd,30,b8,0d),name,null());
HXLINE(  95)		super::__construct();
HXLINE(  96)		this->set_cameras(::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::FlxG_obj::cameras->list->__get((::flixel::FlxG_obj::cameras->list->length - 1)).StaticCast<  ::flixel::FlxCamera >()));
            	}
...
void CustomSubstate_obj::create(){
            	HX_STACKFRAME(&_hx_pos_969328a31f5dabcc_81_create)
HXLINE(  82)		::psychlua::CustomSubstate_obj::instance = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(  83)		::states::PlayState_obj::instance->setOnHScript(HX_("customSubstate",62,39,8a,88),::psychlua::CustomSubstate_obj::instance,null());
HXLINE(  86)		::states::PlayState_obj::instance->callOnScripts(HX_("onCustomSubstateCreate",bd,00,5a,98),::cpp::VirtualArray_obj::__new(1)->init(0,::psychlua::CustomSubstate_obj::name),null(),null(),null());
HXLINE(  87)		this->super::create();
HXLINE(  88)		::states::PlayState_obj::instance->callOnScripts(HX_("onCustomSubstateCreatePost",bd,53,4b,d5),::cpp::VirtualArray_obj::__new(1)->init(0,::psychlua::CustomSubstate_obj::name),null(),null(),null());
            	}


void CustomSubstate_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_969328a31f5dabcc_100_update)
HXLINE( 101)		::states::PlayState_obj::instance->callOnScripts(HX_("onCustomSubstateUpdate",ca,1f,50,a3),::cpp::VirtualArray_obj::__new(2)->init(0,::psychlua::CustomSubstate_obj::name)->init(1,elapsed),null(),null(),null());
HXLINE( 102)		this->super::update(elapsed);
HXLINE( 103)		::states::PlayState_obj::instance->callOnScripts(HX_("onCustomSubstateUpdatePost",4a,7d,72,7b),::cpp::VirtualArray_obj::__new(2)->init(0,::psychlua::CustomSubstate_obj::name)->init(1,elapsed),null(),null(),null());
            	}


void CustomSubstate_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_969328a31f5dabcc_107_destroy)
HXLINE( 108)		::states::PlayState_obj::instance->callOnScripts(HX_("onCustomSubstateDestroy",19,1c,82,c9),::cpp::VirtualArray_obj::__new(1)->init(0,::psychlua::CustomSubstate_obj::name),null(),null(),null());
HXLINE( 109)		::psychlua::CustomSubstate_obj::instance = null();
HXLINE( 110)		::psychlua::CustomSubstate_obj::name = HX_("unnamed",c0,86,15,93);
HXLINE( 112)		::states::PlayState_obj::instance->setOnHScript(HX_("customSubstate",62,39,8a,88),null(),null());
HXLINE( 113)		::states::PlayState_obj::instance->setOnHScript(HX_("customSubstateName",cd,30,b8,0d),::psychlua::CustomSubstate_obj::name,null());
