...
HXLINE(  92)		this->_hx_set_list(HX_CTX,  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null()));
HXLINE(  87)		this->_hx_set_defaultSoundGroup(HX_CTX,  ::flixel::sound::FlxSoundGroup_obj::__alloc( HX_CTX ,null()));
HXLINE(  82)		this->_hx_set_defaultMusicGroup(HX_CTX,  ::flixel::sound::FlxSoundGroup_obj::__alloc( HX_CTX ,null()));
HXLINE(  64)		this->soundTrayEnabled = true;
HXLINE(  57)		this->_hx_set_muteKeys(HX_CTX, ::Array_obj< int >::fromData( _hx_array_data_7ea9c627_1,2));
HXLINE(  51)		this->_hx_set_volumeDownKeys(HX_CTX, ::Array_obj< int >::fromData( _hx_array_data_7ea9c627_2,2));
HXLINE(  45)		this->_hx_set_volumeUpKeys(HX_CTX, ::Array_obj< int >::fromData( _hx_array_data_7ea9c627_3,2));
...
HXLINE( 111)			this->_hx_set_music(HX_CTX,  ::flixel::sound::FlxSound_obj::__alloc( HX_CTX ));
            		}
            		else {
...
void SoundFrontEnd_obj::destroy(::hx::Null< bool >  __o_forceDestroy){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_2d161672f440721c_308_destroy)
...
HXLINE( 312)			this->_hx_set_music(HX_CTX, null());
            		}
HXLINE( 315)		{
HXLINE( 315)			int _g = 0;
...
::hx::Val SoundFrontEnd_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"list") ) { _hx_set_list(HX_CTX_GET,inValue.Cast<  ::flixel::group::FlxTypedGroup >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"music") ) { _hx_set_music(HX_CTX_GET,inValue.Cast<  ::flixel::sound::FlxSound >()); return inValue; }
	...
	case 6:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"muteKeys") ) { _hx_set_muteKeys(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"volumeUpKeys") ) { _hx_set_volumeUpKeys(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"volumeHandler") ) { _hx_set_volumeHandler(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"volumeDownKeys") ) { _hx_set_volumeDownKeys(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"soundTrayEnabled") ) { soundTrayEnabled=inValue.Cast< bool >(); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"defaultMusicGroup") ) { _hx_set_defaultMusicGroup(HX_CTX_GET,inValue.Cast<  ::flixel::sound::FlxSoundGroup >()); return inValue; }
		if (HX_FIELD_EQ(inName,"defaultSoundGroup") ) { _hx_set_defaultSoundGroup(HX_CTX_GET,inValue.Cast<  ::flixel::sound::FlxSoundGroup >()); return inValue; }
	}
