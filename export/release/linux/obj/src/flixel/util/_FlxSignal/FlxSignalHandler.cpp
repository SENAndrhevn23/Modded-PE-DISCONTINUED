...
void FlxSignalHandler_obj::__construct( ::Dynamic listener,bool dispatchOnce){
            	HX_GC_STACKFRAME(&_hx_pos_d696dc5400e6ca39_83_new)
HXLINE(  86)		this->dispatchOnce = false;
HXLINE(  90)		this->_hx_set_listener(HX_CTX, listener);
...
void FlxSignalHandler_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_d696dc5400e6ca39_96_destroy)
HXDLIN(  96)		this->_hx_set_listener(HX_CTX, null());
            	}
