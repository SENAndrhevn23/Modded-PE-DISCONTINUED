...
class HXCPP_CLASS_ATTRIBUTES NativeApplication_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		inline  ::openfl::display::NativeWindow _hx_set__hx___activeWindow(::hx::StackContext *_hx_ctx, ::openfl::display::NativeWindow _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___activeWindow=_hx_v; }
		...
		inline  ::openfl::desktop::InteractiveIcon _hx_set_icon(::hx::StackContext *_hx_ctx, ::openfl::desktop::InteractiveIcon _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return icon=_hx_v; }
		bool get_isCompiledAOT();
		::Dynamic get_isCompiledAOT_dyn();

		::Array< ::Dynamic> _hx___openedWindows;
		inline ::Array< ::Dynamic> _hx_set__hx___openedWindows(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___openedWindows=_hx_v; }
