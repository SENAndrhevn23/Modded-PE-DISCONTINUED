...
class HXCPP_CLASS_ATTRIBUTES Loader_obj : public  ::openfl::display::DisplayObjectContainer_obj
{
	...
	public:
		...
		inline  ::openfl::display::LoaderInfo _hx_set_contentLoaderInfo(::hx::StackContext *_hx_ctx, ::openfl::display::LoaderInfo _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return contentLoaderInfo=_hx_v; }
		...
		inline  ::openfl::utils::AssetLibrary _hx_set__hx___library(::hx::StackContext *_hx_ctx, ::openfl::utils::AssetLibrary _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___library=_hx_v; }
		::String _hx___path;
