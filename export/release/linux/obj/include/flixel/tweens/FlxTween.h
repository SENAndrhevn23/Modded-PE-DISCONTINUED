...
class HXCPP_CLASS_ATTRIBUTES FlxTween_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::flixel::tweens::FlxTweenManager _hx_set_manager(::hx::StackContext *_hx_ctx, ::flixel::tweens::FlxTweenManager _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return manager=_hx_v; }
		bool active;
		Float duration;
		 ::Dynamic ease;
		...
		inline ::Array< ::Dynamic> _hx_set__chainedTweens(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _chainedTweens=_hx_v; }
		 ::flixel::tweens::FlxTween _nextTweenInChain;
		inline  ::flixel::tweens::FlxTween _hx_set__nextTweenInChain(::hx::StackContext *_hx_ctx, ::flixel::tweens::FlxTween _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _nextTweenInChain=_hx_v; }
