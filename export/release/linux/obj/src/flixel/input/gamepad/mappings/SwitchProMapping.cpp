...
void SwitchProMapping_obj::initValues(){
            	HX_GC_STACKFRAME(&_hx_pos_233c14da769792de_23_initValues)
HXLINE(  24)		this->_hx_set_leftStick(HX_CTX, ::flixel::input::gamepad::id::SwitchProID_obj::LEFT_ANALOG_STICK);
HXLINE(  25)		this->_hx_set_rightStick(HX_CTX, ::flixel::input::gamepad::id::SwitchProID_obj::RIGHT_ANALOG_STICK);
