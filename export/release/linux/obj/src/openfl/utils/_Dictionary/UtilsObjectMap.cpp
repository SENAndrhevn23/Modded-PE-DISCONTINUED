...
HXDLIN( 477)		this->_hx_set_map(HX_CTX,  ::haxe::ds::ObjectMap_obj::__alloc( HX_CTX ));
            	}
...
::hx::Val UtilsObjectMap_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"map") ) { _hx_set_map(HX_CTX_GET,inValue.Cast<  ::haxe::ds::ObjectMap >()); return inValue; }
	}
