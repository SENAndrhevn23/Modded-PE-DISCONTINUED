...
HXLINE(  18)		( ( ::crowplexus::iris::IrisConfig)(__this) )->_hx_set_localBlocklist(HX_CTX, ::Array_obj< ::String >::__new(0));
HXLINE(  17)		( ( ::crowplexus::iris::IrisConfig)(__this) )->autoPreset = true;
HXLINE(  16)		( ( ::crowplexus::iris::IrisConfig)(__this) )->autoRun = true;
HXLINE(  15)		( ( ::crowplexus::iris::IrisConfig)(__this) )->_hx_set_name(HX_CTX, null());
HXLINE(  29)		( ( ::crowplexus::iris::IrisConfig)(__this) )->_hx_set_name(HX_CTX, name);
HXLINE(  30)		( ( ::crowplexus::iris::IrisConfig)(__this) )->autoRun = autoRun;
HXLINE(  31)		( ( ::crowplexus::iris::IrisConfig)(__this) )->autoPreset = autoPreset;
HXLINE(  32)		if (::hx::IsNotNull( localBlocklist )) {
HXLINE(  33)			( ( ::crowplexus::iris::IrisConfig)(__this) )->_hx_set_localBlocklist(HX_CTX, localBlocklist);
            		}
            	}
		...
		inline ::Array< ::String > _hx_set_localBlocklist(::hx::StackContext *_hx_ctx,::Array< ::String > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return localBlocklist=_hx_v; }
};
