...
HXLINE(  69)		this->_hx_set__hx___bitmapData(HX_CTX, bitmapData);
HXLINE(  70)		int length = null();
HXDLIN(  70)		bool fixed = null();
HXDLIN(  70)		::Array< Float > array = null();
HXDLIN(  70)		this->_hx_set_rectData(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,array,true));
HXLINE(  72)		this->_hx_set__hx___data(HX_CTX, ::Array_obj< ::Dynamic>::__new());
...
HX_DEFINE_DYNAMIC_FUNC0(Tileset_obj,get_bitmapData,return )
 ...
 ::openfl::display::BitmapData Tileset_obj::set_bitmapData( ::openfl::display::BitmapData value){
            	HX_GC_STACKFRAME(&_hx_pos_7b61decb5082045e_201_set_bitmapData)
HXLINE( 202)		this->_hx_set__hx___bitmapData(HX_CTX, value);
HXLINE( 204)		{
HXLINE( 204)			int _g = 0;
...
::hx::Val Tileset_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"__data") ) { _hx_set__hx___data(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"rectData") ) { _hx_set_rectData(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::FloatVector >()); return inValue; }
		break;
	case 10:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"__bitmapData") ) { _hx_set__hx___bitmapData(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
	}
