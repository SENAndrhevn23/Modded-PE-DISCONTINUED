...
class HXCPP_CLASS_ATTRIBUTES JsonPrinter_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::StringBuf _hx_set_buf(::hx::StackContext *_hx_ctx, ::StringBuf _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return buf=_hx_v; }
		 ::Dynamic replacer;
		inline  ::Dynamic _hx_set_replacer(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return replacer=_hx_v; }
		Dynamic replacer_dyn() { return replacer;}
		::String indent;
		inline ::String _hx_set_indent(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return indent=_hx_v; }
		bool pretty;
		int nind;
