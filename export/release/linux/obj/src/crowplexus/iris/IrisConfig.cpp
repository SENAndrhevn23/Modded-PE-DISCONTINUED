...
HX_LOCAL_STACK_FRAME(_hx_pos_9bb9668e44f4c333_36_from,"crowplexus.iris.IrisConfig","from",0xf6ba5512,"crowplexus.iris.IrisConfig.from","crowplexus/iris/IrisConfig.hx",36,0x7c4bb858)
...
void IrisConfig_obj::__construct(::String name,::hx::Null< bool >  __o_autoRun,::hx::Null< bool >  __o_autoPreset,::Array< ::String > localBlocklist){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_9bb9668e44f4c333_14_new)
HXLINE(  18)		this->_hx_set_localBlocklist(HX_CTX, ::Array_obj< ::String >::__new(0));
HXLINE(  17)		this->autoPreset = true;
HXLINE(  16)		this->autoRun = true;
HXLINE(  15)		this->_hx_set_name(HX_CTX, null());
HXLINE(  29)		this->_hx_set_name(HX_CTX, name);
HXLINE(  30)		this->autoRun = autoRun;
HXLINE(  31)		this->autoPreset = autoPreset;
HXLINE(  32)		if (::hx::IsNotNull( localBlocklist )) {
HXLINE(  33)			this->_hx_set_localBlocklist(HX_CTX, localBlocklist);
            		}
            	}
...
bool IrisConfig_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::crowplexus::iris::IrisConfig IrisConfig_obj::from( ::Dynamic d){
            	HX_GC_STACKFRAME(&_hx_pos_9bb9668e44f4c333_36_from)
HXLINE(  37)		bool _hx_tmp;
HXDLIN(  37)		if (::hx::IsNotNull( d )) {
HXLINE(  37)			_hx_tmp = ::Std_obj::isOfType(d,::hx::ClassOf< ::crowplexus::iris::IrisConfig >());
            		}
            		else {
HXLINE(  37)			_hx_tmp = false;
            		}
HXDLIN(  37)		if (_hx_tmp) {
HXLINE(  38)			return ( ( ::crowplexus::iris::IrisConfig)(d) );
            		}
HXLINE(  39)		 ::Dynamic d1 = d;
HXLINE(  40)		return  ::crowplexus::iris::IrisConfig_obj::__alloc( HX_CTX ,( (::String)(d1->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic)) ),d1->__Field(HX_("autoRun",1c,cf,7b,9d),::hx::paccDynamic),d1->__Field(HX_("autoPreset",2e,c4,8b,1a),::hx::paccDynamic),( (::Array< ::String >)(d1->__Field(HX_("localBlocklist",40,cd,89,c4),::hx::paccDynamic)) ));
            	}
