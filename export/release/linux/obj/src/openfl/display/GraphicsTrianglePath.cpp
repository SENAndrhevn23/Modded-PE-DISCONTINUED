...
void GraphicsTrianglePath_obj::__construct( ::openfl::_Vector::FloatVector vertices, ::openfl::_Vector::IntVector indices, ::openfl::_Vector::FloatVector uvtData, ::Dynamic __o_culling){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_a26b1fc0d062e909_81_new)
HXLINE(  82)		this->_hx_set_vertices(HX_CTX, vertices);
HXLINE(  83)		this->_hx_set_indices(HX_CTX, indices);
HXLINE(  84)		this->_hx_set_uvtData(HX_CTX, uvtData);
HXLINE(  85)		this->_hx_set_culling(HX_CTX, culling);
