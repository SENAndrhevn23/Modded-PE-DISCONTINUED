...
HX_LOCAL_STACK_FRAME(_hx_pos_90f6f206b294b77b_116_kill,"sys.io.Process","kill",0x814efa44,"sys.io.Process.kill","/usr/share/haxe/std/cpp/_std/sys/io/Process.hx",116,0x2d961692)
namespace sys{
namespace io{
...
HXDLIN(  97)		this->_hx_set_p(HX_CTX, _hx_tmp);
HXLINE(  98)		this->_hx_set__hx_stdin(HX_CTX,  ::sys::io::_Process::Stdin_obj::__alloc( HX_CTX ,this->p));
HXLINE(  99)		this->_hx_set__hx_stdout(HX_CTX,  ::sys::io::_Process::Stdout_obj::__alloc( HX_CTX ,this->p,true));
HXLINE( 100)		this->_hx_set__hx_stderr(HX_CTX,  ::sys::io::_Process::Stdout_obj::__alloc( HX_CTX ,this->p,false));
            	}
...
void Process_obj::kill(){
            	HX_STACKFRAME(&_hx_pos_90f6f206b294b77b_116_kill)
...
::hx::Val Process_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
		if (HX_FIELD_EQ(inName,"p") ) { _hx_set_p(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"stdin") ) { _hx_set__hx_stdin(HX_CTX_GET,inValue.Cast<  ::haxe::io::Output >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"stdout") ) { _hx_set__hx_stdout(HX_CTX_GET,inValue.Cast<  ::haxe::io::Input >()); return inValue; }
		if (HX_FIELD_EQ(inName,"stderr") ) { _hx_set__hx_stderr(HX_CTX_GET,inValue.Cast<  ::haxe::io::Input >()); return inValue; }
	}
