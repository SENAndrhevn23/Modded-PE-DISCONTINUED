...
class HXCPP_CLASS_ATTRIBUTES LibrarySymbol_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::lime::utils::AssetLibrary _hx_set_library(::hx::StackContext *_hx_ctx, ::lime::utils::AssetLibrary _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return library=_hx_v; }
		::String libraryName;
		inline ::String _hx_set_libraryName(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return libraryName=_hx_v; }
		::String symbolName;
		inline ::String _hx_set_symbolName(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return symbolName=_hx_v; }
