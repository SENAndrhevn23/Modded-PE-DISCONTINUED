...
HXLINE(  13)		this->_hx_set_currentState(HX_CTX, ::states::stages::objects::SpraycanState_obj::WAITING_dyn());
...
HXLINE(  21)		this->_hx_set_canAtlas(HX_CTX,  ::flxanimate::PsychFlxAnimate_obj::__alloc( HX_CTX ,x,y,null(),null()));
...
HXLINE(  31)		this->_hx_set_explosion(HX_CTX,  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(x - ( (Float)(25) )),(y - ( (Float)(450) )),null()));
...
HXLINE(  34)		this->explosion->animation->_hx_set_finishCallback(HX_CTX,  ::Dynamic(new _hx_Closure_0(_gthis)));
...
void SpraycanAtlasSprite_obj::finishCanAnimation(){
            	HX_GC_STACKFRAME(&_hx_pos_3ad34bcb66487319_43_finishCanAnimation)
...
HXLINE(  49)			this->_hx_set_currentState(HX_CTX, ::states::stages::objects::SpraycanState_obj::WAITING_dyn());
...
HXLINE(  53)			this->_hx_set_currentState(HX_CTX, ::states::stages::objects::SpraycanState_obj::WAITING_dyn());
...
void SpraycanAtlasSprite_obj::playCanStart(){
            	HX_GC_STACKFRAME(&_hx_pos_3ad34bcb66487319_64_playCanStart)
...
HXLINE(  67)		this->_hx_set_currentState(HX_CTX, ::states::stages::objects::SpraycanState_obj::ARCING_dyn());
            	}
...
void SpraycanAtlasSprite_obj::playCanShot(){
            	HX_GC_STACKFRAME(&_hx_pos_3ad34bcb66487319_71_playCanShot)
HXLINE(  72)		this->playAnimation(HX_("Can Shot",4a,1f,16,59));
HXLINE(  73)		this->_hx_set_currentState(HX_CTX, ::states::stages::objects::SpraycanState_obj::SHOT_dyn());
            	}
...
void SpraycanAtlasSprite_obj::playHitPico(){
            	HX_GC_STACKFRAME(&_hx_pos_3ad34bcb66487319_77_playHitPico)
HXLINE(  78)		this->playAnimation(HX_("Hit Pico",12,4e,e7,27));
HXLINE(  79)		this->_hx_set_currentState(HX_CTX, ::states::stages::objects::SpraycanState_obj::IMPACTED_dyn());
            	}
...
void SpraycanAtlasSprite_obj::playAnimation(::String name){
            	HX_GC_STACKFRAME(&_hx_pos_3ad34bcb66487319_84_playAnimation)
HXLINE(  85)		this->canAtlas->anim->play(name,true,null(),null());
HXLINE(  86)		this->_hx_set_playingAnim(HX_CTX, name);
            	}
...
::hx::Val SpraycanAtlasSprite_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"canAtlas") ) { _hx_set_canAtlas(HX_CTX_GET,inValue.Cast<  ::flxanimate::PsychFlxAnimate >()); return inValue; }
		if (HX_FIELD_EQ(inName,"cutscene") ) { cutscene=inValue.Cast< bool >(); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"explosion") ) { _hx_set_explosion(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSprite >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"playingAnim") ) { _hx_set_playingAnim(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"currentState") ) { _hx_set_currentState(HX_CTX_GET,inValue.Cast<  ::states::stages::objects::SpraycanState >()); return inValue; }
	}
