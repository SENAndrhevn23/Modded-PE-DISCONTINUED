...
HXLINE( 116)		this->_hx_set__hx___shapeCache(HX_CTX,  ::openfl::text::_internal::ShapeCache_obj::__alloc( HX_CTX ));
HXLINE( 118)		this->_hx_set_textField(HX_CTX, textField);
HXLINE( 120)		this->width = ( (Float)(100) );
HXLINE( 121)		this->height = ( (Float)(100) );
HXLINE( 122)		this->set_text(HX_("",00,00,00,00));
HXLINE( 124)		this->_hx_set_bounds(HX_CTX,  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,0,0));
HXLINE( 125)		this->_hx_set_textBounds(HX_CTX,  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,0,0));
HXLINE( 127)		this->_hx_set_type(HX_CTX, 0);
HXLINE( 128)		this->_hx_set_autoSize(HX_CTX, 2);
...
HXLINE( 135)		this->_hx_set_gridFitType(HX_CTX, 1);
...
HXDLIN( 144)		this->_hx_set_lineAscents(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,array,true));
HXLINE( 145)		int length1 = null();
HXDLIN( 145)		bool fixed1 = null();
HXDLIN( 145)		::Array< int > array1 = null();
HXDLIN( 145)		this->_hx_set_lineBreaks(HX_CTX,  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length1,fixed1,array1));
HXLINE( 146)		int length2 = null();
HXDLIN( 146)		bool fixed2 = null();
HXDLIN( 146)		::Array< Float > array2 = null();
HXDLIN( 146)		this->_hx_set_lineDescents(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length2,fixed2,array2,true));
HXLINE( 147)		int length3 = null();
HXDLIN( 147)		bool fixed3 = null();
HXDLIN( 147)		::Array< Float > array3 = null();
HXDLIN( 147)		this->_hx_set_lineLeadings(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length3,fixed3,array3,true));
HXLINE( 148)		int length4 = null();
HXDLIN( 148)		bool fixed4 = null();
HXDLIN( 148)		::Array< Float > array4 = null();
HXDLIN( 148)		this->_hx_set_lineHeights(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length4,fixed4,array4,true));
HXLINE( 149)		int length5 = null();
HXDLIN( 149)		bool fixed5 = null();
HXDLIN( 149)		::Array< Float > array5 = null();
HXDLIN( 149)		this->_hx_set_lineWidths(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length5,fixed5,array5,true));
HXLINE( 150)		int length6 = null();
HXDLIN( 150)		bool fixed6 = null();
HXDLIN( 150)		::Array< ::Dynamic> array6 = null();
HXDLIN( 150)		this->_hx_set_layoutGroups(HX_CTX,  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,length6,fixed6,array6,true));
HXLINE( 151)		int length7 = null();
HXDLIN( 151)		bool fixed7 = null();
HXDLIN( 151)		::Array< ::Dynamic> array7 = null();
HXDLIN( 151)		this->_hx_set_textFormatRanges(HX_CTX,  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,length7,fixed7,array7,true));
            	}
...
HXDLIN( 186)			declined1->setCtx( HX_CTX, accepted,(declined2 + ereg->matched(1)));
...
HXLINE(1374)								_gthis->_hx_set__hx___textLayout(HX_CTX,  ::openfl::text::_internal::TextLayout_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
            							}
...
HXLINE(1375)															_gthis->_hx_set__hx___textLayout(HX_CTX,  ::openfl::text::_internal::TextLayout_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
            														}
...
HXLINE(1375)											layoutGroup->_hx_set_format(HX_CTX, formatRange->format);
HXDLIN(1375)											layoutGroup->startIndex = textIndex;
HXDLIN(1375)											layoutGroup->endIndex = placeIndex;
            										}
HXDLIN(1375)										layoutGroup->_hx_set_positions(HX_CTX, positions);
...
HXLINE(1442)									_gthis->_hx_set__hx___textLayout(HX_CTX,  ::openfl::text::_internal::TextLayout_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
            								}
...
HXLINE(1542)																	_gthis->_hx_set__hx___textLayout(HX_CTX,  ::openfl::text::_internal::TextLayout_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
            																}
...
HXLINE(1542)													layoutGroup->_hx_set_format(HX_CTX, formatRange->format);
HXDLIN(1542)													layoutGroup->startIndex = textIndex;
HXDLIN(1542)													layoutGroup->endIndex = placeIndex1;
            												}
HXDLIN(1542)												layoutGroup->_hx_set_positions(HX_CTX, positions);
...
HXLINE(1554)									layoutGroup->_hx_set_positions(HX_CTX, layoutGroup->positions->concat(positions));
...
HXLINE(1563)																			_gthis->_hx_set__hx___textLayout(HX_CTX,  ::openfl::text::_internal::TextLayout_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
            																		}
...
HXLINE(1563)															layoutGroup->_hx_set_format(HX_CTX, formatRange->format);
HXDLIN(1563)															layoutGroup->startIndex = textIndex;
HXDLIN(1563)															layoutGroup->endIndex = placeIndex2;
            														}
HXDLIN(1563)														layoutGroup->_hx_set_positions(HX_CTX, positions);
...
HXLINE(1572)											_gthis->_hx_set__hx___textLayout(HX_CTX,  ::openfl::text::_internal::TextLayout_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
            										}
...
HXLINE(1577)									layoutGroup->_hx_set_positions(HX_CTX, layoutGroup->positions->concat(positions));
...
HXLINE(1592)													_gthis->_hx_set__hx___textLayout(HX_CTX,  ::openfl::text::_internal::TextLayout_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
            												}
...
HXLINE(1592)													layoutGroup->_hx_set_format(HX_CTX, formatRange->format);
HXDLIN(1592)													layoutGroup->startIndex = textIndex;
HXDLIN(1592)													layoutGroup->endIndex = endIndex2;
            												}
HXDLIN(1592)												layoutGroup->_hx_set_positions(HX_CTX, positions);
...
HXLINE(1649)										_gthis->_hx_set__hx___textLayout(HX_CTX,  ::openfl::text::_internal::TextLayout_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
            									}
...
HXLINE(1650)																_gthis->_hx_set__hx___textLayout(HX_CTX,  ::openfl::text::_internal::TextLayout_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
            															}
...
HXLINE(1650)												layoutGroup->_hx_set_format(HX_CTX, formatRange->format);
HXDLIN(1650)												layoutGroup->startIndex = textIndex;
HXDLIN(1650)												layoutGroup->endIndex = placeIndex3;
            											}
HXDLIN(1650)											layoutGroup->_hx_set_positions(HX_CTX, positions);
...
HXLINE(1662)					layoutGroup->_hx_set_format(HX_CTX, formatRange->format);
HXDLIN(1662)					layoutGroup->startIndex = startIndex;
HXDLIN(1662)					layoutGroup->endIndex = endIndex11;
            				}
            			}
HXLINE(1664)			layoutGroup->_hx_set_positions(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
...
::String TextEngine_obj::set_restrict(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_81873a2f4b2980c0_1960_set_restrict)
HXLINE(1961)		if ((this->restrict == value)) {
HXLINE(1963)			return this->restrict;
            		}
HXLINE(1966)		this->_hx_set_restrict(HX_CTX, value);
...
HXLINE(1970)			this->_hx_set__hx___restrictRegexp(HX_CTX, null());
            		}
            		else {
HXLINE(1974)			this->_hx_set__hx___restrictRegexp(HX_CTX, this->createRestrictRegexp(value));
            		}
...
::String TextEngine_obj::set_text(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_81873a2f4b2980c0_2002_set_text)
HXDLIN(2002)		return (this->_hx_set_text(HX_CTX, value));
            	}
...
::hx::Val TextEngine_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		if (HX_FIELD_EQ(inName,"type") ) { _hx_set_type(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 5:
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"bounds") ) { _hx_set_bounds(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
		if (HX_FIELD_EQ(inName,"height") ) { height=inValue.Cast< Float >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__font") ) { _hx_set__hx___font(HX_CTX_GET,inValue.Cast<  ::openfl::text::Font >()); return inValue; }
		break;
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"autoSize") ) { _hx_set_autoSize(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"restrict") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_restrict(inValue.Cast< ::String >()) );_hx_set_restrict(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"textField") ) { _hx_set_textField(HX_CTX_GET,inValue.Cast<  ::openfl::text::TextField >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__texture") ) { _hx_set__hx___texture(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 10:
		...
		if (HX_FIELD_EQ(inName,"lineBreaks") ) { _hx_set_lineBreaks(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::IntVector >()); return inValue; }
		if (HX_FIELD_EQ(inName,"lineWidths") ) { _hx_set_lineWidths(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::FloatVector >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"textBounds") ) { _hx_set_textBounds(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"gridFitType") ) { _hx_set_gridFitType(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"lineAscents") ) { _hx_set_lineAscents(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::FloatVector >()); return inValue; }
		if (HX_FIELD_EQ(inName,"lineHeights") ) { _hx_set_lineHeights(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::FloatVector >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__isKeyDown") ) { _hx___isKeyDown=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__cairoFont") ) { _hx_set__hx___cairoFont(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"layoutGroups") ) { _hx_set_layoutGroups(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::ObjectVector >()); return inValue; }
		if (HX_FIELD_EQ(inName,"lineDescents") ) { _hx_set_lineDescents(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::FloatVector >()); return inValue; }
		if (HX_FIELD_EQ(inName,"lineLeadings") ) { _hx_set_lineLeadings(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::FloatVector >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__shapeCache") ) { _hx_set__hx___shapeCache(HX_CTX_GET,inValue.Cast<  ::openfl::text::_internal::ShapeCache >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__showCursor") ) { _hx___showCursor=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__textFormat") ) { _hx_set__hx___textFormat(HX_CTX_GET,inValue.Cast<  ::openfl::text::TextFormat >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__textLayout") ) { _hx_set__hx___textLayout(HX_CTX_GET,inValue.Cast<  ::openfl::text::_internal::TextLayout >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"antiAliasType") ) { _hx_set_antiAliasType(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"bottomScrollV") ) { bottomScrollV=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__cursorTimer") ) { _hx_set__hx___cursorTimer(HX_CTX_GET,inValue.Cast<  ::haxe::Timer >()); return inValue; }
		break;
	case 15:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"textFormatRanges") ) { _hx_set_textFormatRanges(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::ObjectVector >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__measuredHeight") ) { _hx___measuredHeight=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__restrictRegexp") ) { _hx_set__hx___restrictRegexp(HX_CTX_GET,inValue.Cast<  ::EReg >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__selectionStart") ) { _hx___selectionStart=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__useIntAdvances") ) { _hx_set__hx___useIntAdvances(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
