...
class HXCPP_CLASS_ATTRIBUTES Transform_obj : public  ::flixel::_hx_system::debug::interaction::tools::Tool_obj
{
	...
	public:
		...
		inline  ::flixel::math::FlxBasePoint _hx_set__actionTargetStartScale(::hx::StackContext *_hx_ctx, ::flixel::math::FlxBasePoint _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _actionTargetStartScale=_hx_v; }
		Float _actionTargetStartAngle;
		 ::flixel::math::FlxBasePoint _actionStartPoint;
		inline  ::flixel::math::FlxBasePoint _hx_set__actionStartPoint(::hx::StackContext *_hx_ctx, ::flixel::math::FlxBasePoint _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _actionStartPoint=_hx_v; }
		bool _actionHappening;
		int _actionMarker;
		 ::flixel::math::FlxBasePoint _actionScaleDirection;
		inline  ::flixel::math::FlxBasePoint _hx_set__actionScaleDirection(::hx::StackContext *_hx_ctx, ::flixel::math::FlxBasePoint _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _actionScaleDirection=_hx_v; }
		 ::flixel::_hx_system::debug::TooltipOverlay _tooltip;
		inline  ::flixel::_hx_system::debug::TooltipOverlay _hx_set__tooltip(::hx::StackContext *_hx_ctx, ::flixel::_hx_system::debug::TooltipOverlay _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _tooltip=_hx_v; }
		::Array< ::Dynamic> _markers;
		inline ::Array< ::Dynamic> _hx_set__markers(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _markers=_hx_v; }
		 ::flixel::FlxSprite _target;
		inline  ::flixel::FlxSprite _hx_set__target(::hx::StackContext *_hx_ctx, ::flixel::FlxSprite _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _target=_hx_v; }
		 ::flixel::math::FlxRect _targetArea;
		inline  ::flixel::math::FlxRect _hx_set__targetArea(::hx::StackContext *_hx_ctx, ::flixel::math::FlxRect _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _targetArea=_hx_v; }
		 ::flixel::math::FlxBasePoint _mouseCursor;
		inline  ::flixel::math::FlxBasePoint _hx_set__mouseCursor(::hx::StackContext *_hx_ctx, ::flixel::math::FlxBasePoint _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _mouseCursor=_hx_v; }
