...
class HXCPP_CLASS_ATTRIBUTES QuadPath_obj : public  ::flixel::tweens::motion::Motion_obj
{
	...
	public:
		...
		inline ::Array< ::Dynamic> _hx_set__points(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _points=_hx_v; }
		Float _distance;
		Float _speed;
		int _index;
		int _numSegs;
		bool _updateCurve;
		::Array< Float > _curveT;
		inline ::Array< Float > _hx_set__curveT(::hx::StackContext *_hx_ctx,::Array< Float > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _curveT=_hx_v; }
		::Array< Float > _curveD;
		inline ::Array< Float > _hx_set__curveD(::hx::StackContext *_hx_ctx,::Array< Float > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _curveD=_hx_v; }
		 ::flixel::math::FlxBasePoint _a;
		inline  ::flixel::math::FlxBasePoint _hx_set__a(::hx::StackContext *_hx_ctx, ::flixel::math::FlxBasePoint _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _a=_hx_v; }
		 ::flixel::math::FlxBasePoint _b;
		inline  ::flixel::math::FlxBasePoint _hx_set__b(::hx::StackContext *_hx_ctx, ::flixel::math::FlxBasePoint _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _b=_hx_v; }
		 ::flixel::math::FlxBasePoint _c;
		inline  ::flixel::math::FlxBasePoint _hx_set__c(::hx::StackContext *_hx_ctx, ::flixel::math::FlxBasePoint _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _c=_hx_v; }
		void destroy();
