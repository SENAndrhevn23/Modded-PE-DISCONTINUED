...
class HXCPP_CLASS_ATTRIBUTES Transition_obj : public  ::flixel::FlxSubState_obj
{
	...
	public:
		...
		inline  ::flixel::addons::transition::TransitionEffect _hx_set__effect(::hx::StackContext *_hx_ctx, ::flixel::addons::transition::TransitionEffect _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _effect=_hx_v; }
		void destroy();
