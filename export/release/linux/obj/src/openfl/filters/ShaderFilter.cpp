...
void ShaderFilter_obj::__construct( ::openfl::display::Shader shader){
            	HX_GC_STACKFRAME(&_hx_pos_2e74c672ca03138f_56_new)
HXLINE(  59)		this->_hx_set_blendMode(HX_CTX, 10);
HXLINE( 141)		super::__construct();
HXLINE( 143)		this->_hx_set_shader(HX_CTX, shader);
...
HXLINE( 155)		filter->_hx_set_blendMode(HX_CTX, this->blendMode);
...
HX_DEFINE_DYNAMIC_FUNC1(ShaderFilter_obj,set_rightExtension,return )
 ...
 ::openfl::display::Shader ShaderFilter_obj::_hx___initShader( ::openfl::display::DisplayObjectRenderer renderer,int pass, ::openfl::display::BitmapData sourceBitmapData){
            	HX_GC_STACKFRAME(&_hx_pos_2e74c672ca03138f_209___initShader)
HXLINE( 210)		this->_hx_set__hx___shaderBlendMode(HX_CTX, this->blendMode);
...
::hx::Val ShaderFilter_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"blendMode") ) { _hx_set_blendMode(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 12:
