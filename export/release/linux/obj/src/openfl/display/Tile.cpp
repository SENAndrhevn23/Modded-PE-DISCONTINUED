...
HXLINE( 289)		this->_hx_set__hx___matrix(HX_CTX,  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
HXLINE( 290)		if ((x != 0)) {
...
HXLINE( 301)		this->_hx_set__hx___blendMode(HX_CTX, null());
...
HXLINE( 314)		tile->_hx_set__hx___blendMode(HX_CTX, this->_hx___blendMode);
...
HXLINE( 318)			tile->_hx_set__hx___rect(HX_CTX, this->_hx___rect->clone());
            		}
HXLINE( 320)		tile->set_matrix(this->_hx___matrix->clone());
HXLINE( 321)		tile->_hx_set__hx___shader(HX_CTX, this->_hx___shader);
HXLINE( 322)		tile->set_tileset(this->_hx___tileset);
HXLINE( 324)		if (::hx::IsNotNull( this->_hx___colorTransform )) {
HXLINE( 331)			tile->_hx_set__hx___colorTransform(HX_CTX, this->_hx___colorTransform->_hx___clone());
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(Tile_obj,get_blendMode,return )
 ...
 ::Dynamic Tile_obj::set_blendMode( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_6c0e6bae55b32aaf_561_set_blendMode)
HXLINE( 562)		if (::hx::IsNotEq( value,this->_hx___blendMode )) {
HXLINE( 564)			this->_hx_set__hx___blendMode(HX_CTX, value);
...
HX_DEFINE_DYNAMIC_FUNC0(Tile_obj,get_colorTransform,return )
 ...
 ::openfl::geom::ColorTransform Tile_obj::set_colorTransform( ::openfl::geom::ColorTransform value){
            	HX_GC_STACKFRAME(&_hx_pos_6c0e6bae55b32aaf_577_set_colorTransform)
HXLINE( 578)		if (::hx::IsInstanceNotEq( value,this->_hx___colorTransform )) {
HXLINE( 580)			this->_hx_set__hx___colorTransform(HX_CTX, value);
...
HX_DEFINE_DYNAMIC_FUNC0(Tile_obj,get_matrix,return )
 ...
 ::openfl::geom::Matrix Tile_obj::set_matrix( ::openfl::geom::Matrix value){
            	HX_GC_STACKFRAME(&_hx_pos_6c0e6bae55b32aaf_638_set_matrix)
HXLINE( 639)		if (::hx::IsInstanceNotEq( value,this->_hx___matrix )) {
HXLINE( 641)			this->_hx_set__hx___rotation(HX_CTX, null());
HXLINE( 642)			this->_hx_set__hx___scaleX(HX_CTX, null());
HXLINE( 643)			this->_hx_set__hx___scaleY(HX_CTX, null());
HXLINE( 644)			this->_hx_set__hx___matrix(HX_CTX, value);
...
HX_DEFINE_DYNAMIC_FUNC0(Tile_obj,get_rect,return )
 ...
 ::openfl::geom::Rectangle Tile_obj::set_rect( ::openfl::geom::Rectangle value){
            	HX_GC_STACKFRAME(&_hx_pos_6c0e6bae55b32aaf_689_set_rect)
HXLINE( 690)		if (::hx::IsInstanceNotEq( value,this->_hx___rect )) {
HXLINE( 692)			this->_hx_set__hx___rect(HX_CTX, value);
...
Float Tile_obj::get_rotation(){
            	HX_GC_STACKFRAME(&_hx_pos_6c0e6bae55b32aaf_700_get_rotation)
...
HXLINE( 705)				this->_hx_set__hx___rotation(HX_CTX, 0);
...
HXLINE( 713)				this->_hx_set__hx___rotation(HX_CTX, (radians * (( (Float)(180) ) / ::Math_obj::PI)));
...
Float Tile_obj::set_rotation(Float value){
            	HX_GC_STACKFRAME(&_hx_pos_6c0e6bae55b32aaf_723_set_rotation)
HXLINE( 724)		if (::hx::IsNotEq( value,this->_hx___rotation )) {
HXLINE( 726)			this->_hx_set__hx___rotation(HX_CTX, value);
...
Float Tile_obj::get_scaleX(){
            	HX_GC_STACKFRAME(&_hx_pos_6c0e6bae55b32aaf_746_get_scaleX)
HXLINE( 747)		if (::hx::IsNull( this->_hx___scaleX )) {
HXLINE( 749)			if ((this->get_matrix()->b == 0)) {
HXLINE( 751)				this->_hx_set__hx___scaleX(HX_CTX, this->_hx___matrix->a);
            			}
            			else {
HXLINE( 755)				this->_hx_set__hx___scaleX(HX_CTX, ::Math_obj::sqrt(((this->_hx___matrix->a * this->_hx___matrix->a) + (this->_hx___matrix->b * this->_hx___matrix->b))));
            			}
            		}
...
Float Tile_obj::set_scaleX(Float value){
            	HX_GC_STACKFRAME(&_hx_pos_6c0e6bae55b32aaf_763_set_scaleX)
HXLINE( 764)		if (::hx::IsNotEq( value,this->_hx___scaleX )) {
HXLINE( 766)			this->_hx_set__hx___scaleX(HX_CTX, value);
...
Float Tile_obj::get_scaleY(){
            	HX_GC_STACKFRAME(&_hx_pos_6c0e6bae55b32aaf_790_get_scaleY)
HXLINE( 791)		if (::hx::IsNull( this->_hx___scaleY )) {
HXLINE( 793)			if ((this->_hx___matrix->c == 0)) {
HXLINE( 795)				this->_hx_set__hx___scaleY(HX_CTX, this->get_matrix()->d);
            			}
            			else {
HXLINE( 799)				this->_hx_set__hx___scaleY(HX_CTX, ::Math_obj::sqrt(((this->_hx___matrix->c * this->_hx___matrix->c) + (this->_hx___matrix->d * this->_hx___matrix->d))));
            			}
            		}
...
Float Tile_obj::set_scaleY(Float value){
            	HX_GC_STACKFRAME(&_hx_pos_6c0e6bae55b32aaf_807_set_scaleY)
HXLINE( 808)		if (::hx::IsNotEq( value,this->_hx___scaleY )) {
HXLINE( 810)			this->_hx_set__hx___scaleY(HX_CTX, value);
...
HX_DEFINE_DYNAMIC_FUNC0(Tile_obj,get_shader,return )
 ...
 ::openfl::display::Shader Tile_obj::set_shader( ::openfl::display::Shader value){
            	HX_GC_STACKFRAME(&_hx_pos_6c0e6bae55b32aaf_839_set_shader)
HXLINE( 840)		if (::hx::IsInstanceNotEq( value,this->_hx___shader )) {
HXLINE( 842)			this->_hx_set__hx___shader(HX_CTX, value);
...
HX_DEFINE_DYNAMIC_FUNC0(Tile_obj,get_tileset,return )
 ...
 ::openfl::display::Tileset Tile_obj::set_tileset( ::openfl::display::Tileset value){
            	HX_GC_STACKFRAME(&_hx_pos_6c0e6bae55b32aaf_855_set_tileset)
HXLINE( 856)		if (::hx::IsInstanceNotEq( value,this->_hx___tileset )) {
HXLINE( 858)			this->_hx_set__hx___tileset(HX_CTX, value);
...
::hx::Val Tile_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"parent") ) { _hx_set_parent(HX_CTX_GET,inValue.Cast<  ::openfl::display::TileContainer >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"__rect") ) { _hx_set__hx___rect(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
		break;
	case 7:
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"__matrix") ) { _hx_set__hx___matrix(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Matrix >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__scaleX") ) { _hx_set__hx___scaleX(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__scaleY") ) { _hx_set__hx___scaleY(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"__tileset") ) { _hx_set__hx___tileset(HX_CTX_GET,inValue.Cast<  ::openfl::display::Tileset >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__visible") ) { _hx___visible=inValue.Cast< bool >(); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"__rotation") ) { _hx_set__hx___rotation(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 11:
	...
	case 14:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"__colorTransform") ) { _hx_set__hx___colorTransform(HX_CTX_GET,inValue.Cast<  ::openfl::geom::ColorTransform >()); return inValue; }
