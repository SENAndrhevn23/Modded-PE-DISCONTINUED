...
class HXCPP_CLASS_ATTRIBUTES FlxTimeline_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::flxanimate::animate::FlxSymbol _hx_set__parent(::hx::StackContext *_hx_ctx, ::flxanimate::animate::FlxSymbol _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _parent=_hx_v; }
		::Array< ::Dynamic> _layers;
		inline ::Array< ::Dynamic> _hx_set__layers(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _layers=_hx_v; }
		int length;
		int totalFrames;
