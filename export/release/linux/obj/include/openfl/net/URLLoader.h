...
class HXCPP_CLASS_ATTRIBUTES URLLoader_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		inline  ::Dynamic _hx_set_data(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return data=_hx_v; }
		 ::Dynamic dataFormat;
		inline  ::Dynamic _hx_set_dataFormat(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return dataFormat=_hx_v; }
		::Dynamic _hx___httpRequest;
		inline ::Dynamic _hx_set__hx___httpRequest(::hx::StackContext *_hx_ctx,::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___httpRequest=_hx_v; }
		void close();
		::Dynamic close_dyn();
