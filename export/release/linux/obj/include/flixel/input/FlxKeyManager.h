...
class HXCPP_CLASS_ATTRIBUTES FlxKeyManager_obj : public ::hx::Object
{
	...
	public:
		...
		inline ::cpp::VirtualArray _hx_set_preventDefaultKeys(::hx::StackContext *_hx_ctx,::cpp::VirtualArray _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return preventDefaultKeys=_hx_v; }
		 ::Dynamic pressed;
		inline  ::Dynamic _hx_set_pressed(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return pressed=_hx_v; }
		 ::Dynamic justPressed;
		inline  ::Dynamic _hx_set_justPressed(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return justPressed=_hx_v; }
		 ::Dynamic released;
		inline  ::Dynamic _hx_set_released(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return released=_hx_v; }
		 ::Dynamic justReleased;
		inline  ::Dynamic _hx_set_justReleased(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return justReleased=_hx_v; }
		::Array< ::Dynamic> _keyListArray;
		inline ::Array< ::Dynamic> _hx_set__keyListArray(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _keyListArray=_hx_v; }
		 ::haxe::ds::IntMap _keyListMap;
		inline  ::haxe::ds::IntMap _hx_set__keyListMap(::hx::StackContext *_hx_ctx, ::haxe::ds::IntMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _keyListMap=_hx_v; }
