...
HXLINE(  24)		this->_hx_set_audio(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  25)		this->_hx_set_font(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  26)		this->_hx_set_image(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  33)		this->version = 389515;
            	}
...
HXLINE(  83)			this->_hx_set_audio(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  84)			this->_hx_set_font(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  85)			this->_hx_set_image(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
            		}
            		else {
...
::hx::Val AssetCache_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"font") ) { _hx_set_font(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"audio") ) { _hx_set_audio(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
		if (HX_FIELD_EQ(inName,"image") ) { _hx_set_image(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
		break;
	case 7:
