...
{
            	HX_GC_STACKFRAME(&_hx_pos_95d8637b0520f73a_30_new)
HXDLIN(  30)		( ( ::sys::thread::Lock)(__this) )->_hx_set_l(HX_CTX,  ::__hxcpp_lock_create());
            	}
		...
		::String __ToString() const { return HX_("Lock",0b,c8,90,32); }
		 ...
		 ::Dynamic l;
		inline  ::Dynamic _hx_set_l(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return l=_hx_v; }
