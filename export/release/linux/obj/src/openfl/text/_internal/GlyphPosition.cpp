...
HXLINE(  23)		this->_hx_set_advance(HX_CTX, advance);
HXLINE(  25)		if (::hx::IsNotNull( offset )) {
HXLINE(  27)			this->_hx_set_offset(HX_CTX, offset);
            		}
            		else {
HXLINE(  31)			this->_hx_set_offset(HX_CTX,  ::lime::math::Vector2_obj::__alloc( HX_CTX ,null(),null()));
            		}
            	}
...
::hx::Val GlyphPosition_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"offset") ) { _hx_set_offset(HX_CTX_GET,inValue.Cast<  ::lime::math::Vector2 >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"advance") ) { _hx_set_advance(HX_CTX_GET,inValue.Cast<  ::lime::math::Vector2 >()); return inValue; }
	}
