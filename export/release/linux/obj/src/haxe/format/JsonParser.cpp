...
void JsonParser_obj::__construct(::String str){
            	HX_GC_STACKFRAME(&_hx_pos_c5fe9f5f36ee8c2f_51_new)
HXLINE(  52)		this->_hx_set_str(HX_CTX, str);
...
HXLINE( 171)						buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,s.substr(start,len)));
            					}
            					else {
...
HXLINE( 175)							buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            						}
            						else {
...
HXLINE( 189)								buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1)));
            							}
            							else {
...
HXLINE( 189)								buf->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            							}
...
HXLINE( 185)							buf->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            						}
...
HXLINE( 187)							buf->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            						}
...
HXLINE( 181)							buf->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            						}
...
HXLINE( 179)							buf->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            						}
...
HXLINE( 183)							buf->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            						}
...
HXLINE( 212)										buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2)));
            									}
            									else {
...
HXLINE( 214)											buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3)));
            										}
            										else {
...
HXLINE( 214)											buf->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            										}
...
HXLINE( 220)										buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4)));
            									}
            									else {
...
HXLINE( 220)										buf->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            									}
...
HXLINE( 246)					buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x5)));
            				}
            				else {
...
HXLINE( 251)					buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,s1.substr(start,len1)));
            				}
            				else {
