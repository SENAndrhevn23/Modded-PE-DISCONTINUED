...
HXLINE(  82)		this->_hx_set__hx___context(HX_CTX, context3D);
HXLINE(  83)		this->_hx_set__hx___format(HX_CTX, format);
HXLINE(  85)		if (::hx::IsEq( this->_hx___format,0 )) {
HXLINE(  88)			this->_hx___agalSamplerUsageMask = 0;
HXLINE(  89)			this->_hx_set__hx___agalUniforms(HX_CTX,  ::haxe::ds::List_obj::__alloc( HX_CTX ));
HXLINE(  90)			this->_hx_set__hx___agalSamplerUniforms(HX_CTX,  ::haxe::ds::List_obj::__alloc( HX_CTX ));
HXLINE(  91)			this->_hx_set__hx___agalAlphaSamplerUniforms(HX_CTX,  ::haxe::ds::List_obj::__alloc( HX_CTX ));
HXLINE(  92)			this->_hx_set__hx___agalAlphaSamplerEnabled(HX_CTX, ::Array_obj< ::Dynamic>::__new());
            		}
            		else {
HXLINE(  96)			this->_hx_set__hx___glslAttribNames(HX_CTX, ::Array_obj< ::String >::__new());
HXLINE(  97)			this->_hx_set__hx___glslAttribTypes(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE(  98)			this->_hx_set__hx___glslSamplerNames(HX_CTX, ::Array_obj< ::String >::__new());
HXLINE(  99)			this->_hx_set__hx___glslUniformLocations(HX_CTX, ::Array_obj< int >::__new());
HXLINE( 100)			this->_hx_set__hx___glslUniformNames(HX_CTX, ::Array_obj< ::String >::__new());
HXLINE( 101)			this->_hx_set__hx___glslUniformTypes(HX_CTX, ::Array_obj< ::Dynamic>::__new());
            		}
HXLINE( 104)		this->_hx_set__hx___samplerStates(HX_CTX, ::Array_obj< ::Dynamic>::__new());
            	}
...
void Program3D_obj::upload( ::openfl::utils::ByteArrayData vertexProgram, ::openfl::utils::ByteArrayData fragmentProgram){
            	HX_GC_STACKFRAME(&_hx_pos_536f681b10c755a2_388_upload)
...
HXLINE( 409)				this->_hx___samplerStates->setCtx( HX_CTX, i,samplerStates->__get(i).StaticCast<  ::openfl::display::_internal::SamplerState >());
            			}
            		}
            	}
...
void Program3D_obj::uploadSources(::String vertexSource,::String fragmentSource){
            	HX_GC_STACKFRAME(&_hx_pos_536f681b10c755a2_419_uploadSources)
...
HXLINE( 452)		this->_hx_set__hx___glslSamplerNames(HX_CTX, ::Array_obj< ::String >::__new());
HXLINE( 453)		this->_hx_set__hx___glslAttribNames(HX_CTX, ::Array_obj< ::String >::__new());
HXLINE( 454)		this->_hx_set__hx___glslAttribTypes(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE( 455)		this->_hx_set__hx___glslUniformLocations(HX_CTX, ::Array_obj< int >::__new());
...
HXLINE( 463)				this->_hx___glslSamplerNames->setCtx( HX_CTX, index,name);
            			}
            		}
HXLINE( 466)		{
...
HXLINE( 469)				this->_hx___glslAttribNames->setCtx( HX_CTX, index,attribNames->__get(i));
HXLINE( 470)				this->_hx___glslAttribTypes->setCtx( HX_CTX, index,attribTypes->__get(i));
            			}
            		}
HXLINE( 473)		{
...
HXLINE( 490)		this->_hx_set__hx___agalAlphaSamplerEnabled(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
...
HXLINE( 508)				uniform->_hx_set_name(HX_CTX, name);
...
HXLINE( 518)					uniform->_hx_set_name(HX_CTX, uniform->name.substring(0,indexBracket));
            				}
...
HXLINE( 539)					this->_hx_set__hx___agalPositionScale(HX_CTX, uniform);
            				}
            				else {
...
HXLINE( 544)						uniform->_hx_set_regData(HX_CTX, this->_hx___context->_hx___vertexConstants);
...
HXLINE( 550)							uniform->_hx_set_regData(HX_CTX, this->_hx___context->_hx___fragmentConstants);
...
HXLINE( 572)										this->_hx___agalAlphaSamplerEnabled->setCtx( HX_CTX, uniform->regIndex,uniform);
            									}
            								}
            							}
            						}
...
HXLINE( 581)		this->_hx_set__hx___agalVertexUniformMap(HX_CTX,  ::openfl::display3D::UniformMap_obj::__alloc( HX_CTX ,::Lambda_obj::array(vertexUniforms)));
HXLINE( 582)		this->_hx_set__hx___agalFragmentUniformMap(HX_CTX,  ::openfl::display3D::UniformMap_obj::__alloc( HX_CTX ,::Lambda_obj::array(fragmentUniforms)));
            	}
...
void Program3D_obj::_hx___deleteShaders(){
            	HX_GC_STACKFRAME(&_hx_pos_536f681b10c755a2_587___deleteShaders)
...
void Program3D_obj::_hx___setSamplerState(int sampler, ::openfl::display::_internal::SamplerState state){
            	HX_GC_STACKFRAME(&_hx_pos_536f681b10c755a2_850___setSamplerState)
HXDLIN( 850)		this->_hx___samplerStates->setCtx( HX_CTX, sampler,state);
            	}
...
void Program3D_obj::_hx___uploadFromGLSL(::String vertexShaderSource,::String fragmentShaderSource){
            	HX_GC_STACKFRAME(&_hx_pos_536f681b10c755a2_854___uploadFromGLSL)
HXLINE( 855)		 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = this->_hx___context->gl;
HXLINE( 857)		this->_hx_set__hx___glVertexSource(HX_CTX, vertexShaderSource);
HXLINE( 858)		this->_hx_set__hx___glFragmentSource(HX_CTX, fragmentShaderSource);
HXLINE( 860)		this->_hx_set__hx___glVertexShader(HX_CTX, gl->createShader(gl->VERTEX_SHADER));
...
HXLINE( 872)		this->_hx_set__hx___glFragmentShader(HX_CTX, gl->createShader(gl->FRAGMENT_SHADER));
...
HXLINE( 884)		this->_hx_set__hx___glProgram(HX_CTX, gl->createProgram());
...
::hx::Val Program3D_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"__format") ) { _hx_set__hx___format(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"__context") ) { _hx_set__hx___context(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::Context3D >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"__glProgram") ) { _hx_set__hx___glProgram(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"__agalUniforms") ) { _hx_set__hx___agalUniforms(HX_CTX_GET,inValue.Cast<  ::haxe::ds::List >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"__samplerStates") ) { _hx_set__hx___samplerStates(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"__glVertexShader") ) { _hx_set__hx___glVertexShader(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__glVertexSource") ) { _hx_set__hx___glVertexSource(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"__glslAttribNames") ) { _hx_set__hx___glslAttribNames(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__glslAttribTypes") ) { _hx_set__hx___glslAttribTypes(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"__glFragmentShader") ) { _hx_set__hx___glFragmentShader(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__glFragmentSource") ) { _hx_set__hx___glFragmentSource(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__glslSamplerNames") ) { _hx_set__hx___glslSamplerNames(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__glslUniformNames") ) { _hx_set__hx___glslUniformNames(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__glslUniformTypes") ) { _hx_set__hx___glslUniformTypes(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"__agalPositionScale") ) { _hx_set__hx___agalPositionScale(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::Uniform >()); return inValue; }
		break;
	case 21:
		if (HX_FIELD_EQ(inName,"__agalSamplerUniforms") ) { _hx_set__hx___agalSamplerUniforms(HX_CTX_GET,inValue.Cast<  ::haxe::ds::List >()); return inValue; }
		break;
	case 22:
		if (HX_FIELD_EQ(inName,"__agalSamplerUsageMask") ) { _hx___agalSamplerUsageMask=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__agalVertexUniformMap") ) { _hx_set__hx___agalVertexUniformMap(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::UniformMap >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__glslUniformLocations") ) { _hx_set__hx___glslUniformLocations(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		break;
	case 24:
		if (HX_FIELD_EQ(inName,"__agalFragmentUniformMap") ) { _hx_set__hx___agalFragmentUniformMap(HX_CTX_GET,inValue.Cast<  ::openfl::display3D::UniformMap >()); return inValue; }
		break;
	case 25:
		if (HX_FIELD_EQ(inName,"__agalAlphaSamplerEnabled") ) { _hx_set__hx___agalAlphaSamplerEnabled(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 26:
		if (HX_FIELD_EQ(inName,"__agalAlphaSamplerUniforms") ) { _hx_set__hx___agalAlphaSamplerUniforms(HX_CTX_GET,inValue.Cast<  ::haxe::ds::List >()); return inValue; }
	}
