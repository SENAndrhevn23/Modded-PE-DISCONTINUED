...
class HXCPP_CLASS_ATTRIBUTES BlurShader_obj : public  ::openfl::filters::BitmapFilterShader_obj
{
	...
	public:
		...
		inline  ::openfl::display::ShaderParameter_Float _hx_set_uTextureSize(::hx::StackContext *_hx_ctx, ::openfl::display::ShaderParameter_Float _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return uTextureSize=_hx_v; }
};
