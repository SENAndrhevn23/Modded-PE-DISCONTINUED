...
void Timeline_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_d8cb40cd2da03698_67_new)
HXLINE(  68)		this->_hx___framesLoaded = 1;
HXLINE(  69)		this->_hx___totalFrames = 1;
HXLINE(  70)		this->_hx_set__hx___currentLabels(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
...
HXLINE( 124)				this->_hx_set__hx___frameScripts(HX_CTX,  ::haxe::ds::IntMap_obj::__alloc( HX_CTX ));
            			}
...
HXLINE( 140)		this->_hx_set__hx___scope(HX_CTX, movieClip);
...
HXLINE( 154)						this->_hx_set__hx___currentLabels(HX_CTX, this->_hx___currentLabels->concat(scene->labels));
            					}
            				}
            			}
HXLINE( 158)			this->_hx_set__hx___currentScene(HX_CTX, this->scenes->__get(0).StaticCast<  ::openfl::display::Scene >());
            		}
...
HXLINE( 163)			this->_hx_set__hx___frameScripts(HX_CTX,  ::haxe::ds::IntMap_obj::__alloc( HX_CTX ));
HXLINE( 164)			{
...
void Timeline_obj::_hx___updateFrameLabel(){
            	HX_GC_STACKFRAME(&_hx_pos_d8cb40cd2da03698_368___updateFrameLabel)
HXLINE( 369)		this->_hx_set__hx___currentLabel(HX_CTX, null());
HXLINE( 370)		this->_hx_set__hx___currentFrameLabel(HX_CTX, null());
HXLINE( 374)		{
HXLINE( 374)			int _g = 0;
...
HXLINE( 378)					this->_hx_set__hx___currentLabel(HX_CTX, label->name);
            				}
            				else {
HXLINE( 380)					if ((label->frame == this->_hx___currentFrame)) {
HXLINE( 382)						this->_hx_set__hx___currentLabel(HX_CTX, label->name);
HXLINE( 383)						this->_hx_set__hx___currentFrameLabel(HX_CTX, label->name);
            					}
            					else {
...
::hx::Val Timeline_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"scenes") ) { _hx_set_scenes(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"scripts") ) { _hx_set_scripts(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__scope") ) { _hx_set__hx___scope(HX_CTX_GET,inValue.Cast<  ::openfl::display::MovieClip >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"frameRate") ) { _hx_set_frameRate(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 11:
	...
	case 14:
		...
		if (HX_FIELD_EQ(inName,"__currentLabel") ) { _hx_set__hx___currentLabel(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__currentScene") ) { _hx_set__hx___currentScene(HX_CTX_GET,inValue.Cast<  ::openfl::display::Scene >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__frameScripts") ) { _hx_set__hx___frameScripts(HX_CTX_GET,inValue.Cast<  ::haxe::ds::IntMap >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__framesLoaded") ) { _hx___framesLoaded=inValue.Cast< int >(); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"__currentLabels") ) { _hx_set__hx___currentLabels(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"__lastFrameUpdate") ) { _hx___lastFrameUpdate=inValue.Cast< int >(); return inValue; }
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"__currentFrameLabel") ) { _hx_set__hx___currentFrameLabel(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 21:
