...
void QuadPath_obj::__construct( ::Dynamic Options, ::flixel::tweens::FlxTweenManager manager){
            	HX_GC_STACKFRAME(&_hx_pos_c7e8b5180f8deff5_13_new)
...
HXLINE(  36)		this->_hx_set__points(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  37)		this->_hx_set__curveT(HX_CTX, ::Array_obj< Float >::__new(0));
HXLINE(  38)		this->_hx_set__curveD(HX_CTX, ::Array_obj< Float >::__new(0));
            	}
...
void QuadPath_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_c7e8b5180f8deff5_42_destroy)
...
HXLINE(  49)		this->_hx_set__a(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->_a)) ));
HXLINE(  50)		this->_hx_set__b(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->_b)) ));
HXLINE(  51)		this->_hx_set__c(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->_c)) ));
            	}
...
void QuadPath_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_c7e8b5180f8deff5_109_update)
...
HXLINE( 130)			this->_hx_set__a(HX_CTX, this->_points->__get((this->_index * 2)).StaticCast<  ::flixel::math::FlxBasePoint >());
HXLINE( 131)			this->_hx_set__b(HX_CTX, this->_points->__get(((this->_index * 2) + 1)).StaticCast<  ::flixel::math::FlxBasePoint >());
HXLINE( 132)			this->_hx_set__c(HX_CTX, this->_points->__get(((this->_index * 2) + 2)).StaticCast<  ::flixel::math::FlxBasePoint >());
...
HXLINE( 154)				this->_hx_set__a(HX_CTX, this->_points->__get(((this->_index * 2) + 2)).StaticCast<  ::flixel::math::FlxBasePoint >());
HXLINE( 155)				this->_hx_set__b(HX_CTX, this->_points->__get(((this->_index * 2) + 1)).StaticCast<  ::flixel::math::FlxBasePoint >());
HXLINE( 156)				this->_hx_set__c(HX_CTX, this->_points->__get((this->_index * 2)).StaticCast<  ::flixel::math::FlxBasePoint >());
...
::hx::Val QuadPath_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 2:
		if (HX_FIELD_EQ(inName,"_a") ) { _hx_set__a(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_b") ) { _hx_set__b(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_c") ) { _hx_set__c(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		break;
	case 6:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"_points") ) { _hx_set__points(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_curveT") ) { _hx_set__curveT(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_curveD") ) { _hx_set__curveD(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
		break;
	case 8:
