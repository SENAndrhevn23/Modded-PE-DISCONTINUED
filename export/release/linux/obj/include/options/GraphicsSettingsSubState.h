...
class HXCPP_CLASS_ATTRIBUTES GraphicsSettingsSubState_obj : public  ::options::BaseOptionsMenu_obj
{
	...
	public:
		...
		inline  ::options::Option _hx_set_fpsOption(::hx::StackContext *_hx_ctx, ::options::Option _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return fpsOption=_hx_v; }
		 ::options::Option syncOption;
		inline  ::options::Option _hx_set_syncOption(::hx::StackContext *_hx_ctx, ::options::Option _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return syncOption=_hx_v; }
