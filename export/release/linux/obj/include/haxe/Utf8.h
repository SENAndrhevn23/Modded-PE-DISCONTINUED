...
{
            	HX_GC_STACKFRAME(&_hx_pos_0a40232af2821c0d_32_new)
HXLINE(  33)		( ( ::haxe::Utf8)(__this) )->_hx_set___s(HX_CTX, ::Array_obj< int >::__new());
...
HXLINE(  35)			( ( ::haxe::Utf8)(__this) )->__s->reserve(( (int)(size) ));
		...
		::Array< int > __s;
		inline ::Array< int > _hx_set___s(::hx::StackContext *_hx_ctx,::Array< int > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return __s=_hx_v; }
		void addChar(int c);
		::Dynamic addChar_dyn();
