...
::mikolka::stages::standard::HenchmenKillState HenchmenKillState_obj::KILLING;

::mikolka::stages::standard::HenchmenKillState HenchmenKillState_obj::SPEEDING;

::mikolka::stages::standard::HenchmenKillState HenchmenKillState_obj::SPEEDING_OFFSCREEN;

::mikolka::stages::standard::HenchmenKillState HenchmenKillState_obj::STOPPING;

::mikolka::stages::standard::HenchmenKillState HenchmenKillState_obj::WAIT;
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("mikolka.stages.standard.HenchmenKillState",2f,3f,60,93), ::hx::TCanCast< HenchmenKillState_obj >,HenchmenKillState_obj_sStaticFields,0,
