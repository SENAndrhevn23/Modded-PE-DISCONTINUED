...
HXLINE(  57)		this->_hx_set_replacer(HX_CTX, replacer);
HXLINE(  58)		this->_hx_set_indent(HX_CTX, space);
HXLINE(  59)		this->pretty = ::hx::IsNotNull( space );
HXLINE(  60)		this->nind = 0;
HXLINE(  67)		this->_hx_set_buf(HX_CTX,  ::StringBuf_obj::__alloc( HX_CTX ));
            	}
...
void JsonPrinter_obj::write( ::Dynamic k, ::Dynamic v){
            	HX_GC_STACKFRAME(&_hx_pos_48248be6b214f1a1_81_write)
...
HXLINE( 136)						_this->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_4,1));
            					}
            					else {
...
HXLINE(  90)							_this1->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v1)));
            						}
            						else {
...
HXLINE(  92)							_this3->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v2)));
            						}
            						else {
...
HXLINE( 134)							_this5->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v3)));
            						}
            						else {
...
HXLINE(  94)						_this7->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_5,1));
            					}
            					else {
...
HXLINE( 100)										_this8->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            									}
...
HXLINE( 106)												_this9->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            											}
...
HXLINE( 109)												_this10->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            											}
...
HXLINE( 110)												_this11->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v5)));
            											}
            											else {
...
HXLINE( 114)													_this13->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            												}
...
HXLINE( 115)													_this14->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v6)));
            												}
            												else {
...
HXLINE( 118)										_this16->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            									}
...
HXLINE( 132)									_this17->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v10)));
            								}
            								else {
...
HXLINE(  86)						_this19->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_6,1));
            					}
            					else {
...
void JsonPrinter_obj::fieldsString( ::Dynamic v,::Array< ::String > fields){
            	HX_GC_STACKFRAME(&_hx_pos_48248be6b214f1a1_165_fieldsString)
HXLINE( 166)		{
HXLINE( 166)			 ::StringBuf _this = this->buf;
HXDLIN( 166)			{
HXLINE( 166)				if (::hx::IsNull( _this->charBuf )) {
HXLINE( 166)					_this->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            				}
...
HXLINE( 179)							_this1->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            						}
...
HXLINE( 180)							_this2->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            						}
...
HXLINE( 181)							_this3->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v1)));
            						}
            						else {
...
HXLINE( 183)							_this5->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            						}
...
HXLINE( 185)							_this6->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            						}
...
HXLINE( 189)								_this7->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            							}
...
HXLINE( 190)								_this8->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v2)));
            							}
            							else {
...
HXLINE( 193)					_this10->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            				}
...
void JsonPrinter_obj::quote(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_48248be6b214f1a1_196_quote)
HXLINE( 203)		{
HXLINE( 203)			 ::StringBuf _this = this->buf;
HXDLIN( 203)			{
HXLINE( 203)				if (::hx::IsNull( _this->charBuf )) {
HXLINE( 203)					_this->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            				}
...
HXLINE( 223)						_this1->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_12,1));
            					}
            					else {
...
HXLINE( 221)						_this2->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_13,1));
            					}
            					else {
...
HXLINE( 217)						_this3->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_14,1));
            					}
            					else {
...
HXLINE( 225)						_this4->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_15,1));
            					}
            					else {
...
HXLINE( 219)						_this5->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_16,1));
            					}
            					else {
...
HXLINE( 213)						_this6->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_17,1));
            					}
            					else {
...
HXLINE( 215)						_this7->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_f7b98003_18,1));
            					}
            					else {
...
HXLINE( 248)							_this8->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            						}
            						else {
...
HXLINE( 248)							_this8->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            						}
...
HXLINE( 256)					_this10->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            				}
...
::hx::Val JsonPrinter_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"replacer") ) { _hx_set_replacer(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
