...
class HXCPP_CLASS_ATTRIBUTES SoundChannel_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		inline  ::openfl::media::Sound _hx_set__hx___sound(::hx::StackContext *_hx_ctx, ::openfl::media::Sound _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___sound=_hx_v; }
		bool _hx___isValid;
		...
		inline  ::lime::media::AudioSource _hx_set__hx___audioSource(::hx::StackContext *_hx_ctx, ::lime::media::AudioSource _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___audioSource=_hx_v; }
		 ::openfl::events::SampleDataEvent _hx___sampleDataEvent;
		inline  ::openfl::events::SampleDataEvent _hx_set__hx___sampleDataEvent(::hx::StackContext *_hx_ctx, ::openfl::events::SampleDataEvent _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___sampleDataEvent=_hx_v; }
		 ::Dynamic _hx___alSource;
		inline  ::Dynamic _hx_set__hx___alSource(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___alSource=_hx_v; }
		 ::openfl::utils::ByteArrayData _hx___outputBuffer;
		inline  ::openfl::utils::ByteArrayData _hx_set__hx___outputBuffer(::hx::StackContext *_hx_ctx, ::openfl::utils::ByteArrayData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___outputBuffer=_hx_v; }
		 ::lime::utils::ArrayBufferView _hx___bufferView;
		inline  ::lime::utils::ArrayBufferView _hx_set__hx___bufferView(::hx::StackContext *_hx_ctx, ::lime::utils::ArrayBufferView _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___bufferView=_hx_v; }
		::cpp::VirtualArray _hx___alBuffers;
		inline ::cpp::VirtualArray _hx_set__hx___alBuffers(::hx::StackContext *_hx_ctx,::cpp::VirtualArray _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___alBuffers=_hx_v; }
		int _hx___numberOfBuffers;
		::cpp::VirtualArray _hx___emptyBuffers;
		inline ::cpp::VirtualArray _hx_set__hx___emptyBuffers(::hx::StackContext *_hx_ctx,::cpp::VirtualArray _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___emptyBuffers=_hx_v; }
		void stop();
		::Dynamic stop_dyn();
