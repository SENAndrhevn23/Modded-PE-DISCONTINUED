...
void Socket_obj::connect( ::sys::net::Host host,int port){
            	HX_GC_STACKFRAME(&_hx_pos_7b961d53d8381ba9_152_connect)
HXDLIN( 152)		try {
...
void Socket_obj::close(){
            	HX_GC_STACKFRAME(&_hx_pos_7b961d53d8381ba9_213_close)
...
HXLINE( 225)		output->close();
 ...
 ::Dynamic Socket_obj::buildSSLConfig(bool server){
            	HX_GC_STACKFRAME(&_hx_pos_7b961d53d8381ba9_260_buildSSLConfig)
