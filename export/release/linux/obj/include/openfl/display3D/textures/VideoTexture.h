...
class HXCPP_CLASS_ATTRIBUTES VideoTexture_obj : public  ::openfl::display3D::textures::TextureBase_obj
{
	...
	public:
		...
		inline  ::openfl::net::NetStream _hx_set__hx___netStream(::hx::StackContext *_hx_ctx, ::openfl::net::NetStream _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___netStream=_hx_v; }
