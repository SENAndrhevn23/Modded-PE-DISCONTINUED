...
class HXCPP_CLASS_ATTRIBUTES LogStyle_obj : public ::hx::Object
{
	...
	public:
		...
		bool underlined;
		::String errorSound;
		inline ::String _hx_set_errorSound(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return errorSound=_hx_v; }
		bool openConsole;
		 ::Dynamic callbackFunction;
		inline  ::Dynamic _hx_set_callbackFunction(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return callbackFunction=_hx_v; }
