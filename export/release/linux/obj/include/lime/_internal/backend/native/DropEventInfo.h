...
HX_DECLARE_STACK_FRAME(_hx_pos_a21879e7650910f2_717_new)
...
HXLINE( 718)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 719)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->_hx_set_file(HX_CTX, file);
            	}
