...
class HXCPP_CLASS_ATTRIBUTES FileDialogHandler_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		inline  ::states::editors::content::FileReferenceCustom _hx_set__fileRef(::hx::StackContext *_hx_ctx, ::states::editors::content::FileReferenceCustom _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _fileRef=_hx_v; }
		 ::lime::ui::FileDialogType _dialogMode;
		inline  ::lime::ui::FileDialogType _hx_set__dialogMode(::hx::StackContext *_hx_ctx, ::lime::ui::FileDialogType _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _dialogMode=_hx_v; }
		 ::Dynamic onComplete;
		...
		Dynamic onComplete_dyn() { return onComplete;}
		 ::Dynamic onCancel;
		inline  ::Dynamic _hx_set_onCancel(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onCancel=_hx_v; }
		...
		inline  ::Dynamic _hx_set__currentEvent(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _currentEvent=_hx_v; }
		...
		::String path;
		inline ::String _hx_set_path(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return path=_hx_v; }
		bool completed;
