...
HXLINE( 331)			this->_hx_set__cache(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE( 332)			return;
            		}
HXLINE( 335)		{
...
HXLINE( 362)			this->_hx_set__cache(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE( 363)			return;
            		}
HXLINE( 366)		{
...
HXLINE( 406)			this->_hx_set__whitePixel(HX_CTX, graphic->get_imageFrame()->get_frame());
            		}
...
::hx::Val BitmapFrontEnd_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"_whitePixel") ) { _hx_set__whitePixel(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::frames::FlxFrame >()); return inValue; }
		break;
	case 19:
