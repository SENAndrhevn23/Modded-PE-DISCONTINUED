...
void FlxTypedPathfinderData_obj::__construct( ::Dynamic map,int startIndex,int endIndex){
            	HX_GC_STACKFRAME(&_hx_pos_d2197318fd890c91_569_new)
HXLINE( 570)		this->_hx_set_map(HX_CTX, map);
...
HXDLIN( 571)		this->_hx_set_distances(HX_CTX, _g);
...
HXDLIN( 574)		this->_hx_set_moves(HX_CTX, _g3);
HXLINE( 576)		this->_hx_set_excluded(HX_CTX, ::Array_obj< int >::__new(1)->init(0,startIndex));
...
void FlxTypedPathfinderData_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_d2197318fd890c91_627_destroy)
HXLINE( 628)		this->_hx_set_map(HX_CTX, null());
HXLINE( 629)		this->_hx_set_distances(HX_CTX, null());
HXLINE( 630)		this->_hx_set_moves(HX_CTX, null());
HXLINE( 631)		this->_hx_set_excluded(HX_CTX, null());
            	}
...
::hx::Val FlxTypedPathfinderData_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"map") ) { _hx_set_map(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"moves") ) { _hx_set_moves(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"endIndex") ) { endIndex=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"excluded") ) { _hx_set_excluded(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"foundEnd") ) { foundEnd=inValue.Cast< bool >(); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"distances") ) { _hx_set_distances(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		break;
	case 10:
