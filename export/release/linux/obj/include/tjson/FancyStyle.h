...
class HXCPP_CLASS_ATTRIBUTES FancyStyle_obj : public ::hx::Object
{
	...
	public:
		...
		::String tab;
		inline ::String _hx_set_tab(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return tab=_hx_v; }
		...
		inline ::Array< ::String > _hx_set_charTimesNCache(::hx::StackContext *_hx_ctx,::Array< ::String > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return charTimesNCache=_hx_v; }
