...
class HXCPP_CLASS_ATTRIBUTES FlxGraphicsShader_obj : public  ::openfl::display::GraphicsShader_obj
{
	...
	public:
		...
		inline  ::openfl::display::ShaderParameter_Float _hx_set_alpha(::hx::StackContext *_hx_ctx, ::openfl::display::ShaderParameter_Float _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return alpha=_hx_v; }
		 ::openfl::display::ShaderParameter_Float colorMultiplier;
		inline  ::openfl::display::ShaderParameter_Float _hx_set_colorMultiplier(::hx::StackContext *_hx_ctx, ::openfl::display::ShaderParameter_Float _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return colorMultiplier=_hx_v; }
		 ::openfl::display::ShaderParameter_Float colorOffset;
		inline  ::openfl::display::ShaderParameter_Float _hx_set_colorOffset(::hx::StackContext *_hx_ctx, ::openfl::display::ShaderParameter_Float _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return colorOffset=_hx_v; }
		 ::openfl::display::ShaderParameter_Bool hasColorTransform;
		inline  ::openfl::display::ShaderParameter_Bool _hx_set_hasColorTransform(::hx::StackContext *_hx_ctx, ::openfl::display::ShaderParameter_Bool _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return hasColorTransform=_hx_v; }
		 ::openfl::display::ShaderParameter_Bool hasTransform;
		inline  ::openfl::display::ShaderParameter_Bool _hx_set_hasTransform(::hx::StackContext *_hx_ctx, ::openfl::display::ShaderParameter_Bool _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return hasTransform=_hx_v; }
};
