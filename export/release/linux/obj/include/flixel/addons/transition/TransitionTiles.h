...
class HXCPP_CLASS_ATTRIBUTES TransitionTiles_obj : public  ::flixel::addons::transition::TransitionEffect_obj
{
	...
	public:
		...
		inline  ::flixel::group::FlxTypedSpriteGroup _hx_set__grpSprites(::hx::StackContext *_hx_ctx, ::flixel::group::FlxTypedSpriteGroup _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _grpSprites=_hx_v; }
		bool _isCenter;
		void destroy();
