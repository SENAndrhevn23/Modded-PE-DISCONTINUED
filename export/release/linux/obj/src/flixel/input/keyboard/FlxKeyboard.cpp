...
HXLINE(  43)		this->_hx_set__nativeCorrection(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
...
::hx::Val FlxKeyboard_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 17:
		if (HX_FIELD_EQ(inName,"_nativeCorrection") ) { _hx_set__nativeCorrection(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
	}
