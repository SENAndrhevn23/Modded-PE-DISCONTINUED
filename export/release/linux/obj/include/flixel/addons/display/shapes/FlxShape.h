...
class HXCPP_CLASS_ATTRIBUTES FlxShape_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		::String __ToString() const { return HX_("FlxShape",6f,ed,f6,38); }
		 ...
		 ::Dynamic lineStyle;
		inline  ::Dynamic _hx_set_lineStyle(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return lineStyle=_hx_v; }
		int fillColor;
		Float shapeWidth;
		Float shapeHeight;
		 ::flixel::addons::display::shapes::FlxShapeType shape_id;
		inline  ::flixel::addons::display::shapes::FlxShapeType _hx_set_shape_id(::hx::StackContext *_hx_ctx, ::flixel::addons::display::shapes::FlxShapeType _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return shape_id=_hx_v; }
		bool shapeDirty;
		void destroy();
		...
		void draw();
		 ...
		 ::Dynamic _drawStyle;
		inline  ::Dynamic _hx_set__drawStyle(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _drawStyle=_hx_v; }
