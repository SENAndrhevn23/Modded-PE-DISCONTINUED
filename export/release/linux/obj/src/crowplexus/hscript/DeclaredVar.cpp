...
HX_DEFINE_STACK_FRAME(_hx_pos_693684c71293979c_45_new,"crowplexus.hscript.DeclaredVar","new",0x8a1c3f5a,"crowplexus.hscript.DeclaredVar.new","crowplexus/hscript/Interp.hx",45,0x864063c3)
namespace crowplexus{
namespace hscript{

void DeclaredVar_obj::__construct(::String n, ::crowplexus::hscript::LocalVar old){
            	HX_GC_STACKFRAME(&_hx_pos_693684c71293979c_45_new)
HXDLIN(  45)		this->_hx_set_n(HX_CTX, n);
HXDLIN(  45)		this->_hx_set_old(HX_CTX, old);
            	}
...
::hx::Val DeclaredVar_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
		if (HX_FIELD_EQ(inName,"n") ) { _hx_set_n(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 3:
		if (HX_FIELD_EQ(inName,"old") ) { _hx_set_old(HX_CTX_GET,inValue.Cast<  ::crowplexus::hscript::LocalVar >()); return inValue; }
	}
