...
HX_LOCAL_STACK_FRAME(_hx_pos_79f3aef22ea5a94d_15_update,"psychlua.DebugLuaText","update",0x02ae3ad4,"psychlua.DebugLuaText.update","psychlua/DebugLuaText.hx",15,0x5376377a)
namespace psychlua{
...
HXLINE(  12)		this->set_borderSize(( (Float)(1) ));
            	}
...
void DebugLuaText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_79f3aef22ea5a94d_15_update)
HXLINE(  16)		this->super::update(elapsed);
HXLINE(  17)		 ::psychlua::DebugLuaText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  17)		_hx_tmp->disableTime = (_hx_tmp->disableTime - elapsed);
HXLINE(  18)		if ((this->disableTime < 0)) {
HXLINE(  18)			this->disableTime = ( (Float)(0) );
            		}
HXLINE(  19)		if ((this->disableTime < 1)) {
HXLINE(  19)			this->set_alpha(this->disableTime);
            		}
HXLINE(  21)		bool _hx_tmp1;
HXDLIN(  21)		if ((this->alpha != 0)) {
HXLINE(  21)			_hx_tmp1 = (this->y >= ::flixel::FlxG_obj::height);
            		}
            		else {
