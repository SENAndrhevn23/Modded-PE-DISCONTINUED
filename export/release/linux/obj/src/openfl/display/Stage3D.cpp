...
HXLINE( 215)		this->_hx_set__hx___stage(HX_CTX, stage);
HXLINE( 217)		this->_hx___height = 0;
HXLINE( 218)		this->_hx_set__hx___projectionTransform(HX_CTX,  ::openfl::geom::Matrix3D_obj::__alloc( HX_CTX ,null()));
HXLINE( 219)		this->_hx_set__hx___renderTransform(HX_CTX,  ::openfl::geom::Matrix3D_obj::__alloc( HX_CTX ,null()));
...
HXLINE( 392)			this->_hx_set_context3D(HX_CTX,  ::openfl::display3D::Context3D_obj::__alloc( HX_CTX ,stage,stage->context3D->_hx___contextState,::hx::ObjectPtr<OBJ_>(this)));
...
::hx::Val Stage3D_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 14:
		...
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"__renderTransform") ) { _hx_set__hx___renderTransform(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Matrix3D >()); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"__contextRequested") ) { _hx___contextRequested=inValue.Cast< bool >(); return inValue; }
		break;
	case 21:
		if (HX_FIELD_EQ(inName,"__projectionTransform") ) { _hx_set__hx___projectionTransform(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Matrix3D >()); return inValue; }
	}
