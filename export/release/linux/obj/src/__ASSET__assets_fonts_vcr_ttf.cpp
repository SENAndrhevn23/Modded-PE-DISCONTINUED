...
HX_DEFINE_STACK_FRAME(_hx_pos_a412f7bc953955ad_1853_new,"__ASSET__assets_fonts_vcr_ttf","new",0xbb14ed97,"__ASSET__assets_fonts_vcr_ttf.new","ManifestResources.hx",1853,0xf77aa668)

void __ASSET__assets_fonts_vcr_ttf_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_a412f7bc953955ad_1853_new)
HXDLIN(1853)		this->_hx_set__hx___fontPath(HX_CTX, (::ManifestResources_obj::rootPath + HX_("assets/fonts/vcr.ttf",46,38,26,7e)));
HXDLIN(1853)		this->_hx_set_name(HX_CTX, HX_("VCR OSD Mono",be,44,e4,b8));
HXDLIN(1853)		super::__construct(null());
            	}
