...
HX_DEFINE_STACK_FRAME(_hx_pos_84dc687d4538b090_50_new,"lime.system.Display","new",0x04208dce,"lime.system.Display.new","lime/system/Display.hx",50,0x4536ff82)
namespace lime{
namespace _hx_system{

void Display_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_84dc687d4538b090_50_new)
            	}
...
::hx::Val Display_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"bounds") ) { _hx_set_bounds(HX_CTX_GET,inValue.Cast<  ::lime::math::Rectangle >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"safeArea") ) { _hx_set_safeArea(HX_CTX_GET,inValue.Cast<  ::lime::math::Rectangle >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"currentMode") ) { _hx_set_currentMode(HX_CTX_GET,inValue.Cast<  ::lime::_hx_system::DisplayMode >()); return inValue; }
		if (HX_FIELD_EQ(inName,"orientation") ) { orientation=inValue.Cast< int >(); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"supportedModes") ) { _hx_set_supportedModes(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
...
static ::hx::StorageInfo Display_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsInt,(int)offsetof(Display_obj,orientation),HX_("orientation",d0,ee,fe,fd)},
	...
	{::hx::fsObject /*  ::lime::math::Rectangle */ ,(int)offsetof(Display_obj,safeArea),HX_("safeArea",7a,5f,78,8e)},
	{ ::hx::fsUnknown, 0, null()}
};
