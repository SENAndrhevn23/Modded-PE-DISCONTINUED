...
HXLINE(  19)		this->_hx_set_barOffset(HX_CTX,  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,3,3));
HXLINE(  18)		this->barHeight = 1;
HXLINE(  17)		this->barWidth = 1;
HXLINE(  14)		this->barCenter = ((Float)0);
HXLINE(  13)		this->leftToRight = true;
HXLINE(  12)		this->_hx_set_bounds(HX_CTX,  ::Dynamic(::hx::Anon_obj::Create(2)
            			->setFixed(0,HX_("max",a4,0a,53,00),1)
            			->setFixed(1,HX_("min",92,11,53,00),0)));
HXLINE(  11)		this->percent = ((Float)0);
HXLINE(  10)		this->_hx_set_valueFunction(HX_CTX, null());
HXLINE(  23)		super::__construct(x,y,null());
HXLINE(  25)		this->_hx_set_valueFunction(HX_CTX, valueFunction);
...
HXDLIN(  28)		this->_hx_set_bg(HX_CTX, _hx_tmp->loadGraphic(::backend::Paths_obj::image(image,null(),null()),null(),null(),null(),null(),null()));
...
HXDLIN(  33)		this->_hx_set_leftBar(HX_CTX, _hx_tmp1->makeGraphic(_hx_tmp2,::Std_obj::_hx_int(this->bg->get_height()),-1,null(),null()));
...
HXDLIN(  37)		this->_hx_set_rightBar(HX_CTX, _hx_tmp4->makeGraphic(_hx_tmp5,::Std_obj::_hx_int(this->bg->get_height()),-1,null(),null()));
...
::hx::Val Bar_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 2:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"bounds") ) { _hx_set_bounds(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"leftBar") ) { _hx_set_leftBar(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSprite >()); return inValue; }
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"rightBar") ) { _hx_set_rightBar(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSprite >()); return inValue; }
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"barOffset") ) { _hx_set_barOffset(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		break;
	case 11:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"valueFunction") ) { _hx_set_valueFunction(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
