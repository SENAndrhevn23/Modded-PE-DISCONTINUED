...
HXLINE(  74)						b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_4,1));
            					}
            					else {
...
void CallStack_Impl__obj::itemToString( ::StringBuf b, ::haxe::StackItem s){
            	HX_GC_STACKFRAME(&_hx_pos_3b20f2b68eaa0619_156_itemToString)
...
HXLINE( 158)					b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_10,1));
            				}
            				else {
...
HXLINE( 160)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_11,1));
            						}
            						else {
...
HXLINE( 161)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(m)));
            						}
            						else {
...
HXLINE( 165)								b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_12,1));
            							}
            							else {
...
HXLINE( 167)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(file)));
            						}
            						else {
...
HXLINE( 168)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_13,1));
            						}
            						else {
...
HXLINE( 169)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(line)));
            						}
            						else {
...
HXLINE( 171)								b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_14,1));
            							}
            							else {
...
HXLINE( 172)								b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(col)));
            							}
            							else {
...
HXLINE( 175)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_15,1));
            						}
            						else {
...
HXLINE( 177)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            						}
            						else {
...
HXLINE( 178)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_16,1));
            						}
            						else {
...
HXLINE( 179)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(meth)));
            						}
            						else {
...
HXLINE( 181)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_baffa80f_17,1));
            						}
            						else {
...
HXLINE( 182)							b->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(n)));
            						}
            						else {
