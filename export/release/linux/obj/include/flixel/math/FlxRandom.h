...
class HXCPP_CLASS_ATTRIBUTES FlxRandom_obj : public ::hx::Object
{
	...
	public:
		...
		void shuffle_objects_Note(::Array< ::Dynamic> array);
		::Dynamic shuffle_objects_Note_dyn();
		...
		::Dynamic getObject_flixel_sound_FlxSound_dyn();
		 ...
		 ::mikolka::vslice::freeplay::SongMenuItem getObject_mikolka_vslice_freeplay_SongMenuItem(::Array< ::Dynamic> Objects,::Array< Float > WeightsArray,::hx::Null< int >  StartIndex, ::Dynamic EndIndex);
		::Dynamic getObject_mikolka_vslice_freeplay_SongMenuItem_dyn();

		void shuffle_substates_StickerSprite(::Array< ::Dynamic> array);
		::Dynamic shuffle_substates_StickerSprite_dyn();
		...
		::String getObject_String(::Array< ::String > Objects,::Array< Float > WeightsArray,::hx::Null< int >  StartIndex, ::Dynamic EndIndex);
		::Dynamic getObject_String_dyn();
