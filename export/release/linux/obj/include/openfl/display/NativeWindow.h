...
class HXCPP_CLASS_ATTRIBUTES NativeWindow_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		inline  ::openfl::display::NativeWindowInitOptions _hx_set__hx___initOptions(::hx::StackContext *_hx_ctx, ::openfl::display::NativeWindowInitOptions _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___initOptions=_hx_v; }
		...
		inline  ::Dynamic _hx_set__hx___previousDisplayState(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___previousDisplayState=_hx_v; }
		bool _hx___active;
		 ::openfl::_Vector::ObjectVector _hx___ownedWindows;
		inline  ::openfl::_Vector::ObjectVector _hx_set__hx___ownedWindows(::hx::StackContext *_hx_ctx, ::openfl::_Vector::ObjectVector _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___ownedWindows=_hx_v; }
