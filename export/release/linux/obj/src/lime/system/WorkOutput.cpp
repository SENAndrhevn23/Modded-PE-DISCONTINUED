...
HXLINE(  75)		this->_hx_set__hx___activeJob(HX_CTX,  ::sys::thread::Tls_obj::__alloc( HX_CTX ));
HXLINE(  66)		this->_hx_set__hx___jobComplete(HX_CTX,  ::sys::thread::Tls_obj::__alloc( HX_CTX ));
HXLINE(  60)		this->_hx_set__hx___jobOutput(HX_CTX,  ::sys::thread::Deque_obj::__alloc( HX_CTX ));
HXLINE(  49)		this->_hx_set_workIterations(HX_CTX,  ::sys::thread::Tls_obj::__alloc( HX_CTX ));
...
::hx::Val WorkOutput_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"__jobOutput") ) { _hx_set__hx___jobOutput(HX_CTX_GET,inValue.Cast<  ::sys::thread::Deque >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__activeJob") ) { _hx_set__hx___activeJob(HX_CTX_GET,inValue.Cast<  ::sys::thread::Tls >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"__jobComplete") ) { _hx_set__hx___jobComplete(HX_CTX_GET,inValue.Cast<  ::sys::thread::Tls >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"workIterations") ) { _hx_set_workIterations(HX_CTX_GET,inValue.Cast<  ::sys::thread::Tls >()); return inValue; }
	}
