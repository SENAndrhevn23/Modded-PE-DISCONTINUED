...
class HXCPP_CLASS_ATTRIBUTES FlxTouch_obj : public  ::flixel::input::FlxPointer_obj
{
	...
	public:
		...
		inline  ::flixel::input::FlxInput _hx_set_input(::hx::StackContext *_hx_ctx, ::flixel::input::FlxInput _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return input=_hx_v; }
		 ::openfl::geom::Point flashPoint;
		inline  ::openfl::geom::Point _hx_set_flashPoint(::hx::StackContext *_hx_ctx, ::openfl::geom::Point _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return flashPoint=_hx_v; }
		 ::flixel::math::FlxBasePoint justPressedPosition;
		inline  ::flixel::math::FlxBasePoint _hx_set_justPressedPosition(::hx::StackContext *_hx_ctx, ::flixel::math::FlxBasePoint _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return justPressedPosition=_hx_v; }
