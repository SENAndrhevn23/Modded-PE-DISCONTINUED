...
::String Base64_obj::encode( ::haxe::io::Bytes source){
            	HX_GC_STACKFRAME(&_hx_pos_26b81c39c19229fa_28_encode)
...
HXLINE(  51)			result->setCtx( HX_CTX, numChunksWritten,extendedDictionary->__get(((inputTriplet >> 12) & 4095)));
HXLINE(  52)			result->setCtx( HX_CTX, (numChunksWritten + 1),extendedDictionary->__get((inputTriplet & 4095)));
...
HXLINE(  62)				result->setCtx( HX_CTX, numChunksWritten,extendedDictionary->__get(((inputTriplet >> 12) & 4095)));
HXLINE(  63)				result->setCtx( HX_CTX, (numChunksWritten + 1),HX_("==",60,35,00,00));
            			}
            			break;
            			case (int)2: {
HXLINE(  65)				inputTriplet = ((( (int)(source->b->__get(numBytesRead)) ) << 16) | (( (int)(source->b->__get((numBytesRead + 1))) ) << 8));
HXLINE(  66)				result->setCtx( HX_CTX, numChunksWritten,extendedDictionary->__get(((inputTriplet >> 12) & 4095)));
HXLINE(  67)				result->setCtx( HX_CTX, (numChunksWritten + 1),(dictionary->__get(((inputTriplet >> 6) & 63)) + HX_("=",3d,00,00,00)));
            			}
            			break;
            			default:{
            			}
