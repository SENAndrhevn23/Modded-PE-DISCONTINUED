...
HX_DEFINE_STACK_FRAME(_hx_pos_f2e09e26201a58ee_73_new,"sys.thread._Thread.HaxeThread","new",0x28e1daea,"sys.thread._Thread.HaxeThread.new","/usr/share/haxe/std/cpp/_std/sys/thread/Thread.hx",73,0x59448795)
...
void HaxeThread_obj::__construct( ::Dynamic h){
            	HX_GC_STACKFRAME(&_hx_pos_f2e09e26201a58ee_73_new)
HXLINE(  89)		this->_hx_set_messages(HX_CTX,  ::sys::thread::Deque_obj::__alloc( HX_CTX ));
HXLINE( 171)		this->_hx_set_handle(HX_CTX, h);
            	}
...
HXLINE(  84)		::sys::thread::_Thread::HaxeThread_obj::mainThread->_hx_set_events(HX_CTX,  ::sys::thread::EventLoop_obj::__alloc( HX_CTX ));
            	}
...
HXLINE( 122)				( ( ::sys::thread::_Thread::HaxeThread)(item->__Field(HX_("thread",ca,7a,b9,8e),::hx::paccDynamic)) )->_hx_set_handle(HX_CTX,  ::Dynamic(item->__Field(HX_("handle",a8,83,fd,b7),::hx::paccDynamic)));
            			}
HXLINE( 124)			try {
...
HXLINE( 118)			( ( ::sys::thread::_Thread::HaxeThread)(item->__Field(HX_("thread",ca,7a,b9,8e),::hx::paccDynamic)) )->_hx_set_events(HX_CTX,  ::sys::thread::EventLoop_obj::__alloc( HX_CTX ));
            		}
...
HXLINE( 134)		( ( ::sys::thread::_Thread::HaxeThread)(item->__Field(HX_("thread",ca,7a,b9,8e),::hx::paccDynamic)) )->_hx_set_handle(HX_CTX,  ::Dynamic(item->__Field(HX_("handle",a8,83,fd,b7),::hx::paccDynamic)));
...
::hx::Val HaxeThread_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"events") ) { _hx_set_events(HX_CTX_GET,inValue.Cast<  ::sys::thread::EventLoop >()); return inValue; }
		if (HX_FIELD_EQ(inName,"handle") ) { _hx_set_handle(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"messages") ) { _hx_set_messages(HX_CTX_GET,inValue.Cast<  ::sys::thread::Deque >()); return inValue; }
	}
