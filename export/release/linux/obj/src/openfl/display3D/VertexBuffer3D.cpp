...
void VertexBuffer3D_obj::__construct( ::openfl::display3D::Context3D context3D,int numVertices,int dataPerVertex,::String bufferUsage){
            	HX_GC_STACKFRAME(&_hx_pos_8e0849c8e2179fab_65_new)
HXLINE(  66)		this->_hx_set__hx___context(HX_CTX, context3D);
...
HXLINE(  72)		this->_hx_set__hx___id(HX_CTX, gl->createBuffer());
...
HXDLIN( 113)				_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN( 113)					_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN( 113)							_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN( 113)							_this3->_hx_set_buffer(HX_CTX, buffer);
...
HXDLIN( 168)					_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN( 168)						_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN( 168)								_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN( 168)								_this3->_hx_set_buffer(HX_CTX, buffer);
...
HXDLIN( 168)			this->_hx_set__hx___tempFloat32Array(HX_CTX, this1);
...
::hx::Val VertexBuffer3D_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"__id") ) { _hx_set__hx___id(HX_CTX_GET,inValue.Cast<  ::lime::graphics::opengl::GLObject >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"__data") ) { _hx_set__hx___data(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::FloatVector >()); return inValue; }
		break;
	case 7:
	...
	case 13:
		...
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"__tempFloat32Array") ) { _hx_set__hx___tempFloat32Array(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
	}
