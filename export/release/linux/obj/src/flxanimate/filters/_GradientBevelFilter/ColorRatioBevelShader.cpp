...
void ColorRatioBevelShader_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_91b1343ec2c0d397_682_new)
...
HXLINE( 686)		this->uStrength->_hx_set_value(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_531671be_1,1));
HXLINE( 687)		this->offset->_hx_set_value(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_531671be_2,2));
...
::hx::Val ColorRatioBevelShader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"colorGradient") ) { _hx_set_colorGradient(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >()); return inValue; }
	}
