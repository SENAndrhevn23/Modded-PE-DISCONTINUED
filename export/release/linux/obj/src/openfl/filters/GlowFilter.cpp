...
HXLINE( 273)		return sourceBitmapData;
 ...
 ::openfl::display::Shader GlowFilter_obj::_hx___initShader( ::openfl::display::DisplayObjectRenderer renderer,int pass, ::openfl::display::BitmapData sourceBitmapData){
            	HX_GC_STACKFRAME(&_hx_pos_f54e58291eefcbc3_277___initShader)
...
HXLINE( 315)				shader1->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 321)			shader2->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 331)				shader3->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 337)			shader4->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
