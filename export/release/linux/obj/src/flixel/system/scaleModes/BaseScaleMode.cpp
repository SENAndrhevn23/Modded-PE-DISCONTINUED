...
void BaseScaleMode_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_c713eb0ccb2ced4e_14_new)
HXLINE(  22)		this->_hx_set_verticalAlign(HX_CTX, ::flixel::util::FlxVerticalAlign_obj::CENTER_dyn());
HXLINE(  21)		this->_hx_set_horizontalAlign(HX_CTX, ::flixel::util::FlxHorizontalAlign_obj::CENTER_dyn());
...
HXDLIN(  26)		this->_hx_set_deviceSize(HX_CTX, point);
...
HXDLIN(  27)		this->_hx_set_gameSize(HX_CTX, point1);
...
HXDLIN(  28)		this->_hx_set_scale(HX_CTX, point2);
...
HXDLIN(  29)		this->_hx_set_offset(HX_CTX, point3);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(BaseScaleMode_obj,updateGamePosition,(void))
 ...
 ::flixel::util::FlxHorizontalAlign BaseScaleMode_obj::set_horizontalAlign( ::flixel::util::FlxHorizontalAlign value){
            	HX_GC_STACKFRAME(&_hx_pos_c713eb0ccb2ced4e_97_set_horizontalAlign)
HXLINE(  98)		this->_hx_set_horizontalAlign(HX_CTX, value);
...
HX_DEFINE_DYNAMIC_FUNC1(BaseScaleMode_obj,set_horizontalAlign,return )
 ...
 ::flixel::util::FlxVerticalAlign BaseScaleMode_obj::set_verticalAlign( ::flixel::util::FlxVerticalAlign value){
            	HX_GC_STACKFRAME(&_hx_pos_c713eb0ccb2ced4e_108_set_verticalAlign)
HXLINE( 109)		this->_hx_set_verticalAlign(HX_CTX, value);
...
::hx::Val BaseScaleMode_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"gameSize") ) { _hx_set_gameSize(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"deviceSize") ) { _hx_set_deviceSize(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"verticalAlign") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_verticalAlign(inValue.Cast<  ::flixel::util::FlxVerticalAlign >()) );_hx_set_verticalAlign(HX_CTX_GET,inValue.Cast<  ::flixel::util::FlxVerticalAlign >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"horizontalAlign") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_horizontalAlign(inValue.Cast<  ::flixel::util::FlxHorizontalAlign >()) );_hx_set_horizontalAlign(HX_CTX_GET,inValue.Cast<  ::flixel::util::FlxHorizontalAlign >()); return inValue; }
	}
