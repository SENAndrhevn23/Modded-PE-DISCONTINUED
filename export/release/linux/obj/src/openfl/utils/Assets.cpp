...
HXLINE( 466)			useCache1->setCtx( HX_CTX, 0,true);
            		}
...
HXLINE( 542)			useCache1->setCtx( HX_CTX, 0,true);
            		}
...
HXLINE( 604)					_library->_hx_set__hx___proxy(HX_CTX, library);
...
HXLINE( 625)			useCache1->setCtx( HX_CTX, 0,true);
            		}
...
HXLINE( 717)			useCache1->setCtx( HX_CTX, 0,true);
            		}
