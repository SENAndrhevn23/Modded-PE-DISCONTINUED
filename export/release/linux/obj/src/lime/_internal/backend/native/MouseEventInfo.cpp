...
HX_DEFINE_STACK_FRAME(_hx_pos_3eb566585b06ea2e_840_new,"lime._internal.backend.native.MouseEventInfo","new",0x46fd57c7,"lime._internal.backend.native.MouseEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",840,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_3eb566585b06ea2e_853_clone,"lime._internal.backend.native.MouseEventInfo","clone",0xb20a8284,"lime._internal.backend.native.MouseEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",853,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void MouseEventInfo_obj::__construct( ::Dynamic type,::hx::Null< int >  __o_windowID,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_button,::hx::Null< Float >  __o_movementX,::hx::Null< Float >  __o_movementY,::hx::Null< int >  __o_clickCount){
            	...
            	HX_STACKFRAME(&_hx_pos_3eb566585b06ea2e_840_new)
HXLINE( 841)		this->type = ( (int)(type) );
HXLINE( 842)		this->windowID = 0;
HXLINE( 843)		this->x = x;
HXLINE( 844)		this->y = y;
HXLINE( 845)		this->button = button;
HXLINE( 846)		this->movementX = movementX;
HXLINE( 847)		this->movementY = movementY;
HXLINE( 848)		this->clickCount = clickCount;
            	}
...
bool MouseEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::MouseEventInfo MouseEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_3eb566585b06ea2e_853_clone)
HXDLIN( 853)		return  ::lime::_internal::backend::native::MouseEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->x,this->y,this->button,this->movementX,this->movementY,this->clickCount);
            	}
