...
class HXCPP_CLASS_ATTRIBUTES ChartingGridSprite_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		inline  ::flixel::FlxSprite _hx_set_stripe(::hx::StackContext *_hx_ctx, ::flixel::FlxSprite _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return stripe=_hx_v; }
		::Array< int > stripes;
		inline ::Array< int > _hx_set_stripes(::hx::StackContext *_hx_ctx,::Array< int > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return stripes=_hx_v; }
		 ::flixel::FlxSprite vortexLine;
		inline  ::flixel::FlxSprite _hx_set_vortexLine(::hx::StackContext *_hx_ctx, ::flixel::FlxSprite _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return vortexLine=_hx_v; }
