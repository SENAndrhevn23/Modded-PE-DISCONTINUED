...
HXLINE( 253)		this->_hx_set_left(HX_CTX, l);
HXLINE( 254)		this->_hx_set_key(HX_CTX, k);
HXLINE( 255)		this->_hx_set_value(HX_CTX, v);
HXLINE( 256)		this->_hx_set_right(HX_CTX, r);
HXLINE( 257)		if ((h == -1)) {
...
::hx::Val TreeNode_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 3:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"left") ) { _hx_set_left(HX_CTX_GET,inValue.Cast<  ::haxe::ds::TreeNode >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"right") ) { _hx_set_right(HX_CTX_GET,inValue.Cast<  ::haxe::ds::TreeNode >()); return inValue; }
