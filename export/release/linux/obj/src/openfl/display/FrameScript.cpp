...
void FrameScript_obj::__construct( ::Dynamic script,int frame){
            	HX_GC_STACKFRAME(&_hx_pos_2b74d327ee4b1542_13_new)
HXLINE(  14)		this->_hx_set_script(HX_CTX, script);
...
::hx::Val FrameScript_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"script") ) { _hx_set_script(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
