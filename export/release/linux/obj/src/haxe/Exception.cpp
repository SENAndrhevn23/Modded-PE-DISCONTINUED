...
void Exception_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic native){
            	HX_GC_STACKFRAME(&_hx_pos_c7e014ce41a096e9_5_new)
HXLINE(  14)		this->_hx___skipStack = 0;
HXLINE(  40)		this->_hx_set__hx___exceptionMessage(HX_CTX, message);
HXLINE(  41)		this->_hx_set__hx___previousException(HX_CTX, previous);
HXLINE(  42)		if (::hx::IsNotNull( native )) {
HXLINE(  43)			this->_hx_set__hx___nativeStack(HX_CTX, ::haxe::NativeStackTrace_obj::exceptionStack());
HXLINE(  44)			this->_hx_set__hx___nativeException(HX_CTX, native);
            		}
            		else {
HXLINE(  46)			this->_hx_set__hx___nativeStack(HX_CTX, ::haxe::NativeStackTrace_obj::callStack());
HXLINE(  47)			this->_hx_set__hx___nativeException(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
            		}
            	}
...
::Array< ::Dynamic> Exception_obj::get_stack(){
            	HX_GC_STACKFRAME(&_hx_pos_c7e014ce41a096e9_88_get_stack)
HXDLIN(  88)		::Array< ::Dynamic> _g = this->_hx___exceptionStack;
HXLINE(  89)		if (::hx::IsNull( _g )) {
HXLINE(  89)			return (this->_hx_set__hx___exceptionStack(HX_CTX, ::haxe::NativeStackTrace_obj::toHaxe(this->_hx___nativeStack,this->_hx___skipStack)));
            		}
            		else {
...
::hx::Val Exception_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 13:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"__exceptionStack") ) { _hx_set__hx___exceptionStack(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 17:
