...
class HXCPP_CLASS_ATTRIBUTES FlxAnim_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::flxanimate::animate::FlxElement _hx_set_stageInstance(::hx::StackContext *_hx_ctx, ::flxanimate::animate::FlxElement _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return stageInstance=_hx_v; }
		 ::flxanimate::animate::FlxElement curInstance;
		inline  ::flxanimate::animate::FlxElement _hx_set_curInstance(::hx::StackContext *_hx_ctx, ::flxanimate::animate::FlxElement _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return curInstance=_hx_v; }
		 ::flxanimate::animate::FlxMetaData metadata;
		inline  ::flxanimate::animate::FlxMetaData _hx_set_metadata(::hx::StackContext *_hx_ctx, ::flxanimate::animate::FlxMetaData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return metadata=_hx_v; }
		 ::flxanimate::animate::FlxSymbol curSymbol;
		inline  ::flxanimate::animate::FlxSymbol _hx_set_curSymbol(::hx::StackContext *_hx_ctx, ::flxanimate::animate::FlxSymbol _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return curSymbol=_hx_v; }
		bool finished;
		 ::haxe::ds::StringMap symbolDictionary;
		inline  ::haxe::ds::StringMap _hx_set_symbolDictionary(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return symbolDictionary=_hx_v; }
		bool swfRender;
		 ::haxe::ds::StringMap buttonMap;
		inline  ::haxe::ds::StringMap _hx_set_buttonMap(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return buttonMap=_hx_v; }
		bool isPlaying;
		 ::flixel::util::_FlxSignal::FlxSignal0 onComplete;
		inline  ::flixel::util::_FlxSignal::FlxSignal0 _hx_set_onComplete(::hx::StackContext *_hx_ctx, ::flixel::util::_FlxSignal::FlxSignal0 _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onComplete=_hx_v; }
		 ::flixel::util::_FlxSignal::FlxSignal1 onFrame;
		inline  ::flixel::util::_FlxSignal::FlxSignal1 _hx_set_onFrame(::hx::StackContext *_hx_ctx, ::flixel::util::_FlxSignal::FlxSignal1 _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onFrame=_hx_v; }
		Float framerate;
		Float frameDelay;
		 ::haxe::ds::StringMap animsMap;
		inline  ::haxe::ds::StringMap _hx_set_animsMap(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return animsMap=_hx_v; }
		Float timeScale;
		 ::flxanimate::FlxAnimate _parent;
		inline  ::flxanimate::FlxAnimate _hx_set__parent(::hx::StackContext *_hx_ctx, ::flxanimate::FlxAnimate _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _parent=_hx_v; }
		Float _tick;
