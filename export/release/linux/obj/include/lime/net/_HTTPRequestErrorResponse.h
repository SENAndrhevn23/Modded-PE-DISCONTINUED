...
{
            	HX_GC_STACKFRAME(&_hx_pos_f7b1deedf7981d65_166_new)
HXLINE( 167)		( ( ::lime::net::_HTTPRequestErrorResponse)(__this) )->_hx_set_error(HX_CTX, error);
HXLINE( 168)		( ( ::lime::net::_HTTPRequestErrorResponse)(__this) )->_hx_set_responseData(HX_CTX, responseData);
            	}
