...
HXLINE( 248)		this->_hx_set_type(HX_CTX, type);
...
HXLINE( 254)				switch((int)(this->type->_hx_getIndex())){
            					case (int)0: {
HXLINE( 257)						this->_hx_set_buffer(HX_CTX,  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,null(),width,height,null(),null()));
...
HXDLIN( 266)								_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN( 266)									_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN( 266)											_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN( 266)											_this3->_hx_set_buffer(HX_CTX, buffer1);
...
HXDLIN( 266)						this->_hx_set_buffer(HX_CTX,  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,width,height,null(),null()));
...
HXDLIN(1494)				_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN(1494)					_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN(1494)							_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN(1494)							_this3->_hx_set_buffer(HX_CTX, buffer);
...
HXDLIN(1572)					_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN(1572)						_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN(1572)								_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN(1572)								_this3->_hx_set_buffer(HX_CTX, buffer2);
...
void Image_obj::_hx___fromImageBuffer( ::lime::graphics::ImageBuffer buffer){
            	HX_GC_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1636___fromImageBuffer)
HXLINE(1637)		this->_hx_set_buffer(HX_CTX, buffer);
...
HX_DEFINE_DYNAMIC_FUNC0(Image_obj,get_data,return )
 ...
 ::lime::utils::ArrayBufferView Image_obj::set_data( ::lime::utils::ArrayBufferView value){
            	HX_GC_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1704_set_data)
HXDLIN(1704)		return (this->buffer->_hx_set_data(HX_CTX, value));
            	}
...
HXLINE( 686)		image->_hx_set_type(HX_CTX, ::lime::graphics::ImageType_obj::CANVAS_dyn());
...
HXLINE( 729)		_image->_hx_set_type(HX_CTX, ::lime::graphics::ImageType_obj::CANVAS_dyn());
...
::hx::Val Image_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		if (HX_FIELD_EQ(inName,"type") ) { _hx_set_type(HX_CTX_GET,inValue.Cast<  ::lime::graphics::ImageType >()); return inValue; }
		break;
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"buffer") ) { _hx_set_buffer(HX_CTX_GET,inValue.Cast<  ::lime::graphics::ImageBuffer >()); return inValue; }
