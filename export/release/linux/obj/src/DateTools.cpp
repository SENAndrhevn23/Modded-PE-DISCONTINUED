...
HXLINE( 113)					r->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,f.substr(p,len)));
            				}
            				else {
...
HXLINE( 114)					r->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            				}
            				else {
...
HXLINE( 118)				r->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,f.substr(p,len1)));
            			}
            			else {
