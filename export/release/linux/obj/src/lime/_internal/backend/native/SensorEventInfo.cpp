...
HX_DEFINE_STACK_FRAME(_hx_pos_60e5fd49cce3a06e_896_new,"lime._internal.backend.native.SensorEventInfo","new",0xcd81dd2e,"lime._internal.backend.native.SensorEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",896,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_60e5fd49cce3a06e_906_clone,"lime._internal.backend.native.SensorEventInfo","clone",0x46c86fab,"lime._internal.backend.native.SensorEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",906,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void SensorEventInfo_obj::__construct( ::Dynamic type,::hx::Null< int >  __o_id,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< Float >  __o_z){
            	...
            	HX_STACKFRAME(&_hx_pos_60e5fd49cce3a06e_896_new)
HXLINE( 897)		this->type = ( (int)(type) );
HXLINE( 898)		this->id = id;
HXLINE( 899)		this->x = x;
HXLINE( 900)		this->y = y;
HXLINE( 901)		this->z = z;
            	}
...
bool SensorEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::SensorEventInfo SensorEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_60e5fd49cce3a06e_906_clone)
HXDLIN( 906)		return  ::lime::_internal::backend::native::SensorEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->x,this->y,this->z);
            	}
