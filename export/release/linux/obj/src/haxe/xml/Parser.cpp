...
HXLINE( 269)									buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,str.substr(start,len)));
            								}
            								else {
...
HXLINE( 277)											buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,str.substr(start,len1)));
            										}
            										else {
...
HXDLIN( 277)									if (::hx::IsNull( buf->b )) {
HXLINE( 277)										buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,str.substr(start,len2)));
            									}
            									else {
...
HXLINE( 159)								buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,str.substr(start,len3)));
            							}
            							else {
...
HXLINE( 166)									buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,str.substr(start,len4)));
            								}
            								else {
...
HXLINE( 366)										buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            									}
            									else {
...
HXLINE( 366)										buf->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            									}
...
HXLINE( 370)										buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1)));
            									}
            									else {
...
HXLINE( 372)									buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2)));
            								}
            								else {
...
HXLINE( 379)									buf->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            								}
...
HXLINE( 380)									buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,str.substr(start,len5)));
            								}
            								else {
...
HXLINE( 399)						buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,str.substr(start,len6)));
            					}
            					else {
...
HXLINE( 406)					buf->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            				}
...
HXLINE( 407)					buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,str.substr(start,len7)));
            				}
            				else {
