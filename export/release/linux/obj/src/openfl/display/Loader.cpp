...
void Loader_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_1b7c318d3e4ffa4a_198_new)
HXLINE( 199)		super::__construct();
HXLINE( 202)		this->_hx___drawableType = 4;
HXLINE( 203)		this->_hx_set_contentLoaderInfo(HX_CTX, ::openfl::display::LoaderInfo_obj::create(::hx::ObjectPtr<OBJ_>(this)));
HXLINE( 204)		this->_hx_set_uncaughtErrorEvents(HX_CTX, this->contentLoaderInfo->uncaughtErrorEvents);
...
HXLINE( 394)		this->contentLoaderInfo->_hx_set_loaderURL(HX_CTX, ::openfl::Lib_obj::get_current()->get_loaderInfo()->url);
HXLINE( 395)		this->contentLoaderInfo->_hx_set_url(HX_CTX, request->url);
...
HXLINE( 401)			this->_hx_set__hx___path(HX_CTX, request->url);
HXLINE( 403)			int queryIndex = this->_hx___path.indexOf(HX_("?",3f,00,00,00),null());
HXLINE( 404)			if ((queryIndex > -1)) {
HXLINE( 406)				this->_hx_set__hx___path(HX_CTX, this->_hx___path.substring(0,queryIndex));
            			}
HXLINE( 409)			while(::StringTools_obj::endsWith(this->_hx___path,HX_("/",2f,00,00,00))){
HXLINE( 411)				this->_hx_set__hx___path(HX_CTX, this->_hx___path.substring(0,(this->_hx___path.length - 1)));
            			}
...
HXDLIN( 416)				_hx_tmp1->_hx_set__hx___path(HX_CTX, (_hx_tmp1->_hx___path + HX_("/library.json",2a,a7,07,47)));
HXLINE( 418)				if ((queryIndex > -1)) {
HXLINE( 420)					::String _hx_tmp2 = this->_hx___path;
HXDLIN( 420)					request->_hx_set_url(HX_CTX, (_hx_tmp2 + request->url.substring(queryIndex,null())));
            				}
            				else {
HXLINE( 424)					request->_hx_set_url(HX_CTX, this->_hx___path);
            				}
            			}
...
HXLINE( 434)				_hx_tmp3 = HX_("application/x-www-form-urlencoded",9e,61,91,fa);
            			...
            			_hx_goto_5:;
HXDLIN( 434)			this->contentLoaderInfo->_hx_set_contentType(HX_CTX, _hx_tmp3);
            		}
            		else {
HXLINE( 448)			this->contentLoaderInfo->_hx_set_contentType(HX_CTX, request->contentType);
            		}
HXLINE( 465)		 ::openfl::net::URLLoader loader =  ::openfl::net::URLLoader_obj::__alloc( HX_CTX ,null());
HXLINE( 466)		loader->_hx_set_dataFormat(HX_CTX, 0);
...
HXLINE( 472)			loader->_hx_set_dataFormat(HX_CTX, 1);
            		}
...
HXLINE( 636)				this->_hx_set__hx___library(HX_CTX, null());
            			}
HXLINE( 639)			this->_hx_set_content(HX_CTX, null());
HXLINE( 640)			this->contentLoaderInfo->_hx_set_url(HX_CTX, null());
HXLINE( 641)			this->contentLoaderInfo->_hx_set_contentType(HX_CTX, null());
HXLINE( 642)			this->contentLoaderInfo->_hx_set_content(HX_CTX, null());
...
HXLINE( 707)		event->_hx_set_text(HX_CTX, text);
...
void Loader_obj::_hx___setContent( ::openfl::display::DisplayObject content,int width,int height){
            	HX_GC_STACKFRAME(&_hx_pos_1b7c318d3e4ffa4a_712___setContent)
HXLINE( 713)		this->_hx_set_content(HX_CTX, content);
HXLINE( 715)		this->contentLoaderInfo->_hx_set_content(HX_CTX, content);
...
HXLINE( 787)					_gthis->_hx_set__hx___library(HX_CTX, ( ( ::openfl::utils::AssetLibrary)(library) ));
...
HXLINE( 824)				this->contentLoaderInfo->_hx_set_bytes(HX_CTX, ( ( ::openfl::utils::ByteArrayData)(loader->data) ));
...
void Loader_obj::loader_onError( ::openfl::events::IOErrorEvent event){
            	HX_GC_STACKFRAME(&_hx_pos_1b7c318d3e4ffa4a_830_loader_onError)
HXLINE( 833)		event->_hx_set_target(HX_CTX, this->contentLoaderInfo);
...
void Loader_obj::loader_onProgress( ::openfl::events::ProgressEvent event){
            	HX_GC_STACKFRAME(&_hx_pos_1b7c318d3e4ffa4a_838_loader_onProgress)
HXLINE( 839)		event->_hx_set_target(HX_CTX, this->contentLoaderInfo);
...
::hx::Val Loader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"content") ) { _hx_set_content(HX_CTX_GET,inValue.Cast<  ::openfl::display::DisplayObject >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"__library") ) { _hx_set__hx___library(HX_CTX_GET,inValue.Cast<  ::openfl::utils::AssetLibrary >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"__unloaded") ) { _hx___unloaded=inValue.Cast< bool >(); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"contentLoaderInfo") ) { _hx_set_contentLoaderInfo(HX_CTX_GET,inValue.Cast<  ::openfl::display::LoaderInfo >()); return inValue; }
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"uncaughtErrorEvents") ) { _hx_set_uncaughtErrorEvents(HX_CTX_GET,inValue.Cast<  ::openfl::events::UncaughtErrorEvents >()); return inValue; }
	}
