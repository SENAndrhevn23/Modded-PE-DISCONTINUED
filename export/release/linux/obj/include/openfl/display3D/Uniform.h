...
class HXCPP_CLASS_ATTRIBUTES Uniform_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::lime::utils::ArrayBufferView _hx_set_regData(::hx::StackContext *_hx_ctx, ::lime::utils::ArrayBufferView _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return regData=_hx_v; }
		int regIndex;
		int regCount;
		bool isDirty;
		...
		inline  ::lime::utils::BytePointerData _hx_set_regDataPointer(::hx::StackContext *_hx_ctx, ::lime::utils::BytePointerData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return regDataPointer=_hx_v; }
		void flush();
		::Dynamic flush_dyn();
