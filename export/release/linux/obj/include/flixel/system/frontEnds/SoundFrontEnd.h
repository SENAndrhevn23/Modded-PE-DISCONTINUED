...
class HXCPP_CLASS_ATTRIBUTES SoundFrontEnd_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::flixel::sound::FlxSound _hx_set_music(::hx::StackContext *_hx_ctx, ::flixel::sound::FlxSound _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return music=_hx_v; }
		bool muted;
		 ::Dynamic volumeHandler;
		inline  ::Dynamic _hx_set_volumeHandler(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return volumeHandler=_hx_v; }
		Dynamic volumeHandler_dyn() { return volumeHandler;}
		::Array< int > volumeUpKeys;
		inline ::Array< int > _hx_set_volumeUpKeys(::hx::StackContext *_hx_ctx,::Array< int > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return volumeUpKeys=_hx_v; }
		::Array< int > volumeDownKeys;
		inline ::Array< int > _hx_set_volumeDownKeys(::hx::StackContext *_hx_ctx,::Array< int > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return volumeDownKeys=_hx_v; }
		::Array< int > muteKeys;
		inline ::Array< int > _hx_set_muteKeys(::hx::StackContext *_hx_ctx,::Array< int > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return muteKeys=_hx_v; }
		...
		inline  ::flixel::sound::FlxSoundGroup _hx_set_defaultMusicGroup(::hx::StackContext *_hx_ctx, ::flixel::sound::FlxSoundGroup _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return defaultMusicGroup=_hx_v; }
		 ::flixel::sound::FlxSoundGroup defaultSoundGroup;
		inline  ::flixel::sound::FlxSoundGroup _hx_set_defaultSoundGroup(::hx::StackContext *_hx_ctx, ::flixel::sound::FlxSoundGroup _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return defaultSoundGroup=_hx_v; }
		 ::flixel::group::FlxTypedGroup list;
		inline  ::flixel::group::FlxTypedGroup _hx_set_list(::hx::StackContext *_hx_ctx, ::flixel::group::FlxTypedGroup _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return list=_hx_v; }
		Float volume;
