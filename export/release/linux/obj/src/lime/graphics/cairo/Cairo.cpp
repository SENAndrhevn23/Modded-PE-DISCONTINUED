...
void Cairo_obj::__construct( ::Dynamic surface){
            	HX_GC_STACKFRAME(&_hx_pos_cd8fe9e91aca1c90_47_new)
HXDLIN(  47)		if (::hx::IsNotNull( surface )) {
HXLINE(  50)			this->_hx_set_handle(HX_CTX, ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_create(::hx::DynamicPtr(surface))) ));
            		}
            	}
...
void Cairo_obj::recreate( ::Dynamic surface){
            	HX_GC_STACKFRAME(&_hx_pos_cd8fe9e91aca1c90_257_recreate)
HXDLIN( 257)		this->_hx_set_handle(HX_CTX, ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_cairo_create(::hx::DynamicPtr(surface))) ));
            	}
