...
void ShaderParameter_Bool_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_abe7b394d2d5e035_168_new)
...
::String ShaderParameter_Bool_obj::set_name(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_abe7b394d2d5e035_591_set_name)
...
::hx::Val ShaderParameter_Bool_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"value") ) { _hx_set_value(HX_CTX_GET,inValue.Cast< ::Array< bool > >()); return inValue; }
		break;
	case 7:
