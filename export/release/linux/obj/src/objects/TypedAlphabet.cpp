...
HXDLIN(  39)					_hx_tmp3->play(_hx_tmp4,(this->volume * ::backend::ClientPrefs_obj::data->sfxVolume),null(),null(),null(),null());
            				}
...
HXDLIN(  86)			_hx_tmp->play(_hx_tmp1,(this->volume * ::backend::ClientPrefs_obj::data->sfxVolume),null(),null(),null(),null());
            		}
...
::hx::Val TypedAlphabet_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"sound") ) { _hx_set_sound(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 6:
