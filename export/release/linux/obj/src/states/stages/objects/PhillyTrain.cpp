...
HXDLIN(  12)		this->_hx_set_sound(HX_CTX, _hx_tmp->loadEmbedded(::backend::Paths_obj::returnSound((HX_("sounds/",eb,02,a5,b6) + sound),null(),true,null()),null(),null(),null()));
...
void PhillyTrain_obj::beatHit(Float curBeat){
