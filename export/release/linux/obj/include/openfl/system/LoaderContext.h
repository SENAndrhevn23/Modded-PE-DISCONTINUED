...
class HXCPP_CLASS_ATTRIBUTES LoaderContext_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::openfl::_hx_system::SecurityDomain _hx_set_securityDomain(::hx::StackContext *_hx_ctx, ::openfl::_hx_system::SecurityDomain _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return securityDomain=_hx_v; }
};
