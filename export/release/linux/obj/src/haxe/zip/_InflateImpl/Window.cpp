...
HXLINE(  38)		this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(65536));
HXLINE(  39)		this->pos = 0;
HXLINE(  40)		if (hasCrc) {
HXLINE(  41)			this->_hx_set_crc(HX_CTX,  ::haxe::crypto::Adler32_obj::__alloc( HX_CTX ));
            		}
            	}
...
void Window_obj::slide(){
            	HX_GC_STACKFRAME(&_hx_pos_f6e7d05923176656_44_slide)
...
HXLINE(  50)		this->_hx_set_buffer(HX_CTX, b);
            	}
...
::hx::Val Window_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 3:
		...
		if (HX_FIELD_EQ(inName,"crc") ) { _hx_set_crc(HX_CTX_GET,inValue.Cast<  ::haxe::crypto::Adler32 >()); return inValue; }
		break;
	case 6:
