...
void FloatMap_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_ea32ed7fa92041fa_292_new)
HXLINE( 293)		this->_hx_set_floatKeys(HX_CTX, ::cpp::VirtualArray_obj::__new());
HXLINE( 294)		this->_hx_set_values(HX_CTX, ::cpp::VirtualArray_obj::__new());
            	}
...
void FloatMap_obj::clear(){
            	HX_GC_STACKFRAME(&_hx_pos_ea32ed7fa92041fa_299_clear)
HXLINE( 300)		this->_hx_set_floatKeys(HX_CTX, ::cpp::VirtualArray_obj::__new());
HXLINE( 301)		this->_hx_set_values(HX_CTX, ::cpp::VirtualArray_obj::__new());
            	}
...
::hx::Val FloatMap_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"values") ) { _hx_set_values(HX_CTX_GET,inValue.Cast< ::cpp::VirtualArray >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"floatKeys") ) { _hx_set_floatKeys(HX_CTX_GET,inValue.Cast< ::cpp::VirtualArray >()); return inValue; }
	}
