...
HXLINE(  40)		this->_hx_set__hx___context(HX_CTX, context3D);
...
HXLINE(  44)		this->_hx_set__hx___id(HX_CTX, gl->createBuffer());
...
HXDLIN(  83)				_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN(  83)					_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN(  83)							_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN(  83)							_this3->_hx_set_buffer(HX_CTX, buffer);
...
HXDLIN( 130)					_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN( 130)						_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN( 130)								_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN( 130)								_this3->_hx_set_buffer(HX_CTX, buffer);
...
HXDLIN( 130)			this->_hx_set__hx___tempUInt16Array(HX_CTX, this1);
...
::hx::Val IndexBuffer3D_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 13:
		...
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"__tempUInt16Array") ) { _hx_set__hx___tempUInt16Array(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
	}
