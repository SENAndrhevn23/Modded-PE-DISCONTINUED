...
{
            	HX_GC_STACKFRAME(&_hx_pos_711a0d9398c8bc73_34_new)
HXDLIN(  34)		( ( ::sys::ssl::Key)(__this) )->_hx_set__hx___k(HX_CTX, k);
            	}
		...
		static void __boot();
		 ::Dynamic _hx___k;
		inline  ::Dynamic _hx_set__hx___k(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___k=_hx_v; }
};
