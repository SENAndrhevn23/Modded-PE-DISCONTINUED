...
HXLINE( 149)			_gthis->_hx_set_responseData(HX_CTX, errorResponse->responseData);
...
HXLINE( 155)			_gthis->_hx_set_responseData(HX_CTX, text);
...
HXLINE( 140)			this->_hx_set_uri(HX_CTX, uri);
            		}
