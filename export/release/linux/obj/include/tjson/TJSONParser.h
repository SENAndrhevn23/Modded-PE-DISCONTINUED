...
class HXCPP_CLASS_ATTRIBUTES TJSONParser_obj : public ::hx::Object
{
	...
	public:
		...
		int pos;
		::String json;
		inline ::String _hx_set_json(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return json=_hx_v; }
		...
		inline ::cpp::VirtualArray _hx_set_cache(::hx::StackContext *_hx_ctx,::cpp::VirtualArray _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return cache=_hx_v; }
		 ::EReg floatRegex;
		inline  ::EReg _hx_set_floatRegex(::hx::StackContext *_hx_ctx, ::EReg _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return floatRegex=_hx_v; }
		 ::EReg intRegex;
		inline  ::EReg _hx_set_intRegex(::hx::StackContext *_hx_ctx, ::EReg _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return intRegex=_hx_v; }
		 ::Dynamic strProcessor;
		inline  ::Dynamic _hx_set_strProcessor(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return strProcessor=_hx_v; }
