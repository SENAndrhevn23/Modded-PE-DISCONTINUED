...
class HXCPP_CLASS_ATTRIBUTES Controls_obj : public ::hx::Object
{
	...
	public:
		...
		bool get_FAVORITE();
		::Dynamic get_FAVORITE_dyn();

		bool get_BAR_LEFT();
		::Dynamic get_BAR_LEFT_dyn();

		bool get_BAR_RIGHT();
		::Dynamic get_BAR_RIGHT_dyn();
		...
		bool get_SCREENSHOT();
		::Dynamic get_SCREENSHOT_dyn();

		bool get_RESET();
		::Dynamic get_RESET_dyn();

		bool get_CHAR_SELECT();
		::Dynamic get_CHAR_SELECT_dyn();

		 ::haxe::ds::StringMap keyboardBinds;
		inline  ::haxe::ds::StringMap _hx_set_keyboardBinds(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return keyboardBinds=_hx_v; }
		 ::haxe::ds::StringMap gamepadBinds;
		inline  ::haxe::ds::StringMap _hx_set_gamepadBinds(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return gamepadBinds=_hx_v; }
		...
		bool isInSubstate;
		 ::Dynamic requestedInstance;
		inline  ::Dynamic _hx_set_requestedInstance(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return requestedInstance=_hx_v; }
		 ::Dynamic get_requestedInstance();
		::Dynamic get_requestedInstance_dyn();

		bool get_mobileC();
		::Dynamic get_mobileC_dyn();

		::String controlInfos();
		::Dynamic controlInfos_dyn();
