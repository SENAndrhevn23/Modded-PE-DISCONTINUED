...
class HXCPP_CLASS_ATTRIBUTES Image_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::lime::graphics::ImageBuffer _hx_set_buffer(::hx::StackContext *_hx_ctx, ::lime::graphics::ImageBuffer _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return buffer=_hx_v; }
		bool dirty;
		int height;
		int offsetX;
		int offsetY;
		 ::lime::math::Rectangle rect;
		inline  ::lime::math::Rectangle _hx_set_rect(::hx::StackContext *_hx_ctx, ::lime::math::Rectangle _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return rect=_hx_v; }
		 ::lime::graphics::ImageType type;
		inline  ::lime::graphics::ImageType _hx_set_type(::hx::StackContext *_hx_ctx, ::lime::graphics::ImageType _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return type=_hx_v; }
		int version;
		int width;
		Float x;
		Float y;
