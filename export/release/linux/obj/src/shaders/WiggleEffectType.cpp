...
::shaders::WiggleEffectType WiggleEffectType_obj::DREAMY;

::shaders::WiggleEffectType WiggleEffectType_obj::FLAG;

::shaders::WiggleEffectType WiggleEffectType_obj::HEAT_WAVE_HORIZONTAL;

::shaders::WiggleEffectType WiggleEffectType_obj::HEAT_WAVE_VERTICAL;

::shaders::WiggleEffectType WiggleEffectType_obj::WAVY;
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("shaders.WiggleEffectType",56,2a,1e,9c), ::hx::TCanCast< WiggleEffectType_obj >,WiggleEffectType_obj_sStaticFields,0,
