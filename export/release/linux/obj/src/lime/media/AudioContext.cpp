...
HXLINE(  49)			this->_hx_set_openal(HX_CTX,  ::lime::media::OpenALAudioContext_obj::__alloc( HX_CTX ));
HXLINE(  50)			this->_hx_set_type(HX_CTX, HX_("openal",35,5f,94,21));
            		}
            		else {
HXLINE(  55)			this->_hx_set_type(HX_CTX, HX_("custom",b1,87,92,3f));
            		}
            	}
...
::hx::Val AudioContext_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"web") ) { _hx_set_web(HX_CTX_GET,inValue.Cast<  ::lime::media::WebAudioContext >()); return inValue; }
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"type") ) { _hx_set_type(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"flash") ) { _hx_set_flash(HX_CTX_GET,inValue.Cast<  ::lime::media::FlashAudioContext >()); return inValue; }
		if (HX_FIELD_EQ(inName,"html5") ) { _hx_set_html5(HX_CTX_GET,inValue.Cast<  ::lime::media::HTML5AudioContext >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"custom") ) { _hx_set_custom(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"openal") ) { _hx_set_openal(HX_CTX_GET,inValue.Cast<  ::lime::media::OpenALAudioContext >()); return inValue; }
	}
