...
HXLINE(  27)		( ( ::openfl::display::_internal::SamplerState)(__this) )->_hx_set_wrap(HX_CTX, wrap);
HXLINE(  28)		( ( ::openfl::display::_internal::SamplerState)(__this) )->_hx_set_filter(HX_CTX, filter);
HXLINE(  29)		( ( ::openfl::display::_internal::SamplerState)(__this) )->_hx_set_mipfilter(HX_CTX, mipfilter);
...
HXLINE(  33)		( ( ::openfl::display::_internal::SamplerState)(__this) )->textureAlpha = textureAlpha;
		...
		bool centroid;
		 ::Dynamic filter;
		inline  ::Dynamic _hx_set_filter(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return filter=_hx_v; }
		bool ignoreSampler;
		Float lodBias;
		 ::Dynamic mipfilter;
		inline  ::Dynamic _hx_set_mipfilter(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return mipfilter=_hx_v; }
		bool mipmapGenerated;
		bool textureAlpha;
		 ::Dynamic wrap;
		inline  ::Dynamic _hx_set_wrap(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return wrap=_hx_v; }
