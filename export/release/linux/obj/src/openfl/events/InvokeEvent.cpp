...
void InvokeEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable, ::openfl::filesystem::File dir,::cpp::VirtualArray argv, ::Dynamic __o_reason){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_bfb5fdf2d9e4c469_41_new)
HXLINE(  42)		super::__construct(type,bubbles,cancelable);
HXLINE(  43)		this->_hx_set_currentDirectory(HX_CTX, dir);
...
HXLINE(  49)		this->_hx_set_arguments(HX_CTX, stringArgs);
HXLINE(  50)		this->_hx_set_reason(HX_CTX, reason);
            	}
...
::hx::Val InvokeEvent_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"reason") ) { _hx_set_reason(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"arguments") ) { _hx_set_arguments(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"currentDirectory") ) { _hx_set_currentDirectory(HX_CTX_GET,inValue.Cast<  ::openfl::filesystem::File >()); return inValue; }
	}
