...
HXLINE(1211)		this->_hx_set__hx___connection(HX_CTX, connection);
HXLINE(1212)		this->_hx_set__hx___soundTransform(HX_CTX,  ::openfl::media::SoundTransform_obj::__alloc( HX_CTX ,null(),null()));
            	}
...
::hx::Val NetStream_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"__timer") ) { _hx_set__hx___timer(HX_CTX_GET,inValue.Cast<  ::haxe::Timer >()); return inValue; }
		break;
	case 8:
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"__connection") ) { _hx_set__hx___connection(HX_CTX_GET,inValue.Cast<  ::openfl::net::NetConnection >()); return inValue; }
		break;
	case 13:
