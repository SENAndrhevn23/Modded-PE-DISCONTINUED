...
void DataEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::String __o_data){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_b4044780e24598ba_77_new)
HXLINE(  78)		super::__construct(type,bubbles,cancelable,null());
HXLINE(  80)		this->_hx_set_data(HX_CTX, data);
            	}
...
HXLINE(  86)		event->_hx_set_target(HX_CTX, this->target);
HXLINE(  87)		event->_hx_set_currentTarget(HX_CTX, this->currentTarget);
...
void DataEvent_obj::_hx___init(){
            	HX_GC_STACKFRAME(&_hx_pos_b4044780e24598ba_98___init)
HXLINE(  99)		this->super::_hx___init();
HXLINE( 100)		this->_hx_set_data(HX_CTX, HX_("",00,00,00,00));
            	}
