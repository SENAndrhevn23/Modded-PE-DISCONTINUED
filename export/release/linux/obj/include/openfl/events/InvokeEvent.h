...
class HXCPP_CLASS_ATTRIBUTES InvokeEvent_obj : public  ::openfl::events::Event_obj
{
	...
	public:
		...
		inline ::Array< ::String > _hx_set_arguments(::hx::StackContext *_hx_ctx,::Array< ::String > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return arguments=_hx_v; }
		 ::openfl::filesystem::File currentDirectory;
		inline  ::openfl::filesystem::File _hx_set_currentDirectory(::hx::StackContext *_hx_ctx, ::openfl::filesystem::File _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return currentDirectory=_hx_v; }
		 ::Dynamic reason;
		inline  ::Dynamic _hx_set_reason(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return reason=_hx_v; }
