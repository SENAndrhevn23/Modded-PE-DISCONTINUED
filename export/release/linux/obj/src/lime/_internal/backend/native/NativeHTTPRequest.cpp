...
HXLINE(  47)		this->_hx_set_buffer(HX_CTX,  ::haxe::io::BytesBuffer_obj::__alloc( HX_CTX ));
HXLINE(  61)		this->_hx_set_curl(HX_CTX, null());
HXLINE(  62)		this->_hx_set_timeout(HX_CTX, null());
            	}
...
void NativeHTTPRequest_obj::cancel(){
            	HX_GC_STACKFRAME(&_hx_pos_11449fe5de606ab4_66_cancel)
...
HXLINE(  82)			this->_hx_set_timeout(HX_CTX, null());
            		}
            	}
...
void NativeHTTPRequest_obj::init(::Dynamic parent){
            	HX_GC_STACKFRAME(&_hx_pos_11449fe5de606ab4_88_init)
HXDLIN(  88)		this->_hx_set_parent(HX_CTX, parent);
            	}
...
HXLINE(  93)		this->_hx_set_bytes(HX_CTX, ::haxe::io::Bytes_obj::alloc(0));
...
HXLINE( 102)			this->_hx_set_curl(HX_CTX,  ::lime::net::curl::CURL_obj::__alloc( HX_CTX ,null()));
            		}
            		else {
...
HXLINE( 277)		this->_hx_set_promise(HX_CTX, promise);
...
HXLINE( 332)					::lime::_internal::backend::native::NativeHTTPRequest_obj::multiProgressTimer->_hx_set_run(HX_CTX, ::lime::_internal::backend::native::NativeHTTPRequest_obj::multiProgressTimer_onRun_dyn());
...
HX_DEFINE_DYNAMIC_FUNC1(NativeHTTPRequest_obj,loadText,return )
 ...
 ::haxe::io::Bytes NativeHTTPRequest_obj::buildBuffer(){
            	HX_GC_STACKFRAME(&_hx_pos_11449fe5de606ab4_364_buildBuffer)
HXLINE( 365)		this->_hx_set_bytes(HX_CTX, this->buffer->getBytes());
...
void NativeHTTPRequest_obj::localThreadPool_doWork( ::Dynamic state, ::lime::_hx_system::WorkOutput output){
            	HX_GC_STACKFRAME(&_hx_pos_11449fe5de606ab4_404_localThreadPool_doWork)
...
HXLINE( 428)			instance->_hx_set_bytes(HX_CTX, ::lime::utils::_Bytes::Bytes_Impl__obj::fromFile(path));
...
void NativeHTTPRequest_obj::localThreadPool_onComplete( ::Dynamic state){
            	HX_GC_STACKFRAME(&_hx_pos_11449fe5de606ab4_449_localThreadPool_onComplete)
...
HXLINE( 459)			instance->_hx_set_timeout(HX_CTX, null());
            		}
HXLINE( 462)		instance->_hx_set_bytes(HX_CTX, null());
HXLINE( 463)		instance->_hx_set_promise(HX_CTX, null());
            	}
...
HXLINE( 476)			instance->_hx_set_timeout(HX_CTX, null());
            		}
HXLINE( 479)		instance->_hx_set_bytes(HX_CTX, null());
HXLINE( 480)		instance->_hx_set_promise(HX_CTX, null());
            	}
...
HXLINE( 600)				instance->_hx_set_timeout(HX_CTX, null());
            			}
HXLINE( 603)			instance->_hx_set_bytes(HX_CTX, null());
HXLINE( 604)			instance->_hx_set_promise(HX_CTX, null());
            		}
...
::hx::Val NativeHTTPRequest_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"curl") ) { _hx_set_curl(HX_CTX_GET,inValue.Cast<  ::lime::net::curl::CURL >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"bytes") ) { _hx_set_bytes(HX_CTX_GET,inValue.Cast<  ::haxe::io::Bytes >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"buffer") ) { _hx_set_buffer(HX_CTX_GET,inValue.Cast<  ::haxe::io::BytesBuffer >()); return inValue; }
		if (HX_FIELD_EQ(inName,"parent") ) { _hx_set_parent(HX_CTX_GET,inValue.Cast< ::Dynamic >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"promise") ) { _hx_set_promise(HX_CTX_GET,inValue.Cast<  ::lime::app::Promise_haxe_io_Bytes >()); return inValue; }
		if (HX_FIELD_EQ(inName,"timeout") ) { _hx_set_timeout(HX_CTX_GET,inValue.Cast<  ::haxe::Timer >()); return inValue; }
		break;
	case 8:
