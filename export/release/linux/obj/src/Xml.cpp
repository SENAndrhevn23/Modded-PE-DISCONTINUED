...
HXLINE( 399)		this->_hx_set_children(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE( 400)		this->_hx_set_attributeMap(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
            	}
...
void Xml_obj::addChild( ::Xml x){
            	HX_GC_STACKFRAME(&_hx_pos_d0403d3b89f1ec8d_353_addChild)
...
HXLINE( 359)		x->_hx_set_parent(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
            	}
...
bool Xml_obj::removeChild( ::Xml x){
            	HX_GC_STACKFRAME(&_hx_pos_d0403d3b89f1ec8d_366_removeChild)
...
HXLINE( 369)			x->_hx_set_parent(HX_CTX, null());
...
HXDLIN( 184)			xml->_hx_set_nodeName(HX_CTX, name);
            		}
...
HXDLIN( 193)			xml->_hx_set_nodeValue(HX_CTX, data);
            		}
...
HXDLIN( 202)			xml->_hx_set_nodeValue(HX_CTX, data);
            		}
...
HXDLIN( 211)			xml->_hx_set_nodeValue(HX_CTX, data);
            		}
...
HXDLIN( 220)			xml->_hx_set_nodeValue(HX_CTX, data);
            		}
...
HXDLIN( 229)			xml->_hx_set_nodeValue(HX_CTX, data);
            		}
...
::hx::Val Xml_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"parent") ) { _hx_set_parent(HX_CTX_GET,inValue.Cast<  ::Xml >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"nodeType") ) { nodeType=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"nodeName") ) { _hx_set_nodeName(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"children") ) { _hx_set_children(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"nodeValue") ) { _hx_set_nodeValue(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"attributeMap") ) { _hx_set_attributeMap(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
	}
