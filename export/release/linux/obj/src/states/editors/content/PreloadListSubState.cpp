...
HXLINE(  33)		this->_hx_set_fileDialog(HX_CTX,  ::states::editors::content::FileDialogHandler_obj::__alloc( HX_CTX ));
HXLINE(  18)		this->_hx_set_preloadListKeys(HX_CTX, ::Array_obj< ::String >::__new(0));
HXLINE(  22)		this->_hx_set_saveCallback(HX_CTX, saveCallback);
...
HXDLIN(  23)		this->_hx_set_lockedList(HX_CTX, _hx_tmp);
...
HXDLIN(  24)		this->_hx_set_preloadList(HX_CTX, _hx_tmp1);
HXLINE(  26)		{
...
HXLINE(  61)		this->_hx_set_outputTxt(HX_CTX,  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,24,640,800,HX_("",00,00,00,00),24,null()));
...
HXLINE(  68)		this->_hx_set_removeButton(HX_CTX,  ::backend::ui::PsychUIButton_obj::__alloc( HX_CTX ,0,0,HX_("X",58,00,00,00), ::Dynamic(new _hx_Closure_0(_gthis)),20,null()));
...
HXDLIN(  96)		this->_hx_set_lqCheckBox(HX_CTX,  ::backend::ui::PsychUICheckBox_obj::__alloc( HX_CTX ,_hx_tmp10,_hx_tmp11,HX_("Low Qual.",b3,53,85,7d),0,updateFilters));
HXLINE(  97)		this->_hx_set_hqCheckBox(HX_CTX,  ::backend::ui::PsychUICheckBox_obj::__alloc( HX_CTX ,this->lqCheckBox->x,(this->lqCheckBox->y + 22),HX_("High Qual.",41,69,7a,3e),0,updateFilters));
HXLINE(  98)		this->_hx_set_smCheckBox(HX_CTX,  ::backend::ui::PsychUICheckBox_obj::__alloc( HX_CTX ,this->hqCheckBox->x,(this->hqCheckBox->y + 22),HX_("Story Mode",ae,07,32,40),0,updateFilters));
...
HXLINE( 106)		this->_hx_set_radioGrp(HX_CTX,  ::backend::ui::PsychUIRadioGroup_obj::__alloc( HX_CTX ,(bg->x + 60),(bg->y + 80),this->preloadListKeys,25,15,false,280));
...
HXDLIN( 272)			 ::openfl::media::Sound _hx_tmp3 = ::backend::Paths_obj::returnSound((HX_("sounds/",eb,02,a5,b6) + HX_("scrollMenu",4c,d4,18,06)),null(),true,null());
HXDLIN( 272)			_hx_tmp2->play(_hx_tmp3,(((Float)0.4) * ::backend::ClientPrefs_obj::data->sfxVolume),null(),null(),null(),null());
            		}
            	}
...
void PreloadListSubState_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_1e955f20e1d8150f_276_destroy)
HXLINE( 277)		{
HXLINE( 277)			int _g = 0;
...
HXLINE( 278)		this->_hx_set_fileDialog(HX_CTX, ( ( ::states::editors::content::FileDialogHandler)(::flixel::util::FlxDestroyUtil_obj::destroy(this->fileDialog)) ));
...
::hx::Val PreloadListSubState_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"radioGrp") ) { _hx_set_radioGrp(HX_CTX_GET,inValue.Cast<  ::backend::ui::PsychUIRadioGroup >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"outputTxt") ) { _hx_set_outputTxt(HX_CTX_GET,inValue.Cast<  ::flixel::text::FlxText >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"lockedList") ) { _hx_set_lockedList(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"lqCheckBox") ) { _hx_set_lqCheckBox(HX_CTX_GET,inValue.Cast<  ::backend::ui::PsychUICheckBox >()); return inValue; }
		if (HX_FIELD_EQ(inName,"hqCheckBox") ) { _hx_set_hqCheckBox(HX_CTX_GET,inValue.Cast<  ::backend::ui::PsychUICheckBox >()); return inValue; }
		if (HX_FIELD_EQ(inName,"smCheckBox") ) { _hx_set_smCheckBox(HX_CTX_GET,inValue.Cast<  ::backend::ui::PsychUICheckBox >()); return inValue; }
		if (HX_FIELD_EQ(inName,"outputTime") ) { outputTime=inValue.Cast< Float >(); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"preloadList") ) { _hx_set_preloadList(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"saveCallback") ) { _hx_set_saveCallback(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"removeButton") ) { _hx_set_removeButton(HX_CTX_GET,inValue.Cast<  ::backend::ui::PsychUIButton >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"preloadListKeys") ) { _hx_set_preloadListKeys(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
	}
