...
HXLINE( 119)		this->_hx_set__hx___children(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE( 120)		int length = null();
HXDLIN( 120)		bool fixed = null();
HXDLIN( 120)		::Array< ::Dynamic> array = null();
HXDLIN( 120)		this->_hx_set__hx___removedChildren(HX_CTX,  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,length,fixed,array,true));
            	}
...
HXLINE( 229)			child->_hx_set_parent(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
...
HXLINE( 250)			event->_hx_set_target(HX_CTX, child);
...
HXLINE( 465)			child->_hx_set_parent(HX_CTX, null());
...
void DisplayObjectContainer_obj::swapChildren( ::openfl::display::DisplayObject child1, ::openfl::display::DisplayObject child2){
            	HX_GC_STACKFRAME(&_hx_pos_d11618aadd936e00_632_swapChildren)
...
HXLINE( 637)			this->_hx___children->setCtx( HX_CTX, index1,child2);
HXLINE( 638)			this->_hx___children->setCtx( HX_CTX, index2,child1);
...
void DisplayObjectContainer_obj::swapChildrenAt(int index1,int index2){
            	HX_GC_STACKFRAME(&_hx_pos_d11618aadd936e00_654_swapChildrenAt)
HXLINE( 655)		 ::openfl::display::DisplayObject swap = this->_hx___children->__get(index1).StaticCast<  ::openfl::display::DisplayObject >();
HXLINE( 656)		this->_hx___children->setCtx( HX_CTX, index1,this->_hx___children->__get(index2).StaticCast<  ::openfl::display::DisplayObject >());
HXLINE( 657)		this->_hx___children->setCtx( HX_CTX, index2,swap);
...
void DisplayObjectContainer_obj::_hx___dispatchChildren( ::openfl::events::Event event){
            	HX_GC_STACKFRAME(&_hx_pos_d11618aadd936e00_689___dispatchChildren)
...
HXDLIN( 691)				_g = (_g + 1);
HXLINE( 693)				event->_hx_set_target(HX_CTX, child);
...
::hx::Val DisplayObjectContainer_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 13:
		...
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"__removedChildren") ) { _hx_set__hx___removedChildren(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::ObjectVector >()); return inValue; }
	}
