...
class HXCPP_CLASS_ATTRIBUTES JobData_obj : public ::hx::Object
{
	...
	public:
		...
		int id;
		 ::Dynamic doWork;
		inline  ::Dynamic _hx_set_doWork(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return doWork=_hx_v; }
		Dynamic doWork_dyn() { return doWork;}
		 ::Dynamic state;
		inline  ::Dynamic _hx_set_state(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return state=_hx_v; }
		Float duration;
		Float startTime;
		bool get_started();
