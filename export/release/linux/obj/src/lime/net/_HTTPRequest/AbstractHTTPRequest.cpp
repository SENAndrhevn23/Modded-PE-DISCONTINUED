...
HXLINE(  51)		this->_hx_set_uri(HX_CTX, uri);
HXLINE(  53)		this->_hx_set_contentType(HX_CTX, HX_("application/x-www-form-urlencoded",9e,61,91,fa));
HXLINE(  54)		this->followRedirects = true;
HXLINE(  55)		this->enableResponseHeaders = false;
HXLINE(  56)		this->_hx_set_formData(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  57)		this->_hx_set_headers(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  58)		this->_hx_set_method(HX_CTX, HX_("GET",76,1c,36,00));
HXLINE(  59)		this->timeout = 30000;
HXLINE(  60)		this->withCredentials = false;
HXLINE(  61)		this->manageCookies = true;
HXLINE(  64)		this->_hx_set__hx___backend(HX_CTX,  ::lime::_internal::backend::native::NativeHTTPRequest_obj::__alloc( HX_CTX ));
...
::hx::Val AbstractHTTPRequest_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"uri") ) { _hx_set_uri(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"data") ) { _hx_set_data(HX_CTX_GET,inValue.Cast<  ::haxe::io::Bytes >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"method") ) { _hx_set_method(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"formData") ) { _hx_set_formData(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"userAgent") ) { _hx_set_userAgent(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__backend") ) { _hx_set__hx___backend(HX_CTX_GET,inValue.Cast<  ::lime::_internal::backend::native::NativeHTTPRequest >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"contentType") ) { _hx_set_contentType(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"responseData") ) { _hx_set_responseData(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 13:
	...
	case 15:
		...
		if (HX_FIELD_EQ(inName,"responseHeaders") ) { _hx_set_responseHeaders(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
