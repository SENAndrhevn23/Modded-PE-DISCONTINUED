...
class HXCPP_CLASS_ATTRIBUTES Matrix_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::lime::utils::ArrayBufferView _hx_set__hx___array(::hx::StackContext *_hx_ctx, ::lime::utils::ArrayBufferView _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___array=_hx_v; }
