...
HX_DEFINE_STACK_FRAME(_hx_pos_c2c9be46dde141ff_144_new,"crowplexus.hscript.Error","new",0xcd8d4855,"crowplexus.hscript.Error.new","crowplexus/hscript/Expr.hx",144,0x8be9fac2)
HX_LOCAL_STACK_FRAME(_hx_pos_c2c9be46dde141ff_153_toString,"crowplexus.hscript.Error","toString",0x49f56097,"crowplexus.hscript.Error.toString","crowplexus/hscript/Expr.hx",153,0x8be9fac2)
namespace crowplexus{
namespace hscript{

void Error_obj::__construct( ::crowplexus::hscript::ErrorDef e,int pmin,int pmax,::String origin,int line){
            	HX_GC_STACKFRAME(&_hx_pos_c2c9be46dde141ff_144_new)
HXLINE( 145)		this->_hx_set_e(HX_CTX, e);
HXLINE( 146)		this->pmin = pmin;
HXLINE( 147)		this->pmax = pmax;
HXLINE( 148)		this->_hx_set_origin(HX_CTX, origin);
HXLINE( 149)		this->line = line;
            	}
...
::String Error_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_c2c9be46dde141ff_153_toString)
HXDLIN( 153)		return ::crowplexus::hscript::Printer_obj::errorToString(::hx::ObjectPtr<OBJ_>(this),null());
            	}
...
::hx::Val Error_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
		if (HX_FIELD_EQ(inName,"e") ) { _hx_set_e(HX_CTX_GET,inValue.Cast<  ::crowplexus::hscript::ErrorDef >()); return inValue; }
		break;
	case 4:
