...
HXLINE( 131)		this->_hx_set_htools(HX_CTX,  ::haxe::zip::HuffTools_obj::__alloc( HX_CTX ));
HXLINE( 132)		this->_hx_set_huffman(HX_CTX, this->buildFixedHuffman());
HXLINE( 133)		this->_hx_set_huffdist(HX_CTX, null());
...
HXDLIN( 136)		this->_hx_set_state(HX_CTX, _hx_tmp);
HXLINE( 137)		this->_hx_set_input(HX_CTX, i);
HXLINE( 138)		this->bits = 0;
HXLINE( 139)		this->nbits = 0;
HXLINE( 140)		this->needed = 0;
HXLINE( 141)		this->_hx_set_output(HX_CTX, null());
HXLINE( 142)		this->outpos = 0;
HXLINE( 143)		this->_hx_set_lengths(HX_CTX, ::Array_obj< int >::__new());
HXLINE( 144)		{
...
HXLINE( 146)		this->_hx_set_window(HX_CTX,  ::haxe::zip::_InflateImpl::Window_obj::__alloc( HX_CTX ,( (bool)(crc) )));
            	}
...
int InflateImpl_obj::readBytes( ::haxe::io::Bytes b,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_0abcb738dc81b7f2_159_readBytes)
HXLINE( 160)		this->needed = len;
HXLINE( 161)		this->outpos = pos;
HXLINE( 162)		this->_hx_set_output(HX_CTX, b);
HXLINE( 163)		if ((len > 0)) {
...
bool InflateImpl_obj::inflateLoop(){
            	HX_GC_STACKFRAME(&_hx_pos_0abcb738dc81b7f2_269_inflateLoop)
...
HXLINE( 284)				this->_hx_set_state(HX_CTX, ::haxe::zip::_InflateImpl::State_obj::Block_dyn());
...
HXLINE( 307)						this->_hx_set_state(HX_CTX, ::haxe::zip::_InflateImpl::State_obj::Flat_dyn());
...
HXLINE( 310)						return r;
            					...
            					break;
            					case (int)1: {
HXLINE( 312)						this->_hx_set_huffman(HX_CTX, this->buildFixedHuffman());
HXLINE( 313)						this->_hx_set_huffdist(HX_CTX, null());
HXLINE( 314)						this->_hx_set_state(HX_CTX, ::haxe::zip::_InflateImpl::State_obj::CData_dyn());
...
HXLINE( 324)						this->_hx_set_huffman(HX_CTX, this->htools->make(this->lengths,0,19,8));
...
HXLINE( 329)						this->_hx_set_huffdist(HX_CTX, this->htools->make(lengths,hlit,hdist,16));
HXLINE( 330)						this->_hx_set_huffman(HX_CTX, this->htools->make(lengths,0,hlit,16));
HXLINE( 331)						this->_hx_set_state(HX_CTX, ::haxe::zip::_InflateImpl::State_obj::CData_dyn());
...
HXDLIN( 367)						this->_hx_set_state(HX_CTX, _hx_tmp);
...
HXDLIN( 382)						this->_hx_set_state(HX_CTX, _hx_tmp4);
...
HXDLIN( 342)					this->_hx_set_state(HX_CTX, _hx_tmp6);
            				}
...
HXLINE( 289)					this->_hx_set_state(HX_CTX, ::haxe::zip::_InflateImpl::State_obj::Done_dyn());
...
HXLINE( 295)				this->_hx_set_state(HX_CTX, ::haxe::zip::_InflateImpl::State_obj::Done_dyn());
...
HXLINE( 359)					this->_hx_set_state(HX_CTX, ::haxe::zip::_InflateImpl::State_obj::CData_dyn());
            				}
...
HXLINE( 349)					this->_hx_set_state(HX_CTX, ::haxe::zip::_InflateImpl::State_obj::CData_dyn());
            				}
...
::hx::Val InflateImpl_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"state") ) { _hx_set_state(HX_CTX_GET,inValue.Cast<  ::haxe::zip::_InflateImpl::State >()); return inValue; }
		if (HX_FIELD_EQ(inName,"input") ) { _hx_set_input(HX_CTX_GET,inValue.Cast<  ::haxe::io::Input >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"htools") ) { _hx_set_htools(HX_CTX_GET,inValue.Cast<  ::haxe::zip::HuffTools >()); return inValue; }
		if (HX_FIELD_EQ(inName,"needed") ) { needed=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"output") ) { _hx_set_output(HX_CTX_GET,inValue.Cast<  ::haxe::io::Bytes >()); return inValue; }
		if (HX_FIELD_EQ(inName,"outpos") ) { outpos=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"window") ) { _hx_set_window(HX_CTX_GET,inValue.Cast<  ::haxe::zip::_InflateImpl::Window >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"isFinal") ) { isFinal=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"huffman") ) { _hx_set_huffman(HX_CTX_GET,inValue.Cast<  ::haxe::zip::Huffman >()); return inValue; }
		if (HX_FIELD_EQ(inName,"lengths") ) { _hx_set_lengths(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"huffdist") ) { _hx_set_huffdist(HX_CTX_GET,inValue.Cast<  ::haxe::zip::Huffman >()); return inValue; }
	}
