...
class HXCPP_CLASS_ATTRIBUTES TextLayout_obj : public ::hx::Object
{
	...
	public:
		...
		bool autoHint;
		 ::lime::text::Font font;
		inline  ::lime::text::Font _hx_set_font(::hx::StackContext *_hx_ctx, ::lime::text::Font _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return font=_hx_v; }
		::Array< int > glyphs;
		inline ::Array< int > _hx_set_glyphs(::hx::StackContext *_hx_ctx,::Array< int > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return glyphs=_hx_v; }
		Float letterSpacing;
		::Array< ::Dynamic> positions;
		inline ::Array< ::Dynamic> _hx_set_positions(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return positions=_hx_v; }
		int size;
		::String text;
		...
		inline  ::haxe::io::Bytes _hx_set__hx___buffer(::hx::StackContext *_hx_ctx, ::haxe::io::Bytes _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___buffer=_hx_v; }
		int _hx___direction;
		bool _hx___dirty;
		 ::Dynamic _hx___handle;
		inline  ::Dynamic _hx_set__hx___handle(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___handle=_hx_v; }
		::String _hx___language;
		inline ::String _hx_set__hx___language(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return _hx___language=_hx_v; }
		::String _hx___script;
		inline ::String _hx_set__hx___script(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return _hx___script=_hx_v; }
		 ::lime::text::Font _hx___font;
		inline  ::lime::text::Font _hx_set__hx___font(::hx::StackContext *_hx_ctx, ::lime::text::Font _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___font=_hx_v; }
		 ::Dynamic _hx___hbBuffer;
		inline  ::Dynamic _hx_set__hx___hbBuffer(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___hbBuffer=_hx_v; }
		 ::Dynamic _hx___hbFont;
		inline  ::Dynamic _hx_set__hx___hbFont(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___hbFont=_hx_v; }
