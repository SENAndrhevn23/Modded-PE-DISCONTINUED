...
HXLINE( 179)		this->_hx_set__wasObjectImmovable(HX_CTX, null());
...
HXLINE( 192)			this->_hx_set__nodes(HX_CTX, nodes->copy());
            		}
            		else {
HXLINE( 194)			this->_hx_set__nodes(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(FlxPath_obj,setProperties,return )
 ...
 ::flixel::path::FlxPath FlxPath_obj::start(::Array< ::Dynamic> nodes,::hx::Null< Float >  __o_speed,::hx::Null< int >  __o_mode,::hx::Null< bool >  __o_autoRotate,::hx::Null< bool >  __o_nodesAsReference){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_128203ded77fa8c1_243_start)
HXLINE( 244)		if (::hx::IsNotNull( nodes )) {
HXLINE( 246)			if (nodesAsReference) {
HXLINE( 248)				this->_hx_set__nodes(HX_CTX, nodes);
            			}
            			else {
HXLINE( 252)				this->_hx_set__nodes(HX_CTX, nodes->copy());
            			}
            		}
...
void FlxPath_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_128203ded77fa8c1_317_update)
HXLINE( 318)		if (::hx::IsNull( this->object )) {
HXLINE( 319)			return;
            		}
HXLINE( 321)		if (this->_firstUpdate) {
HXLINE( 323)			if (this->immovable) {
HXLINE( 325)				this->_hx_set__wasObjectImmovable(HX_CTX, this->object->immovable);
...
void FlxPath_obj::onEnd(){
            	HX_GC_STACKFRAME(&_hx_pos_128203ded77fa8c1_560_onEnd)
...
HXLINE( 565)		this->_hx_set__wasObjectImmovable(HX_CTX, null());
            	}
...
void FlxPath_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_128203ded77fa8c1_572_destroy)
HXLINE( 573)		::flixel::util::FlxDestroyUtil_obj::putArray(this->_nodes);
HXLINE( 574)		this->_hx_set__nodes(HX_CTX, null());
HXLINE( 575)		this->_hx_set_object(HX_CTX, null());
HXLINE( 576)		this->_hx_set_onComplete(HX_CTX, null());
            	}
...
::Array< ::Dynamic> FlxPath_obj::set_nodes(::Array< ::Dynamic> nodes){
            	HX_GC_STACKFRAME(&_hx_pos_128203ded77fa8c1_833_set_nodes)
HXLINE( 834)		if (::hx::IsNotNull( nodes )) {
HXLINE( 836)			this->_hx_set__nodes(HX_CTX, nodes);
            		}
...
bool FlxPath_obj::set_immovable(bool value){
            	HX_GC_STACKFRAME(&_hx_pos_128203ded77fa8c1_842_set_immovable)
...
HXLINE( 846)		if (value) {
HXLINE( 848)			this->_hx_set__wasObjectImmovable(HX_CTX, this->object->immovable);
...
HXLINE( 854)				this->_hx_set__wasObjectImmovable(HX_CTX, null());
            			}
            		}
...
::hx::Val FlxPath_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"_nodes") ) { _hx_set__nodes(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	...
	case 12:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"_wasObjectImmovable") ) { _hx_set__wasObjectImmovable(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
