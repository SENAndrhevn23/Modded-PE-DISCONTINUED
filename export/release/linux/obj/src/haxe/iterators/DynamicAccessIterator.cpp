...
void DynamicAccessIterator_obj::__construct( ::Dynamic access){
            	HX_GC_STACKFRAME(&_hx_pos_aed1a9c075829518_33_new)
HXLINE(  34)		this->_hx_set_access(HX_CTX, access);
HXLINE(  35)		this->_hx_set_keys(HX_CTX, ::Reflect_obj::fields(access));
...
::hx::Val DynamicAccessIterator_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"keys") ) { _hx_set_keys(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"index") ) { index=inValue.Cast< int >(); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"access") ) { _hx_set_access(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
