...
::String FlxBasePoint_obj::toString(){
            	HX_GC_STACKFRAME(&_hx_pos_4bc163271948760e_1556_toString)
...
HXDLIN(1556)		_this->_hx_set_label(HX_CTX, HX_("x",78,00,00,00));
HXDLIN(1556)		_this->_hx_set_value(HX_CTX, value);
...
HXDLIN(1556)		_this1->_hx_set_label(HX_CTX, HX_("y",79,00,00,00));
HXDLIN(1556)		_this1->_hx_set_value(HX_CTX, value1);
