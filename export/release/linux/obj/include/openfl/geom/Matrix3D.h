...
class HXCPP_CLASS_ATTRIBUTES Matrix3D_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::openfl::_Vector::FloatVector _hx_set_rawData(::hx::StackContext *_hx_ctx, ::openfl::_Vector::FloatVector _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return rawData=_hx_v; }
