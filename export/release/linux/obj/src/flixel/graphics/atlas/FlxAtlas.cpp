...
HXLINE( 134)		this->_hx_set_nodes(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
...
HXDLIN( 164)		this->_hx_set_root(HX_CTX,  ::flixel::graphics::atlas::FlxNode_obj::__alloc( HX_CTX ,rect,::hx::ObjectPtr<OBJ_>(this),null(),null(),null()));
            	}
...
HXDLIN( 221)		this->_hx_set_root(HX_CTX,  ::flixel::graphics::atlas::FlxNode_obj::__alloc( HX_CTX ,rect,::hx::ObjectPtr<OBJ_>(this),null(),null(),null()));
HXLINE( 222)		this->root->_hx_set_left(HX_CTX, temp);
            	}
...
HXLINE( 318)			firstChild->_hx_set_left(HX_CTX, firstGrandChild);
HXLINE( 319)			firstChild->_hx_set_right(HX_CTX, secondGrandChild);
HXLINE( 321)			nodeToDivide->_hx_set_left(HX_CTX, firstChild);
HXLINE( 322)			nodeToDivide->_hx_set_right(HX_CTX, secondChild);
...
HXDLIN( 553)			this->_hx_set_root(HX_CTX,  ::flixel::graphics::atlas::FlxNode_obj::__alloc( HX_CTX ,rect,::hx::ObjectPtr<OBJ_>(this),null(),null(),null()));
...
HXLINE( 558)			this->root->left->_hx_set_left(HX_CTX, temp);
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxAtlas_obj,getNode,return )
 ...
 ::flixel::graphics::atlas::FlxAtlas FlxAtlas_obj::addNodes(::Array< ::Dynamic> bitmaps,::Array< ::String > keys){
            	HX_GC_STACKFRAME(&_hx_pos_f38becfab6571882_721_addNodes)
...
HXLINE( 733)		this->_hx_set__tempStorage(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE( 734)		{
HXLINE( 734)			int _g = 0;
...
void FlxAtlas_obj::addFromAtlasObjects(::Array< ::Dynamic> objects){
            	HX_GC_STACKFRAME(&_hx_pos_f38becfab6571882_744_addFromAtlasObjects)
...
HXLINE( 751)		this->_hx_set__tempStorage(HX_CTX, null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FlxAtlas_obj,bitmapSorter,return )
 ...
 ::flixel::graphics::atlas::FlxAtlas FlxAtlas_obj::createQueue(){
            	HX_GC_STACKFRAME(&_hx_pos_f38becfab6571882_780_createQueue)
HXLINE( 781)		this->_hx_set__tempStorage(HX_CTX, ::Array_obj< ::Dynamic>::__new());
...
HX_DEFINE_DYNAMIC_FUNC0(FlxAtlas_obj,createQueue,return )
 ...
 ::flixel::graphics::atlas::FlxAtlas FlxAtlas_obj::addToQueue( ::openfl::display::BitmapData data,::String key){
            	HX_GC_STACKFRAME(&_hx_pos_f38becfab6571882_792_addToQueue)
HXLINE( 793)		if (::hx::IsNull( this->_tempStorage )) {
HXLINE( 794)			this->_hx_set__tempStorage(HX_CTX, ::Array_obj< ::Dynamic>::__new());
            		}
...
void FlxAtlas_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_f38becfab6571882_822_destroy)
HXLINE( 823)		this->_hx_set__tempStorage(HX_CTX, null());
HXLINE( 824)		this->deleteSubtree(this->root);
HXLINE( 825)		this->_hx_set_root(HX_CTX, null());
HXLINE( 826)		::flixel::FlxG_obj::bitmap->removeByKey(this->name);
HXLINE( 827)		this->set_bitmapData(null());
HXLINE( 828)		this->_hx_set_nodes(HX_CTX, null());
HXLINE( 829)		this->_hx_set__graphic(HX_CTX, null());
...
HXLINE( 845)		this->_hx_set_nodes(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE( 846)		this->_hx_set__graphic(HX_CTX, null());
            	}
...
void FlxAtlas_obj::deleteSubtree( ::flixel::graphics::atlas::FlxNode node){
            	HX_GC_STACKFRAME(&_hx_pos_f38becfab6571882_886_deleteSubtree)
...
HXLINE( 892)			{
HXLINE( 892)				node->_hx_set_key(HX_CTX, null());
HXDLIN( 892)				node->_hx_set_left(HX_CTX, null());
HXDLIN( 892)				node->_hx_set_right(HX_CTX, null());
HXDLIN( 892)				node->_hx_set_rect(HX_CTX, null());
HXDLIN( 892)				node->_hx_set_atlas(HX_CTX, null());
            			}
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FlxAtlas_obj,findNodeToInsert,return )
 ...
 ::openfl::display::BitmapData FlxAtlas_obj::set_bitmapData( ::openfl::display::BitmapData value){
            	HX_GC_STACKFRAME(&_hx_pos_f38becfab6571882_964_set_bitmapData)
...
HXLINE( 969)		return (this->_hx_set_bitmapData(HX_CTX, value));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxAtlas_obj,set_bitmapData,return )
 ...
 ::flixel::graphics::FlxGraphic FlxAtlas_obj::get_graphic(){
            	HX_GC_STACKFRAME(&_hx_pos_f38becfab6571882_973_get_graphic)
HXLINE( 974)		if (::hx::IsNotNull( this->_graphic )) {
HXLINE( 975)			return this->_graphic;
            		}
HXLINE( 977)		this->_hx_set__graphic(HX_CTX, ::flixel::FlxG_obj::bitmap->add(this->bitmapData,false,this->name));
...
HXDLIN(1102)				this->_hx_set_root(HX_CTX,  ::flixel::graphics::atlas::FlxNode_obj::__alloc( HX_CTX ,rect,::hx::ObjectPtr<OBJ_>(this),null(),null(),null()));
...
HXLINE(1107)					this->root->left->_hx_set_left(HX_CTX, temp);
            				}
            			}
            		}
...
::hx::Val FlxAtlas_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"root") ) { _hx_set_root(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::atlas::FlxNode >()); return inValue; }
		if (HX_FIELD_EQ(inName,"name") ) { _hx_set_name(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"nodes") ) { _hx_set_nodes(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"_graphic") ) { _hx_set__graphic(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::FlxGraphic >()); return inValue; }
		break;
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"bitmapData") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_bitmapData(inValue.Cast<  ::openfl::display::BitmapData >()) );_hx_set_bitmapData(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"_tempStorage") ) { _hx_set__tempStorage(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 13:
