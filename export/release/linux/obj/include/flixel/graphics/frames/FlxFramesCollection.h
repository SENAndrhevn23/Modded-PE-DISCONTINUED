...
class HXCPP_CLASS_ATTRIBUTES FlxFramesCollection_obj : public ::hx::Object
{
	...
	public:
		...
		inline ::Array< ::Dynamic> _hx_set_frames(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return frames=_hx_v; }
		 ::haxe::ds::StringMap framesByName;
		inline  ::haxe::ds::StringMap _hx_set_framesByName(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return framesByName=_hx_v; }
		...
		inline  ::flixel::graphics::frames::FlxFrameCollectionType _hx_set_type(::hx::StackContext *_hx_ctx, ::flixel::graphics::frames::FlxFrameCollectionType _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return type=_hx_v; }
		 ::flixel::math::FlxBasePoint border;
		inline  ::flixel::math::FlxBasePoint _hx_set_border(::hx::StackContext *_hx_ctx, ::flixel::math::FlxBasePoint _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return border=_hx_v; }
