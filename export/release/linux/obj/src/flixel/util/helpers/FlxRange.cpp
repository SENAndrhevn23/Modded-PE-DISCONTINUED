...
void FlxRange_obj::__construct( ::Dynamic start, ::Dynamic end){
            	HX_GC_STACKFRAME(&_hx_pos_05e7652c5709bfbb_8_new)
HXLINE(  23)		this->active = true;
HXLINE(  33)		this->_hx_set_start(HX_CTX, start);
...
HXDLIN(  34)		this->_hx_set_end(HX_CTX, _hx_tmp);
            	}
...
bool FlxRange_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::util::helpers::FlxRange FlxRange_obj::set( ::Dynamic start, ::Dynamic end){
            	HX_GC_STACKFRAME(&_hx_pos_05e7652c5709bfbb_45_set)
HXLINE(  46)		this->_hx_set_start(HX_CTX, start);
...
HXDLIN(  47)		this->_hx_set_end(HX_CTX, _hx_tmp);
...
::String FlxRange_obj::toString(){
            	HX_GC_STACKFRAME(&_hx_pos_05e7652c5709bfbb_68_toString)
...
HXDLIN(  68)		_this->_hx_set_label(HX_CTX, HX_("start",62,74,0b,84));
HXDLIN(  68)		_this->_hx_set_value(HX_CTX, value);
...
HXDLIN(  68)		_this1->_hx_set_label(HX_CTX, HX_("end",db,03,4d,00));
HXDLIN(  68)		_this1->_hx_set_value(HX_CTX, value1);
...
::hx::Val FlxRange_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"end") ) { _hx_set_end(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"start") ) { _hx_set_start(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 6:
