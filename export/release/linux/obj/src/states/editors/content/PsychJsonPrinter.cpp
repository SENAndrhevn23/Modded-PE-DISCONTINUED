...
void PsychJsonPrinter_obj::__construct( ::Dynamic replacer,::String space){
            	HX_GC_STACKFRAME(&_hx_pos_6ce7e6fc01ae98e5_11_new)
HXLINE(  22)		this->_singleLineCheckNext = false;
HXLINE(  13)		this->_hx_set__ignoreTab(HX_CTX, ::Array_obj< ::String >::__new(0));
...
void PsychJsonPrinter_obj::fieldsStringEx( ::Dynamic v,::Array< ::String > fields, ::Dynamic __o_mapCheck){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_6ce7e6fc01ae98e5_29_fieldsStringEx)
HXLINE(  30)		{
HXLINE(  30)			 ::StringBuf _this = this->buf;
HXDLIN(  30)			{
HXLINE(  30)				if (::hx::IsNull( _this->charBuf )) {
HXLINE(  30)					_this->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            				}
...
HXLINE(  63)								_this1->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            							}
...
HXLINE(  64)								_this2->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            							}
...
HXLINE(  81)								_this3->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            							}
...
HXLINE(  82)								_this4->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v1)));
            							}
            							else {
...
HXLINE(  85)							_this6->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            						}
...
HXLINE(  87)							_this7->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            						}
...
HXLINE(  98)									_this8->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            								}
...
HXLINE(  99)									_this9->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v2)));
            								}
            								else {
...
HXLINE( 105)						_this11->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            					}
...
HXLINE( 106)						_this12->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v3)));
            					}
            					else {
...
HXLINE( 108)					_this14->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            				}
...
void PsychJsonPrinter_obj::write( ::Dynamic k, ::Dynamic v){
            	HX_GC_STACKFRAME(&_hx_pos_6ce7e6fc01ae98e5_111_write)
...
HXLINE( 197)						_this->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_25b77200_10,1));
            					}
            					else {
...
HXLINE( 120)							_this1->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v1)));
            						}
            						else {
...
HXLINE( 122)							_this3->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v2)));
            						}
            						else {
...
HXLINE( 195)							_this5->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v3)));
            						}
            						else {
...
HXLINE( 124)						_this7->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_25b77200_11,1));
            					}
            					else {
...
HXLINE( 130)										_this8->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            									}
...
HXLINE( 153)													_this9->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            												}
...
HXLINE( 154)													_this10->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            												}
...
HXLINE( 160)													_this11->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            												}
...
HXLINE( 161)													_this12->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v5)));
            												}
            												else {
...
HXLINE( 169)														_this14->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            													}
...
HXLINE( 170)														_this15->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v6)));
            													}
            													else {
...
HXLINE( 176)											_this17->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            										}
...
HXLINE( 177)											_this18->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v7)));
            										}
            										else {
...
HXLINE( 179)										_this20->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            									}
...
HXLINE( 193)									_this21->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(v10)));
            								}
            								else {
...
HXLINE( 116)						_this23->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_25b77200_12,1));
            					}
            					else {
...
HXLINE(  17)			printer->_hx_set__ignoreTab(HX_CTX, ignoreTab);
            		}
...
::hx::Val PsychJsonPrinter_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 10:
		if (HX_FIELD_EQ(inName,"_ignoreTab") ) { _hx_set__ignoreTab(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		break;
	case 20:
