...
HX_DEFINE_STACK_FRAME(_hx_pos_45f117d879fd522d_697_new,"lime._internal.backend.native.ClipboardEventInfo","new",0x8e61fe76,"lime._internal.backend.native.ClipboardEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",697,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_45f117d879fd522d_702_clone,"lime._internal.backend.native.ClipboardEventInfo","clone",0x18e972f3,"lime._internal.backend.native.ClipboardEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",702,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void ClipboardEventInfo_obj::__construct( ::Dynamic type){
            	HX_STACKFRAME(&_hx_pos_45f117d879fd522d_697_new)
HXDLIN( 697)		this->type = ( (int)(type) );
            	}
...
bool ClipboardEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::ClipboardEventInfo ClipboardEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_45f117d879fd522d_702_clone)
HXDLIN( 702)		return  ::lime::_internal::backend::native::ClipboardEventInfo_obj::__alloc( HX_CTX ,this->type);
            	}
