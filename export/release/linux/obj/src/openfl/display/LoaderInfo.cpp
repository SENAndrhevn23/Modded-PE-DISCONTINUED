...
void LoaderInfo_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_bc206267402385e1_388_new)
HXLINE( 389)		super::__construct(null());
HXLINE( 391)		this->_hx_set_applicationDomain(HX_CTX, ::openfl::_hx_system::ApplicationDomain_obj::currentDomain);
HXLINE( 392)		this->bytesLoaded = 0;
HXLINE( 393)		this->bytesTotal = 0;
HXLINE( 394)		this->childAllowsParent = true;
HXLINE( 395)		this->_hx_set_parameters(HX_CTX,  ::Dynamic(::hx::Anon_obj::Create(0)));
            	}
...
HXLINE( 403)		loaderInfo->_hx_set_uncaughtErrorEvents(HX_CTX,  ::openfl::events::UncaughtErrorEvents_obj::__alloc( HX_CTX ));
HXLINE( 405)		if (::hx::IsNotNull( loader )) {
HXLINE( 407)			loaderInfo->_hx_set_loader(HX_CTX, loader);
            		}
            		else {
HXLINE( 411)			loaderInfo->_hx_set_url(HX_CTX, ::openfl::display::LoaderInfo_obj::_hx___rootURL);
            		}
...
::hx::Val LoaderInfo_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 3:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"bytes") ) { _hx_set_bytes(HX_CTX_GET,inValue.Cast<  ::openfl::utils::ByteArrayData >()); return inValue; }
		if (HX_FIELD_EQ(inName,"width") ) { width=inValue.Cast< int >(); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"height") ) { height=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"loader") ) { _hx_set_loader(HX_CTX_GET,inValue.Cast<  ::openfl::display::Loader >()); return inValue; }
		break;
	case 7:
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"loaderURL") ) { _hx_set_loaderURL(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 10:
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"contentType") ) { _hx_set_contentType(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__completed") ) { _hx___completed=inValue.Cast< bool >(); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"sharedEvents") ) { _hx_set_sharedEvents(HX_CTX_GET,inValue.Cast<  ::openfl::events::EventDispatcher >()); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"applicationDomain") ) { _hx_set_applicationDomain(HX_CTX_GET,inValue.Cast<  ::openfl::_hx_system::ApplicationDomain >()); return inValue; }
