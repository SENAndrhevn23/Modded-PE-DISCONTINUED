...
HX_LOCAL_STACK_FRAME(_hx_pos_131a2bb3c37f0df9_553_getByName,"flxanimate.animate.FlxAnim","getByName",0x97386881,"flxanimate.animate.FlxAnim.getByName","flxanimate/animate/FlxAnim.hx",553,0x524d8fe9)
HX_LOCAL_STACK_FRAME(_hx_pos_131a2bb3c37f0df9_557_getByInstance,"flxanimate.animate.FlxAnim","getByInstance",0xce7068cb,"flxanimate.animate.FlxAnim.getByInstance","flxanimate/animate/FlxAnim.hx",557,0x524d8fe9)
HX_LOCAL_STACK_FRAME(_hx_pos_131a2bb3c37f0df9_586_get_curSymbol,"flxanimate.animate.FlxAnim","get_curSymbol",0x0e9d48d8,"flxanimate.animate.FlxAnim.get_curSymbol","flxanimate/animate/FlxAnim.hx",586,0x524d8fe9)
HX_LOCAL_STACK_FRAME(_hx_pos_131a2bb3c37f0df9_590_destroy,"flxanimate.animate.FlxAnim","destroy",0x39e0bc43,"flxanimate.animate.FlxAnim.destroy","flxanimate/animate/FlxAnim.hx",590,0x524d8fe9)
...
HXLINE( 110)		this->_hx_set_animsMap(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  93)		this->_hx_set_onFrame(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX ));
HXLINE(  87)		this->_hx_set_onComplete(HX_CTX,  ::flixel::util::_FlxSignal::FlxSignal0_obj::__alloc( HX_CTX ));
HXLINE(  77)		this->_hx_set_buttonMap(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  75)		this->swfRender = false;
HXLINE( 148)		this->_tick = ( (Float)(0) );
HXLINE( 149)		this->_hx_set__parent(HX_CTX, parent);
...
HXLINE( 156)		this->_hx_set_symbolDictionary(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE( 157)		this->_hx_set_stageInstance(HX_CTX, null());
...
HXDLIN( 162)		this->_hx_set_stageInstance(HX_CTX, _hx_tmp);
HXLINE( 164)		this->_hx_set_curInstance(HX_CTX, this->stageInstance);
...
HXDLIN( 169)		this->_hx_set_metadata(HX_CTX,  ::flxanimate::animate::FlxMetaData_obj::__alloc( HX_CTX ,_hx_tmp1,::flxanimate::data::_AnimationData::MetaData_Impl__obj::get_FRT(::flxanimate::data::_AnimationData::AnimAtlas_Impl__obj::get_MD(animationFile))));
...
void FlxAnim_obj::play(::String __o_Name, ::Dynamic __o_Force, ::Dynamic __o_Reverse, ::Dynamic __o_Frame){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_131a2bb3c37f0df9_180_play)
...
HXLINE( 190)					this->_hx_set_curInstance(HX_CTX, this->stageInstance);
            				}
            				else {
HXLINE( 191)					if (this->symbolDictionary->exists(Name)) {
HXLINE( 193)						this->curInstance->symbol->reset();
HXLINE( 194)						this->curInstance->symbol->_hx_set_name(HX_CTX, Name);
            					}
            					else {
...
HXLINE( 208)				this->_hx_set_curInstance(HX_CTX, ( ( ::flxanimate::animate::FlxElement)(curThing->__Field(HX_("instance",95,1f,e1,59),::hx::paccDynamic)) ));
            			}
            		}
...
void FlxAnim_obj::playElement( ::flxanimate::animate::FlxElement element, ::Dynamic __o_Force, ::Dynamic __o_Reverse, ::Dynamic __o_Frame){
            		...
            		if (::hx::IsNull(__o_Reverse)) Reverse = false;
            		 ::Dynamic Frame = __o_Frame;
            		if (::hx::IsNull(__o_Frame)) Frame = 0;
            	HX_GC_STACKFRAME(&_hx_pos_131a2bb3c37f0df9_222_playElement)
...
HXLINE( 231)			this->_hx_set_curInstance(HX_CTX, element);
            		}
            		else {
HXLINE( 234)			this->_hx_set_curInstance(HX_CTX, this->stageInstance);
            		}
...
HXLINE( 360)					params2->symbol->_hx_set_name(HX_CTX, name1);
...
HXLINE( 427)		params2->symbol->_hx_set_name(HX_CTX, symbol->name);
...
::String FlxAnim_obj::toString(){
            	HX_GC_STACKFRAME(&_hx_pos_131a2bb3c37f0df9_467_toString)
...
HXDLIN( 468)		_this->_hx_set_label(HX_CTX, HX_("symbolDictionary",0e,e5,dd,19));
HXDLIN( 468)		_this->_hx_set_value(HX_CTX, value);
...
HXDLIN( 469)		_this1->_hx_set_label(HX_CTX, HX_("framerate",8d,e5,4b,4e));
HXDLIN( 469)		_this1->_hx_set_value(HX_CTX, value1);
...
HXDLIN( 545)		if (::hx::IsNotNull( this->curInstance )) {
HXLINE( 546)			return (this->curInstance->symbol->reverse = value);
            		}
            		else {
...
HX_DEFINE_DYNAMIC_FUNC1(FlxAnim_obj,set_reversed,return )
 ...
 ::Dynamic FlxAnim_obj::getByName(::String name){
            	HX_STACKFRAME(&_hx_pos_131a2bb3c37f0df9_553_getByName)
HXDLIN( 553)		return this->animsMap->get(name);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxAnim_obj,getByName,return )
 ...
 ::flxanimate::animate::FlxSymbol FlxAnim_obj::getByInstance(::String instance, ::Dynamic frame, ::Dynamic layer){
            	HX_STACKFRAME(&_hx_pos_131a2bb3c37f0df9_557_getByInstance)
HXLINE( 558)		if (::hx::IsNull( frame )) {
HXLINE( 558)			frame = this->get_curFrame();
            		}
HXLINE( 560)		 ::flxanimate::animate::FlxSymbol symbol = null();
HXLINE( 562)		::Array< ::Dynamic> layers;
HXDLIN( 562)		if (::hx::IsNull( layer )) {
HXLINE( 562)			layers = this->get_curSymbol()->timeline->getList();
            		}
            		else {
HXLINE( 562)			layers = ::Array_obj< ::Dynamic>::__new(1)->init(0,this->get_curSymbol()->timeline->get(layer));
            		}
HXLINE( 563)		{
HXLINE( 563)			int _g = 0;
HXDLIN( 563)			while((_g < layers->length)){
HXLINE( 563)				 ::flxanimate::animate::FlxLayer layer1 = layers->__get(_g).StaticCast<  ::flxanimate::animate::FlxLayer >();
HXDLIN( 563)				_g = (_g + 1);
HXLINE( 565)				if (::hx::IsNull( layer1 )) {
HXLINE( 565)					continue;
            				}
HXLINE( 566)				 ::flxanimate::animate::FlxKeyFrame elements = layer1->get(frame);
HXLINE( 568)				if (::hx::IsNull( elements )) {
HXLINE( 568)					continue;
            				}
HXLINE( 570)				{
HXLINE( 570)					int _g1 = 0;
HXDLIN( 570)					::Array< ::Dynamic> _g2 = elements->getList();
HXDLIN( 570)					while((_g1 < _g2->length)){
HXLINE( 570)						 ::flxanimate::animate::FlxElement element = _g2->__get(_g1).StaticCast<  ::flxanimate::animate::FlxElement >();
HXDLIN( 570)						_g1 = (_g1 + 1);
HXLINE( 572)						if (::hx::IsNull( element->symbol )) {
HXLINE( 572)							continue;
            						}
HXLINE( 573)						bool _hx_tmp;
HXDLIN( 573)						if ((element->symbol->instance != HX_("",00,00,00,00))) {
HXLINE( 573)							_hx_tmp = (element->symbol->instance == instance);
            						}
            						else {
HXLINE( 573)							_hx_tmp = false;
            						}
HXDLIN( 573)						if (_hx_tmp) {
HXLINE( 575)							return ( ( ::flxanimate::animate::FlxSymbol)(this->symbolDictionary->get(element->symbol->name)) );
            						}
            					}
            				}
            			}
            		}
HXLINE( 580)		::flixel::FlxG_obj::log->advanced(HX_("This instance doesn't exist! Have you checked if the layer exists or the instance isn't misspelled?",3b,93,c4,e9),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
...
HX_DEFINE_DYNAMIC_FUNC3(FlxAnim_obj,getByInstance,return )
 ...
 ::flxanimate::animate::FlxSymbol FlxAnim_obj::get_curSymbol(){
            	HX_STACKFRAME(&_hx_pos_131a2bb3c37f0df9_586_get_curSymbol)
HXDLIN( 586)		if (::hx::IsNotNull( this->symbolDictionary )) {
HXDLIN( 586)			return ( ( ::flxanimate::animate::FlxSymbol)(this->symbolDictionary->get(this->curInstance->symbol->name)) );
            		}
            		else {
...
void FlxAnim_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_131a2bb3c37f0df9_590_destroy)
HXLINE( 591)		this->isPlaying = false;
HXLINE( 592)		this->set_curFrame(0);
HXLINE( 593)		this->set_framerate(( (Float)(0) ));
HXLINE( 594)		this->_tick = ( (Float)(0) );
HXLINE( 595)		this->_hx_set_buttonMap(HX_CTX, null());
HXLINE( 596)		this->_hx_set_animsMap(HX_CTX, null());
HXLINE( 597)		this->curInstance->destroy();
HXLINE( 598)		this->_hx_set_curInstance(HX_CTX, null());
HXLINE( 599)		this->stageInstance->destroy();
HXLINE( 600)		this->_hx_set_stageInstance(HX_CTX, null());
HXLINE( 601)		this->metadata->destroy();
HXLINE( 602)		this->_hx_set_metadata(HX_CTX, null());
HXLINE( 603)		this->swfRender = false;
HXLINE( 604)		this->_hx_set__parent(HX_CTX, null());
HXLINE( 605)		{
HXLINE( 605)			 ::Dynamic symbol = this->symbolDictionary->iterator();
HXDLIN( 605)			while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 605)				 ::flxanimate::animate::FlxSymbol symbol1 = ( ( ::flxanimate::animate::FlxSymbol)(symbol->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 607)				symbol1->destroy();
            			}
            		}
HXLINE( 609)		this->_hx_set_symbolDictionary(HX_CTX, null());
            	}
...
::hx::Val FlxAnim_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"onFrame") ) { _hx_set_onFrame(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal1 >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_parent") ) { _hx_set__parent(HX_CTX_GET,inValue.Cast<  ::flxanimate::FlxAnimate >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"metadata") ) { _hx_set_metadata(HX_CTX_GET,inValue.Cast<  ::flxanimate::animate::FlxMetaData >()); return inValue; }
		...
		if (HX_FIELD_EQ(inName,"animsMap") ) { _hx_set_animsMap(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
		if (HX_FIELD_EQ(inName,"loopType") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_loopType(inValue.Cast<  ::flxanimate::data::Loop >()) ); }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"curSymbol") ) { _hx_set_curSymbol(HX_CTX_GET,inValue.Cast<  ::flxanimate::animate::FlxSymbol >()); return inValue; }
		if (HX_FIELD_EQ(inName,"swfRender") ) { swfRender=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"buttonMap") ) { _hx_set_buttonMap(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"onComplete") ) { _hx_set_onComplete(HX_CTX_GET,inValue.Cast<  ::flixel::util::_FlxSignal::FlxSignal0 >()); return inValue; }
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"curInstance") ) { _hx_set_curInstance(HX_CTX_GET,inValue.Cast<  ::flxanimate::animate::FlxElement >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"stageInstance") ) { _hx_set_stageInstance(HX_CTX_GET,inValue.Cast<  ::flxanimate::animate::FlxElement >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"symbolDictionary") ) { _hx_set_symbolDictionary(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
	}
