...
void FlxLinkedList_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_b10ff5d8533aa49f_78_destroy)
HXLINE(  80)		if (!(this->exists)) {
HXLINE(  81)			return;
            		}
HXLINE(  83)		this->_hx_set_object(HX_CTX, null());
HXLINE(  84)		if (::hx::IsNotNull( this->next )) {
HXLINE(  86)			this->next->destroy();
            		}
HXLINE(  88)		this->exists = false;
HXLINE(  91)		this->_hx_set_next(HX_CTX, ::flixel::_hx_system::FlxLinkedList_obj::_cachedListsHead);
...
HXLINE(  33)			cachedList->_hx_set_next(HX_CTX, null());
...
void FlxLinkedList_obj::clearCache(){
            	HX_GC_STACKFRAME(&_hx_pos_b10ff5d8533aa49f_45_clearCache)
...
HXLINE(  51)			node->_hx_set_object(HX_CTX, null());
HXLINE(  52)			node->_hx_set_next(HX_CTX, null());
            		}
...
::hx::Val FlxLinkedList_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"next") ) { _hx_set_next(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::FlxLinkedList >()); return inValue; }
		break;
	case 6:
