...
class HXCPP_CLASS_ATTRIBUTES Font_obj : public ::hx::Object
{
	...
	public:
		...
		int numGlyphs;
		 ::Dynamic src;
		inline  ::Dynamic _hx_set_src(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return src=_hx_v; }
		...
		int unitsPerEM;
		::String _hx___fontID;
		inline ::String _hx_set__hx___fontID(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return _hx___fontID=_hx_v; }
		::String _hx___fontPath;
		inline ::String _hx_set__hx___fontPath(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return _hx___fontPath=_hx_v; }
		::String _hx___fontPathWithoutDirectory;
		inline ::String _hx_set__hx___fontPathWithoutDirectory(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return _hx___fontPathWithoutDirectory=_hx_v; }
		bool _hx___init;
		 ::Dynamic decompose();
