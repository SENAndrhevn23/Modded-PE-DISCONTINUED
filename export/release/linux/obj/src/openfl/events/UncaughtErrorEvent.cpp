...
void UncaughtErrorEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable, ::Dynamic error){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_c2f85669dc13e38b_179_new)
HXLINE( 180)		super::__construct(type,bubbles,cancelable,null(),null());
HXLINE( 182)		this->_hx_set_error(HX_CTX, error);
            	}
...
HXLINE( 188)		event->_hx_set_target(HX_CTX, this->target);
HXLINE( 189)		event->_hx_set_currentTarget(HX_CTX, this->currentTarget);
...
void UncaughtErrorEvent_obj::_hx___init(){
            	HX_GC_STACKFRAME(&_hx_pos_c2f85669dc13e38b_200___init)
HXLINE( 201)		this->super::_hx___init();
HXLINE( 202)		this->_hx_set_error(HX_CTX, null());
            	}
