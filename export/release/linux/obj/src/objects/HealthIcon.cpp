...
void HealthIcon_obj::__construct(::String __o__hx_char,::hx::Null< bool >  __o_isPlayer, ::Dynamic __o_allowGPU){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_ac81527997e0445c_3_new)
HXLINE(  50)		this->autoAdjustOffset = true;
HXLINE(  25)		this->_hx_set_iconOffsets(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_ea1163af_1,2));
HXLINE(   7)		this->_hx_set__hx_char(HX_CTX, HX_("",00,00,00,00));
...
void HealthIcon_obj::changeIcon(::String _hx_char, ::Dynamic __o_allowGPU){
            		 ::Dynamic allowGPU = __o_allowGPU;
            		if (::hx::IsNull(__o_allowGPU)) allowGPU = true;
            	HX_GC_STACKFRAME(&_hx_pos_ac81527997e0445c_27_changeIcon)
...
HXLINE(  41)			this->_hx_set__hx_char(HX_CTX, _hx_char);
...
::hx::Val HealthIcon_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"sprTracker") ) { _hx_set_sprTracker(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSprite >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"iconOffsets") ) { _hx_set_iconOffsets(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
		break;
	case 16:
