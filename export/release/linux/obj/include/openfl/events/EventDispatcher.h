...
class HXCPP_CLASS_ATTRIBUTES EventDispatcher_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::haxe::ds::StringMap _hx_set__hx___eventMap(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___eventMap=_hx_v; }
		 ::haxe::ds::StringMap _hx___iterators;
		inline  ::haxe::ds::StringMap _hx_set__hx___iterators(::hx::StackContext *_hx_ctx, ::haxe::ds::StringMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___iterators=_hx_v; }
		::Dynamic _hx___targetDispatcher;
		inline ::Dynamic _hx_set__hx___targetDispatcher(::hx::StackContext *_hx_ctx,::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___targetDispatcher=_hx_v; }
