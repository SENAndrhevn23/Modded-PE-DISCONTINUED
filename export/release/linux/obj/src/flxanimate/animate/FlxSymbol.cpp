...
HXLINE(  27)		this->_hx_set__sprites(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
HXLINE(  25)		this->activeCount = 0;
HXLINE(  23)		this->_checking = false;
HXLINE(  19)		this->_hx_set_filterPool(HX_CTX,  ::haxe::ds::ObjectMap_obj::__alloc( HX_CTX ));
HXLINE(  65)		this->_hx_set_layers(HX_CTX, ::Array_obj< ::String >::__new(0));
HXLINE(  66)		this->set_curFrame(0);
HXLINE(  67)		this->_hx_set_timeline(HX_CTX, timeline);
HXLINE(  68)		timeline->_hx_set__parent(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
HXLINE(  70)		this->_hx_set_name(HX_CTX, name);
...
void FlxSymbol_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_5a4b2296ba2373e2_154_destroy)
HXLINE( 155)		this->_hx_set_name(HX_CTX, HX_("",00,00,00,00));
...
::hx::Val FlxSymbol_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"labels") ) { _hx_set_labels(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
		if (HX_FIELD_EQ(inName,"layers") ) { _hx_set_layers(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		break;
	case 7:
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"timeline") ) { _hx_set_timeline(HX_CTX_GET,inValue.Cast<  ::flxanimate::animate::FlxTimeline >()); return inValue; }
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"filterPool") ) { _hx_set_filterPool(HX_CTX_GET,inValue.Cast<  ::haxe::ds::ObjectMap >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onCallback") ) { _hx_set_onCallback(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 11:
