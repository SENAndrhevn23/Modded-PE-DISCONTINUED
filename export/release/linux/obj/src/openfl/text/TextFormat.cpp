...
void TextFormat_obj::__construct(::String font, ::Dynamic size, ::Dynamic color, ::Dynamic bold, ::Dynamic italic, ::Dynamic underline,::String url,::String target, ::Dynamic align, ::Dynamic leftMargin, ::Dynamic rightMargin, ::Dynamic indent, ::Dynamic leading){
            	HX_GC_STACKFRAME(&_hx_pos_c5f39c48023aa9de_258_new)
HXLINE( 259)		this->_hx_set_font(HX_CTX, font);
HXLINE( 260)		this->_hx_set_size(HX_CTX, size);
HXLINE( 261)		this->_hx_set_color(HX_CTX, color);
HXLINE( 262)		this->_hx_set_bold(HX_CTX, bold);
HXLINE( 263)		this->_hx_set_italic(HX_CTX, italic);
HXLINE( 264)		this->_hx_set_underline(HX_CTX, underline);
HXLINE( 265)		this->_hx_set_url(HX_CTX, url);
HXLINE( 266)		this->_hx_set_target(HX_CTX, target);
HXLINE( 267)		this->_hx_set_align(HX_CTX, align);
HXLINE( 268)		this->_hx_set_leftMargin(HX_CTX, leftMargin);
HXLINE( 269)		this->_hx_set_rightMargin(HX_CTX, rightMargin);
HXLINE( 270)		this->_hx_set_indent(HX_CTX, indent);
HXLINE( 271)		this->_hx_set_leading(HX_CTX, leading);
            	}
...
HXLINE( 279)		newFormat->_hx_set_align(HX_CTX, this->align);
HXLINE( 280)		newFormat->_hx_set_leftMargin(HX_CTX, this->leftMargin);
HXLINE( 281)		newFormat->_hx_set_rightMargin(HX_CTX, this->rightMargin);
HXLINE( 282)		newFormat->_hx_set_indent(HX_CTX, this->indent);
HXLINE( 283)		newFormat->_hx_set_leading(HX_CTX, this->leading);
HXLINE( 285)		newFormat->_hx_set_blockIndent(HX_CTX, this->blockIndent);
HXLINE( 286)		newFormat->_hx_set_bullet(HX_CTX, this->bullet);
HXLINE( 287)		newFormat->_hx_set_kerning(HX_CTX, this->kerning);
HXLINE( 288)		newFormat->_hx_set_letterSpacing(HX_CTX, this->letterSpacing);
HXLINE( 289)		newFormat->_hx_set_tabStops(HX_CTX, this->tabStops);
HXLINE( 291)		newFormat->_hx_set__hx___ascent(HX_CTX, this->_hx___ascent);
HXLINE( 292)		newFormat->_hx_set__hx___descent(HX_CTX, this->_hx___descent);
HXLINE( 294)		newFormat->_hx_set__hx___cacheKey(HX_CTX, this->_hx___toCacheKey());
...
void TextFormat_obj::_hx___merge( ::openfl::text::TextFormat format){
            	HX_GC_STACKFRAME(&_hx_pos_c5f39c48023aa9de_300___merge)
HXLINE( 301)		if (::hx::IsNotNull( format->font )) {
HXLINE( 301)			this->_hx_set_font(HX_CTX, format->font);
            		}
HXLINE( 302)		if (::hx::IsNotNull( format->size )) {
HXLINE( 302)			this->_hx_set_size(HX_CTX, format->size);
            		}
HXLINE( 303)		if (::hx::IsNotNull( format->color )) {
HXLINE( 303)			this->_hx_set_color(HX_CTX, format->color);
            		}
HXLINE( 304)		if (::hx::IsNotNull( format->bold )) {
HXLINE( 304)			this->_hx_set_bold(HX_CTX, format->bold);
            		}
HXLINE( 305)		if (::hx::IsNotNull( format->italic )) {
HXLINE( 305)			this->_hx_set_italic(HX_CTX, format->italic);
            		}
HXLINE( 306)		if (::hx::IsNotNull( format->underline )) {
HXLINE( 306)			this->_hx_set_underline(HX_CTX, format->underline);
            		}
HXLINE( 307)		if (::hx::IsNotNull( format->url )) {
HXLINE( 307)			this->_hx_set_url(HX_CTX, format->url);
            		}
HXLINE( 308)		if (::hx::IsNotNull( format->target )) {
HXLINE( 308)			this->_hx_set_target(HX_CTX, format->target);
            		}
HXLINE( 309)		if (::hx::IsNotNull( format->align )) {
HXLINE( 309)			this->_hx_set_align(HX_CTX, format->align);
            		}
HXLINE( 310)		if (::hx::IsNotNull( format->leftMargin )) {
HXLINE( 310)			this->_hx_set_leftMargin(HX_CTX, format->leftMargin);
            		}
HXLINE( 311)		if (::hx::IsNotNull( format->rightMargin )) {
HXLINE( 311)			this->_hx_set_rightMargin(HX_CTX, format->rightMargin);
            		}
HXLINE( 312)		if (::hx::IsNotNull( format->indent )) {
HXLINE( 312)			this->_hx_set_indent(HX_CTX, format->indent);
            		}
HXLINE( 313)		if (::hx::IsNotNull( format->leading )) {
HXLINE( 313)			this->_hx_set_leading(HX_CTX, format->leading);
            		}
HXLINE( 314)		if (::hx::IsNotNull( format->blockIndent )) {
HXLINE( 314)			this->_hx_set_blockIndent(HX_CTX, format->blockIndent);
            		}
HXLINE( 315)		if (::hx::IsNotNull( format->bullet )) {
HXLINE( 315)			this->_hx_set_bullet(HX_CTX, format->bullet);
            		}
HXLINE( 316)		if (::hx::IsNotNull( format->kerning )) {
HXLINE( 316)			this->_hx_set_kerning(HX_CTX, format->kerning);
            		}
HXLINE( 317)		if (::hx::IsNotNull( format->letterSpacing )) {
HXLINE( 317)			this->_hx_set_letterSpacing(HX_CTX, format->letterSpacing);
            		}
HXLINE( 318)		if (::hx::IsNotNull( format->tabStops )) {
HXLINE( 318)			this->_hx_set_tabStops(HX_CTX, format->tabStops);
            		}
HXLINE( 320)		if (::hx::IsNotNull( format->_hx___ascent )) {
HXLINE( 320)			this->_hx_set__hx___ascent(HX_CTX, format->_hx___ascent);
            		}
HXLINE( 321)		if (::hx::IsNotNull( format->_hx___descent )) {
HXLINE( 321)			this->_hx_set__hx___descent(HX_CTX, format->_hx___descent);
            		}
...
::String TextFormat_obj::_hx___toCacheKey(){
            	HX_GC_STACKFRAME(&_hx_pos_c5f39c48023aa9de_328___toCacheKey)
HXDLIN( 328)		::String _hx_tmp = ((HX_("",00,00,00,00) + this->font) + this->size);
HXDLIN( 328)		::String _hx_tmp1 = (_hx_tmp + ::Std_obj::string(this->bold));
HXDLIN( 328)		return (this->_hx_set__hx___cacheKey(HX_CTX, (_hx_tmp1 + ::Std_obj::string(this->italic))));
            	}
...
::hx::Val TextFormat_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 3:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"bold") ) { _hx_set_bold(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"font") ) { _hx_set_font(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"size") ) { _hx_set_size(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"bullet") ) { _hx_set_bullet(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"indent") ) { _hx_set_indent(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"italic") ) { _hx_set_italic(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"target") ) { _hx_set_target(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"kerning") ) { _hx_set_kerning(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"leading") ) { _hx_set_leading(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"tabStops") ) { _hx_set_tabStops(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__ascent") ) { _hx_set__hx___ascent(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"underline") ) { _hx_set_underline(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__descent") ) { _hx_set__hx___descent(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"leftMargin") ) { _hx_set_leftMargin(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__cacheKey") ) { _hx_set__hx___cacheKey(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"blockIndent") ) { _hx_set_blockIndent(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"rightMargin") ) { _hx_set_rightMargin(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"letterSpacing") ) { _hx_set_letterSpacing(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
