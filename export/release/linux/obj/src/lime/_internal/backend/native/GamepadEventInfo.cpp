...
HX_DEFINE_STACK_FRAME(_hx_pos_d0c0bd38b1c3a1bc_742_new,"lime._internal.backend.native.GamepadEventInfo","new",0x77bbf84b,"lime._internal.backend.native.GamepadEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",742,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_d0c0bd38b1c3a1bc_752_clone,"lime._internal.backend.native.GamepadEventInfo","clone",0x88154c08,"lime._internal.backend.native.GamepadEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",752,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void GamepadEventInfo_obj::__construct( ::Dynamic type,::hx::Null< int >  __o_id,::hx::Null< int >  __o_button,::hx::Null< int >  __o_axis,::hx::Null< Float >  __o_value){
            	...
            	HX_STACKFRAME(&_hx_pos_d0c0bd38b1c3a1bc_742_new)
HXLINE( 743)		this->type = ( (int)(type) );
HXLINE( 744)		this->id = id;
HXLINE( 745)		this->button = button;
HXLINE( 746)		this->axis = axis;
HXLINE( 747)		this->axisValue = value;
            	}
...
bool GamepadEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::GamepadEventInfo GamepadEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_d0c0bd38b1c3a1bc_752_clone)
HXDLIN( 752)		return  ::lime::_internal::backend::native::GamepadEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->button,this->axis,this->axisValue);
            	}
