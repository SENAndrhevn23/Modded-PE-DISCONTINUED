...
class HXCPP_CLASS_ATTRIBUTES BevelShader_obj : public  ::openfl::filters::BitmapFilterShader_obj
{
	...
	public:
		...
		inline  ::openfl::display::ShaderParameter_Float _hx_set_offset(::hx::StackContext *_hx_ctx, ::openfl::display::ShaderParameter_Float _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return offset=_hx_v; }
		 ::openfl::display::ShaderParameter_Float uColorH;
		inline  ::openfl::display::ShaderParameter_Float _hx_set_uColorH(::hx::StackContext *_hx_ctx, ::openfl::display::ShaderParameter_Float _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return uColorH=_hx_v; }
		 ::openfl::display::ShaderParameter_Float uColorS;
		inline  ::openfl::display::ShaderParameter_Float _hx_set_uColorS(::hx::StackContext *_hx_ctx, ::openfl::display::ShaderParameter_Float _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return uColorS=_hx_v; }
		 ::openfl::display::ShaderParameter_Float uStrength;
		inline  ::openfl::display::ShaderParameter_Float _hx_set_uStrength(::hx::StackContext *_hx_ctx, ::openfl::display::ShaderParameter_Float _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return uStrength=_hx_v; }
		 ::openfl::display::ShaderParameter_Int knockout;
		inline  ::openfl::display::ShaderParameter_Int _hx_set_knockout(::hx::StackContext *_hx_ctx, ::openfl::display::ShaderParameter_Int _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return knockout=_hx_v; }
		 ::openfl::display::ShaderInput_openfl_display_BitmapData sourceBitmap;
		inline  ::openfl::display::ShaderInput_openfl_display_BitmapData _hx_set_sourceBitmap(::hx::StackContext *_hx_ctx, ::openfl::display::ShaderInput_openfl_display_BitmapData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return sourceBitmap=_hx_v; }
};
