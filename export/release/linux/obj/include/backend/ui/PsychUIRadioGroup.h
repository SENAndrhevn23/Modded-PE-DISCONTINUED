...
class HXCPP_CLASS_ATTRIBUTES PsychUIRadioGroup_obj : public  ::flixel::group::FlxTypedSpriteGroup_obj
{
	...
	public:
		...
		::Array< ::String > labels;
		inline ::Array< ::String > _hx_set_labels(::hx::StackContext *_hx_ctx,::Array< ::String > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return labels=_hx_v; }
		::Array< ::Dynamic> radios;
		inline ::Array< ::Dynamic> _hx_set_radios(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return radios=_hx_v; }
		Float space;
		int textWidth;
		int maxItems;
		...
		inline  ::backend::ui::PsychUIRadioItem _hx_set_checkedRadio(::hx::StackContext *_hx_ctx, ::backend::ui::PsychUIRadioItem _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return checkedRadio=_hx_v; }
		 ::flixel::FlxSprite arrowUp;
		inline  ::flixel::FlxSprite _hx_set_arrowUp(::hx::StackContext *_hx_ctx, ::flixel::FlxSprite _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return arrowUp=_hx_v; }
		 ::flixel::FlxSprite arrowDown;
		inline  ::flixel::FlxSprite _hx_set_arrowDown(::hx::StackContext *_hx_ctx, ::flixel::FlxSprite _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return arrowDown=_hx_v; }
		 ::Dynamic onClick;
		...
		inline  ::flixel::FlxObject _hx_set__hitbox(::hx::StackContext *_hx_ctx, ::flixel::FlxObject _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hitbox=_hx_v; }
