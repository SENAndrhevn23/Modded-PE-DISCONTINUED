...
HXLINE(  25)		this->_hx_set__lastCursorPosition(HX_CTX,  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,brain->flixelPointer->x,brain->flixelPointer->x));
HXLINE(  27)		this->_hx_set__name(HX_CTX, HX_("Mover",21,3c,93,9f));
...
HXDLIN(  28)		this->_hx_set__shortcut(HX_CTX, _hx_tmp);
...
::hx::Val Mover_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"_lastCursorPosition") ) { _hx_set__lastCursorPosition(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
	}
