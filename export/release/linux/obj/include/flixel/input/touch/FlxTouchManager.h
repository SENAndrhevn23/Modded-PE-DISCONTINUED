...
class HXCPP_CLASS_ATTRIBUTES FlxTouchManager_obj : public ::hx::Object
{
	...
	public:
		...
		inline ::Array< ::Dynamic> _hx_set__inactiveTouches(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _inactiveTouches=_hx_v; }
		 ::haxe::ds::IntMap _touchesCache;
		inline  ::haxe::ds::IntMap _hx_set__touchesCache(::hx::StackContext *_hx_ctx, ::haxe::ds::IntMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _touchesCache=_hx_v; }
		...
		::Dynamic add_dyn();
		 ...
		 ::flixel::input::touch::FlxTouch recycle(int X,int Y,int PointID,Float pressure);
		::Dynamic recycle_dyn();
