...
HXLINE(  56)					result->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_42269736_5,1));
            				}
            				else {
...
HXLINE(  74)											result->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x)));
            										}
            										else {
...
HXLINE(  77)											result->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1)));
            										}
            										else {
...
HXLINE(  77)											result->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            										}
...
HXLINE(  67)										result->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(bs)));
            									}
            									else {
...
HXLINE(  68)										result->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(bs)));
            									}
            									else {
...
HXLINE(  70)										result->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_42269736_6,1));
            									}
            									else {
...
HXLINE(  63)									bs_buf->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_42269736_7,1));
            								}
            								else {
...
HXDLIN(  74)											if (::hx::IsNull( result->b )) {
HXLINE(  74)												result->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2)));
            											}
            											else {
...
HXDLIN(  77)											if (::hx::IsNull( result->b )) {
HXLINE(  77)												result->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3)));
            											}
            											else {
...
HXLINE(  82)					result->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4)));
            				}
            				else {
...
HXLINE(  85)						result->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x5)));
            					}
            					else {
...
HXLINE(  86)						result->_hx_set_b(HX_CTX, ::Array_obj< ::String >::fromData( _hx_array_data_42269736_8,1));
            					}
            					else {
...
HXLINE(  97)							result9->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            						}
...
HXLINE(  99)								result9->_hx_set_b(HX_CTX, ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x6)));
            							}
            							else {
...
HXLINE(  99)								result9->_hx_set_charBuf(HX_CTX, ::Array_obj< char >::__new());
            							}
