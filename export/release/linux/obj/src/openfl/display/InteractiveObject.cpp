...
void InteractiveObject_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1222_new)
...
HXLINE(1228)		this->_hx_set__hx___tabEnabled(HX_CTX, null());
...
HXLINE(1301)			this->_hx_set__hx___tabEnabled(HX_CTX, value);
...
::hx::Val InteractiveObject_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"focusRect") ) { _hx_set_focusRect(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 10:
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"__tabEnabled") ) { _hx_set__hx___tabEnabled(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 17:
	...
	case 18:
		...
		break;
	case 31:
		if (HX_FIELD_EQ(inName,"softKeyboardInputAreaOfInterest") ) { _hx_set_softKeyboardInputAreaOfInterest(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Rectangle >()); return inValue; }
	}
