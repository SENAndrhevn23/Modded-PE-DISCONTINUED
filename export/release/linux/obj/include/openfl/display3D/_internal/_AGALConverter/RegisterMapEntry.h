			...
			*(void **)__this = RegisterMapEntry_obj::_hx_vtable;
{
		...
		inline  ::openfl::display3D::_internal::_AGALConverter::RegisterUsage _hx_set_usage(::hx::StackContext *_hx_ctx, ::openfl::display3D::_internal::_AGALConverter::RegisterUsage _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return usage=_hx_v; }
};
