...
HXLINE(  62)			this->_hx_set_m_brightnessMatrix(HX_CTX,  ::flxanimate::motion::ColorMatrix_obj::__alloc( HX_CTX ));
            		}
...
HXLINE(  77)			this->_hx_set_m_contrastMatrix(HX_CTX,  ::flxanimate::motion::ColorMatrix_obj::__alloc( HX_CTX ));
            		}
...
HXLINE(  96)			this->_hx_set_m_saturationMatrix(HX_CTX,  ::flxanimate::motion::ColorMatrix_obj::__alloc( HX_CTX ));
            		}
...
HXLINE( 109)			this->_hx_set_m_hueMatrix(HX_CTX,  ::flxanimate::motion::ColorMatrix_obj::__alloc( HX_CTX ));
            		}
...
HXLINE( 147)			this->_hx_set_m_finalMatrix(HX_CTX,  ::flxanimate::motion::ColorMatrix_obj::__alloc( HX_CTX ));
            		}
            		else {
...
::hx::Val AdjustColor_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"m_hueMatrix") ) { _hx_set_m_hueMatrix(HX_CTX_GET,inValue.Cast<  ::flxanimate::motion::ColorMatrix >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"m_finalMatrix") ) { _hx_set_m_finalMatrix(HX_CTX_GET,inValue.Cast<  ::flxanimate::motion::ColorMatrix >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"m_contrastMatrix") ) { _hx_set_m_contrastMatrix(HX_CTX_GET,inValue.Cast<  ::flxanimate::motion::ColorMatrix >()); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"m_brightnessMatrix") ) { _hx_set_m_brightnessMatrix(HX_CTX_GET,inValue.Cast<  ::flxanimate::motion::ColorMatrix >()); return inValue; }
		if (HX_FIELD_EQ(inName,"m_saturationMatrix") ) { _hx_set_m_saturationMatrix(HX_CTX_GET,inValue.Cast<  ::flxanimate::motion::ColorMatrix >()); return inValue; }
	}
