...
class HXCPP_CLASS_ATTRIBUTES DrawCommandBuffer_obj : public ::hx::Object
{
	...
	public:
		...
		::Array< ::Dynamic> types;
		inline ::Array< ::Dynamic> _hx_set_types(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return types=_hx_v; }
		::Array< bool > b;
		inline ::Array< bool > _hx_set_b(::hx::StackContext *_hx_ctx,::Array< bool > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return b=_hx_v; }
		bool copyOnWrite;
		::Array< Float > f;
		inline ::Array< Float > _hx_set_f(::hx::StackContext *_hx_ctx,::Array< Float > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return f=_hx_v; }
		::Array< ::Dynamic> ff;
		inline ::Array< ::Dynamic> _hx_set_ff(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return ff=_hx_v; }
		::Array< int > i;
		inline ::Array< int > _hx_set_i(::hx::StackContext *_hx_ctx,::Array< int > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return i=_hx_v; }
		::Array< ::Dynamic> ii;
		inline ::Array< ::Dynamic> _hx_set_ii(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return ii=_hx_v; }
		::cpp::VirtualArray o;
		inline ::cpp::VirtualArray _hx_set_o(::hx::StackContext *_hx_ctx,::cpp::VirtualArray _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return o=_hx_v; }
