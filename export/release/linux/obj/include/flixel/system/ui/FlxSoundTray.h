...
class HXCPP_CLASS_ATTRIBUTES FlxSoundTray_obj : public  ::openfl::display::Sprite_obj
{
	...
	public:
		...
		Float _timer;
		::Array< ::Dynamic> _bars;
		inline ::Array< ::Dynamic> _hx_set__bars(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _bars=_hx_v; }
		int _width;
		Float _defaultScale;
		::String volumeUpSound;
		inline ::String _hx_set_volumeUpSound(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return volumeUpSound=_hx_v; }
		::String volumeDownSound;
		inline ::String _hx_set_volumeDownSound(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return volumeDownSound=_hx_v; }
		bool silent;
