...
void FlxMouseButton_obj::__construct(int ID){
            	HX_GC_STACKFRAME(&_hx_pos_1a66c6297c27823a_9_new)
...
HXDLIN(  25)		this->_hx_set_justPressedPosition(HX_CTX, point);
...
void FlxMouseButton_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_1a66c6297c27823a_50_destroy)
HXDLIN(  50)		this->_hx_set_justPressedPosition(HX_CTX, ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->justPressedPosition)) ));
            	}
