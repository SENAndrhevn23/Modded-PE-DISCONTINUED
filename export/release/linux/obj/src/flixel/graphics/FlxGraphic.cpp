...
HXLINE( 399)		this->_hx_set_key(HX_CTX, key);
...
HXLINE( 402)		this->_hx_set_frameCollections(HX_CTX,  ::haxe::ds::EnumValueMap_obj::__alloc( HX_CTX ));
HXLINE( 403)		this->_hx_set_frameCollectionTypes(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE( 404)		this->set_bitmap(bitmap);
HXLINE( 406)		this->_hx_set_shader(HX_CTX,  ::flixel::graphics::tile::FlxGraphicsShader_obj::__alloc( HX_CTX ));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGraphic_obj,get__imageFrame,return )
 ...
 ::flixel::graphics::frames::FlxImageFrame FlxGraphic_obj::set__imageFrame( ::flixel::graphics::frames::FlxImageFrame value){
            	HX_GC_STACKFRAME(&_hx_pos_3b8710f86d15c371_378_set__imageFrame)
HXDLIN( 378)		return (this->_hx_set_imageFrame(HX_CTX, value));
            	}
...
void FlxGraphic_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_3b8710f86d15c371_468_destroy)
HXLINE( 469)		this->set_bitmap(::flixel::util::FlxDestroyUtil_obj::dispose(this->bitmap));
HXLINE( 471)		this->_hx_set_shader(HX_CTX, null());
HXLINE( 473)		this->_hx_set_key(HX_CTX, null());
HXLINE( 474)		this->_hx_set_assetsKey(HX_CTX, null());
HXLINE( 475)		this->_hx_set_assetsClass(HX_CTX, null());
HXLINE( 476)		this->_hx_set_imageFrame(HX_CTX, null());
...
HXLINE( 488)		this->_hx_set_frameCollections(HX_CTX, null());
HXLINE( 489)		this->_hx_set_frameCollectionTypes(HX_CTX, null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxGraphic_obj,set_destroyOnNoUse,return )
 ...
 ::flixel::graphics::frames::FlxImageFrame FlxGraphic_obj::get_imageFrame(){
            	HX_GC_STACKFRAME(&_hx_pos_3b8710f86d15c371_600_get_imageFrame)
...
HXDLIN( 602)			this->_hx_set_imageFrame(HX_CTX, ::flixel::graphics::frames::FlxImageFrame_obj::fromRectangle(::hx::ObjectPtr<OBJ_>(this),rect));
            		}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxGraphic_obj,get_atlasFrames,return )
 ...
 ::openfl::display::BitmapData FlxGraphic_obj::set_bitmap( ::openfl::display::BitmapData value){
            	HX_GC_STACKFRAME(&_hx_pos_3b8710f86d15c371_613_set_bitmap)
HXLINE( 614)		if (::hx::IsNotNull( value )) {
HXLINE( 616)			this->_hx_set_bitmap(HX_CTX, value);
...
bool FlxGraphic_obj::defaultPersist;
 ...
 ::flixel::graphics::FlxGraphic FlxGraphic_obj::fromAssetKey(::String Source,::hx::Null< bool >  __o_Unique,::String Key,::hx::Null< bool >  __o_Cache){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_3b8710f86d15c371_38_fromAssetKey)
...
HXLINE(  59)		graphic->_hx_set_assetsKey(HX_CTX, Source);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(FlxGraphic_obj,fromAssetKey,return )
 ...
 ::flixel::graphics::FlxGraphic FlxGraphic_obj::fromClass(::hx::Class Source,::hx::Null< bool >  __o_Unique,::String Key,::hx::Null< bool >  __o_Cache){
            		bool Unique = __o_Unique.Default(false);
            		bool Cache = __o_Cache.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_3b8710f86d15c371_74_fromClass)
...
HXLINE(  90)		graphic->_hx_set_assetsClass(HX_CTX, Source);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(FlxGraphic_obj,fromClass,return )
 ...
 ::flixel::graphics::FlxGraphic FlxGraphic_obj::fromBitmapData( ::openfl::display::BitmapData Source,::hx::Null< bool >  __o_Unique,::String Key,::hx::Null< bool >  __o_Cache){
            		bool Unique = __o_Unique.Default(false);
            		bool Cache = __o_Cache.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_3b8710f86d15c371_105_fromBitmapData)
HXLINE( 106)		if (!(Cache)) {
...
HXLINE( 127)		graphic->_hx_set_assetsKey(HX_CTX, assetKey);
HXLINE( 128)		graphic->_hx_set_assetsClass(HX_CTX, assetClass);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(FlxGraphic_obj,fromBitmapData,return )
 ...
 ::flixel::graphics::FlxGraphic FlxGraphic_obj::fromFrame( ::flixel::graphics::frames::FlxFrame Source,::hx::Null< bool >  __o_Unique,::String Key,::hx::Null< bool >  __o_Cache){
            		bool Unique = __o_Unique.Default(false);
            		bool Cache = __o_Cache.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_3b8710f86d15c371_144_fromFrame)
...
HXDLIN( 147)			_this1->_hx_set_label(HX_CTX, HX_("x",78,00,00,00));
HXDLIN( 147)			_this1->_hx_set_value(HX_CTX, value);
...
HXDLIN( 147)			_this2->_hx_set_label(HX_CTX, HX_("y",79,00,00,00));
HXDLIN( 147)			_this2->_hx_set_value(HX_CTX, value1);
...
HXDLIN( 147)			_this3->_hx_set_label(HX_CTX, HX_("w",77,00,00,00));
HXDLIN( 147)			_this3->_hx_set_value(HX_CTX, value2);
...
HXDLIN( 147)			_this4->_hx_set_label(HX_CTX, HX_("h",68,00,00,00));
HXDLIN( 147)			_this4->_hx_set_value(HX_CTX, value3);
...
HXLINE( 157)		image->frames->__get(0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->_hx_set_name(HX_CTX, Source->name);
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(FlxGraphic_obj,fromFrames,return )
 ...
 ::flixel::graphics::FlxGraphic FlxGraphic_obj::fromGraphic( ::flixel::graphics::FlxGraphic Source,::hx::Null< bool >  __o_Unique,::String Key){
            		bool Unique = __o_Unique.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_3b8710f86d15c371_188_fromGraphic)
...
HXLINE( 195)		graphic->_hx_set_assetsClass(HX_CTX, Source->assetsClass);
HXLINE( 196)		graphic->_hx_set_assetsKey(HX_CTX, Source->assetsKey);
...
::hx::Val FlxGraphic_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 3:
		if (HX_FIELD_EQ(inName,"key") ) { _hx_set_key(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"width") ) { width=inValue.Cast< int >(); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"bitmap") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_bitmap(inValue.Cast<  ::openfl::display::BitmapData >()) );_hx_set_bitmap(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"assetsKey") ) { _hx_set_assetsKey(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_useCount") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set__useCount(inValue.Cast< int >()) ); }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"imageFrame") ) { _hx_set_imageFrame(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::frames::FlxImageFrame >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"assetsClass") ) { _hx_set_assetsClass(HX_CTX_GET,inValue.Cast< ::hx::Class >()); return inValue; }
	...
	case 15:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"frameCollections") ) { _hx_set_frameCollections(HX_CTX_GET,inValue.Cast<  ::haxe::ds::EnumValueMap >()); return inValue; }
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"frameCollectionTypes") ) { _hx_set_frameCollectionTypes(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
