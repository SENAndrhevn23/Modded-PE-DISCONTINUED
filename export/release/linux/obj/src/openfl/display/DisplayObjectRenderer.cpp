...
HXLINE(  66)		this->_hx_set__hx___tempColorTransform(HX_CTX,  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null()));
...
void DisplayObjectRenderer_obj::_hx___renderEvent( ::openfl::display::DisplayObject displayObject){
            	HX_GC_STACKFRAME(&_hx_pos_5a81acb3bead7383_106___renderEvent)
...
HXLINE( 114)			displayObject->_hx___customRenderEvent->_hx_set_renderer(HX_CTX, renderer);
HXLINE( 116)			::String _hx_switch_0 = renderer->_hx___type;
            			if (  (_hx_switch_0==HX_("cairo",88,30,19,41)) ){
HXLINE( 128)				displayObject->_hx___customRenderEvent->_hx_set_type(HX_CTX, HX_("renderCairo",52,5d,ca,0c));
HXDLIN( 128)				goto _hx_goto_11;
            			}
            			if (  (_hx_switch_0==HX_("canvas",d8,54,42,b8)) ){
HXLINE( 141)				displayObject->_hx___customRenderEvent->_hx_set_type(HX_CTX, HX_("renderCanvas",ce,58,98,27));
...
HXLINE( 133)					displayObject->_hx___customRenderEvent->_hx_set_type(HX_CTX, HX_("renderDOM",cc,ac,57,cd));
            				}
            				else {
HXLINE( 137)					displayObject->_hx___customRenderEvent->_hx_set_type(HX_CTX, HX_("clearDOM",f5,22,08,31));
            				}
...
HXLINE( 125)				displayObject->_hx___customRenderEvent->_hx_set_type(HX_CTX, HX_("renderOpenGL",65,4c,ea,90));
...
HXLINE( 312)				displayObject->_hx_set__hx___cacheBitmapMatrix(HX_CTX,  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
            			}
...
HXLINE( 403)				displayObject->_hx_set__hx___cacheBitmapBackground(HX_CTX, displayObject->opaqueBackground);
...
HXLINE( 417)						displayObject->_hx_set__hx___cacheBitmapData(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,bitmapWidth,bitmapHeight,true,bitmapColor));
HXLINE( 419)						if (::hx::IsNull( displayObject->_hx___cacheBitmap )) {
HXLINE( 419)							displayObject->_hx_set__hx___cacheBitmap(HX_CTX,  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,null(),null(),null()));
            						}
HXLINE( 420)						displayObject->_hx___cacheBitmap->_hx_set__hx___bitmapData(HX_CTX, displayObject->_hx___cacheBitmapData);
HXLINE( 421)						displayObject->_hx_set__hx___cacheBitmapRenderer(HX_CTX, null());
            					}
            					else {
...
HXLINE( 438)					displayObject->_hx_set__hx___cacheBitmap(HX_CTX, null());
HXLINE( 439)					displayObject->_hx_set__hx___cacheBitmapData(HX_CTX, null());
HXLINE( 440)					displayObject->_hx_set__hx___cacheBitmapData2(HX_CTX, null());
HXLINE( 441)					displayObject->_hx_set__hx___cacheBitmapData3(HX_CTX, null());
HXLINE( 442)					displayObject->_hx_set__hx___cacheBitmapRenderer(HX_CTX, null());
...
HXLINE( 461)				displayObject->_hx_set__hx___cacheBitmapData(HX_CTX, displayObject->_hx___cacheBitmap->get_bitmapData());
HXLINE( 462)				displayObject->_hx_set__hx___cacheBitmapData2(HX_CTX, null());
HXLINE( 463)				displayObject->_hx_set__hx___cacheBitmapData3(HX_CTX, null());
            			}
...
HXLINE( 492)			displayObject->_hx___cacheBitmap->_hx_set__hx___worldBlendMode(HX_CTX, displayObject->_hx___worldBlendMode);
HXLINE( 493)			displayObject->_hx___cacheBitmap->_hx_set__hx___worldShader(HX_CTX, displayObject->_hx___worldShader);
...
HXLINE( 505)						displayObject->_hx_set__hx___cacheBitmapRenderer(HX_CTX,  ::openfl::display::OpenGLRenderer_obj::__alloc( HX_CTX ,::hx::TCast<  ::openfl::display::OpenGLRenderer >::cast(renderer)->_hx___context3D,displayObject->_hx___cacheBitmapData));
            					}
            					else {
...
HXLINE( 512)							displayObject->_hx_set__hx___cacheBitmapData(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,bitmapWidth,bitmapHeight,true,color));
HXLINE( 513)							displayObject->_hx___cacheBitmap->_hx_set__hx___bitmapData(HX_CTX, displayObject->_hx___cacheBitmapData);
            						}
HXLINE( 520)						displayObject->_hx_set__hx___cacheBitmapRenderer(HX_CTX,  ::openfl::display::CairoRenderer_obj::__alloc( HX_CTX , ::lime::graphics::cairo::Cairo_obj::__alloc( HX_CTX ,displayObject->_hx___cacheBitmapData->getSurface())));
            					}
HXLINE( 524)					displayObject->_hx___cacheBitmapRenderer->_hx_set__hx___worldTransform(HX_CTX,  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
HXLINE( 525)					displayObject->_hx___cacheBitmapRenderer->_hx_set__hx___worldColorTransform(HX_CTX,  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null()));
            				}
HXLINE( 531)				if (::hx::IsNull( displayObject->_hx___cacheBitmapColorTransform )) {
HXLINE( 531)					displayObject->_hx_set__hx___cacheBitmapColorTransform(HX_CTX,  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null()));
            				}
HXLINE( 533)				displayObject->_hx___cacheBitmapRenderer->_hx_set__hx___stage(HX_CTX, displayObject->stage);
...
HXLINE( 605)							displayObject->_hx_set__hx___cacheBitmapData2(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,bitmapWidth,bitmapHeight,true,0));
            						}
            						else {
...
HXLINE( 627)								displayObject->_hx_set__hx___cacheBitmapData3(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,bitmapWidth,bitmapHeight,true,0));
            							}
            							else {
...
HXLINE( 674)						displayObject->_hx___cacheBitmap->_hx_set__hx___bitmapData(HX_CTX, bitmap1);
            					}
HXLINE( 677)					parentRenderer->_hx_set__hx___blendMode(HX_CTX, 10);
...
HXLINE( 734)								displayObject->_hx_set__hx___cacheBitmapData2(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,bitmapWidth,bitmapHeight,true,0));
            							}
            							else {
...
HXLINE( 754)								displayObject->_hx_set__hx___cacheBitmapData3(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,bitmapWidth,bitmapHeight,true,0));
            							}
            							else {
...
HXLINE( 763)							displayObject->_hx_set__hx___tempPoint(HX_CTX,  ::openfl::geom::Point_obj::__alloc( HX_CTX ,null(),null()));
            						}
...
HXLINE( 798)							displayObject->_hx_set__hx___cacheBitmapData(HX_CTX, bitmap4);
HXLINE( 799)							displayObject->_hx_set__hx___cacheBitmapData2(HX_CTX, cacheBitmap1);
HXLINE( 800)							displayObject->_hx___cacheBitmap->_hx_set__hx___bitmapData(HX_CTX, displayObject->_hx___cacheBitmapData);
HXLINE( 801)							displayObject->_hx_set__hx___cacheBitmapRenderer(HX_CTX, null());
            						}
...
HXLINE( 834)				displayObject->_hx_set__hx___cacheBitmap(HX_CTX, null());
HXLINE( 835)				displayObject->_hx_set__hx___cacheBitmapData(HX_CTX, null());
HXLINE( 836)				displayObject->_hx_set__hx___cacheBitmapData2(HX_CTX, null());
HXLINE( 837)				displayObject->_hx_set__hx___cacheBitmapData3(HX_CTX, null());
HXLINE( 838)				displayObject->_hx_set__hx___cacheBitmapColorTransform(HX_CTX, null());
HXLINE( 839)				displayObject->_hx_set__hx___cacheBitmapRenderer(HX_CTX, null());
...
::hx::Val DisplayObjectRenderer_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"__type") ) { _hx_set__hx___type(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 7:
	...
	case 16:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"__overrideBlendMode") ) { _hx_set__hx___overrideBlendMode(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"__tempColorTransform") ) { _hx_set__hx___tempColorTransform(HX_CTX_GET,inValue.Cast<  ::openfl::geom::ColorTransform >()); return inValue; }
		break;
	case 21:
