...
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_183_fold,"Lambda","fold",0x9b8816a8,"Lambda.fold","/usr/share/haxe/std/Lambda.hx",183,0x92dd64dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_194_foldi,"Lambda","foldi",0x7b8bbcc1,"Lambda.foldi","/usr/share/haxe/std/Lambda.hx",194,0x92dd64dc)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Lambda_obj,exists,return )
 ...
 ::Dynamic Lambda_obj::fold( ::Dynamic it, ::Dynamic f, ::Dynamic first){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_183_fold)
HXLINE( 184)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Lambda_obj,fold,return )
 ...
 ::Dynamic Lambda_obj::foldi( ::Dynamic it, ::Dynamic f, ::Dynamic first){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_194_foldi)
HXLINE( 195)		int i = 0;
HXLINE( 196)		{
