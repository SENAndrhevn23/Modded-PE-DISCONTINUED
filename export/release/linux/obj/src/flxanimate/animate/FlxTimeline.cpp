...
void FlxTimeline_obj::__construct(::Array< ::Dynamic> layers){
            	HX_GC_STACKFRAME(&_hx_pos_28c2c011c1601b38_27_new)
...
HXDLIN(  28)		this->_hx_set__layers(HX_CTX, _hx_tmp);
HXLINE(  29)		{
HXLINE(  29)			int _g = 0;
...
void FlxTimeline_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_28c2c011c1601b38_182_destroy)
HXLINE( 183)		{
HXLINE( 183)			int _g = 0;
...
HXLINE( 187)		this->_hx_set__layers(HX_CTX, null());
            	}
...
::hx::Val FlxTimeline_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"_parent") ) { _hx_set__parent(HX_CTX_GET,inValue.Cast<  ::flxanimate::animate::FlxSymbol >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_layers") ) { _hx_set__layers(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 11:
