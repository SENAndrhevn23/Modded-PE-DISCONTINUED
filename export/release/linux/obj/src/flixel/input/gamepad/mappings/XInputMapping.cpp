...
void XInputMapping_obj::initValues(){
            	HX_GC_STACKFRAME(&_hx_pos_84c975cfdc90262d_20_initValues)
HXLINE(  21)		this->_hx_set_leftStick(HX_CTX, ::flixel::input::gamepad::id::XInputID_obj::LEFT_ANALOG_STICK);
HXLINE(  22)		this->_hx_set_rightStick(HX_CTX, ::flixel::input::gamepad::id::XInputID_obj::RIGHT_ANALOG_STICK);
            	}
