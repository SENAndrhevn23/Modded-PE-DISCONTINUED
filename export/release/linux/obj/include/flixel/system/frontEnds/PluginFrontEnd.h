...
class HXCPP_CLASS_ATTRIBUTES PluginFrontEnd_obj : public ::hx::Object
{
	...
	public:
		...
		::String __ToString() const { return HX_("PluginFrontEnd",a5,f8,8b,d8); }
		 ...
		 ::mikolka::vslice::components::ScreenshotPlugin add_mikolka_vslice_components_ScreenshotPlugin( ::mikolka::vslice::components::ScreenshotPlugin plugin);
		::Dynamic add_mikolka_vslice_components_ScreenshotPlugin_dyn();
