...
class HXCPP_CLASS_ATTRIBUTES PsychUINumericStepper_obj : public  ::backend::ui::PsychUIInputText_obj
{
	...
	public:
		...
		inline  ::flixel::FlxSprite _hx_set_buttonPlus(::hx::StackContext *_hx_ctx, ::flixel::FlxSprite _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return buttonPlus=_hx_v; }
		 ::flixel::FlxSprite buttonMinus;
		inline  ::flixel::FlxSprite _hx_set_buttonMinus(::hx::StackContext *_hx_ctx, ::flixel::FlxSprite _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return buttonMinus=_hx_v; }
		 ::Dynamic onValueChange;
		inline  ::Dynamic _hx_set_onValueChange(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return onValueChange=_hx_v; }
