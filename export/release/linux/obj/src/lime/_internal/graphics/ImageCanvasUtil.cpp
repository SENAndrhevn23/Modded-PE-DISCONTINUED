...
HX_LOCAL_STACK_FRAME(_hx_pos_c961afc6e6a20fc0_201_createImageData,"lime._internal.graphics.ImageCanvasUtil","createImageData",0x9f51e458,"lime._internal.graphics.ImageCanvasUtil.createImageData","lime/_internal/graphics/ImageCanvasUtil.hx",201,0x04a6dce0)
HX_LOCAL_STACK_FRAME(_hx_pos_c961afc6e6a20fc0_223_fillRect,"lime._internal.graphics.ImageCanvasUtil","fillRect",0xcb6da198,"lime._internal.graphics.ImageCanvasUtil.fillRect","lime/_internal/graphics/ImageCanvasUtil.hx",223,0x04a6dce0)
...
void ImageCanvasUtil_obj::convertToCanvas( ::lime::graphics::Image image,::hx::Null< bool >  __o_clear){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_75_convertToCanvas)
HXDLIN(  75)		image->_hx_set_type(HX_CTX, ::lime::graphics::ImageType_obj::CANVAS_dyn());
            	}
...
void ImageCanvasUtil_obj::convertToData( ::lime::graphics::Image image,::hx::Null< bool >  __o_clear){
            		bool clear = __o_clear.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_79_convertToData)
HXLINE(  80)		 ::lime::graphics::ImageBuffer buffer = image->buffer;
HXLINE( 115)		image->_hx_set_type(HX_CTX, ::lime::graphics::ImageType_obj::DATA_dyn());
            	}
...
void ImageCanvasUtil_obj::createImageData( ::lime::graphics::Image image){
            	HX_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_201_createImageData)
            	}
...
void ImageCanvasUtil_obj::fillRect( ::lime::graphics::Image image, ::lime::math::Rectangle rect,int color,int format){
            	HX_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_223_fillRect)
HXLINE( 224)		::lime::_internal::graphics::ImageCanvasUtil_obj::convertToCanvas(image,null());
HXLINE( 226)		int r;
HXLINE( 227)		int g;
HXLINE( 228)		int b;
HXLINE( 229)		int a;
...
void ImageCanvasUtil_obj::resize( ::lime::graphics::Image image,int newWidth,int newHeight){
            	HX_GC_STACKFRAME(&_hx_pos_c961afc6e6a20fc0_308_resize)
...
HXLINE( 320)			buffer->_hx_set__hx___srcCanvas(HX_CTX, null());
...
HXLINE( 325)		buffer->_hx_set__hx___srcImageData(HX_CTX, null());
HXLINE( 326)		buffer->_hx_set_data(HX_CTX, null());
