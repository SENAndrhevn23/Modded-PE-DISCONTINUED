...
HXLINE(  36)		this->_hx_set_host(HX_CTX, name);
HXLINE(  37)		try {
...
HXLINE(  40)				this->_hx_set_ipv6(HX_CTX, _hx_std_host_resolve_ipv6(name));
            			}
            			else {
...
::hx::Val Host_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 2:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"host") ) { _hx_set_host(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"ipv6") ) { _hx_set_ipv6(HX_CTX_GET,inValue.Cast< ::Array< unsigned char > >()); return inValue; }
	}
