...
void DispatchIterator_obj::copy(){
            	HX_GC_STACKFRAME(&_hx_pos_eed9e911a94343be_496_copy)
HXDLIN( 496)		if (!(this->isCopy)) {
HXLINE( 498)			this->_hx_set_list(HX_CTX, this->list->copy());
...
void DispatchIterator_obj::reset(::Array< ::Dynamic> list){
            	HX_GC_STACKFRAME(&_hx_pos_eed9e911a94343be_539_reset)
HXLINE( 540)		this->_hx_set_list(HX_CTX, list);
