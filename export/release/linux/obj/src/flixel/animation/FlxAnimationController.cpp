...
HXLINE(  87)		this->_hx_set__animations(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  71)		this->timeScale = ((Float)1.0);
HXLINE(  20)		this->frameIndex = -1;
HXLINE(  93)		this->_hx_set__sprite(HX_CTX, sprite);
            	}
...
HXLINE( 136)		this->_hx_set__prerotated(HX_CTX,  ::flixel::animation::FlxPrerotatedAnimation_obj::__alloc( HX_CTX ,Controller,Controller->_sprite->bakedRotationAngle));
...
void FlxAnimationController_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_5ed655cc53689dfd_147_destroy)
HXLINE( 148)		this->destroyAnimations();
HXLINE( 149)		this->_hx_set__animations(HX_CTX, null());
HXLINE( 150)		this->_hx_set_callback(HX_CTX, null());
HXLINE( 151)		this->_hx_set__sprite(HX_CTX, null());
            	}
...
void FlxAnimationController_obj::clearPrerotated(){
            	HX_GC_STACKFRAME(&_hx_pos_5ed655cc53689dfd_161_clearPrerotated)
HXLINE( 162)		if (::hx::IsNotNull( this->_prerotated )) {
HXLINE( 164)			this->_prerotated->destroy();
            		}
HXLINE( 166)		this->_hx_set__prerotated(HX_CTX, null());
            	}
...
HXLINE( 184)		this->_hx_set__animations(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE( 185)		this->_hx_set__curAnim(HX_CTX, null());
            	}
...
HXLINE( 573)		this->_hx_set__curAnim(HX_CTX, ( ( ::flixel::animation::FlxAnimation)(this->_animations->get(animName)) ));
...
void FlxAnimationController_obj::randomFrame(){
            	HX_GC_STACKFRAME(&_hx_pos_5ed655cc53689dfd_661_randomFrame)
HXLINE( 662)		if (::hx::IsNotNull( this->_curAnim )) {
HXLINE( 664)			this->_curAnim->stop();
HXLINE( 665)			this->_hx_set__curAnim(HX_CTX, null());
            		}
...
::String FlxAnimationController_obj::set_frameName(::String Value){
            	HX_GC_STACKFRAME(&_hx_pos_5ed655cc53689dfd_791_set_frameName)
...
HXLINE( 797)				this->_hx_set__curAnim(HX_CTX, null());
            			}
...
void FlxAnimationController_obj::rename(::String oldName,::String newName){
            	HX_GC_STACKFRAME(&_hx_pos_5ed655cc53689dfd_878_rename)
...
HXLINE( 886)		anim->_hx_set_name(HX_CTX, newName);
...
HX_DEFINE_DYNAMIC_FUNC0(FlxAnimationController_obj,get_curAnim,return )
 ...
 ::flixel::animation::FlxAnimation FlxAnimationController_obj::set_curAnim( ::flixel::animation::FlxAnimation anim){
            	HX_GC_STACKFRAME(&_hx_pos_5ed655cc53689dfd_896_set_curAnim)
...
HXLINE( 909)		return (this->_hx_set__curAnim(HX_CTX, anim));
            	}
...
::hx::Val FlxAnimationController_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"_sprite") ) { _hx_set__sprite(HX_CTX_GET,inValue.Cast<  ::flixel::FlxSprite >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"finished") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_finished(inValue.Cast< bool >()) ); }
		if (HX_FIELD_EQ(inName,"callback") ) { _hx_set_callback(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_curAnim") ) { _hx_set__curAnim(HX_CTX_GET,inValue.Cast<  ::flixel::animation::FlxAnimation >()); return inValue; }
		break;
	case 9:
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"_prerotated") ) { _hx_set__prerotated(HX_CTX_GET,inValue.Cast<  ::flixel::animation::FlxPrerotatedAnimation >()); return inValue; }
		break;
	case 14:
