...
void MainEvent_obj::__construct( ::Dynamic f,int p){
            	HX_GC_STACKFRAME(&_hx_pos_4e9d6ea6e9502540_9_new)
HXLINE(  17)		this->isBlocking = true;
HXLINE(  23)		this->_hx_set_f(HX_CTX, f);
...
::hx::Val MainEvent_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
		if (HX_FIELD_EQ(inName,"f") ) { _hx_set_f(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"prev") ) { _hx_set_prev(HX_CTX_GET,inValue.Cast<  ::haxe::MainEvent >()); return inValue; }
		if (HX_FIELD_EQ(inName,"next") ) { _hx_set_next(HX_CTX_GET,inValue.Cast<  ::haxe::MainEvent >()); return inValue; }
		break;
	case 7:
