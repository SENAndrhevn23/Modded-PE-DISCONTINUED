...
{
            	HX_GC_STACKFRAME(&_hx_pos_33b72a992501f206_266_new)
HXLINE( 267)		( ( ::haxe::ds::_List::ListNode)(__this) )->_hx_set_item(HX_CTX, item);
HXLINE( 268)		( ( ::haxe::ds::_List::ListNode)(__this) )->_hx_set_next(HX_CTX, next);
            	}
		...
		::String __ToString() const { return HX_("ListNode",a0,95,b0,02); }
		 ...
		 ::Dynamic item;
		inline  ::Dynamic _hx_set_item(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return item=_hx_v; }
		 ::haxe::ds::_List::ListNode next;
		inline  ::haxe::ds::_List::ListNode _hx_set_next(::hx::StackContext *_hx_ctx, ::haxe::ds::_List::ListNode _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return next=_hx_v; }
};
