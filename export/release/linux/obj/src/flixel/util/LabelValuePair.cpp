...
void *LabelValuePair_obj::_hx_getInterface(int inHash) {
 ...
 ::flixel::util::LabelValuePair LabelValuePair_obj::create(::String label, ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_53443e31a49e57d3_697_create)
HXLINE( 698)		this->_hx_set_label(HX_CTX, label);
HXLINE( 699)		this->_hx_set_value(HX_CTX, value);
...
void LabelValuePair_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_53443e31a49e57d3_709_destroy)
HXLINE( 710)		this->_hx_set_label(HX_CTX, null());
HXLINE( 711)		this->_hx_set_value(HX_CTX, null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(LabelValuePair_obj,destroy,(void))
 ...
 ::flixel::util::LabelValuePair LabelValuePair_obj::weak(::String label, ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_53443e31a49e57d3_690_weak)
...
HXDLIN( 690)		_this->_hx_set_label(HX_CTX, label);
HXDLIN( 690)		_this->_hx_set_value(HX_CTX, value);
...
::hx::Val LabelValuePair_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"label") ) { _hx_set_label(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
