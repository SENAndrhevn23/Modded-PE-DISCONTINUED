...
HX_DEFINE_STACK_FRAME(_hx_pos_c473b54ae7dfc372_629_new,"flxanimate.animate.FlxMetaData","new",0x085bb6a7,"flxanimate.animate.FlxMetaData.new","flxanimate/animate/FlxAnim.hx",629,0x524d8fe9)
HX_LOCAL_STACK_FRAME(_hx_pos_c473b54ae7dfc372_636_destroy,"flxanimate.animate.FlxMetaData","destroy",0x46ec42c1,"flxanimate.animate.FlxMetaData.destroy","flxanimate/animate/FlxAnim.hx",636,0x524d8fe9)
namespace flxanimate{
namespace animate{

void FlxMetaData_obj::__construct(::String name,Float frameRate){
            	HX_GC_STACKFRAME(&_hx_pos_c473b54ae7dfc372_629_new)
HXLINE( 630)		this->_hx_set_name(HX_CTX, name);
HXLINE( 631)		this->frameRate = frameRate;
HXLINE( 632)		this->showHiddenLayers = true;
HXLINE( 633)		this->skipFilters = false;
            	}
...
void FlxMetaData_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_c473b54ae7dfc372_636_destroy)
HXLINE( 637)		this->_hx_set_name(HX_CTX, null());
HXLINE( 638)		this->frameRate = ( (Float)(0) );
            	}
