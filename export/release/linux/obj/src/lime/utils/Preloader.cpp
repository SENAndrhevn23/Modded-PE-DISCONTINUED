...
HXLINE(  42)		this->_hx_set_bytesTotalCache(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  40)		this->_hx_set_bytesLoadedCache2(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  39)		this->_hx_set_bytesLoadedCache(HX_CTX,  ::haxe::ds::ObjectMap_obj::__alloc( HX_CTX ));
HXLINE(  36)		this->_hx_set_onProgress(HX_CTX,  ::lime::app::_Event_Int_Int_Void_obj::__alloc( HX_CTX ));
HXLINE(  35)		this->_hx_set_onComplete(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE(  60)		this->bytesLoaded = 0;
HXLINE(  61)		this->bytesTotal = 0;
HXLINE(  63)		this->_hx_set_libraries(HX_CTX, ::Array_obj< ::Dynamic>::__new());
HXLINE(  64)		this->_hx_set_libraryNames(HX_CTX, ::Array_obj< ::String >::__new());
...
::hx::Val Preloader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"libraries") ) { _hx_set_libraries(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"onComplete") ) { _hx_set_onComplete(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Void_Void >()); return inValue; }
		if (HX_FIELD_EQ(inName,"onProgress") ) { _hx_set_onProgress(HX_CTX_GET,inValue.Cast<  ::lime::app::_Event_Int_Int_Void >()); return inValue; }
	...
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"libraryNames") ) { _hx_set_libraryNames(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"preloadStarted") ) { preloadStarted=inValue.Cast< bool >(); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"bytesTotalCache") ) { _hx_set_bytesTotalCache(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"bytesLoadedCache") ) { _hx_set_bytesLoadedCache(HX_CTX_GET,inValue.Cast<  ::haxe::ds::ObjectMap >()); return inValue; }
		...
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"bytesLoadedCache2") ) { _hx_set_bytesLoadedCache2(HX_CTX_GET,inValue.Cast<  ::haxe::ds::StringMap >()); return inValue; }
	}
