...
class HXCPP_CLASS_ATTRIBUTES TextField_obj : public  ::openfl::display::InteractiveObject_obj
{
	...
	public:
		...
		inline  ::openfl::text::StyleSheet _hx_set__hx___styleSheet(::hx::StackContext *_hx_ctx, ::openfl::text::StyleSheet _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___styleSheet=_hx_v; }
		::String _hx___text;
		inline ::String _hx_set__hx___text(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return _hx___text=_hx_v; }
		::String _hx___htmlText;
		inline ::String _hx_set__hx___htmlText(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return _hx___htmlText=_hx_v; }
		 ::openfl::text::_internal::TextEngine _hx___textEngine;
		inline  ::openfl::text::_internal::TextEngine _hx_set__hx___textEngine(::hx::StackContext *_hx_ctx, ::openfl::text::_internal::TextEngine _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___textEngine=_hx_v; }
