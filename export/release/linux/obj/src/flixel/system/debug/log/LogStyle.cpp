...
void LogStyle_obj::__construct(::String __o_prefix,::String __o_color,::hx::Null< int >  __o_size,::hx::Null< bool >  __o_bold,::hx::Null< bool >  __o_italic,::hx::Null< bool >  __o_underlined,::String errorSound,::hx::Null< bool >  __o_openConsole, ::Dynamic callback,::hx::Null< bool >  __o_throwException){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_4946e010770d7497_9_new)
HXLINE(  48)		this->throwException = false;
HXLINE(  67)		this->_hx_set_prefix(HX_CTX, prefix);
HXLINE(  68)		this->_hx_set_color(HX_CTX, color);
HXLINE(  69)		this->size = size;
HXLINE(  70)		this->bold = bold;
HXLINE(  71)		this->italic = italic;
HXLINE(  72)		this->underlined = underlined;
HXLINE(  73)		this->_hx_set_errorSound(HX_CTX, errorSound);
HXLINE(  74)		this->openConsole = openConsole;
HXLINE(  75)		this->_hx_set_callbackFunction(HX_CTX, callback);
...
::hx::Val LogStyle_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"color") ) { _hx_set_color(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 6:
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"errorSound") ) { _hx_set_errorSound(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 11:
	...
	case 14:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"callbackFunction") ) { _hx_set_callbackFunction(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
