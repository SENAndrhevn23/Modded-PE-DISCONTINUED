...
class HXCPP_CLASS_ATTRIBUTES MetaNote_obj : public  ::objects::Note_obj
{
	...
	public:
		...
		inline ::cpp::VirtualArray _hx_set_songData(::hx::StackContext *_hx_ctx,::cpp::VirtualArray _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return songData=_hx_v; }
		 ::flixel::FlxSprite sustainSprite;
		inline  ::flixel::FlxSprite _hx_set_sustainSprite(::hx::StackContext *_hx_ctx, ::flixel::FlxSprite _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return sustainSprite=_hx_v; }
		Float chartY;
		int chartNoteData;
		 ::Dynamic tempCast;
		inline  ::Dynamic _hx_set_tempCast(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return tempCast=_hx_v; }
		...
		inline  ::flixel::text::FlxText _hx_set__noteTypeText(::hx::StackContext *_hx_ctx, ::flixel::text::FlxText _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _noteTypeText=_hx_v; }
