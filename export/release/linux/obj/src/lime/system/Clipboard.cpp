...
HXLINE(  71)		if (::hx::IsNull( ::lime::_hx_system::Clipboard_obj::_text )) {
HXLINE(  73)			::lime::_hx_system::Clipboard_obj::_hx___update();
HXLINE(  77)			::lime::_hx_system::Clipboard_obj::set_text(::lime::_hx_system::Clipboard_obj::_text);
            		}
