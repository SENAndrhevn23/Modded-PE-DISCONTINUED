...
::hx::Val GlyphMetrics_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"verticalBearing") ) { _hx_set_verticalBearing(HX_CTX_GET,inValue.Cast<  ::lime::math::Vector2 >()); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"horizontalBearing") ) { _hx_set_horizontalBearing(HX_CTX_GET,inValue.Cast<  ::lime::math::Vector2 >()); return inValue; }
	}
