...
HXLINE( 825)		this->_hx_set__hx___graphics(HX_CTX,  ::openfl::display::Graphics_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this)));
HXLINE( 826)		this->_hx_set__hx___textEngine(HX_CTX,  ::openfl::text::_internal::TextEngine_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this)));
...
HXLINE( 831)		this->_hx_set__hx___text(HX_CTX, HX_("",00,00,00,00));
...
HXLINE( 838)			::openfl::text::TextField_obj::_hx___defaultTextFormat->_hx_set_blockIndent(HX_CTX, 0);
HXLINE( 839)			::openfl::text::TextField_obj::_hx___defaultTextFormat->_hx_set_bullet(HX_CTX, false);
HXLINE( 840)			::openfl::text::TextField_obj::_hx___defaultTextFormat->_hx_set_letterSpacing(HX_CTX, 0);
HXLINE( 841)			::openfl::text::TextField_obj::_hx___defaultTextFormat->_hx_set_kerning(HX_CTX, false);
            		}
HXLINE( 844)		this->_hx_set__hx___textFormat(HX_CTX, ::openfl::text::TextField_obj::_hx___defaultTextFormat->clone());
HXLINE( 845)		{
...
HXLINE(1506)								range->_hx_set_format(HX_CTX, range->format->clone());
...
HXLINE(1549)									range->_hx_set_format(HX_CTX, range->format->clone());
...
void TextField_obj::_hx___startCursorTimer(){
            	HX_GC_STACKFRAME(&_hx_pos_d001dbc361c2c159_2177___startCursorTimer)
HXDLIN(2177)		if (::hx::IsEq( this->get_type(),1 )) {
HXLINE(2179)			if (this->_hx___inputEnabled) {
HXLINE(2181)				this->_hx_set__hx___cursorTimer(HX_CTX, ::haxe::Timer_obj::delay(this->_hx___startCursorTimer_dyn(),600));
...
void TextField_obj::_hx___stopCursorTimer(){
            	HX_GC_STACKFRAME(&_hx_pos_d001dbc361c2c159_2211___stopCursorTimer)
HXLINE(2212)		if (::hx::IsNotNull( this->_hx___cursorTimer )) {
HXLINE(2214)			this->_hx___cursorTimer->stop();
HXLINE(2215)			this->_hx_set__hx___cursorTimer(HX_CTX, null());
            		}
...
void TextField_obj::_hx___updateText(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_d001dbc361c2c159_2437___updateText)
HXLINE(2447)		this->_hx___textEngine->set_text(value);
HXLINE(2448)		this->_hx_set__hx___text(HX_CTX, this->_hx___textEngine->text);
...
HX_DEFINE_DYNAMIC_FUNC0(TextField_obj,get_antiAliasType,return )
 ...
 ::Dynamic TextField_obj::set_antiAliasType( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_d001dbc361c2c159_2509_set_antiAliasType)
HXLINE(2510)		bool _hx_tmp = ::hx::IsNotEq( value,this->_hx___textEngine->antiAliasType );
HXLINE(2515)		return (this->_hx___textEngine->_hx_set_antiAliasType(HX_CTX, value));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TextField_obj,get_autoSize,return )
 ...
 ::Dynamic TextField_obj::set_autoSize( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_d001dbc361c2c159_2524_set_autoSize)
...
HXLINE(2532)		return (this->_hx___textEngine->_hx_set_autoSize(HX_CTX, value));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TextField_obj,get_gridFitType,return )
 ...
 ::Dynamic TextField_obj::set_gridFitType( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_d001dbc361c2c159_2678_set_gridFitType)
HXDLIN(2678)		return (this->_hx___textEngine->_hx_set_gridFitType(HX_CTX, value));
            	}
...
HXLINE(2728)		this->_hx_set__hx___htmlText(HX_CTX, value);
...
HX_DEFINE_DYNAMIC_FUNC0(TextField_obj,get_styleSheet,return )
 ...
 ::openfl::text::StyleSheet TextField_obj::set_styleSheet( ::openfl::text::StyleSheet value){
            	HX_GC_STACKFRAME(&_hx_pos_d001dbc361c2c159_2955_set_styleSheet)
...
HXLINE(2976)		return (this->_hx_set__hx___styleSheet(HX_CTX, value));
            	}
...
::String TextField_obj::set_text(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_d001dbc361c2c159_2990_set_text)
...
HXLINE(3014)		range->_hx_set_format(HX_CTX, this->_hx___textFormat);
...
int TextField_obj::set_textColor(int value){
            	HX_GC_STACKFRAME(&_hx_pos_d001dbc361c2c159_3031_set_textColor)
...
HXLINE(3040)				range1->format->_hx_set_color(HX_CTX, value);
            			}
            		}
HXLINE(3043)		return ( (int)((this->_hx___textFormat->_hx_set_color(HX_CTX, value))) );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(TextField_obj,get_type,return )
 ...
 ::Dynamic TextField_obj::set_type( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_d001dbc361c2c159_3064_set_type)
HXLINE(3065)		if (::hx::IsNotNull( this->_hx___styleSheet )) {
HXLINE(3069)			value = 0;
            		}
HXLINE(3072)		if (::hx::IsNotEq( value,this->_hx___textEngine->type )) {
HXLINE(3076)			this->_hx___textEngine->_hx_set_type(HX_CTX, value);
...
HXLINE(3082)				this->_hx___textEngine->_hx_set__hx___useIntAdvances(HX_CTX, true);
            			}
            			else {
...
HXLINE(3089)				this->_hx___textEngine->_hx_set__hx___useIntAdvances(HX_CTX, null());
            			}
...
::hx::Val TextField_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"__text") ) { _hx_set__hx___text(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 7:
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"__htmlText") ) { _hx_set__hx___htmlText(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 11:
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"__styleSheet") ) { _hx_set__hx___styleSheet(HX_CTX_GET,inValue.Cast<  ::openfl::text::StyleSheet >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__textEngine") ) { _hx_set__hx___textEngine(HX_CTX_GET,inValue.Cast<  ::openfl::text::_internal::TextEngine >()); return inValue; }
