...
class HXCPP_CLASS_ATTRIBUTES BaseScaleMode_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::flixel::math::FlxBasePoint _hx_set_deviceSize(::hx::StackContext *_hx_ctx, ::flixel::math::FlxBasePoint _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return deviceSize=_hx_v; }
		 ::flixel::math::FlxBasePoint gameSize;
		inline  ::flixel::math::FlxBasePoint _hx_set_gameSize(::hx::StackContext *_hx_ctx, ::flixel::math::FlxBasePoint _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return gameSize=_hx_v; }
		...
		inline  ::flixel::util::FlxHorizontalAlign _hx_set_horizontalAlign(::hx::StackContext *_hx_ctx, ::flixel::util::FlxHorizontalAlign _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return horizontalAlign=_hx_v; }
		 ::flixel::util::FlxVerticalAlign verticalAlign;
		inline  ::flixel::util::FlxVerticalAlign _hx_set_verticalAlign(::hx::StackContext *_hx_ctx, ::flixel::util::FlxVerticalAlign _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return verticalAlign=_hx_v; }
