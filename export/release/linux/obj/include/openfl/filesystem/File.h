...
class HXCPP_CLASS_ATTRIBUTES File_obj : public  ::openfl::net::FileReference_obj
{
	...
	public:
		...
		inline  ::openfl::desktop::Icon _hx_set_icon(::hx::StackContext *_hx_ctx, ::openfl::desktop::Icon _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return icon=_hx_v; }
		 ::lime::ui::FileDialog _hx___fileDialog;
		inline  ::lime::ui::FileDialog _hx_set__hx___fileDialog(::hx::StackContext *_hx_ctx, ::lime::ui::FileDialog _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___fileDialog=_hx_v; }
		 ::lime::_hx_system::ThreadPool _hx___fileWorker;
		inline  ::lime::_hx_system::ThreadPool _hx_set__hx___fileWorker(::hx::StackContext *_hx_ctx, ::lime::_hx_system::ThreadPool _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___fileWorker=_hx_v; }
		::String _hx___sep;
		inline ::String _hx_set__hx___sep(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return _hx___sep=_hx_v; }
