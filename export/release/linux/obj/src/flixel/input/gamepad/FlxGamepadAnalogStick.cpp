...
void FlxGamepadAnalogStick_obj::__construct(int x,int y, ::Dynamic settings){
            	HX_GC_STACKFRAME(&_hx_pos_1ef7cee7c9b8631a_5_new)
HXLINE(  38)		this->_hx_set_mode(HX_CTX, ::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::BOTH_dyn());
...
HXDLIN(  48)		this->_hx_set_mode(HX_CTX, _hx_tmp);
...
::String FlxGamepadAnalogStick_obj::toString(){
            	HX_GC_STACKFRAME(&_hx_pos_1ef7cee7c9b8631a_58_toString)
...
HXDLIN(  59)		_this->_hx_set_label(HX_CTX, HX_("x",78,00,00,00));
HXDLIN(  59)		_this->_hx_set_value(HX_CTX, value);
...
HXDLIN(  60)		_this1->_hx_set_label(HX_CTX, HX_("y",79,00,00,00));
HXDLIN(  60)		_this1->_hx_set_value(HX_CTX, value1);
...
HXDLIN(  61)		_this2->_hx_set_label(HX_CTX, HX_("rawUp",63,6a,26,e4));
HXDLIN(  61)		_this2->_hx_set_value(HX_CTX, value2);
...
HXDLIN(  62)		_this3->_hx_set_label(HX_CTX, HX_("rawDown",6a,0e,23,ff));
HXDLIN(  62)		_this3->_hx_set_value(HX_CTX, value3);
...
HXDLIN(  63)		_this4->_hx_set_label(HX_CTX, HX_("rawLeft",0f,1e,65,04));
HXDLIN(  63)		_this4->_hx_set_value(HX_CTX, value4);
...
HXDLIN(  64)		_this5->_hx_set_label(HX_CTX, HX_("rawRight",d4,3c,22,4b));
HXDLIN(  64)		_this5->_hx_set_value(HX_CTX, value5);
...
HXDLIN(  65)		_this6->_hx_set_label(HX_CTX, HX_("digitalThreshold",b3,20,9a,6e));
HXDLIN(  65)		_this6->_hx_set_value(HX_CTX, value6);
...
HXDLIN(  66)		_this7->_hx_set_label(HX_CTX, HX_("mode",63,d3,60,48));
HXDLIN(  66)		_this7->_hx_set_value(HX_CTX, value7);
...
::hx::Val FlxGamepadAnalogStick_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 1:
		...
		break;
	case 4:
		if (HX_FIELD_EQ(inName,"mode") ) { _hx_set_mode(HX_CTX_GET,inValue.Cast<  ::flixel::input::gamepad::FlxAnalogToDigitalMode >()); return inValue; }
		break;
	case 5:
