...
HXLINE(  20)		this->_hx_set_onComplete(HX_CTX,  ::lime::app::_Event_Void_Void_obj::__alloc( HX_CTX ));
HXLINE(  28)		this->_hx_set_display(HX_CTX, display);
...
void Preloader_obj::display_onUnload( ::openfl::events::Event event){
            	HX_GC_STACKFRAME(&_hx_pos_c8b942935957ff96_81_display_onUnload)
...
HXLINE(  92)			this->_hx_set_display(HX_CTX, null());
            		}
...
::hx::Val Preloader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"display") ) { _hx_set_display(HX_CTX_GET,inValue.Cast<  ::openfl::display::Sprite >()); return inValue; }
		break;
	case 8:
