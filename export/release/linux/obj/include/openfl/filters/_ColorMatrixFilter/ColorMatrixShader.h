...
class HXCPP_CLASS_ATTRIBUTES ColorMatrixShader_obj : public  ::openfl::filters::BitmapFilterShader_obj
{
	...
	public:
		...
		inline  ::openfl::display::ShaderParameter_Float _hx_set_uMultipliers(::hx::StackContext *_hx_ctx, ::openfl::display::ShaderParameter_Float _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return uMultipliers=_hx_v; }
		 ::openfl::display::ShaderParameter_Float uOffsets;
		inline  ::openfl::display::ShaderParameter_Float _hx_set_uOffsets(::hx::StackContext *_hx_ctx, ::openfl::display::ShaderParameter_Float _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return uOffsets=_hx_v; }
};
