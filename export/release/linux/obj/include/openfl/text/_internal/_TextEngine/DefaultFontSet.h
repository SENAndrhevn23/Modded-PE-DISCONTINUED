...
class HXCPP_CLASS_ATTRIBUTES DefaultFontSet_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::openfl::text::Font _hx_set_bold(::hx::StackContext *_hx_ctx, ::openfl::text::Font _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return bold=_hx_v; }
		 ::openfl::text::Font boldItalic;
		inline  ::openfl::text::Font _hx_set_boldItalic(::hx::StackContext *_hx_ctx, ::openfl::text::Font _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return boldItalic=_hx_v; }
		 ::openfl::text::Font italic;
		inline  ::openfl::text::Font _hx_set_italic(::hx::StackContext *_hx_ctx, ::openfl::text::Font _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return italic=_hx_v; }
		 ::openfl::text::Font normal;
		inline  ::openfl::text::Font _hx_set_normal(::hx::StackContext *_hx_ctx, ::openfl::text::Font _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return normal=_hx_v; }
