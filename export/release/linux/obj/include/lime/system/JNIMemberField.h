...
{
            	HX_GC_STACKFRAME(&_hx_pos_6a03f50885e20814_250_new)
HXDLIN( 250)		( ( ::lime::_hx_system::JNIMemberField)(__this) )->_hx_set_field(HX_CTX, field);
            	}
		...
		::String __ToString() const { return HX_("JNIMemberField",fb,8c,1f,2d); }
		 ...
		 ::Dynamic field;
		inline  ::Dynamic _hx_set_field(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return field=_hx_v; }
