...
void TileContainer_obj::__construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< Float >  __o_scaleX,::hx::Null< Float >  __o_scaleY,::hx::Null< Float >  __o_rotation,::hx::Null< Float >  __o_originX,::hx::Null< Float >  __o_originY){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_3aeffccbe166a6d0_37_new)
HXLINE(  38)		super::__construct(-1,x,y,scaleX,scaleY,rotation,originX,originY);
HXLINE(  40)		this->_hx_set__hx___tiles(HX_CTX, ::Array_obj< ::Dynamic>::__new());
...
void *TileContainer_obj::_hx_getInterface(int inHash) {
 ...
 ::openfl::display::Tile TileContainer_obj::addTile( ::openfl::display::Tile tile){
            	HX_GC_STACKFRAME(&_hx_pos_3aeffccbe166a6d0_54_addTile)
...
HXLINE(  63)		this->_hx___tiles->setCtx( HX_CTX, this->get_numTiles(),tile);
HXLINE(  64)		tile->_hx_set_parent(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
...
HX_DEFINE_DYNAMIC_FUNC1(TileContainer_obj,addTile,return )
 ...
 ::openfl::display::Tile TileContainer_obj::addTileAt( ::openfl::display::Tile tile,int index){
            	HX_GC_STACKFRAME(&_hx_pos_3aeffccbe166a6d0_90_addTileAt)
...
HXLINE( 100)		tile->_hx_set_parent(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
...
HX_DEFINE_DYNAMIC_FUNC1(TileContainer_obj,getTileIndex,return )
 ...
 ::openfl::display::Tile TileContainer_obj::removeTile( ::openfl::display::Tile tile){
            	HX_GC_STACKFRAME(&_hx_pos_3aeffccbe166a6d0_219_removeTile)
...
HXLINE( 222)			tile->_hx_set_parent(HX_CTX, null());
...
void TileContainer_obj::removeTiles(::hx::Null< int >  __o_beginIndex,::hx::Null< int >  __o_endIndex){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_3aeffccbe166a6d0_256_removeTiles)
...
HXDLIN( 261)				_g = (_g + 1);
HXLINE( 263)				tile->_hx_set_parent(HX_CTX, null());
            			}
            		}
...
void TileContainer_obj::swapTiles( ::openfl::display::Tile tile1, ::openfl::display::Tile tile2){
            	HX_GC_STACKFRAME(&_hx_pos_3aeffccbe166a6d0_343_swapTiles)
...
HXLINE( 348)			this->_hx___tiles->setCtx( HX_CTX, index1,tile2);
HXLINE( 349)			this->_hx___tiles->setCtx( HX_CTX, index2,tile1);
...
void TileContainer_obj::swapTilesAt(int index1,int index2){
            	HX_GC_STACKFRAME(&_hx_pos_3aeffccbe166a6d0_364_swapTilesAt)
HXLINE( 365)		 ::openfl::display::Tile swap = this->_hx___tiles->__get(index1).StaticCast<  ::openfl::display::Tile >();
HXLINE( 366)		this->_hx___tiles->setCtx( HX_CTX, index1,this->_hx___tiles->__get(index2).StaticCast<  ::openfl::display::Tile >());
HXLINE( 367)		this->_hx___tiles->setCtx( HX_CTX, index2,swap);
...
::hx::Val TileContainer_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"__tiles") ) { _hx_set__hx___tiles(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
