...
void CURL_obj::__construct( ::Dynamic handle){
            	HX_GC_STACKFRAME(&_hx_pos_eb990c46aed3e3e1_29_new)
HXDLIN(  29)		if (::hx::IsNotNull( handle )) {
HXLINE(  31)			this->_hx_set_handle(HX_CTX, handle);
            		}
            		else {
HXLINE(  36)			this->_hx_set_handle(HX_CTX, ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_curl_easy_init()) ));
            		}
            	}
...
::hx::Val CURL_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"writeBytes") ) { _hx_set_writeBytes(HX_CTX_GET,inValue.Cast<  ::haxe::io::Bytes >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"headerBytes") ) { _hx_set_headerBytes(HX_CTX_GET,inValue.Cast<  ::haxe::io::Bytes >()); return inValue; }
	}
