...
HX_LOCAL_STACK_FRAME(_hx_pos_44cee9f3d02dfeb3_233_fromBytes,"lime.net._HTTPRequest_lime_text_Font","fromBytes",0x7d0344d7,"lime.net._HTTPRequest_lime_text_Font.fromBytes","lime/text/Font.hx",233,0x3be57807)
namespace lime{
namespace net{
...
bool _HTTPRequest_lime_text_Font_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic _HTTPRequest_lime_text_Font_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_44cee9f3d02dfeb3_233_fromBytes)
HXDLIN( 233)		return ::lime::text::Font_obj::fromBytes(bytes);
            	}
