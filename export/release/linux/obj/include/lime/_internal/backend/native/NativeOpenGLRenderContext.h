...
class HXCPP_CLASS_ATTRIBUTES NativeOpenGLRenderContext_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::lime::graphics::opengl::GLObject _hx_set__hx___arrayBufferBinding(::hx::StackContext *_hx_ctx, ::lime::graphics::opengl::GLObject _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___arrayBufferBinding=_hx_v; }
		 ::lime::graphics::opengl::GLObject _hx___elementBufferBinding;
		inline  ::lime::graphics::opengl::GLObject _hx_set__hx___elementBufferBinding(::hx::StackContext *_hx_ctx, ::lime::graphics::opengl::GLObject _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___elementBufferBinding=_hx_v; }
		int _hx___contextID;
		 ::lime::graphics::opengl::GLObject _hx___currentProgram;
		inline  ::lime::graphics::opengl::GLObject _hx_set__hx___currentProgram(::hx::StackContext *_hx_ctx, ::lime::graphics::opengl::GLObject _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___currentProgram=_hx_v; }
		 ::lime::graphics::opengl::GLObject _hx___framebufferBinding;
		inline  ::lime::graphics::opengl::GLObject _hx_set__hx___framebufferBinding(::hx::StackContext *_hx_ctx, ::lime::graphics::opengl::GLObject _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___framebufferBinding=_hx_v; }
		bool _hx___initialized;
		bool _hx___isContextLost;
		 ::lime::graphics::opengl::GLObject _hx___renderbufferBinding;
		inline  ::lime::graphics::opengl::GLObject _hx_set__hx___renderbufferBinding(::hx::StackContext *_hx_ctx, ::lime::graphics::opengl::GLObject _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___renderbufferBinding=_hx_v; }
		 ::lime::graphics::opengl::GLObject _hx___texture2DBinding;
		inline  ::lime::graphics::opengl::GLObject _hx_set__hx___texture2DBinding(::hx::StackContext *_hx_ctx, ::lime::graphics::opengl::GLObject _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___texture2DBinding=_hx_v; }
		 ::lime::graphics::opengl::GLObject _hx___textureCubeMapBinding;
		inline  ::lime::graphics::opengl::GLObject _hx_set__hx___textureCubeMapBinding(::hx::StackContext *_hx_ctx, ::lime::graphics::opengl::GLObject _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___textureCubeMapBinding=_hx_v; }
