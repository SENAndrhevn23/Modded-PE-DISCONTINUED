...
HXLINE(  73)				sx = (sx->_hx_set_n(HX_CTX,  ::lime::_internal::graphics::BlurStack_obj::__alloc( HX_CTX )));
            			}
            		}
HXLINE(  75)		sx->_hx_set_n(HX_CTX, ssx);
...
HXLINE(  81)				sy = (sy->_hx_set_n(HX_CTX,  ::lime::_internal::graphics::BlurStack_obj::__alloc( HX_CTX )));
            			}
            		}
HXLINE(  83)		sy->_hx_set_n(HX_CTX, ssy);
