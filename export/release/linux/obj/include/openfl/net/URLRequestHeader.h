			...
			*(void **)__this = URLRequestHeader_obj::_hx_vtable;
{
            	...
            	HX_GC_STACKFRAME(&_hx_pos_8cde7e51a6201b8b_100_new)
HXLINE( 101)		( ( ::openfl::net::URLRequestHeader)(__this) )->_hx_set_name(HX_CTX, name);
HXLINE( 102)		( ( ::openfl::net::URLRequestHeader)(__this) )->_hx_set_value(HX_CTX, value);
            	}
