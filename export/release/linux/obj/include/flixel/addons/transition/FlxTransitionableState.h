...
class HXCPP_CLASS_ATTRIBUTES FlxTransitionableState_obj : public  ::flixel::FlxState_obj
{
	...
	public:
		...
		inline  ::flixel::addons::transition::TransitionData _hx_set_transIn(::hx::StackContext *_hx_ctx, ::flixel::addons::transition::TransitionData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return transIn=_hx_v; }
		 ::flixel::addons::transition::TransitionData transOut;
		inline  ::flixel::addons::transition::TransitionData _hx_set_transOut(::hx::StackContext *_hx_ctx, ::flixel::addons::transition::TransitionData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return transOut=_hx_v; }
		void destroy();
		...
		bool _exiting;
		 ::Dynamic _onExit;
		inline  ::Dynamic _hx_set__onExit(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _onExit=_hx_v; }
