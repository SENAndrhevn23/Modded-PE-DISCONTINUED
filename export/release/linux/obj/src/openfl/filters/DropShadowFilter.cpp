...
HXLINE( 311)		return sourceBitmapData;
 ...
 ::openfl::display::Shader DropShadowFilter_obj::_hx___initShader( ::openfl::display::DisplayObjectRenderer renderer,int pass, ::openfl::display::BitmapData sourceBitmapData){
            	HX_GC_STACKFRAME(&_hx_pos_786269b8d678908e_315___initShader)
...
HXLINE( 353)				shader1->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 359)			shader2->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 369)				shader3->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 377)					shader4->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 383)			shader5->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
