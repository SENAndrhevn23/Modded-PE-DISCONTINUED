...
class HXCPP_CLASS_ATTRIBUTES Sprite_obj : public  ::openfl::display::DisplayObjectContainer_obj
{
	...
	public:
		...
		inline  ::openfl::display::DisplayObject _hx_set_dropTarget(::hx::StackContext *_hx_ctx, ::openfl::display::DisplayObject _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return dropTarget=_hx_v; }
		 ::openfl::display::Sprite hitArea;
		inline  ::openfl::display::Sprite _hx_set_hitArea(::hx::StackContext *_hx_ctx, ::openfl::display::Sprite _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return hitArea=_hx_v; }
		bool useHandCursor;
		bool _hx___buttonMode;
		::String _hx___pendingBindClassName;
		inline ::String _hx_set__hx___pendingBindClassName(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return _hx___pendingBindClassName=_hx_v; }
		 ::openfl::utils::AssetLibrary _hx___pendingBindLibrary;
		inline  ::openfl::utils::AssetLibrary _hx_set__hx___pendingBindLibrary(::hx::StackContext *_hx_ctx, ::openfl::utils::AssetLibrary _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___pendingBindLibrary=_hx_v; }
