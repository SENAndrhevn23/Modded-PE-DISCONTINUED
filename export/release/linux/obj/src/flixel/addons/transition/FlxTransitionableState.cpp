...
void FlxTransitionableState_obj::__construct( ::flixel::addons::transition::TransitionData TransIn, ::flixel::addons::transition::TransitionData TransOut){
            	HX_GC_STACKFRAME(&_hx_pos_d118940668e85bda_36_new)
HXLINE( 156)		this->_exiting = false;
HXLINE( 154)		this->transOutFinished = false;
HXLINE(  59)		this->_hx_set_transIn(HX_CTX, TransIn);
HXLINE(  60)		this->_hx_set_transOut(HX_CTX, TransOut);
...
HXLINE(  64)			this->_hx_set_transIn(HX_CTX, ::flixel::addons::transition::FlxTransitionableState_obj::defaultTransIn);
            		}
...
HXLINE(  68)			this->_hx_set_transOut(HX_CTX, ::flixel::addons::transition::FlxTransitionableState_obj::defaultTransOut);
            		}
...
void FlxTransitionableState_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_d118940668e85bda_74_destroy)
HXLINE(  75)		this->super::destroy();
HXLINE(  76)		this->_hx_set_transIn(HX_CTX, null());
HXLINE(  77)		this->_hx_set_transOut(HX_CTX, null());
HXLINE(  78)		this->_hx_set__onExit(HX_CTX, null());
            	}
...
void FlxTransitionableState_obj::transitionOut( ::Dynamic OnExit){
            	HX_GC_STACKFRAME(&_hx_pos_d118940668e85bda_136_transitionOut)
HXLINE( 137)		this->_hx_set__onExit(HX_CTX, OnExit);
...
::hx::Val FlxTransitionableState_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"transIn") ) { _hx_set_transIn(HX_CTX_GET,inValue.Cast<  ::flixel::addons::transition::TransitionData >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_onExit") ) { _hx_set__onExit(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"transOut") ) { _hx_set_transOut(HX_CTX_GET,inValue.Cast<  ::flixel::addons::transition::TransitionData >()); return inValue; }
