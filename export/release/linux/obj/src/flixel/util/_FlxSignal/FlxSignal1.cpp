...
void FlxSignal1_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_d9021ea3f58f5bd9_223_new)
HXLINE( 224)		super::__construct();
HXLINE( 225)		this->_hx_set_dispatch(HX_CTX, this->dispatch1_dyn());
            	}
...
void FlxSignal1_obj::dispatch1( ::Dynamic value1){
            	HX_GC_STACKFRAME(&_hx_pos_d9021ea3f58f5bd9_293_dispatch1)
