...
{
            	HX_GC_STACKFRAME(&_hx_pos_a2c5aad29e94c731_934_new)
HXLINE( 935)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_hx_set__groupMembers(HX_CTX, groupMembers);
HXLINE( 936)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_hx_set__filter(HX_CTX, filter);
...
HXLINE( 938)		( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_length = ( ( ::flixel::group::FlxTypedGroupIterator)(__this) )->_groupMembers->get_length();
		...
		inline ::cpp::VirtualArray _hx_set__groupMembers(::hx::StackContext *_hx_ctx,::cpp::VirtualArray _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _groupMembers=_hx_v; }
		 ::Dynamic _filter;
		inline  ::Dynamic _hx_set__filter(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _filter=_hx_v; }
