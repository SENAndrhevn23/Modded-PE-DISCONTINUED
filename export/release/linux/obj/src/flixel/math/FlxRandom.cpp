...
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_336_shuffle_objects_Note,"flixel.math.FlxRandom","shuffle_objects_Note",0x762fa1d0,"flixel.math.FlxRandom.shuffle_objects_Note","flixel/math/FlxRandom.hx",336,0x4fa37e1d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_260_getObject_mikolka_vslice_freeplay_SongMenuItem,"flixel.math.FlxRandom","getObject_mikolka_vslice_freeplay_SongMenuItem",0xd65fbc97,"flixel.math.FlxRandom.getObject_mikolka_vslice_freeplay_SongMenuItem","flixel/math/FlxRandom.hx",260,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_336_shuffle_substates_StickerSprite,"flixel.math.FlxRandom","shuffle_substates_StickerSprite",0x29717fb2,"flixel.math.FlxRandom.shuffle_substates_StickerSprite","flixel/math/FlxRandom.hx",336,0x4fa37e1d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_260_getObject_String,"flixel.math.FlxRandom","getObject_String",0xa967eaa8,"flixel.math.FlxRandom.getObject_String","flixel/math/FlxRandom.hx",260,0x4fa37e1d)
...
void FlxRandom_obj::shuffle_objects_Note(::Array< ::Dynamic> array){
            	HX_GC_STACKFRAME(&_hx_pos_eba801adaf62ef5c_336_shuffle_objects_Note)
HXLINE( 337)		int maxValidIndex = (array->length - 1);
HXLINE( 338)		{
HXLINE( 338)			int _g = 0;
HXDLIN( 338)			int _g1 = maxValidIndex;
HXDLIN( 338)			while((_g < _g1)){
HXLINE( 338)				_g = (_g + 1);
HXDLIN( 338)				int i = (_g - 1);
HXLINE( 340)				int j = this->_hx_int(i,maxValidIndex,null());
HXLINE( 341)				 ::objects::Note tmp = array->__get(i).StaticCast<  ::objects::Note >();
HXLINE( 342)				array->setCtx( HX_CTX, i,array->__get(j).StaticCast<  ::objects::Note >());
HXLINE( 343)				array->setCtx( HX_CTX, j,tmp);
            			}
            		}
            	}


HX_DEFINE_DYNAMIC_FUNC1(FlxRandom_obj,shuffle_objects_Note,(void))
...
HX_DEFINE_DYNAMIC_FUNC4(FlxRandom_obj,getObject_flixel_sound_FlxSound,return )
 ...
 ::mikolka::vslice::freeplay::SongMenuItem FlxRandom_obj::getObject_mikolka_vslice_freeplay_SongMenuItem(::Array< ::Dynamic> Objects,::Array< Float > WeightsArray,::hx::Null< int >  __o_StartIndex, ::Dynamic EndIndex){
            		int StartIndex = __o_StartIndex.Default(0);
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_260_getObject_mikolka_vslice_freeplay_SongMenuItem)
HXLINE( 261)		 ::mikolka::vslice::freeplay::SongMenuItem selected = null();
HXLINE( 263)		if ((Objects->length != 0)) {
HXLINE( 265)			if (::hx::IsNull( WeightsArray )) {
HXLINE( 267)				::Array< Float > _g = ::Array_obj< Float >::__new(0);
HXDLIN( 267)				{
...
HXDLIN( 291)			::flixel::math::FlxRandom_obj::_arrayFloatHelper = _g3;
HXLINE( 292)			selected = Objects->__get((StartIndex + this->weightedPick(::flixel::math::FlxRandom_obj::_arrayFloatHelper))).StaticCast<  ::mikolka::vslice::freeplay::SongMenuItem >();
            		}
HXLINE( 295)		return selected;
            	}


HX_DEFINE_DYNAMIC_FUNC4(FlxRandom_obj,getObject_mikolka_vslice_freeplay_SongMenuItem,return )

void FlxRandom_obj::shuffle_substates_StickerSprite(::Array< ::Dynamic> array){
            	HX_GC_STACKFRAME(&_hx_pos_eba801adaf62ef5c_336_shuffle_substates_StickerSprite)
HXLINE( 337)		int maxValidIndex = (array->length - 1);
HXLINE( 338)		{
HXLINE( 338)			int _g = 0;
HXDLIN( 338)			int _g1 = maxValidIndex;
...
HXDLIN( 338)				int i = (_g - 1);
HXLINE( 340)				int j = this->_hx_int(i,maxValidIndex,null());
HXLINE( 341)				 ::substates::StickerSprite tmp = array->__get(i).StaticCast<  ::substates::StickerSprite >();
HXLINE( 342)				array->setCtx( HX_CTX, i,array->__get(j).StaticCast<  ::substates::StickerSprite >());
HXLINE( 343)				array->setCtx( HX_CTX, j,tmp);
            			}
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxRandom_obj,shuffle_substates_StickerSprite,(void))
...
::String FlxRandom_obj::getObject_String(::Array< ::String > Objects,::Array< Float > WeightsArray,::hx::Null< int >  __o_StartIndex, ::Dynamic EndIndex){
            		int StartIndex = __o_StartIndex.Default(0);
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_260_getObject_String)
HXLINE( 261)		::String selected = null();
HXLINE( 263)		if ((Objects->length != 0)) {
HXLINE( 265)			if (::hx::IsNull( WeightsArray )) {
HXLINE( 267)				::Array< Float > _g = ::Array_obj< Float >::__new(0);
HXDLIN( 267)				{
...
HX_DEFINE_DYNAMIC_FUNC4(FlxRandom_obj,getObject_String,return )
...
::hx::Val FlxRandom_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 15:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"getObject_String") ) { return ::hx::Val( getObject_String_dyn() ); }
	...
	case 17:
		...
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"shuffle_objects_Note") ) { return ::hx::Val( shuffle_objects_Note_dyn() ); }
	...
	case 31:
		...
		if (HX_FIELD_EQ(inName,"shuffle_substates_StickerSprite") ) { return ::hx::Val( shuffle_substates_StickerSprite_dyn() ); }
		break;
	case 38:
		if (HX_FIELD_EQ(inName,"getObject_flixel_group_FlxTypedGroup_T") ) { return ::hx::Val( getObject_flixel_group_FlxTypedGroup_T_dyn() ); }
		break;
	case 46:
		if (HX_FIELD_EQ(inName,"getObject_mikolka_vslice_freeplay_SongMenuItem") ) { return ::hx::Val( getObject_mikolka_vslice_freeplay_SongMenuItem_dyn() ); }
	}
...
static ::String FlxRandom_obj_sMemberFields[] = {
	...
	HX_("shuffle_objects_Note",e3,bb,f4,10),
	HX_("getObject_flixel_sound_FlxSound",86,7e,c9,c9),
	HX_("getObject_mikolka_vslice_freeplay_SongMenuItem",6a,62,0f,88),
	HX_("shuffle_substates_StickerSprite",7f,c8,23,7d),
	HX_("getObject_Array_String",01,58,9d,f8),
	HX_("getObject_String",3b,bf,cb,3f),
