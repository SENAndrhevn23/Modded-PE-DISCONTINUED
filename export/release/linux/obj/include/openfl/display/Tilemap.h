...
class HXCPP_CLASS_ATTRIBUTES Tilemap_obj : public  ::openfl::display::DisplayObject_obj
{
	...
	public:
		...
		inline  ::openfl::display::TileContainer _hx_set__hx___group(::hx::StackContext *_hx_ctx, ::openfl::display::TileContainer _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___group=_hx_v; }
		...
		inline  ::openfl::display::_internal::Context3DBuffer _hx_set__hx___buffer(::hx::StackContext *_hx_ctx, ::openfl::display::_internal::Context3DBuffer _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___buffer=_hx_v; }
