...
class HXCPP_CLASS_ATTRIBUTES FloatMap_obj : public ::hx::Object
{
	...
	public:
		...
		inline ::cpp::VirtualArray _hx_set_floatKeys(::hx::StackContext *_hx_ctx,::cpp::VirtualArray _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return floatKeys=_hx_v; }
		::cpp::VirtualArray values;
		inline ::cpp::VirtualArray _hx_set_values(::hx::StackContext *_hx_ctx,::cpp::VirtualArray _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return values=_hx_v; }
		void clear();
		::Dynamic clear_dyn();
