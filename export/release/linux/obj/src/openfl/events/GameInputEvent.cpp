...
void GameInputEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable, ::openfl::ui::GameInputDevice device){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_a9944c00dfbe9396_40_new)
HXLINE(  41)		super::__construct(type,bubbles,cancelable);
HXLINE(  43)		this->_hx_set_device(HX_CTX, device);
            	}
...
HXLINE(  49)		event->_hx_set_target(HX_CTX, this->target);
HXLINE(  50)		event->_hx_set_currentTarget(HX_CTX, this->currentTarget);
...
void GameInputEvent_obj::_hx___init(){
            	HX_GC_STACKFRAME(&_hx_pos_a9944c00dfbe9396_61___init)
HXLINE(  62)		this->super::_hx___init();
HXLINE(  63)		this->_hx_set_device(HX_CTX, null());
            	}
...
::hx::Val GameInputEvent_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"device") ) { _hx_set_device(HX_CTX_GET,inValue.Cast<  ::openfl::ui::GameInputDevice >()); return inValue; }
	}
