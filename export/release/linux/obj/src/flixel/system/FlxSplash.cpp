...
void FlxSplash_obj::__construct( ::Dynamic nextState){
            	HX_GC_STACKFRAME(&_hx_pos_0cd566ad6ef5d750_17_new)
HXLINE(  31)		this->_curPart = 0;
HXLINE(  40)		super::__construct();
HXLINE(  41)		this->_hx_set_nextState(HX_CTX, nextState);
            	}
...
HXLINE(  60)		this->_hx_set__times(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_1ea84f6c_3,5));
HXLINE(  61)		this->_hx_set__colors(HX_CTX, ::Array_obj< int >::fromData( _hx_array_data_1ea84f6c_4,5));
HXLINE(  62)		this->_hx_set__functions(HX_CTX, ::Array_obj< ::Dynamic>::__new(5)->init(0,this->drawGreen_dyn())->init(1,this->drawYellow_dyn())->init(2,this->drawRed_dyn())->init(3,this->drawBlue_dyn())->init(4,this->drawLightBlue_dyn()));
HXLINE(  64)		{
HXLINE(  64)			int _g = 0;
...
HXLINE(  72)		this->_hx_set__sprite(HX_CTX,  ::openfl::display::Sprite_obj::__alloc( HX_CTX ));
HXLINE(  73)		::openfl::Lib_obj::get_current()->stage->addChild(this->_sprite);
HXLINE(  74)		this->_hx_set__gfx(HX_CTX, this->_sprite->get_graphics());
HXLINE(  76)		this->_hx_set__text(HX_CTX,  ::openfl::text::TextField_obj::__alloc( HX_CTX ));
...
HXLINE(  80)		dtf->_hx_set_align(HX_CTX, 0);
...
void FlxSplash_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_0cd566ad6ef5d750_96_destroy)
HXLINE(  97)		this->_hx_set__sprite(HX_CTX, null());
HXLINE(  98)		this->_hx_set__gfx(HX_CTX, null());
HXLINE(  99)		this->_hx_set__text(HX_CTX, null());
HXLINE( 100)		this->_hx_set__times(HX_CTX, null());
HXLINE( 101)		this->_hx_set__colors(HX_CTX, null());
HXLINE( 102)		this->_hx_set__functions(HX_CTX, null());
...
HXDLIN( 108)		if (_hx_tmp) {
            			...
            			void _hx_run(){
            				HX_GC_STACKFRAME(&_hx_pos_0cd566ad6ef5d750_108_complete)
HXDLIN( 108)				if (::hx::IsInstanceEq( ::flixel::FlxG_obj::game->_state,stateOnCall )) {
HXDLIN( 108)					::flixel::FlxG_obj::game->_hx_set__nextState(HX_CTX, nextState);
            				}
            				else {
...
::hx::Val FlxSplash_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"_gfx") ) { _hx_set__gfx(HX_CTX_GET,inValue.Cast<  ::openfl::display::Graphics >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"_text") ) { _hx_set__text(HX_CTX_GET,inValue.Cast<  ::openfl::text::TextField >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"_times") ) { _hx_set__times(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"_sprite") ) { _hx_set__sprite(HX_CTX_GET,inValue.Cast<  ::openfl::display::Sprite >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_colors") ) { _hx_set__colors(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"_curPart") ) { _curPart=inValue.Cast< int >(); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"nextState") ) { _hx_set_nextState(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"_functions") ) { _hx_set__functions(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 14:
