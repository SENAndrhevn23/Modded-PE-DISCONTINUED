...
HXLINE(  23)		this->_hx_set_handle(HX_CTX,  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,1,true,-14540254),null(),null()));
...
::hx::Val CompletionListScrollBar_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"handle") ) { _hx_set_handle(HX_CTX_GET,inValue.Cast<  ::openfl::display::Bitmap >()); return inValue; }
	}
