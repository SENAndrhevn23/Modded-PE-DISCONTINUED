...
class HXCPP_CLASS_ATTRIBUTES AbstractNoise_obj : public ::hx::Object
{
	...
	public:
		...
		inline ::Array< Float > _hx_set_octaves_frequencies(::hx::StackContext *_hx_ctx,::Array< Float > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return octaves_frequencies=_hx_v; }
		::Array< Float > octaves_persistences;
		inline ::Array< Float > _hx_set_octaves_persistences(::hx::StackContext *_hx_ctx,::Array< Float > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return octaves_persistences=_hx_v; }
