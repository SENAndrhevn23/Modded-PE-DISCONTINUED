...
HXDLIN( 151)		this->_hx_set__hx___ownedWindows(HX_CTX,  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,length,fixed,array,true));
HXLINE( 150)		this->_hx___active = false;
HXLINE( 144)		this->_hx___closed = false;
HXLINE( 172)		super::__construct(null());
HXLINE( 173)		this->_hx_set__hx___initOptions(HX_CTX, initOptions);
HXLINE( 174)		if (::hx::IsNotNull( this->_hx___initOptions->_hx___window )) {
HXLINE( 176)			this->_hx_set__hx___window(HX_CTX, this->_hx___initOptions->_hx___window);
HXLINE( 182)			::openfl::desktop::NativeApplication_obj::get_nativeApplication()->_hx_set__hx___activeWindow(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
            		}
            		else {
...
HXLINE( 187)			this->_hx_set__hx___window(HX_CTX, Dynamic( app->createWindow( ::Dynamic(::hx::Anon_obj::Create(12)
...
HXLINE( 215)		this->_hx_set__hx___previousDisplayState(HX_CTX, 0);
HXLINE( 216)		this->_hx___window->stage->_hx_set_nativeWindow(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
...
HXLINE( 576)		return !(this->_hx___window->_hx___hidden);
            	}
...
HXLINE(1099)		::openfl::desktop::NativeApplication_obj::get_nativeApplication()->_hx_set__hx___activeWindow(HX_CTX, ::hx::ObjectPtr<OBJ_>(this));
...
HXLINE(1111)			::openfl::desktop::NativeApplication_obj::get_nativeApplication()->_hx_set__hx___activeWindow(HX_CTX, null());
...
HXLINE(1141)		this->_hx_set__hx___previousDisplayState(HX_CTX, afterDisplayState);
...
HXLINE(1150)		this->_hx_set__hx___previousDisplayState(HX_CTX, afterDisplayState);
...
HXLINE(1159)		this->_hx_set__hx___previousDisplayState(HX_CTX, afterDisplayState);
...
::hx::Val NativeWindow_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"__window") ) { _hx_set__hx___window(HX_CTX_GET,inValue.Cast<  ::openfl::display::Window >()); return inValue; }
	...
	case 11:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"__initOptions") ) { _hx_set__hx___initOptions(HX_CTX_GET,inValue.Cast<  ::openfl::display::NativeWindowInitOptions >()); return inValue; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"__ownedWindows") ) { _hx_set__hx___ownedWindows(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::ObjectVector >()); return inValue; }
		break;
	case 15:
	...
	case 16:
		...
		break;
	case 22:
		if (HX_FIELD_EQ(inName,"__previousDisplayState") ) { _hx_set__hx___previousDisplayState(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
