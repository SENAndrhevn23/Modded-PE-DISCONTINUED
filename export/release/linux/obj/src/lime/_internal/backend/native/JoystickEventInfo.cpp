...
HX_DEFINE_STACK_FRAME(_hx_pos_21cd05885e6e0032_775_new,"lime._internal.backend.native.JoystickEventInfo","new",0x6a2decec,"lime._internal.backend.native.JoystickEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",775,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_21cd05885e6e0032_786_clone,"lime._internal.backend.native.JoystickEventInfo","clone",0x72666ae9,"lime._internal.backend.native.JoystickEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",786,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void JoystickEventInfo_obj::__construct( ::Dynamic type,::hx::Null< int >  __o_id,::hx::Null< int >  __o_index,::hx::Null< int >  __o_value,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_21cd05885e6e0032_775_new)
HXLINE( 776)		this->type = ( (int)(type) );
HXLINE( 777)		this->id = id;
HXLINE( 778)		this->index = index;
HXLINE( 779)		this->eventValue = value;
HXLINE( 780)		this->x = x;
HXLINE( 781)		this->y = y;
            	}
...
bool JoystickEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::JoystickEventInfo JoystickEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_21cd05885e6e0032_786_clone)
HXDLIN( 786)		return  ::lime::_internal::backend::native::JoystickEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->index,this->eventValue,this->x,this->y);
            	}
