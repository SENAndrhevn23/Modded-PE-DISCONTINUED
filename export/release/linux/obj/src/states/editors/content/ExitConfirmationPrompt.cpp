...
HXDLIN(  14)			 ::openfl::media::Sound _hx_tmp1 = ::backend::Paths_obj::returnSound((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)),null(),true,null());
HXDLIN(  14)			_hx_tmp->playMusic(_hx_tmp1,::backend::ClientPrefs_obj::data->bgmVolume,null(),null());
