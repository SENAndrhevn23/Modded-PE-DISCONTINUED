...
class HXCPP_CLASS_ATTRIBUTES CustomFadeTransition_obj : public  ::flixel::FlxSubState_obj
{
	public:
	...
	public:
		...
		inline  ::flixel::FlxSprite _hx_set_transBlack(::hx::StackContext *_hx_ctx, ::flixel::FlxSprite _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return transBlack=_hx_v; }
		 ::flixel::FlxSprite transGradient;
		inline  ::flixel::FlxSprite _hx_set_transGradient(::hx::StackContext *_hx_ctx, ::flixel::FlxSprite _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return transGradient=_hx_v; }
		Float duration;
		void create();
