...
HXLINE( 267)				::Reflect_obj::setField(swagSong,HX_("generatedBy",46,6b,37,46),((HX_("H-Slice - PE v",f1,46,ef,87) + ::states::MainMenuState_obj::psychEngineVersion) + HX_(" - Chart Editor V-Slice Importer",35,f1,ba,c7)));
...
HXLINE( 332)		::String generatedBy = ((HX_("H-Slice - PE v",f1,46,ef,87) + ::states::MainMenuState_obj::psychEngineVersion) + HX_(" - Chart Editor V-Slice Exporter",04,43,5d,ac));
...
HXDLIN( 398)						 ::EReg hideChars =  ::EReg_obj::__alloc( HX_CTX ,HX_("[,'\"%?!]",e2,95,ce,be),HX_("g",67,00,00,00));
...
HXDLIN( 398)						diffs1->setCtx( HX_CTX, num,diff);
...
HXDLIN( 405)				::backend::Language_obj::phraseStr = ( ( ::haxe::ds::StringMap)(this1) )->get_string(::StringTools_obj::trim(hideChars1->replace(::StringTools_obj::replace(key,HX_(" ",20,00,00,00),HX_("_",5f,00,00,00)),HX_("",00,00,00,00)).toLowerCase()));
HXDLIN( 405)				if (::hx::IsNull( ::backend::Language_obj::phraseStr )) {
HXLINE( 405)					::backend::Language_obj::phraseStr = diffName1;
            				}
HXDLIN( 405)				if (::hx::IsNull( ::backend::Language_obj::phraseStr )) {
HXLINE( 405)					::backend::Language_obj::phraseStr = key;
            				}
HXDLIN( 405)				if (::hx::IsNotNull( values )) {
...
HXDLIN( 405)						::backend::Language_obj::phraseStr = ::StringTools_obj::replace(::backend::Language_obj::phraseStr,((HX_("{",7b,00,00,00) + (num2 + 1)) + HX_("}",7d,00,00,00)),( (::String)(value) ));
            					}
            				}
HXDLIN( 405)				diff1 = ::backend::Language_obj::phraseStr;
            			}
            			else {
...
HXDLIN( 407)			 ::EReg hideChars2 =  ::EReg_obj::__alloc( HX_CTX ,HX_("[,'\"%?!]",e2,95,ce,be),HX_("g",67,00,00,00));
