...
void CairoTilemap_obj::render( ::openfl::display::Tilemap tilemap, ::openfl::display::CairoRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_577544eec98749ac_35_render)
...
HXLINE(  48)		::openfl::display::_internal::CairoTilemap_obj::renderTileContainer(tilemap1,renderer,tilemap2,tilemap3,_hx_tmp1,tilemap4,alpha,tilemap5,tilemap6,null(),null(),null(),rect,::lime::math::_Matrix3::Matrix3_Impl__obj::_new(null(),null(),null(),null(),null(),null()));
