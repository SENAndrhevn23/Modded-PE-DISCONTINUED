...
void ByteArrayData_obj::__construct(::hx::Null< int >  __o_length){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_1129_new)
...
HXDLIN(1149)			this->_hx_set__hx___endian(HX_CTX, ::openfl::utils::ByteArrayData_obj::_hx___defaultEndian);
            		}
...
void ByteArrayData_obj::compress( ::Dynamic __o_algorithm){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_1161_compress)
...
HXLINE(1186)			{
HXLINE(1186)				this->_hx_set_b(HX_CTX, bytes->b);
...
void ByteArrayData_obj::uncompress( ::Dynamic __o_algorithm){
            		 ::Dynamic algorithm = __o_algorithm;
            		if (::hx::IsNull(__o_algorithm)) algorithm = 2;
            	HX_GC_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_1543_uncompress)
...
HXLINE(1568)			{
HXLINE(1568)				this->_hx_set_b(HX_CTX, bytes->b);
...
void ByteArrayData_obj::_hx___fromBytes( ::haxe::io::Bytes bytes){
            	HX_GC_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_1724___fromBytes)
HXLINE(1725)		{
HXLINE(1725)			this->_hx_set_b(HX_CTX, bytes->b);
...
void ByteArrayData_obj::_hx___resize(int size){
            	HX_GC_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_1730___resize)
...
HXLINE(1746)			{
HXLINE(1746)				this->_hx_set_b(HX_CTX, bytes->b);
...
void ByteArrayData_obj::_hx___setData( ::haxe::io::Bytes bytes){
            	HX_GC_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_1756___setData)
HXLINE(1764)		this->_hx_set_b(HX_CTX, bytes->b);
...
HX_DEFINE_DYNAMIC_FUNC0(ByteArrayData_obj,get_endian,return )
 ...
 ::Dynamic ByteArrayData_obj::set_endian( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_dd5cdbe7a8b93fcc_1815_set_endian)
HXDLIN(1815)		return (this->_hx_set__hx___endian(HX_CTX, value));
            	}
...
::hx::Val ByteArrayData_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"__endian") ) { _hx_set__hx___endian(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
