...
HXLINE(  63)				_library->_hx_set__hx___proxy(HX_CTX, library);
...
HXLINE( 108)				_library->_hx_set__hx___proxy(HX_CTX, library);
...
::hx::Val AssetLibrary_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"__proxy") ) { _hx_set__hx___proxy(HX_CTX_GET,inValue.Cast<  ::lime::utils::AssetLibrary >()); return inValue; }
	}
