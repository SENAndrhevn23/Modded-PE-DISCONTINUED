...
::String InputFormatter_obj::getKeyName(int key){
            	HX_GC_STACKFRAME(&_hx_pos_14feba4c8d15a5ff_10_getKeyName)
...
HXDLIN(  98)						arr->setCtx( HX_CTX, i,(_hx_tmp + text.substr(1,null()).toLowerCase()));
            					}
            				}
...
::String InputFormatter_obj::getGamepadName(int key){
            	HX_GC_STACKFRAME(&_hx_pos_14feba4c8d15a5ff_104_getGamepadName)
...
HXDLIN( 223)						arr->setCtx( HX_CTX, i,(_hx_tmp + text.substr(1,null()).toLowerCase()));
            					}
            				}
