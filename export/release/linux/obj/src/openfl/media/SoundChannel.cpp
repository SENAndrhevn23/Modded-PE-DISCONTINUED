...
HXLINE( 119)		this->_hx_set__hx___sound(HX_CTX, sound);
HXLINE( 121)		this->leftPeak = ( (Float)(1) );
HXLINE( 122)		this->rightPeak = ( (Float)(1) );
HXLINE( 124)		if (::hx::IsNotNull( soundTransform )) {
HXLINE( 126)			this->_hx_set__hx___soundTransform(HX_CTX, soundTransform);
            		}
            		else {
HXLINE( 130)			this->_hx_set__hx___soundTransform(HX_CTX,  ::openfl::media::SoundTransform_obj::__alloc( HX_CTX ,null(),null()));
            		}
...
void SoundChannel_obj::stop(){
            	HX_GC_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_142_stop)
...
HXLINE( 164)			this->_hx_set__hx___emptyBuffers(HX_CTX, null());
HXLINE( 165)			this->_hx_set__hx___alSource(HX_CTX, null());
            		}
...
void SoundChannel_obj::_hx___dispose(){
            	HX_GC_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_176___dispose)
...
HXLINE( 182)		this->_hx_set__hx___audioSource(HX_CTX, null());
...
HXLINE( 223)			this->_hx_set__hx___sampleDataEvent(HX_CTX,  ::openfl::events::SampleDataEvent_obj::__alloc( HX_CTX ,HX_("sampleData",74,3f,0b,5e),null(),null()));
...
HXLINE( 239)				this->_hx_set__hx___alSource(HX_CTX, alAudioContext->createSource());
...
HXLINE( 244)				this->_hx_set__hx___alBuffers(HX_CTX, alAudioContext->genBuffers(this->_hx___numberOfBuffers));
HXLINE( 245)				this->_hx_set__hx___outputBuffer(HX_CTX,  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,0));
...
HXDLIN( 246)						_this->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this->byteLength));
...
HXDLIN( 246)							_this1->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(_this1->byteLength));
...
HXDLIN( 246)									_this2->_hx_set_buffer(HX_CTX, ::haxe::io::Bytes_obj::alloc(cloneLength));
...
HXDLIN( 246)									_this3->_hx_set_buffer(HX_CTX, buffer);
...
HXDLIN( 246)				this->_hx_set__hx___bufferView(HX_CTX, this1);
HXLINE( 248)				{
HXLINE( 248)					int _g = 0;
...
void SoundChannel_obj::_hx___initAudioSource( ::lime::media::AudioSource audioSource){
            	HX_GC_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_279___initAudioSource)
HXLINE( 281)		this->_hx_set__hx___audioSource(HX_CTX, audioSource);
...
HXLINE( 400)				this->_hx_set__hx___emptyBuffers(HX_CTX, alAudioContext->sourceUnqueueBuffers(this->_hx___alSource,bufferState));
HXLINE( 401)				{
HXLINE( 401)					int _g = 0;
...
::hx::Val SoundChannel_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"__sound") ) { _hx_set__hx___sound(HX_CTX_GET,inValue.Cast<  ::openfl::media::Sound >()); return inValue; }
		break;
	case 8:
	...
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"__alSource") ) { _hx_set__hx___alSource(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"__alBuffers") ) { _hx_set__hx___alBuffers(HX_CTX_GET,inValue.Cast< ::cpp::VirtualArray >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"__bufferView") ) { _hx_set__hx___bufferView(HX_CTX_GET,inValue.Cast<  ::lime::utils::ArrayBufferView >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"__audioSource") ) { _hx_set__hx___audioSource(HX_CTX_GET,inValue.Cast<  ::lime::media::AudioSource >()); return inValue; }
		break;
	case 14:
		...
		if (HX_FIELD_EQ(inName,"__outputBuffer") ) { _hx_set__hx___outputBuffer(HX_CTX_GET,inValue.Cast<  ::openfl::utils::ByteArrayData >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__emptyBuffers") ) { _hx_set__hx___emptyBuffers(HX_CTX_GET,inValue.Cast< ::cpp::VirtualArray >()); return inValue; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"__soundTransform") ) { _hx_set__hx___soundTransform(HX_CTX_GET,inValue.Cast<  ::openfl::media::SoundTransform >()); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"__sampleDataEvent") ) { _hx_set__hx___sampleDataEvent(HX_CTX_GET,inValue.Cast<  ::openfl::events::SampleDataEvent >()); return inValue; }
