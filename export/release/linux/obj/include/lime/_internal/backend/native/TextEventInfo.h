...
HX_DECLARE_STACK_FRAME(_hx_pos_48b909785036aaec_925_new)
...
HXLINE( 926)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 927)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->windowID = windowID;
HXLINE( 928)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->_hx_set_text(HX_CTX, text);
HXLINE( 929)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->start = start;
HXLINE( 930)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->length = length;
            	}
