...
HXLINE( 285)		this->_hx_set__hx___colors(HX_CTX, colors);
HXLINE( 286)		this->_hx_set__hx___alphas(HX_CTX, alphas);
HXLINE( 287)		this->_hx_set__hx___ratios(HX_CTX, ratios);
...
HXLINE( 292)		this->_hx_set__hx___type(HX_CTX, type);
HXLINE( 293)		this->_hx___knockout = knockout;
HXLINE( 294)		this->_hx_set__hx___colorFadeArr(HX_CTX,  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,0));
...
HXDLIN( 311)		return  ::flxanimate::filters::GradientGlowFilter_obj::__alloc( HX_CTX ,this->_hx___distance,this->_hx___angle,this->_hx___colors,this->_hx___alphas,this->_hx___ratios,this->_hx___blurX,this->_hx___blurY,this->_hx___strength,this->_hx___quality,this->_hx___type,this->_hx___knockout);
 ...
 ::openfl::display::Shader GradientBevelFilter_obj::_hx___initShader( ::openfl::display::DisplayObjectRenderer renderer,int pass, ::openfl::display::BitmapData sourceBitmapData){
            	HX_GC_STACKFRAME(&_hx_pos_00badf6175ae6572_316___initShader)
...
HXLINE( 335)			shader->uColor->_hx_set_value(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_08679cf0_4,4));
...
HXLINE( 345)			shader1->colorGradient->_hx_set_input(HX_CTX, ::flxanimate::filters::GradientGlowFilter_obj::_hx___colorFadeBmp);
...
HXLINE( 391)				shader2->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 398)			shader3->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 375)				shader4->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 381)			shader5->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 359)				shader6->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
HXLINE( 365)			shader7->sourceBitmap->_hx_set_input(HX_CTX, sourceBitmapData);
...
::Array< Float > GradientBevelFilter_obj::set_alphas(::Array< Float > value){
            	HX_GC_STACKFRAME(&_hx_pos_00badf6175ae6572_484_set_alphas)
HXLINE( 485)		if (::hx::IsPointerNotEq( value,this->_hx___alphas )) {
HXLINE( 487)			this->_hx_set__hx___alphas(HX_CTX, value);
...
::Array< int > GradientBevelFilter_obj::set_colors(::Array< int > value){
            	HX_GC_STACKFRAME(&_hx_pos_00badf6175ae6572_548_set_colors)
HXLINE( 549)		if (::hx::IsPointerNotEq( value,this->_hx___colors )) {
HXLINE( 551)			this->_hx_set__hx___colors(HX_CTX, value);
...
::Array< int > GradientBevelFilter_obj::set_ratios(::Array< int > value){
            	HX_GC_STACKFRAME(&_hx_pos_00badf6175ae6572_602_set_ratios)
HXLINE( 603)		if (::hx::IsPointerNotEq( value,this->_hx___ratios )) {
HXLINE( 605)			this->_hx_set__hx___ratios(HX_CTX, value);
...
::String GradientBevelFilter_obj::set_type(::String value){
            	HX_GC_STACKFRAME(&_hx_pos_00badf6175ae6572_629_set_type)
HXLINE( 630)		if ((value != this->_hx___type)) {
HXLINE( 632)			this->_hx_set__hx___type(HX_CTX, value);
...
::hx::Val GradientBevelFilter_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"__alphas") ) { _hx_set__hx___alphas(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__colors") ) { _hx_set__hx___colors(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__ratios") ) { _hx_set__hx___ratios(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		break;
	case 9:
	...
	case 10:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"__colorFadeArr") ) { _hx_set__hx___colorFadeArr(HX_CTX_GET,inValue.Cast<  ::openfl::utils::ByteArrayData >()); return inValue; }
		break;
	case 16:
