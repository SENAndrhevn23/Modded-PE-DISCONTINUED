...
void LogFrontEnd_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_ba09e0c9e62cea6b_11_new)
HXLINE(  16)		this->redirectTraces = false;
HXLINE(  97)		this->_hx_set__standardTraceFunction(HX_CTX, ::haxe::Log_obj::trace);
            	}
...
::hx::Val LogFrontEnd_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 14:
		...
		break;
	case 22:
		if (HX_FIELD_EQ(inName,"_standardTraceFunction") ) { _hx_set__standardTraceFunction(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
