...
class HXCPP_CLASS_ATTRIBUTES AGALMiniAssembler_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::openfl::utils::ByteArrayData _hx_set_agalcode(::hx::StackContext *_hx_ctx, ::openfl::utils::ByteArrayData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return agalcode=_hx_v; }
		::String error;
		inline ::String _hx_set_error(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return error=_hx_v; }
		bool verbose;
		bool debugEnabled;
