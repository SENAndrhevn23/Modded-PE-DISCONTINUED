...
void CURLMulti_obj::__construct( ::Dynamic handle){
            	HX_GC_STACKFRAME(&_hx_pos_fb515ac759b1a1a7_25_new)
HXDLIN(  25)		if (::hx::IsNotNull( handle )) {
HXLINE(  27)			this->_hx_set_handle(HX_CTX, handle);
            		}
            		else {
HXLINE(  32)			this->_hx_set_handle(HX_CTX, ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_curl_multi_init()) ));
            		}
            	}
