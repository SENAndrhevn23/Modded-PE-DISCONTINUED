...
HXLINE(  99)		this->_hx_set_blendMode(HX_CTX, 10);
HXLINE(  91)		this->_curFrame = 0;
HXLINE(  83)		this->firstFrame = 0;
HXLINE( 135)		this->_hx_set_name(HX_CTX, name);
HXLINE( 136)		this->_hx_set_instance(HX_CTX, instance);
HXLINE( 137)		this->set_type(type);
HXLINE( 138)		this->set_loop(loop);
HXLINE( 139)		this->set_firstFrame(0);
HXLINE( 140)		this->_hx_set_transformationPoint(HX_CTX,  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) )));
...
HXLINE( 144)		this->_hx_set_cacheAsBitmapMatrix(HX_CTX,  ::flixel::math::FlxMatrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
HXLINE( 145)		this->_hx_set__filterMatrix(HX_CTX,  ::flixel::math::FlxMatrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null()));
            	}
...
void SymbolParameters_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_a5b45c946faf294d_149_destroy)
HXLINE( 150)		this->_hx_set_instance(HX_CTX, null());
HXLINE( 151)		this->set_type(null());
HXLINE( 152)		this->reverse = false;
HXLINE( 153)		this->set_firstFrame(0);
HXLINE( 154)		this->_hx_set_name(HX_CTX, null());
HXLINE( 155)		this->set_colorEffect(null());
HXLINE( 156)		this->_hx_set_transformationPoint(HX_CTX, null());
HXLINE( 158)		if (::hx::IsNotNull( this->_filterFrame )) {
HXLINE( 159)			::flixel::FlxG_obj::bitmap->remove(this->_filterFrame->parent);
            		}
HXLINE( 161)		this->_hx_set__filterFrame(HX_CTX, ( ( ::flixel::graphics::frames::FlxFrame)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_filterFrame)) ));
HXLINE( 162)		this->_hx_set__filterCamera(HX_CTX, ( ( ::flixel::FlxCamera)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_filterCamera)) ));
HXLINE( 163)		this->_hx_set__filterMatrix(HX_CTX, null());
...
HXLINE( 165)		this->_hx_set__bmp1(HX_CTX, ::flixel::util::FlxDestroyUtil_obj::dispose(this->_bmp1));
...
HXLINE( 167)		this->_hx_set__bmp2(HX_CTX, ::flixel::util::FlxDestroyUtil_obj::dispose(this->_bmp2));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SymbolParameters_obj,destroy,(void))
 ...
 ::flxanimate::data::SymbolT SymbolParameters_obj::set_type( ::flxanimate::data::SymbolT type){
            	HX_GC_STACKFRAME(&_hx_pos_a5b45c946faf294d_171_set_type)
HXLINE( 172)		this->_hx_set_type(HX_CTX, type);
...
HX_DEFINE_DYNAMIC_FUNC1(SymbolParameters_obj,update,(void))
 ...
 ::flxanimate::data::Loop SymbolParameters_obj::set_loop( ::flxanimate::data::Loop loop){
            	HX_GC_STACKFRAME(&_hx_pos_a5b45c946faf294d_211_set_loop)
HXLINE( 212)		if (::hx::IsNull( this->type )) {
HXLINE( 212)			return (this->_hx_set_loop(HX_CTX, null()));
            		}
...
HXDLIN( 213)		this->_hx_set_loop(HX_CTX, _hx_tmp);
...
void SymbolParameters_obj::reset(){
            	HX_GC_STACKFRAME(&_hx_pos_a5b45c946faf294d_235_reset)
HXLINE( 236)		this->_hx_set_name(HX_CTX, null());
...
HXLINE( 239)		this->_hx_set_instance(HX_CTX, HX_("",00,00,00,00));
...
HX_DEFINE_DYNAMIC_FUNC0(SymbolParameters_obj,get__colorEffect,return )
 ...
 ::flxanimate::effects::FlxColorEffect SymbolParameters_obj::set_colorEffect( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_a5b45c946faf294d_251_set_colorEffect)
...
HXLINE( 260)			this->_hx_set_colorEffect(HX_CTX, ::flxanimate::data::AnimationData_obj::parseColorEffect(value));
            		}
            		else {
HXLINE( 263)			this->_hx_set_colorEffect(HX_CTX, ( ( ::flxanimate::effects::FlxColorEffect)(value) ));
            		}
...
::Array< ::Dynamic> SymbolParameters_obj::set_filters(::Array< ::Dynamic> filters){
            	HX_GC_STACKFRAME(&_hx_pos_a5b45c946faf294d_269_set_filters)
...
HXLINE( 293)					this->_hx_set__filterFrame(HX_CTX, ( ( ::flixel::graphics::frames::FlxFrame)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_filterFrame)) ));
...
HXLINE( 295)					this->_hx_set__bmp1(HX_CTX, ::flixel::util::FlxDestroyUtil_obj::dispose(this->_bmp1));
...
HXLINE( 297)					this->_hx_set__bmp2(HX_CTX, ::flixel::util::FlxDestroyUtil_obj::dispose(this->_bmp2));
            				}
            			}
            		}
HXLINE( 301)		return (this->_hx_set_filters(HX_CTX, filters));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(SymbolParameters_obj,set_filters,return )
 ...
 ::Dynamic SymbolParameters_obj::set_blendMode( ::Dynamic value){
            	HX_GC_STACKFRAME(&_hx_pos_a5b45c946faf294d_305_set_blendMode)
HXLINE( 306)		if (::hx::IsNull( value )) {
HXLINE( 307)			value = 10;
            		}
HXLINE( 309)		if (::hx::IsPointerEq( this->type,::flxanimate::data::SymbolT_obj::Graphic_dyn() )) {
HXLINE( 309)			return (this->_hx_set_blendMode(HX_CTX, 10));
            		}
HXLINE( 311)		if (::hx::IsNotEq( this->blendMode,value )) {
HXLINE( 313)			this->_hx_set_blendMode(HX_CTX, value);
...
HXLINE( 346)				this->_hx_set__filterFrame(HX_CTX,  ::flixel::graphics::frames::FlxFrame_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null()));
            			}
HXLINE( 349)			 ::flixel::_hx_system::frontEnds::BitmapFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::bitmap;
HXDLIN( 349)			this->_filterFrame->_hx_set_parent(HX_CTX, _hx_tmp3->add( ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,::Math_obj::ceil(wid),::Math_obj::ceil(hei),null(),0),null(),null()));
HXLINE( 350)			this->_hx_set__bmp1(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,::Math_obj::ceil(wid),::Math_obj::ceil(hei),null(),0));
HXLINE( 351)			::flixel::graphics::FlxGraphic_obj::fromBitmapData(this->_bmp1,null(),null(),null());
HXLINE( 352)			if (this->_needSecondBmp) {
HXLINE( 354)				this->_hx_set__bmp2(HX_CTX,  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,::Math_obj::ceil(wid),::Math_obj::ceil(hei),null(),0));
...
HXLINE( 372)					this->_hx_set__bmp2(HX_CTX, null());
            				}
            			}
            		}
...
::hx::Val SymbolParameters_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"type") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_type(inValue.Cast<  ::flxanimate::data::SymbolT >()) );_hx_set_type(HX_CTX_GET,inValue.Cast<  ::flxanimate::data::SymbolT >()); return inValue; }
		if (HX_FIELD_EQ(inName,"loop") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_loop(inValue.Cast<  ::flxanimate::data::Loop >()) );_hx_set_loop(HX_CTX_GET,inValue.Cast<  ::flxanimate::data::Loop >()); return inValue; }
		if (HX_FIELD_EQ(inName,"name") ) { _hx_set_name(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"_bmp1") ) { _hx_set__bmp1(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_bmp2") ) { _hx_set__bmp2(HX_CTX_GET,inValue.Cast<  ::openfl::display::BitmapData >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"_parent") ) { _hx_set__parent(HX_CTX_GET,inValue.Cast<  ::flxanimate::animate::FlxElement >()); return inValue; }
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"instance") ) { _hx_set_instance(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"_curFrame") ) { _curFrame=inValue.Cast< int >(); return inValue; }
		if (HX_FIELD_EQ(inName,"blendMode") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_blendMode(inValue.Cast<  ::Dynamic >()) );_hx_set_blendMode(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 10:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"colorEffect") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_colorEffect(inValue.Cast<  ::flxanimate::effects::FlxColorEffect >()) );_hx_set_colorEffect(HX_CTX_GET,inValue.Cast<  ::flxanimate::effects::FlxColorEffect >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"_filterFrame") ) { _hx_set__filterFrame(HX_CTX_GET,inValue.Cast<  ::flixel::graphics::frames::FlxFrame >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_renderDirty") ) { _renderDirty=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_colorEffect") ) { _hx_set__colorEffect(HX_CTX_GET,inValue.Cast<  ::openfl::geom::ColorTransform >()); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"_filterCamera") ) { _hx_set__filterCamera(HX_CTX_GET,inValue.Cast<  ::flixel::FlxCamera >()); return inValue; }
	...
	case 14:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"transformationPoint") ) { _hx_set_transformationPoint(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxBasePoint >()); return inValue; }
		if (HX_FIELD_EQ(inName,"cacheAsBitmapMatrix") ) { _hx_set_cacheAsBitmapMatrix(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxMatrix >()); return inValue; }
	}
