...
HX_DEFINE_STACK_FRAME(_hx_pos_cef4a471e9b9c478_808_new,"lime._internal.backend.native.KeyEventInfo","new",0x84b8978d,"lime._internal.backend.native.KeyEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",808,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_cef4a471e9b9c478_817_clone,"lime._internal.backend.native.KeyEventInfo","clone",0x44e9bfca,"lime._internal.backend.native.KeyEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",817,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void KeyEventInfo_obj::__construct( ::Dynamic type,::hx::Null< int >  __o_windowID,::hx::Null< Float >  __o_keyCode,::hx::Null< int >  __o_modifier){
            	...
            	HX_STACKFRAME(&_hx_pos_cef4a471e9b9c478_808_new)
HXLINE( 809)		this->type = ( (int)(type) );
HXLINE( 810)		this->windowID = windowID;
HXLINE( 811)		this->keyCode = keyCode;
HXLINE( 812)		this->modifier = modifier;
            	}
...
bool KeyEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::KeyEventInfo KeyEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_cef4a471e9b9c478_817_clone)
HXDLIN( 817)		return  ::lime::_internal::backend::native::KeyEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->keyCode,this->modifier);
            	}
