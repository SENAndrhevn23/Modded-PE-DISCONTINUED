...
class HXCPP_CLASS_ATTRIBUTES BMFont_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::flixel::graphics::frames::bmfont::BMFontInfo _hx_set_info(::hx::StackContext *_hx_ctx, ::flixel::graphics::frames::bmfont::BMFontInfo _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return info=_hx_v; }
		 ::flixel::graphics::frames::bmfont::BMFontCommon common;
		inline  ::flixel::graphics::frames::bmfont::BMFontCommon _hx_set_common(::hx::StackContext *_hx_ctx, ::flixel::graphics::frames::bmfont::BMFontCommon _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return common=_hx_v; }
		::Array< ::Dynamic> pages;
		inline ::Array< ::Dynamic> _hx_set_pages(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return pages=_hx_v; }
		::Array< ::Dynamic> chars;
		...
		inline ::Array< ::Dynamic> _hx_set_kerning(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return kerning=_hx_v; }
};
