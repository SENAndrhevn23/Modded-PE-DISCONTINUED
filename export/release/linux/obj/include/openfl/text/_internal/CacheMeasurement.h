...
class HXCPP_CLASS_ATTRIBUTES CacheMeasurement_obj : public ::hx::Object
{
	...
	public:
		...
		inline ::Array< ::String > _hx_set__hx___collisions(::hx::StackContext *_hx_ctx,::Array< ::String > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___collisions=_hx_v; }
		 ::haxe::ds::IntMap _hx___wordMap;
		inline  ::haxe::ds::IntMap _hx_set__hx___wordMap(::hx::StackContext *_hx_ctx, ::haxe::ds::IntMap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _hx___wordMap=_hx_v; }
		int hash;
