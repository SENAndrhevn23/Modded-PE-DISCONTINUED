			...
			*(void **)__this = ID3Info_obj::_hx_vtable;
{
		...
		::String album;
		inline ::String _hx_set_album(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return album=_hx_v; }
		::String artist;
		inline ::String _hx_set_artist(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return artist=_hx_v; }
		::String comment;
		inline ::String _hx_set_comment(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return comment=_hx_v; }
		::String genre;
		inline ::String _hx_set_genre(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return genre=_hx_v; }
		::String songName;
		inline ::String _hx_set_songName(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return songName=_hx_v; }
		::String track;
		inline ::String _hx_set_track(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return track=_hx_v; }
		::String year;
		inline ::String _hx_set_year(::hx::StackContext *_hx_ctx,::String _hx_v) { HX_OBJ_WB(this,_hx_v.raw_ref()) return year=_hx_v; }
};
