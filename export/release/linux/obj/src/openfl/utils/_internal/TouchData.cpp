...
void TouchData_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_76b1f70d22d64ab9_25_new)
HXDLIN(  25)		this->_hx_set_rollOutStack(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
            	}
...
void TouchData_obj::reset(){
            	HX_GC_STACKFRAME(&_hx_pos_76b1f70d22d64ab9_29_reset)
HXLINE(  30)		this->_hx_set_touch(HX_CTX, null());
HXLINE(  31)		this->_hx_set_touchDownTarget(HX_CTX, null());
HXLINE(  32)		this->_hx_set_touchOverTarget(HX_CTX, null());
...
::hx::Val TouchData_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"touch") ) { _hx_set_touch(HX_CTX_GET,inValue.Cast<  ::lime::ui::Touch >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"rollOutStack") ) { _hx_set_rollOutStack(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"touchDownTarget") ) { _hx_set_touchDownTarget(HX_CTX_GET,inValue.Cast<  ::openfl::display::InteractiveObject >()); return inValue; }
		if (HX_FIELD_EQ(inName,"touchOverTarget") ) { _hx_set_touchOverTarget(HX_CTX_GET,inValue.Cast<  ::openfl::display::InteractiveObject >()); return inValue; }
	}
