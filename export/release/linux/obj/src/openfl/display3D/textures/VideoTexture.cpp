...
void VideoTexture_obj::attachNetStream( ::openfl::net::NetStream netStream){
            	HX_GC_STACKFRAME(&_hx_pos_8bd748bb3c8a0c13_92_attachNetStream)
HXLINE( 100)		this->_hx___cacheTime = ( (Float)(-1) );
HXLINE( 101)		this->_hx_set__hx___netStream(HX_CTX, netStream);
...
::hx::Val VideoTexture_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"__netStream") ) { _hx_set__hx___netStream(HX_CTX_GET,inValue.Cast<  ::openfl::net::NetStream >()); return inValue; }
	}
