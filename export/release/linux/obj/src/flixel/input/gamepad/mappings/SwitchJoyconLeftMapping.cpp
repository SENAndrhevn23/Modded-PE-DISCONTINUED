...
void SwitchJoyconLeftMapping_obj::initValues(){
            	HX_GC_STACKFRAME(&_hx_pos_ff520b897dd7c849_23_initValues)
HXLINE(  24)		this->_hx_set_leftStick(HX_CTX, ::flixel::input::gamepad::id::SwitchJoyconLeftID_obj::LEFT_ANALOG_STICK);
