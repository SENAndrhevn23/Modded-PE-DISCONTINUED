...
HXLINE(  25)		this->_hx_set_data(HX_CTX,  ::haxe::ds::StringMap_obj::__alloc( HX_CTX ));
HXLINE(  26)		this->_hx_set_paths(HX_CTX, ::Array_obj< ::String >::__new());
            	}
...
::hx::Val AssetBundle_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"paths") ) { _hx_set_paths(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
	}
