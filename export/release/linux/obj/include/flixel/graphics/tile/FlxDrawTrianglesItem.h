...
class HXCPP_CLASS_ATTRIBUTES FlxDrawTrianglesItem_obj : public  ::flixel::graphics::tile::FlxDrawBaseItem_obj
{
	...
	public:
		...
		inline ::Array< Float > _hx_set_colorMultipliers(::hx::StackContext *_hx_ctx,::Array< Float > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return colorMultipliers=_hx_v; }
		::Array< Float > colorOffsets;
		inline ::Array< Float > _hx_set_colorOffsets(::hx::StackContext *_hx_ctx,::Array< Float > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return colorOffsets=_hx_v; }
		...
		inline  ::openfl::_Vector::IntVector _hx_set_colors(::hx::StackContext *_hx_ctx, ::openfl::_Vector::IntVector _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return colors=_hx_v; }
		int verticesPosition;
		int indicesPosition;
		int colorsPosition;
		 ::flixel::math::FlxRect bounds;
		inline  ::flixel::math::FlxRect _hx_set_bounds(::hx::StackContext *_hx_ctx, ::flixel::math::FlxRect _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return bounds=_hx_v; }
