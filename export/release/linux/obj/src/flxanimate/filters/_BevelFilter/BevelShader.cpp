...
void BevelShader_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_b66b193ad562e05a_591_new)
HXLINE( 182)		if (::hx::IsNull( this->_hx___glFragmentSource )) {
HXLINE( 184)			this->_hx_set__hx___glFragmentSource(HX_CTX, HX_("varying vec2 openfl_TextureCoordv;\n\n\t\tuniform sampler2D openfl_Texture;\n\t\tuniform vec2 openfl_TextureSize;\n\n\t\tuniform vec4 uColorH;\n\t\tuniform vec4 uColorS;\n\t\tuniform float uStrength;\n\t\tuniform int knockout;\n\t\tuniform sampler2D sourceBitmap;\n\t\tvarying vec4 textureCoords;\n\t\n\n\t\tvoid main(void) {\n\n\t\t\tgl_FragColor = texture2D (openfl_Texture, openfl_TextureCoordv);\n\n\t\tfloat HA = texture2D(openfl_Texture, textureCoords.zw).a * uStrength;\n\t\tfloat SA = texture2D(openfl_Texture, textureCoords.xy).a * uStrength;\n\n\t\tfloat a = SA;\n\n\n\t\tSA -= HA;\n\t\tHA -= a;\n\n\t\tSA = clamp(SA, 0., 1.);\n\t\tHA = clamp(HA, 0., 1.);\n\n\n\t\tvec4 bevel = ((uColorS * SA) + (uColorH * HA));\n\n\t\tvec4 src = texture2D(sourceBitmap, openfl_TextureCoordv);\n\t\n\n\t\t}",5f,f6,03,c5));
            		}
HXLINE( 174)		if (::hx::IsNull( this->_hx___glVertexSource )) {
HXLINE( 176)			this->_hx_set__hx___glVertexSource(HX_CTX, HX_("attribute vec4 openfl_Position;\n\t\tattribute vec2 openfl_TextureCoord;\n\n\t\tvarying vec2 openfl_TextureCoordv;\n\n\t\tuniform mat4 openfl_Matrix;\n\t\tuniform vec2 openfl_TextureSize;\n\n\t\tuniform vec2 offset;\n\t\tvarying vec4 textureCoords;\n\t\n\n\t\tvoid main(void) {\n\n\t\t\topenfl_TextureCoordv = openfl_TextureCoord;\n\n\t\tgl_Position = openfl_Matrix * openfl_Position;\ntextureCoords = vec4(openfl_TextureCoord - offset / openfl_TextureSize, openfl_TextureCoord + offset / openfl_TextureSize);\n\n\t\t}",49,a6,09,18));
            		}
HXLINE( 592)		super::__construct(null());
HXLINE( 595)		this->uColorH->_hx_set_value(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_51cf6fd6_1,4));
HXLINE( 596)		this->uColorS->_hx_set_value(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_51cf6fd6_2,4));
HXLINE( 597)		this->uStrength->_hx_set_value(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_51cf6fd6_3,1));
HXLINE( 598)		this->offset->_hx_set_value(HX_CTX, ::Array_obj< Float >::fromData( _hx_array_data_51cf6fd6_4,2));
HXLINE( 599)		this->knockout->_hx_set_value(HX_CTX, ::Array_obj< int >::fromData( _hx_array_data_51cf6fd6_5,1));
...
::hx::Val BevelShader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"offset") ) { _hx_set_offset(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"uColorH") ) { _hx_set_uColorH(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		if (HX_FIELD_EQ(inName,"uColorS") ) { _hx_set_uColorS(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"knockout") ) { _hx_set_knockout(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Int >()); return inValue; }
		break;
	case 9:
		if (HX_FIELD_EQ(inName,"uStrength") ) { _hx_set_uStrength(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"sourceBitmap") ) { _hx_set_sourceBitmap(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderInput_openfl_display_BitmapData >()); return inValue; }
	}
