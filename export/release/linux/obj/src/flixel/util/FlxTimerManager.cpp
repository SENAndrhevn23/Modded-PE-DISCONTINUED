...
void FlxTimerManager_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_626da793e26fdbd0_263_new)
HXLINE( 265)		this->_hx_set__timers(HX_CTX, ::Array_obj< ::Dynamic>::__new(0));
...
void FlxTimerManager_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_626da793e26fdbd0_284_destroy)
HXLINE( 285)		::flixel::util::FlxArrayUtil_obj::clearArray(this->_timers,null());
HXLINE( 286)		this->_hx_set__timers(HX_CTX, null());
...
void FlxTimerManager_obj::remove( ::flixel::util::FlxTimer timer){
            	HX_GC_STACKFRAME(&_hx_pos_626da793e26fdbd0_346_remove)
HXDLIN( 346)		::Array< ::Dynamic> array = this->_timers;
HXDLIN( 346)		int index = array->indexOf(timer,null());
HXDLIN( 346)		if ((index != -1)) {
HXDLIN( 346)			array->setCtx( HX_CTX, index,array->__get((array->length - 1)).StaticCast<  ::flixel::util::FlxTimer >());
...
::hx::Val FlxTimerManager_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 7:
		if (HX_FIELD_EQ(inName,"_timers") ) { _hx_set__timers(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
	}
