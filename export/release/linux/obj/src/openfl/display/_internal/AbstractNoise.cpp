...
void AbstractNoise_obj::calculateOctaves(Float fPersistence){
            	HX_GC_STACKFRAME(&_hx_pos_40b07ea52dd2579e_148_calculateOctaves)
HXLINE( 149)		Float fFreq;
HXDLIN( 149)		Float fPers;
HXLINE( 151)		this->_hx_set_octaves_frequencies(HX_CTX, ::Array_obj< Float >::__new(0));
HXLINE( 152)		this->_hx_set_octaves_persistences(HX_CTX, ::Array_obj< Float >::__new(0));
...
::hx::Val AbstractNoise_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 16:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"octaves_frequencies") ) { _hx_set_octaves_frequencies(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
		break;
	case 20:
		if (HX_FIELD_EQ(inName,"octaves_persistences") ) { _hx_set_octaves_persistences(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
	}
