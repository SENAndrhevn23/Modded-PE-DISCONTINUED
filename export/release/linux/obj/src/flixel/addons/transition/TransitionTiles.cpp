...
HXLINE(  22)		this->_hx_set__grpSprites(HX_CTX,  ::flixel::group::FlxTypedSpriteGroup_obj::__alloc( HX_CTX ,null(),null(),null()));
HXLINE(  23)		Float delay = ( (Float)(0) );
HXLINE(  25)		if (::hx::IsNull( data->tileData )) {
HXLINE(  27)			data->_hx_set_tileData(HX_CTX,  ::Dynamic(::hx::Anon_obj::Create(3)
...
void TransitionTiles_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_260f396e6842cd39_90_destroy)
HXLINE(  91)		this->super::destroy();
HXLINE(  92)		this->_hx_set__grpSprites(HX_CTX, null());
            	}
...
::hx::Val TransitionTiles_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"_grpSprites") ) { _hx_set__grpSprites(HX_CTX_GET,inValue.Cast<  ::flixel::group::FlxTypedSpriteGroup >()); return inValue; }
	}
