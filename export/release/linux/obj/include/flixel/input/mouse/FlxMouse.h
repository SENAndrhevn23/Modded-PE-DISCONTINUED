...
class HXCPP_CLASS_ATTRIBUTES FlxMouse_obj : public  ::flixel::input::FlxPointer_obj
{
	...
	public:
		...
		inline  ::openfl::display::Sprite _hx_set_cursorContainer(::hx::StackContext *_hx_ctx, ::openfl::display::Sprite _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return cursorContainer=_hx_v; }
		 ::openfl::display::Bitmap cursor;
		inline  ::openfl::display::Bitmap _hx_set_cursor(::hx::StackContext *_hx_ctx, ::openfl::display::Bitmap _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return cursor=_hx_v; }
		bool visible;
		bool useSystemCursor;
		 ::flixel::input::mouse::FlxMouseButton _leftButton;
		inline  ::flixel::input::mouse::FlxMouseButton _hx_set__leftButton(::hx::StackContext *_hx_ctx, ::flixel::input::mouse::FlxMouseButton _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _leftButton=_hx_v; }
		 ::flixel::input::mouse::FlxMouseButton _middleButton;
		inline  ::flixel::input::mouse::FlxMouseButton _hx_set__middleButton(::hx::StackContext *_hx_ctx, ::flixel::input::mouse::FlxMouseButton _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _middleButton=_hx_v; }
		 ::flixel::input::mouse::FlxMouseButton _rightButton;
		inline  ::flixel::input::mouse::FlxMouseButton _hx_set__rightButton(::hx::StackContext *_hx_ctx, ::flixel::input::mouse::FlxMouseButton _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _rightButton=_hx_v; }
		 ::openfl::display::BitmapData _cursorBitmapData;
		inline  ::openfl::display::BitmapData _hx_set__cursorBitmapData(::hx::StackContext *_hx_ctx, ::openfl::display::BitmapData _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _cursorBitmapData=_hx_v; }
		bool _wheelUsed;
		...
		inline  ::openfl::display::Stage _hx_set__stage(::hx::StackContext *_hx_ctx, ::openfl::display::Stage _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _stage=_hx_v; }
