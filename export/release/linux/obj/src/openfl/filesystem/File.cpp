...
void File_obj::__construct(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_19861550b6f626f4_94_new)
HXLINE( 420)		this->_hx___fileStatsDirty = false;
HXLINE( 419)		this->_hx_set__hx___sep(HX_CTX, HX_("/",2f,00,00,00));
HXLINE( 240)		this->_hx_set_icon(HX_CTX, null());
...
HXLINE( 464)			this->_hx_set_name(HX_CTX, dirs->__get((dirs->length - 1)));
            		}
            	}
...
HXLINE( 529)		this->_hx_set__hx___fileDialog(HX_CTX,  ::lime::ui::FileDialog_obj::__alloc( HX_CTX ));
...
HXLINE( 591)		this->_hx_set__hx___fileDialog(HX_CTX,  ::lime::ui::FileDialog_obj::__alloc( HX_CTX ));
...
HXLINE( 652)		this->_hx_set__hx___fileDialog(HX_CTX,  ::lime::ui::FileDialog_obj::__alloc( HX_CTX ));
...
HXLINE( 716)		this->_hx_set__hx___fileDialog(HX_CTX,  ::lime::ui::FileDialog_obj::__alloc( HX_CTX ));
...
HXLINE( 727)		this->_hx___fileWorker->cancel(null());
...
void File_obj::canonicalize(){
            	HX_GC_STACKFRAME(&_hx_pos_19861550b6f626f4_754_canonicalize)
...
HXLINE( 771)		this->_hx_set__hx___path(HX_CTX, ::haxe::io::Path_obj::removeTrailingSlashes(cPath3));
            	}
...
HXLINE( 957)			_gthis->_hx_set__hx___fileWorker(HX_CTX, null());
...
HXLINE( 962)			_gthis->_hx_set__hx___fileWorker(HX_CTX, null());
...
HXLINE( 976)						_gthis->_hx___fileWorker->sendComplete(ioErrorEvent,null());
            					}
            					else {
HXLINE( 980)						_gthis->_hx___fileWorker->sendError(e,null());
            					}
HXLINE( 982)					return;
            				}
            				else {
...
HXLINE( 986)			 ::lime::_hx_system::ThreadPool _gthis1 = _gthis->_hx___fileWorker;
HXDLIN( 986)			_gthis1->sendComplete( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null()),null());
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE( 954)		this->_hx_set__hx___fileWorker(HX_CTX,  ::lime::_hx_system::ThreadPool_obj::__alloc( HX_CTX ,null(),null(),null()));
...
HXLINE( 965)		::lime::_hx_system::_ThreadPool::PseudoEvent_Impl__obj::add(this->_hx___fileWorker->get_doWork(), ::Dynamic(new _hx_Closure_2(_gthis,overwrite,newLocation)));
HXLINE( 989)		this->_hx___fileWorker->run(null(),null(),null());
            	}
...
HXLINE(1080)			_gthis->_hx_set__hx___fileWorker(HX_CTX, null());
...
HXLINE(1085)			_gthis->_hx_set__hx___fileWorker(HX_CTX, null());
...
HXLINE(1099)						_gthis->_hx___fileWorker->sendComplete(ioErrorEvent,null());
            					}
            					else {
HXLINE(1103)						_gthis->_hx___fileWorker->sendError(e,null());
            					}
HXLINE(1105)					return;
            				}
            				else {
...
HXLINE(1109)			 ::lime::_hx_system::ThreadPool _gthis1 = _gthis->_hx___fileWorker;
HXDLIN(1109)			_gthis1->sendComplete( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null()),null());
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE(1077)		this->_hx_set__hx___fileWorker(HX_CTX,  ::lime::_hx_system::ThreadPool_obj::__alloc( HX_CTX ,null(),null(),null()));
...
HXLINE(1088)		::lime::_hx_system::_ThreadPool::PseudoEvent_Impl__obj::add(this->_hx___fileWorker->get_doWork(), ::Dynamic(new _hx_Closure_2(_gthis,deleteDirectoryContents)));
HXLINE(1112)		this->_hx___fileWorker->run(null(),null(),null());
            	}
...
HXLINE(1151)			_gthis->_hx_set__hx___fileWorker(HX_CTX, null());
...
HXLINE(1156)			_gthis->_hx_set__hx___fileWorker(HX_CTX, null());
...
HXLINE(1170)						_gthis->_hx___fileWorker->sendComplete(ioErrorEvent,null());
            					}
            					else {
HXLINE(1174)						_gthis->_hx___fileWorker->sendError(e,null());
            					}
HXLINE(1176)					return;
            				}
            				else {
...
HXLINE(1180)			 ::lime::_hx_system::ThreadPool _gthis1 = _gthis->_hx___fileWorker;
HXDLIN(1180)			_gthis1->sendComplete( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null()),null());
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE(1148)		this->_hx_set__hx___fileWorker(HX_CTX,  ::lime::_hx_system::ThreadPool_obj::__alloc( HX_CTX ,null(),null(),null()));
...
HXLINE(1159)		::lime::_hx_system::_ThreadPool::PseudoEvent_Impl__obj::add(this->_hx___fileWorker->get_doWork(), ::Dynamic(new _hx_Closure_2(_gthis)));
HXLINE(1183)		this->_hx___fileWorker->run(null(),null(),null());
            	}
...
HXLINE(1261)			_gthis->_hx_set__hx___fileWorker(HX_CTX, null());
...
HXLINE(1266)			_gthis->_hx_set__hx___fileWorker(HX_CTX, null());
...
HXLINE(1281)						_gthis->_hx___fileWorker->sendComplete(ioErrorEvent,null());
            					}
            					else {
HXLINE(1285)						_gthis->_hx___fileWorker->sendError(e,null());
            					}
HXLINE(1287)					return;
            				}
            				else {
...
HXLINE(1296)			 ::lime::_hx_system::ThreadPool _gthis1 = _gthis->_hx___fileWorker;
HXDLIN(1296)			_gthis1->sendComplete( ::openfl::events::FileListEvent_obj::__alloc( HX_CTX ,HX_("directoryListing",57,8c,81,22),files,null(),null()),null());
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE(1258)		this->_hx_set__hx___fileWorker(HX_CTX,  ::lime::_hx_system::ThreadPool_obj::__alloc( HX_CTX ,null(),null(),null()));
...
HXLINE(1269)		::lime::_hx_system::_ThreadPool::PseudoEvent_Impl__obj::add(this->_hx___fileWorker->get_doWork(), ::Dynamic(new _hx_Closure_2(_gthis)));
HXLINE(1299)		this->_hx___fileWorker->run(null(),null(),null());
            	}
...
HXLINE(1532)			_gthis->_hx_set__hx___fileWorker(HX_CTX, null());
...
HXLINE(1537)			_gthis->_hx_set__hx___fileWorker(HX_CTX, null());
...
HXLINE(1551)						_gthis->_hx___fileWorker->sendComplete(ioErrorEvent,null());
            					}
            					else {
HXLINE(1555)						_gthis->_hx___fileWorker->sendError(e,null());
            					}
HXLINE(1557)					return;
            				}
            				else {
...
HXLINE(1561)			 ::lime::_hx_system::ThreadPool _gthis1 = _gthis->_hx___fileWorker;
HXDLIN(1561)			_gthis1->sendComplete( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null()),null());
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE(1529)		this->_hx_set__hx___fileWorker(HX_CTX,  ::lime::_hx_system::ThreadPool_obj::__alloc( HX_CTX ,null(),null(),null()));
...
HXLINE(1540)		::lime::_hx_system::_ThreadPool::PseudoEvent_Impl__obj::add(this->_hx___fileWorker->get_doWork(), ::Dynamic(new _hx_Closure_2(_gthis,overwrite,newLocation)));
HXLINE(1564)		this->_hx___fileWorker->run(null(),null(),null());
            	}
...
HXLINE(1728)			this->_hx_set__hx___fileDialog(HX_CTX, null());
            		}
...
HXLINE(1737)			this->_hx_set__hx___fileDialog(HX_CTX, null());
            		}
...
HXLINE(1749)			this->_hx_set__hx___fileDialog(HX_CTX, null());
            		}
...
void File_obj::_hx___updateFileStats(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_19861550b6f626f4_1920___updateFileStats)
...
HXLINE(1929)			this->_hx_set_creationDate(HX_CTX, ( ( ::Date)(fileInfo->__Field(HX_("ctime",f0,39,a8,4d),::hx::paccDynamic)) ));
HXLINE(1930)			this->_hx_set_modificationDate(HX_CTX, ( ( ::Date)(fileInfo->__Field(HX_("mtime",fa,06,aa,0f),::hx::paccDynamic)) ));
HXLINE(1931)			this->size = ( (Float)(fileInfo->__Field(HX_("size",c1,a0,53,4c),::hx::paccDynamic)) );
            		}
            		else {
HXLINE(1935)			this->_hx_set_creationDate(HX_CTX, null());
HXLINE(1936)			this->_hx_set_modificationDate(HX_CTX, null());
HXLINE(1937)			this->size = ( (Float)(0) );
            		}
HXLINE(1939)		this->_hx_set_extension(HX_CTX, ::haxe::io::Path_obj::extension(path));
HXLINE(1940)		this->_hx_set_type(HX_CTX, this->get_extension());
HXLINE(1941)		this->_hx_set_name(HX_CTX, ::haxe::io::Path_obj::withoutDirectory(path));
            	}
...
HXDLIN(2056)		return (this->_hx_set__hx___path(HX_CTX, _hx_tmp));
            	}
...
::hx::Val File_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"icon") ) { _hx_set_icon(HX_CTX_GET,inValue.Cast<  ::openfl::desktop::Icon >()); return inValue; }
		break;
	case 5:
		if (HX_FIELD_EQ(inName,"__sep") ) { _hx_set__hx___sep(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"nativePath") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set_nativePath(inValue.Cast< ::String >()) ); }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"__fileDialog") ) { _hx_set__hx___fileDialog(HX_CTX_GET,inValue.Cast<  ::lime::ui::FileDialog >()); return inValue; }
		if (HX_FIELD_EQ(inName,"__fileWorker") ) { _hx_set__hx___fileWorker(HX_CTX_GET,inValue.Cast<  ::lime::_hx_system::ThreadPool >()); return inValue; }
		break;
	case 16:
...
static ::hx::StorageInfo File_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::lime::_hx_system::ThreadPool */ ,(int)offsetof(File_obj,_hx___fileWorker),HX_("__fileWorker",3a,f3,b5,e2)},
