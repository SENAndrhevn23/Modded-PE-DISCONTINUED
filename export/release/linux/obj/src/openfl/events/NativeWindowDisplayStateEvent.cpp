...
void NativeWindowDisplayStateEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable, ::Dynamic beforeDisplayState, ::Dynamic afterDisplayState){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_ce7954d4ba23c2d4_74_new)
HXLINE(  75)		super::__construct(type,bubbles,cancelable);
HXLINE(  76)		this->_hx_set_beforeDisplayState(HX_CTX, beforeDisplayState);
HXLINE(  77)		this->_hx_set_afterDisplayState(HX_CTX, afterDisplayState);
            	}
...
HXLINE(  84)		event->_hx_set_target(HX_CTX, this->target);
HXLINE(  85)		event->_hx_set_currentTarget(HX_CTX, this->currentTarget);
...
::hx::Val NativeWindowDisplayStateEvent_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 17:
		if (HX_FIELD_EQ(inName,"afterDisplayState") ) { _hx_set_afterDisplayState(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"beforeDisplayState") ) { _hx_set_beforeDisplayState(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
