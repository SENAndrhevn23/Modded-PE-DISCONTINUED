...
class HXCPP_CLASS_ATTRIBUTES FlxSave_obj : public ::hx::Object
{
	...
	public:
		...
		inline  ::flixel::util::FlxSaveStatus _hx_set_status(::hx::StackContext *_hx_ctx, ::flixel::util::FlxSaveStatus _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return status=_hx_v; }
		 ::openfl::net::SharedObject _sharedObject;
		inline  ::openfl::net::SharedObject _hx_set__sharedObject(::hx::StackContext *_hx_ctx, ::openfl::net::SharedObject _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return _sharedObject=_hx_v; }
		void destroy();
		::Dynamic destroy_dyn();
