...
class HXCPP_CLASS_ATTRIBUTES FlxBaseSignal_obj : public ::hx::Object
{
	...
	public:
		...
		inline ::Array< ::Dynamic> _hx_set_handlers(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return handlers=_hx_v; }
		::Array< ::Dynamic> pendingRemove;
		inline ::Array< ::Dynamic> _hx_set_pendingRemove(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return pendingRemove=_hx_v; }
