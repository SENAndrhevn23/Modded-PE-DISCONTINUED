...
void FlxTimer_obj::__construct( ::flixel::util::FlxTimerManager manager){
            	HX_GC_STACKFRAME(&_hx_pos_151a56598b761d13_22_new)
...
HXDLIN( 129)		this->_hx_set_manager(HX_CTX, _hx_tmp);
            	}
...
void FlxTimer_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_151a56598b761d13_137_destroy)
HXDLIN( 137)		this->_hx_set_onComplete(HX_CTX, null());
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxTimer_obj,destroy,(void))
 ...
 ::flixel::util::FlxTimer FlxTimer_obj::start(::hx::Null< Float >  __o_time, ::Dynamic onComplete,::hx::Null< int >  __o_loops){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_151a56598b761d13_151_start)
...
HXLINE( 166)		this->_hx_set_onComplete(HX_CTX, onComplete);
...
::hx::Val FlxTimer_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"manager") ) { _hx_set_manager(HX_CTX_GET,inValue.Cast<  ::flixel::util::FlxTimerManager >()); return inValue; }
		break;
	case 8:
