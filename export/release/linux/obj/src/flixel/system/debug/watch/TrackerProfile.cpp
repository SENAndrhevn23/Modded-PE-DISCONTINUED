...
void TrackerProfile_obj::__construct(::hx::Class ObjectClass,::Array< ::String > Variables,::Array< ::Dynamic> Extensions){
            	HX_GC_STACKFRAME(&_hx_pos_045fa5a979169169_277_new)
HXLINE( 278)		this->_hx_set_objectClass(HX_CTX, ObjectClass);
HXLINE( 279)		this->_hx_set_variables(HX_CTX, Variables);
HXLINE( 280)		this->_hx_set_extensions(HX_CTX, Extensions);
            	}
...
::String TrackerProfile_obj::toString(){
            	HX_GC_STACKFRAME(&_hx_pos_045fa5a979169169_285_toString)
...
HXDLIN( 286)		_this->_hx_set_label(HX_CTX, HX_("variables",b7,e2,62,82));
HXDLIN( 286)		_this->_hx_set_value(HX_CTX, value);
...
HXDLIN( 287)		_this1->_hx_set_label(HX_CTX, HX_("extensions",14,7c,70,89));
HXDLIN( 287)		_this1->_hx_set_value(HX_CTX, value1);
...
::hx::Val TrackerProfile_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 9:
		if (HX_FIELD_EQ(inName,"variables") ) { _hx_set_variables(HX_CTX_GET,inValue.Cast< ::Array< ::String > >()); return inValue; }
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"extensions") ) { _hx_set_extensions(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"objectClass") ) { _hx_set_objectClass(HX_CTX_GET,inValue.Cast< ::hx::Class >()); return inValue; }
	}
