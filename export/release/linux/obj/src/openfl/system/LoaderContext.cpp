...
void LoaderContext_obj::__construct(::hx::Null< bool >  __o_checkPolicyFile, ::openfl::_hx_system::ApplicationDomain applicationDomain, ::openfl::_hx_system::SecurityDomain securityDomain){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_b514a9552a6ee0e8_421_new)
HXLINE( 422)		this->checkPolicyFile = checkPolicyFile;
HXLINE( 423)		this->_hx_set_securityDomain(HX_CTX, securityDomain);
HXLINE( 424)		this->_hx_set_applicationDomain(HX_CTX, applicationDomain);
...
::hx::Val LoaderContext_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 14:
		if (HX_FIELD_EQ(inName,"securityDomain") ) { _hx_set_securityDomain(HX_CTX_GET,inValue.Cast<  ::openfl::_hx_system::SecurityDomain >()); return inValue; }
		break;
	case 15:
