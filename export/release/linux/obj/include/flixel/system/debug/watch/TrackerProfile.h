...
class HXCPP_CLASS_ATTRIBUTES TrackerProfile_obj : public ::hx::Object
{
	...
	public:
		...
		inline ::hx::Class _hx_set_objectClass(::hx::StackContext *_hx_ctx,::hx::Class _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return objectClass=_hx_v; }
		::Array< ::String > variables;
		inline ::Array< ::String > _hx_set_variables(::hx::StackContext *_hx_ctx,::Array< ::String > _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return variables=_hx_v; }
		::Array< ::Dynamic> extensions;
		inline ::Array< ::Dynamic> _hx_set_extensions(::hx::StackContext *_hx_ctx,::Array< ::Dynamic> _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return extensions=_hx_v; }
