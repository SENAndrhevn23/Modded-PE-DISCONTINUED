...
void FlxQuadTree_obj::reset(Float X,Float Y,Float Width,Float Height, ::flixel::_hx_system::FlxQuadTree Parent){
            	HX_GC_STACKFRAME(&_hx_pos_d6b090d39d0d72d3_277_reset)
...
HXLINE( 282)		this->_hx_set__headA(HX_CTX, (this->_hx_set__tailA(HX_CTX, ::flixel::_hx_system::FlxLinkedList_obj::recycle())));
HXLINE( 283)		this->_hx_set__headB(HX_CTX, (this->_hx_set__tailB(HX_CTX, ::flixel::_hx_system::FlxLinkedList_obj::recycle())));
...
HXLINE( 298)						this->_hx_set__tailA(HX_CTX, ::flixel::_hx_system::FlxLinkedList_obj::recycle());
HXLINE( 299)						ot->_hx_set_next(HX_CTX, this->_tailA);
            					}
HXLINE( 301)					this->_tailA->_hx_set_object(HX_CTX, iterator->object);
...
HXLINE( 313)						this->_hx_set__tailB(HX_CTX, ::flixel::_hx_system::FlxLinkedList_obj::recycle());
HXLINE( 314)						ot->_hx_set_next(HX_CTX, this->_tailB);
            					}
HXLINE( 316)					this->_tailB->_hx_set_object(HX_CTX, iterator->object);
...
HXLINE( 328)		this->_hx_set__northWestTree(HX_CTX, null());
HXLINE( 329)		this->_hx_set__northEastTree(HX_CTX, null());
HXLINE( 330)		this->_hx_set__southEastTree(HX_CTX, null());
HXLINE( 331)		this->_hx_set__southWestTree(HX_CTX, null());
...
void FlxQuadTree_obj::destroy(){
            	HX_GC_STACKFRAME(&_hx_pos_d6b090d39d0d72d3_346_destroy)
HXLINE( 347)		this->_hx_set__headA(HX_CTX, ( ( ::flixel::_hx_system::FlxLinkedList)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_headA)) ));
HXLINE( 348)		this->_hx_set__headB(HX_CTX, ( ( ::flixel::_hx_system::FlxLinkedList)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_headB)) ));
HXLINE( 350)		this->_hx_set__tailA(HX_CTX, ( ( ::flixel::_hx_system::FlxLinkedList)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_tailA)) ));
HXLINE( 351)		this->_hx_set__tailB(HX_CTX, ( ( ::flixel::_hx_system::FlxLinkedList)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_tailB)) ));
HXLINE( 353)		this->_hx_set__northWestTree(HX_CTX, ( ( ::flixel::_hx_system::FlxQuadTree)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_northWestTree)) ));
HXLINE( 354)		this->_hx_set__northEastTree(HX_CTX, ( ( ::flixel::_hx_system::FlxQuadTree)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_northEastTree)) ));
HXLINE( 356)		this->_hx_set__southWestTree(HX_CTX, ( ( ::flixel::_hx_system::FlxQuadTree)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_southWestTree)) ));
HXLINE( 357)		this->_hx_set__southEastTree(HX_CTX, ( ( ::flixel::_hx_system::FlxQuadTree)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_southEastTree)) ));
...
HXLINE( 366)		this->_hx_set_next(HX_CTX, ::flixel::_hx_system::FlxQuadTree_obj::_cachedTreesHead);
...
void FlxQuadTree_obj::addObject(){
            	HX_GC_STACKFRAME(&_hx_pos_d6b090d39d0d72d3_460_addObject)
...
HXLINE( 476)					this->_hx_set__northWestTree(HX_CTX, ::flixel::_hx_system::FlxQuadTree_obj::recycle(this->_leftEdge,this->_topEdge,this->_halfWidth,this->_halfHeight,::hx::ObjectPtr<OBJ_>(this)));
            				}
...
HXLINE( 485)					this->_hx_set__southWestTree(HX_CTX, ::flixel::_hx_system::FlxQuadTree_obj::recycle(this->_leftEdge,this->_midpointY,this->_halfWidth,this->_halfHeight,::hx::ObjectPtr<OBJ_>(this)));
            				}
...
HXLINE( 497)					this->_hx_set__northEastTree(HX_CTX, ::flixel::_hx_system::FlxQuadTree_obj::recycle(this->_midpointX,this->_topEdge,this->_halfWidth,this->_halfHeight,::hx::ObjectPtr<OBJ_>(this)));
            				}
...
HXLINE( 506)					this->_hx_set__southEastTree(HX_CTX, ::flixel::_hx_system::FlxQuadTree_obj::recycle(this->_midpointX,this->_midpointY,this->_halfWidth,this->_halfHeight,::hx::ObjectPtr<OBJ_>(this)));
            				}
...
HXLINE( 518)				this->_hx_set__northWestTree(HX_CTX, ::flixel::_hx_system::FlxQuadTree_obj::recycle(this->_leftEdge,this->_topEdge,this->_halfWidth,this->_halfHeight,::hx::ObjectPtr<OBJ_>(this)));
            			}
...
HXLINE( 526)				this->_hx_set__northEastTree(HX_CTX, ::flixel::_hx_system::FlxQuadTree_obj::recycle(this->_midpointX,this->_topEdge,this->_halfWidth,this->_halfHeight,::hx::ObjectPtr<OBJ_>(this)));
            			}
...
HXLINE( 534)				this->_hx_set__southEastTree(HX_CTX, ::flixel::_hx_system::FlxQuadTree_obj::recycle(this->_midpointX,this->_midpointY,this->_halfWidth,this->_halfHeight,::hx::ObjectPtr<OBJ_>(this)));
            			}
...
HXLINE( 542)				this->_hx_set__southWestTree(HX_CTX, ::flixel::_hx_system::FlxQuadTree_obj::recycle(this->_leftEdge,this->_midpointY,this->_halfWidth,this->_halfHeight,::hx::ObjectPtr<OBJ_>(this)));
            			}
...
void FlxQuadTree_obj::addToList(){
            	HX_GC_STACKFRAME(&_hx_pos_d6b090d39d0d72d3_552_addToList)
...
HXLINE( 559)				this->_hx_set__tailA(HX_CTX, ::flixel::_hx_system::FlxLinkedList_obj::recycle());
HXLINE( 560)				ot->_hx_set_next(HX_CTX, this->_tailA);
            			}
HXLINE( 562)			this->_tailA->_hx_set_object(HX_CTX, ::flixel::_hx_system::FlxQuadTree_obj::_object);
            		}
            		else {
HXLINE( 566)			if (::hx::IsNotNull( this->_tailB->object )) {
HXLINE( 568)				ot = this->_tailB;
HXLINE( 569)				this->_hx_set__tailB(HX_CTX, ::flixel::_hx_system::FlxLinkedList_obj::recycle());
HXLINE( 570)				ot->_hx_set_next(HX_CTX, this->_tailB);
            			}
HXLINE( 572)			this->_tailB->_hx_set_object(HX_CTX, ::flixel::_hx_system::FlxQuadTree_obj::_object);
            		}
...
void FlxQuadTree_obj::clearCache(){
            	HX_GC_STACKFRAME(&_hx_pos_d6b090d39d0d72d3_265_clearCache)
...
HXLINE( 271)			node->_hx_set_next(HX_CTX, null());
            		}
...
::hx::Val FlxQuadTree_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"next") ) { _hx_set_next(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::FlxQuadTree >()); return inValue; }
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"exists") ) { exists=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_headA") ) { _hx_set__headA(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::FlxLinkedList >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_tailA") ) { _hx_set__tailA(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::FlxLinkedList >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_headB") ) { _hx_set__headB(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::FlxLinkedList >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_tailB") ) { _hx_set__tailB(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::FlxLinkedList >()); return inValue; }
		break;
	case 8:
	...
	case 13:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"_northWestTree") ) { _hx_set__northWestTree(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::FlxQuadTree >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_northEastTree") ) { _hx_set__northEastTree(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::FlxQuadTree >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_southEastTree") ) { _hx_set__southEastTree(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::FlxQuadTree >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_southWestTree") ) { _hx_set__southWestTree(HX_CTX_GET,inValue.Cast<  ::flixel::_hx_system::FlxQuadTree >()); return inValue; }
	}
