...
void GraphicsGradientFill_obj::__construct( ::Dynamic type,::Array< int > colors,::Array< Float > alphas,::Array< int > ratios, ::openfl::geom::Matrix matrix, ::Dynamic spreadMethod, ::Dynamic interpolationMethod,::hx::Null< Float >  __o_focalPointRatio){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_e4c1d0f133e7c9cd_179_new)
...
HXLINE( 195)		this->_hx_set_type(HX_CTX, type);
HXLINE( 196)		this->_hx_set_colors(HX_CTX, colors);
HXLINE( 197)		this->_hx_set_alphas(HX_CTX, alphas);
HXLINE( 198)		this->_hx_set_ratios(HX_CTX, ratios);
HXLINE( 199)		this->_hx_set_matrix(HX_CTX, matrix);
HXLINE( 200)		this->_hx_set_spreadMethod(HX_CTX, spreadMethod);
HXLINE( 201)		this->_hx_set_interpolationMethod(HX_CTX, interpolationMethod);
...
::hx::Val GraphicsGradientFill_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"matrix") ) { _hx_set_matrix(HX_CTX_GET,inValue.Cast<  ::openfl::geom::Matrix >()); return inValue; }
		if (HX_FIELD_EQ(inName,"ratios") ) { _hx_set_ratios(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"spreadMethod") ) { _hx_set_spreadMethod(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 15:
	...
	case 18:
		...
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"interpolationMethod") ) { _hx_set_interpolationMethod(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
	}
