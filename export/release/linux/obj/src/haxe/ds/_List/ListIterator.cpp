...
void ListIterator_obj::__construct( ::haxe::ds::_List::ListNode head){
            	HX_GC_STACKFRAME(&_hx_pos_bedc49e96a3e9316_281_new)
HXDLIN( 281)		this->_hx_set_head(HX_CTX, head);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ListIterator_obj,hasNext,return )
 ...
 ::Dynamic ListIterator_obj::next(){
            	HX_GC_STACKFRAME(&_hx_pos_bedc49e96a3e9316_288_next)
HXLINE( 289)		 ::Dynamic val = this->head->item;
HXLINE( 290)		this->_hx_set_head(HX_CTX, this->head->next);
...
::hx::Val ListIterator_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 4:
		if (HX_FIELD_EQ(inName,"head") ) { _hx_set_head(HX_CTX_GET,inValue.Cast<  ::haxe::ds::_List::ListNode >()); return inValue; }
	}
