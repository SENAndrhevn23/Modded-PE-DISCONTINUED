...
class HXCPP_CLASS_ATTRIBUTES Font_obj : public  ::lime::text::Font_obj
{
	...
	public:
		...
		static ::Dynamic registerFont_dyn();
		 ...
		 ::Dynamic fontStyle;
		inline  ::Dynamic _hx_set_fontStyle(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return fontStyle=_hx_v; }
		 ::Dynamic fontType;
		inline  ::Dynamic _hx_set_fontType(::hx::StackContext *_hx_ctx, ::Dynamic _hx_v) { HX_OBJ_WB(this,_hx_v.mPtr) return fontType=_hx_v; }
