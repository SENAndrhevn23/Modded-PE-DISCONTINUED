...
HXLINE(  21)				if (::hx::IsNotNull( ::states::PlayState_obj::instance->getLuaObject(obj,null()) )) {
HXLINE(  22)					::states::PlayState_obj::instance->getLuaObject(obj,null())->animation->play(name,forced,false,startFrame);
...
HXLINE( 143)		{
            		...
            		Float toValue = __o_toValue.Default(1);
            				HX_GC_STACKFRAME(&_hx_pos_0c94275d643f1e89_143_implement)
HXLINE( 144)				{
HXLINE( 144)					 ::flixel::sound::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN( 144)					Float From = (fromValue * ::backend::ClientPrefs_obj::data->bgmVolume);
HXDLIN( 144)					Float To = (toValue * ::backend::ClientPrefs_obj::data->bgmVolume);
...
HXDLIN( 144)					_this->_hx_set_fadeTween(HX_CTX, ::flixel::tweens::FlxTween_obj::num(From,To,duration, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 148)		{
            		...
            		Float toValue = __o_toValue.Default(0);
            				HX_GC_STACKFRAME(&_hx_pos_0c94275d643f1e89_148_implement)
HXLINE( 149)				{
HXLINE( 149)					 ::flixel::sound::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN( 149)					 ::Dynamic To = (toValue * ::backend::ClientPrefs_obj::data->bgmVolume);
...
HXDLIN( 149)					_this->_hx_set_fadeTween(HX_CTX, ::flixel::tweens::FlxTween_obj::num(_this->_volume,( (Float)(To) ),duration, ::Dynamic(::hx::Anon_obj::Create(1)
            						->setFixed(0,HX_("onComplete",f8,d4,7e,5d),onComplete)),_this->volumeTween_dyn()));
            				}
