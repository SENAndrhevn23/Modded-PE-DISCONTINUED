...
void FlxGraphicsShader_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_07f48bb0273dd92f_74_new)
...
::hx::Val FlxGraphicsShader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 5:
		if (HX_FIELD_EQ(inName,"alpha") ) { _hx_set_alpha(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"colorOffset") ) { _hx_set_colorOffset(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"hasTransform") ) { _hx_set_hasTransform(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Bool >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"colorMultiplier") ) { _hx_set_colorMultiplier(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Float >()); return inValue; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"hasColorTransform") ) { _hx_set_hasColorTransform(HX_CTX_GET,inValue.Cast<  ::openfl::display::ShaderParameter_Bool >()); return inValue; }
	}
