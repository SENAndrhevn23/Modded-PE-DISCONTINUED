...
void FlxTypeText_obj::__construct(Float X,Float Y,int Width,::String Text,::hx::Null< int >  __o_Size,::hx::Null< bool >  __o_EmbeddedFont){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_09182b6b580f8cf2_34_new)
...
HXLINE( 116)		this->_hx_set__finalText(HX_CTX, HX_("",00,00,00,00));
HXLINE( 101)		this->_hx_set_skipKeys(HX_CTX, ::Array_obj< int >::__new(0));
...
HXLINE(  64)		this->_hx_set_prefix(HX_CTX, HX_("",00,00,00,00));
HXLINE(  59)		this->cursorBlinkSpeed = ((Float)0.5);
HXLINE(  54)		this->_hx_set_cursorCharacter(HX_CTX, HX_("|",7c,00,00,00));
...
HXLINE( 187)		this->_hx_set__finalText(HX_CTX, Text);
            	}
...
void FlxTypeText_obj::start( ::Dynamic Delay,::hx::Null< bool >  __o_ForceRestart,::hx::Null< bool >  __o_AutoErase,::Array< int > SkipKeys, ::Dynamic Callback){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_09182b6b580f8cf2_202_start)
...
HXLINE( 223)			this->_hx_set_skipKeys(HX_CTX, SkipKeys);
            		}
HXLINE( 226)		if (::hx::IsNotNull( Callback )) {
HXLINE( 228)			this->_hx_set_completeCallback(HX_CTX, Callback);
            		}
...
void FlxTypeText_obj::insertBreakLines(){
            	HX_GC_STACKFRAME(&_hx_pos_09182b6b580f8cf2_251_insertBreakLines)
...
HXLINE( 273)			if ((n0 == n1)) {
HXLINE( 275)				this->_hx_set__finalText(HX_CTX, nextText1);
            			}
            		}
            		_hx_goto_3:;
...
void FlxTypeText_obj::erase( ::Dynamic Delay,::hx::Null< bool >  __o_ForceRestart,::Array< int > SkipKeys, ::Dynamic Callback){
            		bool ForceRestart = __o_ForceRestart.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_09182b6b580f8cf2_291_erase)
...
HXLINE( 310)			this->_hx_set_skipKeys(HX_CTX, SkipKeys);
            		}
HXLINE( 313)		this->_hx_set_eraseCallback(HX_CTX, Callback);
...
void FlxTypeText_obj::resetText(::String Text){
            	HX_GC_STACKFRAME(&_hx_pos_09182b6b580f8cf2_327_resetText)
HXLINE( 328)		this->set_text(HX_("",00,00,00,00));
HXLINE( 329)		this->_hx_set__finalText(HX_CTX, Text);
...
HXDLIN( 551)		this->_hx_set__sound(HX_CTX, _hx_tmp->load( ::flixel::addons::text::TypeSound_obj::__alloc( HX_CTX ,null(),null()),null(),null(),null(),null(),null(),null(),null(),null()));
            	}
...
::hx::Val FlxTypeText_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"prefix") ) { _hx_set_prefix(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
		if (HX_FIELD_EQ(inName,"paused") ) { paused=inValue.Cast< bool >(); return inValue; }
		if (HX_FIELD_EQ(inName,"sounds") ) { _hx_set_sounds(HX_CTX_GET,inValue.Cast< ::Array< ::Dynamic> >()); return inValue; }
		if (HX_FIELD_EQ(inName,"_timer") ) { _timer=inValue.Cast< Float >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_sound") ) { _hx_set__sound(HX_CTX_GET,inValue.Cast<  ::flixel::sound::FlxSound >()); return inValue; }
		break;
	case 7:
	...
	case 8:
		...
		if (HX_FIELD_EQ(inName,"skipKeys") ) { _hx_set_skipKeys(HX_CTX_GET,inValue.Cast< ::Array< int > >()); return inValue; }
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"_finalText") ) { _hx_set__finalText(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	...
	case 12:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"eraseCallback") ) { _hx_set_eraseCallback(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"cursorCharacter") ) { _hx_set_cursorCharacter(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	...
	case 16:
		...
		if (HX_FIELD_EQ(inName,"completeCallback") ) { _hx_set_completeCallback(HX_CTX_GET,inValue.Cast<  ::Dynamic >()); return inValue; }
