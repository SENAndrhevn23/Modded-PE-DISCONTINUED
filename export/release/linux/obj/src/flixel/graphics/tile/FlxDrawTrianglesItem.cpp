...
HXDLIN(  42)		this->_hx_set_bounds(HX_CTX, rect);
...
HXDLIN(  36)		this->_hx_set_colors(HX_CTX,  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length,fixed,array));
HXLINE(  35)		int length1 = null();
HXDLIN(  35)		bool fixed1 = null();
HXDLIN(  35)		::Array< Float > array1 = null();
HXDLIN(  35)		this->_hx_set_uvtData(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length1,fixed1,array1,true));
HXLINE(  34)		int length2 = null();
HXDLIN(  34)		bool fixed2 = null();
HXDLIN(  34)		::Array< int > array2 = null();
HXDLIN(  34)		this->_hx_set_indices(HX_CTX,  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length2,fixed2,array2));
HXLINE(  33)		int length3 = null();
HXDLIN(  33)		bool fixed3 = null();
HXDLIN(  33)		::Array< Float > array3 = null();
HXDLIN(  33)		this->_hx_set_vertices(HX_CTX,  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length3,fixed3,array3,true));
HXLINE(  46)		super::__construct();
HXLINE(  47)		this->_hx_set_type(HX_CTX, ::flixel::graphics::tile::FlxDrawItemType_obj::TRIANGLES_dyn());
HXLINE(  49)		this->_hx_set_alphas(HX_CTX, ::Array_obj< Float >::__new(0));
            	}
...
void FlxDrawTrianglesItem_obj::render( ::flixel::FlxCamera camera){
            	HX_GC_STACKFRAME(&_hx_pos_a928be64e2bd594d_54_render)
...
HXLINE(  63)		shader->bitmap->_hx_set_input(HX_CTX, this->graphics->bitmap);
...
HXDLIN(  64)		shader->bitmap->_hx_set_filter(HX_CTX, _hx_tmp);
HXLINE(  65)		shader->bitmap->_hx_set_wrap(HX_CTX, 2);
HXLINE(  66)		shader->alpha->_hx_set_value(HX_CTX, this->alphas);
...
HXLINE(  70)			shader->colorMultiplier->_hx_set_value(HX_CTX, this->colorMultipliers);
HXLINE(  71)			shader->colorOffset->_hx_set_value(HX_CTX, this->colorOffsets);
            		}
HXLINE(  74)		{
HXLINE(  74)			 ::openfl::display::ShaderParameter_Bool parameter = shader->hasTransform;
HXDLIN(  74)			if (::hx::IsNull( parameter->value )) {
HXLINE(  74)				parameter->_hx_set_value(HX_CTX, ::Array_obj< bool >::__new(0));
            			}
...
HXLINE(  75)				parameter1->_hx_set_value(HX_CTX, ::Array_obj< bool >::__new(0));
            			}
...
void FlxDrawTrianglesItem_obj::dispose(){
            	HX_GC_STACKFRAME(&_hx_pos_a928be64e2bd594d_122_dispose)
HXLINE( 123)		this->super::dispose();
HXLINE( 125)		this->_hx_set_vertices(HX_CTX, null());
HXLINE( 126)		this->_hx_set_indices(HX_CTX, null());
HXLINE( 127)		this->_hx_set_uvtData(HX_CTX, null());
HXLINE( 128)		this->_hx_set_colors(HX_CTX, null());
HXLINE( 129)		this->_hx_set_bounds(HX_CTX, null());
HXLINE( 131)		this->_hx_set_alphas(HX_CTX, null());
HXLINE( 132)		this->_hx_set_colorMultipliers(HX_CTX, null());
HXLINE( 133)		this->_hx_set_colorOffsets(HX_CTX, null());
            	}
...
void FlxDrawTrianglesItem_obj::addTriangles( ::openfl::_Vector::FloatVector vertices, ::openfl::_Vector::IntVector indices, ::openfl::_Vector::FloatVector uvtData, ::openfl::_Vector::IntVector colors, ::flixel::math::FlxBasePoint position, ::flixel::math::FlxRect cameraBounds, ::openfl::geom::ColorTransform transform){
            	HX_GC_STACKFRAME(&_hx_pos_a928be64e2bd594d_139_addTriangles)
...
HXLINE( 224)				this->_hx_set_colorMultipliers(HX_CTX, ::Array_obj< Float >::__new(0));
            			}
HXLINE( 226)			if (::hx::IsNull( this->colorOffsets )) {
HXLINE( 227)				this->_hx_set_colorOffsets(HX_CTX, ::Array_obj< Float >::__new(0));
            			}
HXLINE( 229)			{
...
void FlxDrawTrianglesItem_obj::setParameterValue( ::openfl::display::ShaderParameter_Bool parameter,bool value){
            	HX_GC_STACKFRAME(&_hx_pos_a928be64e2bd594d_261_setParameterValue)
HXLINE( 262)		if (::hx::IsNull( parameter->value )) {
HXLINE( 263)			parameter->_hx_set_value(HX_CTX, ::Array_obj< bool >::__new(0));
            		}
...
::hx::Val FlxDrawTrianglesItem_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"alphas") ) { _hx_set_alphas(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
		if (HX_FIELD_EQ(inName,"colors") ) { _hx_set_colors(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::IntVector >()); return inValue; }
		if (HX_FIELD_EQ(inName,"bounds") ) { _hx_set_bounds(HX_CTX_GET,inValue.Cast<  ::flixel::math::FlxRect >()); return inValue; }
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"indices") ) { _hx_set_indices(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::IntVector >()); return inValue; }
		if (HX_FIELD_EQ(inName,"uvtData") ) { _hx_set_uvtData(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::FloatVector >()); return inValue; }
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"vertices") ) { _hx_set_vertices(HX_CTX_GET,inValue.Cast<  ::openfl::_Vector::FloatVector >()); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"colorOffsets") ) { _hx_set_colorOffsets(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
		break;
	case 14:
	...
	case 15:
		...
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"colorMultipliers") ) { _hx_set_colorMultipliers(HX_CTX_GET,inValue.Cast< ::Array< Float > >()); return inValue; }
