...
HXLINE(1179)		this->_hx_set_format(HX_CTX,  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,null(),null(),fontColor,bold,italic,underline,null(),null(),null(),null(),null(),null(),null()));
...
int FlxTextFormat_obj::set_leading(int value){
            	HX_GC_STACKFRAME(&_hx_pos_a69907c6a733237a_1184_set_leading)
HXLINE(1185)		this->format->_hx_set_leading(HX_CTX, value);
...
::hx::Val FlxTextFormat_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"format") ) { _hx_set_format(HX_CTX_GET,inValue.Cast<  ::openfl::text::TextFormat >()); return inValue; }
		break;
	case 7:
