...
void FlxTextFormatMarkerPair_obj::__construct( ::flixel::text::FlxTextFormat format,::String marker){
            	HX_GC_STACKFRAME(&_hx_pos_415d3a020ae56400_1208_new)
HXLINE(1209)		this->_hx_set_format(HX_CTX, format);
HXLINE(1210)		this->_hx_set_marker(HX_CTX, marker);
            	}
...
::hx::Val FlxTextFormatMarkerPair_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"marker") ) { _hx_set_marker(HX_CTX_GET,inValue.Cast< ::String >()); return inValue; }
	}
